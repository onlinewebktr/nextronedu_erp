<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="online-registration-unpaid.aspx.cs" Inherits="school_web.Admin.online_registration_unpaid" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Unpaid Student List</li>
                        </ol>
                    </nav>
                </div>
            </div>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td style="text-align: left;">
                                                                                        <asp:Label ID="lbl_razorpay_payment_id" runat="server" Text='<%#Bind("razorpay_payment_id")%>'></asp:Label>
                                                                                         <asp:Label ID="lbl_payment_slip1" runat="server" Text='<%#Bind("payment_slip")%>' Visible="false"></asp:Label>
                                                                                    </td>
                                                                                    ...
                                                                                    <td style="text-align: left;">
                                                                                        <div class="user-box dropdown" style="float: left; display: inherit; height: auto; border-left: 0px solid #f0f0f0; margin-left: 0px;">
                                                                                            ...
                                                                                            <ul class="dropdown-menu dropdown-menu-end">
                                                                                                ...
                                                                                                <li>
                                                                                                    <asp:LinkButton ID="lnk_update_payment" class="dropdown-item"  runat="server" OnClick="lnk_update_payment_Click">Verify Payment</asp:LinkButton> 
                                                                                                </li> 
        ...
        <div class="modal-dialog md-width" style="max-width: 600px;">
            ...
            <div class="modal-content" style="position: relative">
                <div class="modal-header">
                    <h3 class="modal-title" style="font-size: 20px;">Verify Payment</h3>
    ...
    width: 100%;" />
                        ...
                        <div class="col-md-12" runat="server" id="pnl_mode_t_n_dv" visible="false">
                            ...
                            <asp:TextBox ID="txt_transaction_no" runat="server" class="form-control">NA</asp:TextBox>
                        </div>
                        <div class="col-md-12">
