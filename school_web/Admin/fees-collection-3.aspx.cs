...
{
    public partial class fees_collection_3 : System.Web.UI.Page
    {
        My mycode = new My();
            ...
            else
            {
                ...
                if (ViewState["is_separate_panel_hostel"].ToString() == "1")
                {
                    ...
                    if (dtH.Rows.Count > 0)
                    {
                        ...
                        string respUrl = hostelLink + "/login.aspx?feePage=fees-collection-3.aspx&snId=" + ddlsessionad.SelectedValue + "&clsid=" + ViewState["classid"].ToString() + "&admno=" + txt_admission_no.Text + "&userid=" + ViewState["Userid"].ToString();
            ...
            try
            {
                if (btn_save_payment.Text == "Pay")
                {
                    ...
                    using (TransactionScope scope = new TransactionScope(TransactionScopeOption.RequiresNew, new TimeSpan(1, 0, 0)))
                    {
                        ...
                        string paid_amount = txt_paid_amount.Text;
                        if (My.toDouble(txttotalbill.Text) < My.toDouble(txt_paid_amount.Text))
                        {
                            paid_amount = txttotalbill.Text;
                        }



                        if (My.toDouble(txttotalbill.Text) >= My.toDouble(paid_amount))
                        {
                            #region ForBackDate
                            ...
                            if (chk_collect_adm_ann_fee.Checked == true)
                            {
                                ...
                                if (ViewState["Transfer_Status"].ToString() == "New")
                                {
                                    ...
                                    feeTypes = "Admission";
                                    make_admission_fee(con, admissionPaid, slip_no, paid_amount, feeTypes);
                                }
                                else
                                {
                                    if (chk_delete_slip.Checked == true)
                                    ...
                                    feeTypes = "Annual";
                                    make_annual_fee(con, admissionPaid, slip_no, paid_amount);
                                }
                    ...
                    if (flag == true)
                    {
                        ...
                        try
                        {
                            ...
                            double amountpaid = My.toDouble(paid_amount);
                        ...
                        if (iS_any_payment_done == "1")
                        {
                            ...
                            if (chk_collect_adm_ann_fee.Checked == true)
                            {
                                try
                                {
                                    ...
                                    My.send_success_notice_fee(lbl_name.Text, lblclass.Text, txt_section.Text, txtrollnumber.Text, lbl_admission_no.Text, paid_amount, notice_type, notice_type_name, ViewState["sessionIDs"].ToString());
                                }
                                catch (Exception ex)
                                {
                                }
                            ...
                            else
                            {
                                ...
                                {
                                    Response.Redirect("fees-collection-3.aspx?adm=" + lbl_admission_no.Text + "&sessionid=" + ddlsessionad.SelectedValue, false);
        ...
        void send_data_in_student_payment_history(string type, string slip_no, string entry_id, List<string> month_lst, string total_paid, SqlConnection con, string withAdm)
        {
            if (withAdm == "0")
            {
                ...
                if (My.toDouble(txttotalbill.Text) < My.toDouble(txt_paid_amount.Text))
                {
                    double mnthly_dues_amt = (My.toDouble(txt_paid_amount.Text) - My.toDouble(txttotalbill.Text));
                    dr["Refund_amount"] = mnthly_dues_amt.ToString();
                }
                else
                {
                    dr["Refund_amount"] = "0";
        ...
        {
            SqlCommand cmd;
            string query = "insert into Student_Payment_History(Addmission_no,Session,Date,Idate,Description,Entry_id,Slip_no,Amount,Type,mode,discount,Discoun_in_School,Discoun_in_Hostel,Discoun_in_Transport,fine,is_ofline_sync,Is_online_sync,is_update_in_online,Previous_admission_no,App_Transection_id,time,user_id,Acamedic_Semester_Id,Branch,Class_id,User_Slip_no,Pay_mode_transaction_no,Remarks,Transection_in,parameter_New,Bank_name,Bank_date,Refund_amount) values (@Addmission_no,@Session,@Date,@Idate,@Description,@Entry_id,@Slip_no,@Amount,@Type,@mode,@discount,@Discoun_in_School,@Discoun_in_Hostel,@Discoun_in_Transport,@fine,@is_ofline_sync,@Is_online_sync,@is_update_in_online,@Previous_admission_no,@App_Transection_id,@time,@user_id,@Acamedic_Semester_Id,@Branch,@Class_id,@User_Slip_no,@Pay_mode_transaction_no,@Remarks,@Transection_in,@parameter_New,@Bank_name,@Bank_date,@Refund_amount)";
            cmd = new SqlCommand(query);
            cmd.Parameters.AddWithValue("@Addmission_no", ad_no);
            cmd.Parameters.AddWithValue("@Session", ViewState["session"].ToString());
            ...
            {
                double mnthly_dues_amt = (My.toDouble(txt_paid_amount.Text) - My.toDouble(txttotalbill.Text));
                cmd.Parameters.AddWithValue("@Refund_amount", mnthly_dues_amt.ToString());
            }
            else
            {
                cmd.Parameters.AddWithValue("@Refund_amount", parameter_New);
            }
            ...
            if (isamountfill == true)
            {
                ...
                if (flag == true)
                {
                    if (ViewState["issubmit"].ToString() == "1")
                    {
                        ...
                        Response.Redirect("fees-collection-3.aspx?adm=" + txt_admission_no.Text + "&sessionid=" + ddlsessionad.SelectedValue, false);
                    }
                    else
                    {
                        Session["IsDiscountOpen"] = "0";
        ...
        protected void lnkDelExtFee_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                using (TransactionScope scope = new TransactionScope(TransactionScopeOption.RequiresNew, new TimeSpan(1, 0, 0)))
                {
                    ...
                    payments.delete_log(lbl_session_id.Text, ViewState["classid"].ToString(), lbl_admission_no.Text, "DeleteExtraFeeHead", desc, "fees-collection-3.aspx", ViewState["Userid"].ToString(), con);
                    dues_update_headwise_transaction.update_student_dues(ViewState["sessionIDs"].ToString(), ViewState["class_id"].ToString(), lbl_admission_no.Text, "0", "0", con);
...
values ('" + ViewState["Admission_no"].ToString() + "','" + class1 + "','" + ViewState["session"].ToString() + "','MonthlyFee','" + mycode.date() + "','" + mycode.idate() + "','" + TransportationFeetype + "','" + My.toDouble(Amount).ToString("0.00") + "','0','" + My.toDouble(afterdicount).ToString("0.00") + "','Dues','" + ddl_monthname.SelectedItem.Text + "','" + content_id1 + "','','School','false','false','false','" + My.toDouble(disc_amount).ToString("0.00") + "','" + section + "','" + ViewState["Userid"].ToString() + "','" + ViewState["Branchid"].ToString() + "','" + group_id + "','" + class_id + "','" + position + "','" + afterdicount.ToString("0.00") + "')", con);
            ...
            if (flag == true)
            {
                ...
                Response.Redirect("fees-collection-3.aspx?adm=" + ViewState["Admission_no"].ToString() + "&sessionid=" + ddlsessionad.SelectedValue, false);
            }
        }
                ...
                if (ViewState["Is_delete_Bus"].ToString() == "1")
                {
                    ...
                    using (TransactionScope scope = new TransactionScope(TransactionScopeOption.RequiresNew, new TimeSpan(1, 0, 0)))
                    {
                        ...
                        if (payments.InsertUpdateData(cmd1, con))
                        {
                            ...
                            payments.delete_log(ViewState["sessionIDs"].ToString(), ViewState["classid"].ToString(), lbl_admission_no.Text, "RemoveTransport", desc, "fees-collection-3.aspx", ViewState["Userid"].ToString(), con);
        ...
        private void save_hostel_mapping()
        {
            ...
            using (TransactionScope scope = new TransactionScope(TransactionScopeOption.RequiresNew, new TimeSpan(1, 0, 0)))
            {
                ...
                if (payments.InsertUpdateData(cmd, con))
                {
                    try
                    {
                        payments.save_hostel_aggign_remove_history(ViewState["sessionIDs"].ToString(), ViewState["classid"].ToString(), lbl_admission_no.Text, "Assign", "", "Hostel Assign", "fees-collection-3.aspx", ViewState["Userid"].ToString(), con);
            ...
            try
            {
                if (ViewState["Is_delete_Hostel"].ToString() == "1")
                {
                    ...
                    using (TransactionScope scope = new TransactionScope(TransactionScopeOption.RequiresNew, new TimeSpan(1, 0, 0)))
                    {
                        ...
                        payments.save_hostel_aggign_remove_history(ViewState["sessionIDs"].ToString(), ViewState["classid"].ToString(), lbl_admission_no.Text, "Remove", ddl_hostel_remove_month.SelectedItem.Text, txt_h_rmov_remark.Text, "fees-collection-3.aspx", ViewState["Userid"].ToString(), con);
                        string desc = "Hostel removed for name : " + lbl_name.Text;
                        payments.delete_log(ViewState["sessionIDs"].ToString(), ViewState["classid"].ToString(), lbl_admission_no.Text, "RemoveHostel", desc, "fees-collection-3.aspx", ViewState["Userid"].ToString(), con);
                        dues_update_headwise_transaction.update_student_dues(ViewState["sessionIDs"].ToString(), ViewState["class_id"].ToString(), lbl_admission_no.Text, "0", "0", con);
