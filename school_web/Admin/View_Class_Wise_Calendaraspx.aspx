<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="View_Class_Wise_Calendaraspx.aspx.cs" Inherits="school_web.Admin.View_Class_Wise_Calendaraspx" EnableEventValidation="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    View Class Wise Calendar
</asp:Content>
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><a href="student-report-home.aspx" class="backlnk-css"><i class="bx bx-arrow-back"></i></a>About School</div>
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            <li class="breadcrumb-item"><a href="Home.aspx"><i class="bx bx-home-alt"></i></a>
                            </li>
                            <li class="breadcrumb-item active" aria-current="page">Class Wise Calendar</li>
                        </ol>
                    </nav>
                </div>
            </div>
                        ...
                        <div class="card-body">
                                            ...
                                            <div class="find-dv">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-2">
                                                        ...
                                                        <asp:DropDownList ID="ddlmonth" runat="server" class="form-select find-dv-txtbx"></asp:DropDownList>
                                                    </div>
                                                    <div class="col-sm-2">
                            ...
                            <asp:Label ID="lbl_website" runat="server"></asp:Label>
                                                    ...
                                                    <p style="text-align: center; border: 1px solid #000; padding: 5px 0px 8px 0px; margin: 0px; background: #0074ff; width: 100%; color: #141212; float: left; text-align: center">
                                                        ...
                                                        <asp:Label ID="Label1" Style="font-size: 21px;" runat="server" Font-Bold="True" Font-Size="Medium"
                                                    ...
                                                    <asp:Calendar ID="Calendar1" runat="server" OnDayRender="Calendar1_DayRender" SelectionMode="None" ShowTitle="False" DayNameFormat="Full" ShowGridLines="True" CellSpacing="1" Style="width: 100%; margin: 0px;">
                                                        <WeekendDayStyle BorderColor="#CC9900" Wrap="True" />
                                                    </asp:Calendar>
                                                </div>
                                            </div>

                                            <div class="grd-wpr" style="height: 1px; overflow: hidden">
                                                <asp:GridView ID="GrdView" runat="server" class="table-bordered" AutoGenerateColumns="False" Width="100%">
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Date">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lbl_date" runat="server" Text='<%#Bind("new_date")%>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
