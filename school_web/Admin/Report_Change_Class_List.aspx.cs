...
{
    public partial class Report_Change_Class_List : System.Web.UI.Page
    {
        My mycode = new My();
            ...
            try
            {
                if (!IsPostBack)
                {
                    ...
                    else
                    {
                        ...
                        string pagename_current = "Report_Change_Class_List.aspx";
        ...
        private void find_by_c_s_a()
        {
            ...
            {
                bind_grd_view("select ar.studentname,ar.admissionserialnumber,ar.class,ar.Section,ar.rollnumber,arc.Old_admission_no,format(arc.Date_time, 'dd/MM/yyyy') as date1,(Select top 1 Course_Name from Add_course_table where course_id=arc.Old_Class_id) as Course_Nameold,arc.Roll_no_old,arc.Old_Section_name,arc.Session_id,arc.Slip_no     from admission_registor ar join  admission_registor_Change_admission_no_history arc on arc.Current_admission_no=ar.admissionserialnumber and  arc.Session_id=ar.Session_id where (ar.Transfer_Status='New' or ar.Transfer_Status='NT' or ar.Transfer_Status='Transferred') and ar.Status='1'   and ar.Session_id='" + ddlsession.SelectedValue + "' and   Class_id='" + ddlclass.SelectedValue + "' and   Section='" + ddl_section.Text + "'  and arc.Change_type='Class Name Change' order by ar.rollnumber asc");
        ...
        protected void btn_fnd_by_admission_no_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                bind_grd_view("select ar.studentname,ar.admissionserialnumber,ar.class,ar.Section,ar.rollnumber,arc.Old_admission_no,format(arc.Date_time, 'dd/MM/yyyy') as date1,(Select top 1 Course_Name from Add_course_table where course_id=arc.Old_Class_id) as Course_Nameold,arc.Roll_no_old,arc.Old_Section_name,arc.Session_id,arc.Slip_no      from admission_registor ar join  admission_registor_Change_admission_no_history arc on arc.Current_admission_no=ar.admissionserialnumber and  arc.Session_id=ar.Session_id where (ar.Transfer_Status='New' or ar.Transfer_Status='NT' or ar.Transfer_Status='Transferred')   and ar.Session_id='" + sessioid + "'  and    ar.admissionserialnumber='" + txt_admission_no.Text + "' and ar.Status='1'  and arc.Change_type='Class Name Change' order by ar.rollnumber asc");
            }
        }
        ...
        protected void LinkButton1_Click(object sender, EventArgs e)
        {
            ...
            string path = "slip/Print_Change_Class_Payment.aspx?admissionno=" + lbl_currentadmission_no.Text + "&Slip_no=" + lbl_Slip_no.Text + "&sessionid=" + lbl_Session_id.Text;
