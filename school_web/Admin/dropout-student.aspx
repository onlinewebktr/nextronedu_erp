<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="dropout-student.aspx.cs" Inherits="school_web.Admin.dropout_student" %>
        ...
        <div class="page-content">
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Dropout Student’s List</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-12"> 
                    <div class="card">
                        <div class="card-body">
                            <asp:Label ID="ltUsertop" runat="server" Style="font-weight: 500; font-size: 1rem;" class="mb-0 text-uppercase" Text="Dropout Student’s List"></asp:Label>
                            <hr />
                                                                                    ...
                                                                                    <td style="text-align: left;">
                                                                                        <div class="user-box dropdown" style="float: left; display: inherit; height: auto; border-left: 0px solid #f0f0f0; margin-left: 0px;">
                                                                                            ...
                                                                                            <ul class="dropdown-menu dropdown-menu-end">
                                                                                                <li>
                                                                                                    <a class="dropdown-item" href="slip/Student_Payment_History.aspx?admNo=<%#Eval("admissionserialnumber") %>&Session=<%#Eval("Session_id") %>&class=<%#Eval("Class_id") %>" target="_blank"><i class='bx bx-printer'></i><span>View Payment History</span></a>
                                                                                                </li>
                                                                                            </ul>
                                                                                        </div>
