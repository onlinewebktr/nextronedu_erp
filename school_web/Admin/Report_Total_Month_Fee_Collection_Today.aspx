<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="Report_Total_Month_Fee_Collection_Today.aspx.cs" Inherits="school_web.Admin.Report_Total_Month_Fee_Collection_Today" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">   Monthly Fee Collection Today Report
</asp:Content>
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Monthly Fee Collection Today Report</li>
                        </ol>
                    </nav>
                </div>
            </div>
