<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="Subject_maped_list_with_Teacher.aspx.cs" Inherits="school_web.Admin.Subject_maped_list_with_Teacher" EnableEventValidation="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
     Mapped Subject List with Teacher
</asp:Content>
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Mapped Subject List with Teacher</li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                                            ...
                                            <div class="find-dv">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-2">
                                                        ...
                                                        <asp:DropDownList ID="ddl_section_serch" runat="server" CssClass="form-control find-dv-txtbx">
                                                        </asp:DropDownList>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-2">
                                                        ...
                                                        <asp:DropDownList ID="ddl_teacher" runat="server" class="form-control find-dv-txtbx">
                                                        </asp:DropDownList>
                                                    </div>
                                                    <div class="col-sm-1">
                            ...
                            <asp:Label ID="lbl_website" runat="server"></asp:Label>
                                                                ...
                                                                <div style="margin: 7px 0px 0px 0px; padding: 0px; float: left; height: auto; text-align: center; vertical-align: middle; font-size: 13px; width: 100%;">
                                                                    <span style="font-size: 14px; font-weight: bold;">Subject Maped List With The Teacher -<asp:Label ID="lbl_class22" runat="server"></asp:Label></span>
