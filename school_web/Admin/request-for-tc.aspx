<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="request-for-tc.aspx.cs" Inherits="school_web.Admin.request_for_tc" EnableEventValidation="false" %>
    ...
    <div class="page-wrapper">
        <div class="page-content">
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"> Request for TC</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row" data-ng-app="ComplainApp" data-ng-controller="ComplainAppCtrl">
                <div class="col-xl-12">
                    <h6 class="mb-0 text-uppercase"> Request for TC</h6>
                    <hr />
                    <div class="card">
                        <div class="card-body">
                            ...
                            <asp:Label ID="lbl_website" runat="server"></asp:Label>
                                                                ...
                                                                <div style="margin: 7px 0px 0px 0px; padding: 0px; float: left; height: auto; text-align: center; vertical-align: middle; font-size: 13px; width: 100%;">
                                                                    <span style="font-size: 14px; font-weight: bold;"> Request for TC
                                                        ...
                                                        <ItemTemplate>
                                                            <tr>
                                                                ...
                                                                <td style="text-align: left;">
                                                                    ...
                                                                    <asp:LinkButton ID="lnk_process" Style="background-color: #e14eca; color: #fff; padding: 2px 5px 2px 5px; width: auto; border-radius: 2px; font-weight: 500; display: inherit;" runat="server" OnClick="lnk_process_Click" CssClass="btnfindaa btnfindaa2a">Process</asp:LinkButton>
                                                                </td>
                                                            </tr>
                                                        </ItemTemplate>
                                                    </asp:Repeater>
