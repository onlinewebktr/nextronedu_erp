<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="Upload_Admission_Or_Annual_Fee_Using_CSV.aspx.cs" Inherits="school_web.Admin.Upload_Admission_Or_Annual_Fee_Using_CSV" EnableEventValidation="false" ValidateRequest="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Upload Bulk Admission Fee or Annual Fee taken Using CSV File
</asp:Content>
        ...
        <div class="page-content">
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Upload Bulk Admission/Annual Fee Fee taken Using CSV File</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="p-4 border rounded">
                                        <div class="row g-3 needs-validation" novalidate="">
                                            <div class="col-sm-12">
                                                <label for="validationCustom01" class="find-dv-lbl">Download With Fee</label>
                                        ...
                                        <div class="row g-3 needs-validation" novalidate="">
                                            <div class="col-md-12" id="exclempty" style="display: none">
                                                <a href="doc/Admission-annual-fee-format.csv" download="" class="btnbtn btn-1 btn-sep icon-cart">Download Excel Format</a>
                                            </div>
                ...
                <asp:Panel ID="pnl_grid" runat="server" Visible="false">
                    <div class="col-xl-12">
                        <h6 class="mb-0 text-uppercase">Uploaded Admission/Annual Fee</h6>
                        <hr />
                        <div class="card">
                            <div class="card-body">
