...
{
    public partial class fees_collection : System.Web.UI.Page
    {
        My mycode = new My();
        ...
        private void find_details(string query)
        {
            ...
            else
            {
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    if (ViewState["Transfer_Status"].ToString() == "New")
                    {
                        ...
                        if (ViewState["Hostel_id"].ToString() == "0")
                        {
                            ...
                            qryCheckDisc = "select 'Admission' as Type, isnull(sum(convert(float, disc_amount)),'0') as Total_disc from(select isnull((isnull((select top 1 disc_amount from dbo.[Discount_Master] where admission_no = '" + dr["admissionserialnumber"].ToString() + "'  and (parameter_id = '1' or parameter_id = '5') and session = '" + dr["session"].ToString() + "' and fee_head_id = Typewise_fee_collection.content_id and Discount_on = 'Admission'), (select top 1 disc_amount from dbo.[Discount_Master] where Class_id = '" + dr["Class_id"].ToString() + "' and admission_no = 'All'  and(parameter_id = '1' or parameter_id = '5') and session = '" + dr["session"].ToString() + "' and fee_head_id = Typewise_fee_collection.content_id and Discount_on = 'Admission' and category_id = '" + dr["category_id"].ToString() + "' and sub_category_id = '" + dr["SubCategory_id"].ToString() + "'))),0) disc_amount from dbo.[Typewise_fee_collection] WHERE admission_no = '" + dr["admissionserialnumber"].ToString() + "' and (parameter = 'AdmissionFee' ) and session = '" + dr["session"].ToString() + "' and class_id=" + dr["Class_id"].ToString() + ")t";
                        }
                        else
                        {//Check In Admission yes hostel
                            qryCheckDisc = "select 'Admission' as Type, isnull(sum(convert(float, disc_amount)),'0') as Total_disc from(select isnull((isnull((select top 1 disc_amount from dbo.[Discount_Master] where Hostel_id=" + ViewState["Hostel_id"].ToString() + " and admission_no = '" + dr["admissionserialnumber"].ToString() + "'  and (parameter_id = '1' or parameter_id = '5') and session = '" + dr["session"].ToString() + "' and fee_head_id = Typewise_fee_collection.content_id and Discount_on = 'Admission'), (select top 1 disc_amount from dbo.[Discount_Master] where Hostel_Id=" + ViewState["Hostel_id"].ToString() + " and Class_id = '" + dr["Class_id"].ToString() + "' and admission_no = 'All'  and(parameter_id = '1' or parameter_id = '5') and session = '" + dr["session"].ToString() + "' and fee_head_id = Typewise_fee_collection.content_id and Discount_on = 'Admission' and category_id = '" + dr["category_id"].ToString() + "' and sub_category_id = '" + dr["SubCategory_id"].ToString() + "'))),0) disc_amount from dbo.[Typewise_fee_collection] WHERE admission_no = '" + dr["admissionserialnumber"].ToString() + "' and (parameter = 'AdmissionFee') and session = '" + dr["session"].ToString() + "' and class_id=" + dr["Class_id"].ToString() + ")t";
                        }
                        ...
                        if (adm_check_disc.Rows.Count == 0)
                        {
                            if (ViewState["Hostel_id"].ToString() == "0")
                            {
                                qryCheckDisc = "select 'Admission' as Type, isnull(sum(convert(float, disc_amount)),'0') as Total_disc from(select isnull((isnull((select top 1 disc_amount from dbo.[Discount_Master] where admission_no = '" + dr["admissionserialnumber"].ToString() + "'  and(parameter_id = '1' or parameter_id = '5') and session = '" + dr["session"].ToString() + "' and fee_head_id = cm.content_id and Discount_on = 'Admission'), (select top 1 disc_amount from dbo.[Discount_Master] where Class_id = '" + dr["Class_id"].ToString() + "' and admission_no = 'All'  and(parameter_id = '1' or parameter_id = '5') and session = '" + dr["session"].ToString() + "' and fee_head_id = cm.content_id and Discount_on = 'Admission' and category_id = '" + dr["category_id"].ToString() + "' and sub_category_id = '" + dr["SubCategory_id"].ToString() + "'))),0) disc_amount from dbo.[Fee_master_content_wise] fmc join Content_master cm on fmc.content_id = cm.content_id where and (parameter = 'AdmissionFee' )  and session = '" + dr["session"].ToString() + "' and class_id = '" + dr["Class_id"].ToString() + "' and class_id=" + dr["Class_id"].ToString() + ") t";
                            }
                            else
                            {
                                qryCheckDisc = "select 'Admission' as Type, isnull(sum(convert(float, disc_amount)),'0') as Total_disc from(select isnull((isnull((select top 1 disc_amount from dbo.[Discount_Master] where Hostel_Id=" + ViewState["Hostel_id"].ToString() + " and admission_no = '" + dr["admissionserialnumber"].ToString() + "'  and(parameter_id = '1' or parameter_id = '5') and session = '" + dr["session"].ToString() + "' and fee_head_id = cm.content_id and Discount_on = 'Admission'), (select top 1 disc_amount from dbo.[Discount_Master] where Hostel_Id=" + ViewState["Hostel_id"].ToString() + " and Class_id = '" + dr["Class_id"].ToString() + "' and admission_no = 'All'  and(parameter_id = '1' or parameter_id = '5') and session = '" + dr["session"].ToString() + "' and fee_head_id = cm.content_id and Discount_on = 'Admission' and category_id = '" + dr["category_id"].ToString() + "' and sub_category_id = '" + dr["SubCategory_id"].ToString() + "'))),0) disc_amount from dbo.[Fee_master_content_wise] fmc join Content_master cm on fmc.content_id = cm.content_id whereand (parameter = 'AdmissionFee' )  and session = '" + dr["session"].ToString() + "' and class_id = '" + dr["Class_id"].ToString() + "' and fmc.Hostel_Id=" + ViewState["Hostel_id"].ToString() + ") t";
                            }
                    ...
                    else
                    {
                        ...
                        if (ViewState["Hostel_id"].ToString() == "0")
                        {
                            ...
                            qryCheckDiscAnn = "select 'Annual' as Type,isnull(sum(convert(float, disc_amount)),'0') as Total_disc from(select isnull((isnull((select top 1 disc_amount from dbo.[Discount_Master] where admission_no='" + dr["admissionserialnumber"].ToString() + "'  and (parameter_id='2' or parameter_id='6') and session='" + dr["session"].ToString() + "' and fee_head_id=Typewise_fee_collection.content_id and Discount_on='Annual'),(select top 1 disc_amount from dbo.[Discount_Master] where Class_id='" + dr["Class_id"].ToString() + "' and admission_no='All'  and (parameter_id='2' or parameter_id='6') and session='" + dr["session"].ToString() + "' and fee_head_id=Typewise_fee_collection.content_id and Discount_on='Annual' and category_id='" + dr["category_id"].ToString() + "' and sub_category_id='" + dr["SubCategory_id"].ToString() + "'))),0) disc_amount from dbo.[Typewise_fee_collection] WHERE admission_no='" + dr["admissionserialnumber"].ToString() + "' and ( parameter='AnnualFee') and session='" + dr["session"].ToString() + "' and class_id=" + dr["Class_id"].ToString() + ")t";
                        }
                        else
                        { //Check In Annual  yes hostel
                            qryCheckDiscAnn = "select 'Annual' as Type,isnull(sum(convert(float, disc_amount)),'0') as Total_disc from(select isnull((isnull((select top 1 disc_amount from dbo.[Discount_Master] where Hostel_id=" + ViewState["Hostel_id"].ToString() + " and admission_no='" + dr["admissionserialnumber"].ToString() + "'  and (parameter_id='2' or parameter_id='6') and session='" + dr["session"].ToString() + "' and fee_head_id=Typewise_fee_collection.content_id and Discount_on='Annual'),(select top 1 disc_amount from dbo.[Discount_Master] where Hostel_id=" + ViewState["Hostel_id"].ToString() + " and Class_id='" + dr["Class_id"].ToString() + "' and admission_no='All'  and (parameter_id='2' or parameter_id='6') and session='" + dr["session"].ToString() + "' and fee_head_id=Typewise_fee_collection.content_id and Discount_on='Annual' and category_id='" + dr["category_id"].ToString() + "' and sub_category_id='" + dr["SubCategory_id"].ToString() + "'))),0) disc_amount from dbo.[Typewise_fee_collection] WHERE admission_no='" + dr["admissionserialnumber"].ToString() + "' and (parameter='HostelAnnualFee') and session='" + dr["session"].ToString() + "' and class_id=" + dr["Class_id"].ToString() + " )t";
                        }
                        ...
                        if (ann_check_disc.Rows.Count == 0)
                        {
                            if (ViewState["Hostel_id"].ToString() == "0")
                            {
                                qryCheckDiscAnn = "select 'Annual' as Type,isnull(sum(convert(float, disc_amount)),'0') as Total_disc from(select isnull((isnull((select top 1 disc_amount from dbo.[Discount_Master] where admission_no='" + dr["admissionserialnumber"].ToString() + "'  and (parameter_id='2' or parameter_id='6') and session='" + dr["session"].ToString() + "' and fee_head_id=cm.content_id and Discount_on='Annual'),(select top 1 disc_amount from dbo.[Discount_Master] where Class_id='" + dr["Class_id"].ToString() + "' and admission_no='All'  and (parameter_id='2' or parameter_id='6') and session='" + dr["session"].ToString() + "' and fee_head_id=cm.content_id and Discount_on='Annual' and category_id='" + dr["category_id"].ToString() + "' and sub_category_id='" + dr["SubCategory_id"].ToString() + "'))),0) disc_amount from dbo.[Fee_master_content_wise] fmc join Content_master cm on fmc.content_id=cm.content_id where and( parameter = 'AnnualFee') and session='" + dr["session"].ToString() + "' and class_id='" + dr["Class_id"].ToString() + "')t";
                            }
                            else
                            {
                                qryCheckDiscAnn = "select 'Annual' as Type,isnull(sum(convert(float, disc_amount)),'0') as Total_disc from(select isnull((isnull((select top 1 disc_amount from dbo.[Discount_Master] where Hostel_id=" + ViewState["Hostel_id"].ToString() + " and admission_no='" + dr["admissionserialnumber"].ToString() + "'  and (parameter_id='2' or parameter_id='6') and session='" + dr["session"].ToString() + "' and fee_head_id=cm.content_id and Discount_on='Annual'),(select top 1 disc_amount from dbo.[Discount_Master] where Hostel_Id=" + ViewState["Hostel_id"].ToString() + " and Class_id='" + dr["Class_id"].ToString() + "' and admission_no='All'  and (parameter_id='2' or parameter_id='6') and session='" + dr["session"].ToString() + "' and fee_head_id=cm.content_id and Discount_on='Annual' and category_id='" + dr["category_id"].ToString() + "' and sub_category_id='" + dr["SubCategory_id"].ToString() + "'))),0) disc_amount from dbo.[Fee_master_content_wise] fmc join Content_master cm on fmc.content_id=cm.content_id where and(parameter = 'HostelAnnualFee') and session='" + dr["session"].ToString() + "' and class_id='" + dr["Class_id"].ToString() + "' and fmc.Hostel_Id=" + ViewState["Hostel_id"].ToString() + ")t";
                            }
                    ...
                    if (ViewState["Hostel_id"].ToString() == "0")
                    {
                        qryCheckDiscMnthlY = "select isnull(sum(convert(float, disc_amount)),'0') as Total_disc from Discount_Master where session='" + dr["session"].ToString() + "' and Class_id='" + dr["Class_id"].ToString() + "' and admission_no='" + dr["admissionserialnumber"].ToString() + "' and Discount_on='Monthly'";
                    }
                    else
                    {
                        qryCheckDiscMnthlY = "select isnull(sum(convert(float, disc_amount)),'0') as Total_disc from Discount_Master where session='" + dr["session"].ToString() + "' and Class_id='" + dr["Class_id"].ToString() + "' and admission_no='" + dr["admissionserialnumber"].ToString() + "' and Hostel_Id=" + ViewState["Hostel_id"].ToString() + " and Room_Category_id='" + ViewState["Room_Category_id"].ToString() + "' and Discount_on='Monthly'";
                    }
                    ...
                    if (mnthly_check_disc.Rows.Count == 0)
                    {
                        if (ViewState["Hostel_id"].ToString() == "0")
                        {
                            qryCheckDiscMnthlY = "select isnull(sum(convert(float, disc_amount)),'0') as Total_disc from Discount_Master where session='" + dr["session"].ToString() + "' and Class_id='" + dr["Class_id"].ToString() + "' and Discount_on='Monthly'";
                        }
                        else
                        {
                            qryCheckDiscMnthlY = "select isnull(sum(convert(float, disc_amount)),'0') as Total_disc from Discount_Master where session='" + dr["session"].ToString() + "' and Class_id='" + dr["Class_id"].ToString() + "' and Hostel_Id=" + ViewState["Hostel_id"].ToString() + " and Room_Category_id='" + ViewState["Room_Category_id"].ToString() + "' and Discount_on='Monthly'";
                        }
                ...
                find_all_due_fee();
                fetch_ledger();
                Bind_month_name_split(); for_discount(ddlsession.SelectedItem.Text, ddlsession.SelectedValue, ddlclass.SelectedValue, txt_admission_no.Text, lblhostel.Text, lbltransporttion.Text, ViewState["Hostel_id"].ToString(), ViewState["Room_Category_id"].ToString(), ViewState["TransportPath_id"].ToString(), ViewState["Boarding_Point_id"].ToString());
                ...
                string total_dues_for_month = monthlyDues.get_month_fee_dues_till_months(ddlsession.SelectedValue, ddlclass.SelectedValue, txt_admission_no.Text);
                lbl_monthly_dues_till_now.Text = "Monthly Fee Dues : " + total_dues_for_month;
                double total_amts = (My.toDouble(total_dues_for_month) + My.toDouble(ViewState["Admission_Annual_Amount"].ToString()));
        ...
        private void section_roll_auto_assign()
        {
            ...
            if (dt.Rows.Count == 0)
            {
                AssignRollDV.Visible = true; string sectionS = "A";
        ...
        private void find_admission_dues_fee()
        {
            ...
            else
            {
                ...
                btn_admission_fees.InnerText = "Admission Fees : " + payble_after_disc.ToString("0.00");
        ...
        private void find_annual_dues_fee()
        {
            ...
            if (ViewState["Hostel_id"].ToString() == "0")
            {
                ...
                qry = "select *,(payable-cast(disc_amount as float)-cast(paid as float)) net_payable from(select '0' payable_after_disc,session,feetype,cast(payable as float) payable,paid,dues,status,content_id, isnull((isnull((select top 1 disc_amount from dbo.[Discount_Master] where admission_no='" + txt_admission_no.Text + "'  and (parameter_id='" + parameter_id + "' or parameter_id='" + parameter_id2 + "') and session='" + ddlsessionad.SelectedItem.Text + "' and fee_head_id=Typewise_fee_collection.content_id and Discount_on='Annual'),(select top 1 disc_amount from dbo.[Discount_Master] where Class_id='" + ViewState["classid"].ToString() + "' and admission_no='All'  and (parameter_id='" + parameter_id + "' or parameter_id='" + parameter_id2 + "') and session='" + ddlsessionad.SelectedItem.Text + "' and fee_head_id=Typewise_fee_collection.content_id and Discount_on='Annual' and category_id='" + ViewState["category_id"].ToString() + "' and sub_category_id='" + ViewState["sub_category_id"].ToString() + "'))),0) disc_amount from dbo.[Typewise_fee_collection] WHERE admission_no='" + txt_admission_no.Text + "' and (parameter='" + parameter + "')  and session='" + ddlsessionad.SelectedItem.Text + "' and class_id=" + ViewState["classid"].ToString() + ")t";

            }
            else
            {
                parameter = "HostelAnnualFee";
                qry = "select *,(payable-cast(disc_amount as float)-cast(paid as float)) net_payable from(select '0' payable_after_disc,session,feetype,cast(payable as float) payable,paid,dues,status,content_id, isnull((isnull((select top 1 disc_amount from dbo.[Discount_Master] where Hostel_id=" + ViewState["Hostel_id"].ToString() + " and admission_no='" + txt_admission_no.Text + "'  and (parameter_id='" + parameter_id + "' or parameter_id='" + parameter_id2 + "') and session='" + ddlsessionad.SelectedItem.Text + "' and fee_head_id=Typewise_fee_collection.content_id and Discount_on='Annual'),(select top 1 disc_amount from dbo.[Discount_Master] where Hostel_id=" + ViewState["Hostel_id"].ToString() + " and Class_id='" + ViewState["classid"].ToString() + "' and admission_no='All'  and (parameter_id='" + parameter_id + "' or parameter_id='" + parameter_id2 + "') and session='" + ddlsessionad.SelectedItem.Text + "' and fee_head_id=Typewise_fee_collection.content_id and Discount_on='Annual' and category_id='" + ViewState["category_id"].ToString() + "' and sub_category_id='" + ViewState["sub_category_id"].ToString() + "'))),0) disc_amount from dbo.[Typewise_fee_collection] WHERE admission_no='" + txt_admission_no.Text + "' and (parameter='" + parameter + "' )  and session='" + ddlsessionad.SelectedItem.Text + "' and class_id=" + ViewState["classid"].ToString() + ")t";
            ...
            if (fee_dt.Rows.Count == 0)
            {
                if (ViewState["Hostel_id"].ToString() == "0")
                {
                    qry = "select '0' as payable_after_disc, session as Session,Perticular as feetype,Amount as payable,  '0' as paid, Amount as dues,'Dues' as status,'ANN01' as content_id,'0' as disc_amount,Amount as net_payable from Misc_Fee_Master_Studentwise where (Type_Mode='AdmissionFee' or Type_Mode='AnnualFee') and session='" + ddlsessionad.SelectedItem.Text + "' and Admission_No='" + txt_admission_no.Text + "' UNION ALL select *,(payable-cast(disc_amount as float)) net_payable from(select '0' payable_after_disc,fmc.session,cm.content feetype,cast(fmc.amount as float) payable,'0' paid,fmc.amount dues,'Dues' status,cm.content_id, isnull((isnull((select top 1 disc_amount from dbo.[Discount_Master] where admission_no='" + txt_admission_no.Text + "'  and (parameter_id='" + parameter_id + "' or parameter_id='" + parameter_id2 + "') and session='" + ddlsessionad.SelectedItem.Text + "' and fee_head_id=cm.content_id and Discount_on='Annual'),(select top 1 disc_amount from dbo.[Discount_Master] where Class_id='" + ViewState["classid"].ToString() + "' and admission_no='All'  and (parameter_id='" + parameter_id + "' or parameter_id='" + parameter_id2 + "') and session='" + ddlsessionad.SelectedItem.Text + "' and fee_head_id=cm.content_id and Discount_on='Annual' and category_id='" + ViewState["category_id"].ToString() + "' and sub_category_id='" + ViewState["sub_category_id"].ToString() + "'))),0) disc_amount   from dbo.[Fee_master_content_wise] fmc join Content_master cm on fmc.content_id=cm.content_id where (parameter='" + parameter + "' )  and session='" + ddlsessionad.SelectedItem.Text + "' and class_id='" + ViewState["classid"].ToString() + "') t";
                }
                else
                {
                    qry = "select '0' as payable_after_disc, session as Session,Perticular as feetype,Amount as payable,  '0' as paid, Amount as dues,'Dues' as status,'ANN01' as content_id,'0' as disc_amount,Amount as net_payable from Misc_Fee_Master_Studentwise where (Type_Mode='AdmissionFee' or Type_Mode='AnnualFee') and session='" + ddlsessionad.SelectedItem.Text + "' and Admission_No='" + txt_admission_no.Text + "' UNION ALL select *,(payable-cast(disc_amount as float)) net_payable from(select '0' payable_after_disc,fmc.session,cm.content feetype,cast(fmc.amount as float) payable,'0' paid,fmc.amount dues,'Dues' status,cm.content_id, isnull((isnull((select top 1 disc_amount from dbo.[Discount_Master] where Hostel_id=" + ViewState["Hostel_id"].ToString() + " and admission_no='" + txt_admission_no.Text + "'  and (parameter_id='" + parameter_id + "' or parameter_id='" + parameter_id2 + "') and session='" + ddlsessionad.SelectedItem.Text + "' and fee_head_id=cm.content_id and Discount_on='Annual'),(select top 1 disc_amount from dbo.[Discount_Master] where Hostel_id=" + ViewState["Hostel_id"].ToString() + " and Class_id='" + ViewState["classid"].ToString() + "' and admission_no='All'  and (parameter_id='" + parameter_id + "' or parameter_id='" + parameter_id2 + "') and session='" + ddlsessionad.SelectedItem.Text + "' and fee_head_id=cm.content_id and Discount_on='Annual' and category_id='" + ViewState["category_id"].ToString() + "' and sub_category_id='" + ViewState["sub_category_id"].ToString() + "'))),0) disc_amount   from dbo.[Fee_master_content_wise] fmc join Content_master cm on fmc.content_id=cm.content_id where (parameter='" + parameter + "' )  and session='" + ddlsessionad.SelectedItem.Text + "' and class_id='" + ViewState["classid"].ToString() + "' and  fmc.Hostel_Id='" + ViewState["Hostel_id"].ToString() + "') t";
                }
                fee_dt = My.dataTable(qry);
            }
            ...
            else
            {
                ...
                btn_admission_fees.InnerText = "Annual Fees : " + totalpay.ToString("0.00");
                                ...
                                if (ViewState["Transfer_Status"].ToString() == "New")
                                {
                                    if (chk_delete_slip.Checked == true)
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            string checkDupbill = payments.check_manual_dup_bill_no(slip_no, con);
                                            if (checkDupbill == "1")
                                            {
                    ...
                    if (flag == true)
                    {
                        if (iS_any_payment_done == "1")
                        {
                            ...
                            if (chk_collect_adm_ann_fee.Checked == true)
                            {
                                try
                                {
                                    string notice_type = "4"; string notice_type_name = "Fee Deposite";
                                    My.send_success_notice_fee(lbl_name.Text, lblclass.Text, txt_section.Text, txtrollnumber.Text, lbl_admission_no.Text, txt_paid_amount.Text, notice_type, notice_type_name, ViewState["sessionIDs"].ToString());
                                }
                                catch (Exception ex)
                                {
                                }
                            ...
                            else
                            {
                                try
                                {
                                    string notice_type = "4"; string notice_type_name = "Monthly Fee Deposite";
                                    My.send_success_notice_fee(lbl_name.Text, lblclass.Text, txt_section.Text, txtrollnumber.Text, lbl_admission_no.Text, monthlYPaid.ToString(), notice_type, notice_type_name, ViewState["sessionIDs"].ToString());
                                }
                                catch (Exception ex)
                                {
                                }
                                string message = "";
                                // "Dear " + lbl_name.Text + " you have paid monthly fee :- " + monthlYPaid.ToString() + " date :- " + txt_payment_date.Text + " slip no.:-" + slip_no;
                                ...
                                try
                                {
                                    string sub = "Monthly Fee Deposite";
                            ...
                            else
                            {
                                ...
                                {
                                    Response.Redirect("fees-collection.aspx?adm=" + lbl_admission_no.Text, false);
        ...
        private void send_message(string admission_no, string session_id, string msgs)
        {
            ...
            cmd.Parameters.AddWithValue("@Notice_type", "Monthly Fee Deposite");
            ...
            if (tdt.Rows.Count > 0)
            {
                ...
                foreach (DataRow dr in tdt.Rows)
                {
                    ...
                    else
                    {
                        ...
                        #region send in collection slip
                        send_data_in_fee_collection_slip(dr["payable"].ToString(), "0.00", dr["parameter"], dr["feetype"], dr["content_id"], slip_no, entry_id, dr["Ledger"], adno, session, class_id, sction, dr["Disc"].ToString(), dr["month"], dr["position"], prevpaid, con);
                        #endregion
        ...
        protected void btn_find_name_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else if (dt.Rows.Count == 1)
                {
                    if (ViewState["Isadmissionfeetekent"].ToString() == "1")// admission fee not mindtree
                    {
                        query = "select * from admission_registor where admissionserialnumber='" + dt.Rows[0]["admissionserialnumber"].ToString() + "' and Session='" + ddl_session_student.SelectedItem.Text + "' and StudentStatus='AV'   and Is_TC_Taken!='true' order by id asc";
                    }
                    else
                    {
                        query = "select * from admission_registor where admissionserialnumber='" + dt.Rows[0]["admissionserialnumber"].ToString() + "' and Session='" + ddl_session_student.SelectedItem.Text + "' and StudentStatus='AV'  and payment_status!='Unpaid' and Is_TC_Taken!='true' order by id asc";
                    }
                    find_details(query);
                }
                else
        ...
        private void Bind_fee_details()
        {
            ...
            string qry = "select *,(payable-cast(disc_amount as float)-cast(paid as float)) net_payable from(select '0' payable_after_disc,session,feetype,cast(payable as float) payable,paid,dues,status,content_id, Disc disc_amount from dbo.[Typewise_fee_collection] WHERE admission_no='" + lbl_admissionno.Text + "' and parameter='" + parameter + "' and session='" + lbl_session.Text + "')t";
            DataTable fee_dt = My.dataTable(qry);
            if (fee_dt.Rows.Count == 0)
            {
                if (ViewState["Hostel_id"].ToString() == "0")
                {
                    qry = "select '0' as payable_after_disc, session as Session,Perticular as feetype,Amount as payable,  '0' as paid, Amount as dues,'Dues' as status,'ADM01' as content_id,'0' as disc_amount,Amount as net_payable from Misc_Fee_Master_Studentwise where (Type_Mode='AdmissionFee' or Type_Mode='AnnualFee') and session='" + lbl_session.Text + "' and Admission_No='" + lbl_admissionno.Text + "' UNION ALL select *,(payable-cast(disc_amount as float)) net_payable from(select '0' payable_after_disc,fmc.session,cm.content feetype,cast(fmc.amount as float) payable,'0' paid,fmc.amount dues,'Dues' status,cm.content_id, isnull((isnull((select top 1 disc_amount from dbo.[Discount_Master] where admission_no='" + lbl_admissionno.Text + "'  and parameter_id='" + parameter_id + "' and session='" + lbl_session.Text + "' and fee_head_id=cm.content_id and Discount_on='" + discountOn + "'),(select top 1 disc_amount from dbo.[Discount_Master] where  Class_id='" + ViewState["classid"].ToString() + "' and admission_no='All'  and parameter_id='" + parameter_id + "' and session='" + lbl_session.Text + "' and fee_head_id=cm.content_id and Discount_on='" + discountOn + "' and category_id='" + ViewState["category_id"].ToString() + "' and sub_category_id='" + ViewState["SubCategory_id"].ToString() + "'))),0) disc_amount   from dbo.[Fee_master_content_wise] fmc join Content_master cm on fmc.content_id=cm.content_id where parameter='" + parameter + "'  and session='" + lbl_session.Text + "' and class_id='" + ViewState["classid"].ToString() + "' ) t";
                }
                else
                {
                    qry = "select '0' as payable_after_disc, session as Session,Perticular as feetype,Amount as payable,  '0' as paid, Amount as dues,'Dues' as status,'ADM01' as content_id,'0' as disc_amount,Amount as net_payable from Misc_Fee_Master_Studentwise where (Type_Mode='AdmissionFee' or Type_Mode='AnnualFee') and session='" + lbl_session.Text + "' and Admission_No='" + lbl_admissionno.Text + "' UNION ALL select *,(payable-cast(disc_amount as float)) net_payable from(select '0' payable_after_disc,fmc.session,cm.content feetype,cast(fmc.amount as float) payable,'0' paid,fmc.amount dues,'Dues' status,cm.content_id, isnull((isnull((select top 1 disc_amount from dbo.[Discount_Master] where Hostel_Id=" + ViewState["Hostel_id"].ToString() + " and admission_no='" + lbl_admissionno.Text + "'  and parameter_id='" + parameter_id + "' and session='" + lbl_session.Text + "' and fee_head_id=cm.content_id and Discount_on='" + discountOn + "'),(select top 1 disc_amount from dbo.[Discount_Master] where Hostel_Id=" + ViewState["Hostel_id"].ToString() + " and Class_id='" + ViewState["classid"].ToString() + "' and admission_no='All'  and parameter_id='" + parameter_id + "' and session='" + lbl_session.Text + "' and fee_head_id=cm.content_id and Discount_on='" + discountOn + "' and category_id='" + ViewState["category_id"].ToString() + "' and sub_category_id='" + ViewState["SubCategory_id"].ToString() + "'))),0) disc_amount   from dbo.[Fee_master_content_wise] fmc join Content_master cm on fmc.content_id=cm.content_id where parameter='" + parameter + "'  and session='" + lbl_session.Text + "' and class_id='" + ViewState["classid"].ToString() + "' and fmc.Hostel_Id='" + ViewState["Hostel_id"].ToString() + "') t";
                }
                fee_dt = My.dataTable(qry);
            }
                    ...
                    if (My.toDouble(lbl_totaldues.Text) >= 0)
                    {
                        ...
                        if (flag == true)
                        {
                            ...
                            if (My.toDouble(txt_paid_amount_adm.Text) > 0)
                            {
                                try
                                {
                                    string notice_type = "2"; string notice_type_name = "Admission Fee Deposite";
                                    My.send_success_notice_fee(lbl_studentname.Text, lbl_class.Text, ViewState["Section"].ToString(), ViewState["rollnumber"].ToString(), lbl_admissionno.Text, txt_paid_amount_adm.Text, notice_type, notice_type_name, ViewState["sessionid"].ToString());
                                }
                                catch (Exception ex)
                                {
                                }
        ...
        {
            string Uid = slip_no;
            string Tag = txt_paid_amount_adm.Text;
            string parameter = "";
            if (type == "Admission")
            {
                parameter = ViewState["hostaltaken"].ToString().ToUpper() == "NO" ? "AdmissionFee" : "HostelAdmissionFee";
            ...
            send_data_in_student_payment_history_adm_popup(type, slip_no, entry_id, ad_no, parameter, con);
            ...
            try
            {
                send_data_to_split_month(slip_no, type + " Fee", con);
            }
            catch (Exception ex)
            {
            }
        ...
        private void make_admission_fee(SqlConnection con, double PaidAmt, string slip_no, string Full_paid_amt, string feeTypes)
        {
            ...
            if (fee_dt.Rows.Count == 0)
            {
                if (ViewState["Hostel_id"].ToString() == "0")
                {
                    qry = "select '0' as payable_after_disc, session as Session,Perticular as feetype,Amount as payable,  '0' as paid, Amount as dues,'Dues' as status,'ADM01' as content_id,'0' as disc_amount,Amount as net_payable from Misc_Fee_Master_Studentwise where (Type_Mode='AdmissionFee' or Type_Mode='AnnualFee') and session='" + lbl_session.Text + "' and Admission_No='" + lbl_admissionno.Text + "' UNION ALL select *,(payable-cast(disc_amount as float)) net_payable from(select '0' payable_after_disc,fmc.session,cm.content feetype,cast(fmc.amount as float) payable,'0' paid,fmc.amount dues,'Dues' status,cm.content_id, isnull((isnull((select top 1 disc_amount from dbo.[Discount_Master] where admission_no='" + lbl_admissionno.Text + "'  and parameter_id='" + parameter_id + "' and session='" + lbl_session.Text + "' and fee_head_id=cm.content_id and Discount_on='Admission'),(select top 1 disc_amount from dbo.[Discount_Master] where  Class_id='" + ViewState["classid"].ToString() + "' and admission_no='All'  and parameter_id='" + parameter_id + "' and session='" + lbl_session.Text + "' and fee_head_id=cm.content_id and Discount_on='Admission' and category_id='" + ViewState["category_id"].ToString() + "' and sub_category_id='" + ViewState["SubCategory_id"].ToString() + "'))),0) disc_amount   from dbo.[Fee_master_content_wise] fmc join Content_master cm on fmc.content_id=cm.content_id where parameter='" + parameter + "'  and session='" + lbl_session.Text + "' and class_id='" + ViewState["classid"].ToString() + "' ) t";
                }
                else
                {
                    qry = "select '0' as payable_after_disc, session as Session,Perticular as feetype,Amount as payable,  '0' as paid, Amount as dues,'Dues' as status,'ADM01' as content_id,'0' as disc_amount,Amount as net_payable from Misc_Fee_Master_Studentwise where (Type_Mode='AdmissionFee' or Type_Mode='AnnualFee') and session='" + lbl_session.Text + "' and Admission_No='" + lbl_admissionno.Text + "' UNION ALL select *,(payable-cast(disc_amount as float)) net_payable from(select '0' payable_after_disc,fmc.session,cm.content feetype,cast(fmc.amount as float) payable,'0' paid,fmc.amount dues,'Dues' status,cm.content_id, isnull((isnull((select top 1 disc_amount from dbo.[Discount_Master] where Hostel_Id=" + ViewState["Hostel_id"].ToString() + " and admission_no='" + lbl_admissionno.Text + "'  and parameter_id='" + parameter_id + "' and session='" + lbl_session.Text + "' and fee_head_id=cm.content_id and Discount_on='Admission'),(select top 1 disc_amount from dbo.[Discount_Master] where Hostel_Id=" + ViewState["Hostel_id"].ToString() + " and Class_id='" + ViewState["classid"].ToString() + "' and admission_no='All'  and parameter_id='" + parameter_id + "' and session='" + lbl_session.Text + "' and fee_head_id=cm.content_id and Discount_on='Admission' and category_id='" + ViewState["category_id"].ToString() + "' and sub_category_id='" + ViewState["SubCategory_id"].ToString() + "'))),0) disc_amount from dbo.[Fee_master_content_wise] fmc join Content_master cm on fmc.content_id=cm.content_id where parameter='" + parameter + "'  and session='" + lbl_session.Text + "' and class_id='" + ViewState["classid"].ToString() + "' and fmc.Hostel_Id='" + ViewState["Hostel_id"].ToString() + "') t";
                }
        ...
        private void create_admission_annual_dues_admission(string parameter, SqlConnection con, double PaidAmt)
        {
            if (payments.dataTable("select session,feetype,payable,paid,dues,status,content_id from dbo.[Typewise_fee_collection] WHERE admission_no='" + lbl_admissionno.Text + "' and parameter='" + parameter + "' and session='" + ViewState["session"].ToString() + "'", con).Rows.Count == 0)
            {
                ...
                {
                    query = "select '0' as payable_after_disc, session as Session,Perticular as feetype,Amount as payable,  '0' as paid, Amount as dues,'Dues' as status,'ADM01' as content_id,'0' as disc_amount from Misc_Fee_Master_Studentwise where (Type_Mode='AdmissionFee' or Type_Mode='AnnualFee') and session='" + ViewState["session"].ToString() + "' and Admission_No='" + lbl_admissionno.Text + "' UNION ALL select '0' payable_after_disc,fmc.session,cm.content feetype,fmc.amount payable,'0' paid,fmc.amount dues,'Dues' status,cm.content_id, (isnull((select top 1 disc_amount from dbo.[Discount_Master] where Hostel_id='" + ViewState["Hostel_id"].ToString() + "' and admission_no='" + lbl_admissionno.Text + "'  and (parameter_id='1' or parameter_id='5') and session='" + ViewState["session"].ToString() + "' and fee_head_id=cm.content_id and Discount_on='Admission'),(select top 1 disc_amount from dbo.[Discount_Master] where Hostel_id='" + ViewState["Hostel_id"].ToString() + "' and Class_id='" + ViewState["classid"].ToString() + "' and admission_no='All'  and (parameter_id='1' or parameter_id='5') and session='" + ViewState["session"].ToString() + "' and fee_head_id=cm.content_id and Discount_on='Admission' and category_id='" + ViewState["category_id"].ToString() + "' and sub_category_id='" + ViewState["SubCategory_id"].ToString() + "'))) disc_amount  from dbo.[Fee_master_content_wise] fmc join Content_master cm on fmc.content_id=cm.content_id where parameter='" + parameter + "' and session='" + ViewState["session"].ToString() + "' and class_id='" + ViewState["classid"].ToString() + "' and fmc.Hostel_Id='" + ViewState["Hostel_id"].ToString() + "'";
                }
                DataTable dt = payments.dataTable(query, con);
                if (dt.Rows.Count == 0)
                {
        ...
        private void create_admission_annual_dues_annual(string parameter, SqlConnection con)
        {
            if (payments.dataTable("select session,feetype,payable,paid,dues,status,content_id from dbo.[Typewise_fee_collection] WHERE admission_no='" + lbl_admissionno.Text + "' and parameter='" + parameter + "' and session='" + ViewState["session"].ToString() + "'", con).Rows.Count == 0)
            {
                ...
                if (ViewState["Hostel_id"].ToString() == "0")
                {
                    query = "select '0' as payable_after_disc, session as Session,Perticular as feetype,Amount as payable,  '0' as paid, Amount as dues,'Dues' as status,'ADM01' as content_id,'0' as disc_amount from Misc_Fee_Master_Studentwise where (Type_Mode='AdmissionFee' or Type_Mode='AnnualFee') and session='" + ViewState["session"].ToString() + "' and Admission_No='" + lbl_admissionno.Text + "' UNION ALL select '0' payable_after_disc,fmc.session,cm.content feetype,fmc.amount payable,'0' paid,fmc.amount dues,'Dues' status,cm.content_id, (isnull((select top 1 disc_amount from dbo.[Discount_Master] where admission_no='" + lbl_admissionno.Text + "'  and (parameter_id='2' or parameter_id='6') and session='" + ViewState["session"].ToString() + "' and fee_head_id=cm.content_id and Discount_on='Annual'),(select top 1 disc_amount from dbo.[Discount_Master] where Class_id='" + ViewState["classid"].ToString() + "' and admission_no='All'  and (parameter_id='2' or parameter_id='6') and session='" + ViewState["session"].ToString() + "' and fee_head_id=cm.content_id and Discount_on='Annual' and category_id='" + ViewState["category_id"].ToString() + "' and sub_category_id='" + ViewState["SubCategory_id"].ToString() + "'))) disc_amount  from dbo.[Fee_master_content_wise] fmc join Content_master cm on fmc.content_id=cm.content_id where parameter='" + parameter + "' and session='" + ViewState["session"].ToString() + "' and class_id='" + ViewState["classid"].ToString() + "'";
                }
                else
                {
                    query = "select '0' as payable_after_disc, session as Session,Perticular as feetype,Amount as payable,  '0' as paid, Amount as dues,'Dues' as status,'ADM01' as content_id,'0' as disc_amount from Misc_Fee_Master_Studentwise where (Type_Mode='AdmissionFee' or Type_Mode='AnnualFee') and session='" + ViewState["session"].ToString() + "' and Admission_No='" + lbl_admissionno.Text + "' UNION ALL select '0' payable_after_disc,fmc.session,cm.content feetype,fmc.amount payable,'0' paid,fmc.amount dues,'Dues' status,cm.content_id, (isnull((select top 1 disc_amount from dbo.[Discount_Master] where Hostel_id='" + ViewState["Hostel_id"].ToString() + "' and admission_no='" + lbl_admissionno.Text + "'  and (parameter_id='2' or parameter_id='6') and session='" + ViewState["session"].ToString() + "' and fee_head_id=cm.content_id and Discount_on='Annual'),(select top 1 disc_amount from dbo.[Discount_Master] where Hostel_id='" + ViewState["Hostel_id"].ToString() + "' and  Class_id='" + ViewState["classid"].ToString() + "' and admission_no='All'  and (parameter_id='2' or parameter_id='6') and session='" + ViewState["session"].ToString() + "' and fee_head_id=cm.content_id and Discount_on='Annual' and category_id='" + ViewState["category_id"].ToString() + "' and sub_category_id='" + ViewState["SubCategory_id"].ToString() + "'))) disc_amount  from dbo.[Fee_master_content_wise] fmc join Content_master cm on fmc.content_id=cm.content_id where parameter='" + parameter + "' and session='" + ViewState["session"].ToString() + "' and class_id='" + ViewState["classid"].ToString() + "' and fmc.Hostel_Id='" + ViewState["Hostel_id"].ToString() + "'";
                }
                DataTable dt = payments.dataTable(query, con);
                if (dt.Rows.Count == 0)
                { }
        ...
        private void for_discount(string session_name, string session_id, string class_id, string admission_no, string hostel_taken, string transport_taken, string hostel_id, string room_category_id, string TransportPath_id, string Boarding_Point_id)
        {
            ...
            else
            {
                ...
                {
                    query1 = "select fmc.content,fmc.content_id,fmc.amount,cm.group_id,'0' as discount from dbo.[Fee_master_content_wise] fmc join Content_master cm on fmc.content_id=cm.content_id  where fmc.class_id='" + class_id + "' and fmc.session_id='" + session_id + "' and fmc.parameter_id='4' and fmc.Month='" + startmonthname + "' UNION all select t1.Parameter as content,parameter_id as content_id,Amount as amount,'0' as group_id,'0' as discount from Transportation_Fee_Master t1 join Month_Index t2 on t1.Month_id=t2.Month_Id where t1.session_id='" + session_id + "' and t1.Transportation_path_id='" + TransportPath_id + "'and t1.Boarding_Point_id='" + Boarding_Point_id + "' and t1.Month='" + startmonthname + "'";
                }
                else
                {
                    query1 = "select fmc.content,fmc.content_id,fmc.amount,cm.group_id,'0' as discount from dbo.[Fee_master_content_wise] fmc join Content_master cm on fmc.content_id=cm.content_id  where fmc.class_id='" + class_id + "' and fmc.session_id='" + session_id + "' and fmc.parameter_id='4' and fmc.Month='" + startmonthname + "'";
                }
            }
                ...
                if (ViewState["Is_add_Discount"].ToString() == "1")
                {
                    ...
                    if (chk_is_admission_disc.Checked == true)
                    {
                        ...
                        if (ViewState["issubmit"].ToString() == "1")
                        {
                            ...
                            Response.Redirect("fees-collection.aspx?adm=" + txt_admission_no.Text, false);
                        }
                    }
                    else
                    {
                ...
                for (int i = 0; i < rp_fee_head_admission.Items.Count; i++)
                {
                    ...
                    if (My.toDouble(txt_disc_fee.Text) > 0)
                    {
                        ...
                        if (dt.Rows.Count == 0)
                        {
                            ...
                            if (My.InsertUpdateData(cmd))
                            {
                                DataTable dtF = My.dataTable("select * from Typewise_fee_collection where admission_no='" + hd_admission_no.Value + "' and session='" + ViewState["session"].ToString() + "' and (group_id='1' or group_id='2') and content_id='" + lbl_content_id.Text + "'");
                                if (dtF.Rows.Count > 0)
                                {
                                    double payableAfterDisc = My.toDouble(dtF.Rows[0]["payable"].ToString()) - My.toDouble(discount_fee);
                                    My.exeSql("update Typewise_fee_collection set Disc='" + My.toDouble(discount_fee).ToString("0.00") + "',Payable_after_disc='" + payableAfterDisc.ToString("0.00") + "' where Id=" + dtF.Rows[0]["Id"].ToString() + "");
                                }
                            }
                        }
                        else
            ...
            try
            {
                if (ViewState["Is_delete_Discount"].ToString() == "1")
                {
                    ...
                    else if (lbl_discount_on.Text == "Annual" || lbl_discount_on.Text == "Admission")
                    {
                        ...
                        if (dt.Rows.Count == 0)
                        {
                            mycode.executequery("delete from Discount_Master where admission_no='" + lbl_admission_no.Text + "' and session_id='" + lbl_session_id.Text + "' and Discount_on='" + lbl_discount_on.Text + "' and fee_head_id='" + lbl_content_id.Text + "'");
        ...
        private void for_extra_fee_head(string session_name, string session_id, string class_id, string admission_no, string hostel_taken, string transport_taken, string hostel_id, string room_category_id, string TransportPath_id, string Boarding_Point_id)
        {
            ...
            string qryExtHeadMonth = "select Month, Position from Month_Index order by Position asc";
            if (ViewState["Is_quarterwise_payment"].ToString() == "1")
            {
                qryExtHeadMonth = "select Month, Position from (select Month, Position,(select isnull(sum(convert(float, amount)),0) from Fee_master_content_wise where (parameter = 'MonthlyFee'  or parameter = 'HostelMonthlyFee') and session_id='" + ViewState["sessionIDs"].ToString() + "' and class_id='" + ViewState["classid"].ToString() + "' and Month=Month_Index.Month) as Total_fee from Month_Index where Month in (select month from Typewise_fee_collection where admission_no = '" + admission_no + "' and(parameter = 'MonthlyFee'  or parameter = 'HostelMonthlyFee') and session = '" + session_name + "' and class_id = '" + class_id + "' and status = 'Dues') or Month not in (select month from Typewise_fee_collection where admission_no = '" + admission_no + "' and(parameter = 'MonthlyFee'  or parameter = 'HostelMonthlyFee') and session = '" + session_name + "' and class_id = '" + class_id + "' and status = 'Paid')) t where convert(float, Total_fee)>0 order by Position asc";
            }
        ...
        private void save_extra_head_for_fee()
        {
            string qryForCheck = "select Id from Misc_Fee_Master_Studentwise where Admission_No='" + hd_admission_no.Value + "' and Session_id='" + ViewState["sessionIDs"].ToString() + "' and Perticular='" + txt_fee_title.Text + "' and Type_Mode='" + ddl_extra_head_for.SelectedItem.Text + "'";
            string months = "";
            if (ddl_extra_head_for.SelectedValue == "1")
            {
                months = ddl_month.SelectedItem.Text;
                qryForCheck = "select Id from Misc_Fee_Master_Studentwise where Admission_No='" + hd_admission_no.Value + "' and Session_id='" + ViewState["sessionIDs"].ToString() + "' and Month='" + ddl_month.SelectedItem.Text + "' and Perticular='" + txt_fee_title.Text + "' and Type_Mode='" + ddl_extra_head_for.SelectedItem.Text + "'";
            }

            if (mycode.IsUserExist(qryForCheck))
            {
                SqlCommand cmd;
                ...
                if (My.InsertUpdateData(cmd))
                {
                    ...
                    if (ddl_extra_head_for.SelectedValue == "1")
                    {
                        ...
                        typewise_months = ddl_month.SelectedItem.Text;
                        typewise_months_position = ddl_month.SelectedValue;
                        content_id = "1001";
                        group_id = "3";
                        qryChkTypewise = "select Id from Typewise_fee_collection where admission_no='" + hd_admission_no.Value + "' and session='" + ViewState["session"].ToString() + "' and month='" + ddl_month.SelectedItem.Text + "' and (parameter='MonthlyFee'  or parameter='HostelMonthlyFee')";
                    }
            ...
            {
                Alertme("Already added this fee title on selected month.", "warning");
                ScriptManager.RegisterStartupScript(this, this.GetType(), "Pop", "openExtraFeeAlert();", true);
            }
        }
        ...
        protected void lnkDelExtFee_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    mycode.executequery("delete from Misc_Fee_Master_Studentwise where Id='" + lbl_Id.Text + "'; delete from Typewise_fee_collection where admission_no='" + hd_admission_no.Value + "' and session='" + ViewState["session"].ToString() + "' and parameter='" + ViewState["parameter"].ToString() + "' and feetype='" + lbl_perticular.Text + "' and content_id='1001' and month='" + lbl_month.Text + "' and status='Dues'");
                }
                else
                {
                    mycode.executequery("delete from Misc_Fee_Master_Studentwise where Id='" + lbl_Id.Text + "'; delete from Typewise_fee_collection where admission_no='" + hd_admission_no.Value + "' and session='" + ViewState["session"].ToString() + "' and feetype='" + lbl_perticular.Text + "' and (content_id='ADM01' or content_id='ANN01') and status='Dues'");
                }
                string desc = "Extra fee head deleted for head name : " + lbl_perticular.Text + " amount : " + lbl_amount + " month : " + lbl_month.Text;
                log_hostory.delete_log(lbl_session_id.Text, ViewState["classid"].ToString(), lbl_admission_no.Text, "DeleteExtraFeeHead", desc, "fees-collection.aspx", ViewState["Userid"].ToString());
        ...
        protected void btn_Submit_Click(object sender, EventArgs e)
        {
            if (ViewState["Is_Edit_Bus"].ToString() == "1")
            {
                ...
                else
                {
                    ...
                    Response.Redirect("fees-collection.aspx?adm=" + ViewState["Admission_no"].ToString(), false);
                }
            }
            else
            {
        ...
        private void save_boarding_data()
        {
            ...
            if (My.InsertUpdateData(cmd))
            {
                ...
                {
                    // chek if dues  
                    DataTable dt = mycode.FillData("Select top 1 * from Typewise_fee_collection where admission_no='" + ViewState["Admission_no"].ToString() + "' and session='" + ViewState["session"].ToString() + "' and parameter='MonthlyFee' and status='Dues' and month='" + ddl_monthname.SelectedItem.Text + "'");
                    if (dt.Rows.Count != 0)
                    {
                ...
                (isnull((select top 1 disc_amount from dbo.[Discount_Master_for_bus] where admission_no='" + ViewState["Admission_no"].ToString() + "' and month='" + ddl_monthname.SelectedItem.Text + "' and session_id='" + ViewState["sessionIDs"].ToString() + "' and Bus_path='" + ddl_path_root.SelectedValue + "'),(select top 1 disc_amount from dbo.[Discount_Master_for_bus] where  admission_no='All' and month='" + ddl_monthname.SelectedItem.Text + "' and session_id='" + ViewState["sessionIDs"].ToString() + "' and Bus_path='" + ddl_path_root.SelectedValue + "'))) disc_amount from admission_registor ar join Transportation_Fee_Master tr on ar.Transportation_Id=tr.Transportation_path_id and ar.transportationtaken='yes' and ar.Session_id='" + ViewState["sessionIDs"].ToString() + "' and admissionserialnumber='" + ViewState["Admission_no"].ToString() + "' and tr.Month='" + ddl_monthname.SelectedItem.Text + "'  join Student_mapping_with_TransportPath smt on  ar.Session_id=smt.Session_id and ar.admissionserialnumber=smt.Admission_no and smt.Year_month<=" + s_year + monthid + "");
                        if (feedt.Rows.Count != 0)
                        {
                            foreach (DataRow dr in feedt.Rows)
                            {
                                ...
                                mycode.executequery("delete from Typewise_fee_collection where admission_no='" + ViewState["Admission_no"].ToString() + "' and session='" + ViewState["session"].ToString() + "' and parameter='MonthlyFee' and feetype='TransportationFee' and month='" + get_onemonthback + "'");
...
values ('" + ViewState["Admission_no"].ToString() + "','" + class1 + "','" + ViewState["session"].ToString() + "','MonthlyFee','" + mycode.date() + "','" + mycode.idate() + "','" + TransportationFeetype + "','" + My.toDouble(Amount).ToString("0.00") + "','0','" + My.toDouble(afterdicount).ToString("0.00") + "','Dues','" + ddl_monthname.SelectedItem.Text + "','" + content_id1 + "','','School','false','false','false','" + My.toDouble(disc_amount).ToString("0.00") + "','" + section + "','" + ViewState["Userid"].ToString() + "','" + ViewState["Branchid"].ToString() + "','" + group_id + "','" + class_id + "','" + position + "','" + afterdicount.ToString("0.00") + "')");
            ...
            try
            {
                if (ViewState["Is_delete_Bus"].ToString() == "1")
                {
                    ...
                    if (My.InsertUpdateData(cmd1))
                    {
                        ...
                        log_hostory.delete_log(ViewState["sessionIDs"].ToString(), ViewState["classid"].ToString(), lbl_admission_no.Text, "RemoveTransport", desc, "fees-collection.aspx", ViewState["Userid"].ToString());
                        ...
                        cmd1.Parameters.AddWithValue("@Remarks", "NA");
        ...
        private void save_transport_mapping()
        {
            ...
            DataTable dt = My.dataTable("select * from TRANSPORT_PATH_MAPPING_WITH_SHEET where TransportationPath_id='" + ddl_trns_route.SelectedValue + "' and Transportation_Id='" + ddl_trns_vehicle.SelectedValue + "' and Sheet_Status='0'");
            if (dt.Rows.Count > 0)
            {
                SqlCommand cmd;
                ...
                if (My.InsertUpdateData(cmd))
                {
                    try
                    {
                        ...
                        if (My.InsertUpdateData(cmd1))
                        {
                            DataTable dtTR = mycode.FillData("Select distinct month,class,position from Typewise_fee_collection where admission_no='" + ViewState["Admission_no"].ToString() + "' and session='" + ViewState["session"].ToString() + "' and parameter ='MonthlyFee' and class_id=" + ViewState["classid"].ToString() + " and position>=" + ddl_tr_month.SelectedValue + " order by position asc ");//
                            if (dtTR.Rows.Count > 0)
                            {
                                DataTable dtTT = My.dataTable("select * from Transportation_Boarding_Point where Session_Id='" + ddlsession.SelectedValue + "' and Transportation_Id='" + ddl_trns_vehicle.SelectedValue + "' and TransportationPath_id='" + ddl_trns_route.SelectedValue + "' and Boarding_Point_id='" + ddl_boarding_point_map.SelectedValue + "'");
                                foreach (DataRow drtr in dtTR.Rows)
                                {
                                    ...
                                    mycode.executequery("delete from Typewise_fee_collection where admission_no='" + ViewState["Admission_no"].ToString() + "' and session='" + ViewState["session"].ToString() + "' and parameter='MonthlyFee' and feetype='TransportationFee' and month='" + month + "' and class_id='" + class_id + "'");
                                    My.exeSql(@"insert into Typewise_fee_collection(admission_no,class,session,parameter,Date,idate,feetype,payable,paid,dues,status,month,content_id,transection,
Ledger,is_readyfor_sync,is_sync,is_sync_dues_diary,Disc,section,user_id,branchid,group_id,class_id,position,Payable_after_disc) 
values ('" + ViewState["Admission_no"].ToString() + "','" + class1 + "','" + ViewState["session"].ToString() + "','MonthlyFee','" + mycode.date() + "','" + mycode.idate() + "','" + TransportationFeetype + "','" + My.toDouble(Amount).ToString("0.00") + "','0','" + My.toDouble(afterdicount).ToString("0.00") + "','Dues','" + month + "','" + content_id1 + "','00','School','false','false','false','" + My.toDouble(disc_amount).ToString("0.00") + "','" + section + "','" + ViewState["Userid"].ToString() + "','" + ViewState["Branchid"].ToString() + "','" + group_id + "','" + class_id + "','" + position + "','" + afterdicount.ToString("0.00") + "')");
        ...
        private void save_hostel_mapping()
        {
            ...
            if (My.InsertUpdateData(cmd))
            {
                try
                {
                    mycode.executequery("update admission_registor set hosteltaken='Yes',transportationtaken='No',Hostel_id='" + ddl_hostel.SelectedValue + "',Hostel_assignD_id='" + hostel_assign_id + "',Transportation_Id='0',Transportationpath='0' where admissionserialnumber='" + ViewState["Admission_no"].ToString() + "' and Session_id='" + ViewState["sessionIDs"].ToString() + "'  ");

                    DataTable dtTns = My.dataTable("select * from Student_mapping_with_TransportPath where Session_id='" + ViewState["sessionIDs"].ToString() + "' and Admission_no='" + ViewState["Admission_no"].ToString() + "'  and Class_id='" + ViewState["classid"].ToString() + "'");
                ...
                mycode.executequery("update Typewise_fee_collection set parameter='" + parameter_m_new + "'  where admission_no='" + ViewState["Admission_no"].ToString() + "' and session='" + ViewState["session"].ToString() + "' and parameter='" + parameter_m_old + "'; update Typewise_fee_collection set parameter='" + parameter + "' where admission_no='" + ViewState["Admission_no"].ToString() + "' and session='" + ViewState["session"].ToString() + "' and parameter='" + parameter_old + "' ");


                if (ViewState["firm_id"].ToString() == "DIS-01")
                {
                    DataTable dtH = My.dataTable("select * from Typewise_fee_collection where session='" + ViewState["session"].ToString() + "' and admission_no='" + ViewState["Admission_no"].ToString() + "' and parameter='" + parameter + "' and class_id='" + ViewState["classid"].ToString() + "'");
                    if (dtH.Rows.Count > 0)
                    {
                        string daysFee = "0"; string HostelFee = "0";
                        if (studenttype.ToUpper() == "NEW")
                        {
                            daysFee = get_total_adm_fee("daysAd", ddl_hostel.SelectedValue);
                            HostelFee = get_total_adm_fee("hostelAd", ddl_hostel.SelectedValue);
                        }
                        else
                        {
                            daysFee = get_total_adm_fee("daysAn", ddl_hostel.SelectedValue);
                            HostelFee = get_total_adm_fee("hostelAn", ddl_hostel.SelectedValue);
                        }
                        double HadmissionFee = (My.toDouble(HostelFee) - My.toDouble(daysFee));
                        if (HadmissionFee > 0)
                        {
                            My.exeSql("insert into Typewise_fee_collection(admission_no,class,session,parameter,Date,idate,feetype,payable,paid,dues,status,month,content_id,transection,Ledger,is_readyfor_sync,is_sync,is_sync_dues_diary,Disc,section,user_id,branchid,group_id,class_id,position,Payable_after_disc) values ('" + ViewState["Admission_no"].ToString() + "','" + lblclass.Text + "','" + ViewState["session"].ToString() + "','" + parameter + "','" + mycode.date() + "','" + mycode.idate() + "','Hostel Admission Fee','" + HadmissionFee.ToString("0.00") + "','0','" + HadmissionFee.ToString("0.00") + "','Dues','April','" + ViewState["Userid"].ToString() + "','00','School','false','false','false','0.00','" + ViewState["Section"].ToString() + "','" + ViewState["Userid"].ToString() + "','" + ViewState["Branchid"].ToString() + "','3','" + ViewState["classid"].ToString() + "','1','" + HadmissionFee.ToString("0.00") + "')");
                        }
                    }
                }
            }
        ...
        private string get_total_adm_fee(string type, string hostel_id)
        {
        ...
        protected void btn_remove_hostel_Click(object sender, EventArgs e)
        {
            try
            {
                if (ViewState["Is_delete_Hostel"].ToString() == "1")
                {
                    ...
                    mycode.executequery("update Hostel_assign_master set Status='0',Remove_cause='Remove From Fee Collection Page',Updated_by='" + ViewState["Userid"].ToString() + "',Updated_date='" + mycode.date() + "',Updated_idate='" + mycode.idate() + "' where Hostel_assign_id='" + ViewState["Hostel_assign_id"].ToString() + "'");
                    mycode.executequery("update admission_registor set hosteltaken='No',Hostel_id='0' where admissionserialnumber='" + ViewState["Admission_no"].ToString() + "' and Session_id='" + ViewState["sessionIDs"].ToString() + "' ");
                    ...
                    log_hostory.delete_log(ViewState["sessionIDs"].ToString(), ViewState["classid"].ToString(), lbl_admission_no.Text, "RemoveHostel", desc, "fees-collection.aspx", ViewState["Userid"].ToString());
