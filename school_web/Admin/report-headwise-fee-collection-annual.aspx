<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="report-headwise-fee-collection-annual.aspx.cs" Inherits="school_web.Admin.report_headwise_fee_collection_annual" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Head wise Annual Fee Collection
</asp:Content>
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Head wise Annual Fee Collection</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    ...
                    <ul class="sub-pag-menu-ul">
                        ...
                        <li><a href="report-headwise-fee-collection-annual.aspx" class="sub-mnu-p-a-active">Head wise Fee Collection</a></li>
