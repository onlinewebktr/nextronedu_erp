...
{
    public partial class report_student_headwise_admission_fee_collection_N : System.Web.UI.Page
    {
        My mycode = new My();
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                My.submitException(ex, "report_student_headwise_admission_fee_collection_N");
            }
        }
        ...
        private void final_find_report_by_date(int idate1, int idate21, string type)
        {
            ...
            cmd.Parameters.AddWithValue("@parameter ", "AdmissionFee");
            cmd.Parameters.AddWithValue("@parameter2 ", "HostelAdmissionFee");
            if (type == "OnlyDatE")
            {
        ...
        private void find_student_amount_details(int idate1, int idate21, string type)
        {
            ...
            if (type == "DatEClasS")
            {
                if (ddl_paymentmode.Text == "All")
                {
                    qry = " select ROW_NUMBER() OVER (ORDER BY t1.Id) AS Sl,t2.Date,t1.session,t2.Addmission_no as Admission_no,t1.class as Class,t1.Section,t1.rollnumber as Roll_number,t1.studentname as Student_name,t1.Session_id,t1.Class_id,t2.Slip_no,t2.mode as Payment_Mode from admission_registor t1 join Student_Payment_History t2 on t1.admissionserialnumber=t2.Addmission_no and t1.session=t2.Session join Payment_Mode_Master pmm on pmm.Type_Mode=t2.mode where t2.Idate>=" + idate1 + " and t2.Idate<=" + idate21 + " and t2.session='" + ViewState["SessioNs"].ToString() + "' and t1.Class_id='" + ddl_class.SelectedValue + "'  and t2.Type='Admission'  order by pmm.Position,t2.Idate asc";
                }
                else
                {
                    qry = " select ROW_NUMBER() OVER (ORDER BY t1.Id) AS Sl,t2.Date,t1.session,t2.Addmission_no as Admission_no,t1.class as Class,t1.Section,t1.rollnumber as Roll_number,t1.studentname as Student_name,t1.Session_id,t1.Class_id,t2.Slip_no,t2.mode as Payment_Mode from admission_registor t1 join Student_Payment_History t2 on t1.admissionserialnumber=t2.Addmission_no and t1.session=t2.Session join Payment_Mode_Master pmm on pmm.Type_Mode=t2.mode where t2.Idate>=" + idate1 + " and t2.Idate<=" + idate21 + " and t2.session='" + ViewState["SessioNs"].ToString() + "' and t1.Class_id='" + ddl_class.SelectedValue + "' and t2.mode='" + ddl_paymentmode.Text + "'  and t2.Type='Admission' order by pmm.Position,t2.Idate asc";
            ...
            if (type == "DatEClasSSectioN")
            {
                if (ddl_paymentmode.Text == "All")
                {
                    qry = " select ROW_NUMBER() OVER (ORDER BY t1.Id) AS Sl,t2.Date,t1.session,t2.Addmission_no as Admission_no,t1.class as Class,t1.Section,t1.rollnumber as Roll_number,t1.studentname as Student_name,t1.Session_id,t1.Class_id,t2.Slip_no,t2.mode as Payment_Mode from admission_registor t1 join Student_Payment_History t2 on t1.admissionserialnumber=t2.Addmission_no and t1.session=t2.Session join Payment_Mode_Master pmm on pmm.Type_Mode=t2.mode where t2.Idate>=" + idate1 + " and t2.Idate<=" + idate21 + " and t2.session='" + ViewState["SessioNs"].ToString() + "' and t1.Class_id='" + ddl_class.SelectedValue + "' and t1.Section='" + ddl_section.SelectedItem.Text + "'  and t2.Type='Admission' order by t2.Idate asc";
                }
                else
                {
                    qry = " select ROW_NUMBER() OVER (ORDER BY t1.Id) AS Sl,t2.Date,t1.session,t2.Addmission_no as Admission_no,t1.class as Class,t1.Section,t1.rollnumber as Roll_number,t1.studentname as Student_name,t1.Session_id,t1.Class_id,t2.Slip_no,t2.mode as Payment_Mode from admission_registor t1 join Student_Payment_History t2 on t1.admissionserialnumber=t2.Addmission_no and t1.session=t2.Session join Payment_Mode_Master pmm on pmm.Type_Mode=t2.mode where t2.Idate>=" + idate1 + " and t2.Idate<=" + idate21 + " and t2.session='" + ViewState["SessioNs"].ToString() + "' and t1.Class_id='" + ddl_class.SelectedValue + "' and t1.Section='" + ddl_section.SelectedItem.Text + "' and t2.mode='" + ddl_paymentmode.Text + "'  and t2.Type='Admission' order by pmm.Position,t2.Idate asc";
                }
            }
            ...
            if (type == "ByAdmNo")
            {
                if (ddl_paymentmode.Text == "All")
                {
                    qry = " select ROW_NUMBER() OVER (ORDER BY t1.Id) AS Sl,t2.Date,t1.session,t2.Addmission_no as Admission_no,t1.class as Class,t1.Section,t1.rollnumber as Roll_number,t1.studentname as Student_name,t1.Session_id,t1.Class_id,t2.Slip_no,t2.mode as Payment_Mode from admission_registor t1 join Student_Payment_History t2 on t1.admissionserialnumber=t2.Addmission_no and t1.session=t2.Session join Payment_Mode_Master pmm on pmm.Type_Mode=t2.mode where t2.session='" + ddl_session.SelectedItem.Text + "' and t2.Addmission_no='" + txt_admission_no.Text + "'  and t2.Type='Admission' order by pmm.Position,t2.Idate asc";
                }
                else
                {
                    qry = " select ROW_NUMBER() OVER (ORDER BY t1.Id) AS Sl,t2.Date,t1.session,t2.Addmission_no as Admission_no,t1.class as Class,t1.Section,t1.rollnumber as Roll_number,t1.studentname as Student_name,t1.Session_id,t1.Class_id,t2.Slip_no,t2.mode as Payment_Mode from admission_registor t1 join Student_Payment_History t2 on t1.admissionserialnumber=t2.Addmission_no and t1.session=t2.Session join Payment_Mode_Master pmm on pmm.Type_Mode=t2.mode where t2.session='" + ddl_session.SelectedItem.Text + "' and t2.Addmission_no='" + txt_admission_no.Text + "' and t2.mode='" + ddl_paymentmode.Text + "'  and t2.Type='Admission' order by pmm.Position,t2.Idate asc";
                }
            }
        ...
        private string find_fees(string FeeType, string content_id, DataRow dr)
        {
            ...
            double headFee = 0;
            feedt = My.dataTable("select sum(isnull(convert(float, paid),0)) as Paid_amt from Monthly_Fee_Collection_Slip where parameter  in ('AdmissionFee','HostelAdmissionFee') and content_id='" + content_id + "' and adno='" + dr["Admission_no"].ToString() + "' and session='" + dr["session"].ToString() + "' and class='" + dr["Class_id"].ToString() + "' and slipno='" + dr["Slip_no"].ToString() + "'");
        ...
        protected void btn_find_by_adm_no_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    Bind_data_by_Admission_no_wise();
                }
            }
            catch (Exception ex)
            {
        ...
        private void Bind_data_by_Admission_no_wise()
        {
            SqlCommand cmd = new SqlCommand("sp_Fee_collection_report_new");
            cmd.Parameters.AddWithValue("@parameter ", "AdmissionFee");
            cmd.Parameters.AddWithValue("@parameter2 ", "HostelAdmissionFee");
            ...
            if (rowcount > 0)
            {
                ...
                find_student_amount_details(0, 0, "ByAdmNo");
            }
            else
            {
                rp_month.DataSource = null;
