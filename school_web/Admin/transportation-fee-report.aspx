<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="transportation-fee-report.aspx.cs" Inherits="school_web.Admin.transportation_fee_report" EnableEventValidation="false" ValidateRequest="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Transportation Fee Report
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Transportation Fee Report</li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <asp:Label ID="lbl_website" runat="server"></asp:Label>
                                                                    ...
                                                                    <div style="margin: 7px 0px 0px 0px; padding: 0px; float: left; height: auto; text-align: center; vertical-align: middle; font-size: 13px; width: 100%;">
                                                                        <span style="font-size: 14px; font-weight: bold;">Transportation Fee<asp:Label ID="lbl_class22" runat="server"></asp:Label></span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                <asp:GridView ID="GrdView" runat="server" class="table table-bordered" ShowFooter="True" AutoGenerateColumns="False" Width="100%" OnRowDataBound="GrdView_RowDataBound">
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Slip No.">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lbl_transection" runat="server" Text='<%#Bind("transection")%>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField HeaderText="Transportation Amount">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lbl_paid" runat="server" Text='<%#Bind("paid")%>'></asp:Label>
                                                            </ItemTemplate>
                                                            <FooterTemplate>
                                                                <asp:Label ID="lbl_total_amount" runat="server"></asp:Label>
                                                            </FooterTemplate>
                                                        </asp:TemplateField>
    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            var options = {
                title: 'ClassWise Transportation Fee Summary',
                width: 1140,
                height: 400,
            ...
            $.ajax({
                type: "POST",
                url: "transportation-fee-report.aspx/GetChartData",
