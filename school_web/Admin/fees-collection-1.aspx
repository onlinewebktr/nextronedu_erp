<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="fees-collection-1.aspx.cs" Inherits="school_web.Admin.fees_collection_1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="head" runat="server">
    ...
    <style type="text/css">
        ...
        .applycoupon-stl {
            ...
            float: left;
            background: #b32b32 !important;
        }

            .applycoupon-stl:hover {
                color: #fff;
            }
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#<%=txt_student_name.ClientID%>").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        url: 'fees-collection-1.aspx/GetRooPath',
        ...
        $(function () {
            ...
            $("#<%=txt_admission_no.ClientID%>").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        url: 'fees-collection-1.aspx/GetRooPathAdmNo',
                        data: "{ 'PathRooT': '" + request.term + "',Session_id:'" + sessionid + "'}",
                        dataType: "json",
                        type: "POST",
                        contentType: "application/json; charset=utf-8",
    ...
    <script type="text/javascript">
        ...
        function showDiscError() {
            $('#myModalDiscError').modal('show');
        }
    </script>
</asp:Content>
    ...
    <div data-ng-app="RpFeeApp" data-ng-controller="RpFeeAppCtrl">
        ...
        <div class="page-wrapper">
            <div class="page-content">
                ...
                <asp:HiddenField ID="hd_is_auto_paid_fill" runat="server" />
                <div class="row">
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="p-4 border rounded">
                                    ...
                                    <asp:Panel ID="std_basic_infoS" runat="server" Visible="false">
                                                ...
                                                <div class="fnd-box-wpr">
                                                    <div class="fnd-box-row-wpr-h std-info-ch" data-bs-toggle="collapse" href="#multiCollapseExample1" role="button" aria-expanded="false" aria-controls="multiCollapseExample1">
                                                        ...
                                                        <ul class="std-info-ul">
                                                            ...
                                                            <li><i>Name : </i>
                                                                <asp:Label ID="lbl_name_c" runat="server"></asp:Label>
                                                            </li>

                                                            <li><i>F. Name : </i>
                                                                <asp:Label ID="lbl_father_name1" runat="server"></asp:Label>
                                                            </li>

                                                            <li><i>Class : </i>
                                                                <asp:Label ID="lblclass_show_c" runat="server"></asp:Label>
                                                            </li>
                                                            <li><i>Roll No. : </i>
                                                                <asp:Label ID="txtroll_no" runat="server" Font-Bold="true" Text=""></asp:Label>
                                                            </li>
                                                            <li><i>Bus : </i>
                                                                <asp:Label ID="lbl_transport_c" runat="server"></asp:Label>
                                                            </li>
                                                            <li><i>Hostel : </i>
                                                                <asp:Label ID="lbl_hostel_c" runat="server"></asp:Label>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <div class="fnd-box-wpr-inr">
                                                            ...
                                                            <div class="fnd-box-row-wpr stdinfo-lft">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-xl-5 padd-rght-5">
                                                                        <div class="row">
                                                                            <div class="col-xl-4 padd-rght-5">
                                                                                <label for="validationCustom01" class="stdnt-info-fnds">Mother's Name : </label>
                                                                            </div>
                                                                            <div class="col-xl-8 padd-lft-5">
                                                                                <asp:Label ID="lbl_mothersname" runat="server" Font-Bold="true" class="stdnt-info-fnds"></asp:Label>
                                                                                <asp:Label ID="lbl_admission_no" runat="server" Font-Bold="true" class="stdnt-info-fnds" Style="display: none"></asp:Label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-xl-2 padd-rght-5">
                                                                        <div class="row">
                                                                            <div class="col-xl-6 padd-rght-5">
                                                                                <label for="validationCustom01" class="stdnt-info-fnds"></label>
                                                                            </div>
                                                                            <div class="col-xl-6 padd-lft-5">
                                                                            </div>
                                                                        </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-xl-5 padd-rght-5">
                                                                        <div class="row">
                                                                            <div class="col-xl-4 padd-rght-5">
                                                                                <label for="validationCustom01" class="stdnt-info-fnds">Discount Group : </label>
                                                                            </div>
                                                                            <div class="col-xl-8 padd-lft-5">
                                                                    ...
                                                                    <div class="col-xl-5 padd-rght-5">
                                                                        <div class="row">
                                                                            <div class="col-xl-4 padd-rght-5">
                                                                                <label for="validationCustom01" class="stdnt-info-fnds">Dis. Sub Group : </label>
                                                                            </div>
                                                                            <div class="col-xl-8 padd-lft-5">
                                                                    ...
                                                                    <div class="col-xl-2 padd-rght-5">
                                                                        <div class="row">
                                                                            <div class="col-xl-6 padd-rght-5">
                                                                                <label for="validationCustom01" class="stdnt-info-fnds">Pwd : </label>
                                                                            </div>
                                                                            <div class="col-xl-6 padd-lft-5">
                                                                                <asp:Label ID="lbl_password" runat="server" Font-Bold="true" class="stdnt-info-fnds"></asp:Label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-xl-12 padd-rght-5">
                                                                        <div class="row">
                                                                            <div class="col-xl-2 padd-rght-5">
                                                                                <label for="validationCustom01" class="stdnt-info-fnds">Address : </label>
                                                                            </div>
                                                                            <div class="col-xl-10 padd-lft-5">
                                                                                <asp:Label ID="lbl_addresss" runat="server" Font-Bold="true" class="stdnt-info-fnds"></asp:Label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class=" row">
                                                                <div class="col-md-7">
                                                                    <div class="imp-info-lft">
                                                                        ...
                                                                        <asp:Label ID="lbl_back_dues" class="monthlyduesshow" runat="server" Visible="false" Style="background: #b2d300;"></asp:Label>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-5">
                                                                    <div class="imp-info-rght">
                                                                        ...
                                                                        <p runat="server" id="discBTN" data-toggle="modal" data-target="#mdlDiscount" class="button-6161 disc-pupup-btn floatrght" onclick="discApply()">Discount</p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                        ...
                                        <asp:TextBox ID="txt_apply_discount_status" runat="server" Text="0" Style="display: none"></asp:TextBox>
                                        <script type="text/javascript">
                                            function discApply() {
                                                //alert("h");
                                                var vlues = 1;
                                                $("#<%=txt_apply_discount_status.ClientID %>").val(vlues);
                                            }
                                        </script>
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12">
                                                <div class="fnd-box-wpr" id="spilt_month_show" style="margin: 5px 0px 0px 0px;" runat="server" visible="false">
                                                    ...
                                                    <asp:Label ID="lbl_Monthsplit" runat="server"></asp:Label>
                                                    </h2>
                                                ...
                                                <div class="fnd-box-wpr" style="margin: 5px 0px 0px 0px;">
                                                    <h2 class="fnd-box-row-wpr-h"><span id="insTypes" runat="server">Select Month</span>
                                                    ...
                                                    <div class="fnd-box-wpr-inr" style="padding: 0px 5px 5px 5px;">
                                                        <div class="month-checkbox">
                                                            <div style="float: left; width: 100%" id="instDv" runat="server" visible="false">
                                                                <asp:Repeater ID="rp_installment" runat="server">
                                                                    <itemtemplate>
                                                                        <asp:CheckBox ID="chk_installment" Text='<%#Eval("Intstallment_name") %>' OnCheckedChanged="chk_installment_CheckedChanged" AutoPostBack="true" runat="server" />
                                                                        <asp:Label ID="lbl_Month_id" runat="server" Visible="false" Text='<%#Bind("Month_id")%>'></asp:Label>
                                                                        <asp:Label ID="lbl_month_name" runat="server" Visible="false" Text='<%#Bind("Month_name")%>'></asp:Label>
                                                                        <asp:Label ID="lbl_month_position_no" runat="server" Visible="false" Text='<%#Bind("Month_position_no")%>'></asp:Label>
                                                                    </itemtemplate>
                                                                </asp:Repeater>
                                                            </div>


                                                            <div style="float: left; width: 100%" id="monthsDv" runat="server">
                                                    ...
                                                    <div class="fnd-box-wpr-inr">
                                                        <asp:Panel ID="pnl_month_wise_fee_details" runat="server" Visible="false">
                                                            <table style="width: 100%;" class="table table-hover table-bordered">
                                                                <tr>
                                                                    <th id="chkbxallMonth" runat="server"></th>
                                                                    <th>Month</th>
                                                                    <th>Fees Head</th>
                                                                    <th>Amount</th>
                                                                    <th>Discount</th>
                                                                ...
                                                                <tr>
                                                                    <th colspan="3" id="tdmonthclspn" runat="server">Total :
                                                                    </th>
                                                                    <th class="txtalignrights">
                                                                        <asp:Label ID="lbl_fee_amount" runat="server" Text=""></asp:Label>
                                                                    </th>
                                                                    <th class="txtalignrights">
                                                                        <asp:Label ID="lbl_discount" runat="server" Text=""></asp:Label>
                                                                    </th>
                                                                    <th class="txtalignrights">
                                                                        <asp:Label ID="lbl_paid_prev" runat="server" Text=""></asp:Label>
                                                                    </th>
                                                                    <th class="txtalignrights">
                            ...
                            <asp:Label ID="lbl_website" runat="server"></asp:Label>
                                                                    ...
                                                                    <asp:Repeater ID="rl_ledger" runat="server" OnItemDataBound="rl_ledger_ItemDataBound">
                                                                        <itemtemplate>
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <asp:LinkButton ID="lnk_edit" Visible="false" runat="server" OnClick="lnk_edit_Click"><span class="material-symbols-outlined" style="font-size: 18px;">edit_square</span></asp:LinkButton>
                                                ...
                                                <div class="fnd-box-wpr" style="margin: 5px 0px 0px 0px;">
                                                    ...
                                                    <div class="fnd-box-wpr-inr">
                                                        ...
                                                        <div class="fnd-box-row-wpr">
                                                            <div class="row">
                                                                <div class="col-md-3" style="position: relative">
                                                                    <label for="validationCustom01" class="form-label-fnds">Apply Discount  </label>
                                                                    <p runat="server" id="P33" onclick="discApply()" style="position: absolute; right: 0; top: -2px;" data-toggle="modal" data-target="#mdlDiscount" class="button-6161 disc-pupup-btn floatrght"><span class="material-symbols-outlined" style="font-size: 17px;">add</span></p>
                                                                </div>
                                                                <div class="col-md-3 padd-lft0">
                                                                    ...
                                                                    <script>
                                                                        ...
                                                                        function ShowHideDiv(chkPassport) {
                                                                            ...
                                                                            if ($(chkPassport).prop('checked') == true) {
                                                                                ...
                                                                                ///===TO BE Paid
                                                                                var isAutoFill = $("#<%=hd_is_auto_paid_fill.ClientID %>").val();
                                                                                if (isAutoFill == "1") {
                                                                                    $("#<%=txt_paid_amount.ClientID %>").val(ttl_m_an_net_apyable_amount.toFixed());
                                                                                }
                                                                                ///===TO BE Paid
                                                                            }
                                                                            else {
                                                                                ...
                                                                                var isAutoFill = $("#<%=hd_is_auto_paid_fill.ClientID %>").val();
                                                                                if (isAutoFill == "1") {
                                                                                    $("#<%=txt_paid_amount.ClientID %>").val(ttl_m_net_apyable_amount.toFixed());
                                                                                }
                                                                                ///===TO BE Paid
                                                        ...
                                                        <div class="fnd-box-row-wpr" id="pnl_mode_t_nS">
                                                            ...
                                                            <div style="width: 100%; float: left; margin: 10px 0px 0px 0px" id="payeeBankNameDV" runat="server" visible="false">
                                                                <div class="row">
                                                                    <div class="col-md-3">
                                                                        <asp:Label ID="Label15" runat="server" class="form-label-fnds" Text="Payee Bank"></asp:Label>
                                                                    </div>
                                                                    <div class="col-md-9 padd-lft0">
                                                                        <asp:DropDownList ID="ddl_payee_bank" runat="server" class="form-select find-dv-txtbx"></asp:DropDownList>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="fnd-box-row-wpr" style="border: 1px solid #ddd; padding: 3px 7px 6px; border-radius: 3px;"
                                                            ...
                                                            <div class="row" id="sectionAutpDV" runat="server" visible="false">
                                                                <div class="col-md-3">
                                                                    <label for="validationCustom01" class="form-label-fnds">Roll No.</label>
                                                                </div>
                                                                <div class="col-md-3 padd-lft0">
                                                            ...
                                                            <div class="row" id="rollAutodV" runat="server" visible="false">
                                                                <div class="col-md-3">
                                                                    <label for="validationCustom01" class="form-label-fnds">Section</label>
                                                                </div>
                                                                <div class="col-md-3 padd-lft0">
                                                                    <asp:DropDownList ID="ddl_section_assign" runat="server" class="form-select find-dv-txtbx"></asp:DropDownList>
                                                                </div>
                                                                <div class="col-md-3">
                                                                    <label for="validationCustom01" class="form-label-fnds">Roll No.</label>
                                                                </div>
                                                                <div class="col-md-3 padd-lft0">
                                                                    <asp:TextBox ID="txt_roll_assign" runat="server" class="form-control find-dv-txtbx"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                            <asp:Label ID="lbl_class_id" runat="server" Style="display: none"></asp:Label>
                                                            <asp:Label ID="lbl_session_id" runat="server" Style="display: none"></asp:Label>
                                                            <script type="text/javascript">
                                                                $("#<%=ddl_section_assign.ClientID%>").on('change', function () {
                                                                    on_section_selection();
                                                                })
                                                                ...
                                                                function on_section_selection() {
                                                                    var data = {};
                                                                    data.class = $('#<%=lbl_class_id.ClientID%>').text();
                                                                    data.section = $('#<%=ddl_section_assign.ClientID%>').val();
                                                                    data.session_id = $('#<%=lbl_session_id.ClientID%>').text();
                                                                    gowithData('../../api/get-roll-no-list', 'post', JSON.stringify({ data: data }), function (resp) {
                                                                        $('#<%=txt_roll_assign.ClientID%>').val(resp.data[0].MissingRollNumber);
                                                                        $('#rollList').empty();
                                                        ...
                                                        <div class="fnd-box-row-wpr">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6 padd-lft0">
                                                                    ...
                                                                    <asp:LinkButton ID="lnk_apply_coupan" class="applycoupon-stl button-6161 disc-pupup-btn" Visible="false" runat="server" OnClick="lnk_apply_coupan_Click">Apply Coupon</asp:LinkButton>
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header" style="padding: 3px 10px;">
                                                        <h5 class="modal-title" style="font-size: 18px; padding: 5px 0px 0px 0px;">Discount
                                                          <asp:CheckBox ID="chk_is_admission_disc" onclick="ShowHideDivAdm(this)" Text="Discount on Admission" runat="server" />
                                                        </h5>
                                                                ...
                                                                <div class="fnd-box-wpr-inr" style="padding: 0px 0px;">
                                                                    <div id="monthFeeDiscHead">
                                                                        <div class="disc-month-checkbox-sec">
                                                                            <div class="discchkalldv">
                                                                                <asp:CheckBox ID="CheckBox1" Text="Choose All" runat="server" />
                                                                            </div>
                                                                            <div class="disc-grid-wpr" id="discRep">
                                                                                <asp:Repeater ID="rp_month_for_discount" runat="server">
                                                                                    <itemtemplate>
                                                                                        <asp:CheckBox ID="chk_month_discount" CssClass="dischk" Text='<%#Eval("Month") %>' runat="server" />
                                                                        ...
                                                                        <script type="text/javascript">
                                                                            $('#<%= CheckBox1.ClientID %>').on('change', function () {
                                                                                $('#discRep input').prop('checked', $(this).prop('checked'))
                                                                            })
                                                                        </script>
                                                                            ...
                                                                            <table class="table table-striped table-bordered dataTable" style="border-bottom: 1px solid #adadad; border-left: 1px solid #adadad; border-top: 1px solid #adadad; margin-bottom: 0px !important;">
                                                                                ...
                                                                                <tbody>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>
                                                                                            <asp:Label ID="lbl_total_head_fee_for_head" Style="font-weight: bold;" runat="server"></asp:Label>
                                                                                        </td>
                                                                                        <td>
                                                                                            <asp:Label ID="lbl_total_disc" runat="server" Style="font-weight: bold;"></asp:Label>
                                                                                        </td>
                                                                                        <td></td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            ...
                                                                            <table class="table table-striped table-bordered dataTable" style="border-bottom: 1px solid #adadad; border-left: 1px solid #adadad; border-top: 1px solid #adadad; margin-bottom: 0px !important; margin-top: 0px !important;">
                                                                                ...
                                                                                <tbody>
                                                                                    <asp:Repeater ID="rp_fee_head_admission" runat="server">
                                                                                        <itemtemplate>
                                                                                            <tr>
                                                                                                ...
                                                                                                <td>
                                                                                                    <asp:TextBox ID="txt_adm_disc_perc" runat="server" Text='0' Style="width: 80px;" onkeypress="return isNumberKey(event)"></asp:TextBox>
                                                                                                </td>
                                                                                            </tr>
                                                                                        </itemtemplate>
                                                                                    </asp:Repeater>
                                                                                    <tr>
                                                                                        ...
                                                                                        <td style="text-align: right; font-weight: 700;">TOTAL</td>
                                                                                        <td>
                                                                                            <asp:Label ID="lbl_total_head_fee_for_head_adm" Style="font-weight: bold;" runat="server"></asp:Label>
                                                                                        </td>
                                                                                        <td>
                                                                                            <asp:Label ID="lbl_total_disc_adm" runat="server" Style="font-weight: bold;"></asp:Label>
                                                                                        </td>
                                                                                        <td></td>
                                                                                    </tr>
                                                                                </tbody>
                                                                    ...
                                                                    <div class="disc-pop-grid-sec" id="discgridDV" runat="server">
                                                                        <h2>List of Applied Discount</h2>
                                                                        <table id="example21" class="table table-striped table-bordered dataTable" role="grid" aria-describedby="example2_info">
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:Label ID="lbl_ttl_disc_amtss1" runat="server"></asp:Label>
                                                                                    </td>
                                                                                    <td>
                                                                                        <asp:Label ID="lbl_ttl_disc_amtss2" runat="server"></asp:Label>
                                                                                    </td>
                                                                                    <td>
                                                                                        <asp:Label ID="lbl_ttl_disc_amtss3" runat="server"></asp:Label>
                                                                                    </td>
                                                                                    <td colspan="3">-</td>
                                                                                </tr>
                                                                            </tbody>
                                        ...
                                        <div id="myModalDiscError" class="modal fade" role="dialog">
                                            <div class="modal-dialog" style="max-width: 800px;">
                                                <div class="modal-content">
                                                    <div class="modal-header" style="padding: 3px 10px;">
                                                        <h5 class="modal-title" style="font-size: 18px; padding: 5px 0px 0px 0px;">Discount Alert</h5>
                                                        <a href="#!" data-dismiss="modal" style="margin: 5px 0px 0px 0px !important; padding: 3px 5px 4px 5px; background: #fa2020; border: #9b0202;"
                                                            class="btn btn-primary find-dv-btn">Close</a>
                                                    </div>
                                                    <div class="modal-body" style="padding: 5px 5px;">
                                                        <div class="p-4 border rounded" style="float: left; width: 100%; padding: 5px 5px !important;">
                                                            <div class="disc-pop-dv-wpr">
                                                                <div class="fnd-box-wpr-inr" style="padding: 0px 0px;">
                                                                    <div class="discalertmsgdv">
                                                                        <img src="../assets/images/error-con.png" class="discalertmsgimg" />
                                                                        <p class="discalertmsgp">
                                                                            A discount has already been applied to this fee head, and the bill has been finalized. Consequently, a discount lower than the previously applied amount cannot be processed for this fee head. 
                                                                            <br />
                                                                            <span>(इस शुल्क पर पहले ही छूट लागू की जा चुकी है और बिल को अंतिम रूप दे दिया गया है। नतीजतन, इस शुल्क के लिए पहले लागू की गई राशि से कम छूट संसाधित नहीं की जा सकती है।)</span>
                                                                        </p>
                                                                    </div>
                                                                    <div class="disc-pop-tbl-wpr">
                                                                        <p class="discalertmsgp1">Previous Applied Discount List</p>
                                                                        <table class="table table-striped table-bordered dataTable" style="border-bottom: 1px solid #adadad; border-left: 1px solid #adadad; border-top: 1px solid #adadad; margin-bottom: 0px !important; margin-top: 0px !important;">
                                                                            <thead>
                                                                                <tr>
                                                                                    <th>#</th>
                                                                            ...
                                                                            <tbody>
                                                                                <asp:Repeater ID="rp_error_disc" runat="server">
                                                                                    <itemtemplate>
                                                                                        <tr>
                                                                                            <td>
                                                                                                <asp:Label ID="lbl_SL" runat="server" Text='<%#Container.ItemIndex+1 %>'></asp:Label>
                                                                                            ...
                                                                                            <td>
                                                                                                <asp:Label ID="lbl_adm_content" runat="server" Text='<%#Bind("Discount_on") %>'></asp:Label>
                                                                                            </td>
                                                                                            <td>
                                                                                                <asp:Label ID="Label6" runat="server" Text='<%#Bind("Month") %>'></asp:Label>
                                                                                            </td>
                                                                                            <td>
                                                                                                <asp:Label ID="Label12" runat="server" Text='<%#Bind("Content") %>'></asp:Label>
                                                                                            </td>
                                                                                            <td>
                                                                                                <asp:Label ID="Label13" runat="server" Text='<%#Bind("Amount") %>'></asp:Label>
                                                                                            </td>
                                                                                            <td>
                                                                                                <asp:Label ID="Label14" runat="server" Text='<%#Bind("Discount_amt") %>'></asp:Label>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </itemtemplate>
                                                                                </asp:Repeater>
                                        ...
                                        <script type="text/javascript">  
                                            ...
                                            $("[Id*=txt_disc_fee]").on('input', function () {
                                                var disc = parseFloat($(this).val());
                                                var tr = $(this).closest('tr');
                                                var txt_head_fee = tr.find('[Id*=txt_head_fee]');
                                                var txt_disc_perc = tr.find('[Id*=txt_disc_perc]');
                                                var txt_disc_fee = tr.find('[Id*=txt_disc_fee]');

                                                if (disc > parseFloat(txt_head_fee.val())) {
                                                    txt_disc_fee.val(txt_head_fee.val());
                                                    disc = parseFloat(txt_head_fee.val());
                                                }
                                                ...
                                                var disc_perc = (parseFloat(disc) / (parseFloat(txt_head_fee.val()))) * 100;
                                                txt_disc_perc.val(disc_perc);
                                            });


                                            $("[Id*=txt_disc_perc]").on('input', function () {
                                                var disc_perc = parseFloat($(this).val());
                                                var tr = $(this).closest('tr');
                                                var txt_head_fee = tr.find('[Id*=txt_head_fee]');
                                                var txt_disc_fee = tr.find('[Id*=txt_disc_fee]');
                                                var txt_disc_perc = tr.find('[Id*=txt_disc_perc]');
                                                ...
                                                if (disc_perc > 100) {
                                                    txt_disc_perc.val(100);
                                                    disc_perc = 100;
                                                }
                                                if (isNaN(parseFloat(disc_perc))) {
                                                    txt_disc_perc.val(0);
                                                    disc_perc = 0;
                                                }


                                                var disc_amt = (parseFloat(txt_head_fee.val()) * parseFloat(disc_perc)) / 100;
                                                txt_disc_fee.val(disc_amt);
                                            });


                                            ///=========================ADMISSION
                                            $("[Id*=txt_adm_disc_fee]").on('input', function () {
                                                var disc = parseFloat($(this).val());
                                                var tr = $(this).closest('tr');
                                                var txt_adm_head_fee = tr.find('[Id*=txt_adm_head_fee]');
                                                var txt_adm_disc_perc = tr.find('[Id*=txt_adm_disc_perc]');
                                                var txt_adm_disc_fee = tr.find('[Id*=txt_adm_disc_fee]');

                                                if (disc > parseFloat(txt_adm_head_fee.val())) {
                                                    txt_adm_disc_fee.val(txt_adm_head_fee.val());
                                                    disc = parseFloat(txt_adm_head_fee.val());
                                                }
                                                if (isNaN(parseFloat(disc))) {
                                                    txt_adm_disc_fee.val(0);
                                                    disc = 0;
                                                }


                                                var disc_perc = (parseFloat(disc) / (parseFloat(txt_adm_head_fee.val()))) * 100;
                                                txt_adm_disc_perc.val(disc_perc);
                                            });


                                            $("[Id*=txt_adm_disc_perc]").on('input', function () {
                                                var disc_perc = parseFloat($(this).val());
                                                var tr = $(this).closest('tr');
                                                var txt_adm_head_fee = tr.find('[Id*=txt_adm_head_fee]');
                                                var txt_adm_disc_fee = tr.find('[Id*=txt_adm_disc_fee]');
                                                ...
                                                if (disc_perc > 100) {
                                                    txt_adm_disc_perc.val(100);
                                                    disc_perc = 100;
                                                }
                                                if (isNaN(parseFloat(disc_perc))) {
                                                    txt_adm_disc_perc.val(0);
                                                    disc_perc = 0;
                                                }
                                                var disc_amt = (parseFloat(txt_adm_head_fee.val()) * parseFloat(disc_perc)) / 100;
                                                txt_adm_disc_fee.val(disc_amt);
                                            });
                                            ...
                                            function CalculateTotal() {
                                                ...
                                                $("[Id*=txt_disc_perc").each(function () {
                                                    $("[Id*=txt_disc_perc").focus(function () { $(this).select(); });
                                                });
                                            ...
                                            function CalculateTotalAdm() {
                                                ...
                                                $("[Id*=txt_adm_disc_perc").each(function () {
                                                    $("[Id*=txt_adm_disc_perc").focus(function () { $(this).select(); });
                                                });
                        ...
                        <div class="adm-box-wprs1">
                            <table style="width: 100%;" class="table table-hover table-bordered">
                                <tr>
                                    ...
                                    <th class="hidden"></th>
                                    <th class="hidden"></th>
                                    <th style="text-align: center" id="chkalltdadm" runat="server">
                                        <asp:CheckBox class="boxadm" ID="chkAll" runat="server" Checked="true" />
                                    </th>
                                ...
                                <asp:Repeater ID="grd_fee_adm_fee" runat="server" OnItemDataBound="grd_fee_adm_fee_ItemDataBound">
                                    <itemtemplate>
                                        <tr id="row" runat="server">
                                            ...
                                            <td class="hidden"></td>
                                            <td class="hidden"></td>
                                            <td style="text-align: center" id="tdHideAdm" runat="server">
                                ...
                                <tr>
                                    <th colspan="2" id="admttltdclspN" runat="server">Total :
                                    </th>
                                    <th class="txtalignrights">
                                        <asp:Label ID="lbl_ttl_adm_payble" runat="server" Text=""></asp:Label>
                                    </th>
                                    <th class="txtalignrights">
                                        <asp:Label ID="lbl_ttl_adm_disc" runat="server" Text=""></asp:Label>
                                    </th>
                                    <th class="txtalignrights">
                                        <asp:Label ID="lbl_ttl_prev_adm_paid" runat="server" Text=""></asp:Label>
                                    </th>
                                    <th class="txtalignrights">
                                        <asp:Label ID="lbl_adm_net_payble" runat="server" Text=""></asp:Label>
                                    </th>
                                </tr>

                                <tr>
                                    <th colspan="2" id="finalftrttladm" runat="server">
                                        <asp:Label ID="lbl_amount_to_be_paid" runat="server" Style="font-size: 14px;"></asp:Label>
                                    </th>
                                    <th colspan="2" id="finalttlftrbtnchk" runat="server" class="isChangeAdmAmt" style="white-space: nowrap; word-break: keep-all;">
                    ...
                    <div class="modal-body" style="padding: 5px 5px;">
                        <div class="p-4 border rounded" style="float: left; width: 100%; padding: 5px 5px !important;">
                            <div class="disc-pop-dv-wpr">
                                <div class="fnd-box-wpr-inr" style="padding: 0px 0px;">
                                    <div class="disc-pop-txtbx-sec">
                                        <div class="disc-month-checkbox-sec" id="extHeadMnth">
                                            <div class="discchkalldv">
                                                <asp:CheckBox ID="CheckBox2" Text="Choose All" runat="server" />
                                            </div>
                                            <div class="disc-grid-wpr" id="feeheadMnth">
                                                <asp:Repeater ID="rp_extra_head_month" runat="server">
                                                    <itemtemplate>
                                                        <asp:CheckBox ID="chk_month_eH" Text='<%#Eval("Month") %>' runat="server" />
                                                        <asp:Label ID="lbl_Month_eH" runat="server" Visible="false" Text='<%#Bind("Month")%>'></asp:Label>
                                                        <asp:Label ID="lbl_month_id" runat="server" Visible="false" Text='<%#Bind("Month_Id")%>'></asp:Label>
                                                        <asp:Label ID="lbl_month_position" runat="server" Visible="false" Text='<%#Bind("Position")%>'></asp:Label>
                                                    </itemtemplate>
                                                </asp:Repeater>
                                            </div>
                                        </div>
                                        <script type="text/javascript">
                                            $('#<%= CheckBox2.ClientID %>').on('change', function () {
                                                $('#feeheadMnth input').prop('checked', $(this).prop('checked'))
                                            })
                                        </script>
                                        <div class="row">
                                            <div class="col-md-2">
                                        ...
                                        <table class="table table-striped table-bordered dataTable" role="grid" aria-describedby="example2_info">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:Label ID="lbl_ttl_extra_fee" runat="server" Style="font-weight: 600"></asp:Label>
                                                    </td>
                                                    <td colspan="2">-</td>
                                                </tr>
                                            </tbody>
                    ...
                    <div class="modal-body" style="padding: 5px 5px;">
                        <div class="p-4 border rounded">
                            <div class="row g-3 needs-validation" novalidate="" id="mappedTransporTDV" runat="server">
                                <div class="col-md-12">
                                    <div style="width: 100%; float: left; background: #d3d3af; padding: 0px 5px 5px 6px; border: 1px solid #d7a8a8; border-radius: 3px;">
                                        <p style="margin: 1px 0px 2px 0px; padding: 0px 0px 4px 0px; font-size: 15px; font-weight: 600; border-bottom: 1px solid #ddd;">
                                            Transport Assigned Details
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2 noclick">
                                                <label for="validationCustom01" class="form-label">From Month</label>
                                                <asp:DropDownList ID="ddl_monthname" runat="server" class="form-select">
                                                </asp:DropDownList>
                                            </div>
                                            <div class="col-md-3 noclick">
                                            ...
                                            <div class="col-md-4 noclick">
                                                <label for="validationCustom01" class="form-label">Boarding Point</label>
                                                <div class="select2-dv">
                                                    <asp:DropDownList ID="ddl_boarding_point" runat="server" CssClass="single-select"></asp:DropDownList>
                                                </div>
                                            </div>
                                            <asp:Button ID="btn_Submit" runat="server" Text="Update" Style="display: none" CssClass="btn btn-primary" ValidationGroup="a" OnClick="btn_Submit_Click" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div style="width: 100%; margin: 5px 0px 0px 0px; float: left; background: #efff00; padding: 0px 5px 5px 6px; border: 1px solid #e5e900; border-radius: 3px;">
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <label for="validationCustom01" class="form-label">Remove From Month</label>
                                                        <asp:DropDownList ID="ddl_transport_remove_month" runat="server" class="form-select"></asp:DropDownList>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <label for="validationCustom01" class="form-label">Remarks<sup>*</sup></label>
                                                        <asp:TextBox ID="txt_transport_remove_remark" runat="server" class="form-control"></asp:TextBox>
                                                    </div>
                                                    <div class="col-md-5">
                                                        <asp:Button ID="btn_remove_transport" OnClick="btn_remove_transport_Click" OnClientClick="return confirm('Are you sure you want to remove transport from this student?');" runat="server" Text="Remove Transport From This Student" Style="float: left; background: #f00; padding: 2px 7px 4px 7px; border: 1px solid #c10000; font-weight: 600; margin: 24px 0px 0px 0px;"
                            ...
                            <div class="row g-3 needs-validation" novalidate="" id="TransportMapping" runat="server">
                                <div class="col-12">
                                    <div style="width: 100%; float: left; background: #fffde0; padding: 0px 5px 5px 6px; border: 1px solid #fdc2c2; border-radius: 3px;">
                                        <div class="row">
                                            <div class="col-2">
                                            ...
                                            <div class="col-3">
                                                <label for="validationCustom01" class="form-label">Boarding Point</label>
                                                <div class="select2-dv">
                                                    <asp:DropDownList ID="ddl_boarding_point_map" runat="server" CssClass="single-select"></asp:DropDownList>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div style="width: 100%; margin: 5px 0px 0px 0px; float: left; background: #efff00; padding: 0px 5px 5px 6px; border: 1px solid #e5e900; border-radius: 3px;">
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <label for="validationCustom01" class="form-label">Remove From Month</label>
                                                        <asp:DropDownList ID="ddl_hostel_remove_month" runat="server" class="form-select"></asp:DropDownList>
                                                    </div>
                                                    <div class="col-md-7">
                                                        <label for="validationCustom01" class="form-label">Remark<sup>*</sup></label>
                                                        <asp:TextBox ID="txt_h_rmov_remark" runat="server" class="form-control"></asp:TextBox>
                                                    </div>
                                                    <asp:TextBox ID="TextBox1" runat="server" Visible="false"></asp:TextBox>
                                                    <asp:DropDownList ID="DropDownList1" runat="server" Visible="false"></asp:DropDownList>
                                                    <div class="col-md-2">
                                                        <asp:Button ID="btn_remove_hostel" OnClick="btn_remove_hostel_Click" OnClientClick="return confirm('Are you sure you want to remove hostel from this student?');" runat="server" Text="Remove Hostel" Style="float: right; font-weight: 700; background: #f00; padding: 2px 7px 4px 7px; border: 1px solid #c10000; font-weight: 600; margin: 25px 0px 0px 0px;"
                                                            class="btn btn-dark" CausesValidation="false" />
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="row g-3 needs-validation" novalidate="" id="mappingHostelDV" runat="server">
                                <div class="col-12">
                                    <div style="width: 100%; float: left; background: #fffde0; padding: 0px 5px 5px 6px; border: 1px solid #fdc2c2; border-radius: 3px;">
                                        ...
                                        <asp:Button ID="btn_assign_hostel" runat="server" Style="margin: 10px 0px 0px 0px;" Text="Save" CssClass="btn btn-primary" OnClick="btn_assign_hostel_Click" />
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="std-search-wpr" runat="server" id="angStd">
                                <table class="table table-bordered">
                                    <tr>
                                        ...
                                        <th>Mother Name</th>
                                        <th>Mobile No.</th>
                                        <th class="{{reportStd[0].Is_RegShow}}">Reg./Ac. No.</th>
                                        <th></th>
                                    </tr>
                                    <tr data-ng-repeat="x in reportStd | filter : searchs">
                                        ...
                                        <td>{{x.MotherName}}</td>
                                        <td>{{x.Mobile_no}}</td>
                                        <td class="{{reportStd[0].Is_RegShow}}">{{x.Admission_no_date}}</td>
                                        <td class="hiddenOnPrint"><a style="background-color: #f7f100; min-width: 30px; color: #000;"
        ...
        <script type="text/javascript">
            ...
            app.controller('RpFeeAppCtrl', function ($scope, $http, $exceptionHandler) {
                ...
                var firm_id = $("#<%=hd_firm_id.ClientID %>").val();
                ...
                $http.get("webServices/student-note.asmx/fetch_student_data", { params: { "Session_id": session_idstd, "Firm_id": firm_id } }).then(function (response) {
