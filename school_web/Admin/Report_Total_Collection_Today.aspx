<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="Report_Total_Collection_Today.aspx.cs" Inherits="school_web.Admin.Report_Total_Collection_Today" EnableEventValidation="false" ValidateRequest="false" %>
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Total Collection</li>
                        </ol>
                    </nav>
                </div>
            </div>
