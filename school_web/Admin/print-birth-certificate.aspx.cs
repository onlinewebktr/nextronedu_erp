...
{
    public partial class print_birth_certificate : System.Web.UI.Page
    {
        My mycode = new My();
        ...
        //        check_certificate_created(character, dob, bonafied, leaving, bonafied_fees, lbl_adm_no.Text, lbl_session_id.Text, lbl_class_id.Text);
        ...
        protected void lnkDel_Click(object sender, EventArgs e)
        {
            if (ViewState["Is_delete"].ToString() == "1")
            {
                ...
                mycode.executequery("delete from Certificate_Master where Session_id='" + lbl_session_id.Text + "' and Class_id='" + lbl_class_id.Text + "' and Admission_no='" + lbl_adm_no.Text + "' and Certificate_type='DOB'");
                string desc = "DOB certificate has been delete for certificate no. " + lbl_certificate_no.Text + ".";
                log_hostory.delete_log(lbl_session_id.Text, lbl_class_id.Text, lbl_adm_no.Text, "DOB Certificate", desc, "print-birth-certificate.aspx", ViewState["Userid"].ToString());
