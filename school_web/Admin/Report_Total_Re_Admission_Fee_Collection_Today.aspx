<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="Report_Total_Re_Admission_Fee_Collection_Today.aspx.cs" Inherits="school_web.Admin.Report_Total_Re_Admission_Fee_Collection_Today" EnableEventValidation="false" ValidateRequest="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Annual Fees Collection Today Report
</asp:Content>
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Annual Fees Collection Today Report</li>
                        </ol>
                    </nav>
                </div>
            </div>
