...
{
    /// <summary>
    /// Summary description for dcr_all_fee
    /// </summary>
    ...
    public class dcr_all_fee : System.Web.Services.WebService
    {
        #region MonthlY
        ...
        public void fetch_report_heading_day_end_amts(string Session_id, string Class_id, string FromDate, string ToDate, string Type, string Session_name, string Class_name, string Collection_type)
        {
            ...
            if (Session_id == "0" && Class_id == "0")
            {
                query = "select * from (select *,(select top 1 name from user_details where user_id=t.By_user_id) as By_user_name from (select DISTINCT t1.session,t2.Session_id,t2.Class_id,t1.slipno,t2.studentname,t2.fathername,t2.class,t2.Section,t1.adno,t2.rollnumber,(select top 1 mode from Student_Payment_History where Slip_no=t1.slipno and Session=t1.Session) as Payment_mode,(select top 1 Pay_mode_transaction_no from Student_Payment_History where Slip_no=t1.slipno and Session=t1.Session) as Transaction_Id,(select top 1 user_id from Student_Payment_History where Slip_no=t1.slipno and Session=t1.Session) as By_user_id,t1.Date,t1.Idate,(select top 1 Id from Student_Payment_History where Slip_no=t1.slipno and Session=t1.Session) as RowId,'0' as Type,'0' as Amount from Monthly_Fee_Collection_Slip t1 join admission_registor t2 on t1.session=t2.session and t1.adno=t2.admissionserialnumber where t1.Idate>='" + My.DateConvertToIdate(FromDate) + "' and t1.Idate<='" + My.DateConvertToIdate(ToDate) + "') t union all select (select top 1 Session from session_details where session_id=t1.Session_id) as session,Session_id,t1.Class_id,recpt_no as slipno,student_name as studentname,fathers_name as fathername,class,'-' as Section,'-' as adno,'-' as rollnumber,Payment_Mode as Payment_mode,Bank_tran_no as Transaction_Id,Created_by as By_user_id,Created_date as Date,Created_idate as Idate,'0' as RowId,'1' as Type,Amount,(select top 1 name from user_details where user_id=t1.Created_by) as By_user_name from Form_sale_details t1 where t1.idate>='" + My.DateConvertToIdate(FromDate) + "' and t1.idate<='" + My.DateConvertToIdate(ToDate) + "') t order by try_cast(slipno as int ) asc";//order by RowId asc
            }
            else if (Session_id != "0" && Class_id == "0")
            {
                query = "select * from (select *,(select top 1 name from user_details where user_id=t.By_user_id) as By_user_name from (select DISTINCT t1.session,t2.Session_id,t2.Class_id,t1.slipno,t2.studentname,t2.fathername,t2.class,t2.Section,t1.adno,t2.rollnumber,(select top 1 mode from Student_Payment_History where Slip_no=t1.slipno and Session=t1.Session) as Payment_mode,(select top 1 Pay_mode_transaction_no from Student_Payment_History where Slip_no=t1.slipno and Session=t1.Session) as Transaction_Id,(select top 1 user_id from Student_Payment_History where Slip_no=t1.slipno and Session=t1.Session) as By_user_id,t1.Date,t1.Idate,(select top 1 Id from Student_Payment_History where Slip_no=t1.slipno and Session=t1.Session) as RowId,'0' as Type,'0' as Amount from Monthly_Fee_Collection_Slip t1 join admission_registor t2 on t1.session=t2.session and t1.adno=t2.admissionserialnumber where t1.session='" + Session_name + "' and t1.Idate>='" + My.DateConvertToIdate(FromDate) + "' and t1.Idate<='" + My.DateConvertToIdate(ToDate) + "') t union all select (select top 1 Session from session_details where session_id=t1.Session_id) as session,Session_id,t1.Class_id,recpt_no as slipno,student_name as studentname,fathers_name as fathername,class,'-' as Section,'-' as adno,'-' as rollnumber,Payment_Mode as Payment_mode,Bank_tran_no as Transaction_Id,Created_by as By_user_id,Created_date as Date,Created_idate as Idate,'0' as RowId,'1' as Type,Amount,(select top 1 name from user_details where user_id=t1.Created_by) as By_user_name from Form_sale_details t1 where t1.session='" + Session_name + "' and t1.idate>='" + My.DateConvertToIdate(FromDate) + "' and t1.idate<='" + My.DateConvertToIdate(ToDate) + "') t order by try_cast(slipno as int ) asc";
            ...
            {
                query = "select * from (select *,(select top 1 name from user_details where user_id=t.By_user_id) as By_user_name from (select DISTINCT t1.session,t2.Session_id,t2.Class_id,t1.slipno,t2.studentname,t2.fathername,t2.class,t2.Section,t1.adno,t2.rollnumber,(select top 1 mode from Student_Payment_History where Slip_no=t1.slipno and Session=t1.Session) as Payment_mode,(select top 1 Pay_mode_transaction_no from Student_Payment_History where Slip_no=t1.slipno and Session=t1.Session) as Transaction_Id,(select top 1 user_id from Student_Payment_History where Slip_no=t1.slipno and Session=t1.Session) as By_user_id,t1.Date,t1.Idate,(select top 1 Id from Student_Payment_History where Slip_no=t1.slipno and Session=t1.Session) as RowId,'0' as Type,'0' as Amount from Monthly_Fee_Collection_Slip t1 join admission_registor t2 on t1.session=t2.session and t1.adno=t2.admissionserialnumber where (t1.class='" + Class_id + "' or t1.class='" + Class_name + "') and t1.Idate>='" + My.DateConvertToIdate(FromDate) + "' and t1.Idate<='" + My.DateConvertToIdate(ToDate) + "') t union all select (select top 1 Session from session_details where session_id=t1.Session_id) as session,Session_id,t1.Class_id,recpt_no as slipno,student_name as studentname,fathers_name as fathername,class,'-' as Section,'-' as adno,'-' as rollnumber,Payment_Mode as Payment_mode,Bank_tran_no as Transaction_Id,Created_by as By_user_id,Created_date as Date,Created_idate as Idate,'0' as RowId,'1' as Type,Amount,(select top 1 name from user_details where user_id=t1.Created_by) as By_user_name from Form_sale_details t1 where t1.Class_id='" + Class_id + "' and t1.idate>='" + My.DateConvertToIdate(FromDate) + "' and t1.idate<='" + My.DateConvertToIdate(ToDate) + "') t order by try_cast(slipno as int ) asc";
            ...
            {
                query = "select * from (select *,(select top 1 name from user_details where user_id=t.By_user_id) as By_user_name from (select DISTINCT t1.session,t2.Session_id,t2.Class_id,t1.slipno,t2.studentname,t2.fathername,t2.class,t2.Section,t1.adno,t2.rollnumber,(select top 1 mode from Student_Payment_History where Slip_no=t1.slipno and Session=t1.Session) as Payment_mode,(select top 1 Pay_mode_transaction_no from Student_Payment_History where Slip_no=t1.slipno and Session=t1.Session) as Transaction_Id,(select top 1 user_id from Student_Payment_History where Slip_no=t1.slipno and Session=t1.Session) as By_user_id,t1.Date,t1.Idate,(select top 1 Id from Student_Payment_History where Slip_no=t1.slipno and Session=t1.Session) as RowId,'0' as Type,'0' as Amount from Monthly_Fee_Collection_Slip t1 join admission_registor t2 on t1.session=t2.session and t1.adno=t2.admissionserialnumber where t1.session='" + Session_name + "' and (t1.class='" + Class_id + "' or t1.class='" + Class_name + "') and t1.Idate>='" + My.DateConvertToIdate(FromDate) + "' and t1.Idate<='" + My.DateConvertToIdate(ToDate) + "') t union all select (select top 1 Session from session_details where session_id=t1.Session_id) as session,Session_id,t1.Class_id,recpt_no as slipno,student_name as studentname,fathers_name as fathername,class,'-' as Section,'-' as adno,'-' as rollnumber,Payment_Mode as Payment_mode,Bank_tran_no as Transaction_Id,Created_by as By_user_id,Created_date as Date,Created_idate as Idate,'0' as RowId,'1' as Type,Amount,(select top 1 name from user_details where user_id=t1.Created_by) as By_user_name from Form_sale_details t1 where t1.session='" + Session_name + "' and t1.Class_id='" + Class_id + "' and t1.idate>='" + My.DateConvertToIdate(FromDate) + "' and t1.idate<='" + My.DateConvertToIdate(ToDate) + "') t order by try_cast(slipno as int ) asc";
            ...
            else
            {
                ...
                {
                    List<MyFeeReport> MBdetails = findmyCollectionDt(dr["adno"].ToString(), dr["slipno"].ToString(), Session_id, Class_id, FromDate, ToDate, Type, Session_name, Class_name, dr["Type"].ToString(), dr["Amount"].ToString(), dr["Session_id"].ToString(), dr["Class_id"].ToString(), dr["session"].ToString(), dr["class"].ToString());
                    string months = "-";
                    ...
                    {
                        months = get_months_of_invoice(dr["slipno"].ToString(), dr["session"].ToString(), dr["adno"].ToString());
                    }
                    string paids_amt = "";
                    if (dr["Type"].ToString() == "1")
                    {
                    ...
                    {
                        paids_amt = get_ttl_amt_of_a_std(dr["adno"].ToString(), dr["slipno"].ToString(), Session_id, Class_id, FromDate, ToDate, Type, Session_name, Class_name, dr["Session_id"].ToString(), dr["Class_id"].ToString(), dr["session"].ToString(), dr["class"].ToString());
                    }
        ...
        private string get_ttl_amt_of_a_std(string Admission_no, string Slip_no, string session_id, string class_id, string fromDate, string toDate, string type, string session_name, string class_name, string Session_idF, string Class_idF, string sessionF, string classF)
        {
            string querys = "";
            querys = "select (isnull(sum(convert(float, payable)),0)-isnull(sum(convert(float, previously_paid)),0)) as Payble_amt,isnull(sum(convert(float, paid)),0) as Paid_amt from Monthly_Fee_Collection_Slip where adno='" + Admission_no + "' and slipno='" + Slip_no + "' and Session='" + sessionF + "'";
            string paids_amt = "0";
        ...
        private List<MyFeeReport> findmyCollectionDt(string Admission_no, string Slip_no, string Session_id, string Class_id, string FromDate, string ToDate, string Type, string Session_name, string Class_name, string FormSaleType, string formSaleAmt, string Session_idF, string Class_idF, string sessionF, string classF)
        {
            List<MyFeeReport> MyFeeReportItem = new List<MyFeeReport>();
            string querys = "";
            if (Session_id == "0" && Class_id == "0")
            {
                querys = @"select distinct Content from Monthly_Fee_Collection_Slip where  Idate>='" + My.DateConvertToIdate(FromDate) + "' and Idate<='" + My.DateConvertToIdate(ToDate) + @"' union all select top 1 'Form Sale' as Content from Form_sale_details where idate>='" + My.DateConvertToIdate(FromDate) + "' and Idate<='" + My.DateConvertToIdate(ToDate) + @"' order by Content desc; 
            ...
            else if (Session_id != "0" && Class_id == "0")
            {
                ...
                querys = @"select distinct Content from Monthly_Fee_Collection_Slip where session='" + Session_name + "' and Idate>='" + My.DateConvertToIdate(FromDate) + "' and Idate<='" + My.DateConvertToIdate(ToDate) + @"' union all select top 1 'Form Sale' as Content from Form_sale_details where session='" + Session_name + "'   and idate>='" + My.DateConvertToIdate(FromDate) + "' and idate<='" + My.DateConvertToIdate(ToDate) + @"' order by Content desc; 
                           select (isnull(sum(convert(float, payable)),0)-isnull(sum(convert(float, previously_paid)),0)) as Payble_amt,isnull(sum(convert(float, paid)),0) as Paid_amt from Monthly_Fee_Collection_Slip where adno='" + Admission_no + "' and slipno='" + Slip_no + @"' and parameter in ('HostelAnnualFee','AdmissionFee','AnnualFee','HostelAdmissionFee');
            ...
            else if (Session_id == "0" && Class_id != "0")
            {
                ...
                querys = @"select distinct Content from Monthly_Fee_Collection_Slip where (class='" + Class_id + "' or class='" + Class_name + "') and  Idate>='" + My.DateConvertToIdate(FromDate) + "' and Idate<='" + My.DateConvertToIdate(ToDate) + @"' union all select top 1 'Form Sale' as Content from Form_sale_details where Class_id='" + Class_id + "' and idate>='" + My.DateConvertToIdate(FromDate) + "' and idate<='" + My.DateConvertToIdate(ToDate) + @"' order by Content desc;
                           select (isnull(sum(convert(float, payable)),0)-isnull(sum(convert(float, previously_paid)),0)) as Payble_amt,isnull(sum(convert(float, paid)),0) as Paid_amt from Monthly_Fee_Collection_Slip where adno='" + Admission_no + "' and slipno='" + Slip_no + @"' and parameter in ('HostelAnnualFee','AdmissionFee','AnnualFee','HostelAdmissionFee');
            ...
            else
            {
                ...
                querys = @"select distinct Content from Monthly_Fee_Collection_Slip where session='" + Session_name + "' and (class='" + Class_id + "' or class='" + Class_name + "') and Idate>='" + My.DateConvertToIdate(FromDate) + "' and Idate<='" + My.DateConvertToIdate(ToDate) + @"' union all select top 1 'Form Sale' as Content from Form_sale_details where session='" + Session_name + "' and Class_id='" + Class_id + "' and idate>='" + My.DateConvertToIdate(FromDate) + "' and idate<='" + My.DateConvertToIdate(ToDate) + @"' order by Content desc;
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                if (dtD.Rows.Count > 0)
                {
                    ...
                    {
                        string paid_amt = get_fees_amt(drr["Content"].ToString(), Admission_no, "0", Type, Slip_no, formSaleAmt, sessionF);
        ...
        private string get_months_of_invoice(string slipno, string session_name, string adm_no)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                month_name = dt.Rows[0]["Month"].ToString();
                if (dt.Rows.Count > 1)
                {
                    month_name = month_name + "-" + dt.Rows[dt.Rows.Count - 1]["Month"].ToString();
                }
            }
            return month_name;
        }
        ...
        private string get_fees_amt(string content, string admission_no, string Dates, string Type, string slip_no, string formSaleAmt, string SessionF)
        {
            string querys = "";
            querys = "select (isnull(sum(convert(float, payable)),0)-isnull(sum(convert(float, previously_paid)),0)) as Payble_amt,isnull(sum(convert(float, paid)),0) as Paid_amt from Monthly_Fee_Collection_Slip where adno='" + admission_no + "' and Content='" + content + "' and slipno='" + slip_no + "' and session='" + SessionF + "'";
            string paids_amt = "0";
