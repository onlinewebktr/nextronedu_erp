...
{
    /// <summary>
    /// Summary description for collection_sheet_dcr_n
    /// </summary>
    ...
    public class collection_sheet_dcr_n : System.Web.Services.WebService
    {
        #region MonthlY
        ...
        public void fetch_report_heading_day_end_amts(string Session_id, string Class_id, string FromDate, string ToDate, string Type, string Session_name, string Class_name, string Collection_type)
        {
            ...
            if (Session_id == "0" && Class_id == "0")
            {
                query = "select * from (select *,(select top 1 name from user_details where user_id=t.By_user_id) as By_user_name from (select DISTINCT t1.slipno,t2.studentname,t2.fathername,t2.class,t2.Section,t1.adno,t2.rollnumber,(select top 1 mode from Student_Payment_History where Slip_no=t1.slipno and Session=t1.Session) as Payment_mode,(select top 1 Pay_mode_transaction_no from Student_Payment_History where Slip_no=t1.slipno and Session=t1.Session) as Transaction_Id,(select top 1 user_id from Student_Payment_History where Slip_no=t1.slipno and Session=t1.Session) as By_user_id,t1.Date,t1.Idate,(select top 1 Id from Student_Payment_History where Slip_no=t1.slipno and Session=t1.Session) as RowId,'0' as Type,'0' as Amount from Monthly_Fee_Collection_Slip t1 join admission_registor t2 on t1.session=t2.session and t1.adno=t2.admissionserialnumber where t1.Idate>='" + My.DateConvertToIdate(FromDate) + "' and t1.Idate<='" + My.DateConvertToIdate(ToDate) + "') t union all select recpt_no as slipno,student_name as studentname,fathers_name as fathername,class,'-' as Section,'-' as adno,'-' as rollnumber,Payment_Mode as Payment_mode,Bank_tran_no as Transaction_Id,Created_by as By_user_id,Created_date as Date,Created_idate as Idate,'0' as RowId,'1' as Type,Amount,(select top 1 name from user_details where user_id=t1.Created_by) as By_user_name from Form_sale_details t1 where t1.idate>='" + My.DateConvertToIdate(FromDate) + "' and t1.idate<='" + My.DateConvertToIdate(ToDate) + "') t order by try_cast(slipno as int ) asc";//order by RowId asc
            }
            else if (Session_id != "0" && Class_id == "0")
            {
                query = "select * from (select *,(select top 1 name from user_details where user_id=t.By_user_id) as By_user_name from (select DISTINCT t1.slipno,t2.studentname,t2.fathername,t2.class,t2.Section,t1.adno,t2.rollnumber,(select top 1 mode from Student_Payment_History where Slip_no=t1.slipno and Session=t1.Session) as Payment_mode,(select top 1 Pay_mode_transaction_no from Student_Payment_History where Slip_no=t1.slipno and Session=t1.Session) as Transaction_Id,(select top 1 user_id from Student_Payment_History where Slip_no=t1.slipno and Session=t1.Session) as By_user_id,t1.Date,t1.Idate,(select top 1 Id from Student_Payment_History where Slip_no=t1.slipno and Session=t1.Session) as RowId,'0' as Type,'0' as Amount from Monthly_Fee_Collection_Slip t1 join admission_registor t2 on t1.session=t2.session and t1.adno=t2.admissionserialnumber where t1.session='" + Session_name + "' and t1.Idate>='" + My.DateConvertToIdate(FromDate) + "' and t1.Idate<='" + My.DateConvertToIdate(ToDate) + "') t union all select recpt_no as slipno,student_name as studentname,fathers_name as fathername,class,'-' as Section,'-' as adno,'-' as rollnumber,Payment_Mode as Payment_mode,Bank_tran_no as Transaction_Id,Created_by as By_user_id,Created_date as Date,Created_idate as Idate,'0' as RowId,'1' as Type,Amount,(select top 1 name from user_details where user_id=t1.Created_by) as By_user_name from Form_sale_details t1 where t1.session='" + Session_name + "' and t1.idate>='" + My.DateConvertToIdate(FromDate) + "' and t1.idate<='" + My.DateConvertToIdate(ToDate) + "') t order by try_cast(slipno as int ) asc";
            ...
            {
                query = "select * from (select *,(select top 1 name from user_details where user_id=t.By_user_id) as By_user_name from (select DISTINCT t1.slipno,t2.studentname,t2.fathername,t2.class,t2.Section,t1.adno,t2.rollnumber,(select top 1 mode from Student_Payment_History where Slip_no=t1.slipno and Session=t1.Session) as Payment_mode,(select top 1 Pay_mode_transaction_no from Student_Payment_History where Slip_no=t1.slipno and Session=t1.Session) as Transaction_Id,(select top 1 user_id from Student_Payment_History where Slip_no=t1.slipno and Session=t1.Session) as By_user_id,t1.Date,t1.Idate,(select top 1 Id from Student_Payment_History where Slip_no=t1.slipno and Session=t1.Session) as RowId,'0' as Type,'0' as Amount from Monthly_Fee_Collection_Slip t1 join admission_registor t2 on t1.session=t2.session and t1.adno=t2.admissionserialnumber where (t1.class='" + Class_id + "' or t1.class='" + Class_name + "') and t1.Idate>='" + My.DateConvertToIdate(FromDate) + "' and t1.Idate<='" + My.DateConvertToIdate(ToDate) + "') t union all select recpt_no as slipno,student_name as studentname,fathers_name as fathername,class,'-' as Section,'-' as adno,'-' as rollnumber,Payment_Mode as Payment_mode,Bank_tran_no as Transaction_Id,Created_by as By_user_id,Created_date as Date,Created_idate as Idate,'0' as RowId,'1' as Type,Amount,(select top 1 name from user_details where user_id=t1.Created_by) as By_user_name from Form_sale_details t1 where t1.Class_id='" + Class_id + "' and t1.idate>='" + My.DateConvertToIdate(FromDate) + "' and t1.idate<='" + My.DateConvertToIdate(ToDate) + "') t order by try_cast(slipno as int ) asc";
            ...
            {
                query = "select * from (select *,(select top 1 name from user_details where user_id=t.By_user_id) as By_user_name from (select DISTINCT t1.slipno,t2.studentname,t2.fathername,t2.class,t2.Section,t1.adno,t2.rollnumber,(select top 1 mode from Student_Payment_History where Slip_no=t1.slipno and Session=t1.Session) as Payment_mode,(select top 1 Pay_mode_transaction_no from Student_Payment_History where Slip_no=t1.slipno and Session=t1.Session) as Transaction_Id,(select top 1 user_id from Student_Payment_History where Slip_no=t1.slipno and Session=t1.Session) as By_user_id,t1.Date,t1.Idate,(select top 1 Id from Student_Payment_History where Slip_no=t1.slipno and Session=t1.Session) as RowId,'0' as Type,'0' as Amount from Monthly_Fee_Collection_Slip t1 join admission_registor t2 on t1.session=t2.session and t1.adno=t2.admissionserialnumber where t1.session='" + Session_name + "' and (t1.class='" + Class_id + "' or t1.class='" + Class_name + "') and t1.Idate>='" + My.DateConvertToIdate(FromDate) + "' and t1.Idate<='" + My.DateConvertToIdate(ToDate) + "') t union all select recpt_no as slipno,student_name as studentname,fathers_name as fathername,class,'-' as Section,'-' as adno,'-' as rollnumber,Payment_Mode as Payment_mode,Bank_tran_no as Transaction_Id,Created_by as By_user_id,Created_date as Date,Created_idate as Idate,'0' as RowId,'1' as Type,Amount,(select top 1 name from user_details where user_id=t1.Created_by) as By_user_name from Form_sale_details t1 where t1.session='" + Session_name + "' and t1.Class_id='" + Class_id + "' and t1.idate>='" + My.DateConvertToIdate(FromDate) + "' and t1.idate<='" + My.DateConvertToIdate(ToDate) + "') t order by try_cast(slipno as int ) asc";
