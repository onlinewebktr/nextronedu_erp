<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="print-income-certificate.aspx.cs" Inherits="school_web.Admin.print_income_certificate" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Reprint Income Certificate
</asp:Content>
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Reprint Income Certificate</li>
                        </ol>
                    </nav>
                </div>
            </div>
                                                                                    ...
                                                                                    <td style="text-align: left;">
                                                                                        ...
                                                                                        <div class="user-box dropdown" style="float: left; display: inherit; height: auto; border-left: 0px solid #f0f0f0; margin-left: 0px;">
                                                                                            ...
                                                                                            <ul class="dropdown-menu dropdown-menu-end">
                                                                                                <asp:Label ID="lbl_type_one" runat="server">
                                                                                                <li>
                                                                                                ...
                                                                                                <asp:Label ID="lbl_type_two" runat="server">
                                                                                                <li>
                                                                                                    <a class="dropdown-item" href="slip/income-certificate2.aspx?adm_no=<%#Eval("admissionserialnumber") %>&clssid=<%#Eval("Class_id") %>&sessnid=<%#Eval("Session_id") %>&type=0" target="_blank"><i class='bx bx-printer'></i><span>Bonafide</span></a>
                                                                                                </li>
                                                                                                <li>
                                                                                                    <a class="dropdown-item" href="slip/income-certificate2.aspx?adm_no=<%#Eval("admissionserialnumber") %>&clssid=<%#Eval("Class_id") %>&sessnid=<%#Eval("Session_id") %>&type=1" target="_blank"><i class='bx bx-printer'></i><span>Bonafide with fees</span></a>
                                                                                                </li>
                                                                                                </asp:Label>


                                                                                                <asp:Label ID="lbl_type_three" runat="server">
                                                                                                <li>
                                                                                                    <a class="dropdown-item" href="slip/bonafide-certificate1.aspx?adm_no=<%#Eval("admissionserialnumber") %>&clssid=<%#Eval("Class_id") %>&sessnid=<%#Eval("Session_id") %>&crtificateno=<%#Eval("Certificate_no") %>" target="_blank"><i class='bx bx-printer'></i><span>Bonafide</span></a>
                                                                                                </li>
                                                                                                <li>
                                                                                                    <a class="dropdown-item" href="slip/income-certificate2.aspx?adm_no=<%#Eval("admissionserialnumber") %>&clssid=<%#Eval("Class_id") %>&sessnid=<%#Eval("Session_id") %>&type=1" target="_blank"><i class='bx bx-printer'></i><span>Bonafide with fees</span></a>
                                                                                                </li>
