<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="Today_Fee_Collection_Summary.aspx.cs" Inherits="school_web.Admin.Today_Fee_Collection_Summary" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Today Fees Collection Summary
</asp:Content>
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Today Fees Collection Summary Report</li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <table style="margin: 0px; padding: 0px; float: left; height: auto; width: 100%; background-color: white; border: 1px solid #000; color: black;" border="1">
                        <tr>
                            <td style="padding: 5px;">Total Collection: 
                                ...
                                <asp:LinkButton ID="lnk_click_here_toview_total_collection" class="pdispnone" runat="server" OnClick="lnk_click_here_toview_total_collection_Click">Click Here</asp:LinkButton>
                            </td>

                            <td style="padding: 5px;">Total Admission Fees:
                                 
                                 <asp:Label ID="lbl_totaladmissionfee1" runat="server" Font-Bold="true">0.00</asp:Label>
                                <asp:LinkButton ID="lnk_click_here_toview_total_admissionfee" runat="server" class="pdispnone" OnClick="lnk_click_here_toview_total_admissionfee_Click">Click Here</asp:LinkButton>
                            </td>
                            <td style="padding: 5px;">Total Annual Fees:
                                ...
                                <asp:LinkButton ID="lnk_click_here_toview_total_readmissionadmissionfee" class="pdispnone" runat="server" OnClick="lnk_click_here_toview_total_readmissionadmissionfee_Click">Click Here</asp:LinkButton>

                            </td>
                            <td style="padding: 5px;">Total Monthly Fees:
                                <asp:Label ID="lbl_monthfee" runat="server" Font-Bold="true">0.00</asp:Label>
                                <asp:LinkButton ID="lnk_month_fee" class="pdispnone" runat="server" OnClick="lnk_month_fee_Click">Click Here</asp:LinkButton>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                url: "graph.asmx/find_today_fee_summary",
                data: "{Day_date: '" + Day_date + "', Class: '" + Class + "'}",
                dataType: "json",
