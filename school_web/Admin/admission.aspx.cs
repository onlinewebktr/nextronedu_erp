    ...
    public partial class admission1 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!IsPostBack)
                {
                    ...
                    {
                        ViewState["imgstudent"] = "0";
                        if (Request.QueryString["stdid"] == null)
                        {
                            DataTable dtPage = My.dataTable("select * from MenuMaster_web where Menu_page in ('admission-new.aspx','admissions.aspx','Admission_form_BD.aspx') and Type='1'");
                            if (dtPage.Rows.Count > 0)
                            {
                                Response.Redirect(dtPage.Rows[0]["Menu_page"].ToString(), false);
                            }
                        }
                        ...
                        if (Request.QueryString["stdid"] != null)
                        {
                            ...
                            if (dtPage.Rows.Count > 0)
                            {
                                Response.Redirect(dtPage.Rows[0]["Menu_page"].ToString() + "?stdid=" + Request.QueryString["stdid"].ToString() + "&admno=" + Request.QueryString["admno"].ToString() + "&from=" + ViewState["Edtfrom"].ToString(), false);
                            }
        ...
        private void get_firm_details()
        {
            ...
            else
            {
                ...
                try
                {
                    if (dt.Rows[0]["is_roll_no_mandatory"].ToString() == "")
                    {
                        ViewState["is_roll_no_mandatory"] = "0";
                    }
                    else if (dt.Rows[0]["is_roll_no_mandatory"].ToString() == "0")
                    {
                        ViewState["is_roll_no_mandatory"] = "0";
                    }
                    else
                    {
                        ViewState["is_roll_no_mandatory"] = "1";
                ...
                try
                {
                    if (dt.Rows[0]["is_student_photo_mandatory"].ToString() == "")
                    {
                        ViewState["is_student_photo_mandatory"] = "0";
                    }
                    else if (dt.Rows[0]["is_student_photo_mandatory"].ToString() == "0")
                    {
                        ViewState["is_student_photo_mandatory"] = "0";
                    }
                    else
                    {
                        ViewState["is_student_photo_mandatory"] = "1";
        ...
        private void fetch_admission_no()
        {
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    else if (ViewState["firm_id"].ToString() == "LM-001")
                    {
                        if (sl_no.Length == 1)
                        {
                            sl_no = "00" + sl_no;
        ...
        private void BindTransferFormSaleDetails()
        {
            ...
            else
            {
                ...
                try
                {
                    txt_occupation.Text = dt.Rows[0]["F_occupation"].ToString();
                }
                catch (Exception ex) { }
                try
                {
                    txt_father_qualification.Text = dt.Rows[0]["F_qualification"].ToString();
                }
                catch (Exception ex) { }
                ...
                try
                {
                    txt_m_occupation.Text = dt.Rows[0]["M_occupation"].ToString();
                }
                catch (Exception ex)
                {
                }
                try
                {
                    txt_mother_qualification.Text = dt.Rows[0]["M_qualification"].ToString();
                }
                catch (Exception ex)
                {
                }
        ...
        private void BindDetails()
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                txt_guardian_occupation.Text = dt.Rows[0]["Guardian_occupation"].ToString();
                txt_guardian_qualification.Text = dt.Rows[0]["Guardian_qualification"].ToString();
                ...
                txt_reg_acc_id.Text = dt.Rows[0]["Admission_no_date"].ToString();
                ...
                txt_occupation.Text = dt.Rows[0]["occuption"].ToString();
                ...
                txt_m_occupation.Text = dt.Rows[0]["m_occupation"].ToString();
                txt_mother_qualification.Text = dt.Rows[0]["motherqualifiaction"].ToString();
                ...
                {
                    rollDV.Attributes["class"] = "col-lg-3 col-md-3 col-sm-12 col-xs-12";
                    HSrollDV.Attributes["class"] = "col-lg-3 col-md-3 col-sm-12 col-xs-12";
                    HSrollDV.Visible = true;
                    txt_h_roll_no_update.Text = dt.Rows[0]["Hostel_roll_no"].ToString();
                }
            }
        }
        ...
        protected void btn_academic_dt_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (ViewState["is_roll_no_mandatory"].ToString() == "1")
                {
                    if (txt_rollnumber.Text == "" || txt_rollnumber.Text == "0")
                    {
                        Alertme("Please enter valid roll no.", "warning");
        ...
        protected void btn_fther_dt_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (txt_father_qualification.Text == "Select")
                {
                    Alertme("Please enter father qualification.", "warning");
                    txt_father_qualification.Focus();
                    return;
                }
        ...
        protected void btn_mther_dt_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (txt_father_qualification.Text == "")
                {
                    Alertme("Please enter father qualification.", "warning");
                    txt_father_qualification.Focus();
                    return;
        ...
        protected void btn_final_submit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (ViewState["is_roll_no_mandatory"].ToString() == "1")
                {
                    ...
                    if (txt_rollnumber.Text == "" || txt_rollnumber.Text == "0")
                    {
                        roll_required.Visible = true;
                        final_requiredfilecheck = false;
                    }
                    else
                    {
                        roll_required.Visible = false;
                ...
                if (ViewState["is_student_photo_mandatory"].ToString() == "1")
                {

                    if (ViewState["imgstudent"].ToString() == "" || ViewState["imgstudent"].ToString() == "0")
                    {
                        studentphot1.Visible = true;
                        final_requiredfilecheck = false;
                    }
                    else
                    {
                        studentphot1.Visible = false;
                ...
                if (final_requiredfilecheck == true)
                {
                    if (btn_final_submit.Text == "Submit")
                    {
                        ...
                        if (flag == true)
                        {
                            updated_submitted_doc(ddlsession.SelectedValue, ddlclass.SelectedValue, txt_admission_no.Text);
                            ...
                            try
                            {
                                ...
                                if (vrls.Length > 2)
                                {
                                    lst[2] = ddlsession.SelectedItem.Text;
                                }
                                if (vrls.Length > 3)
                                {
                                    lst[3] = txt_admission_no.Text;
                                }
                                if (vrls.Length > 4)
                                {
                                    lst[4] = "";
    ...
    { "wid", ViewState["Wid"].ToString()}
                                            ...
                                            if (whatsappno.Length > 9)
                                            {
                                                My.Insert("WhatsApp_send", new
                                                {
                                                    ...
                                                    Admission_no = txt_admission_no.Text,
                                                    Status = "Pending",
                                                    Date = mycode.date(),
                                                    Idate = mycode.idate(),
                                                    Time = mycode.time(),
        ...
        private void fetch_saved_images(HtmlImage Image1, Label lbl_column_name)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                {
                    ViewState["imgstudent"] = dt.Rows[0]["Image_path"].ToString();
                }
        ...
        private void register_details(SqlConnection con)
        {
            if (payments.IsUserExistS("select Id from admission_registor where admissionserialnumber='" + txt_admission_no.Text + "'", con))
            {
                ...
                cmd.Parameters.AddWithValue("@Guardian_occupation", txt_guardian_occupation.Text);
                cmd.Parameters.AddWithValue("@Guardian_qualification", txt_guardian_qualification.Text);
                ...
                cmd.Parameters.AddWithValue("@Admission_no_date", txt_reg_acc_id.Text);
                ...
                cmd.Parameters.AddWithValue("@occuption", txt_occupation.Text);
                cmd.Parameters.AddWithValue("@fatherqualification", txt_father_qualification.Text);
                ...
                cmd.Parameters.AddWithValue("@m_occupation", txt_m_occupation.Text);
                cmd.Parameters.AddWithValue("@motherqualifiaction", txt_mother_qualification.Text);
                ...
                if (ddl_day_boarding.SelectedValue == "3")
                {
                    cmd.Parameters.AddWithValue("@Hostel_roll_no", txt_h_roll_no.Text);
                }
                else
                {
                    cmd.Parameters.AddWithValue("@Hostel_roll_no", "");
                }
        ...
        private void update_registration(SqlConnection con)
        {
            ...
            cmd.Parameters.AddWithValue("@Hostel_roll_no", txt_h_roll_no_update.Text.Trim());
        ...
        [WebMethod]
        public static List<string> GetFatherOccupation(string PathRooT)
        {
            List<string> MobResult = new List<string>();
            using (SqlConnection con = new SqlConnection(compLN.comp))
            {
                using (SqlCommand cmd = new SqlCommand())
                {
                    cmd.CommandText = "select distinct Occupation from Father_occupation where Occupation LIKE '%'+@SearchMobNo+'%' order by Occupation asc";
                    cmd.Connection = con;
                    con.Open();
                    cmd.Parameters.AddWithValue("@SearchMobNo", PathRooT);
                    SqlDataReader dr = cmd.ExecuteReader();
                    while (dr.Read())
                    {
                        MobResult.Add(dr["Occupation"].ToString());
                    }
                    con.Close();
                    return MobResult;
                }
        ...
        [WebMethod]
        public static List<string> GetFatherQualification(string PathRooT)
        {
            List<string> MobResult = new List<string>();
            using (SqlConnection con = new SqlConnection(compLN.comp))
            {
                using (SqlCommand cmd = new SqlCommand())
                {
                    cmd.CommandText = "select distinct Name from Qualification_master where Name LIKE '%'+@SearchMobNo+'%' order by Name asc";
                    cmd.Connection = con;
                    con.Open();
                    cmd.Parameters.AddWithValue("@SearchMobNo", PathRooT);
                    SqlDataReader dr = cmd.ExecuteReader();
        ...
        [WebMethod]
        public static List<string> GetMotherOccupation(string PathRooT)
        {
            List<string> MobResult = new List<string>();
            using (SqlConnection con = new SqlConnection(compLN.comp))
            {
                using (SqlCommand cmd = new SqlCommand())
                {
                    cmd.CommandText = "select distinct Occupation from Mother_occupation where Occupation LIKE '%'+@SearchMobNo+'%' order by Occupation asc";
                    cmd.Connection = con;
                    con.Open();
                    cmd.Parameters.AddWithValue("@SearchMobNo", PathRooT);
                    SqlDataReader dr = cmd.ExecuteReader();
        ...
        [WebMethod]
        public static List<string> GetGuardianOccupation(string PathRooT)
        {
            List<string> MobResult = new List<string>();
            using (SqlConnection con = new SqlConnection(compLN.comp))
            {
                using (SqlCommand cmd = new SqlCommand())
                {
                    cmd.CommandText = "select distinct Occupation from (select Occupation from Father_occupation union all select Occupation from Mother_occupation) t where Occupation LIKE '%'+@SearchMobNo+'%' order by Occupation asc";
                    cmd.Connection = con;
                    con.Open();
                    cmd.Parameters.AddWithValue("@SearchMobNo", PathRooT);
                    SqlDataReader dr = cmd.ExecuteReader();
        ...
        protected void rp_document_submit_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                CheckBox chk_doc_submit = ((CheckBox)e.Item.FindControl("chk_doc_submit")) as CheckBox;
                DataTable dt = My.dataTable("select * from Admission_student_doc_submit where Session_id='" + ddlsession.SelectedValue + "' and Admission_no='" + txt_admission_no.Text + "' and Class_id='" + ddlclass.SelectedValue + "' and Doc_id='" + lbl_doc_id.Text + "'");
                if (dt.Rows.Count > 0)
                {
                    chk_doc_submit.Checked = true;
                }
            }
        }


        private void updated_submitted_doc(string session_id, string class_id, string adm_No)
        {
            My.exeSql("delete from Admission_student_doc_submit where Session_id='" + session_id + "' and Admission_no='" + adm_No + "' and Class_id='" + class_id + "'");
            int mgrowcount = rp_document_submit.Items.Count;
            for (int ixi = 0; ixi < mgrowcount; ixi++)
            {
                CheckBox chkM = (CheckBox)rp_document_submit.Items[ixi].FindControl("chk_doc_submit");
                if (chkM.Checked == true)
                {
                    Label lbl_doc_id = (Label)rp_document_submit.Items[ixi].FindControl("lbl_doc_id");
                    SqlCommand cmd;
                    string query = "INSERT INTO Admission_student_doc_submit (Session_id,Admission_no,Class_id,Doc_id) values (@Session_id,@Admission_no,@Class_id,@Doc_id)";
                    cmd = new SqlCommand(query);
                    cmd.Parameters.AddWithValue("@Session_id", session_id);
                    cmd.Parameters.AddWithValue("@Admission_no", adm_No);
                    cmd.Parameters.AddWithValue("@Class_id", class_id);
                    cmd.Parameters.AddWithValue("@Doc_id", lbl_doc_id.Text);
                    if (My.InsertUpdateData(cmd))
                    {
                    }
                }
