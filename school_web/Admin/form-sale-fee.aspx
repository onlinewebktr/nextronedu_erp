<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="form-sale-fee.aspx.cs" Inherits="school_web.Admin.form_sale_fee" %>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <ul class="sub-pag-menu-ul sub-pag-menu-ul-mrgn">
                        <li><a href="form-sale-fee.aspx" class="sub-mnu-p-a-active">Form Sale Fees</a></li>
                                    ...
                                    <div class="col-xl-12">
                                        <div class="row">
                                            <div class="col-md-4">
                                                ...
                                                <asp:DropDownList ID="ddl_session" runat="server" class="form-select" Style="margin: 0px 0px 10px 0px;"></asp:DropDownList>
                                            </div>
                                            <div class="col-md-12">
                                            ...
                                            <div class="col-md-4">
                                                <label for="validationCustom01" class="form-label Llabel">Fee</label>
                                                <asp:TextBox ID="txt_fee" runat="server" class="form-control" Style="margin: 0px 0px 10px 0px;"></asp:TextBox>
                                            </div>
                                            <div class="col-12">
                ...
                <div class="col-xl-12">
                    <h6 class="mb-0 text-uppercase">Added Form Sale Fees</h6>
                    <hr />
                    <div class="card">
                        <div class="card-body">
                            <div class="table-responsive">
                                <div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap5 hdrmodify">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3">
                                            <asp:Button ID="btn_find" OnClick="btn_find_Click" runat="server" Text="Find" Style="margin: 20px 0px 6px 10px;" CssClass="btn btn-primary find-dv-btn" />
                                        </div>
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <asp:Panel ID="Panel1" runat="server">
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:Label ID="lbl_Amount" runat="server" Text='<%#Bind("Fee_amount")%>'></asp:Label>
                                                                                    </td>
