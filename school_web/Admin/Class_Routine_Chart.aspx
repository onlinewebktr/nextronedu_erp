<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="Class_Routine_Chart.aspx.cs" Inherits="school_web.Admin.Class_Routine_Chart" EnableEventValidation="false" ValidateRequest="false" %>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <asp:Label ID="lbl_website" runat="server"></asp:Label>
                                                                    ...
                                                                    <div style="margin: 7px 0px 0px 0px; padding: 0px; float: left; height: auto; text-align: center; vertical-align: middle; font-size: 13px; width: 100%;">
                                                                        <span style="font-size: 18px; font-weight: bold;">Class Routine Report-<asp:Label ID="lbl_date" runat="server"></asp:Label></span>
