<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="deleted-bill-history.aspx.cs" Inherits="school_web.Admin.deleted_bill_history" %>
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Deleted Bill History</li>
                        </ol>
                    </nav>
                </div>
            </div>
