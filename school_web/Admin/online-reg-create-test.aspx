<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="online-reg-create-test.aspx.cs" Inherits="school_web.Admin.online_reg_create_test" EnableEventValidation="false" ValidateRequest="false" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="page-wrapper">
        <div class="page-content">
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Add Admission Name</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-4">
                    <asp:Label ID="ltUsertop" runat="server" Style="font-weight: 500; font-size: 1rem;" class="mb-0 text-uppercase" Text="Add Admission Name"></asp:Label>
                    <hr />
                    <div class="card">
                        <div class="card-body">
                            <div class="p-4 border rounded">
                                <div class="row g-3 needs-validation" novalidate="">
                                    ...
                                    <div class="col-md-12">
                                        <label for="validationCustom01" class="form-label">Admission Name</label>
                                        <asp:TextBox ID="txt_test_name" runat="server" class="form-control"></asp:TextBox>
                                    </div>
                ...
                <div class="col-xl-8">
                    <h6 class="mb-0 text-uppercase">Added Admission Name</h6>
                    <hr />
                    <div class="card">
                        <div class="card-body">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:Panel ID="Panel1" runat="server">
                                                                <tr>
                                                                    ...
                                                                    <td style="text-align: left;">
                                                                        <asp:Label ID="lbl_status" runat="server" Text='<%#Bind("Is_active")%>'></asp:Label>
                                                                    </td>
