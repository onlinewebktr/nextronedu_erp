<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="Student_attendance-log-history-datewise.aspx.cs" Inherits="school_web.Admin.Student_attendance_log_history_datewise" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Attendance Log History Datewise
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="page-wrapper">
        <div class="page-content">
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Attendance Biometric Log History Datewise</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <h6 class="mb-0 text-uppercase">Attendance Log History Datewise</h6>
                    <hr />
                    <div class="card">
                        <div class="card-body">
                            ...
                            <asp:Label ID="lbl_website" runat="server"></asp:Label>
                                                        ...
                                                        <div style="margin: 0px; padding: 0px; float: left; width: 100%">
                                                            ...
                                                            <table style="margin: 0px; padding: 0px; float: left; height: auto; width: 100%;">
                                                                ...
                                                                <tr>
                                                                    <td style="padding: 5px;">Total no. of Student</td>
                                                                    <td style="padding: 5px;">

                                                                        <asp:Label ID="lbl_ttl_no_of_emp" runat="server" Text="" Font-Bold="true"></asp:Label>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </div>
