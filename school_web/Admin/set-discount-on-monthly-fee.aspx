<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="set-discount-on-monthly-fee.aspx.cs" Inherits="school_web.Admin.set_discount_on_monthly_fee" %>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <ul class="sub-pag-menu-ul sub-pag-menu-ul-mrgn">
                        ...
                        <li><a href="set-discount-on-monthly-fee.aspx" class="sub-mnu-p-a-active">Monthly Fees</a></li>
                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            <asp:Label ID="ltUsertop" runat="server" Style="font-weight: 500; font-size: 1rem;" class="mb-0 text-uppercase" Text="Set Discount for Monthly Fees"></asp:Label>
                            <hr />
                                ...
                                <div class="row g-3 needs-validation" novalidate="">
                                    <div class="col-xl-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-2" id="hostel_room_catogery" runat="server" visible="false">
                                                <label for="validationCustom01" class="form-label Llabel">Room Type </label>
                                                <asp:DropDownList ID="ddl_room_catogery" runat="server" class="form-select">
                                                </asp:DropDownList>
                                            </div>
                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            <h6 class="mb-0 text-uppercase">Added Discount for Monthly Fees</h6>
                            <hr />
                                            ...
                                            <div class="find-dv">
                                                <div class="row">
                                                    <div class="col-sm-2">
                                                        ...
                                                        <asp:DropDownList ID="ddl_discount_for_srch" runat="server" class="form-select find-dv-txtbx" OnSelectedIndexChanged="ddl_discount_for_srch_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                                                    </div>
                                                    <div class="col-sm-2">
                            ...
                            <asp:Label ID="lbl_website" runat="server"></asp:Label>
                                                                ...
                                                                <div style="margin: 7px 0px 0px 0px; padding: 0px; float: left; height: auto; text-align: center; vertical-align: middle; font-size: 13px; width: 100%;">
                                                                    <span style="font-size: 14px; font-weight: bold;">Discount Monthly Fees
