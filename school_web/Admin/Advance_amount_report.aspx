<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="Advance_amount_report.aspx.cs" Inherits="school_web.Admin.Advance_amount_report" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">Advance Amount Report
</asp:Content>
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Advance Amount Report</li>
                        </ol>
                    </nav>
                </div>
            </div>
                                                        ...
                                                        <asp:GridView ID="grd_fee" runat="server" AutoGenerateColumns="False" Style="width: 100%" class="table table-bordered" Width="100%" OnRowDataBound="grd_fee_RowDataBound" ShowFooter="True">
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Student Name">
                                                                 ...
                                                                 <asp:TemplateField HeaderText="Fater Name">
                                                                    <ItemTemplate>
                                                                    ...
                                                                    <ItemTemplate>
                                                                        <div class="user-box dropdown" style="float: left; display: inherit; height: auto; border-left: 0px solid #f0f0f0; margin-left: 0px;">
                                                                            ...
                                                                            <ul class="dropdown-menu dropdown-menu-end">
                                                                                <li>
                                                                                    <a class="dropdown-item" href="slip/Advance_Pay_slip.aspx?receiptid=<%#Eval("Slipid") %>" target="_blank"><i class='bx bx-printer'></i><span>Print Slip</span></a>
                                                                                </li>
