<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="overall-dues.aspx.cs" Inherits="school_web.Admin.overall_dues" EnableEventValidation="false" ValidateRequest="false" %>
                                    ...
                                    <div class="row g-3 needs-validation" novalidate="">
                                        <div class="col-xl-12">
                                            <div class="row">
                                                ...
                                                <div class="col-md-3" style="margin-top: 7px;">
                                                    <label for="validationCustom01" class="form-label Llabel">Father's Mobile No.</label>
                                                    
                                                     <asp:TextBox ID="txt_father_mobile_no" runat="server" CssClass="form-control" onkeypress="return isNumberKey(event)"></asp:TextBox>
