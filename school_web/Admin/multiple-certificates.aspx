<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="multiple-certificates.aspx.cs" Inherits="school_web.Admin.multiple_certificates" %>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#<%=txt_student_name.ClientID%>").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        url: 'multiple-certificates.aspx/GetRooPath',
        ...
        $(function () {
            ...
            $("#<%=txt_admission_no.ClientID%>").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        url: 'multiple-certificates.aspx/GetRooPathAdmNo',
                        data: "{ 'PathRooT': '" + request.term + "',Session_id:'" + sessionid + "'}",
                        dataType: "json",
                        type: "POST",
                        contentType: "application/json; charset=utf-8",
        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            <asp:Label ID="ltUsertop" runat="server" Style="font-weight: 500; font-size: 1rem;" class="mb-0 text-uppercase" Text="Create Certificate"></asp:Label>
                            <hr />
        ...
        <div class="modal-dialog md-width">
            ...
            <div class="modal-content" style="position: relative">
                <div class="modal-header">
                    <h3 class="modal-title" style="font-size: 20px;">Create Certificate</h3>
                            ...
                            <asp:Repeater ID="rp_std" runat="server">
                                <ItemTemplate>
                                    <tr id="row" runat="server">
                                        ...
                                        <td>
                                            <asp:Label ID="Label5" runat="server" Text='<%#Bind("rollnumber") %>'></asp:Label>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            ...
                                            <asp:Label ID="Label7" Visible="false" runat="server" Text='<%#Bind("session") %>'></asp:Label>
                                            <asp:Label ID="Label8" Visible="false" runat="server" Text='<%#Bind("Session_id") %>'></asp:Label>
                                        </td>
                                        <td>
