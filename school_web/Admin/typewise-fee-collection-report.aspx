<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="typewise-fee-collection-report.aspx.cs" Inherits="school_web.Admin.typewise_fee_collection_report" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Monthly Wise Fee Collection Report
</asp:Content>
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Monthly Wise Fee Collection Report</li>
                        </ol>
                    </nav>
                </div>
            </div>
