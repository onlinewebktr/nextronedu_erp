<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="View_Sent_Message_to_Student.aspx.cs" Inherits="school_web.Admin.View_Sent_Message_to_Student" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    View Sent Message to Student
</asp:Content>
                                                            ...
                                                            <asp:GridView ID="GrdView" runat="server" class="table table-bordered" AutoGenerateColumns="False" Width="100%" OnRowDataBound="GrdView_RowDataBound">
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Section">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lbl_section" runat="server" Text='<%#Bind("Section_Id") %>'></asp:Label>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Date">
                                                                        <ItemTemplate>
                                                                            ...
                                                                            <asp:Label ID="lbl_Posted_Date" runat="server" Text='<%#Bind("Date")%>'></asp:Label>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
