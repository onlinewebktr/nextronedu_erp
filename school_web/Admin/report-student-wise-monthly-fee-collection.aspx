<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="report-student-wise-monthly-fee-collection.aspx.cs" Inherits="school_web.Admin.report_student_wise_monthly_fee_collection" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Student Wise Monthly Fee Collection
</asp:Content>
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Student wise Admission Fee Collection</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    ...
                    <ul class="sub-pag-menu-ul">
                        ...
                        <li><a href="report-student-wise-admission-fee-collection.aspx" class="sub-mnu-p-a-active">Student Wise Fee Collection</a></li>
                        <li><a href="typewise-fee-collection-report.aspx" class="sub-mnu-p-a-active">Month Wise Fee Collection</a></li>
                    </ul>
                </div>
                <div class="col-xl-12">
                    <hr />
                                        ...
                                        <div class="col-sm-12">
                                            <div class="find-dv">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-1">
                                                        <asp:LinkButton ID="lnks_filter" runat="server" class="filters-btn" OnClick="lnks_filter_Click"><i class="bx bx-filter-alt"></i></asp:LinkButton>
                                                    </div>
                                                    <div class="col-sm-3">
