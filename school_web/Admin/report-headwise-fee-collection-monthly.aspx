<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="report-headwise-fee-collection-monthly.aspx.cs" Inherits="school_web.Admin.report_headwise_fee_collection_monthly" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Head wise Monthly Fee Collection
</asp:Content>
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Head wise Monthly Fee Collection</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    ...
                    <ul class="sub-pag-menu-ul">
                        ...
                        <li><a href="report-headwise-fee-collection-monthly.aspx" class="sub-mnu-p-a-active">Head wise Fee Collection</a></li>
                        ...
                        <li><a href="report-headwise-fee-collection-monthly.aspx"  class="sub-mnu-p-a-active">Head wise Fee Collection(Day Boarding)</a></li> 
                        <li><a href="report-student-headwise-monthley-fee-collection_N.aspx">Student & Head wise Fee Collection</a></li>
                                                                            ...
                                                                            <ItemTemplate>
                                                                                ...
                                                                                <asp:GridView ID="GrdViews" runat="server" ShowHeader="false" OnRowDataBound="GrdViews_RowDataBound" class="table table-bordered" ShowFooter="true" AutoGenerateColumns="False" Width="100%" Style="width: 103%; border-collapse: collapse; margin: -9px;">
                                                                                    <Columns>
                                                                                        ...
                                                                                        <asp:TemplateField>
                                                                                            <ItemTemplate>
                                                                                                <asp:Label ID="lbl_Paid_amt" runat="server" Text='<%#Bind("Paid_amt")%>'></asp:Label>
                                                                                            </ItemTemplate>
                                                                                            <FooterTemplate>
