<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="bulk-fee-update-adm-mnth-with-bill.aspx.cs" Inherits="school_web.Admin.bulk_fee_update_adm_mnth_with_bill" %>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="p-4 border rounded">
                                        <div class="row g-3 needs-validation" novalidate="">
                                            <div class="col-md-12">
                                                <a href="doc/fee-payment-with-bill.csv" download="" class="btnbtn btn-1 btn-sep icon-cart">Download Excel</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
