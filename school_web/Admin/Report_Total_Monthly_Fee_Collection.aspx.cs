...
{
    public partial class Report_Total_Monthly_Fee_Collection : System.Web.UI.Page
    {
        My mycode = new My();
        ...
        protected void btn_excels_Click(object sender, EventArgs e)
        {
            ...
            if (ViewState["Is_Download"].ToString() == "1")
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename=Total_Monthly_Fee_Collection" + "_" + DateTime.Now + ".xls");
                Response.Charset = "";
