<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="Online_payment_History.aspx.cs" Inherits="school_web.Admin.Online_payment_History" EnableEventValidation="false" %>
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Online Reg. Collection</li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <asp:Label ID="lbl_website" runat="server"></asp:Label>
                                                                    ...
                                                                    <div style="margin: 7px 0px 0px 0px; padding: 0px; float: left; height: auto; text-align: center; vertical-align: middle; font-size: 13px; width: 100%;">
                                                                        <span style="font-size: 14px; font-weight: bold;">Date between -<asp:Label ID="lbl_class22" runat="server"></asp:Label></span>
                                                            ...
                                                            <asp:GridView ID="grd_fee" runat="server" CssClass="table table-bordered" border="1" AutoGenerateColumns="False" Width="100%" Style="text-align: center;" GridLines="Vertical" OnRowDataBound="grd_fee_RowDataBound" ShowFooter="True">
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Apply Id No.">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lbl_admissionserialnumber" runat="server" Text='<%#Bind("Registration_id")%>'></asp:Label>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>

                                                                    <asp:TemplateField HeaderText="Mobile No.">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="Label4" runat="server" Text='<%#Bind("Student_mob_no")%>'></asp:Label>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>

                                                                    <asp:TemplateField HeaderText="Email Id">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lbl_Student_email_id" runat="server" Text='<%#Bind("Student_email_id")%>'></asp:Label>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="Payment Order Id">
                                                                        <ItemTemplate>
                                                                     ...
                                                                     <asp:TemplateField HeaderText="Payment Mode">
                                                                        <ItemTemplate>
                                                                            ...
                                                                            <asp:Label ID="Label1" runat="server" Text='<%#Bind("razorpay_order_id")%>'></asp:Label>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Amount">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lbl_Paid_amount" runat="server" Text='<%#Bind("Payable_amount")%>'></asp:Label>
                                                                        </ItemTemplate>
