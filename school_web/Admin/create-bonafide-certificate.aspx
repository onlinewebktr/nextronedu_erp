<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="create-bonafide-certificate.aspx.cs" Inherits="school_web.Admin.create_bonafide_certificate" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Created Bonafied Certificate
</asp:Content>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#<%=txt_student_name.ClientID%>").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        url: 'create-bonafide-certificate.aspx/GetRooPath',
        ...
        $(function () {
            ...
            $("#<%=txt_admission_no.ClientID%>").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        url: 'create-bonafide-certificate.aspx/GetRooPathAdmNo',
                        data: "{ 'PathRooT': '" + request.term + "',Session_id:'" + sessionid + "'}",
                        dataType: "json",
                        type: "POST",
                        contentType: "application/json; charset=utf-8",
        ...
        <div class="page-content">
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active">Create Bonafide Certificate</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            <asp:Label ID="ltUsertop" runat="server" Style="font-weight: 500; font-size: 1rem;" class="mb-0 text-uppercase" Text="Create Bonafide Certificate"></asp:Label>
                            <hr />
                                                        ...
                                                        <asp:Repeater ID="rd_view" runat="server">
                                                            <ItemTemplate>
                                                                <tr>
                                                                    ...
                                                                    <td style="text-align: left;">
                                                                        <asp:Label ID="lbl_father_name" runat="server" Text='<%#Bind("fathername")%>'></asp:Label>
                                                                    </td>
                                                                    <td style="text-align: left;">
                                                                        <asp:Label ID="lbl_admissionserialnumber" runat="server" Text='<%#Bind("admissionserialnumber")%>'></asp:Label>
                                                                    </td>
        ...
        <div class="modal-dialog md-width" style="max-width: 800px">
            ...
            <div class="modal-content" style="position: relative">
                <div class="modal-header">
                    <h3 class="modal-title" style="font-size: 20px;">Create Bonafide Certificate</h3>
                ...
                <div class="modal-body md-bdy">
                    <div class="bonafde-sec">
                        <p class="bonafde-sec-p1">
                            This is to certify that
                            <asp:TextBox ID="txt_student_name_c" runat="server" placeholder="[Student's Name]"></asp:TextBox>, son/daughter of
                            <asp:TextBox ID="txt_guardian_name" runat="server" placeholder="[Parent's/Guardian's Name]"></asp:TextBox>, is a bona fide student of
                            <asp:TextBox ID="txt_class_grade" runat="server" placeholder="[Class/Grade/Year]"></asp:TextBox>
                            in
                            <asp:TextBox ID="txt_class_c" runat="server" placeholder="[CLASS]"></asp:TextBox>
                        ...
                        <p class="bonafde-sec-p1">
                            ...
                            <asp:TextBox ID="txt_dob_c" runat="server" placeholder="[DD/MM/YYYY]"></asp:TextBox>
                        </p>

                        <p class="bonafde-sec-p1">
                            Admission Number :
                            <asp:TextBox ID="txt_admission_no_c" ReadOnly="true" runat="server" placeholder="[admission no.]"></asp:TextBox>
                        </p>


                        <p class="bonafde-sec-p1">
                            <asp:TextBox ID="txt_student_name_c1" runat="server" placeholder="[Student's Name]"></asp:TextBox>
                            has been a student of this institution since
                            <asp:TextBox ID="txt_date_of_admission_c" runat="server" placeholder="[Date of Admission]"></asp:TextBox>, and during this period, [he/she/they] has/have shown
                            <asp:TextBox ID="txt_remarks" Style="width: 100%;" runat="server" placeholder="[character, academic performance, or any other remarks you may wish to add]"></asp:TextBox>.
                        </p>
                    </div>
                    ...
                    <div class="mdl-frm-row">
                        <div class="row"> 
                            <div class="col-sm-8">
                                <asp:Button ID="btn_save_bona" runat="server" Text="Submit" OnClick="btn_save_bona_Click" class="btn btn-primary" Style="width: auto !important;" />
                            </div>
                        </div>
                    </div> 
                </div>
