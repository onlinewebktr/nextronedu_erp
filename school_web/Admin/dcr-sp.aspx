<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="dcr-sp.aspx.cs" Inherits="school_web.Admin.dcr_sp" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="row" data-ng-app="RpCardApp" data-ng-controller="RpCardAppCtrl">
                ...
                <%--<div class="col-xl-12">
                    <ul class="sub-pag-menu-ul">
                        <li><a href="dcr-sp.aspx" class="sub-mnu-p-a-active">Today Collection Sheet</a></li>
                                                        ...
                                                        <table class="table table-bordered" datatable="ng" dt-options="vm.dtOptions" style="border: 1px solid #c5c0c0;">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th class="scrollable-td fixed-hd" ng-repeat="(key, value) in reportHeadinG[0].DynamicData">{{ key }}</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody>
                                                                <tr data-ng-repeat="x in reportHeadinG">
                                                                    <td>{{$index+1}}</td>
                                                                    <td ng-repeat="(key, value) in x.DynamicData">{{value}}</td>
                                                                </tr>
                                                            </tbody>

                                                            <tr data-ng-repeat="x in reportHeadttl">
                                                                <td colspan="15" class="fntbold" style="text-align: right">Total : </td>
                                                                <td class="fntbold" ng-repeat="(key, value) in x.DynamicData">{{value}}</td>
                                                            </tr>
                                                        </table>
                                                    </div>
                                                    <div class="paid-cat-div">
                                                        <ul class="mode-ul">
                                                            <li data-ng-repeat="x in reportModettl"><i>{{x.Mode}} </i>: <span>{{x.Amount}}</span></li>
                                                        </ul>
                                                    </div>
                                                </div>
    ...
    <script type="text/javascript">
        ...
        app.controller('RpCardAppCtrl', function ($scope, $http) {
            ...
            $http.get("webServices/account/dcr-all-fees.asmx/fetch_report_collection_SP", {
                ...
                if ($scope.reportHeadinG == "") {
                    ...
                    $http.get("webServices/account/dcr-all-fees.asmx/fetch_report_collection_total_heawise_SP", {
                        params: { "Class_id": class_id, "FromDate": Fromdates, "ToDate": Todates }
                    }).then(function (response) {
                    ...
                    //=================Modewise Total
                    $http.get("webServices/account/dcr-all-fees.asmx/fetch_report_collection_total_modewise_SP", {
                        params: { "Class_id": class_id, "FromDate": Fromdates, "ToDate": Todates }
                    }).then(function (response) {
                        $scope.reportModettl = response.data;
                    })
