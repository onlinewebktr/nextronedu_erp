<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="religionwise-student.aspx.cs" Inherits="school_web.Admin.religionwise_student" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Religion Wise Student's List</li>
                        </ol>
                    </nav>
                </div>
            </div>
                                            ...
                                            <div class="grd-wpr">
                                                <div id="tblPrintIQ" runat="server">
                                                 <div style="margin: 18px 0px 19px 0px; padding: 6px 0px 0px 0px; float: left; height: 33px; text-align: center; vertical-align: middle; font-size: 13px; width: 100%; border-top: 1px solid #000; border-bottom: 1px solid #000;">
                                                        <span style="font-size: 14px; font-weight: bold;">Religion  Wise Student List-<asp:Label ID="lbl_class222" runat="server"></asp:Label></span>
                                                    </div>
    ...
    <asp:HiddenField ID="hd_religion" runat="server" />
    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            var options = {
                title: 'ReligionWise Student Summary',
                width: 980,
                height: 420,
            ...
            $.ajax({
                type: "POST",
                url: "religionwise-student.aspx/GetChartData",
                data: "{Session: '" + $('#<%=hd_session.ClientID%>').val() + "', Class_id: '" + $('#<%=hd_class.ClientID%>').val() + "', Section: '" + $('#<%=hd_section.ClientID%>').val() + "', Religion: '" + $('#<%=hd_religion.ClientID%>').val() + "'}",
        ...
        $(document).ready(function () {
            ...
            var Religion = $('#<%= hd_religion.ClientID %>').val();
            ...
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "graph.asmx/Get_student_religionwise",
                data: "{Session: '" + Session + "', Class_id: '" + Class + "', Section: '" + Section + "', Religion: '" + Religion + "'}",
                dataType: "json",
