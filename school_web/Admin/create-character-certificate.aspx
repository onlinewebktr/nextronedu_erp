<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="create-character-certificate.aspx.cs" Inherits="school_web.Admin.create_character_certificate" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Create Character Certificate
</asp:Content>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#<%=txt_student_name.ClientID%>").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        url: 'create-character-certificate.aspx/GetRooPath',
        ...
        $(function () {
            ...
            $("#<%=txt_admission_no.ClientID%>").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        url: 'create-character-certificate.aspx/GetRooPathAdmNo',
                        data: "{ 'PathRooT': '" + request.term + "',Session_id:'" + sessionid + "'}",
                        dataType: "json",
                        type: "POST",
                        contentType: "application/json; charset=utf-8",
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="page-content">
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Create Character Certificate</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <asp:Label ID="ltUsertop" runat="server" Style="font-weight: 500; font-size: 1rem;" class="mb-0 text-uppercase" Text="Create Character Certificate"></asp:Label>
                            <hr />
                            <div class="p-4 border rounded">
                                <div class="row" style="border-bottom: 1px solid #ddd; padding: 0px 0px 10px 0px;">
                                    ...
                                    <div class="col-xl-8" id="pendingforgeneratedata" runat="server" visible="false">
                                        <div class="fnd-box-wpr">
                                            <h2 class="fnd-box-row-wpr-h">Pending Character Certificate </h2>
                                            <div class="fnd-box-wpr-inr">
                                                            ...
                                                            <ItemTemplate>
                                                                <tr>
                                                                    ...
                                                                    <td style="text-align: left;">
                                                                        <asp:Label ID="lbl_dateofadmission" runat="server" Text='<%#Bind("dateofadmission")%>' Visible="false"></asp:Label>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="text-align: left;"> 
                                                                        <asp:LinkButton ID="lnkCreate" runat="server" CausesValidation="false" OnClick="lnkCreate_Click" Style="background: #f00; padding: 2px 5px 1px 5px; display: inline-flex; color: #fff; border-radius: 2px;"
                                                                            ToolTip="Create certificate" OnClientClick="return confirm('Are you sure you want to create character certificate?');">
    ...
    <div class="modal fade" id="myMdlCertificate" role="dialog" style="top: 0px">
        <div class="modal-dialog md-width" style="max-width: 792px;">
            <!-- Modal content-->
            <div class="modal-content" style="position: relative">
                <div class="modal-header" style="padding: 5px 15px;">
                ...
                <div class="modal-body md-bdy">
                    <div class="ttpp-wprs">
                        ...
                        <div class="rowdevider">
                            <div class="row">
                                <div class="col-xl-6 padd-rght-5">
                                    <label for="validationCustom01" class="form-label-fnds">UID No.</label>
                                </div>
                                <div class="col-xl-4 padd-lft-5">
                                    <asp:TextBox ID="txt_uid_no" runat="server" class="form-control find-dv-txtbx"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="rowdevider">
                            <div class="row">
                                ...
                                <div class="col-xl-4 padd-lft-5">
                                    <asp:DropDownList ID="ddl_old_class" runat="server" class="form-control find-dv-txtbx"></asp:DropDownList>
                                </div>
                            </div>
                        </div>
                        <div class="rowdevider">
                            <div class="row">
                                <div class="col-xl-6 padd-rght-5">
                                    <label for="validationCustom01" class="form-label-fnds">Date of admission</label>
                                </div>
                                <div class="col-xl-4 padd-lft-5">
                                    <asp:TextBox ID="txt_date_of_admission" runat="server" class="form-control find-dv-txtbx datepicker" Style="width: 220px"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="rowdevider">
                            <div class="row">
                                <div class="col-xl-6 padd-rght-5">
                                    <label for="validationCustom01" class="form-label-fnds">Passout Date</label>
                                </div>
                                <div class="col-xl-6 padd-lft-5">
                                    <asp:TextBox ID="txt_passout_date" runat="server" class="form-control find-dv-txtbx datepicker" Style="width: 220px"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-6 padd-lft-5">
                            <asp:Button ID="btn_create_certificate" OnClick="btn_create_certificate_Click" runat="server" Text="Create" CssClass="btn btn-primary form-fnd-btns" Style="margin: 8px 0px 10px -4px;" />
                        </div>
                    </div>
                </div>
            </div>
