<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="Send_Notice_To_Teacher.aspx.cs" Inherits="school_web.Admin.Send_Notice_To_Teacher" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Send Notice to Teachers
</asp:Content>
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Send Notice to Teachers</li>
                        </ol>
                    </nav>
                </div>
            </div>
                                ...
                                <div class="col-xl-6">
                                    <div class="p-4 border rounded">
                                        <div class="row g-3 needs-validation" novalidate=""> 
                                            <div class="col-md-12">
                                                <label for="validationCustom01" class="form-label">Teacher List<sup></sup></label>
