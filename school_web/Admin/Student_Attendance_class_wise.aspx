<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="Student_Attendance_class_wise.aspx.cs" Inherits="school_web.Admin.Student_Attendance_class_wise" EnableEventValidation="false" %>
                    ...
                    <div class="card">
                        <div class="card-body">
                                            ...
                                            <div class="find-dv">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        ...
                                                        <asp:LinkButton ID="print1" Visible="false" OnClientClick="return PrintPanel()" CssClass="print-btn" runat="server" Style="background-color: #009f25; border: 5px solid #009f25; cursor: pointer; float: none; display: inline-block; width: 32px; height: 26px; margin: 22px 0px 0px 13px;"
                            ...
                            <asp:Label ID="lbl_website" runat="server"></asp:Label>
                                                                ...
                                                                <div style="margin: 7px 0px 0px 0px; padding: 0px; float: left; height: auto; text-align: center; vertical-align: middle; font-size: 13px; width: 100%;">
                                                                    Class Wise Student Attendance :<asp:Label ID="lbll_section_and_class" runat="server"></asp:Label>
