<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="Day_wise_Class_Chart_Teacher.aspx.cs" Inherits="school_web.Admin.Day_wise_Class_Chart_Teacher" EnableEventValidation="false" ValidateRequest="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Day Wise Teacher Routing
</asp:Content>
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Day Wise Teacher Routing</li>
                        </ol>
                    </nav>
                </div>
            </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="find-dv">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-2">
                                                        <label for="validationCustom01" class="find-dv-lbl">Day</label>
                                                        <asp:DropDownList ID="ddl_Day" runat="server" class="form-select"></asp:DropDownList>
                                                    </div>
