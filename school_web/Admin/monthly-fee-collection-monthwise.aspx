<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="monthly-fee-collection-monthwise.aspx.cs" Inherits="school_web.Admin.monthly_fee_collection_monthwise" %>
            ...
            <div class="row">
                <div class="col-xl-12">
                    ...
                    <ul class="sub-pag-menu-ul"> 
                        ...
                        <li><a href="monthly-fee-collection-monthwise.aspx"  class="sub-mnu-p-a-active">Month-Wise Fee Collection</a></li>
                        ...
                        <li><a href="monthly-fee-collection-monthwise.aspx" class="sub-mnu-p-a-active">Monthly Fee Collection Month-Wisek</a></li>
                            ...
                            <asp:Label ID="lbl_website" runat="server"></asp:Label>
                                                    ...
                                                    <asp:Panel ID="Panel1" runat="server">
                                                        <table id="example2" class="table table-bordered dataTable" role="grid" aria-describedby="example2_info">
                                                                ...
                                                                <asp:Repeater ID="rd_view" runat="server">
                                                                    <ItemTemplate>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <asp:Label ID="Label7" runat="server" Text='<%#Bind("slipno")%>'></asp:Label>
                                                                            </td>
                                                                            <td>
                                                                                <asp:Label ID="Label6" runat="server" Text='<%#Bind("adno")%>'></asp:Label>
                                                                            </td>
                                                                            <td>
                                                                            ...
                                                                            <td>
                                                                                <asp:Label ID="lbl_class" runat="server" Text='<%#Bind("Class_name")%>'></asp:Label>
                                                                            </td>

                                                                            <td>
                                                                                <asp:Label ID="lbl_section_name" runat="server" Text='<%#Bind("Section_name")%>'></asp:Label>
                                                                            </td>
                                                                            <td>
                                                            ...
                                                            <tr>
                                                                <td colspan="7" style="text-align: right; border-bottom: 1px solid #c5c0c0; font-weight: 500; font-size: 14px;">Total Paid Amount</td>
                                                                <td colspan="2" style="border-bottom: 1px solid #c5c0c0; font-weight: 500; font-size: 14px;">
                                                                    <asp:Label ID="lbl_fnl_paid" runat="server"></asp:Label></td>
                                                            </tr>
                                                        </table>
