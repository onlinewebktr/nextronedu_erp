<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="monthly-slip.aspx.cs" Inherits="school_web.Admin.slip.monthly_slip" %>
                    ...
                    <div class="certificate-wpr1">
                        ...
                        <asp:Label ID="lbl_paymentdate" runat="server" Font-Bold="true"></asp:Label>
                                ...
                                <div class="footer_auth_sig">
                                   <asp:Label ID="lbl_note" class="slipnotes" runat="server" Style="float: left; padding: 0px 0px 6px 4px;"></asp:Label>
                                    
                                    <div style="margin:0px;padding:0px;width:30%;float: left;">
                                        <b>Accountant Signature</b>
                                    </div>
                                    
                                     <div style="margin:0px;padding:0px;width:20%;float: left;float: left;">
                                        <b>Seal</b>
                                    </div>

                                     <div style="margin:0px;padding:0px;width:46%;float: left;">
                                        <b><asp:Label ID="lbl_username" runat="server"></asp:Label></b>
                                    </div>
                ...
                <div class="mainautot" id="studentcopY">
                    <div class="certificate-wpr1">
                        ...
                        <asp:Label ID="lbl_paymentdate1" runat="server" Font-Bold="true"></asp:Label>
                                ...
                                <div class="studentdetails">
                                    <div class="student_left-p-info" runat="server" id="fNamDV1">
                                        <p>Father Name</p>
                                        <i>:</i>
                                    ...
                                    <div class="student_left-p-info" runat="server" id="RollDV1">
                                        <p>Roll No.</p>
                                        <i>:</i>
                                ...
                                <div class="footer_auth_sig">
                                    <asp:Label ID="lbl_note1" class="slipnotes" runat="server" Style="float: left; padding: 0px 0px 6px 4px;"></asp:Label>
                                    ...
                                    <div style="margin:0px;padding:0px;width:30%;float: left;">
                                     ...
                                     <div style="margin:0px;padding:0px;width:46%;float: left;">
                                        <b><asp:Label ID="lbl_username1" runat="server"></asp:Label></b>
                                    </div>
                                </div>
