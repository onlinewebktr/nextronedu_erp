<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sports_certificate.aspx.cs" Inherits="school_web.Admin.slip.sports_certificate" %>
                                ...
                                <div class="certificate-horikk">
                                    <div class="certificate-content-t-sec">
                                        ...
                                        <div class="certtextkk">
                                            <asp:Label ID="lbl_year1" runat="server" class="certtextkk_label certmk1"  Style="margin: -5px 0px 0px 67px;"> </asp:Label>
                                        ...
                                        <div class="certtextkk mcmainnn">
                                            <asp:Label ID="lbl_participated" runat="server" class="certtextkklabmm certmk3" style="width: 62%;"> </asp:Label>
                                        ...
                                        <div class="certtextkk mcmainnn2">
                                            <asp:Label ID="lbl_date" runat="server" class="certtextkklabmm certmk6">21/11/2024</asp:Label>
                                        </div>
