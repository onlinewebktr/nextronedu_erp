<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="online_career_form.aspx.cs" Inherits="school_web.Admin.slip.online_career_form" %>
                ...
                <div class="print-pg-sec" id="tblPrintIQ" runat="server">
                    <div class="print_form-inr">
                        ...
                        <div class="certificate-type-name-t-sec">
                            <h1 class="t-certificate-type-name-h">STAFF RECRUITMENT FORM -<asp:Label ID="lbl_session1" runat="server" Text=""></asp:Label></h1>
                        </div>
                        ...
                        <div class="print_form-dtls">
                            ...
                            <table class="print_table">
                                ...
                                <tr>
                                    ...
                                    <td>Subject Name :</td>
                                    <td>
                                        <asp:Label ID="lbl_subject_name" runat="server" Text=""></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td colspan="5">
                                        <asp:GridView ID="grid_work_experiance" runat="server" class="table table-bordered" AutoGenerateColumns="False" Width="100%" OnRowDataBound="grid_work_experiance_RowDataBound" ShowFooter="True">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Cass Teacher(if teacher)">
                                                    <ItemTemplate>
                                ...
                                <tr>
                                    <td colspan="5" style="font-weight: 600;">
                                        <asp:GridView ID="grid_english" runat="server" class="table table-bordered" AutoGenerateColumns="False" Width="100%" OnRowDataBound="grid_work_experiance_RowDataBound" ShowFooter="True">
                                            <Columns>
                                        ...
                                        <asp:GridView ID="grid_hindi" runat="server" class="table table-bordered" AutoGenerateColumns="False" Width="100%" OnRowDataBound="grid_work_experiance_RowDataBound" ShowFooter="True">
                                            <Columns>
                                        ...
                                        <asp:GridView ID="grid_bangali" runat="server" class="table table-bordered" AutoGenerateColumns="False" Width="100%" OnRowDataBound="grid_work_experiance_RowDataBound" ShowFooter="True">
                                            <Columns>
