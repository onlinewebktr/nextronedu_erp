<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="transfer-certificate-006.aspx.cs" Inherits="school_web.Admin.slip.TC.transfer_certificate_006" %>
                                ...
                                <div class="certificate-wpr2">
                                    ...
                                    <div class="certificate-content-t-sec">
                                        <div class="crtifcate-dvder3">
                                            <div style="margin:0px;padding:0px; float:left; height:auto;width:50%">
                                                <p class="crtifcate-dvder3-p-cntr" id="schoolno" runat="server" visible="false" style="width:100%;line-height: 30px;">
                                                School Regd. No. :
                                            ...
                                            <p class="crtifcate-dvder3-p-rght" style="float: right; margin: 4px 0px 0px 0px;width:100%;line-height: 30px;" id="udise_no" runat="server" visible="false">
                                                UDISE :
                                        ...
                                        <div class="crtifcate-contnt-t-wpr">
                                            <div class="t-certificate-img-dv-cnt-wpr">
                                                ...
                                                <div class="crtifcate-contnt-t-row">
                                                 ...
                                                 <div class="crtifcate-contnt-t-row">
                                                    <p class="crtifcate-contnt-t-p-lft dec-width"><span>4.</span>Father's Name<i>:</i></p>
                                            ...
                                            <div class="crtifcate-contnt-t-row">
                                                <p class="crtifcate-contnt-t-p-lft"><span style="height: 40px;">11.</span>Examination Result of the class last studied<i>:</i></p>
                                                <asp:Label ID="lbl_school_board_exam_taken" runat="server" class="crtifcate-contnt-t-p-rght"></asp:Label>
                                            </div>
                                           
                                            <div class="crtifcate-contnt-t-row">
                                                <p class="crtifcate-contnt-t-p-lft"><span>12.</span>Subject studied, Compulsory<i>:</i></p>
                                            ...
                                            <div class="crtifcate-contnt-t-row">
                                                <p class="crtifcate-contnt-t-p-lft"><span>13.</span>Whether qualified for promotion/to which class<i>:</i></p>
                                                <asp:Label ID="lbl_qualified_for_promotion" runat="server" class="crtifcate-contnt-t-p-rght"></asp:Label>
                                            </div>
                                            
                                           
                                            <div class="crtifcate-contnt-t-row">
                                                <p class="crtifcate-contnt-t-p-lft"><span>14.</span>Total no of working days<i>:</i></p>
                                                <asp:Label ID="lbl_ttl_no_of_working" runat="server" class="crtifcate-contnt-t-p-rght"></asp:Label>
                                            </div>
                                            <div class="crtifcate-contnt-t-row">
                                                <p class="crtifcate-contnt-t-p-lft"><span>15.</span>Total no of working days present<i>:</i></p>
                                                <asp:Label ID="lbl_ttl_no_of_working_present" runat="server" class="crtifcate-contnt-t-p-rght"></asp:Label>
                                            </div>
                                           
                                           
                                            <div class="crtifcate-contnt-t-row">
                                                <p class="crtifcate-contnt-t-p-lft"><span>16.</span>General conduct<i>:</i></p>
                                                <asp:Label ID="lbl_general_conduct" runat="server" class="crtifcate-contnt-t-p-rght" Text=""></asp:Label>
                                            </div>
                                            <div class="crtifcate-contnt-t-row">
                                                <p class="crtifcate-contnt-t-p-lft"><span>17.</span>Date of application for certificate<i>:</i></p>
                                                <asp:Label ID="lbl_date_of_application" runat="server" class="crtifcate-contnt-t-p-rght" Text=""></asp:Label>
                                            </div>
                                            <div class="crtifcate-contnt-t-row">
                                                <p class="crtifcate-contnt-t-p-lft"><span>18.</span>Date of issue of certificate<i>:</i></p>
                                    ...
                                    <div class="certificate-footer-t-sec signbtm" id="bydefult" runat="server">
                                        ...
                                        <div class="sig-left" runat="server" id="Position2" visible="false" >
                                            ...
                                            <p class="sig-ps">
                                                <asp:Label ID="lbl_deg2" runat="server"></asp:Label></p>
                                        </div>
