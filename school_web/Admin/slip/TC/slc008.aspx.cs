...
{
    public partial class slc008 : System.Web.UI.Page
    {
        My mycode = new My();
        ...
        private void Bind_crtificate_info()
        {
            ...
            else
            {
                ...
                lbl_promot_class.Text = dt.Rows[0]["Promotion_class"].ToString();
                //=============
                lbl_monthuptopaid.Text = dt.Rows[0]["Monthuptopaid"].ToString();
                lbl_concession.Text = dt.Rows[0]["Concession"].ToString();
                //=============
        ...
        {
            Response.Redirect("../../print-SLC-certificate.aspx", false);
        }
    }
}