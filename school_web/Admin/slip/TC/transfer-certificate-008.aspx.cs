...
{
    public partial class transfer_certificate_008 : System.Web.UI.Page
    {
        My mycode = new My();
        ...
        private void Bind_Transfer_certificate_setting()
        {
            try
            {
                ...
                if (dt.Rows.Count == 0)
                {
                    DataTable dt1 = mycode.FillData("select * from Transfer_certificate_setting where Tc_type_id='8'");
                    if (dt1.Rows.Count == 0)
                    {
        ...
        private void Bind_crtificate_info()
        {
            ...
            else
            {
                ...
                lbl_pin_no.Text = dt.Rows[0]["Student_PEN"].ToString();
                if (dt.Rows[0]["Student_PEN"].ToString() == "")
                {
                    pin_no.Visible = false;
                }
                else
                {
                    pin_no.Visible = true;
                ...
                lbl_admission_2.Text= dt.Rows[0]["Admission_no"].ToString();
                ...
                lbl_whether_qualified_for_promotion.Text = dt.Rows[0]["whether_qualified_for_promotion"].ToString();

                lbl_monthuptopaid.Text =dt.Rows[0]["Monthuptopaid"].ToString();
                ...
                lbl_student_address.Text= dt.Rows[0]["careof"].ToString() +" PO:- "+ dt.Rows[0]["postoffice"].ToString()+" PS:- "+ dt.Rows[0]["policestation"].ToString()+" Dist:- "+ dt.Rows[0]["district"].ToString() + " STATE:- " + dt.Rows[0]["state"].ToString() + " PIN:- " + dt.Rows[0]["pin"].ToString();

                lbl_dob.Text= dt.Rows[0]["dob"].ToString();
                lbl_gender.Text= dt.Rows[0]["gender"].ToString();
                lbl_leftdate_student.Text= dt.Rows[0]["Data_of_left_school"].ToString();
                ...
                try
                {
                    ...
                    lbl_dob_word.Text =  inword_day + " " + monthName + ", " + inword_year;
                }
                catch (Exception ex)
                {
                    lbl_dob_word.Text = dt.Rows[0]["dob"].ToString();
                }
            }
        }
        ...
        private void Bind_schoolinfo()
        {
            ...
            else
            {
                ...
                //if (dt.Rows[0]["school_no"].ToString() == "")
                //{
                //    schoolno.Visible = false;
                //}
                //else
                //{
                //    schoolno.Visible = true;
                //}

                lbl_udise_no.Text = dt.Rows[0]["Udise_no"].ToString();
                if (dt.Rows[0]["Udise_no"].ToString() == "")
                {
                    udise_no.Visible = false;
                }
                else
                {
                    udise_no.Visible = true;
                }
                ...
                {
                    affiliation_no = "CBSE Affiliation No. : " + dt.Rows[0]["Affiliation"].ToString();
                }
