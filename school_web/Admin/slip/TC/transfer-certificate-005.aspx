<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="transfer-certificate-005.aspx.cs" Inherits="school_web.Admin.slip.TC.transfer_certificate_005" %>
...
<head runat="server">
    ...
    <link href="css/certificate005.css" rel="stylesheet" />
    <script type="text/javascript">
        function PrintPanel() {
            ...
            printWindow.document.write('<link href="css/certificate005.css" rel="stylesheet" type="text/css" />');
                                ...
                                <div class="certificate-wpr2">
                                    <div class="t-crtifcate-hdr-sec"  id="header_txt" runat="server" visible="false">
                                        ...
                                        <div class="t-crtifcate-hdr-contnt-sec">
                                            ...
                                            <p class="crtifcate-dvder3-aff-nos">
                                                <asp:Label ID="lbl_tegline1" runat="server"></asp:Label>
                                            </p>

                                            <p class="crtifcate-dvder3-aff-nos">
                                                <asp:Label ID="lbl_tegline2" runat="server"></asp:Label>
                                            </p>

                                            <p class="crtifcate-dvder3-aff-nos">
                                                <asp:Label ID="lbl_tegline3" runat="server"></asp:Label>
                                            </p>
                                        </div>
                                        <asp:Label ID="lbl_estd" class="estd-scholno-rght" Text="ESTD : 2007" runat="server"></asp:Label>


                                        <div class="aff-scholno">
                                            <div class="aff-scholno-lft">
                                                Affiliation No : 
                                                <asp:Label ID="lbl_aff_no" runat="server"></asp:Label>
                                            </div>

                                            <div class="aff-scholno-rght">
                                                School No :
                                    ...
                                    <div class="certificate-content-t-sec">
                                        ...
                                        <div class="crtifcate-contnt-t-wpr">
                                            <div class="t-certificate-img-dv-cnt-wpr">
                                                ...
                                                <div class="crtifcate-contnt-t-row">
                                                    <p class="crtifcate-contnt-t-p-lft dec-width"><span>2.</span> Aadhar No.<i>:</i></p>
                                                    <asp:Label ID="lbl_aadhar_no" runat="server" class="crtifcate-contnt-t-p-rght dec-width1"></asp:Label>
                                                </div>
                                                <div class="crtifcate-contnt-t-row">
                                                    <p class="crtifcate-contnt-t-p-lft dec-width"><span>2.</span> Student’s PEN<i>:</i></p>
                                                    <asp:Label ID="txt_pen_no" runat="server" class="crtifcate-contnt-t-p-rght dec-width1"></asp:Label>
                                                </div>
                                                <div class="crtifcate-contnt-t-row">
