<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="transfer-certificate-007.aspx.cs" Inherits="school_web.Admin.slip.TC.transfer_certificate_007" %>
                                    ...
                                    <div class="certificate-content-t-sec">
                                        <div class="crtifcate-dvder3">
                                            ...
                                            <div style="margin: 0px; padding: 0px; float: right; height: auto; width: 50%">
                                                <p class="crtifcate-dvder3-p-cntr" runat="server" style="width: 100%; float: right; line-height: 30px; text-align: right;">
                                                    Admission No. :
                                                <asp:Label ID="lbl_admission_no" runat="server"></asp:Label>


                                                </p>
                                                <p class="crtifcate-dvder3-p-cntr" id="pin_no" runat="server" visible="false" style="width: 100%; float: right; line-height: 30px; text-align: right; display: none">
                                                    Student Pin No. :
                                        ...
                                        <div class="crtifcate-contnt-t-wpr">
                                            <div class="t-certificate-img-dv-cnt-wpr">
                                                ...
                                                <div class="crtifcate-contnt-t-row">
                                                    <p class="crtifcate-contnt-t-p-lft dec-width"><span>2.</span>Father's/Gurdian's Name<i>:</i></p>
                                                    <asp:Label ID="lbl_father_name" runat="server" class="crtifcate-contnt-t-p-rght dec-width1"></asp:Label>
                                                </div>
                                                <div class="crtifcate-contnt-t-row">
                                                    <p class="crtifcate-contnt-t-p-lft dec-width"><span>3.</span>Mother's Name<i>:</i></p>
                                            ...
                                            <div class="crtifcate-contnt-t-row">
                                                <p class="crtifcate-contnt-t-p-lft"><span>4.</span>Nationality<i>:</i></p>
                                                <asp:Label ID="lbl_nationality" runat="server" class="crtifcate-contnt-t-p-rght"></asp:Label>
                                            </div>
                                            <div class="crtifcate-contnt-t-row">
                                                <p class="crtifcate-contnt-t-p-lft"><span>5.</span>Does the candidate belongs to SC/ST/OBC<i>:</i></p>
                                                <asp:Label ID="lbl_belongs_to_sc_st" runat="server" class="crtifcate-contnt-t-p-rght"></asp:Label>
                                            </div>
                                            <div class="crtifcate-contnt-t-row">
                                                <p class="crtifcate-contnt-t-p-lft"><span>6.</span>Date of admission & Class<i>:</i></p>
                                                <asp:Label ID="lbl_date_of_admision" runat="server" class="crtifcate-contnt-t-p-rght"></asp:Label>
                                            </div>
                                            <div class="crtifcate-contnt-t-row">
                                                <p class="crtifcate-contnt-t-p-lft"><span>7.</span>Date of birth as per admission register<i>:</i></p>
                                            ...
                                            <div class="crtifcate-contnt-t-row">
                                                <p class="crtifcate-contnt-t-p-lft"><span>10.</span>Whether failed in same class<i>:</i></p>
                                                <asp:Label ID="lbl_failed_in_same_class" runat="server" class="crtifcate-contnt-t-p-rght"></asp:Label>
                                            </div>
                                            <div class="crtifcate-contnt-t-row">
                                                <p class="crtifcate-contnt-t-p-lft"><span>11.</span>Subject studied, Compulsory<i>:</i></p>
                                            ...
                                            <div class="crtifcate-contnt-t-row">
                                                <p class="crtifcate-contnt-t-p-lft"><span>12.</span>Whether qualified for promotion to the higher class, if so, to which class<i>:</i></p>
                                            ...
                                            <div class="crtifcate-contnt-t-row">
                                                <p class="crtifcate-contnt-t-p-lft"><span>13.</span>Whether NCC Cadet/Boy Scout/Girl Guide<i>:</i></p>
                                                <asp:Label ID="lbl_ncc_cadet" runat="server" class="crtifcate-contnt-t-p-rght"></asp:Label>
                                            </div>
                                            <div class="crtifcate-contnt-t-row">
                                                <p class="crtifcate-contnt-t-p-lft"><span style="height: 40px;">14.</span>Games played or extra curricular activities in which the pupil usually took apart<i>:</i></p>
                                            ...
                                            <div class="crtifcate-contnt-t-row">
                                                <p class="crtifcate-contnt-t-p-lft"><span>16.</span>Date of application for certificate<i>:</i></p>
                                                <asp:Label ID="lbl_date_of_application" runat="server" class="crtifcate-contnt-t-p-rght" Text=""></asp:Label>
                                            </div>
                                            <div class="crtifcate-contnt-t-row">
                                                <p class="crtifcate-contnt-t-p-lft"><span>17.</span>Date of issue of certificate<i>:</i></p>
                                                <asp:Label ID="lbl_date_of_issue" runat="server" class="crtifcate-contnt-t-p-rght" Text=""></asp:Label>
                                            </div>
                                            <div class="crtifcate-contnt-t-row">
                                                <p class="crtifcate-contnt-t-p-lft"><span>18.</span>Reason for leaving the school<i>:</i></p>
                                                <asp:Label ID="lbl_reason_for_leaving" runat="server" class="crtifcate-contnt-t-p-rght" Text=""></asp:Label>
                                            </div>
                                            <div class="crtifcate-contnt-t-row">
                                                <p class="crtifcate-contnt-t-p-lft"><span>19.</span>Any other remarks<i>:</i></p>
