<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="transfer-certificate-004.aspx.cs" Inherits="school_web.Admin.slip.TC.transfer_certificate_004" %>
...
<head runat="server">
    ...
    <link href="css/certificate004.css" rel="stylesheet" />
    <script type="text/javascript">
        function PrintPanel() {
            ...
            printWindow.document.write('<link href="css/certificate004.css" rel="stylesheet" type="text/css" />');
                                ...
                                <div class="certificate-wpr2">
                                    ...
                                    <div class="certificate-content-t-sec">
                                        ...
                                        <div class="crtifcate-contnt-t-wpr">
                                            ...
                                            <div class="crtifcate-contnt-t-row">
                                                <p class="crtifcate-contnt-t-p-lft"><span>25.</span>Any other remarks<i>:</i></p>
