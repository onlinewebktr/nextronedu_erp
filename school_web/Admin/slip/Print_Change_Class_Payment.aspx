<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Print_Change_Class_Payment.aspx.cs" Inherits="school_web.Admin.slip.Print_Change_Class_Payment" %>
                ...
                <div class="mainwith">
                    ...
                    <div class="slipno">
                        ...
                        <div class="slipno_middle">
                            <b>Receipt(Class Change History)  </b>
                        </div>
                    ...
                    <div class="studentdetails">
                        <div class="student_left-p-info">
                            <p style="width: 100%; font-weight: bold">Old Student Details</p>

                        </div>
                        <asp:GridView ID="grid_old_student_details" runat="server" CssClass="table table-bordered table-striped" AutoGenerateColumns="False" Width="100%" Style="text-align: center;">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Admission No">
                                    <ItemTemplate>
                                        <asp:Label ID="lbl_Old_admission_no" runat="server" Text='<%#Bind("Old_admission_no") %>'></asp:Label>
                                ...
                                <asp:TemplateField HeaderText="Class Name">
                                    <ItemTemplate>
                                        <asp:Label ID="lbl_Course_Nameold" runat="server" Text='<%#Bind("Course_Nameold") %>'></asp:Label>
                                ...
                                <asp:TemplateField HeaderText="Section">
                                    <ItemTemplate>
                                        <asp:Label ID="lbl_sOld_Section_name" runat="server" Text='<%#Bind("Old_Section_name") %>'></asp:Label>
                                ...
                                <asp:TemplateField HeaderText="Roll No.">
                                    <ItemTemplate>
                                        <asp:Label ID="lbl_Roll_no_old" runat="server" Text='<%#Bind("Roll_no_old") %>'></asp:Label>
                        ...
                        <div class="student_left-p-info">
                            <p style="width: 100%; font-weight: bold">New Details after change class</p>

                        </div>
                        <asp:GridView ID="grid_new_student_details" runat="server" CssClass="table table-bordered table-striped" AutoGenerateColumns="False" Width="100%" Style="text-align: center;">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Admission No">
                                    <ItemTemplate>
                                        <asp:Label ID="lbl_Current_admission_no" runat="server" Text='<%#Bind("Current_admission_no") %>'></asp:Label>
                                ...
                                <asp:TemplateField HeaderText="Class Name">
                                    <ItemTemplate>
                                        <asp:Label ID="lbl_Course_Namenew" runat="server" Text='<%#Bind("Course_Namenew") %>'></asp:Label>
                                ...
                                <asp:TemplateField HeaderText="Section">
                                    <ItemTemplate>
                                        <asp:Label ID="lbl_New_Section" runat="server" Text='<%#Bind("New_Section") %>'></asp:Label>
                                ...
                                <asp:TemplateField HeaderText="Roll No.">
                                    <ItemTemplate>
                                        <asp:Label ID="lbl_Roll_no_New" runat="server" Text='<%#Bind("Roll_no_New") %>'></asp:Label>
                    ...
                    <div class="pay_particular" id="p1" runat="server" visible="false">
                        <div class="student_left-p-info">
                            <p style="width: 100%; font-weight: bold">Student Payment History(Previous Class)</p>
