<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="online-admission-fee-taken.aspx.cs" Inherits="school_web.Admin.slip.online_admission_fee_taken" %>
                    ...
                    <div class="certificate-wpr1">
                        ...
                        <asp:Label ID="lbl_paymentdate" runat="server" Font-Bold="true"></asp:Label>
                                ...
                                <div class="pay_particular">
                                    <asp:GridView ID="grd_fee" runat="server" CssClass="table table-bordered table-striped" AutoGenerateColumns="False" Width="100%" Style="text-align: center;" ShowFooter="True">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Particular">
                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_feetype" runat="server" Text="Admission Fee"></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Fee Amount">
                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_payable" runat="server" Text='<%#Bind("Admission_fee","{0:n}") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Paid Amount">
                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_admission_fee_taken" runat="server" Text='<%#Bind("Admission_fee_taken","{0:n}") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="Dues Amount">
                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_admission_fee_dues" runat="server" Text='<%#Bind("Admission_fee_dues","{0:n}") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                    </asp:GridView>
                ...
                <div class="mainautot" id="studentcopY">
                    <div class="certificate-wpr1">
                        ...
                        <asp:Label ID="lbl_paymentdate1" runat="server" Font-Bold="true"></asp:Label>
                                ...
                                <div class="pay_particular">
                                    <asp:GridView ID="grd_fee1" runat="server" CssClass="table table-bordered table-striped" AutoGenerateColumns="False" Width="100%" Style="text-align: center;" ShowFooter="True">
                                        <Columns>
