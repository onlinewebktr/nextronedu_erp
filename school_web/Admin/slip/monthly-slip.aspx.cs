...
{
    public partial class monthly_slip : System.Web.UI.Page
    {
        My mycode = new My();
        ...
        private void bind_amount()
        {
            ...
            else
            {
                ...
                lbl_username1.Text = lbl_username.Text ="User Name ("+mycode.get_user(dt.Rows[0]["user_id"].ToString())+")";
            }
        }
        ...
        private void Bind_schoolinfo()
        {
            ...
            else
            {
                ...
                try
                {
                    DataTable dtn = My.dataTable("select * from Slip_note where Slip_type='Monthly_slip'");
                    if (dtn.Rows.Count > 0)
                    {
                        lbl_note.Text = lbl_note1.Text = dtn.Rows[0]["Description_note"].ToString();
                    }
                    else
                    {
