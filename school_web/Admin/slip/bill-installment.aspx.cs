...
{
    public partial class bill_installment : System.Web.UI.Page
    {
        My mycode = new My();
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                if (Request.QueryString["admissionno"] != null)
                {
                    ...
                    hd_month_name_hide.Value = "No"; 
                    hd_session.Value = ViewState["session"].ToString();
                    hd_class_id.Value = Request.QueryString["classid"];
                    hd_admission_no.Value = Request.QueryString["admissionno"];
                    hd_slip_no.Value = Request.QueryString["Slip_no"];
                    try
                    {
                        ...
                        if (isopenFromMBL.ToUpper() == "YES")
                        {
                            ...
                            hd_print_type.Value = "2";

                            officecopY.Attributes["style"] = "margin: 20px auto!important;float: none!important; ";
                            printBtns.Attributes["style"] = "margin-top: 20px;!important;";

                        }
                    }
                    catch
                    {
                        officecopY.Attributes["style"] = "0px 1% 0px 0px!important;float: left!important; ";
                        printBtns.Attributes["style"] = "margin-top: 0px;!important;";
        ...
        private void Bind_schoolinfo()
        {
            ...
            else
            {
                ...
                {
                    hd_month_name_hide.Value = "No";
                    if (dt.Rows[0]["Is_month_hide_from_inst_bill"].ToString() == "True")
                    {
                        hd_month_name_hide.Value = "Yes";
                    } 
                }
                catch
                {
