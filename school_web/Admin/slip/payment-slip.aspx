<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="payment-slip.aspx.cs" Inherits="school_web.Admin.slip.payment_slip1" %>
...
<head runat="server">
    ...
    <link href="css/receipt-landscap.css" rel="stylesheet" />
    ...
    <script type="text/javascript">
        function PrintPanel() {
            ...
            printWindow.document.write('<link href="css/receipt-landscap.css" rel="stylesheet" type="text/css" />');
    ...
    <form id="form1" runat="server">
            ...
            <div class="printpagewprs" data-ng-app="RpCardApp" data-ng-controller="RpCardAppCtrl">
                <div id="tblPrintIQ" runat="server">
                    <div class="mainautot">
                                ...
                                <div class="certificate-wpr2">
                                    <div class="mainwith">
                                            ...
                                            <table class="table table-bordered table-striped">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>Particulars</th>
                                                        <th class="txtcnter">Amount</th>
                                                        <th class="txtcnter">Discount</th>
                                                        <%--<th class="txtcnter">Payable</th>--%>
                                                ...
                                                <tbody> 
                                                    <tr>
                                                        ...
                                                        <td class="txtcnter">
                                                            <span class="incomeLeft txtcntr" data-ng-repeat="x in feeDetails">{{x.Fee_amount}}</span>
                                                        </td>
                                                        <td class="txtcnter">
                                                            <span class="incomeLeft txtcntr" data-ng-repeat="x in feeDetails">{{x.Disc_amt}}</span>
                                                        </td>
                                                        <%--<td class="txtcnter">
                                                            <span class="incomeLeft txtcntr" data-ng-repeat="x in feeDetails">{{x.Payable}}</span>
                                                        </td>--%>
                                                        <td class="txtcnter">
                                                ...
                                                <tr>
                                                    <td></td>
                                                    <td class="fntbold" colspan="3">Total</td>
                                                    <td class="txtcnter" style="display:none">
                                                ...
                                                <tr>
                                                    <td></td>
                                                    <td class="fntbold" colspan="3">Discount</td> 
                                                    <td class="txtcnter"><asp:Label ID="lbl_discount_amt" class="fntbold" runat="server"></asp:Label></td>
                                                </tr>
                                                <tr>
                                                    <td></td>
                                                    <td class="fntbold" colspan="3">Remaining Amount</td> 
                                                    <td class="txtcnter">
                                        ...
                                        <div class="notediv">
                                            ...
                                            <p>2. If any correction, Please consult to fee counter.</p>
                                        </div>
                        ...
                        <div class="printrghts" id="officecopY">
                            <div class="certificate-wpr1">
        ...
        <script type="text/javascript">
            ...
            app.controller('RpCardAppCtrl', function ($scope, $http) {
                ...
                // Fetch income data
                $http.get("webServices/payment-receipt.asmx/fetch_report_billing_fee_dt", { params: { "Session": session, "Admission_no": admission_no, "Slip_no": slip_no } })
