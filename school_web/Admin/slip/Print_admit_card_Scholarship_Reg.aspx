<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Print_admit_card_Scholarship_Reg.aspx.cs" Inherits="school_web.Admin.slip.Print_admit_card_Scholarship_Reg" %>
    ...
    <form id="form1" runat="server">
                        ...
                        <div class="invoice-wpr">
                            <div class="printpage-sec-main">
                                ...
                                <div class="nammarggg">
                                    ...
                                    <div class="name1sec">
                                        ...
                                        <div class="namehead">
                                            ...
                                            <asp:Label ID="Label4" runat="server" CssClass="nameheadll" Text="{{x.Roll_no}}"></asp:Label>
                                        </div>
                                ...
                                <div class="administration-paragraph">
                                    ...
                                    <table>
                                        <tr>
                                            <th colspan="8" style="text-align: center; background-color: #f7f7f7">EXAMINATION CENTRE,STARTING DATE & TIME  </th>
                                        </tr>
                                        <tr>
                                            <td colspan="2" style="text-align: left">EXAMINATION CENTRE
                                            </td>
                                            <td colspan="6">
                                                <asp:Label ID="lbl_exam_centername" runat="server" CssClass="nameheadll" Text="{{x.centername}}"></asp:Label>
                                            </td>


                                        </tr>
                                        <tr>
                                            <td colspan="2" style="text-align: left">CENTRE ADDRESS
                                            </td>
                                            <td colspan="6">
                                                <asp:Label ID="lbl_Center_Address" runat="server" CssClass="nameheadll" Text="{{x.Center_Address}}"></asp:Label>
                                            </td>
                                        ...
                                        <tr>
                                            <td colspan="2" style="text-align: left">ROLL NO.
                                            </td>
                                            <td colspan="6">
                                                <asp:Label ID="lbl_roll_no" runat="server" CssClass="nameheadll" Text="{{x.Roll_no}}"></asp:Label>
                                            </td>


                                        </tr>
                                         <tr>
                                            <td colspan="2" style="text-align: left">ROOM NO
                                            </td>
                                            <td colspan="6">
                                                <asp:Label ID="lbl_room_no" runat="server" CssClass="nameheadll" Text="{{x.Room_no}}"></asp:Label>
                                            </td>
                                      ...
                                      <%--      <th>EXAM SHIFT</th>--%>
                                            ...
                                            <%--<th>GATE CLOSURE TIME</th>--%>
                                            <%--<th>EXAM TYPE	</th>--%>
                                            <%--<th>SIGNATURE OF THE INTERVIEWER</th>--%>
                                        </tr>
                                        <tr data-ng-repeat="item in x.MyExamDetailsItem track by $index">
                                            <td>{{$index+1}}</td>
                                            <%--<td>{{item.Exam_Shift}}</td>--%>
        ...
        <script type="text/javascript">
            ...
            app.controller('RpCardAppCtrl', function ($scope, $http) {
                ...
                var exam_centerid = $("#<%=hd_exam_centerid.ClientID%>").val();
                messge("Please Wait...");
                $("#intsLoader").removeClass("hidden");
                $http.get("webServices/ScholarshipadmitCard.asmx/fetch_admit_card_details", { params: { "scholarshipid": scholarshipid, "exam_centerid": exam_centerid, "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Coming_from": coming_from, "Branch_id": branch_id } }).then(function (response) {
