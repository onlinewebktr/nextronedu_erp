<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="print-demand-bill-backdues.aspx.cs" Inherits="school_web.Admin.slip.print_demand_bill_backdues" %>
                                ...
                                <div class="printpage-sec-main">
                                    ...
                                    <div class="administration-paragraph ">
                                        <table>
                                            ...
                                            <tr id="moreInfo" runat="server" visible="false" style="display: none">
                                                <td colspan="3">
                                            ...
                                            <tr>
                                                <td colspan="3">
                                                    <p class="remarks-note-p" style="font-size: 16px; line-height: 26px;">
                                                        📢 अभिभावकों के लिए महत्वपूर्ण निर्देश
                                                    </p> 
                                                    <p class="remarks-note-p" style="padding: 5px 50px 0px 27px; font-weight: 500;">
                                                        <i style="font-style: normal; float: left; padding: 0px 4px 18px 0px;">⭐</i> जो अभिभावक हर महीने की 1 तारीख से 5 तारीख के बीच पेमेंट करेंगे, उन्हें ट्यूशन फ़ीस पर 5% की छूट मिलेगी।
                                                    </p>
                                                    <p class="remarks-note-p" style="padding: 5px 50px 0px 27px; font-weight: 500;">
                                                        <i style="font-style: normal; float: left; padding: 0px 4px 0px 0px;">⭐</i> जो अभिभावक पूरे 12 महीनों की ट्यूशन फ़ीस एक साथ (एडवांस में) देने का विकल्प चुनेंगे, उन्हें एक महीने की ट्यूशन फ़ीस छूट दी जाएगी।
                                                    </p>
                                                    <p class="remarks-note-p" style="padding: 5px 50px 0px 27px; font-weight: 500;">
                                                        <i style="font-style: normal; float: left; padding: 0px 4px 18px 0px;">⭐</i> यदि पूरी मासिक फीस निर्धारित समय-सीमा के भीतर जमा नहीं की जाती है, तो एक महीने की अतिरिक्त मोहलत (grace period) दी जाएगी। इसके बाद, दूसरे महीने से ₹50 प्रति माह का विलंब शुल्क (late fine) लिया जाएगा
                                                    </p>
                                                    <%--<p class="remarks-note-p" style="padding: 5px 50px 0px 27px; font-weight: 500;">
                                                        <i style="font-style: normal; float: left; padding: 0px 4px 18px 0px;">⭐</i> Without Admit Card, students will not be allowed to appear in the Final Examination.
                                                    </p>--%>
                                                </td>
                                            </tr>
                                        </table>
