<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="online-reg.aspx.cs" Inherits="school_web.Admin.slip.online_reg" %>
                ...
                <div class="print-pg-sec" id="tblPrintIQ" runat="server">
                    <div class="print_form-inr">
                        ...
                        <div class="certificate-type-name-t-sec">
                            <h1 class="t-certificate-type-name-h">Admission Registration Receipt -<asp:Label ID="lbl_session1" runat="server" Text=""></asp:Label></h1>
                        </div>
                        ...
                        <div class="print_form-dtls">
                            ...
                            <div class="images-wprs" runat="server" id="decuments">
                                <div class="images-dv-wprs" id="img_parentSignDV" runat="server" style="width: 50%; margin: 0px auto; float: none; display: flow-root;">
                                    <div class="images-wprsimges">
                                        <asp:Image ID="img_parents_sign" runat="server" />
                                    </div>
                                    <div class="images-dv-wprs-name-pdv">
                                        <p class="images-dv-wprs-name-p">Parent's Signature</p>
                                    </div>
                                </div>
                                ...
                                <div class="images-dv-wprs" id="paymentslip" runat="server">
                                    <div class="images-wprsimges">
                                        <asp:Image ID="Image2" runat="server" />
                                    </div>
                                    <div class="images-dv-wprs-name-pdv">
                                        <p class="images-dv-wprs-name-p">Payment Slip</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <p class="dtls_grp-p">
                                Note : Hard copy of photo & id proof is needed at admission time.
                            </p>
                        </div>
                    </div>
                </div>
