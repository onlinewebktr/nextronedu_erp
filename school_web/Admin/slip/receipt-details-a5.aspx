<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="receipt-details-a5.aspx.cs" Inherits="school_web.Admin.slip.receipt_details_a5" %>
...
<head runat="server">
    ...
    <link href="css/receipt-details-a5.css" rel="stylesheet" />
    <script type="text/javascript">
        function PrintPanel() {
            ...
            printWindow.document.write('<link href="css/receipt-details-a5.css" rel="stylesheet" type="text/css" />');
                                ...
                                <div class="certificate-wpr2">
                                    <div class="mainwith">
                                        ...
                                        <div class="studentdetails">
                                            ...
                                            <div class="student-info-row" runat="server" id="payChekOnline" style="display: none">
                                                <div class="student_left-p-info">
                                        ...
                                        <div class="pay_particular">
                                            <table class="table table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    <asp:Repeater ID="grd_fees" runat="server" OnItemDataBound="grd_fees_ItemDataBound">
                                                        <ItemTemplate>
                                                            <tr>
                                                                <td class="txtcnter">
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <asp:Label ID="lbl_month_name_s" runat="server"></asp:Label>
                                                                    <asp:Label ID="lbl_month_name" Visible="false" runat="server" Text='<%#Bind("Month") %>'></asp:Label>
                                                                </td>
                                                                <td class="txtcnter">
                                        ...
                                        <div class="footer_auth_sig">
                                            <p>
                                                <i>Signature</i><br />
                                                <asp:Label ID="lbl_issued_by" runat="server"></asp:Label>
                                                <br />
                                                Collection Incharge
                                            </p>
                                        </div>
                                ...
                                <div class="certificate-wpr2">
                                    <div class="mainwith" id="studentcopYInr">
                                        ...
                                        <div class="studentdetails">
                                            ...
                                            <div class="student-info-row" runat="server" id="payChekOnline1" style="display: none">
                                                <div class="student_left-p-info">
                                        ...
                                        <div class="pay_particular">
                                            <table class="table table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    <asp:Repeater ID="rp_fees1" runat="server" OnItemDataBound="rp_fees1_ItemDataBound">
                                                        <ItemTemplate>
                                                            <tr>
                                                                <td class="txtcnter">
                                                                    <asp:Label ID="lbl_SL" runat="server" Text='<%#Container.ItemIndex+1 %>'></asp:Label>
                                                                ...
                                                                <td>
                                                                    <asp:Label ID="lbl_feetype" runat="server" Text='<%#Bind("Particular") %>'></asp:Label>,
                                                                     <asp:Label ID="lbl_month_name_s1" runat="server"></asp:Label>
                                                                    <asp:Label ID="lbl_month_name1" Visible="false" runat="server" Text='<%#Bind("Month") %>'></asp:Label>
                                                                </td>
                                                                <td class="txtcnter">
                                                                    <asp:Label ID="lbl_payable" runat="server" Text='<%#Bind("fee_amount") %>'></asp:Label>
                                                                </td>
