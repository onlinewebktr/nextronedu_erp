...
{
    public partial class bill_with_scholarship : System.Web.UI.Page
    {
        My mycode = new My();
        ...
        private void Bind_schoolinfo()
        {
            ...
            { 
                ...
                if (dt.Rows[0]["firm_id"].ToString() == "MSI-001")
                {
                    payChekOnline1.Visible = false;
                    payBankName1.Visible = false;
                    payBankName.Visible = false;
                    ...
                    //=============================
                    bankImages.Visible = true;
                    bankImages1.Visible = true;
                }
            }
        }
