<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admission_slip.aspx.cs" Inherits="school_web.Admin.slip.Admission_slip" %>
                ...
                <div class="certificate-wpr1">
                    ...
                    <div class="certificate-wpr2">
                        ...
                        <asp:Label ID="lbl_paymentdate" runat="server" Font-Bold="true"></asp:Label>
                            ...
                            <div class="studentdetails">
                                <div class="student_left-p-info" id="fNamDV" runat="server">
                                    <p>Father Name</p>
                                    <i>:</i>
                                ...
                                <div class="student_left-p-info" runat="server" id="RollDV">
                                    <p>Roll</p>
                                    <i>:</i>
                                ...
                                <asp:GridView ID="grd_fee" runat="server" CssClass="table table-bordered table-striped" AutoGenerateColumns="False" Width="100%" Style="text-align: center;" ShowFooter="True" OnRowDataBound="grd_fee_RowDataBound">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Fee Amount">
                                            <ItemTemplate>
                                                <asp:Label ID="lbl_payable" runat="server" Text='<%#Eval("fee_amount","{0:n}") %>'></asp:Label>
                            ...
                            <div class="footer-ttl-div">
                                <div style="margin: 0px; padding: 2px 0px 2px 0px; float: left; height: auto; width: 100%" id="spilt_month_show" runat="server" visible="false">
                                    <h2 class="fnd-box-row-wpr-h" style="font-size: 11px; margin: 2px 0px 4px 0px;">Split Month for Admission Fee
                                    </h2>
                                    <div class="month-checkbox" style="background-color: #fff; padding: 4px 4px 4px 6px; border: 1px solid; text-align: right; color: red">
                                        <asp:Repeater ID="rep_total_split" runat="server">
                                            <ItemTemplate>
                                                ...
                                                -
                                                                 <asp:Label ID="lbl_amount" runat="server" Text='<%#Bind("Amount")%>' ForeColor="Black" Font-Bold="true"></asp:Label>
                                            </ItemTemplate>
                                        </asp:Repeater>
                                    </div>
                                </div>
                                ...
                                <div class="footer-ttl-lft-div">
                                    ...
                                    <div class="footer-ttl-lft-p-dv" runat="server" id="HouseDV">
                                        <p>House </p>
                                        <i>:</i>
                                        <asp:Label ID="lbl_house1" runat="server"></asp:Label>
                                    </div>
                ...
                <div class="certificate-wpr1">
                    ...
                    <div class="certificate-wpr2">
                        ...
                        <asp:Label ID="lbl_schoolno1" runat="server" Font-Bold="true"></asp:Label>
                            ...
                            <div class="heading" id="textheader1" runat="server">
                                <div class="leftlogoheading">
                            ...
                            <div class="heading" id="printheader1" runat="server" style="text-align: center">
                        ...
                        <asp:Label ID="lbl_paymentdate1" runat="server" Font-Bold="true"></asp:Label>
                            ...
                            <div class="studentdetails">
                                <div class="student_left-p-info" id="fNamDV1" runat="server">
                                    <p>Father Name</p>
                                    <i>:</i>
                                ...
                                <div class="student_left-p-info" id="RollDV1" runat="server">
                                    <p>Roll</p>
                                    <i>:</i>
                            ...
                            <div class="footer-ttl-div">
                                <div style="margin: 0px; padding: 2px 0px 2px 0px; float: left; height: auto; width: 100%" id="spilt_month_show1" runat="server" visible="false">
                                    <h2 class="fnd-box-row-wpr-h" style="font-size: 11px; margin: 2px 0px 4px 0px;">Split Month for Admission Fee
                                    </h2>
                                    <div class="month-checkbox" style="background-color: #fff; padding: 4px 4px 4px 6px; border: 1px solid; text-align: right; color: red;">
                                        <asp:Repeater ID="rep_total_split1" runat="server">
                                            <ItemTemplate>
                                ...
                                <div class="footer-ttl-lft-div">
                                    ...
                                    <div class="footer-ttl-lft-p-dv" runat="server" id="HouseDV2">
                                        <p>House </p>
                                        <i>:</i>
                                        <asp:Label ID="lbl_house2" runat="server"></asp:Label>
                                    </div>
