...
{
    public partial class bill_slip_a5_single : System.Web.UI.Page
    {
        My mycode = new My();
        ...
        private void bind_amount()
        {
            ...
            else
            {
                ...
                lbl_tr_bank.Text = lbl_tr_bank1.Text = dt.Rows[0]["Payee_bank"].ToString();
        ...
        private void Bind_particular()
        {
            ...
            else
            {
                ...
                lbl_remaining_amt.Text = lbl_remaining_amt1.Text = (remaining_amt - My.toDouble(Total_discount)).ToString();
