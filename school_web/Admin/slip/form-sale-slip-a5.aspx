<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="form-sale-slip-a5.aspx.cs" Inherits="school_web.Admin.slip.form_sale_slip_a5" %>
                                                    ...
                                                    <asp:Repeater ID="grd_fees" runat="server">
                                                        <ItemTemplate>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:Label ID="lbl_feetype" runat="server" Text='Form Sale'></asp:Label>
                                                                </td>
