<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="special-fee-receipt.aspx.cs" Inherits="school_web.Admin.slip.special_fee_receipt" %>
                                                    ...
                                                    <tr>
                                                        <td class="txtcnter">
                                                            <div style="min-height: 240px;">
                                                                <span class="incomeLeft txtcntr">1</span>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <span class="incomeLeft" id="feeHead" runat="server"></span>
                                                        </td>
                                                        <td>
                                                            <span class="incomeLeft txtcntr" id="toPayAmt" runat="server"></span>
                                                        </td>
                                                        <td class="txtcnter">
                                                            <span class="incomeLeft txtcntr" id="toPaidAmt" runat="server"></span>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                        ...
                                        <div class="studentdetails">
                                            ...
                                            <div class="student-info-row">
                                                ...
                                                <div class="student-rght-p-info">
                                                    <p>Pay Mode</p>
                                                    <i>:</i>
                                                    <asp:Label ID="lbl_mode1" runat="server"></asp:Label>
                                                </div>
                                            </div>
                                            ...
                                            <table class="table table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span class="incomeLeft" id="feeHead1" runat="server"></span>
                                                        </td>
                                                        <td class="txtcnter">
                                                            <span class="incomeLeft txtcntr" id="toPayAmt1" runat="server"></span>
                                                        </td>
                                                        <td class="txtcnter">
                                                            <span class="incomeLeft txtcntr" id="toPaidAmt1" runat="server"></span>
                                                        </td>
                                                    </tr>
                                                </tbody>
