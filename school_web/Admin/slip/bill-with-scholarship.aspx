<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bill-with-scholarship.aspx.cs" Inherits="school_web.Admin.slip.bill_with_scholarship" %>
                            ...
                            <div class="certificate-wpr1">
                                ...
                                <div class="certificate-wpr2">
                                    <div class="mainwith">
                                        ...
                                        <div class="studentdetails">
                                            ...
                                            <div class="student-info-row" runat="server" id="payChekOnline">
                                                <div class="student_left-p-info" style="width: 100%">
                                                    <p id="paytrnoname" runat="server" style="width: 16%">Cheque No.</p>
                                                    <i>:</i>
                                            ...
                                            <table class="table table-bordered table-striped">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="txtcnter">Scholarship</th>
                                                ...
                                                <tbody>
                                                    <asp:Repeater ID="grd_fees" runat="server">
                                                        <ItemTemplate>
                                                            <tr>
                                                                ...
                                                                <td class="txtcnter">
                                                                    <asp:Label ID="Label1" runat="server" Text='<%#Bind("disc_amt") %>'></asp:Label>
                                                                </td>
                                                                <td class="txtcnter">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="txtcnter">
                                                            <asp:Label ID="lbl_ttl_paidd" class="fntbold" runat="server"></asp:Label></td>
                                        ...
                                        <div style="width: 100%; float: left; text-align: center; padding: 0px 5px;" runat="server" id="bankImages" visible="false">
                                            <img src="https://msideal.purnank.co.in/Master_Img/ms-idea-bank-details.jpg" style="max-width: 100%" />
                                        </div>
                                    ...
                                    <div class="mainwith" id="studentcopYInr">
                                        ...
                                        <div class="studentdetails">
                                            ...
                                            <div class="student-info-row" runat="server" id="payChekOnline1">
                                                <div class="student_left-p-info" style="width: 100%">
                                                    <p id="paytrnoname1" runat="server" style="width: 16%">Cheque No.</p>
                                                    <i>:</i>
                                            ...
                                            <table class="table table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="fntbold txtrght">Paid Amount</td>
                                                        <td class="txtcnter">
                                                            <asp:Label ID="lbl_ttl_paid11" class="fntbold" runat="server"></asp:Label></td>
                                                        <td class="txtcnter"></td>
                                                        <td class="txtcnter"></td>
                                                    </tr>
                                                    <tr>
                                        ...
                                        <div style="width: 100%; float: left; text-align: center; padding: 0px 5px;" runat="server" id="bankImages1" visible="false">
                                            <img src="https://msideal.purnank.co.in/Master_Img/ms-idea-bank-details.jpg" style="max-width: 100%" />
                                        </div>
