<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="payment-voucher.aspx.cs" Inherits="school_web.Admin.slip.payment_voucher" %>
                ...
                <div class="mainwith">
                    ...
                    <div class="heading" id="textheader" runat="server">
                        ...
                        <div class="righttextheading">
                            <h1 style="margin: 23px 0px 0px 0px; width: 100%; padding: 0px; font-weight: bold; float: left; height: auto; text-align: center; vertical-align: middle; font-size: 24px; line-height: 27px; text-decoration: underline;">
                    ...
                    <div class="heading" id="printheader" runat="server" style="text-align: center">
                        ...
                        <asp:Image ID="img_header" runat="server" style="width: 500px;
    height: 96px;"/>
                    ...
                    <div class="pay_particular">
                        ...
                        <div class="fees-amt-dv">
                            ...
                            <p class="fees-amt-dv-p prevous-duess" style="display: none">
                                <%--₹--%>
                                <asp:Label ID="lbl_prev_dues" runat="server" Style="display: none"></asp:Label>
                            </p>
                            <p class="fees-amt-dv-p prevous-duess" style="border-bottom: 0px dashed #323232;">
                                <%--₹--%>
                                <asp:Label ID="lbl_ttl_amts" runat="server" Style="display: none"></asp:Label>
                            </p>
                    ...
                    <div style="margin: 0px auto; padding: 6px 0px 6px 0px; float: left; height: auto; width: 72%; font-weight: bold; font-size: 21px; border: 1px solid; text-align: center; background-color: #c4c2c2;">
                ...
                <div class="mainautot">
                    <div class="mainwith" style="margin: 0px 0px 5px 15px;">
                        ...
                        <div class="heading" id="printheader1" runat="server" style="text-align: center">
                            ...
                            <asp:Image ID="img_header1" runat="server" style="width: 500px;
    height: 96px;" />
                        ...
                        <div class="pay_particular">
                            ...
                            <div class="fees-amt-dv">
                                ...
                                <p class="fees-amt-dv-p prevous-duess" style="display: none">
                                    <%--₹--%>
                                    <asp:Label ID="lbl_prev_dues1" runat="server" Style="display: none"></asp:Label>
                                </p>
                                <p class="fees-amt-dv-p prevous-duess" style="border-bottom: 0px dashed #323232;">
                                    <%-- ₹--%>
                                    <asp:Label ID="lbl_ttl_amts1" runat="server" Style="display: none"></asp:Label>
                                </p>
