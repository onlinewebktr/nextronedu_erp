...
{
    public partial class transfer_certificate3 : System.Web.UI.Page
    {
        My mycode = new My();
        ...
        private void Bind_Transfer_certificate_setting()
        {
            try
            {
                ...
                if (dt.Rows.Count == 0)
                {
                    DataTable dt1 = mycode.FillData("select * from Transfer_certificate_setting where Tc_type_id='3'");
                    if (dt1.Rows.Count == 0)
                    {
        ...
        private void Bind_crtificate_info()
        {
            ...
            else
            {
                ...
                //lbl_admission_no1.Text = dt.Rows[0]["Admission_no"].ToString();
               ...
               // lbl_religion.Text = dt.Rows[0]["religion"].ToString();
                ...
                //{
                //    lbl_belongs_to_sc_st.Text = "NO";
                //}
                //else
                //{
                //    lbl_belongs_to_sc_st.Text = dt.Rows[0]["cast"].ToString();
                //}
              //  lbl_date_of_admision.Text = dt.Rows[0]["Date_of_admission_and_class"].ToString();
                ...
                lbl_meetings.Text= dt.Rows[0]["ttl_working_days"].ToString();
                lbl_ncc.Text= dt.Rows[0]["ncc_cadet"].ToString();
                //=============

                //=============

                lbl_ttl_no_of_working.Text = dt.Rows[0]["present_days"].ToString();
               ...
               // lbl_date_of_application.Text = dt.Rows[0]["Date_of_receipt_of_slc"].ToString();
                ...
                lbl_dues_fees.Text = dt.Rows[0]["Dues_fee"].ToString();
                lbl_any_fee_concession_availed.Text = dt.Rows[0]["AnyConcession"].ToString();
                lbl_Nationality.Text= dt.Rows[0]["Nationality"].ToString();
                lbl_stobc.Text= dt.Rows[0]["Belongs_t_sc_st_obc"].ToString();
                lbl_srn_no.Text= dt.Rows[0]["srn_no"].ToString();
                try
                {
                    string dob = dt.Rows[0]["Date_of_births"].ToString();
                    ...
                    lbl_dob.Text = dt.Rows[0]["Date_of_births"].ToString() + ", " + inword_day + " " + monthName + ", " + inword_year;
                }
                catch (Exception ex)
                {
        ...
        private void Bind_schoolinfo()
        {
            ...
            {
                lbl_school_info_3.Text = dt.Rows[0]["Certificate_tagline3"].ToString();
                lbl_school_info.Text = dt.Rows[0]["Certificate_tagline2"].ToString();
                lbl_website.Text = dt.Rows[0]["Website_for_show"].ToString();
                ...
                lbl_cbse_aff.Text = dt.Rows[0]["Affiliation"].ToString();
                lbl_school_no.Text = dt.Rows[0]["school_no"].ToString();
                lbl_contact_no.Text = "Contact Number : " + dt.Rows[0]["contact_no"].ToString();
                lbl_Renewedupto.Text = dt.Rows[0]["Renewedupto"].ToString();
                lbl_status_school.Text = dt.Rows[0]["status_school"].ToString();
                try
                {
                    Image3.Visible = true;
