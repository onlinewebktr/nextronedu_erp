<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="print-demand-bill-m.aspx.cs" Inherits="school_web.Admin.slip.print_demand_bill_m" %>
    ...
    <form id="form1" runat="server">
                        ...
                        <div class="printheadse333">
                            <div class="invoice-wpr {{x.WhatDivTB}}">
                                <div class="printpage-sec-main">
                                    ...
                                    <p class="demandbllhead">Demand Bill</p>
                                    <div class="nammarggg">
                                    ...
                                    <div class="administration-paragraph ">
                                        <table>
                                            ...
                                            <tr data-ng-repeat="item in x.MyFeeDetailsItem_M track by $index" class="{{item.rowsHidden}}">
                                                <td class="txtcntr">{{$index+1}}</td>
                                                <td>{{item.Content}}, {{item.Month_name}}</td>
        ...
        <script type="text/javascript">
            ...
            app.controller('RpCardAppCtrl', function ($scope, $http) {
                ...
                $http.get("webServices/demandBillN.asmx/fetch_demand_bill_M", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id, "Section": section, "Checked": checked, "Month_name": month_name, "Paydate": paydate, "Session_name": session_name, "Bill_type": bill_type } }).then(function (response) {
