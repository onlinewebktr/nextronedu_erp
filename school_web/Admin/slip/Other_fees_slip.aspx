<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Other_fees_slip.aspx.cs" Inherits="school_web.Admin.slip.Other_fees_slip" %>

<!DOCTYPE html> 
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Other Fees Slip</title>
    <style>
        body, #form1 {
            margin: 0px;
            padding: 0px;
                                ...
                                <asp:GridView ID="grd_fee" runat="server" CssClass="table table-bordered table-striped" AutoGenerateColumns="False" Width="100%" Style="text-align: center;" ShowFooter="True" OnRowDataBound="grd_fee_RowDataBound">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Particular">
                                            <ItemTemplate>
                                                <asp:Label ID="lbl_feetype" runat="server" Text='<%#Bind("Content_Name") %>'></asp:Label>
                                        ...
                                        <asp:TemplateField HeaderText="Payable">
                                            <ItemTemplate>
                                                <asp:Label ID="lbl_Content_Fee" runat="server" Text='<%#Bind("Content_Fee","{0:n}") %>'></asp:Label>
                                            </ItemTemplate>
                                            <FooterTemplate>
