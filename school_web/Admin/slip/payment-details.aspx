<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="payment-details.aspx.cs" Inherits="school_web.Admin.slip.payment_details" %>
    ...
    <form id="form1" runat="server">
                        ...
                        <div class="rportwprs" style="height: 1294px">
                            ...
                            <div class="std-sec">
                                <div class="std-dt-rows">
                                    ...
                                    <p class="std-dt-name-frst width50">Contact No. : <span>{{x.Mobile_no}}</span></p>
                                </div>
                                <div class="std-dt-rows">
                                ...
                                <div class="std-dt-rows">
                                    ...
                                    <p class="std-dt-name-frst width33">Category : <span>{{x.castCaltegory}}</span></p>
                                </div>
                            </div>
        ...
        <script type="text/javascript">
            ...
            app.controller('RpCardAppCtrl', function ($scope, $http) {
                ...
                $http.get("webServices/paymentDetail.asmx/fetch_payments_of_student", { params: { "Session_id": session_id, "Session_name": session_name, "Class_id": class_id, "Section": section, "Adm_no": adm_no } }).then(function (response) {
