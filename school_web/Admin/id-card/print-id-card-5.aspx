<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="print-id-card-5.aspx.cs" Inherits="school_web.Admin.id_card.print_id_card_5" %>
...
<head runat="server">
    ...
    <link href="css/id-card-5.css" rel="stylesheet" />
    ...
    <script type="text/javascript">
        function PrintPanel() {
            ...
            printWindow.document.write('<link href="css/id-card-5.css" rel="stylesheet" type="text/css" />');
                                ...
                                <div class="id-card-vr-prnt-wpr">
                                    <div class="id-card-vr-wpr-bg-color">
                                        ...
                                        <div class="id-card-vr-content-sec">
                                            <h2 class="identitycardh">Identity Card</h2>
                                            <div class="imgsDvS">
                                            ...
                                            <div class="id-card-vr-child-details-sec">
                                                ...
                                                <div class="id-card-vr-child-details-wpr">
                                                    ...
                                                    <p class="id-card-hr-child-details-psss">{{x.sclass}} | <span>Sec.</span> <i>:</i> {{x.sec}}</p>
                                                    <%--<div class="devider"></div>
                                                    ...
                                                    <div class="id-card-vr-child-details-wpr">
                                                        ...
                                                        <p class="id-card-hr-child-details-address"><span>Residential  <i>:</i></span> {{x.address}}</p>
                                                    </div>
