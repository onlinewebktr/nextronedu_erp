<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="print-vr-id-card-new1.aspx.cs" Inherits="school_web.Admin.id_card.print_vr_id_card_new1" %>
...
<head runat="server">
    ...
    <link href="css/vr-id-card-new1.css" rel="stylesheet" />
                        ...
                        <div class="id-card-vr-sec-inr">
                            <div data-ng-repeat="x in vrid">
                                <div id="dvTable" runat="server" class="ids-center-vr idspadd">
                                            ...
                                            <div class="id-card-vr-content-sec">
                                                ...
                                                <div class="id-card-vr-child-details-sec">
                                                    ...
                                                    <div class="id-card-vr-child-details-wpr">
                                                        ...
                                                        <p class="id-card-hr-child-details-psss">{{x.sec}} <%--<span style="color: #00188e; padding: 0px 0px 0px 10px;"> Roll No. : </span> {{x.roll_no}}--%></p>
                                                        <div class="devider"></div>
                                                    ...
                                                    <div class="id-card-vr-child-details-wpr">
                                                        <p class="id-card-vr-child-details-p"><span>Residential</span> <i>:</i> {{x.address}}</p>
                                    ...
                                    <%--<img src="https://carmelkinder.edunextg.org/UploadedImage/IdTemplate/17_04_202405_07_56.jpg" />--%>
                                    <%--<img src="../../assets/images/login-images/17_04_202405_07_56.jpg" style="width: 100%" />
                                    <img src="../../assets/images/Add_User.png" style="width: 50%" />
                                    <img src="../../assets/images/gallery/07.png" style="width: 100%" />--%>
                                    <%--<p style="color: #fff; background: #b6ff00; position: absolute; top: 0px; left: 200px; font-size: 25px;">
                                        Nikhil
                                    </p>--%>
                                </div>
