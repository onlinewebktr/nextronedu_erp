<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bulk-emp-id.aspx.cs" Inherits="school_web.Admin.id_card.kdes.bulk_emp_id" %>
...
<head runat="server">
    ...
    <link href="empids.css" rel="stylesheet" />
    ...
    <script type="text/javascript">
        function PrintPanel() {
            ...
            printWindow.document.write('<link href="empids.css" rel="stylesheet" type="text/css" />');
                                    ...
                                    <div class="id-card-vr-wpr-bg-color">
                                        ...
                                        <div class="id-card-vr-content-sec">
                                            ...
                                            <div class="id-card-vr-child-details-sec">
                                                ...
                                                <%--<p class="emp-id-contnt-wpr-desig">Department : {{x.Designation}}</p>

                                                    <p class="emp-id-contnt-wpr-desig">Emp. Code : {{x.Emp_Code}}</p>
                                                    <p class="emp-id-contnt-wpr-desig">D.O.B. : {{x.Date_of_birth}}</p>
                                                    <p class="emp-id-contnt-wpr-desig">D.O.J. : {{x.Date_of_Joining}}</p>
                                                   
                                                    <p class="emp-id-contnt-wpr-desig">Contact No. : {{x.Mobile}}</p>
                                                    <p class="emp-id-contnt-wpr-desig">Address : {{x.Address}}</p>--%>
                                                <%--<p class="emp-id-contnt-wpr-desig">Father : {{x.Mobile}}</p>--%>
                                                <%--<p class="emp-id-contnt-wpr-desig">Address : {{x.Date_of_JoiningDate_of_Joining}}</p>--%>
                                                ...
                                                <div class="emp-id-contnt-wpr">
                                                    ...
                                                    <p class="id-card-hr-child-details-psss" style="width: 170px; line-height: 16px;">
                                                        {{x.Address}}
                                                    </p>
                                                </div>
                                            </div>
