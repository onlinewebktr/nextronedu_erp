<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="id-card02.aspx.cs" Inherits="school_web.Admin.id_card.id_card02" %>
                                    ...
                                    <div class="id-card-vr-wpr-bg-color">
                                        ...
                                        <div class="id-card-vr-content-sec">
                                            <div class="regnosec">
                                                ...
                                                <p class="regnosec-id-card-hr-child-details-psss">{{x.Admission_no}}</p>
                                            </div>
                                            <div class="id-card-vr-child-details-wpr">
                                                <p class="regnosec-id-card-vr-child-details-p"><span>Name</span>  <i>:</i> </p>
                                                <p class="regnosec-id-card-hr-child-details-psss">{{x.name}}</p>
                                            </div>
                                            ...
                                            <div class="id-card-vr-child-details-sec">
                                                ...
                                                <div class="id-card-vr-child-details-wpr">
                                                    ...
                                                    <p class="id-card-vr-child-details-p id-card-hr-txt-color">{{x.Transports}}</p>
                                            ...
                                            <div class="id-card-vr-child-details-wpr">
                                                <p class="id-card-address-dts" style="width: 100%">Address : {{x.address}}</p>
