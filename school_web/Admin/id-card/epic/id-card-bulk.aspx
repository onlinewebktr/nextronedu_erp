<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="id-card-bulk.aspx.cs" Inherits="school_web.Admin.id_card.epic.id_card_bulk" %>
                                            ...
                                            <div class="id-card-vr-child-details-sec">
                                                ...
                                                <div class="id-card-vr-child-details-wpr">
                                                    <p class="id-card-vr-child-details-p">
                                                        <span>Residential</span> <i>:</i><panel style="color: #000000 !important;">{{x.address}}</panel>
                                                    </p>
