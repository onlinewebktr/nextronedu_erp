<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="print-id-card-kes-bulk.aspx.cs" Inherits="school_web.Admin.id_card.print_id_card_kes_bulk" %>
...
<head runat="server">
    ...
    <link href="css/id-card-kes-bulk.css" rel="stylesheet" /> 
    ...
    <script type="text/javascript">
        function PrintPanel() {
            ...
            printWindow.document.write('<link href="css/id-card-kes-bulk.css" rel="stylesheet" type="text/css" /><link href="https://fonts.googleapis.com/css2?family=Sofia+Sans:ital,wght@0,1..1000;1,1..1000&display=swap" rel="stylesheet" />');
                                        ...
                                        <div class="id-card-vr-content-sec">
                                            ...
                                            <div class="id-card-vr-child-details-sec">
                                                ...
                                                <div class="id-card-vr-child-details-wpr"> 
                                                    <p class="id-card-hr-child-details-psss-name">{{x.name}}</p>
                                                    ...
                                                    <div class="devider"></div>
                                                    <p class="id-card-vr-child-details-p"><span>Section</span> <i>:</i> </p>
                                                    <p class="id-card-hr-child-details-psss">{{x.sec}} <span style="padding: 0px 0px 0px 10px;"> Roll No. : </span> {{x.roll_no}}</p>
