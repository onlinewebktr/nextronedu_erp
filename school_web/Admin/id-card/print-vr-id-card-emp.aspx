<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="print-vr-id-card-emp.aspx.cs" Inherits="school_web.Admin.id_card.print_vr_id_card_emp" %>
...
<head runat="server">
    ...
    <link href="css/emp-id.css" rel="stylesheet" /> 
    ...
    <script type="text/javascript">
        function PrintPanel() {
            ...
            printWindow.document.write('<link href="css/emp-id.css" rel="stylesheet" type="text/css" />');
                                        ...
                                        <div class="id-card-vr-content-sec">
                                            ...
                                            <div class="id-card-vr-child-details-sec">
                                                <div class="emp-id-contnt-wpr">
                                                    ...
                                                    <p class="id-card-vr-child-details-p"><span>Designation </span> <i>:</i> </p>
