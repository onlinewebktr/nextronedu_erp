<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="print-vr-id-card-new--1.aspx.cs" Inherits="school_web.Admin.id_card.print_vr_id_card_new__1" %>
...
<head runat="server">
    ...
    <link href="css/vr-id-card-new--1.css" rel="stylesheet" /> 
    ...
    <script type="text/javascript">
        function PrintPanel() {
            ...
            printWindow.document.write('<link href="css/vr-id-card-new--1.css" rel="stylesheet" type="text/css" />');
                                    ...
                                    <div class="id-card-vr-wpr-bg-color">
                                        ...
                                        <div class="id-card-vr-content-sec">
                                            ...
                                            <div class="id-card-vr-child-details-sec">
                                                ...
                                                <div class="regnosec">
                                                    <p class="regnosec-id-card-vr-child-details-p">Admission No : {{x.Admission_no}}<%--{{x.mobile}} {{x.Mother_mob}}--%></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
