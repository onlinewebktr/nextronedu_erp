<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="id-card.aspx.cs" Inherits="school_web.Admin.id_card.gps.id_card" %>
...
<head runat="server">
    ...
    <link href="cssids.css" rel="stylesheet" />
    ...
    <script type="text/javascript">
        function PrintPanel() {
            ...
            printWindow.document.write('<link href="cssids.css" rel="stylesheet" type="text/css" />');
    ...
    <form id="form1" runat="server">
                                        ...
                                        <div class="id-card-vr-content-sec">
                                            ...
                                            <div class="id-card-vr-child-details-sec">
                                                ...
                                                <div class="id-card-vr-child-details-wpr">
                                                    <%--<p class="id-card-vr-child-details-p"><span>Name</span> <i>:</i> </p>
                                                    <p class="id-card-hr-child-details-psss">{{x.name}}</p>
                                                    <div class="devider"></div>--%>




                                                    <p class="id-card-vr-child-details-p"><span>Father<%--{{x.So_or_Do}}--%></span> <i>:</i> </p>
                                                    <p class="id-card-hr-child-details-psss">{{x.father_name}}</p>
                                                    <div class="devider"></div>
                                                    <p class="id-card-vr-child-details-p"><span>Mother<%--{{x.So_or_Do}}--%></span> <i>:</i> </p>
                                                    <p class="id-card-hr-child-details-psss">{{x.Mothername}}</p>
                                                    <div class="devider"></div>

                                                    <p class="id-card-vr-child-details-p"><span>Adm. No.</span> <i>:</i> </p>
                                                    ...
                                                    <p class="id-card-hr-child-details-psss">{{x.sclass}} | <span>Sec.</span> <i>:</i> {{x.sec}} ({{x.Session_only}})</p>
                                                    <%--<div class="devider"></div>
                                                    ...
                                                    <p class="id-card-hr-child-details-psss">{{x.roll_no}} <%--<span style="color: #00188e; padding: 0px 0px 0px 10px;"> Roll No. : </span> {{x.roll_no}}--%></p>

                                                    <div class="devider"></div>
                                                    <p class="id-card-vr-child-details-p"><span>Mobile No.</span> <i>:</i> </p>
                                                    <p class="id-card-hr-child-details-psss">
                                                        {{x.mobile}}
                                                    </p>
                                                    ...
                                                    <p class="id-card-hr-child-details-psss" style="width: 213px; -webkit-line-clamp: 2; max-height: 32px;">{{x.address}}</p>

                                                    <%--<div class="id-card-vr-child-details-wpr">
                                                        <p class="id-card-vr-child-details-p"><span>Residential</span> <i>:</i></p>
                                                        <p class="id-card-hr-child-details-address"><span><i>:</i></span> {{x.address}}</p>
                                                    </div>--%>
                                                    ...
                                                    <%--<div class="regnosec">
                                                    <p class="regnosec-id-card-vr-child-details-p">Admission No : {{x.Admission_no}}  </p>
                                                </div>--%>
                                                </div>
                                            </div>
                                        </div>
        ...
        <script type="text/javascript">
            ...
            app.controller('IdCardvrctrl', function ($scope, $http) {
                ...
                $http.get("../webService/print-id-card-5.asmx/fetch_all_verticle_id_card_details", { params: { "Session_id": session_id, "Class_id": class_id, "Sections": sections, "Branch_id": branch_id, "IdType": idType, "Admission_no": admission_no } }).then(function (response) {
