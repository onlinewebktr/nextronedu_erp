<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="verticle-id-card.aspx.cs" Inherits="school_web.Admin.id_card.abc.verticle_id_card" %>
...
<head runat="server">
    ...
    <link href="css/verticleid.css" rel="stylesheet" />
    ...
    <script type="text/javascript">
        function PrintPanel() {
            ...
            printWindow.document.write('<link href="css/verticleid.css" rel="stylesheet" type="text/css" /><link href="https://fonts.googleapis.com/css2?family=Sofia+Sans:ital,wght@0,1..1000;1,1..1000&display=swap" rel="stylesheet" />');
                                    ...
                                    <div class="id-card-vr-wpr-bg-color">
                                        ...
                                        <div class="id-card-vr-content-sec">
                                            <div class="id-card-vr-stu-img-sec">
                                                <div class="photowprs">
                                                    <img src="{{x.photo}}" class="id-card-vr-stu-img {{x.photo}}" />
                                                </div>
                                            </div>
                                            <div class="id-card-vr-child-details-sec">
                                                <div class="id-card-vr-child-details-wpr">
                                                    ...
                                                    <p class="id-card-vr-child-details-p id-card-hr-txt-color" style="font-weight: 600!important;">{{x.Admission_no}}</p>
                                                </div>

                                                <div class="id-card-vr-child-details-wpr">
                                                    <p class="id-card-vr-child-details-p"><span>Name</span>  <i>:</i> </p>
                                                    <p class="id-card-vr-child-details-p id-card-hr-txt-color" style="font-weight: 600!important;">{{x.name}}</p>
                                                </div>
                                                <div class="id-card-vr-child-details-wpr">
                                                ...
                                                <div class="id-card-vr-child-details-wpr">
                                                    <p class="id-card-vr-child-details-p"><span>Mother</span> <i>:</i></p>
                                                    <p class="id-card-hr-child-details-psss" style="width: 155px;">{{x.Mother_name}}</p>
                                                </div>
                                                ...
                                                <div class="id-card-vr-child-details-wpr">
                                                    ...
                                                    <p class="id-card-vr-child-details-p"><span>Section</span> <i>:</i> {{x.sec}}</p>
                                                </div>

                                                <div class="id-card-vr-child-details-wpr">
                                                    <p class="id-card-vr-child-details-p"><span>Class</span> <i>:</i></p>
                                                    <p class="id-card-hr-child-details-psss" style="width: 155px;">{{x.sclass}}</p>
                                                </div>

                                                <div class="id-card-vr-child-details-wpr">
                                                    <p class="id-card-vr-child-details-p"><span>D.O.B.</span> <i>:</i></p>
                                                    <p class="id-card-hr-child-details-psss" style="width: 155px;">{{x.dob}}</p>
                                                </div>
                                                ...
                                                <div class="id-card-vr-child-details-wpr">
                                                    <p class="id-card-vr-child-details-p"><span>Add.</span> <i>:</i></p>
                                                    <p class="id-card-hr-child-details-psss" style="width: 50%; -webkit-line-clamp: 4; max-height: 46px;">
                                                        {{x.Address2}}
                                                    </p>
                                                </div>
                                            </div>
