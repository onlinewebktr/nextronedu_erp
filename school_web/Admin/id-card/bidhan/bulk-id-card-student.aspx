<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bulk-id-card-student.aspx.cs" Inherits="school_web.Admin.id_card.bidhan.bulk_id_card_student" %>
...
<head runat="server">
    ...
    <link href="css/bulk-student.css" rel="stylesheet" />
    ...
    <script type="text/javascript">
        function PrintPanel() {
            ...
            printWindow.document.write('<link href="css/bulk-student.css" rel="stylesheet" type="text/css" />');
                                ...
                                <div class="id-card-vr-prnt-wpr">
                                    <div class="id-card-vr-wpr-bg-color">
                                        ...
                                        <div class="id-card-vr-content-sec">
                                            <p class="id-card-hr-admno">{{x.Admission_no}}</p>
                                            <p class="id-card-hr-Bgroup">{{x.Blood_group}}</p>
                                            ...
                                            <div class="id-card-vr-child-details-sec">
                                                ...
                                                <div class="id-card-vr-child-details-wpr">
                                                    <p class="id-card-vr-child-details-p">
                                                        <span>Address</span> <i>:</i><panel>{{x.address}}</panel>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
