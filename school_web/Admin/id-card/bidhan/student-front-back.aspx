<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="student-front-back.aspx.cs" Inherits="school_web.Admin.id_card.bidhan.student_front_back" %>
...
<head runat="server">
    ...
    <script type="text/javascript">  
        function ConvertToImageBack(btnExport) {
            debugger;
            html2canvas($("#dvTable2")[0]).then(function (canvas) {
                debugger;
                var base64 = canvas.toDataURL();
                $("[id*=hfImageData]").val(base64);
                debugger;
    ...
    <form id="form1" runat="server">
        ...
        <div class="id-card-page-sec" data-ng-app="IdCardvrApp">
            <div class="id-card-page-wpr" data-ng-controller="IdCardvrctrl">
                ...
                <asp:Button ID="Button1" Style="margin: 0px 0px 5px 0px;float: right;" Text="Export to Image" runat="server" UseSubmitBehavior="false" OnClick="ExportToImage" OnClientClick="return ConvertToImageBack(this)" />
                <div class="id-card-hr-sec" id="tblPrintIQ" runat="server">
                    <div class="print-div">
                                    ...
                                    <div class="id-card-vr-prnt-wpr">
                                        <div class="id-card-vr-wpr-bg-color">
                                            ...
                                            <div class="id-card-vr-content-sec">
                                                <p class="id-card-hr-adm-no">{{x.Admission_no}}</p>
                                                <p class="id-card-hr-b-grp">{{x.Blood_group}}</p>
                                                <div class="stdimgDV">
                                                ...
                                                <div class="id-card-vr-child-details-sec">
                                                    ...
                                                    <div class="id-card-vr-child-details-wpr">
                                                        ...
                                                        <p class="id-card-hr-child-details-psss">{{x.roll_no}} </p>
                                                        <div class="devider"></div>
                                                    ...
                                                    <div class="id-card-vr-child-details-wpr">
                                                        ...
                                                        <p class="id-card-hr-child-details-address"><span>Address</span> <i>:</i> {{x.address}}</p>
                                                    </div>
                        ...
                        <div class="id-card-vr-sec-inr-rght">
                            <div data-ng-repeat="x in vrid">
                                <div id="dvTable2" runat="server" class="ids-center-vr idspadd">
                                    <div class="ids-back-img-vr">
                                        ...
                                        <div class="id-card-vr-wpr-bg-color">
                                            ...
                                            <div class="id-card-vr-content-sec">
                                                <div class="father-imgs">
                                                    <div class="id-card-vr-fthr-img-sec">
                                                        <div class="id-card-vr-fthr-img-dvinnr">
                                                            <img src="{{x.Father_img}}" class="id-card-vr-stu-img-fthr" />
                                                        </div>
                                                    </div>
