<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="print-vr-id-card.aspx.cs" Inherits="school_web.Admin.id_card.print_vr_id_card" %>
...
<head runat="server">
    ...
    <link href="css/burdhwan-id.css" rel="stylesheet" />
    ...
    <script type="text/javascript">
        function PrintPanel() {
            ...
            printWindow.document.write('<link href="css/burdhwan-id.css" rel="stylesheet" type="text/css" /><link href="https://fonts.googleapis.com/css2?family=Sofia+Sans:ital,wght@0,1..1000;1,1..1000&display=swap" rel="stylesheet" />');
                                        ...
                                        <div class="id-card-vr-content-sec">
                                            ...
                                            <div class="id-card-vr-child-details-sec">
                                                ...
                                                <div class="id-card-vr-child-details-wpr">
                                                    ...
                                                    <p class="id-card-hr-child-details-psss" style="width: 73%; -webkit-line-clamp: 4; max-height: 46px;">
                                                        {{x.Address2}}
                                                    </p>
                                                </div>
                                            </div>
