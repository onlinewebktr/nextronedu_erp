<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bulk-id-card.aspx.cs" Inherits="school_web.Admin.id_card.manidweep.bulk_id_card" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function PrintPanel() {
            ...
            printWindow.document.write('<link href="css/vr-id-card-new.css" rel="stylesheet" type="text/css" /><link href="https://fonts.googleapis.com/css2?family=Sofia+Sans:ital,wght@0,1..1000;1,1..1000&display=swap" rel="stylesheet" />');
                                    ...
                                    <div class="id-card-vr-wpr-bg-color">
                                        ...
                                        <div class="id-card-vr-content-sec">
                                            ...
                                            <div class="id-card-vr-child-details-sec">
                                                <p class="id-card-vr-child-details-p id-card-hr-txt-color namespp">{{x.name}}</p>
                                                ...
                                                <div class="id-card-vr-child-details-wpr">
                                                    ...
                                                    <div class="devider"></div>
                                                    <p class="id-card-vr-child-details-p" style="color: {{x.InfotxtColor}}"><span>House</span> <i>:</i> </p>
                                                    <p class="id-card-hr-child-details-psss" style="color: {{x.InfotxtColor}}">{{x.House_name}}</p>
                                                </div>


                                                <div class="id-card-vr-child-details-wpr" style="width: 75%;">
                                                    <p class="id-card-vr-child-details-p" style="color: {{x.InfotxtColor}}">
                                                        <span>Address</span> <i>:</i><panel style="color: {{x.InfotxtColor}}">{{x.address}}</panel>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
