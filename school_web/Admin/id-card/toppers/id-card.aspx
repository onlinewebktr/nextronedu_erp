<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="id-card.aspx.cs" Inherits="school_web.Admin.id_card.toppers.id_card" %>
...
<head runat="server">
    ...
    <link href="idcards.css" rel="stylesheet" /> 
    ...
    <script type="text/javascript">
        function PrintPanel() {
            ...
            printWindow.document.write('<link href="idcards.css" rel="stylesheet" type="text/css" /><link href="https://fonts.googleapis.com/css2?family=Sofia+Sans:ital,wght@0,1..1000;1,1..1000&display=swap" rel="stylesheet" />');
                                        ...
                                        <div class="id-card-vr-content-sec">
                                            ...
                                            <div class="id-card-vr-child-details-sec">
                                                ...
                                                <div class="id-card-vr-child-details-wpr">
                                                    ...
                                                    <p class="id-card-hr-child-details-psss">{{x.Father_mob}}</p>
                                                </div>
                                                <div class="id-card-vr-child-details-wpr">
