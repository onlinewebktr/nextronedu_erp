<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="print-vr-id-card-new2.aspx.cs" Inherits="school_web.Admin.id_card.print_vr_id_card_new2" %>
                                        ...
                                        <div class="id-card-vr-wpr-bg-color">
                                            ...
                                            <div class="id-card-vr-content-sec">
                                                ...
                                                <div class="id-card-vr-child-details-sec">
                                                    ...
                                                    <div class="id-card-vr-child-details-wpr">
                                                        <p class="id-card-vr-child-details-p line-height-18"><span>Residential</span> <i>:</i> {{x.address}}</p>
