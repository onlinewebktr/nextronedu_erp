<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="generate-qr.aspx.cs" Inherits="school_web.Admin.generate_qr" %>
                                                ...
                                                <asp:Repeater ID="rd_view" runat="server">
                                                    <ItemTemplate>
                                                        <tr id="trR" runat="server"> 
                                                            ...
                                                            <td>
                                                                <a href='slip/student-qr.aspx?admNo=<%#Eval("admissionserialnumber")%>&ssion_id=<%#Eval("Session_id")%>&clss_id=<%#Eval("Class_id")%>&Branch_id=<%#Eval("Branch_id")%>&Section=ALL&Type=SINGLE' style="background-color: #f7f100; min-width: 30px; color: #000;"
