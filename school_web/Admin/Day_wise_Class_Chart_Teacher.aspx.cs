...
{
    public partial class Day_wise_Class_Chart_Teacher : System.Web.UI.Page
    {
        My mycode = new My();
        ...
        private void find_data_chart()
        {
            ...
            else
            {
                ...
                DataTable dt = mycode.get_class_routine_day_wise(ViewState["Sessionid"].ToString(), ddl_Day.Text, ddl_class.SelectedValue);
                ...
                {
                    lbl_date.Text = " Day: " + ddl_Day.Text;
