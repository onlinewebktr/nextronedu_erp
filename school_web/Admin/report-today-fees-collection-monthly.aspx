<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="report-today-fees-collection-monthly.aspx.cs" Inherits="school_web.Admin.report_today_fees_collection_monthly" EnableEventValidation="false" ValidateRequest="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Today Monthly Fees Collection
</asp:Content>
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Monthly Fees Collection</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    ...
                    <ul class="sub-pag-menu-ul">
                        <li><a href="report-today-fees-collection-monthly.aspx" class="sub-mnu-p-a-active">Today Fee Collection</a></li>
