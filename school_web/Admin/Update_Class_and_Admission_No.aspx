<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="Update_Class_and_Admission_No.aspx.cs" Inherits="school_web.Admin.Update_Class_and_Admission_No" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Change Class Or Admission No.
</asp:Content>
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Change Class Or Admission No.</li>
                        </ol>
                    </nav>
                </div>
            </div>
                                ...
                                <asp:Panel ID="std_basic_infoS" runat="server" Visible="false">
                                    ...
                                    <div class="row">
                                        <div style="margin: 0px; padding: 8px 0px 0px 0px; height: 43px; width: 100%; border-bottom: 1px solid #e3d4d4; text-align: center;">
                                            <asp:RadioButton ID="rd_change_admission_no" runat="server" Text="Change Admission No." GroupName="ab" AutoPostBack="true" OnCheckedChanged="rd_change_admission_no_CheckedChanged" />
                                            <asp:RadioButton ID="rd_change_class" runat="server" Text="Change Class" GroupName="ab" AutoPostBack="true" OnCheckedChanged="rd_change_class_CheckedChanged" />
                                        </div>
                                        ...
                                        <div style="margin: 0px; padding: 0%; float: left; height: auto; width: 100%" id="pnl_change_class" runat="server" visible="false">
                                            <table class="table">
                                                <tr>
                                                    <td colspan="8">When you will be change class . Than all fees will be deleted. Please keep the payment slip after deletion. 
                                                    </td>
                                                </tr>
                                                <tr>
