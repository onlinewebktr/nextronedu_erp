<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="assign-for-hostel-attendance.aspx.cs" Inherits="school_web.Admin.assign_for_hostel_attendance" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Assign Warden for Hostel Attendance
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="page-wrapper">
        <div class="page-content">
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Assign Warden for Hostel Attendance</li>
                        </ol>
                    </nav>
                </div> 
            </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <asp:Label ID="ltUsertop" runat="server" Style="font-weight: 500; font-size: 1rem;" class="mb-0 text-uppercase" Text="Assign Warden for Hostel Attendance"></asp:Label>
                    <hr />
                    <div class="card">
                        <div class="card-body">
                            <div class="p-4 border rounded">
                                <div class="row g-3 needs-validation" novalidate="">
                                    ...
                                    <div class="col-md-3">
                                        <label for="validationCustom01" class="form-label">Teacher/Warden<sup>*</sup></label>
                ...
                <div class="col-xl-12" style="margin-top: 5px;">
                    <h6 class="mb-0 text-uppercase">Warden Assigned List</h6>
                    <hr />
                    <div class="card">
                        <div class="card-body">
