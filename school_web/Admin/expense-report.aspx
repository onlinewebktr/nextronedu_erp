<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="expense-report.aspx.cs" Inherits="school_web.Admin.expense_report" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                                ...
                                <div class="find-dv">
                                    <div class="row  g-3 needs-validation">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div id="excel" runat="server" visible="true">
                                                <a href="javascript:" class="btn btn-primary find-dv-btn" id="Export" data-ng-click="Export()"><i class='bx bx-download'></i>Excel</a>
                                            </div> 
                                                ...
                                                <div class="grd-wpr-new">
                                                    <div class="exp-grd">
                                                        <table class="table table-bordered" datatable="ng" dt-options="vm.dtOptions" style="border: 1px solid #c5c0c0;">
                                                            ...
                                                            <tbody>
                                                                <tr data-ng-repeat="x in reportExp">
                                                                    <td>{{$index+1}}</td>
                                                                    <td>{{x.VoucherDate}}</td>
                                                                    <td>{{x.VoucherNo}}</td>
                                                                    <td>{{x.Content}}</td>
                                                                    <td>{{x.Description}}</td>
                                                                    <td>{{x.MOP}}</td>
                                                                    <td style="text-align: center;" > <a class="{{x.ImagePath}}" href="{{x.ImagePath}}" download>
   <i class="fa fa-download" aria-hidden="true"></i>
                                                            ...
                                                            <tr>
                                                                <td class="fntwtbld txtrght" colspan="7">Total Expense :</td>
                                                                <td colspan="1" class="fntwtbld">{{reportExp[reportExp[0].RowsCountss].Total_Expense}}</td>
                                                            </tr>
                                                        </table> 
                                                        <p class="prnsign" style="display:none">Principal Sign</p>
                                                    </div>
                                                </div>
                                            </div>
    ...
    <script type="text/javascript">
        ...
        app.controller('RpCardAppCtrl', function ($scope, $http) {
            ...
            // Fetch income data
            $http.get("webServices/account/incomeExpense.asmx/fetch_report_expense_saprate", { params: { "FromDate": Fromdates, "ToDate": Todates } })
                .then(function (response) {
                    $scope.reportExp = response.data;
