<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="fees-collection-3.aspx.cs" Inherits="school_web.Admin.fees_collection_3" %>
                                                    ...
                                                    <div class="fnd-box-wpr-inr">
                                                        ...
                                                        <div class="fnd-box-row-wpr">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <label for="validationCustom01" class="form-label-fnds" id="ttlDueslbl">Total Dues</label>
                                                                </div>
                                                                <div class="col-md-3 padd-lft0 noclick">
                                                                        ...
                                                                        $(function () {
                                                                            ...
                                                                            function calculate() {
                                                                                ...
                                                                                if (mnthly_ttl_bill_amt < mnthly_paid_amt) {
                                                                                    ...
                                                                                    mnthly_dues_amt = (mnthly_paid_amt - mnthly_ttl_bill_amt);
                                                                                    $("#<%=txt_total_dues.ClientID %>").val(mnthly_dues_amt.toFixed(2));
                                                                                    $("#<%=txt_total_dues.ClientID %>").addClass('red-bgs');
                                                                                    $('#ttlDueslbl').text("Refund Amount");
                                                                                }
                                                                                else {
                                                                                    mnthly_dues_amt = (mnthly_ttl_bill_amt - mnthly_paid_amt);
                                                                                    $("#<%=txt_total_dues.ClientID %>").val(mnthly_dues_amt.toFixed(2));
                                                                                    $("#<%=txt_total_dues.ClientID %>").removeClass('red-bgs');
                                                                                    $('#ttlDueslbl').text("Total Dues");
                                                                                }
                                                                            }
                                                                        });
                                                                    </script>
                            ...
                            <div class="std-search-wpr" runat="server" id="angStd">
                                <table class="table table-bordered">
                                    ...
                                    <tr data-ng-repeat="x in reportStd | filter : searchs">
                                        ...
                                        <td>{{x.Mobile_no}}</td>
                                        <td class="hiddenOnPrint"><a style="background-color: #f7f100; min-width: 30px; color: #000;"
                                            class="button-61 nowordbreak collect-feesss" href="fees-collection-3.aspx?adm={{x.Admission_no}}&sessionid={{x.Session_id}}"><span class="material-symbols-outlined">done_all</span></a></td>
                                    </tr>
                                </table>
                            </div>
                        </div>
