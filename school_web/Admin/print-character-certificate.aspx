<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="print-character-certificate.aspx.cs" Inherits="school_web.Admin.print_character_certificate" %>
                                                                                    ...
                                                                                    <td style="text-align: left;">
                                                                                        ...
                                                                                        <div class="user-box dropdown" style="float: left; display: inherit; height: auto; border-left: 0px solid #f0f0f0; margin-left: 0px;">
                                                                                            ...
                                                                                            <ul class="dropdown-menu dropdown-menu-end">
                                                                                                <li>
                                                                                                    <a class="dropdown-item" id="ccc_link" runat="server" target="_blank"><i class='bx bx-printer'></i><span>Print</span> </a>
                                                                                                </li>

                                                                                                <li>
                                                                                                    <asp:LinkButton ID="lnk_edit" class="dropdown-item" runat="server" ToolTip="Edit" CausesValidation="false" OnClick="lnk_edit_Click"><i class="bx bxs-edit"> </i><span>Edit</span></asp:LinkButton>
                                                                                                </li>
                                                                                                <li>
        ...
        <div class="modal-dialog md-width" style="max-width: 792px;">
            ...
            <div class="modal-content" style="position: relative">
                <div class="modal-header" style="padding: 5px 15px;">
                    <h3 class="modal-title" style="font-size: 20px;">Update Character Certificate</h3>
                        ...
                        <div class="rowdevider">
                         ...
                         <div class="rowdevider">
                            <div class="row">
                                ...
                                <div class="col-xl-6 padd-lft-5">
                                    <asp:Button ID="btn_update_certificate" OnClick="btn_update_certificate_Click" runat="server" Text="Update" CssClass="btn btn-primary form-fnd-btns" Style="margin: 8px 0px 10px -4px;" />
                                </div>
                            </div>
                        </div> 
                    </div>
