<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="Report_Total_Head_Wise_Collection_Today.aspx.cs" Inherits="school_web.Admin.Report_Total_Head_Wise_Collection_Today" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Head Wise Collection Today
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="head" runat="server">

    <script>
        $(function () {
            $("#<%=txt_date11.ClientID %>").datepicker({
                    dateFormat: "dd/mm/yy",
                    changeMonth: true,
                    changeYear: true,
                    readOnly: true,
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><a href="Today_Fee_Collection_Summary.aspx" runat="server" id="backbtns" visible="false" class="backlnk-css"><i class="bx bx-arrow-back"></i></a>Report</div>
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            <li class="breadcrumb-item"><a href="Home.aspx"><i class="bx bx-home-alt"></i></a>
                            </li>
                            <li class="breadcrumb-item active" aria-current="page">Head Wise Collection Today</li>
                        </ol>
                    </nav>
                </div>
            </div>
                                            ...
                                            <div class="find-dv">
                                                <div class="row">
                                                    <div class="col-sm-2">
                                                        ...
                                                        <div class="clndr-div">
                                                            <asp:TextBox ID="txt_date11" runat="server" class="form-control find-dv-txtbx"></asp:TextBox>
                                                    ...
                                                    <div class="col-sm-2">
                                                        <asp:LinkButton ID="btn_excels" runat="server" Style="float: right;" OnClick="btn_excels_Click" class="btn btn-primary find-dv-btn">  <i class='bx bx-download'></i> Excel</asp:LinkButton>
                                                    ...
                                                    <asp:GridView ID="grd_fee" runat="server" AutoGenerateColumns="False" Style="width: 100%" class="table table-striped table-bordered dataTable" OnRowDataBound="grd_fee_RowDataBound" ShowFooter="True">
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Admission No.">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lbl_admission_no" runat="server" Text='<%#Bind("adno") %>'></asp:Label>
                                                            ...
                                                            <asp:TemplateField HeaderText="Type" Visible="false">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lbl_Type" runat="server" Text='<%#Bind("parameter") %>'></asp:Label>

                                                                </ItemTemplate>

                                                            </asp:TemplateField>

                                                            <asp:TemplateField HeaderText="Payment Head">
                                                                <ItemTemplate>
                                                            ...
                                                            <asp:TemplateField HeaderText="Total Amount">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lbl_Amount" runat="server" Text='<%# Getamount_comma_seperated(Eval("paid").ToString())%>'></asp:Label>
                                                                </ItemTemplate>
