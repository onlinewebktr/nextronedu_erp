...
{
    public partial class fee_collection_test : System.Web.UI.Page
    {
        My mycode = new My();
        ...
        private void find_admission_dues_fee()
        {
            ...
            else
            {
                ...
                btn_admission_fee.Text = "Collect admission Fees : " + payble_after_disc.ToString("0.00");
        ...
        private void find_annual_dues_fee()
        {
            ...
            else
            {
                ...
                btn_admission_fee.Text = "Collect Annual Fees : " + totalpay.ToString("0.00");
        ...
        protected void btn_admission_fee_Click(object sender, EventArgs e)
        {
            ...
            if (dtBnk.Rows.Count > 0)
            {
                ddl_bank_adm.DataSource = dtBnk;
                ddl_bank_adm.DataTextField = "Bank_name";
                ddl_bank_adm.DataBind();
                ddl_bank_adm.Items.Insert(0, new ListItem("Select", "Select"));
            }
            else { compLN.bind_ddl_select(ddl_bank_adm, "select Bank_name from Bank_master order by Bank_name asc"); }
                    ...
                    if (My.toDouble(txttotalbill.Text) >= My.toDouble(txt_paid_amount.Text))
                    {
                        ...
                        if (flag == true)
                        {
                            ...
                            try
                            {
                                ...
                                string messge = "Dear " + lbl_name.Text + " you have paid monthly fee :- " + txt_paid_amount.Text + " date :- " + txt_payment_date.Text + " slip no.:-" + slipno;
        ...
        private void send_data_in_student_payment_history_adm_popup(string type, string slip_no, string entry_id, string ad_no, string parameter_New, SqlConnection con)
        {
            ...
            {
                cmd.Parameters.AddWithValue("@Bank_name", ddl_bank_adm.Text);
                cmd.Parameters.AddWithValue("@Bank_date", txt_bank_date_adm.Text);
            }
        ...
        private void for_discount(string session_name, string session_id, string class_id, string admission_no, string hostel_taken, string transport_taken, string hostel_id, string room_category_id, string TransportPath_id, string Boarding_Point_id)
        {
            ...
            {
                if (ViewState["Is_Edit_Discount"].ToString() == "1" || ViewState["Is_delete_Discount"].ToString() == "1" || ViewState["Is_add_Discount"].ToString() == "1")
                {
            ...
            try
            {
                if (ViewState["Is_Edit_Bus"].ToString() == "1")
                {
                    ...
                    else
                    {
                        ...
                        Response.Redirect("fee-collection-test.aspx?adm=" + ViewState["Admission_no"].ToString(), false);
                    }
                }
                else
                {
