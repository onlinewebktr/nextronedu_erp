<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="total-outstanding-transport.aspx.cs" Inherits="school_web.Admin.total_outstanding_transport" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="row" data-ng-app="ComplainApp" data-ng-controller="ComplainAppCtrl">
                <div class="col-xl-12">
                    <ul class="sub-pag-menu-ul">
                        ...
                        <li><a href="total-outstanding-transport.aspx" class="sub-mnu-p-a-active">Transport Outstanding</a></li>
    ...
    <script type="text/javascript">
        function Export() {
            var class_name = "Dues_list_transport";
