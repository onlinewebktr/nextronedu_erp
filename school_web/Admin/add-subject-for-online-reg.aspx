<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="add-subject-for-online-reg.aspx.cs" Inherits="school_web.Admin.add_subject_for_online_reg" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xl-4">
                    <asp:Label ID="ltUsertop" runat="server" Style="font-weight: 500; font-size: 1rem;" class="mb-0 text-uppercase" Text="Add Subject"></asp:Label>
                    <hr />
                    <div class="card">
                        <div class="card-body">
                            <div class="p-4 border rounded">
                                <div class="row g-3 needs-validation" novalidate="">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <asp:TextBox ID="txt_subject_name" runat="server" class="form-control"></asp:TextBox>
                                    </div>
                ...
                <div class="col-xl-8">
                    <h6 class="mb-0 text-uppercase">Added Subject</h6>
                    <hr />
                    <div class="card">
                        <div class="card-body">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:Panel ID="Panel1" runat="server">
                                                                <tr>
                                                                    ...
                                                                    <td style="text-align: left;">
                                                                        <asp:Label ID="lbl_subj_name" runat="server" Text='<%#Bind("Subject")%>'></asp:Label>
                                                                    </td> 
