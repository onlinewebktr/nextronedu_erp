<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="Send_App_Link_to_student.aspx.cs" Inherits="school_web.Admin.Send_App_Link_to_student" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Send WhatsApp Messaging App Link for Students
</asp:Content>
     ...
     <script type="text/javascript">
         function Confirm() {
             ...
             if (confirm("Do you want to submit final?")) {
                 ...
                 if (!isSubmitted) {
                     $('#<%=btn_save.ClientID %>').val('Submitting.. Please Wait..');
                     isSubmitted = true;
                 }
                 else {
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Send WhatsApp Messaging App Link for Students</li>
                        </ol>
                    </nav>
                </div>
            </div>
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-3">
                                                            ...
                                                            <asp:DropDownList ID="ddl_secion" runat="server" class="form-control find-dv-txtbx"></asp:DropDownList>
                                                        </div>
                                                        <div class="col-sm-3">
                                        ...
                                        <div class="grd-wpr" style="overflow: auto;">
                                            <asp:GridView ID="GrdView" runat="server" class="table table-striped table-bordered dataTable" AutoGenerateColumns="False" Width="100%" >
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Section">
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:Label ID="lbl_Class_id" runat="server" Text='<%#Bind("Class_id")%>' Visible="false"></asp:Label>
                                                             <asp:Label ID="lbl_pwd" runat="server" Text='<%#Bind("Pwd")%>' Visible="false"></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderText="Fatehr's whatsApp No">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lbl_Father_whatsApp_no" runat="server" Text='<%#Bind("Father_whatsApp_no")%>'></asp:Label>
                                            ...
                                            <asp:Button ID="btn_save" runat="server" Text="Send" class="btn btn-primary find-dv-btn" OnClick="btn_save_Click" Style="padding: 10px 14px 10px 14px; margin-bottom: 10px; float:right" Visible="false" />
