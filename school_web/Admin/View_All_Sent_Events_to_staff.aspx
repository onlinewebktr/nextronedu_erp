<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="View_All_Sent_Events_to_staff.aspx.cs" Inherits="school_web.Admin.View_All_Sent_Events_to_staff" EnableEventValidation="false" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">staff Events
</asp:Content>
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">View All Sent Event's</li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="find-dv">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-2">
                                                        <label for="validationCustom01" class="find-dv-lbl">Teacher/staff</label>
                                                        <asp:DropDownList ID="ddl_staff" runat="server" class="form-select find-dv-txtbx"></asp:DropDownList>
                                                    </div>
                            ...
                            <asp:Label ID="lbl_website" runat="server"></asp:Label>
                                                                    ...
                                                                    <div style="margin: 7px 0px 0px 0px; padding: 0px; float: left; height: auto; text-align: center; vertical-align: middle; font-size: 13px; width: 100%;">
                                                                        <span style="font-size: 14px; font-weight: bold;">Event's-<asp:Label ID="lbl_class22" runat="server"></asp:Label></span>
                                                            ...
                                                            <asp:GridView ID="GrdView" runat="server" class="table table-bordered" AutoGenerateColumns="False" Width="100%" OnRowDataBound="GrdView_RowDataBound">
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Teacher/staff">
                                                                        <ItemTemplate>
                                                                           <asp:Label ID="lbl_teacheridname" runat="server"></asp:Label>
                                                                             <asp:Label ID="lbl_Teacher_Id" runat="server" Visible="false" Text='<%#Bind("Teacher_Id")%>'></asp:Label>
                                                                            
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>

                                                                    
                                                                    <asp:TemplateField HeaderText="Event Subject">
                                                                        <ItemTemplate>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Event Details">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lbl_Details" runat="server" Style="word-break: break-all" Text='<%#Bind("Details")%>'></asp:Label>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="File">
                                                                        <ItemTemplate>
                                                                            ...
                                                                            <a runat="server" id="a1" href='<%#Eval("Attachment") %>' download style="padding: 0px 0px 2px 8px; font-family: ebrima; font-size: 17px; color: #0066CC; text-decoration: none;" target="_blank"><i class="fa fa-download" aria-hidden="true"></i></a>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
