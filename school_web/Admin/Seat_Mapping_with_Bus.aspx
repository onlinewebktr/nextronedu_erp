<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="Seat_Mapping_with_Bus.aspx.cs" Inherits="school_web.Admin.Sheet_Mapping_with_Bus" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Seat Mapping with Bus
</asp:Content>
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Seat Mapping </li>
                        </ol>
                    </nav>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            <div class="p-4 border rounded">
                                <div class="row g-3 needs-validation" novalidate="">
                                    <div class="col-md-4">
                                        <label for="validationCustom01" class="form-label">Select Vehicle Name<sup>*</sup></label>
                                            ...
                                            <div class="col-12">
                                                <asp:GridView ID="GrdView" runat="server" class="mb-0 table table-bordered" AutoGenerateColumns="False" Width="100%" Style="margin-top: 10px;">
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Row Name">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lbl_rowname" runat="server" Text='<%#Bind("Row")%>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
