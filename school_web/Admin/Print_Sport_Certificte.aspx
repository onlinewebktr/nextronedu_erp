<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="Print_Sport_Certificte.aspx.cs" Inherits="school_web.Admin.Print_Sport_Certificte" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Reprint Sports Certificate
    ...
    <style>
      ...
      <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#<%=txt_Participated_in_the.ClientID%>").autocomplete({
                 source: function (request, response) {
                     $.ajax({
                         url: 'Create_Sports_Certificate.aspx/GetParticipated',
        ...
        $(function () {
            ...
            $("#<%=txt_Division.ClientID%>").autocomplete({
                  source: function (request, response) {
                      $.ajax({
                          url: 'Create_Sports_Certificate.aspx/GetDivision',
                          data: "{ 'PathRooT': '" + request.term + "'}",
                          dataType: "json",
                          type: "POST",
                          contentType: "application/json; charset=utf-8",
        ...
        $(function () {
            ...
            $("#<%=txt_Remarks.ClientID%>").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        url: 'Create_Sports_Certificate.aspx/GetRemarks',
                        data: "{ 'PathRooT': '" + request.term + "'}",
                        dataType: "json",
                        type: "POST",
                        contentType: "application/json; charset=utf-8",
        ...
        <div class="page-content">
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Re-print Sports Certificate</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <asp:Label ID="ltUsertop" runat="server" Style="font-weight: 500; font-size: 1rem; display: none;" class="mb-0 text-uppercase" Text="Re-print Sports Certificate"></asp:Label>
                            ...
                            <asp:Label ID="lbl_website" runat="server"></asp:Label>
                                                                    ...
                                                                    <div style="margin: 7px 0px 0px 0px; padding: 0px; float: left; height: auto; text-align: center; vertical-align: middle; font-size: 13px; width: 100%;">
                                                                        <span style="font-size: 14px; font-weight: bold;">Reprint Sports Certificate 
                                                                        ...
                                                                        <asp:Repeater ID="rd_view" runat="server">
                                                                            <ItemTemplate>
                                                                                <tr>
                                                                                    ...
                                                                                    <td style="text-align: left;">
                                                                                        <asp:Label ID="lbl_Participated_in" runat="server" Text='<%#Bind("Participated_in")%>'></asp:Label>
                                                                                    </td>
                                                                                    <td style="text-align: left;">
                                                                                        <asp:Label ID="lbl_Division" runat="server" Text='<%#Bind("Division")%>'></asp:Label>
                                                                                    </td>
                                                                                    <td style="text-align: left;">
                                                                                        <asp:Label ID="lbl_Remarks" runat="server" Text='<%#Bind("Remarks")%>' Style="word-break: break-all"></asp:Label>
                                                                                    </td>
                                                                                    ...
                                                                                    <td style="text-align: left;">
                                                                                        ...
                                                                                        <div class="user-box dropdown" style="float: left; display: inherit; height: auto; border-left: 0px solid #f0f0f0; margin-left: 0px;">
                                                                                            ...
                                                                                            <ul class="dropdown-menu dropdown-menu-end">
                                                                                                ...
                                                                                                <li>
                                                                                                    <a class="dropdown-item" href="slip/sports_certificate.aspx?Id=<%#Eval("Id") %>" target="_blank"><i class='bx bx-printer'></i><span>Print Certificate</span></a>
                                                                                                </li>
                                                                                                <li>
                                                                                                ...
                                                                                                <li>
                                                                                                    <asp:LinkButton ID="lnk_edit" class="dropdown-item" runat="server" ToolTip="Edit" CausesValidation="false" OnClick="lnk_edit_Click"><i class="lni lni-pencil-alt"> </i><span>Update</span></asp:LinkButton>
                                                                                                </li>
                                                                                            </ul>
                                                                                        </div>
                                                                                    </td>
        ...
        <div class="modal-dialog md-width">
            ...
            <div class="modal-content" style="position: relative">
                <div class="modal-header">
                    <h3 class="modal-title" style="font-size: 20px;">Update Sport Certificate</h3>
                ...
                <div class="modal-body md-bdy">
                    ...
                    <div class="mdl-frm-row">
                        <div class="row">
                            <div class="col-sm-4">
                                <label for="validationCustom01" class="find-dv-lbl">Participated in the<sup>* 
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="txt_Participated_in_the" runat="server" ErrorMessage="RequiredField" ValidationGroup="ab" Style="color: red"></asp:RequiredFieldValidator></sup></label>
                            </div>

                            <div class="col-sm-8">
                                <asp:TextBox ID="txt_Participated_in_the" runat="server" class="form-control"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                    <div class="mdl-frm-row">
                        <div class="row">
                            <div class="col-sm-4">
                                <label for="validationCustom01" class="find-dv-lbl">Division<sup>*<asp:RequiredFieldValidator ID="RequiredFieldValidator2" ControlToValidate="txt_Division" runat="server" ErrorMessage="RequiredField" ValidationGroup="ab" Style="color: red"></asp:RequiredFieldValidator></sup></label>
                            </div>
                            <div class="col-sm-8">
                                <asp:TextBox ID="txt_Division" runat="server" class="form-control"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                    <div class="mdl-frm-row">
                        <div class="row">
                            <div class="col-sm-4">
                                <label for="validationCustom01" class="find-dv-lbl">Remarks<sup>*<asp:RequiredFieldValidator ID="RequiredFieldValidator3" ControlToValidate="txt_Remarks" runat="server" ErrorMessage="RequiredField" ValidationGroup="ab" Style="color: red"></asp:RequiredFieldValidator></sup></label>
                            </div>
                            <div class="col-sm-8">
                    ...
                    <div class="mdl-frm-row">
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <asp:Button ID="btn_create" runat="server" Text="Update" OnClick="btn_create_Click" class="btn btn-primary" Style="width: auto !important;" ValidationGroup="ab" />
                            </div>
                        </div>
                    </div>
                </div>
