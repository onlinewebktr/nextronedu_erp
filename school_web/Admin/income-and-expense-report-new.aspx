<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="income-and-expense-report-new.aspx.cs" Inherits="school_web.Admin.income_and_expense_report_new" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        app.controller('RpCardAppCtrl', function ($scope, $http) {
            ...
            // Fetch income data
            $http.get("webServices/account/incomeExpenseNew.asmx/fetch_report_income", { params: { "FromDate": Fromdates, "ToDate": Todates, "OpBlnce": OpBlnce } })
            ...
            // Fetch expense data
            $http.get("webServices/account/incomeExpenseNew.asmx/fetch_report_expense", { params: { "FromDate": Fromdates, "ToDate": Todates, "OpBlnce": OpBlnce } })
                .then(function (response) {
