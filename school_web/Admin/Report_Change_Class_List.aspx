<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="Report_Change_Class_List.aspx.cs" Inherits="school_web.Admin.Report_Change_Class_List" %>
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Change Class List</li>
                        </ol>
                    </nav>
                </div>
            </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="find-dv">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-2">
                                                        <label for="validationCustom01" class="find-dv-lbl" style="width: auto;">Current Adm. No.</label>
                                                        <asp:TextBox ID="txt_admission_no" runat="server" class="form-control find-dv-txtbx"></asp:TextBox>
                                                    </div>
                                                    <div class="col-sm-1"  >
                                                        <asp:Button ID="btn_fnd_by_admission_no" runat="server" Text="Find" class="btn btn-primary find-dv-btn" OnClick="btn_fnd_by_admission_no_Click" />
                                                    </div>
                                                ...
                                                <div class="prnt-dv-wpr">
                                                    ...
                                                    <div class="pgslry-head-div head" style="border-bottom: 1px solid #000; margin: 0px; float: left; width: 100%;">
                                                        ...
                                                        <div style="margin: 0px; padding: 0px; height: 110px; width: 80%; float: left;">
                                                            ...
                                                            <div style="margin: 7px 0px 0px 0px; padding: 0px; float: left; height: auto; text-align: center; vertical-align: middle; font-size: 13px; width: 100%;">
                                                                <span style="font-size: 14px; font-weight: bold;">Change History -<asp:Label ID="lbl_class22" runat="server"></asp:Label></span>
                                                    ...
                                                    <div class="grd-wpr">
                                                        ...
                                                        <asp:GridView ID="GrdView" runat="server" class="table table-bordered" AutoGenerateColumns="False" Width="100%">
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Current Admission No.">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lbl_currentadmission_no" runat="server" Text='<%#Bind("admissionserialnumber")%>'></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Old Admission No.">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lbl_oldadmission_no" runat="server" Text='<%#Bind("Old_admission_no")%>'></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Current Class">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lbl_class" runat="server" Text='<%#Bind("class")%>'></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>

                                                                 <asp:TemplateField HeaderText="Old Class">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lbl_oldclass" runat="server" Text='<%#Bind("Course_Nameold")%>'></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                ...
                                                                <asp:TemplateField HeaderText="Current Section">
                                                                 ...
                                                                 <asp:TemplateField HeaderText="Old Section">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lbl_old_section" runat="server" Text='<%#Bind("Old_Section_name")%>'></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Roll No.">
                                                                  ...
                                                                  <asp:TemplateField HeaderText="Old Roll No.">
                                                                    <ItemTemplate>
                                                                ...
                                                                <asp:TemplateField HeaderText="Change Date">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lbl_date" runat="server" Text='<%#Bind("date1")%>'></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                 <asp:TemplateField HeaderText="Print Slip">
                                                                    <ItemTemplate>
                                                                        <asp:LinkButton ID="LinkButton1" runat="server" OnClick="LinkButton1_Click">Print Slip</asp:LinkButton>
