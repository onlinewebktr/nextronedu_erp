<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="Scholarship_Program_Create.aspx.cs" Inherits="school_web.Admin.Scholarship_Program_Create" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="page-wrapper">
        <div class="page-content">
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Create Scholarship Program </li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-4">
                    <asp:Label ID="ltUsertop" runat="server" Style="font-weight: 500; font-size: 1rem;" class="mb-0 text-uppercase" Text="Create Scholarship Program"></asp:Label>
                    <hr />
                    <div class="card">
                        <div class="card-body">
                ...
                <div class="col-xl-8">
                    <h6 class="mb-0 text-uppercase">Added Scholarship Program</h6>
                    <hr />
                    <div class="card">
                        <div class="card-body">
