...
{
    public partial class Report_Total_Re_Admission_Fee_Collection_Today : System.Web.UI.Page
    {
        My mycode = new My();
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                My.submitException(ex, "Report_Total_Re_Admission_Fee_Collection_Today");
            }
        }
        ...
        private void bind_grd_view_data(string query)
        {
            ...
            {
                lbl_print_headS.Text = "Annual Fees Collection Report of Date : " + txt_date1.Text + " and Class : " + ddlclass.SelectedItem.Text;
