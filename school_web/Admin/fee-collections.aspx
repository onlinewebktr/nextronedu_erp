<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="fee-collections.aspx.cs" Inherits="school_web.Admin.fee_collections" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                                                        ...
                                                        <div class=" row">
                                                            <div class="col-md-8">
                                                                <div class="imp-info-lft">
                                                                    ...
                                                                    <p runat="server" id="btn_admission_fees" data-toggle="modal" data-target="#MdlAdmAnnFeeInfo" class="button-61 collectadmissionfeebtn">Add Fee Head</p>
                                                                ...
                                                                <asp:Repeater ID="rl_ledger" runat="server" OnItemDataBound="rl_ledger_ItemDataBound">
                                                                    <ItemTemplate>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <asp:LinkButton ID="lnk_edit" runat="server" Style="display: none" OnClick="lnk_edit_Click"><span class="material-symbols-outlined" style="font-size: 18px;">edit_square</span></asp:LinkButton>
    ...
    <div id="MdlAdmAnnFeeInfo" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog" style="max-width: 700px;">
            <div class="modal-content">
                <div class="modal-header" style="padding: 3px 17px;">
                    <h5 class="modal-title" style="font-size: 18px; padding: 5px 0px 0px 0px;">Fee Details</h5>
                    <a href="#!" data-dismiss="modal" style="margin: 5px 0px 0px 0px !important; padding: 3px 5px 4px 5px; background: #fa2020; border: #9b0202;"
                        class="btn btn-primary find-dv-btn">Close</a>
                </div>
                <div class="modal-body">
