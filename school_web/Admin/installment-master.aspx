<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="installment-master.aspx.cs" Inherits="school_web.Admin.installment_master" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="page-wrapper">
        <div class="page-content">
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Installment Master</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-5">
                    <asp:Label ID="ltUsertop" runat="server" Style="font-weight: 500; font-size: 1rem;" class="mb-0 text-uppercase" Text="Add Installment"></asp:Label>
                    <hr />
                    <div class="card">
                        <div class="card-body">
                            <div class="p-4 border rounded">
                                <div class="row g-3 needs-validation" novalidate="">
                                    <div class="col-md-12">
                                        <label for="validationCustom01" class="form-label">Installment Name<sup>*</sup></label>
                                        <asp:TextBox ID="txt_ins_name" runat="server" class="form-control" Style="height: 35px"></asp:TextBox>
                                    </div>

                                    <div class="col-md-12">
                                        <label for="validationCustom01" class="form-label" style="float: left; width: 100%;">
                                            Month<sup>*</sup></label>
                                        <asp:Repeater ID="rp_month" runat="server" OnItemDataBound="rp_month_ItemDataBound">
                                            <ItemTemplate>
                                                ...
                                                <asp:Label ID="lbl_position" runat="server" Visible="false" Text='<%#Bind("Position")%>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:Repeater>
                                    </div>
                ...
                <div class="col-xl-7">
                    <h6 class="mb-0 text-uppercase">Added Installment</h6>
                    <hr />
                    <div class="card">
                        <div class="card-body">
                                                    ...
                                                    <asp:Repeater ID="rd_view" runat="server">
                                                        <ItemTemplate>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:Label ID="lbl_intstallment_name" runat="server" Text='<%#Bind("Intstallment_name")%>'></asp:Label>
                                                                </td>
                                                                <td>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <asp:Label ID="lbl_month_position_no" runat="server" Text='<%#Bind("Month_position_no")%>' Visible="false"></asp:Label>
                                                                </td>
                                                            </tr>
                                                        </ItemTemplate>
                                                    </asp:Repeater>
