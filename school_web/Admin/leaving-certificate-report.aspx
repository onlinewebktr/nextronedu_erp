<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="leaving-certificate-report.aspx.cs" Inherits="school_web.Admin.leaving_certificate_report" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Reprint Leaving Certificate for Class XII
</asp:Content>
        ...
        <div class="page-content">
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Reprint Leaving Certificate for Class XII</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            <asp:Label ID="ltUsertop" runat="server" Style="font-weight: 500; font-size: 1rem;" class="mb-0 text-uppercase" Text="Reprint Leaving Certificate for Class XII"></asp:Label>
                            <hr />
                            ...
                            <asp:Label ID="lbl_website" runat="server"></asp:Label>
                                                                    ...
                                                                    <div style="margin: 7px 0px 0px 0px; padding: 0px; float: left; height: auto; text-align: center; vertical-align: middle; font-size: 13px; width: 100%;">
                                                                        <span style="font-size: 14px; font-weight: bold;">Leaving Certificate  
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td style="text-align: left;">
                                                                                        <asp:Panel ID="Panel2" runat="server">
                                                                                            <a style="background: #f00; padding: 2px 5px 1px 5px; display: inline-flex; color: #fff; border-radius: 2px;" href="slip/leaving-certificate.aspx?adm_no=<%#Eval("admissionserialnumber") %>&clssid=<%#Eval("Class_id") %>&sessnid=<%#Eval("Session_id") %>&crtificateno=<%#Eval("Certificate_no") %>" target="_blank"><i class='bx bx-printer'></i><span>Print</span> </a>
                                                                                        </asp:Panel>
                                                                                    </td>
                                                                                </tr>
                                                                            </ItemTemplate>
