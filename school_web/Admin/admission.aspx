<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="admission.aspx.cs" Inherits="school_web.Admin.admission1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#<%=txt_guardian_qualification.ClientID%>").on('focus', function () {
        ...
        /*//=====================Father Occupation==============*/
        $(function () {
            $("#<%=txt_occupation.ClientID%>").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        url: 'admission.aspx/GetFatherOccupation',
                        data: "{ 'PathRooT': '" + request.term + "'}",
                        dataType: "json",
                        type: "POST",
                        contentType: "application/json; charset=utf-8",
            ...
            $("#<%=txt_occupation.ClientID%>").on('focus', function () {
                $(this).autocomplete("search", '');
            });
        });
        ...
        $(function () {
            $("#<%=txt_father_qualification.ClientID%>").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        url: 'admission.aspx/GetFatherQualification',
                        data: "{ 'PathRooT': '" + request.term + "'}",
                        dataType: "json",
                        type: "POST",
                        contentType: "application/json; charset=utf-8",
            ...
            $("#<%=txt_father_qualification.ClientID%>").on('focus', function () {
                $(this).autocomplete("search", '');
            });
        });
        ...
        /*//=====================Mother Occuapation==============*/
        $(function () {
            $("#<%=txt_m_occupation.ClientID%>").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        url: 'admission.aspx/GetMotherOccupation',
                        data: "{ 'PathRooT': '" + request.term + "'}",
                        dataType: "json",
                        type: "POST",
                        contentType: "application/json; charset=utf-8",
            ...
            $("#<%=txt_m_occupation.ClientID%>").on('focus', function () {
                $(this).autocomplete("search", '');
            });
        });
        ...
        $(function () {
            $("#<%=txt_mother_qualification.ClientID%>").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        url: 'admission.aspx/GetFatherQualification',
                        data: "{ 'PathRooT': '" + request.term + "'}",
            ...
            $("#<%=txt_mother_qualification.ClientID%>").on('focus', function () {
                $(this).autocomplete("search", '');
            });
        });
        ...
        /*//=====================Guardian Occupation==============*/
        $(function () {
            $("#<%=txt_guardian_occupation.ClientID%>").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        url: 'admission.aspx/GetGuardianOccupation',
                        data: "{ 'PathRooT': '" + request.term + "'}",
                        dataType: "json",
                        type: "POST",
                        contentType: "application/json; charset=utf-8",
            ...
            $("#<%=txt_guardian_occupation.ClientID%>").on('focus', function () {
                $(this).autocomplete("search", '');
            });
        });
        ...
        $(function () {
            $("#<%=txt_guardian_qualification.ClientID%>").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        url: 'admission.aspx/GetFatherQualification',
                        data: "{ 'PathRooT': '" + request.term + "'}",
                                            ...
                                            <div class="online_frm">
                                                <asp:Panel ID="pnl_academic_details" runat="server">
                                                    ...
                                                    <div class="online_frm-inr">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                                <div class="online_frm-grp">
                                                                    <h2 class="online_frm-grp-h">Acc./Reg. Id</h2>
                                                                    <asp:TextBox ID="txt_reg_acc_id" runat="server" CssClass="form_control"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                        ...
                                                        <div id="HostelDV" style="margin: 0px 0px 5px 0px; float: left; width: 100%; border: 1px solid #ddd; padding: 1px 5px 0px; border-radius: 4px; background: rgb(209 255 204);">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                                                                    <div class="online_frm-grp">
                                                                        <h2 class="online_frm-grp-h">H. Roll No. <a href="#" data-toggle="modal" data-target="#myModalRollH" style="float: right; position: relative;"><span class="material-symbols-outlined" style="color: #0005a9; font-size: 22px; position: absolute; right: 0px;">info</span></a></h2>
                                                                        <asp:TextBox ID="txt_h_roll_no" runat="server" CssClass="form_control"></asp:TextBox>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>

                                                        <div class="modal rights fade model-fltr" id="myModalRollH" role="dialog" style="z-index: 9999; background: rgb(0 0 0 / 17%);">
                                                            <div class="modal-dialog model-dialog-fltr" style="background: rgb(255 255 255 / 62%);">
                                                                <div class="modal-content menusidec" style="background: #dddddd00;">
                                                                    <div class="p-4 border contnt-cntr">
                                                                        <div id="HrollList" class="roll-dv"></div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <script type="text/javascript">
                                                            $("#<%=ddlsession.ClientID%>,#<%=ddl_day_boarding.ClientID%>").on('change', function () {
                                                                var data = {}; 
                                                                data.session_id = $('#<%=ddlsession.ClientID%>').val(); 
                                                                gowithData('../../api/get-h-roll-no-list', 'post', JSON.stringify({ data: data }), function (resp) {
                                                                    $('#<%=txt_h_roll_no.ClientID%>').val(resp.data[0].MissingRollNumber);
                                                                    $('#HrollList').empty();
                                                                    $.each(resp.data, function (i, d) {
                                                                        $('#HrollList').append($('<p>').text(d.MissingRollNumber));
                                                                    })
                                                                })
                                                            })
                                                        </script>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                                <div class="online_frm-grp">
                                                                    ...
                                                                    <asp:DropDownList ID="ddlclass" runat="server" CssClass="form_control"></asp:DropDownList>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                                <div class="online_frm-grp">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" id="rollDV" runat="server">
                                                                <div class="online_frm-grp">
                                                                    <h2 class="online_frm-grp-h">Roll No. <a href="#" data-toggle="modal" data-target="#myModalRoll" style="float: right; position: relative;"><span class="material-symbols-outlined" style="color: #0005a9; font-size: 22px; position: absolute; right: 0px;">info</span></a></h2>
                                                                    <asp:TextBox ID="txt_rollnumber" runat="server" CssClass="form_control" onkeypress="return isNumberKey(event)"></asp:TextBox>
                                                                </div>
                                                            </div> 
                                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" id="HSrollDV" runat="server" visible="false">
                                                                <div class="online_frm-grp">
                                                                    <h2 class="online_frm-grp-h">Hostel Roll No.</h2>
                                                                    <asp:TextBox ID="txt_h_roll_no_update" runat="server" CssClass="form_control" onkeypress="return isNumberKey(event)"></asp:TextBox>
                                                                </div>
                                                            </div> 
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                                <div class="online_frm-grp">
                                                                    ...
                                                                    <asp:TextBox ID="txt_firstname" runat="server" CssClass="form_control" oninput="this.value = this.value.toUpperCase()"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                                <div class="online_frm-grp">
                                                                    <h2 class="online_frm-grp-h">Middle Name <sup></sup></h2>
                                                                    <asp:TextBox ID="txt_middlename" runat="server" oninput="this.value = this.value.toUpperCase()" CssClass="form_control"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                                <div class="online_frm-grp">
                                                                    <h2 class="online_frm-grp-h">Last Name <sup></sup></h2>
                                                                    <asp:TextBox ID="txt_lastname" runat="server" oninput="this.value = this.value.toUpperCase()" CssClass="form_control"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                                <div class="online_frm-grp">
                                                                    <h2 class="online_frm-grp-h">Date of birth<sup>*</sup> <span id="result" style="float: right; color: #0015a7; font-size: 12px;"></span></h2>
                                                    ...
                                                    <div class="online_frm-inr">
                                                        <div class="row">
                                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                                <div class="online_frm-grp">
                                                                    <h2 class="online_frm-grp-h">First Name <sup>*</sup></h2>
                                                                    <asp:TextBox ID="txt_father_first_name" oninput="this.value = this.value.toUpperCase()" runat="server" CssClass="form_control"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                                <div class="online_frm-grp">
                                                                    <h2 class="online_frm-grp-h">Middle Name <sup></sup></h2>
                                                                    <asp:TextBox ID="txt_father_middle_name" oninput="this.value = this.value.toUpperCase()" runat="server" CssClass="form_control"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                                <div class="online_frm-grp">
                                                                    <h2 class="online_frm-grp-h">Last Name <sup></sup></h2>
                                                                    <asp:TextBox ID="txt_father_last_name" oninput="this.value = this.value.toUpperCase()" runat="server" CssClass="form_control"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                                <div class="online_frm-grp">
                                                                    ...
                                                                    <asp:TextBox ID="txt_father_qualification" oninput="this.value = this.value.toUpperCase()" runat="server" CssClass="form_control"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                    ...
                                                    <div class="online_frm-inr">
                                                        <div class="row">
                                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                                <div class="online_frm-grp">
                                                                    <h2 class="online_frm-grp-h">First Name <sup>*</sup></h2>
                                                                    <asp:TextBox ID="txt_mother_first_name" oninput="this.value = this.value.toUpperCase()" runat="server" CssClass="form_control"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                                <div class="online_frm-grp">
                                                                    <h2 class="online_frm-grp-h">Middle Name </h2>
                                                                    <asp:TextBox ID="txt_mother_middle_name" oninput="this.value = this.value.toUpperCase()" runat="server" CssClass="form_control"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                                <div class="online_frm-grp">
                                                                    <h2 class="online_frm-grp-h">Last Name <sup></sup></h2>
                                                                    <asp:TextBox ID="txt_mother_last_name" oninput="this.value = this.value.toUpperCase()" runat="server" CssClass="form_control"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                                <div class="online_frm-grp">
                                                                    ...
                                                                    <asp:TextBox ID="txt_m_occupation" oninput="this.value = this.value.toUpperCase()" runat="server" CssClass="form_control"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                                <div class="online_frm-grp">
                                                    ...
                                                    <div class="online_frm-inr">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                                <div class="online_frm-grp">
                                                                    <h2 class="online_frm-grp-h">Occupation</h2>
                                                                    <asp:TextBox ID="txt_guardian_occupation" oninput="this.value = this.value.toUpperCase()" runat="server" CssClass="form_control"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                                <div class="online_frm-grp">
                                                                    <h2 class="online_frm-grp-h">Qualification<sup>*</sup></h2>
                                                                    <asp:TextBox ID="txt_guardian_qualification" oninput="this.value = this.value.toUpperCase()" runat="server" CssClass="form_control"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <asp:Panel ID="pnl_docs" runat="server" Visible="false">
                                                    ...
                                                    <div class="online_frm-inr">
                                                        ...
                                                        <asp:Panel ID="pnl_submit_doc" runat="server" Visible="false">
                                                            <div class="online_frm-hdg" style="margin: 20px 0px 0px 0px;">
                                                                <h2 class="online_frm-h">Submit Document<sup></sup></h2>
                                                            </div>
                                                            <table class="table table-striped table-bordered dataTable">
                                                                <asp:Repeater ID="rp_document_submit" runat="server" OnItemDataBound="rp_document_submit_ItemDataBound">
                                                                    <ItemTemplate>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <asp:CheckBox ID="chk_doc_submit" runat="server" />
                                                                            </td>
                                                                        </tr>
                                                                    </ItemTemplate>
                                                                </asp:Repeater>
                ...
                <div class="modal-body md-bdy">
                    <div class="mdl-frm-row">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <table style="margin: 0px; padding: 0px; float: left; height: auto" class="table table-bordered">
                                    ...
                                    <tr id="roll_required" runat="server" visible="false">
                                        <td class="td1"><i class="fa fa-times"></i>Roll no. is required
                                        </td>
                                    </tr>
                                </table>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <label for="validationCustom01" class="find-dv-lbl" style="background: #faf52b; padding: 2px 0px 2px 5px;">
                                    <span style="border-bottom: 1px solid #000;">6. Student Document</span>
                                </label>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <table style="margin: 0px; padding: 0px; float: left; height: auto" class="table table-bordered">
                                    <tr id="studentphot1" runat="server" visible="false">
                                        <td class="td1"><i class="fa fa-times"></i>Student Photo is required
                                        </td>
                                    </tr>
