<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="print-multiple-certificate.aspx.cs" Inherits="school_web.Admin.print_multiple_certificate" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="page-content">
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Re-print Certificate</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-12"> 
                    <div class="card">
                        <div class="card-body">
                            <asp:Label ID="ltUsertop" runat="server" Style="font-weight: 500; font-size: 1rem; display: none;" class="mb-0 text-uppercase" Text="Re-print Certificate"></asp:Label>
                                                                        ...
                                                                        <asp:Repeater ID="rd_view" runat="server">
                                                                            <ItemTemplate>
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:Label ID="lbl_adm_no" runat="server" Text='<%#Bind("Admisison_no")%>'></asp:Label>
                                                                                    </td>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:Label ID="Label2" runat="server" Text='<%#Bind("Certificate_type_name")%>'></asp:Label>
                                                                                    </td>
                                                                                    <td>
                                                                                    ...
                                                                                    <td>
                                                                                        ...
                                                                                        <asp:Label ID="lbl_certificate_type" Visible="false" runat="server" Text='<%#Bind("Certificate_type_id")%>'></asp:Label>

                                                                                        <asp:Label ID="lbl_securing_position_rank" Visible="false" runat="server" Text='<%#Bind("Securing_position_rank")%>'></asp:Label>
                                                                                        <asp:Label ID="lbl_competition_name" Visible="false" runat="server" Text='<%#Bind("Competition_name")%>'></asp:Label>
                                                                                        ...
                                                                                        <div class="user-box dropdown" style="float: left; display: inherit; height: auto; border-left: 0px solid #f0f0f0; margin-left: 0px;">
                                                                                            ...
                                                                                            <ul class="dropdown-menu dropdown-menu-end">
                                                                                                ...
                                                                                                <li>
                                                                                                    <a class="dropdown-item" href="slip/certificates.aspx?Id=<%#Eval("Id") %>" target="_blank"><i class='bx bx-printer'></i><span>Print Certificate</span></a>
                                                                                                </li>
                                                                                                <li>
        ...
        <div class="modal-dialog md-width">
            ...
            <div class="modal-content" style="position: relative">
                <div class="modal-header">
                    <h3 class="modal-title" style="font-size: 20px;">Update Certificate</h3>
                ...
                <div class="modal-body md-bdy">
                    ...
                    <div class="mdl-frm-row" style="pointer-events: none">
                        <div class="row">
                            <div class="col-sm-4">
                                <label for="validationCustom01" class="find-dv-lbl">Certificate Type </label>
                            </div>
                            <div class="col-sm-8">
                                <asp:DropDownList ID="ddl_certificate_type" runat="server" class="form-select">
                                    <asp:ListItem Value="0">Select</asp:ListItem>
                                    <asp:ListItem Value="1">Attendance Certificate</asp:ListItem>
                                    <asp:ListItem Value="2">Competition Certificate</asp:ListItem>
                                    <asp:ListItem Value="3">Rank Certificate</asp:ListItem>
                                </asp:DropDownList>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mdl-frm-row" id="securingPosition">
                        <div class="row">
                            <div class="col-sm-4">
                                <asp:Label ID="Label9" runat="server" class="find-dv-lbl">Securing Position</asp:Label>
                            </div>
                            <div class="col-sm-8">
                                <asp:TextBox ID="txt_securing" runat="server" class="form-control"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                    <div class="mdl-frm-row" id="competitionName">
                        <div class="row">
                            <div class="col-sm-4">
                                <label for="validationCustom01" class="find-dv-lbl">
                                    Competition Name<sup>* </sup>
                                </label>
                            </div>
                            <div class="col-sm-8">
                                <asp:TextBox ID="txt_competition_name" runat="server" class="form-control"></asp:TextBox>
                            </div>
                        </div>
                    </div>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            on_certificate_type_selection();
            $("#<%=ddl_certificate_type.ClientID%>").on('change', function () {
                on_certificate_type_selection();
            })
        });
        function on_certificate_type_selection() {
            if ($('#<%= ddl_certificate_type.ClientID %> option:selected').val() == "3") {
                $("#<%=Label9.ClientID%>").text("Securing Rank");
                $("#securingPosition").show();
                $("#competitionName").hide();
            }
            else if ($('#<%= ddl_certificate_type.ClientID %> option:selected').val() == "2") {
                $("#<%=Label9.ClientID%>").text("Securing Position");
                $("#securingPosition").show();
                $("#competitionName").show();
            }
            else {
                $("#securingPosition").hide();
                $("#competitionName").hide();
            }
        }
    </script>
