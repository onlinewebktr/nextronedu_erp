<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="Report_Total_Collection.aspx.cs" Inherits="school_web.Admin.Report_Total_Collection" EnableEventValidation="false" ValidateRequest="false" %>
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="grd-wpr">
                                                ...
                                                <div class="col-sm-12" id="tblPrintIQ" runat="server">
                                                    ...
                                                    <asp:GridView ID="grd_fee" runat="server" AutoGenerateColumns="False" Width="100%" class="table table-striped table-bordered dataTable" OnRowDataBound="grd_fee_RowDataBound" ShowFooter="True">
                                                        <Columns>
