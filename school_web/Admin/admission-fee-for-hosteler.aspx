<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="admission-fee-for-hosteler.aspx.cs" Inherits="school_web.Admin.admission_fee_for_hosteler" EnableEventValidation="false" ValidateRequest="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Admission Fees for Hostel
</asp:Content>
    ...
    <script type="text/javascript">
        function Export() {
            ...
            $("[id*=tabledata1]").table2excel({
                filename: class_name + "AdmissionFeeHostler.xls",
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xl-12">
                    <%--<asp:Label ID="ltUsertop" runat="server" Style="font-weight: 500; font-size: 1rem;" class="mb-0 text-uppercase" Text="Admission Fees For Hostel"></asp:Label>--%>
                    <ul class="sub-pag-menu-ul">
                        <li><a href="admission-fee-for-hosteler.aspx" class="sub-mnu-p-a-active">Admission Fees</a></li>
    ...
    <div class="modal fade" id="myModal1" role="dialog" style="top: 0px">
        <div class="modal-dialog md-width" style="max-width: 500px; margin: 5.75rem auto;">
            ...
            <div class="modal-content" style="position: relative">
                <div class="modal-header">
                    <h3 class="modal-title" style="font-size: 18px;">Copy Hostel Admission Fee For Next Session</h3>
                ...
                <div class="modal-body md-bdy">
                    ...
                    <div class="mdl-frm-row">
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <asp:Button ID="btn_copy_admissionfee_for_day" OnClick="btn_copy_admissionfee_for_day_Click" runat="server" Text="Copy" class="btn btn-success" OnClientClick="return confirm('Are you sure you want to copy  admission fee?');" />
                            </div>
                        </div>
                    </div>
                </div>
