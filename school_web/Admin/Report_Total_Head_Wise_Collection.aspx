<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="Report_Total_Head_Wise_Collection.aspx.cs" Inherits="school_web.Admin.Report_Total_Head_Wise_Collection" EnableEventValidation="false" ValidateRequest="false" %>
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Course">
                                                              ...
                                                              <asp:TemplateField HeaderText="Slip No.">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lbl_Slip_no" runat="server" Text='<%#Bind("slipno") %>'></asp:Label>
