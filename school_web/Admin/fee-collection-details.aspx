<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="fee-collection-details.aspx.cs" Inherits="school_web.Admin.fee_collection_details" %>
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Student Payment Status</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <ul class="sub-pag-menu-ul">
                        ...
                        <li><a href="fee-collection-details.aspx" class="sub-mnu-p-a-active">Student Payment Status</a></li>
                                        ...
                                        <div class="find-dv">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-2">
                                                    ...
                                                    <asp:DropDownList ID="ddl_class" runat="server" class="form-control find-dv-txtbx" AutoPostBack="true" OnSelectedIndexChanged="ddl_class_SelectedIndexChanged"></asp:DropDownList>
                                                </div>
                                                <div class="col-sm-2">
                                        ...
                                        <div id="tblPrintIQ" runat="server">
                                            <div class="head-printdv" style="border-bottom: 1px solid #000; margin: 0px; float: left; width: 100%;">
                                                ...
                                                <div style="margin: 0px; padding: 0px; height: 110px; width: 80%; float: left;">
                                                    ...
                                                    <div style="margin: 7px 0px 0px 0px; padding: 0px; float: left; height: auto; text-align: center; vertical-align: middle; font-size: 13px; width: 100%;">
                                                        <span style="font-size: 14px; font-weight: bold;">Overall Fee Collection Report<asp:Label ID="lbl_date_period" runat="server"></asp:Label></span>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <table class="table table-striped table-bordered dataTable" role="grid" aria-describedby="example2_info">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="font-weight: 700">{{reportFeeS[reportFeeS[0].Roucounts].Final_payable}}</td>
                                                                <td style="font-weight: 700">{{reportFeeS[reportFeeS[0].Roucounts].Final_paid}}</td>
                                                                <td style="font-weight: 700">{{reportFeeS[reportFeeS[0].Roucounts].Final_dues}}</td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </div>
    ...
    <script type="text/javascript">
        ...
        app.controller('RpCardAppCtrl', function ($scope, $http) {
            ...
            $scope.ButtonClickFind = function () {
                ...
                $http.get("webServices/overall-collection.asmx/fetch_student_paid_fee", { params: { "Session_id": session_id, "Class_id": class_id, "Section": section, "Session_name": session_name } }).then(function (response) {
            ...
            $scope.Export = function () {
                $("#tblCustomers").table2excel({
                    filename: "Payment-fee-status.xls"
                });
            }
        });
