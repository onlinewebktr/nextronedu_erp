<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="Individual_edit_subject_mapping.aspx.cs" Inherits="school_web.Admin.Individual_edit_subject_mapping" %>
        ...
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3">
                    <asp:LinkButton ID="lnk_back" runat="server" class="backlnk-css" OnClick="lnk_back_Click"><i class="bx bx-arrow-back"></i></asp:LinkButton>Subject Master
                </div>
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Subject mapping with Students</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-6">
                    <asp:Label ID="ltUsertop" runat="server" Style="font-weight: 500; font-size: 1rem;" class="mb-0 text-uppercase" Text="Subject mapping with Students"></asp:Label>
                    <hr />
                    <div class="card">
                        <div class="card-body">
                ...
                <div class="col-xl-6">
                    <asp:Label ID="Label3" runat="server" Style="font-weight: 500; font-size: 1rem;" class="mb-0 text-uppercase" Text="Subject List"></asp:Label>
                    <hr />
                    <div class="card">
                        <div class="card-body">
                            <div class="p-4 border rounded">
                                ...
                                <div class="row g-3 needs-validation" novalidate="" style="overflow: auto;">
                                    <div class="grd-wpr">
