<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="Taken_Other_Fee_From_Student.aspx.cs" Inherits="school_web.Admin.Taken_Other_Fee_From_Student" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Other Fee Collection</li>
                        </ol>
                    </nav>
                </div>
            </div>
                                                ...
                                                <div class="card-body">
                                                    <div class="p-4 border rounded">
                                                        <div class="row g-3 needs-validation" novalidate="">
                                                            ...
                                                            <div class="col-md-12">
                                                                <label for="validationCustom01" class="form-label">Select Fees Type </label>
                                                            ...
                                                            <div class="col-md-12">
                                                                ...
                                                                <asp:TextBox ID="txt_fee" runat="server" class="form-control"></asp:TextBox>
                                                            </div>
                                                            <div class="col-md-12" id="payDatedv">
                                                                <label for="validationCustom01" class="form-label">Select Date<sup>*<asp:RequiredFieldValidator ID="RequiredFieldValidator1" Display="Dynamic" runat="server" ErrorMessage="*" ValidationGroup="a" ControlToValidate="txt_date"></asp:RequiredFieldValidator></sup></label>

                                                                <div id="Paydatelbl" style="display: none">
                                                                    <asp:Label ID="lbl_payment_date" runat="server" class="form-control"></asp:Label>
                                                                </div>
                                                                <div id="payDatetxtbx">
    ...
    <%--<script type="text/javascript">
        $(document).ready(function () {
            ...
            if (UserType == "Admin") {
                var paydatelbl = document.getElementById("Paydatelbl");
                paydatelbl.className += " hidden";

                var paydatetxtbx = document.getElementById("payDatetxtbx");
                paydatetxtbx.className += " showd";
            }
            else {
                var paydatelbl = document.getElementById("Paydatelbl");
                paydatelbl.className += " showd";

                var paydatetxtbx = document.getElementById("payDatetxtbx");
                paydatetxtbx.className += " hidden";

                var d1 = document.getElementById("payDatedv");
                d1.className += " otherclass1";
            }
        });
    </script>--%>
