<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="admission-fee-collection-report.aspx.cs" Inherits="school_web.Admin.admission_fee_collection_report" EnableEventValidation="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Admission Fees Collection Report
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Admission Fees Collection Report</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    ...
                    <ul class="sub-pag-menu-ul">
                        ...
                        <li><a href="admission-fee-collection-report.aspx" class="sub-mnu-p-a-active">Today Fees Collection</a></li>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <asp:Label ID="lbl_website" runat="server"></asp:Label>
                                                                ...
                                                                <div style="margin: 7px 0px 0px 0px; padding: 0px; float: left; height: auto; text-align: center; vertical-align: middle; font-size: 13px; width: 100%;">
                                                                    <span style="font-size: 14px; font-weight: bold;">Admission Fee Collection Report-<asp:Label ID="lbl_class22" runat="server"></asp:Label></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                                                ...
                                                                                <td style="text-align: left;">
                                                                                    <div class="user-box dropdown" style="float: left; display: inherit; height: auto; border-left: 0px solid #f0f0f0; margin-left: 0px;">
                                                                                        ...
                                                                                        <ul class="dropdown-menu dropdown-menu-end">
                                                                                            ...
                                                                                            <li>
                                                                                                <asp:LinkButton ID="lnkviewDt" Visible="false" class="dropdown-item" runat="server" CausesValidation="false" OnClick="lnkviewDt_Click" ToolTip="Edit" Style="display: none"> <i class="lni lni-pencil-alt"></i><span>View Details</span></asp:LinkButton>
                                                                                            </li>
                                                                                        </ul>
                                                                                    </div>
    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            var options = {
                title: 'Admission Fees Collection Summary',
                width: 940,
                height: 400,
            ...
            $.ajax({
                type: "POST",
                url: "admission-fee-collection-report.aspx/GetChartData",
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "graph.asmx/Get_admission_fee_mode",
