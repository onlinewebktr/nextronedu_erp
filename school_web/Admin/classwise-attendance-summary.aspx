<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="classwise-attendance-summary.aspx.cs" Inherits="school_web.Admin.classwise_attendance_summary" %>
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Class-wise  Attendance Summary</li>
                        </ol>
                    </nav>
                </div>
            </div>
                                            ...
                                            <div class="prnt-dv-wpr printborder" id="tblCustomers">
                                                <div class="pgslry-head-div head" style="border-bottom: 1px solid #000; margin: 0px; float: left; width: 100%;">
                                                    ...
                                                    <div style="margin: 0px; padding: 0px; height: 110px; width: 80%; float: left;">
                                                        ...
                                                        <div style="margin: 7px 0px 0px 0px; padding: 0px; float: left; height: auto; text-align: center; vertical-align: middle; font-size: 13px; width: 100%;">
                                                            <span style="font-size: 14px; font-weight: bold;">Class-wise Attendance Summary for the Date of 
    ...
    <script type="text/javascript">
        ...
        app.controller('RpCardAppCtrl', function ($scope, $http) {
            ...
            if (find_status == "1") {
                ...
                $http.get("webServices/attendance.asmx/fetch_classwise_attendance_summary", { params: { "Session": session, "Session_id": session_id, "Class_id": class_id, "Section": section, "Idate": idate } }).then(function (response) {
