...
namespace school_web.Admin
{
    public partial class chat : System.Web.UI.Page
    {
        ...
        {
            string sql = @"select t1.*,t2.studentname as Full_name,t2.mobilenumber as Mobile_no,t2.admissionserialnumber,t2.Section,t2.rollnumber,t2.class  from Complain_feedback t1 join admission_registor t2 on t1.User_id=t2.admissionserialnumber where t1.Request_id='" + hd_request_id.Value + "' and t1.User_id='" + hd_studentid.Value + "' and  t2.Transfer_Status in('New','NT')";
        ...
        protected void lnk_back_Click(object sender, EventArgs e)
        {
                ...
                Response.Redirect("Student_complain_list.aspx", false);
