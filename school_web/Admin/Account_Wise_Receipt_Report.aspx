<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="Account_Wise_Receipt_Report.aspx.cs" Inherits="school_web.Admin.Account_Wise_Receipt_Report" EnableEventValidation="false" ValidateRequest="false" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">Account Wise Receipt History
</asp:Content>
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">>Account Wise Receipt History</li>
                        </ol>
                    </nav>
                </div>
            </div>
                            ...
                            <div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap5 hdrmodify">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="find-dv">
                                            <div class="row">
                                                <div style="margin: 0px auto; padding: 3px 9px 6px 53px; width: 50%; background-color: beige;">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <label for="validationCustom01" class="find-dv-lbl">Account Name</label>
                                                        <asp:TextBox ID="txt_account_name" runat="server" CssClass="form-control find-dv-txtbx ui-autocomplete-input"></asp:TextBox>
                                            ...
                                            <div id="tblPrintIQ" runat="server">
                                                <div class="pgslry-head-div head" style="border-bottom: 1px solid #000; margin: 0px; float: left; width: 100%;">
                                                    ...
                                                    <div style="margin: 0px; padding: 0px; height: 110px; width: 80%; float: left;">
                                                        ...
                                                        <div style="margin: 7px 0px 0px 0px; padding: 0px; float: left; height: auto; text-align: center; vertical-align: middle; font-size: 13px; width: 100%;">
                                                            <span style="font-size: 14px; font-weight: bold;">>Account Wise Receipt History
                                                    ...
                                                    <table id="datatable1" data-page-length='100000' class="table table-striped table-bordered dataTable" role="grid" aria-describedby="example2_info">
                                                            ...
                                                            <asp:Repeater ID="grd_view" runat="server">
                                                                <ItemTemplate>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <asp:Label ID="lbl_cr_account" runat="server" Text='<%#Eval("Credit","{0:n}") %>'></asp:Label>
                                                                            <asp:Label ID="lbl_dr_account" runat="server"  Visible="false" Text='<%#Eval("Debit","{0:n}") %>'></asp:Label>
                                                                        </td>
                                                        ...
                                                        <tfoot>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                     <asp:Label  ID="txt_total_debit" Visible="false" runat="server"></asp:Label>
        ...
        function searching_by_ledger_name() {
            $("#<%=txt_account_name.ClientID%>").autocomplete({
                ...
                source: function (request, response) {
                    $.ajax({
                        url: 'Account_Wise_Receipt_Report.aspx/Search_particular',
