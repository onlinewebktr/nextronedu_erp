<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="collection-sheet-dcr-userwise.aspx.cs" Inherits="school_web.Admin.collection_sheet_dcr_userwise" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    User-Wise Collection Sheet
</asp:Content>
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">User-Wise Collection Sheet</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <ul class="sub-pag-menu-ul">
                        ...
                        <li><a href="collection-sheet-dcr-userwise.aspx" class="sub-mnu-p-a-active">User-Wise Collection Sheet</a></li>
