<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="discount-report.aspx.cs" Inherits="school_web.Admin.discount_report" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-4">
                                                                ...
                                                                <asp:DropDownList ID="ddl_student_type" runat="server" class="form-select find-dv-txtbx txtbx-ddl-style">
                                                                    ...
                                                                    <asp:ListItem Value="NT">Old</asp:ListItem>
                                                                </asp:DropDownList>
                                                            </div>
                                                            ...
                                                            <table class="table table-bordered">
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <th>Payable Monthly Fee </th>
                                                                        <th>Total Adm./Annual Fee </th>
                                                                        <th>Adm./Annual Fee Discount</th>
                                                                        <th>Payable Adm./Annual</th>
                                                                        <%-- <th>Total</th>--%>
                                                                        <th>Discount Type</th>
                                                                ...
                                                                <tbody>
                                                                    <tr data-ng-repeat="x in reportAmountS | filter : searchs">
                                                                        ...
                                                                        <%-- <td>{{x.PaidFesAmt}}</td>--%>
                                                                        <td>{{x.Student_Discunt_Type}}</td>
                                                                        <td>{{x.Student_Discunt_Remarks}}</td>
                                                                    </tr>
    ...
    <script type="text/javascript">
        ...
        app.controller('RpCardAppCtrl', function ($scope, $http) {
            ...
            var type = $("#<%=ddl_student_type.ClientID%>").val();
            ...
            $http.get("webServices/account/discount-report.asmx/fetch_report_heading_day_end_amts", { params: { "Session_id": session_id, "Class_id": class_id, "FromDate": Fromdates, "ToDate": Todates, "Type": type, "Session_name": session_name, "Class_name": class_name, "Collection_type": collection_type } }).then(function (response) {
                ...
                if ($scope.reportAmountS == "") {
                    ...
                    $http.get("webServices/account/discount-report.asmx/fetch_report_heading_day_end_final_amts", { params: { "Session_id": session_id, "Class_id": class_id, "FromDate": Fromdates, "ToDate": Todates, "Type": type, "Session_name": session_name, "Class_name": class_name, "Collection_type": collection_type } }).then(function (response) {
