<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="fees-collections.aspx.cs" Inherits="school_web.Admin.fees_collections" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                                                                ...
                                                                <script>
                                                                    ...
                                                                    function ShowHideDiv(chkPassport) {
                                                                        ...
                                                                        if ($(chkPassport).prop('checked') == true) {
                                                                            ...
                                                                            ///===TO BE COMMENT
                                                                            $("#<%=txt_paid_amount.ClientID %>").val(totalFee.toFixed());
                                                                            ///===TO BE COMMENT
                                                                        }
                                                                        else {
                                                                            var ttl_mnthlyamt = parseFloat($("#<%=txt_monthlyFee.ClientID %>").val());
                                                                            ...
                                                                            ///===TO BE COMMENT
                                                                            $("#<%=txt_paid_amount.ClientID %>").val(ttl_mnthlyamt.toFixed());
                                                                            ///===TO BE COMMENT
    ...
    <div id="MdlAdmAnnFeeInfo" class="modal fade" role="dialog">
