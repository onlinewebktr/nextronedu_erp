<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="sectionwise-student.aspx.cs" Inherits="school_web.Admin.sectionwise_student" EnableEventValidation="false" ValidateRequest="false" %>
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <tr>
                                                                                <td>
                                                                                    ...
                                                                                    <asp:Label ID="Label6" Visible="false" runat="server" Text='<%#Bind("session")%>'></asp:Label>
                                                                                ...
                                                                                <td style="text-align: left;">
                                                                                    <asp:Label ID="lbl_new_admission" runat="server"></asp:Label>
                                                                                </td>
                                                                                <td style="text-align: left;">
                                                                                    <asp:Label ID="lbl_old_admission" runat="server"></asp:Label>
                                                                                </td>
                                                                                <td style="text-align: left;">
                                                                                    <asp:Label ID="lbl_ttl_admission" runat="server"></asp:Label>
                                                                                </td>
                                                                                ...
                                                                                <td style="text-align: left;">
                                                                                    <asp:Label ID="lbl_transgender" runat="server"></asp:Label>
                                                                                </td>
                                                                                <td style="text-align: left;">
                                                                                    <asp:Label ID="lbl_total_genderwise" runat="server"></asp:Label>
                                                                                </td>
                                                                            </tr>
                                                                        </ItemTemplate>
                                                                    </asp:Repeater>
    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            var options = {
                ...
                titleTextStyle: {
                    color: '#00a7cd',    // any HTML string color ('red', '#cc00cc')
                    fontSize: 18
                },
            ...
            $.ajax({
                type: "POST",
                url: "sectionwise-student.aspx/GetChartData",
                data: "{Session: '" + $('#<%=hd_session.ClientID%>').val() + "', Class_id: '" + $('#<%=hd_class.ClientID%>').val() + "', Section: '" + $('#<%=hd_section.ClientID%>').val() + "'}",
