<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="Report_Delete_Bill_History.aspx.cs" Inherits="school_web.Admin.Report_Delete_Bill_History" EnableEventValidation ="false" ValidateRequest="false"  %>
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Delete bill List</li>
                        </ol>
                    </nav>
                </div>
            </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="find-dv">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-2">
                                                        <label for="validationCustom01" class="find-dv-lbl" style="width: auto;">Admission No.</label>
                                                ...
                                                <div class="prnt-dv-wpr">
                                                    ...
                                                    <div class="pgslry-head-div head" style="border-bottom: 1px solid #000; margin: 0px; float: left; width: 100%;">
                                                        ...
                                                        <div style="margin: 0px; padding: 0px; height: 110px; width: 80%; float: left;">
                                                            ...
                                                            <div style="margin: 7px 0px 0px 0px; padding: 0px; float: left; height: auto; text-align: center; vertical-align: middle; font-size: 13px; width: 100%;">
                                                                <span style="font-size: 14px; font-weight: bold;">Delete bill History -<asp:Label ID="lbl_class22" runat="server"></asp:Label></span>
