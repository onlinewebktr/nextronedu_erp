<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="Student_complain_list.aspx.cs" Inherits="school_web.Admin.Student_complain_list" EnableEventValidation="false" %>
                            ...
                            <asp:Panel ID="pnl_view" runat="server" Visible="false">
                                ...
                                <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered">
                                    <thead>
                                        <tr>
                                            <th colspan="13">
                                                <p style="width: auto; float: left; background-color: #e50800; padding: 4px 9px 9px 0px; margin: 0px 5px 0px 0px; line-height: 10px; color: #fff; border-radius: 2px; font-weight: 500;">
                                                ...
                                                <p style="width: auto; float: left; background-color: #29a700; padding: 4px 9px 9px 0px; margin: 0px; line-height: 10px; color: #fff; border-radius: 2px; font-weight: 500;">
