<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="Send_Events_To_Staff.aspx.cs" Inherits="school_web.Admin.Send_Events_To_Staff" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">Send Events To Staff
</asp:Content>
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><a href="Event.aspx" class="backlnk-css"><i class="bx bx-arrow-back"></i></a>Events</div>
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            <li class="breadcrumb-item"><a href="Home.aspx"><i class="bx bx-home-alt"></i></a>
                            </li>
                            <li class="breadcrumb-item active" aria-current="page">Send Events to Teachers</li>
                        </ol>
                    </nav>
                </div>
            </div>
                                ...
                                <div class="col-xl-6">
                                    <div class="p-4 border rounded">
                                        <div class="row g-3 needs-validation" novalidate="">
                                            <div class="col-md-12">
                                                <label for="validationCustom01" class="form-label">Teacher/staff List<sup></sup></label>
                                                <asp:DropDownList ID="ddl_Teacherlist" runat="server" class="form-select find-dv-txtbx"></asp:DropDownList>
                                            </div>
                                            <div class="col-md-12">
                                            ...
                                            <div class="col-md-12">
                                                <label>Events Details<sup>*</sup></label>
                                            ...
                                            <div class="col-12" style="text-align: center">
                                                <asp:Button ID="btn_Submit" runat="server" Text="Send" CssClass="btn btn-primary" ValidationGroup="a" OnClick="btn_Submit_Click" />
