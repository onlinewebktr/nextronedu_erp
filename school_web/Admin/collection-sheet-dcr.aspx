<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="collection-sheet-dcr.aspx.cs" Inherits="school_web.Admin.collection_sheet_dcr" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="row" data-ng-app="RpCardApp" data-ng-controller="RpCardAppCtrl">
                ...
                <div class="col-xl-12">
                    <ul class="sub-pag-menu-ul">
                        <li><a href="collection-sheet-dcr.aspx" class="sub-mnu-p-a-active">Today Collection Sheet</a></li>
                                        ...
                                        <div id="tblPrintIQ" runat="server">
                                            <div class="head-printdv" style="border-bottom: 1px solid #000; margin: 0px; float: left; width: 100%;">
                                                ...
                                                <div style="margin: 0px; padding: 0px; height: 110px; width: 80%; float: left;">
                                                    ...
                                                    <div style="margin: 7px 0px 0px 0px; padding: 0px; float: left; height: auto; text-align: center; vertical-align: middle; font-size: 13px; width: 100%;">
                                                        <span style="font-size: 14px; font-weight: bold;">Collection Sheet/Day End Report for -
                                                ...
                                                <div class="grd-wpr-new">
                                                    <table class="table table-bordered" datatable="ng" dt-options="vm.dtOptions" style="border: 1px solid #c5c0c0;">
                                                        ...
                                                        <tr data-ng-repeat="x in reportAmountSFnal track by $index">
                                                            <td colspan="12" class="fntbold" style="text-align: right">Total : </td>
    ...
    <script type="text/javascript">
        ...
        app.controller('RpCardAppCtrl', function ($scope, $http) {
            ...
            $http.get("webServices/account/collection-sheet-dcr.asmx/fetch_report_heading_day_end", {
                params: { "Session_id": session_id, "Class_id": class_id, "FromDate": Fromdates, "ToDate": Todates, "Type": type, "Session_name": session_name, "Class_name": class_name, "Collection_type": collection_type }
            ...
            $http.get("webServices/account/collection-sheet-dcr.asmx/fetch_report_heading_day_end_amts", { params: { "Session_id": session_id, "Class_id": class_id, "FromDate": Fromdates, "ToDate": Todates, "Type": type, "Session_name": session_name, "Class_name": class_name, "Collection_type": collection_type } }).then(function (response) {
                ...
                if ($scope.reportAmountS == "") {
                    ...
                    $http.get("webServices/account/collection-sheet-dcr.asmx/fetch_report_heading_day_end_final_amts", { params: { "Session_id": session_id, "Class_id": class_id, "FromDate": Fromdates, "ToDate": Todates, "Type": type, "Session_name": session_name, "Class_name": class_name, "Collection_type": collection_type } }).then(function (response) {
                        $scope.reportAmountSFnal = response.data;
                    })

                    $http.get("webServices/account/collection-sheet-dcr.asmx/fetch_report_modewise", { params: { "Session_id": session_id, "Class_id": class_id, "FromDate": Fromdates, "ToDate": Todates, "Type": type, "Session_name": session_name, "Class_name": class_name, "Collection_type": collection_type } }).then(function (response) {
                        $scope.reportmodes = response.data;
                    })

                    ///===================================UserWise

                    $http.get("webServices/account/collection-sheet-dcr.asmx/fetch_report_userwise_collection_head", { params: { "Session_id": session_id, "Class_id": class_id, "FromDate": Fromdates, "ToDate": Todates, "Type": type, "Session_name": session_name, "Class_name": class_name, "Collection_type": collection_type } }).then(function (response) {
                        $scope.reportmodesUser = response.data;
                        if ($scope.reportmodesUser == "") {
                        }
                        else {
                            $http.get("webServices/account/collection-sheet-dcr.asmx/fetch_report_userwise_collection_amt", { params: { "Session_id": session_id, "Class_id": class_id, "FromDate": Fromdates, "ToDate": Todates, "Type": type, "Session_name": session_name, "Class_name": class_name, "Collection_type": collection_type } }).then(function (response) {
