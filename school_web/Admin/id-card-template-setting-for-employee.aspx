<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="id-card-template-setting-for-employee.aspx.cs" Inherits="school_web.Admin.id_card_template_setting_for_employee" %>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <table class="table  table-bordered" runat="server" id="grddv">
                                ...
                                <tr>
                                    <td runat="server" id="imgTemp">Front : 
                                         <asp:Image ID="Image1" runat="server" class="img-responsive" Style="max-width: 100%" />
                                    </td>
                                </tr>

                                <tr>
                                    <td runat="server" id="imgTempBack" visible="false">Back : 
                                         <asp:Image ID="Image2" runat="server" class="img-responsive" Style="max-width: 100%" />
                                    </td>
                                </tr>
                            </table>
                        </div>
