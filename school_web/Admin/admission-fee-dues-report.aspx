<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="admission-fee-dues-report.aspx.cs" Inherits="school_web.Admin.admission_fee_dues_report" EnableEventValidation="false" ValidateRequest="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Admission Fees Dues Report
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Admission Fees Dues List</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <ul class="sub-pag-menu-ul">
                        ...
                        <li><a href="admission-fee-dues-report.aspx" class="sub-mnu-p-a-active">Admission Fees Dues List</a></li>
                    ...
                    <div class="card">
                        <div class="card-body">
                                ...
                                <div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap5 hdrmodify">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <div class="home-grph-wprdv" style="display: none">
                            ...
                            <asp:Label ID="lbl_website" runat="server"></asp:Label>
                                                                ...
                                                                <div style="margin: 7px 0px 0px 0px; padding: 0px; float: left; height: auto; text-align: center; vertical-align: middle; font-size: 13px; width: 100%;">
                                                                    <span style="font-size: 14px; font-weight: bold;">Admission Fees Dues List-<asp:Label ID="lbl_class22" runat="server"></asp:Label></span>
                                                                </div>
                                                            </div>
                                                        </div>
    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            var options = {
                title: 'ClassWise Admission Dues Fees Summary',
                width: 1140,
                height: 400,
            ...
            $.ajax({
                type: "POST",
                url: "admission-fee-dues-report.aspx/GetChartData",
                data: "{Session: '" + $('#<%=hd_session.ClientID%>').val() + "', Class: '" + $('#<%=hd_class.ClientID%>').val() + "', Stunt_name: '" + $('#<%=hd_stunt_name.ClientID%>').val() + "', Flags: '" + $('#<%=hd_flag.ClientID%>').val() + "'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (r) {
