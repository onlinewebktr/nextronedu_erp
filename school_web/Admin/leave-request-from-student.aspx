<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="leave-request-from-student.aspx.cs" Inherits="school_web.Admin.leave_request_from_student" EnableEventValidation="false" ValidateRequest="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Leave Request From Student
</asp:Content>
    ...
    <div class="page-wrapper">
        <div class="page-content">
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Leave request From Student</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row" data-ng-app="ComplainApp" data-ng-controller="ComplainAppCtrl">
                <div class="col-xl-12">
                    <h6 class="mb-0 text-uppercase">Leave request From Student</h6>
                    <hr />
                    <div class="card">
                        <div class="card-body">
                            ...
                            <asp:Label ID="lbl_website" runat="server"></asp:Label>
                                                            ...
                                                            <div style="margin: 7px 0px 0px 0px; padding: 0px; float: left; height: auto; text-align: center; vertical-align: middle; font-size: 13px; width: 100%;">
                                                                <span style="font-size: 14px; font-weight: bold;">Leave request From Student -<asp:Label ID="lbl_class22" runat="server"></asp:Label></span>
                                    ...
                                    <asp:Label ID="lbltotal_approved" runat="server">0</asp:Label>
                                                                    ...
                                                                    <th colspan="6" class="hdr-bg">Rejected Leave : 
                                                                ...
                                                                <asp:Repeater ID="rd_view" runat="server" OnItemDataBound="rd_view_ItemDataBound">
                                                                    <ItemTemplate>
                                                                        <tr>
                                                                            ...
                                                                            <td style="text-align: left;">
                                                                                <asp:Label ID="lbl_leave_from" runat="server" Text='<%#Bind("Leave_From")%>'></asp:Label>
                                                                            </td>
                                                                            <td style="text-align: left;">
                                                                                <asp:Label ID="lbl_leave_to" runat="server" Text='<%#Bind("Leave_To")%>'></asp:Label>
                                                                            </td>
                                                                            <td style="text-align: left;">
                                                                            ...
                                                                            <td style="text-align: left;">
                                                                                <asp:Label ID="lbl_class_name" runat="server" Style="text-align: left; width: 100%; line-height: 18px;"
                                                                                    Text='<%#Bind("Class_Name")%>'></asp:Label>
                                                                            </td>

                                                                            <td style="text-align: left;">
                                                                                <asp:Label ID="lbl_section" runat="server" Style="text-align: left; width: 100%; line-height: 18px;"
                                                                                    Text='<%#Bind("Section")%>'></asp:Label>
                                                                            </td>
                                                                            <td style="text-align: left;">
                                                                                <asp:Label ID="Label11" runat="server" Style="text-align: left; width: 100%; line-height: 18px;"
                                                                                    Text='<%#Bind("Roll_No")%>'></asp:Label>
                                                                            </td>
                                                                            <td style="text-align: left;">
                                                                                <asp:Label ID="lbl_admission_no" runat="server" Style="text-align: left; width: 100%; line-height: 18px;"
                                                                                    Text='<%#Bind("Admission_no")%>'></asp:Label>
                                                                            </td>
