<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="Delete_other_fee.aspx.cs" Inherits="school_web.Admin.Delete_other_fee" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">Delete other Fee
</asp:Content>
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Today Other Fees Collection</li>
                        </ol>
                    </nav>
                </div>
            </div>
                                                                ...
                                                                <asp:TemplateField HeaderText="Amount">
                                                                  ...
                                                                  <asp:TemplateField HeaderText="Slip">
                                                                    <ItemTemplate>
                                                                        ...
                                                                        <asp:LinkButton ID="lnkDel" runat="server" ToolTip="Delete" OnClientClick="return confirm('Are you sure you want to delete this?');" CausesValidation="false" OnClick="lnkDel_Click"><i class="lni lni-trash"> </i>Delete</asp:LinkButton>
