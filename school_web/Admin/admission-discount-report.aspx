<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="admission-discount-report.aspx.cs" Inherits="school_web.Admin.admission_discount_report" EnableEventValidation="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Admission Fee Discount Report
</asp:Content>
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Admission Fee Discount</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <ul class="sub-pag-menu-ul">
                        <li><a href="admission-discount-report.aspx" class="sub-mnu-p-a-active">Admission Fees Discount List</a></li>
                        <li><a href="annual-discount-report.aspx">Annual Fees Discount List</a></li>
                        <li><a href="monthly-discount-report.aspx">Monthly Fees Discount List</a></li>
                        <li><a href="all-discount-report.aspx">All Fees Discount List</a></li>
                    </ul>
                </div>
                <div class="col-xl-12">
                    <hr />
                    ...
                    <div class="col-xl-12">
                        <h6 class="mb-0 text-uppercase">Admission Fee Discount List</h6>
                        <hr />
                        <div class="card">
                            <div class="card-body">
                            ...
                            <asp:Label ID="lbl_website" runat="server"></asp:Label>
                                                                    ...
                                                                    <div style="margin: 7px 0px 0px 0px; padding: 0px; float: left; height: auto; text-align: center; vertical-align: middle; font-size: 13px; width: 100%;">
                                                                        <span style="font-size: 18px; font-weight: bold;">Admission Discount List
                                                            ...
                                                            <div class="grd-wpr">
                                                                <asp:GridView ID="GridView2" runat="server" CssClass="table table-bordered table-striped" Style="width: 100%" AutoGenerateColumns="true" OnRowCreated="GridView2_RowCreated" OnSelectedIndexChanged="GridView2_SelectedIndexChanged" ShowFooter="true">
                                                                </asp:GridView>
