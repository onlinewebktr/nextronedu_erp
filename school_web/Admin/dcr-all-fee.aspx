<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="dcr-all-fee.aspx.cs" Inherits="school_web.Admin.dcr_all_fee" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="row" data-ng-app="RpCardApp" data-ng-controller="RpCardAppCtrl">
                ...
                <div class="col-xl-12">
                    <ul class="sub-pag-menu-ul">
                        <li><a href="dcr-all-fee.aspx" class="sub-mnu-p-a-active">Today Collection Sheet</a></li>
    ...
    <script type="text/javascript">
        ...
        app.controller('RpCardAppCtrl', function ($scope, $http) {
            ...
            $http.get("webServices/account/dcr-all-fee.asmx/fetch_report_heading_day_end", {
            ...
            $http.get("webServices/account/dcr-all-fee.asmx/fetch_report_heading_day_end_amts", { params: { "Session_id": session_id, "Class_id": class_id, "FromDate": Fromdates, "ToDate": Todates, "Type": type, "Session_name": session_name, "Class_name": class_name, "Collection_type": collection_type } }).then(function (response) {
                ...
                if ($scope.reportAmountS == "") {
                    ...
                    $http.get("webServices/account/dcr-all-fee.asmx/fetch_report_heading_day_end_final_amts", { params: { "Session_id": session_id, "Class_id": class_id, "FromDate": Fromdates, "ToDate": Todates, "Type": type, "Session_name": session_name, "Class_name": class_name, "Collection_type": collection_type } }).then(function (response) {
                        $scope.reportAmountSFnal = response.data;
                    })

                    $http.get("webServices/account/dcr-all-fee.asmx/fetch_report_modewise", { params: { "Session_id": session_id, "Class_id": class_id, "FromDate": Fromdates, "ToDate": Todates, "Type": type, "Session_name": session_name, "Class_name": class_name, "Collection_type": collection_type } }).then(function (response) {
                        $scope.reportmodes = response.data;
                    })

                    ///===================================UserWise

                    $http.get("webServices/account/dcr-all-fee.asmx/fetch_report_userwise_collection_head", { params: { "Session_id": session_id, "Class_id": class_id, "FromDate": Fromdates, "ToDate": Todates, "Type": type, "Session_name": session_name, "Class_name": class_name, "Collection_type": collection_type } }).then(function (response) {
                        $scope.reportmodesUser = response.data;
                        if ($scope.reportmodesUser == "") {
                        }
                        else {
                            $http.get("webServices/account/dcr-all-fee.asmx/fetch_report_userwise_collection_amt", { params: { "Session_id": session_id, "Class_id": class_id, "FromDate": Fromdates, "ToDate": Todates, "Type": type, "Session_name": session_name, "Class_name": class_name, "Collection_type": collection_type } }).then(function (response) {
