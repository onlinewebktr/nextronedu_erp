<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="view_ledger.aspx.cs" Inherits="school_web.Admin.view_ledger" EnableEventValidation="false" ValidateRequest="false"  %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        $(document).ready(function () {
            $("#view_ledger").addClass("dcjq-parent active");
        });
    </script>
    <style>
        .ddttxx {
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">View Ledger</li>
                        </ol>
                    </nav>
                </div>
            </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="find-dv">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-3">
                                                    <label for="validationCustom01" class="find-dv-lbl">Select Ledger</label>
                                                    <asp:TextBox ID="txt_account_name" runat="server" CssClass="form-control find-dv-txtbx" Text=""></asp:TextBox>
                                            ...
                                            <div id="tblPrintIQ" runat="server">
                                                <div class="pgslry-head-div head" style="border-bottom: 1px solid #000; margin: 0px; float: left; width: 100%;">
                                                    ...
                                                    <div style="margin: 0px; padding: 0px; height: 110px; width: 80%; float: left;">
                                                       ...
                                                       <div style="margin: 7px 0px 0px 0px; padding: 0px; float: left; height: auto; text-align: center; vertical-align: middle; font-size: 13px; width: 100%;">
                                                                    <span style="font-size: 14px; font-weight: bold;">Ledger <asp:Label ID="lbl_class22" runat="server"></asp:Label></span>
                                                    ...
                                                    <table id="datatable1" data-page-length='100000' class="table table-striped table-bordered dataTable" role="grid" aria-describedby="example2_info">
                                                        <thead>
                                                            <tr>
                                                                <th colspan="5" style="text-align: left">
                                                                    <span>Ledger:</span><asp:Label ID="txt_ledger_name" runat="server" Text="Ledger Name"></asp:Label>
                                                                </th>
                                                            ...
                                                            <asp:Repeater ID="grd_view" runat="server">
                                                                <ItemTemplate>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <asp:Label ID="lbl_Account_Name" runat="server" Text='<%#Bind("Account_Name")%>'></asp:Label>(<asp:Label ID="lbl_Account_id" runat="server" Text='<%#Bind("Account_id")%>'></asp:Label>)
                                                                        </td>
                                                        ...
                                                        <tfoot >
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <b><asp:Label ID="txt_ob_debit" runat="server"></asp:Label></b>
                                                                </td>
                                                                <td>
                                                                     <b><asp:Label ID="txt_ob_credit" runat="server"></asp:Label></b>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td colspan="6"></td>
                                                                ...
                                                                <td>
                                                                   <b> <asp:Label ID="txt_total_debit" runat="server"></asp:Label></b>
                                                                </td>
                                                                <td>
                                                                   <b> <asp:Label ID="txt_total_credit" runat="server"></asp:Label></b>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-top: 1px solid #000; font-weight: bold;">
                                                                <td colspan="6"></td>
                                                                <td><b>Closing Balance : </b>
                                            </td>
                                                                <td>
                                                                    <b><asp:Label ID="txt_cb_debit" runat="server"></asp:Label></b>
                                                                </td>
                                                                <td>
                                                                    <b><asp:Label ID="txt_cb_credit" runat="server"></asp:Label></b>
                                                                </td>
                                                            </tr>
                                                        </tfoot>
    ...
    <script type="text/javascript">
        ...
        function searching_by_ledger_name() {
            $("#<%=txt_account_name.ClientID%>").autocomplete({

                source: function (request, response) {
                    $.ajax({
                        url: 'view_ledger.aspx/searching_by_ledger_name',
                        data: "{ 'Ledgername': '" + request.term + "'}",
                        dataType: "json",
                        type: "POST",
