<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="Update_Student_information.aspx.cs" Inherits="school_web.Admin.Update_Student_information" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">Update Student Details
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xl-12">
                    <asp:Label ID="ltUsertop" runat="server" Style="font-weight: 500; font-size: 1rem;" class="mb-0 text-uppercase" Text="Upload Student Details"></asp:Label>
                    <hr />
                    <div class="card">
                        <div class="card-body">
                            <div class="p-4 border rounded">
                                <div class="row g-3 needs-validation" novalidate="">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <a href="doc/update_student_details_csv.csv" download="" style="margin: 5px 0px 0px 0px; float: left; font-weight: 500;">Download Excel Format</a>
                                        <br />
                                       
                                    </div>

                                    <div class="col-4">
                                        <asp:Button ID="btn_Submit" runat="server" Text="Upload" CssClass="btn btn-primary" ValidationGroup="a" OnClick="btn_Submit_Click1" Style="margin: 20px 0px 0px 0px; padding: 6px 10px;" />
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-xl-12">
                    <h6 class="mb-0 text-uppercase">Update Student Details</h6>
                    <hr />
                    <div class="card">
                        <div class="card-body">
