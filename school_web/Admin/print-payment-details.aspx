<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="print-payment-details.aspx.cs" Inherits="school_web.Admin.print_payment_details" %>
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Print Payment Details</li>
                        </ol>
                    </nav>
                </div>
            </div>
                                                    ...
                                                    <itemtemplate>
                                                        <tr id="trR" runat="server">
                                                            ...
                                                            <td style="text-align: left;">
                                                                ...
                                                                <a href="slip/payment-details.aspx?clssid=<%#Eval("Class_id")%>&ssionid=<%#Eval("Session_id")%>&ssionname=<%#Eval("session")%>&admNo=<%#Eval("admissionserialnumber")%>&section=<%#Eval("Section")%>" style="background-color: #f7f100; min-width: 30px; color: #000;"
