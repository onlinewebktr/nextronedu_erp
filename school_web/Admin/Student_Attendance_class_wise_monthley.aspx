<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="Student_Attendance_class_wise_monthley.aspx.cs" Inherits="school_web.Admin.Student_Attendance_class_wise_monthley" EnableEventValidation="false" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="page-wrapper">
        <div class="page-content">
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Class Wise Student Attendance</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <h6 class="mb-0 text-uppercase">Class Wise Student Attendance</h6>
                    <hr />
                    <div class="card">
                        <div class="card-body">
                                            ...
                                            <div class="find-dv">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-2">
                                                        ...
                                                        <asp:DropDownList ID="ddlyear" runat="server" class="form-control find-dv-txtbx"></asp:DropDownList>
                                                    </div>
                                                    <div class="col-sm-2">
                                                    ...
                                                    <div class="col-sm-3">
                                                        ...
                                                        <asp:LinkButton ID="print1" OnClientClick="return PrintPanel()" CssClass="print-btn" runat="server" Style="background-color: #009f25; border: 5px solid #009f25; cursor: pointer; float: none; display: inline-block; width: 32px; height: 31px; margin: 12px 0px 0px 13px;"
                            ...
                            <asp:Label ID="lbl_website" runat="server"></asp:Label>
                                                                ...
                                                                <div style=" display:none; margin: 7px 0px 0px 0px; padding: 0px; float: left; height: auto; text-align: center; vertical-align: middle; font-size: 13px; width: 100%;">
                                                                 ...
                                                                 <div style="margin: 7px 0px 0px 0px; padding: 0px; float: left; height: auto; text-align: center; vertical-align: middle; font-size: 13px; width: 100%;">
                                                                    Class & Section :<asp:Label ID="lbll_section_and_class" runat="server"></asp:Label>
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Count">
                                                                        <ItemTemplate>
                                                                            ...
                                                                            <asp:Label ID="lbl_Attendance_persent" runat="server"></asp:Label>
                                                                            <asp:Label ID="lbl_Attendance_leave" runat="server" Style="margin: 0px 6px 0px 0px 7px;"></asp:Label>
                                                                            <asp:Label ID="lbl_Attendance_absent" runat="server"></asp:Label>


                                                                                 <asp:Button ID="btn_select" runat="server" Text="Find" class="btn btn-primary find-dv-btn"  Style="margin: 0px 0px 0px 12px!Important;" OnClick="btn_select_Click" />
