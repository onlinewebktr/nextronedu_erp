<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="Hostel_additional_service_master.aspx.cs" Inherits="school_web.Admin.Hostel_additional_service_master" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Hostel Service Master
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="page-wrapper">
        <div class="page-content">
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Hostel Service Master</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-4">
                    <asp:Label ID="ltUsertop" runat="server" Style="font-weight: 500; font-size: 1rem;" class="mb-0 text-uppercase" Text="Add Hostel Other Service"></asp:Label>
                    <hr />
                    <div class="card">
                        <div class="card-body">
                            <div class="p-4 border rounded">
                                <div class="row g-3 needs-validation" novalidate="">
                                    <div class="col-md-12">
                                        <label for="validationCustom01" class="form-label">Service Name<sup>*</sup></label>
                                        <asp:TextBox ID="txt_service_name" runat="server" class="form-control"></asp:TextBox>
                                    </div>
                                    <div class="col-md-12">
                                        <label for="validationCustom01" class="form-label">Fees Amount(Per Month Applied)<sup>*</sup></label>
                ...
                <div class="col-xl-8">
                    <h6 class="mb-0 text-uppercase">Added Hostel Other Service</h6>
                    <hr />
                    <div class="card">
                        <div class="card-body">
                            ...
                            <asp:Label ID="lbl_website" runat="server"></asp:Label>
                                                            ...
                                                            <div style="margin: 7px 0px 0px 0px; padding: 0px; float: left; height: auto; text-align: center; vertical-align: middle; font-size: 13px; width: 100%;">
                                                                <span style="font-size: 14px; font-weight: bold;">Hostel Additional Service Master
                                                                ...
                                                                <asp:Repeater ID="rd_view" runat="server">
                                                                    <ItemTemplate>
                                                                        <tr>
                                                                            ...
                                                                            <td style="text-align: left;">
                                                                                <asp:Label ID="lbl_fees_amount" runat="server" Text='<%#Bind("Service_amount")%>'></asp:Label>
                                                                            </td>
                                                                            ...
                                                                            <td style="text-align: left;">
                                                                                ...
                                                                                <asp:Label ID="lbl_service_id" runat="server" Text='<%#Bind("Service_id")%>' Visible="false"></asp:Label>
                                                                            </td>
                                                                        </tr>
                                                                    </ItemTemplate>
                                                                </asp:Repeater>
