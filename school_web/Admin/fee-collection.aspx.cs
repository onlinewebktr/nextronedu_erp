    ...
    public partial class fee_collection : System.Web.UI.Page
    {
        ...
        private void find_details(string query)
        {
            ...
            else
            {
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    std_basic_infoS.Visible = true; findSection.Visible = false;
        ...
        private void find_admission_dues_fee()
        {
            ...
            else
            {
                ...
                feeTypelbl.InnerText = "Admission Fees";
                ...
                txt_payble_adm_ann_fee.Text = payble_after_disc.ToString();
        ...
        private void find_annual_dues_fee()
        {
            ...
            else
            {
                ...
                feeTypelbl.InnerText = "Annual Fees";
                ...
                txt_payble_adm_ann_fee.Text = totalpay.ToString();
                if (totalpay > 0)
                {
                    lbl_adission_monthly_dues_till_now.Visible = true;
                    chk_collect_adm_ann_fee.Visible = true;
        ...
        protected void chk_month_CheckedChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    DataTable dtf = PayrollMy.dataTable("select Month_selection,Is_fine_repeat from Firm_Details");
                ...
                if (btn_save_payment.Text == "Pay")
                {
                    ...
                    using (TransactionScope scope = new TransactionScope(TransactionScopeOption.RequiresNew, new TimeSpan(1, 0, 0)))
                    {
                        ...
                        if (My.toDouble(txttotalbill.Text) >= My.toDouble(txt_paid_amount.Text))
                        {
                            ...
                            {
                                if (txt_paid_adm_ann_fee_payment.Text == "")
                                { }
                                else
                                {
                                    if (ViewState["Transfer_Status"].ToString() == "New")
                                    ...
                                    payments.exeSql("insert into Month_yearly_payment_history(Unique_no,Monthly_slip_no,Yearly_slip_no,Payment_type,Admission_no,Created_date,Created_idate,Created_time,Created_by) values ('" + entry_id + "','" + slipno + "','" + ViewState["yearlYSLipNo"].ToString() + "','" + feeTypes + "','" + lbl_admission_no.Text + "','" + mycode.date() + "','" + mycode.idate() + "','" + mycode.time() + "','" + Session["Admin"].ToString() + "');", con);
                                    if (ddl_paymentmode.Text == "Cheque")
                                    {
                                        payments.exeSql("insert into Fee_payment_by_cheque_status(Session_id,Admission_no,Monthly_slip_no,Yearly_slip_no,Payment_type,Cheque_no,Bank_name,Cheque_date,Status,Created_by,Created_date,Created_time,Created_idate,Is_group_payment,Cheque_amount) values ('" + ViewState["sessionIDs"].ToString() + "','" + txt_admission_no.Text + "','" + slipno + "','" + ViewState["yearlYSLipNo"].ToString() + "','" + feeTypes + "','" + txt_trans_no.Text + "','" + ddl_bank.Text + "','" + txt_bank_date.Text + "','PENDING','" + ViewState["Userid"].ToString() + "','" + mycode.date() + "','" + mycode.time() + "','" + mycode.idate() + "','1','" + txt_final_amt.Text + "');", con);
                                    }
                                }
                            }
                            else
                            {
                                if (ddl_paymentmode.Text == "Cheque")
                                {
                                    payments.exeSql("insert into Fee_payment_by_cheque_status(Session_id,Admission_no,Monthly_slip_no,Yearly_slip_no,Payment_type,Cheque_no,Bank_name,Cheque_date,Status,Created_by,Created_date,Created_time,Created_idate,Is_group_payment,Cheque_amount) values ('" + ViewState["sessionIDs"].ToString() + "','" + txt_admission_no.Text + "','" + slipno + "','0','MonthlyFee','" + txt_trans_no.Text + "','" + ddl_bank.Text + "','" + txt_bank_date.Text + "','PENDING','" + ViewState["Userid"].ToString() + "','" + mycode.date() + "','" + mycode.time() + "','" + mycode.idate() + "','0','" + total_paid + "');", con);
                                }
                            }
                            #endregion
                    ...
                    if (flag == true)
                    {
                        ...
                        if (My.toDouble(txt_paid_amount.Text) > 0)
                        {
                            ...
                            try
                            {
                                ...
                                // "Dear " + lbl_name.Text + " you have paid monthly fee :- " + txt_paid_amount.Text + " date :- " + txt_payment_date.Text + " slip no.:-" + slipno;
                                if (vrls.Length > 0)
                                {
                        ...
                        if (chk_collect_adm_ann_fee.Checked == true)
                        {
                            ...
                            try
                            {
                                ...
                                /// "Dear " + lbl_name.Text + " you have paid admission fee :- " + txt_paid_adm_ann_fee_payment.Text + " date :- " + txt_paid_adm_ann_fee_payment.Text + " slip no.:-" + ViewState["yearlYSLipNo"].ToString();
                                ...
                                if (vrls.Length > 0)
                                {
                                    lst[0] = txt_paid_adm_ann_fee_payment.Text;
                                }
                                if (vrls.Length > 1)
                                {
                                    lst[1] = ViewState["yearlYSLipNo"].ToString();
                                }
                                if (vrls.Length > 2)
                                {
                                    lst[2] = txt_paid_adm_ann_fee_payment.Text;
                                }
                                if (vrls.Length > 3)
                                {
                            ...
                            try
                            {
                                if (My.toDouble(txt_paid_adm_ann_fee_payment.Text) > 0)
                                {
                                    string sub = "";
                                    string messge = "";
                                    if (ViewState["Transfer_Status"].ToString() == "New")
                                    {
                                        ...
                                        messge = message;/// "Dear " + lbl_name.Text + " you have paid admission fee :- " + txt_paid_adm_ann_fee_payment.Text + " date :- " + txt_paid_adm_ann_fee_payment.Text + " slip no.:-" + ViewState["yearlYSLipNo"].ToString();
                                    }
                                    else
                                    {
                                        sub = "Annual Fee Deposit";
                                        messge = message; //"Dear " + lbl_name.Text + " you have paid annual fee :- " + txt_paid_adm_ann_fee_payment.Text + " date :- " + txt_paid_adm_ann_fee_payment.Text + " slip no.:-" + ViewState["yearlYSLipNo"].ToString();
                                    }
                                    Dictionary<String, String> ss = new Dictionary<string, string>();
                                    ss["notification_id"] = Guid.NewGuid().ToString();
                                    ss["message"] = messge;
                        ...
                        if (confirmValue == "Yes")
                        {
                            if (feeTypes == "Admission" || feeTypes == "Annual")
                            {
                                Response.Redirect("slip/monthly-slip-with-yearly.aspx?admissionno=" + lbl_admission_no.Text + "&sessionid=" + ddlsessionad.SelectedValue + "&classid=" + ViewState["classid"].ToString() + "&Slip_no=" + entry_id, false);
                            }
                            else
                            {
                                Response.Redirect("slip/monthly-slip.aspx?admissionno=" + lbl_admission_no.Text + "&sessionid=" + ddlsessionad.SelectedValue + "&classid=" + ViewState["classid"].ToString() + "&Slip_no=" + slipno, false);
                            }
                        }
                        else
                        {
                            ...
                            {
                                Response.Redirect("fee-collection.aspx?adm=" + lbl_admission_no.Text, false);
        ...
        private void fine_calculation(string monthName, string from)
        {
            ...
            DataTable dty = PayrollMy.dataTable("select Fine_mode from globle_data where Fine_mode='2'");
            if (dty.Rows.Count != 0)
            {
                #region DayRanGEWise
                ...
                {
                    DataTable dtz = PayrollMy.dataTable("select top 1 * from Fine_master_day_range");
                    if (dtz.Rows.Count != 0)
                    {
                        ...
                        DataTable dt_fine = PayrollMy.dataTable("select top 1 * from Fine_master_day_range where No_of_day>" + totaldays + " order by No_of_day asc");
                        ...
                        {
                            DataTable dt_fines = PayrollMy.dataTable("select top 1 * from Fine_master_day_range order by No_of_day desc");
            ...
            else
            {
                ...
                DataTable dt = PayrollMy.dataTable("select * from Fine_master where Status='1' and Session_id='" + ViewState["sessionIDs"].ToString() + "'");
                if (dt.Rows.Count != 0)
                {
                    if (chk_latefineapplay.Checked != true)
                    {
                ...
                if (btn_submit_admission_fee.Text == "Pay Now")
                {
                    ...
                    if (My.toDouble(lbl_totaldues.Text) >= 0)
                    {
                        ...
                        if (flag == true)
                        {
                            ...
                            try
                            {
                                //"Dear " + lbl_name.Text + " you have paid annual fee :- " + txt_paid_amount_adm.Text + " date :- " + txt_date.Text + " slip no.:-" + slip_no;
                            ...
                            if (My.toDouble(txt_paid_amount_adm.Text) > 0)
                            {
                                ...
                                try
                                {
                                    ...
                                    {
                                        sub = "Admission Fee Deposit";
                                        messge = message; //"Dear " + lbl_name.Text + " you have paid admission fee :- " + txt_paid_amount_adm.Text + " date :- " + txt_date.Text + " slip no.:-" + slip_no;
                                    }
                                    else
                                    {
                                        sub = "Annual Fee Deposit";
                                        messge = message; //"Dear " + lbl_name.Text + " you have paid annual fee :- " + txt_paid_amount_adm.Text + " date :- " + txt_date.Text + " slip no.:-" + slip_no;
                                    }
                                    Dictionary<String, String> ss = new Dictionary<string, string>();
                                    ss["notification_id"] = Guid.NewGuid().ToString();
                                    ss["message"] = messge;
        ...
        private void make_admission_fee(SqlConnection con)
        {
            string parameter = "";
            string parameter_id = "";
            if (ViewState["Transfer_Status"].ToString() == "New")
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                admission_payment(slip_no, entry_id, ad_no, con);
                payments.send_data_to_user_log_history(ViewState["Userid"].ToString(), ViewState["Userid"].ToString() + " received " + type + " fee :-" + txt_paid_adm_ann_fee_payment.Text + " Adjust Amount" + hd_total_discount.Value + " rs,Slip No :- " + slip_no + " from " + lbl_studentname.Text + ", Admission No :-" + ad_no, con);
                //try
                //{
                //    string notice_type = "2"; string notice_type_name = "Admission Fee Deposite";
                //    payments.send_success_notice_fee(lbl_studentname.Text, lbl_class.Text, ViewState["Section"].ToString(), ViewState["rollnumber"].ToString(), lbl_admissionno.Text, txt_paid_adm_ann_fee_payment.Text, notice_type, notice_type_name, ViewState["sessionid"].ToString(), con);
                //}
                //catch (Exception ex)
                //{
                //}
        ...
        private void admission_payment(string slip_no, string entry_id, string ad_no, SqlConnection con)
        {
            string Uid = slip_no;
            string Tag = txt_paid_adm_ann_fee_payment.Text;
            string parameter = "";
            if (type == "Admission")
            {
                parameter = ViewState["hostaltaken"].ToString().ToUpper() == "NO" ? "AdmissionFee" : "HostelAdmissionFee";
            ...
            send_data_in_student_payment_history_admission(type, slip_no, entry_id, ad_no, parameter, con);
            send_data_to_school_ledger_admission(slip_no, entry_id, con);
            create_admission_annual_dues_admission(parameter, con);
            send_data_in_feetypewise_collection_admission(slip_no, entry_id, parameter, con);
            if (type == "Admission")
            {
        ...
        private void send_data_in_feetypewise_collection_admission(string slip_no, string entry_id, string parameter, SqlConnection con)
        {
            string class_id = ViewState["classid"].ToString();
            double paid_amount = My.toDouble(txt_paid_adm_ann_fee_payment.Text);
            SqlDataAdapter ad = new SqlDataAdapter(" select * from Typewise_fee_collection  where admission_no='" + lbl_admissionno.Text + "' and session='" + ViewState["session"].ToString() + "' and parameter='" + parameter + "'", con);
            DataSet ds = new DataSet();
            ad.Fill(ds, "Typewise_fee_collection");
            DataTable tdt = ds.Tables[0];
        ...
        private void create_admission_annual_dues_admission(string parameter, SqlConnection con)
        {
            if (payments.dataTable("select session,feetype,payable,paid,dues,status,content_id from dbo.[Typewise_fee_collection] WHERE admission_no='" + lbl_admissionno.Text + "' and parameter='" + parameter + "' and session='" + ViewState["session"].ToString() + "'", con).Rows.Count == 0)
            {
                string query = "";
        ...
        private void send_data_to_school_ledger_admission(string transcation, string entry_id, SqlConnection con)
        {
            SqlDataAdapter ad = new SqlDataAdapter("select * from SchoolLedger ", con);
            DataSet ds = new DataSet();
            ad.Fill(ds, "SchoolLedger");
            ...
            DataRow dr = dt.NewRow();
            dr["Particulars"] = type + " Fee Collection";
            dr["Discription"] = type + " fee for " + lbl_studentname.Text + " Adm.No:-" + lbl_admissionno.Text + " Total Bill :-" + txt_payble_adm_ann_fee.Text + " Paid Amount :-  " + txt_paid_adm_ann_fee_payment.Text;
            dr["AllInput"] = My.toDouble(txt_paid_adm_ann_fee_payment.Text).ToString("0.00");
            dr["AllOutput"] = "0";
            dr["IDate"] = Convert.ToDateTime(txt_payment_date.Text).ToString("yyyyMMdd");
            dr["Date"] = txt_payment_date.Text;
            dr["TransactionId"] = transcation;
        ...
        private void send_data_in_student_payment_history_admission(string type, string slip_no, string entry_id, string ad_no, string parameter_New, SqlConnection con)
        {
            SqlCommand cmd;
            string query = "insert into Student_Payment_History(Addmission_no,Session,Date,Idate,Description,Entry_id,Slip_no,Amount,Type,mode,discount,Discoun_in_School,Discoun_in_Hostel,Discoun_in_Transport,fine,is_ofline_sync,Is_online_sync,is_update_in_online,Previous_admission_no,App_Transection_id,time,user_id,Acamedic_Semester_Id,Branch,Class_id,User_Slip_no,Pay_mode_transaction_no,Remarks,Transection_in,parameter_New,Bank_name,Bank_date) values (@Addmission_no,@Session,@Date,@Idate,@Description,@Entry_id,@Slip_no,@Amount,@Type,@mode,@discount,@Discoun_in_School,@Discoun_in_Hostel,@Discoun_in_Transport,@fine,@is_ofline_sync,@Is_online_sync,@is_update_in_online,@Previous_admission_no,@App_Transection_id,@time,@user_id,@Acamedic_Semester_Id,@Branch,@Class_id,@User_Slip_no,@Pay_mode_transaction_no,@Remarks,@Transection_in,@parameter_New,@Bank_name,@Bank_date)";
            cmd = new SqlCommand(query);
            ...
            cmd.Parameters.AddWithValue("@Description", type + " fee collection for " + lbl_studentname.Text + " Paid Amount : " + txt_paid_adm_ann_fee_payment.Text + " /-");
            cmd.Parameters.AddWithValue("@Entry_id", entry_id);
            cmd.Parameters.AddWithValue("@Slip_no", slip_no);
            cmd.Parameters.AddWithValue("@Amount", My.toDouble(txt_paid_adm_ann_fee_payment.Text).ToString("0.00"));
            cmd.Parameters.AddWithValue("@Type", type);
            ...
            if (payments.InsertUpdateData(cmd, con))
            {
                ...
                DataRow dr = dt.NewRow();
                dr["Particulars"] = type + " Money Receipt";
                dr["Discription"] = type + " Money Receipt " + lbl_studentname.Text + " Adm.No:-" + lbl_admissionno.Text + " Paid Amount :-  " + My.toDouble(txt_paid_adm_ann_fee_payment.Text).ToString("0.00");
                dr["AllInput"] = My.toDouble(txt_paid_adm_ann_fee_payment.Text).ToString("0.00");
                dr["AllOutput"] = "0";
                dr["IDate"] = Convert.ToDateTime(txt_payment_date.Text).ToString("yyyyMMdd");
                dr["Date"] = txt_payment_date.Text;
        ...
        private void make_annual_fee(SqlConnection con)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                slip_no = payments.invoice_readmission("slip_no", con);
                ViewState["yearlYSLipNo"] = slip_no;
                annual_payment(slip_no, entry_id, ad_no, con);
                payments.send_data_to_user_log_history(ViewState["Userid"].ToString(), ViewState["Userid"].ToString() + " received " + type + " fee :-" + txt_paid_adm_ann_fee_payment.Text + " Adjust Amount" + hd_total_discount.Value + " rs,Slip No :- " + slip_no + " from " + lbl_studentname.Text + ", Admission No :-" + ad_no, con);
                //try
                //{
        ...
        private void annual_payment(string slip_no, string entry_id, string ad_no, SqlConnection con)
        {
            string Uid = slip_no;
            string Tag = txt_paid_adm_ann_fee_payment.Text;
            string parameter = "";
            parameter = ViewState["hostaltaken"].ToString().ToUpper() == "NO" ? "AnnualFee" : "HostelAnnualFee";
            send_data_in_student_payment_history_annual(type, slip_no, entry_id, ad_no, parameter, con);
            send_data_to_school_ledger_annual(slip_no, entry_id, con);
            create_admission_annual_dues_annual(parameter, con);
            send_data_in_feetypewise_collection_annual(slip_no, entry_id, parameter, con);
        ...
        private void send_data_in_feetypewise_collection_annual(string slip_no, string entry_id, string parameter, SqlConnection con)
        {
            string class_id = ViewState["classid"].ToString();
            double paid_amount = My.toDouble(txt_paid_adm_ann_fee_payment.Text);
        ...
        private void send_data_to_school_ledger_annual(string transcation, string entry_id, SqlConnection con)
        {
            SqlDataAdapter ad = new SqlDataAdapter("select * from SchoolLedger ", con);
            DataSet ds = new DataSet();
            ad.Fill(ds, "SchoolLedger");
        ...
        private void send_data_in_student_payment_history_annual(string type, string slip_no, string entry_id, string ad_no, string parameter_New, SqlConnection con)
        {
            SqlCommand cmd;
            string query = "insert into Student_Payment_History(Addmission_no,Session,Date,Idate,Description,Entry_id,Slip_no,Amount,Type,mode,discount,Discoun_in_School,Discoun_in_Hostel,Discoun_in_Transport,fine,is_ofline_sync,Is_online_sync,is_update_in_online,Previous_admission_no,App_Transection_id,time,user_id,Acamedic_Semester_Id,Branch,Class_id,User_Slip_no,Pay_mode_transaction_no,Remarks,Transection_in,parameter_New,Bank_name,Bank_date) values (@Addmission_no,@Session,@Date,@Idate,@Description,@Entry_id,@Slip_no,@Amount,@Type,@mode,@discount,@Discoun_in_School,@Discoun_in_Hostel,@Discoun_in_Transport,@fine,@is_ofline_sync,@Is_online_sync,@is_update_in_online,@Previous_admission_no,@App_Transection_id,@time,@user_id,@Acamedic_Semester_Id,@Branch,@Class_id,@User_Slip_no,@Pay_mode_transaction_no,@Remarks,@Transection_in,@parameter_New,@Bank_name,@Bank_date)";
            cmd = new SqlCommand(query);
                ...
                if (ViewState["Is_add_Discount"].ToString() == "1")
                {
                    ...
                    if (chk_is_admission_disc.Checked == true)
                    {
                        ...
                        if (ViewState["issubmit"].ToString() == "1")
                        {
                            ...
                            Response.Redirect("fee-collection.aspx?adm=" + txt_admission_no.Text, false);
                        }
                    }
                    else
                    {
        ...
        protected void lnkDelExtFee_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                log_hostory.delete_log(lbl_session_id.Text, ViewState["classid"].ToString(), lbl_admission_no.Text, "DeleteExtraFeeHead", desc, "fee-collection.aspx", ViewState["Userid"].ToString());
            ...
            try
            {
                if (ViewState["Is_Edit_Bus"].ToString() == "1")
                {
                    ...
                    else
                    {
                        ...
                        Response.Redirect("fee-collection.aspx?adm=" + ViewState["Admission_no"].ToString(), false);
                    }
                }
                else
                {
            ...
            try
            {
                if (ViewState["Is_delete_Bus"].ToString() == "1")
                {
                    ...
                    if (My.InsertUpdateData(cmd1))
                    {
                        ...
                        log_hostory.delete_log(ViewState["sessionIDs"].ToString(), ViewState["classid"].ToString(), lbl_admission_no.Text, "RemoveTransport", desc, "fee-collection.aspx", ViewState["Userid"].ToString());
        ...
        protected void btn_remove_hostel_Click(object sender, EventArgs e)
        {
            try
            {
                if (ViewState["Is_delete_Hostel"].ToString() == "1")
                {
                    ...
                    log_hostory.delete_log(ViewState["sessionIDs"].ToString(), ViewState["classid"].ToString(), lbl_admission_no.Text, "RemoveHostel", desc, "fee-collection.aspx", ViewState["Userid"].ToString());
