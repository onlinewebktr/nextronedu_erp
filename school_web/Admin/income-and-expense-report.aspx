<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="income-and-expense-report.aspx.cs" Inherits="school_web.Admin.income_and_expense_report" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                                            ...
                                            <div class="prnt-dv-wpr printborder hidden" id="grdsdatA">
                                                <div class="grd-wpr-new">
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <span class="incomeLeft txtcntr" data-ng-repeat="x in reportIncome">{{$index+1}}</span>
                                                            </td>
                                                            <td>
                                                                <span class="incomeLeft" data-ng-repeat="x in reportIncome">{{x.Content}}</span>
                                                            </td>
                                                            <td>
                                                                <span class="incomeLeft txtright" data-ng-repeat="x in reportIncome">{{x.Amounts}}</span>
                                                            </td> 
                                                            <td>
    ...
    <script type="text/javascript">
        ...
        app.controller('RpCardAppCtrl', function ($scope, $http) {
            ...
            // Fetch income data
            $http.get("webServices/account/incomeExpense.asmx/fetch_report_income", { params: { "FromDate": Fromdates, "ToDate": Todates } })
            ...
            // Fetch expense data
            $http.get("webServices/account/incomeExpense.asmx/fetch_report_expense", { params: { "FromDate": Fromdates, "ToDate": Todates } })
                .then(function (response) {
            ...
            function calculateDifference() {
                ...
                // $scope.incomeExpenseDifference = totalIncome - totalExpense; // Store the difference in scope
