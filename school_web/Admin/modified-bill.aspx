<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="modified-bill.aspx.cs" Inherits="school_web.Admin.modified_bill" EnableEventValidation="false" ValidateRequest="true" %>
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><a href="home1.aspx" class="backlnk-css"><i class="bx bx-arrow-back"></i>Reports</a></div>
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            <li class="breadcrumb-item"><a href="Home.aspx"><i class="bx bx-home-alt"></i></a>
                            </li>
                            <li class="breadcrumb-item active" aria-current="page">Modified Receipt</li>
                        </ol>
                    </nav>
                </div>
            </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="find-dv">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-2">
                                                    <label for="validationCustom01" class="find-dv-lbl">Choose Date</label>
                                        ...
                                        <div id="tblPrintIQ" runat="server">
                                            <div class="head-printdv" style="border-bottom: 1px solid #000; margin: 0px; float: left; width: 100%;">
                                                ...
                                                <div style="margin: 0px; padding: 0px; height: 110px; width: 80%; float: left;">
                                                    ...
                                                    <div style="margin: 7px 0px 0px 0px; padding: 0px; float: left; height: auto; text-align: center; vertical-align: middle; font-size: 13px; width: 100%;">
                                                        <span style="font-size: 14px; font-weight: bold;">Modified Receipt for Date -<asp:Label ID="lbl_date_period" runat="server"></asp:Label></span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="grd-wpr">
                                                <div class="col-sm-12">
                                                                ...
                                                                <asp:Repeater ID="rd_view" runat="server">
                                                                    <ItemTemplate>
                                                                        <tr>
                                                                            ...
                                                                            <td style="text-align: left;">
                                                                                <asp:Label ID="Label5" runat="server" Text='<%#Bind("Created_date")%>'></asp:Label>
                                                                            </td>
                                                                            <td style="text-align: left;">
                                                                            ...
                                                                            <td style="text-align: left;">
                                                                                <asp:Label ID="Label4" runat="server" Text='<%#Bind("ModiBy")%>'></asp:Label>
                                                                            </td>
                                                                            <td style="text-align: left;">
                                                    ...
                                                    <%--<div class="paid-cat-div">
                                                        <ul class="mode-ul">
                                                            <asp:Repeater ID="rp_mode" runat="server">
                                                                <ItemTemplate>
                                                                    <li><i><%#Eval("mode") %> </i>: <span><%#Eval("Paid_amt") %></span></li>
                                                                </ItemTemplate>
                                                            </asp:Repeater>
                                                        </ul>
                                                    </div>--%>
