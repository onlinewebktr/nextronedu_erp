<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="location-wise-student.aspx.cs" Inherits="school_web.Admin.location_wise_student" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#<%=txt_area.ClientID%>").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        url: 'location-wise-student.aspx/GetRooPath',
                        data: "{ 'PathRooT': '" + request.term + "',Session_id:'" + sessionid + "',class_id:'" + class_id + "'}",
                        dataType: "json",
                        type: "POST",
        ...
        <div class="page-content">
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Area-Wise Student List</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            <asp:Label ID="ltUsertop" runat="server" Style="font-weight: 500; font-size: 1rem;" class="mb-0 text-uppercase" Text="Area-Wise Student List"></asp:Label>
                            <hr />
                                    ...
                                    <div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap5 hdrmodify">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-2">
                                                ...
                                                <asp:DropDownList ID="ddlclass" runat="server" class="form-control find-dv-txtbx" AutoPostBack="true"></asp:DropDownList>
                                            </div>
                                            <div class="col-sm-4">
                                                <label for="validationCustom01" class="find-dv-lbl">Area</label>
                                                <asp:TextBox ID="txt_area" runat="server" class="form-control find-dv-txtbx"></asp:TextBox>
                                            </div>
                                            <div class="col-sm-1">
                                                                        ...
                                                                        <asp:Repeater ID="rd_view" runat="server">
                                                                            <ItemTemplate>
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:Label ID="Label3" runat="server" Text='<%#Bind("session")%>'></asp:Label>
                                                                                    </td>
                                                                                    <td>
                                                                                        <asp:Label ID="Label4" runat="server" Text='<%#Bind("admissionserialnumber")%>'></asp:Label>
                                                                                    </td>
                                                                                    <td>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:Label ID="Label7" runat="server" Text='<%#Bind("rollnumber")%>'></asp:Label>
                                                                                    </td>
                                                                                    <td>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:Label ID="Label10" runat="server" Text='<%#Bind("mothername")%>'></asp:Label>
                                                                                    </td>
                                                                                    <td>
                                                                                        <asp:Label ID="Label11" runat="server" Text='<%#Bind("mobilenumber")%>'></asp:Label>
                                                                                    </td>
                                                                                    <td>
                                                                                        <asp:Label ID="Label12" runat="server" Text='<%#Bind("careof")%>'></asp:Label>
                                                                                    </td>
                                                                                </tr>
                                                                            </ItemTemplate>
                                                                        </asp:Repeater>
