...
{
    public partial class fee_collection_monthly_wise : System.Web.UI.Page
    {
        My mycode = new My();
            ...
            try
            {
                if (!IsPostBack)
                {
                    ...
                    else
                    {
                        ...
                        Session["SlipBkSn"] = "MN1";
                        ViewState["total_split_amount"] = "0";
                        Session["reprintadmission"] = "2";
            ...
            else
            {
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    else
                    {
                        if (My.toDouble(mnthly_check_disc.Rows[0]["Total_disc"].ToString()) > 0)
                        {
                            isDiscountGiven = 1; get_month_discount();
                        }
                    }
        ...
        private void get_month_discount()
        {
            ...
            foreach (DataRow drm in dtm.Rows)
            {
                ...
                //ViewState["parameter"] = ViewState["parameter"].ToString().ToUpper() == "YES" ? "HostelMonthlyFee" : "MonthlyFee";
        ...
        private void find_admission_dues_fee()
        {
            ...
            if (dt.Rows.Count == 0)
            {
                btn_admission_fee.Visible = false;
            }
            else
            {
                btn_admission_fee.Visible = false;
                ...
                btn_admission_fee.Text = "Admission Fees : " + payble_after_disc.ToString("0.00");
                ViewState["Admission_Annual_Amount"] = payble_after_disc.ToString();
                if (payble_after_disc > 0)
                {
                    btn_admission_fee.Visible = true;
        ...
        private void find_annual_dues_fee()
        {
            ...
            else
            {
                ...
                btn_admission_fee.Text = "Annual Fees : " + totalpay.ToString("0.00");
        ...
        {
            string ReturN = "0";
            DataTable dt = mycode.FillData("select Dues_Amount from Previous_Year_Dues  where Session_id='" + ViewState["sessionIDs"].ToString() + "' and AdmissionNumber='" + txt_admission_no.Text + "'  and Class_id='" + ViewState["classid"].ToString() + "' and Status='Unpaid'");
            if (dt.Rows.Count > 0)
            {
        ...
        protected void rl_ledger_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                else if (lbl_fee_type.Text == "Monthly")
                {
                ...
                else if (lbl_fee_type.Text == "FormSale")
                {
                    printLnk.HRef = "slip/Form_Sale_Slip.aspx?transaction=" + lbl_entry_id.Text;
                }
                else
                {
                    printLnk.HRef = "slip/Other_fees_slip.aspx?receiptid=" + lbl_Receipt_No.Text;
                }
        ...
        protected void chk_month_CheckedChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                //======== Auto date of 10 of selected month
                //string month_name = lbl_Monthc.Text;
                //int mnth_idss = My.tomonth_number(lbl_Monthc.Text);
                ...
                //int session_s_year = My.toint(session_frst_year);
                //int s_year = My.toint(session_frst_year);
                //int pay_month = My.toint(mnth_idss);
                //s_year = My.check_start_months(pay_month, s_year);


                //txt_payment_date.Text = "10/" + month_id_in_two_dgts + "/" + s_year;
                //========
                ...
                else
                {
                            ...
                            if (My.toint(ViewState["repeatMonthPoscc"].ToString()) >= My.toint(ViewState["repeatMonthPos"].ToString()))
                            {
                                ...
                                if (chk.Checked == true)
                                {
                                    ...
                                    if (ViewState["Dues"].ToString() == "Yes")
                                    {
                                        if (ViewState["DuesCalculate"].ToString() == "No")
                                        {
                                            //if (lbl_Month.Text == My.get_next_month(lbl_MonthFine.Text))
                                            //{
                                            if (lbl_Month.Text == lbl_MonthFine.Text)
                                            {
                                                ViewState["DuesCalculate"] = "Yes";
                    ...
                    else
                    {
                        ...
                        if (chk.Checked == true)
                        {
                            ...
                            chk.Enabled = false;
                            string month = lbl_Month.Text;
                            //find_fine(txt_payment_date.Text, month);
                            bind_monthly_fee();
                            ViewState["MnthName"] = lbl_Month.Text;
                            fine_calculation(lbl_Month.Text, "1");
                            //}

                            //else if (My.toBool(monthSS.Rows[(GridView2.SelectedIndex) - 1]["value"]))
                            //{
                            //    dtDatas.Rows[GridView2.SelectedIndex]["value"] = true; 
                            //    DataRow dr = ((DataRowView)GridView2.SelectedItem).Row;
                            ...
                            //{ 
                            //    chk.Checked = false;
                            //    Alertme("You can't skip any Month, Please select top to bottom...", "warning");
                            //}
                        }
                        else
                        {
        ...
        private void bind_ttl_fee()
        {
            ...
            if (0 >= My.toDouble(txttotalbill.Text))
            {
        ...
        private void find_fine(string date, string month)
        {
            try
            {
                ...
                days1 += 1;
                DataTable dt = My.dataTable("select top 1 * from dbo.[Fine_Setup] where Session='" + ddlsession.Text + "' and Status='Active' and Date_Limitation<='" + days1 + "'");
                ...
                if (btn_save_payment.Text == "Pay")
                {
                    ...
                    if (My.toDouble(txttotalbill.Text) >= My.toDouble(txt_paid_amount.Text))
                    {
                        ...
                        using (TransactionScope scope = new TransactionScope(TransactionScopeOption.RequiresNew, new TimeSpan(1, 0, 0)))
                        {
                            ...
                            string total_paid = txt_paid_amount.Text;
                            if (chk_delete_slip.Checked == true)
                            {
                                if (txt_old_slip_no.Text == "")
                                {
                                    Alertme("Please enter deleted slip no.", "warning");
                                    return;
                                }
                                else
                                {
                                    slipno = txt_old_slip_no.Text.Trim();
                                    string chek_bill_no = payments.get_old_bill_no(slipno, ViewState["Branchid"].ToString(), con);
                                    if (chek_bill_no != "Yes")
                                    {
                            ...
                            calculate_dues_for_new_month(slipno, con);
                            ...
                            if (ddl_paymentmode.Text == "Cheque")
                            {
                                payments.exeSql("insert into Fee_payment_by_cheque_status(Session_id,Admission_no,Monthly_slip_no,Yearly_slip_no,Payment_type,Cheque_no,Bank_name,Cheque_date,Status,Created_by,Created_date,Created_time,Created_idate,Is_group_payment,Cheque_amount) values ('" + ddlsessionad.SelectedValue + "','" + lbl_admission_no.Text + "','" + slipno + "','0','MonthlyFee','" + txt_trans_no.Text + "','" + ddl_bank.Text + "','" + txt_bank_date.Text + "','PENDING','" + ViewState["Userid"].ToString() + "','" + mycode.date() + "','" + mycode.time() + "','" + mycode.idate() + "','0','" + total_paid + "');", con);
                            }
                            #endregion
                        ...
                        if (flag == true)
                        {
                            ...
                            try
                            {
                                ...
                                string messge = message;//"Dear " + lbl_name.Text + " you have paid monthly fee :- " + txt_paid_amount.Text + " date :- " + txt_payment_date.Text + " slip no.:-" + slipno;
                            ...
                            if (confirmValue == "Yes")
                            {
                                ...
                                Response.Redirect(page + "?admissionno=" + lbl_admission_no.Text + "&sessionid=" + ddlsessionad.SelectedValue + "&classid=" + ViewState["classid"].ToString() + "&Slip_no=" + slipno, false);
                            }
                            else
                            {
                                empty_form();
                                ...
                                {
                                    Response.Redirect("fee-collection-monthly-wise.aspx?adm=" + lbl_admission_no.Text, false);
        ...
        void send_data_in_student_payment_history(string type, string slip_no, string entry_id, List<string> month_lst, string total_paid, SqlConnection con)
        {
            ...
            submit_transection_in_typewise(txt_admission_no.Text, ViewState["session"].ToString(), My.toDouble(txtfineamount.Text), txt_payment_date.Text, My.DateConvertToIdate(txt_payment_date.Text).ToString(), My.toDouble(txt_paid_amount.Text), slip_no, entry_id, sdt.Rows[0]["class"].ToString(), sdt.Rows[0]["Section"].ToString(), sdt.Rows[0]["Class_id"].ToString(), sdt.Rows[0]["hosteltaken"].ToString(), sdt.Rows[0]["Hostel_id"].ToString(), "", app_payment_type, con);
            #endregion
        }
        ...
        {
            if (ViewState["OnPayDateChange"].ToString() == "1")
            {
        ...
        {
            DataTable dt = mycode.FillData("select *,(select top 1 session_id from session_details where Session=Student_Payment_History.Session) as session_id from Student_Payment_History  where Session='" + ViewState["session"].ToString() + "' and Addmission_no='" + lbl_admissionno.Text + "' and Type='Admission'   ORDER BY id ASC");
            if (dt.Rows.Count == 0)
            {
                        ...
                        if (flag == true)
                        {
                            ...
                            if (My.toDouble(txt_paid_amount_adm.Text) > 0)
                            {
                                ...
                                try
                                {
                                    ...
                                    if (vrls.Length > 0)
                                    {
                                        lst[0] = txt_paid_amount_adm.Text;
                                    }
                                    if (vrls.Length > 1)
                                    {
                                        lst[1] = slip_no;
                ...
                if (ViewState["Is_add_Discount"].ToString() == "1")
                {
                    ...
                    if (chk_is_admission_disc.Checked == true)
                    {
                        ...
                        if (ViewState["issubmit"].ToString() == "1")
                        {
                            ...
                            Response.Redirect("fee-collection-monthly-wise.aspx?adm=" + txt_admission_no.Text, false);
                        }
                    }
                    else
                    {
                        ...
                        if (lbl_content_id.Text == "1002") // FOR TRANSPORT
                        {
                            if (My.toDouble(txt_disc_fee.Text) > 0)
                            {
                                ...
                                if (dtF.Rows.Count == 0)
                                {
                                    ...
                                    SqlDataAdapter ad = new SqlDataAdapter("select * from Discount_Master_for_bus where Bus_path=" + ViewState["TransportPath_id"].ToString() + " and session_id='" + ViewState["sessionIDs"].ToString() + "' and month='" + lbl_month_name.Text + "' and admission_no='" + txt_admission_no.Text + "' and Class_id='" + ViewState["class_id"].ToString() + "'", My.conn);
                                    DataSet ds = new DataSet();
        ...
        {
            if (mycode.IsUserExist("select Month, Position from Month_Index where Month in (select month from Typewise_fee_collection where admission_no = '" + admission_no + "' and(parameter = 'MonthlyFee'  or parameter = 'HostelMonthlyFee') and session = '" + session_name + "' and class_id = '" + class_id + "' and status = 'Dues') or Month not in (select month from Typewise_fee_collection where admission_no = '" + admission_no + "' and(parameter = 'MonthlyFee'  or parameter = 'HostelMonthlyFee') and session = '" + session_name + "' and class_id = '" + class_id + "' and status = 'Paid') order by Position asc"))
            {
                ExtraHeadBtn.Visible = false;
            }
            else
            {
                ...
                string qryExtHeadMonth = "select Month, Position from Month_Index where Month in (select month from Typewise_fee_collection where admission_no = '" + admission_no + "' and(parameter = 'MonthlyFee'  or parameter = 'HostelMonthlyFee') and session = '" + session_name + "' and class_id = '" + class_id + "' and status = 'Dues') or Month not in (select month from Typewise_fee_collection where admission_no = '" + admission_no + "' and(parameter = 'MonthlyFee'  or parameter = 'HostelMonthlyFee') and session = '" + session_name + "' and class_id = '" + class_id + "' and status = 'Paid') order by Position asc";
                if (ViewState["Is_quarterwise_payment"].ToString() == "1")
                {
        ...
        private void save_extra_head_for_fee()
        {
            ...
            if (mycode.IsUserExist(qryForCheck))
            {
                ...
                if (My.InsertUpdateData(cmd))
                {
                    ...
                    string qryChkTypewise = "select Id from Typewise_fee_collection where admission_no='" + hd_admission_no.Value + "' and session='" + ViewState["session"].ToString() + "' and status='Dues' and (parameter='AdmissionFee' or parameter='HostelAdmissionFee' or parameter='AnnualFee' or parameter='HostelAnnualFee')";
                    if (ddl_extra_head_for.SelectedValue == "1")
                    {
                        ...
                        content_id = "1001";
                        group_id = "3";
                        qryChkTypewise = "select Id from Typewise_fee_collection where admission_no='" + hd_admission_no.Value + "' and session='" + ViewState["session"].ToString() + "' and month='" + ddl_month.SelectedItem.Text + "' and status='Dues' and (parameter='MonthlyFee'  or parameter='HostelMonthlyFee')";
                    }
        ...
        protected void lnkDelExtFee_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                log_hostory.delete_log(lbl_session_id.Text, ViewState["classid"].ToString(), lbl_admission_no.Text, "DeleteExtraFeeHead", desc, "fee-collection-monthly-wise.aspx", ViewState["Userid"].ToString());
        ...
        protected void btn_Submit_Click(object sender, EventArgs e)
        {
            if (ViewState["Is_Edit_Bus"].ToString() == "1")
            {
                ...
                else
                {
                    ...
                    Response.Redirect("fee-collection-monthly-wise.aspx?adm=" + ViewState["Admission_no"].ToString(), false);
                }
            }
            else
            {
            ...
            try
            {
                if (ViewState["Is_delete_Bus"].ToString() == "1")
                {
                    ...
                    if (My.InsertUpdateData(cmd1))
                    {
                        ...
                        log_hostory.delete_log(ViewState["sessionIDs"].ToString(), ViewState["classid"].ToString(), lbl_admission_no.Text, "RemoveTransport", desc, "fee-collection-monthly-wise.aspx", ViewState["Userid"].ToString());
        ...
        protected void btn_remove_hostel_Click(object sender, EventArgs e)
        {
            try
            {
                if (ViewState["Is_delete_Hostel"].ToString() == "1")
                {
                    ...
                    log_hostory.delete_log(ViewState["sessionIDs"].ToString(), ViewState["classid"].ToString(), lbl_admission_no.Text, "RemoveHostel", desc, "fee-collection-monthly-wise.aspx", ViewState["Userid"].ToString());
