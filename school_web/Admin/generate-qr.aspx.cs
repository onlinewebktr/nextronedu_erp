...
{
    public partial class generate_qr : System.Web.UI.Page
    {
            ...
            try
            {
                if (!IsPostBack)
                {
                    ...
                    else
                    {
                        ...
                        string pagename_current = "generate-qr.aspx";
                    ...
                    else
                    {
                        ...
                        if (k == growcount)
                        {
                            if (lbl_is_check.Text == "1")
                            {
                                ...
                                {
                                    Response.Redirect("slip/student-qr.aspx?admNo=0&ssion_id=" + ddlsession.SelectedValue + "&clss_id=" + ddlclass.SelectedValue + "&Branch_id=" + ViewState["Branchid"].ToString() + "&Section=" + ddl_section.SelectedItem.Text + "&Type=BULK", false);
                                }
                                else
                                {
                                    Response.Redirect("slip/student-qr.aspx?admNo=0&ssion_id=" + ddlsession.SelectedValue + "&clss_id=" + ddlclass.SelectedValue + "&Branch_id=" + ViewState["Branchid"].ToString() + "&Section=" + ddl_section.SelectedItem.Text + "&Type=BULK", false);
                        ...
                        else
                        {
                            if (lbl_is_check.Text == "1")
                            {
                                if (chk_is_ckeck.Checked == true)
                                {
                                    string reslink = "slip/student-qr.aspx?Type=CHECK&ssion_id=" + ddlsession.SelectedValue + "&clss_id=" + ddlclass.SelectedValue + "&Branch_id=" + ViewState["Branchid"].ToString() + "&admNo=" + adm_ids;
