...
{
    public partial class Report_Total_Admission_Fee_Collection_Today : System.Web.UI.Page
    {
        My mycode = new My();
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                My.submitException(ex, "Report_Total_Admission_Fee_Collection_Today");
            }
        }
        ...
        private void bind_grd_view_data(string query)
        {
            ...
            {
                lbl_print_headS.Text = "Admission Fees Collection Report of Date : " + txt_date11.Text + " and Class : " + ddlclass.SelectedItem.Text;
        ...
        protected void btn_excels_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=Total_Admission_Fee_Collection_Today" + "_" + DateTime.Now + ".xls");
            Response.Charset = "";
