<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="admission-fee-dcr.aspx.cs" Inherits="school_web.Admin.admission_fee_dcr" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                                ...
                                <div class="find-dv">
                                    <div class="row  g-3 needs-validation">
                                        ...
                                        <div class="col-sm-2">
                                            ...
                                            <asp:DropDownList ID="ddl_student_type" runat="server" class="form-select find-dv-txtbx txtbx-ddl-style">
                                        ...
                                        <div id="tblPrintIQ" runat="server">
                                            <div class="head-printdv" style="border-bottom: 1px solid #000; margin: 0px; float: left; width: 100%;">
                                                ...
                                                <div style="margin: 0px; padding: 0px; height: 110px; width: 80%; float: left;">
                                                    ...
                                                    <div style="margin: 7px 0px 0px 0px; padding: 0px; float: left; height: auto; text-align: center; vertical-align: middle; font-size: 13px; width: 100%;">
                                                        <span style="font-size: 14px; font-weight: bold;">Day end report for Admission/Annual fee 
                                                ...
                                                <div class="grd-wpr-new">
                                                    <table class="table table-bordered" datatable="ng" dt-options="vm.dtOptions" style="border: 1px solid #c5c0c0;">
                                                        ...
                                                        <tr data-ng-repeat="x in reportAmountSFnal track by $index">
                                                            <td colspan="13" class="fntbold" style="text-align: right">Total : </td>
    ...
    <script type="text/javascript">
        ...
        app.controller('RpCardAppCtrl', function ($scope, $http) {
            ...
            $http.get("webServices/account/dcr-adm.asmx/fetch_report_heading_day_end", {
                params: { "Session_id": session_id, "Class_id": class_id, "FromDate": Fromdates, "ToDate": Todates, "Type": type, "Session_name": session_name, "Class_name": class_name, "Collection_type": collection_type, "Std_type": std_type }
            ...
            $http.get("webServices/account/dcr-adm.asmx/fetch_report_heading_day_end_amts", { params: { "Session_id": session_id, "Class_id": class_id, "FromDate": Fromdates, "ToDate": Todates, "Type": type, "Session_name": session_name, "Class_name": class_name, "Collection_type": collection_type, "Std_type": std_type } }).then(function (response) {
                ...
                if ($scope.reportAmountS == "") {
                    ...
                    $http.get("webServices/account/dcr-adm.asmx/fetch_report_heading_day_end_final_amts", { params: { "Session_id": session_id, "Class_id": class_id, "FromDate": Fromdates, "ToDate": Todates, "Type": type, "Session_name": session_name, "Class_name": class_name, "Collection_type": collection_type, "Std_type": std_type } }).then(function (response) {
