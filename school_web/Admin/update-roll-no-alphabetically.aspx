<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="update-roll-no-alphabetically.aspx.cs" Inherits="school_web.Admin.update_roll_no_alphabetically" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Update Roll No. Alphabetically 
</asp:Content>
    ...
    <div class="page-wrapper">
        <div class="page-content">
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Update Roll No. Alphabetically </li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row" data-ng-app="ComplainApp" data-ng-controller="ComplainAppCtrl">
                <div class="col-xl-12">
                    <h6 class="mb-0 text-uppercase">Update Roll No. Alphabetically </h6>
                    <hr />
                    <div class="card">
                        <div class="card-body">
                            ...
                            <asp:Label ID="lbl_website" runat="server"></asp:Label>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            ...
                                                            <asp:Button ID="btn_update_roll_alphbaticaly" Visible="false" OnClick="btn_update_roll_alphbaticaly_Click" class="btn btn-primary find-dv-btn" runat="server" Text="Update Alphabetically" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
