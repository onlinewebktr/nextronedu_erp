<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="Report_Total_Dues_Fee.aspx.cs" Inherits="school_web.Admin.Report_Total_Dues_Fee" EnableEventValidation="false" ValidateRequest="false" %>
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Total Dues List</li>
                        </ol>
                    </nav>
                </div>
            </div>
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="grd-wpr">
                                                <div class="col-sm-12" id="tblPrintIQ" runat="server">
                                                    ...
                                                    <asp:GridView ID="grd_fee" runat="server" AutoGenerateColumns="False" Style="width: 100%" class="table table-striped table-bordered dataTable" Width="100%"  OnRowDataBound="grd_fee_RowDataBound" ShowFooter="True">
                                                        <Columns> 
                                                            ...
                                                            <asp:TemplateField HeaderText="Total Amount">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lbl_Amount" runat="server" Text='<%# Getamount_comma_seperated(Eval("totaldues").ToString())%>'></asp:Label>
                                                                </ItemTemplate>
