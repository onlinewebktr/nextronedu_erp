<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="Create_Abacus_Certificate.aspx.cs" Inherits="school_web.Admin.Create_Abacas_Certificate" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">Create Abacus Certificate
</asp:Content>
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active">Create Abacus Certificate</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="modal-dialog md-width">
            ...
            <div class="modal-content" style="position: relative">
                <div class="modal-header">
                    <h3 class="modal-title" style="font-size: 20px;">Create Abacus Certificate</h3>
                ...
                <div class="modal-body md-bdy">
                    ...
                    <div class="mdl-frm-row">
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <asp:TextBox ID="txt_Participated_in_the" runat="server" class="form-control" Text="ABACUS"></asp:TextBox>
                            </div>
                        </div>
                    </div>
