            ...
            try
            {
                if (!IsPostBack)
                {
                    ...
                    else
                    {
                        ...
                        lbl_report_type.Text = "Expense Detail for Date : " + txt_from_date.Text + " to " + txt_to_date.Text;
                        if (txt_from_date.Text == txt_to_date.Text)
                        {
                            ...
                            lbl_report_type.Text = "Expense Detail for Date : " + txt_from_date.Text + " - " + datatimes.ToString("dddd");
                        } 
                    }
                }
            }
