<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="monthly-fee-master.aspx.cs" Inherits="school_web.Admin.monthly_fee_master" EnableEventValidation="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Monthly Fees for Day Scholar
</asp:Content>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <ul class="sub-pag-menu-ul">
                        ...
                        <li><a href="monthly-fee-master.aspx" class="sub-mnu-p-a-active">Monthly Fees</a></li>
                                ...
                                <div class="row g-3 needs-validation" novalidate="">
                                    <div class="col-xl-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <label for="validationCustom01" class="form-label Llabel">Fees For</label>
                                                <asp:DropDownList ID="ddl_fees_for" runat="server" class="form-select">
                ...
                <div class="col-xl-12">
                    <h6 class="mb-0 text-uppercase">Added Monthly Fees </h6>
                    <hr />
                    <div class="card">
                        <div class="card-body">
                            <div class="table-responsive">
                                <div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap5 hdrmodify">
                                    <div class="row">
                                        <div class="col-sm-2">
                                            <label for="validationCustom01" class="find-dv-lbl" style="font-weight: bold">Fees For</label>
                                            <asp:DropDownList ID="ddl_fees_type_srch" runat="server" class="form-control find-dv-txtbx" AutoPostBack="true" OnSelectedIndexChanged="ddl_fees_type_srch_SelectedIndexChanged">
                                                <asp:ListItem Value="4">Day Scholar</asp:ListItem>
                                                <asp:ListItem Value="44">Day Boarding with Lunch</asp:ListItem>
                                            </asp:DropDownList>
                                        </div>
                                        ...
                                        <div class="col-sm-2">
                                            <label for="validationCustom01" class="find-dv-lbl" style="font-weight: bold">Month Name</label>
                                            <asp:DropDownList ID="ddl_months" runat="server" class="form-control find-dv-txtbx" AutoPostBack="true" OnSelectedIndexChanged="ddl_months_SelectedIndexChanged"></asp:DropDownList>
                                        </div>
                            ...
                            <asp:Label ID="lbl_website" runat="server"></asp:Label>
                                                                ...
                                                                <div style="margin: 7px 0px 0px 0px; padding: 0px; float: left; height: auto; text-align: center; vertical-align: middle; font-size: 13px; width: 100%;">
                                                                    <span style="font-size: 14px; font-weight: bold;">Month Fee Master
    ...
    <div class="modal fade" id="myModal1" role="dialog" style="top: 0px">
        <div class="modal-dialog md-width" style="max-width: 500px; margin: 5.75rem auto;">
            ...
            <div class="modal-content" style="position: relative">
                <div class="modal-header">
                    <h3 class="modal-title" style="font-size: 18px;">Copy Monthly Fee For Next Session</h3>
                ...
                <div class="modal-body md-bdy">
                    ...
                    <div class="mdl-frm-row">
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <asp:Button ID="btn_copy_monthley_for_day" OnClick="btn_copy_monthley_for_day_Click" runat="server" Text="Copy" class="btn btn-success" OnClientClick="return confirm('Are you sure you want to copy monthly fee?');" />
                            </div>
                        </div>
                    </div>
                </div>
