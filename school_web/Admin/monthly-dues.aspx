<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="monthly-dues.aspx.cs" Inherits="school_web.Admin.monthly_dues" EnableEventValidation="false" ValidateRequest="false" %>
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Monthly Dues</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <ul class="sub-pag-menu-ul">
                        ...
                        <li><a href="monthly-dues.aspx" class="sub-mnu-p-a-active">Monthly Dues List</a></li>
                                        ...
                                        <div class="col-xl-12">
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <%--<asp:DropDownList ID="ddl_class" runat="server" class="form-select" Style="display: none"></asp:DropDownList>--%>
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <asp:DropDownList ID="ddl_fee_type" runat="server" class="form-select">
                                                        ...
                                                        <asp:ListItem Value="2">Day Scholar(With Transport)</asp:ListItem>
                                                        <asp:ListItem Value="5">Day Scholar(Without Transport)</asp:ListItem>
                                                        <asp:ListItem Value="3">Day Boarding with Lunch</asp:ListItem>
                                                        <asp:ListItem Value="4">Transport</asp:ListItem>
                                                    </asp:DropDownList>
                                                </div>
                                                <div class="col-md-3">
                                                    <label for="validationCustom01" class="form-label Llabel">Calculate with fine</label>
                                                    <asp:DropDownList ID="ddl_calculate_with_Fine" runat="server" class="form-select">
                    ...
                    <div class="col-xl-12">
                        ...
                        <div class="card">
                            ...
                            <asp:Label ID="lbl_website" runat="server"></asp:Label>
                                                                        ...
                                                                        <div style="margin: 7px 0px 0px 0px; padding: 0px; float: left; height: auto; text-align: center; vertical-align: middle; font-size: 13px; width: 100%;">
                                                                            <span style="font-size: 14px; font-weight: bold;">Dues List
                                                                        <asp:Label ID="lbl_date" runat="server"></asp:Label></span>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="grd-wpr">
                                                                    <asp:GridView ID="GridView2" runat="server" CssClass="table table-bordered table-striped" Style="width: 100%" AutoGenerateColumns="true" OnRowCreated="GridView2_RowCreated" OnSelectedIndexChanged="GridView2_SelectedIndexChanged" OnRowDataBound="GridView2_RowDataBound2" ShowFooter="true">
                                                                    </asp:GridView>
                                                                </div>
                                                            </asp:Panel>
                                                                        ...
                                                                        <td style="padding: 5px;">
                                                                            ...
                                                                            <div class="row">
                                                                                <asp:Panel runat="server" Visible="false" ID="pnl_msg" class="col-lg-12">
                                                                                    ...
                                                                                    <asp:TextBox ID="txt_message" ReadOnly="true" TextMode="MultiLine" runat="server" class="form-control"></asp:TextBox>
                                                                                </asp:Panel>
                                                                            </div>
