<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="reprint-bill.aspx.cs" Inherits="school_web.Admin.reprint_bill" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        $(function () {
            $("#<%=txt_bill_no.ClientID%>").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        url: 'reprint-bill.aspx/GetRooPath',
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Re-Print Slip</li>
                        </ol>
                    </nav>
                </div>
            </div>
                                ...
                                <div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap5 hdrmodify">
                                    ...
                                    <div class="find-dv">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-3">
                                                <label for="validationCustom01" class="find-dv-lbl" style="font-weight: bold">Bill No.</label>
                                                <asp:TextBox ID="txt_bill_no" runat="server" class="form-control find-dv-txtbx"></asp:TextBox>
                                            </div>
                                            <div class="col-sm-1">
                                                <asp:Button ID="btn_find_by_bill_no" runat="server" Text="find" class="btn btn-primary find-dv-btn" OnClick="btn_find_by_bill_no_Click" />
                                            </div>
