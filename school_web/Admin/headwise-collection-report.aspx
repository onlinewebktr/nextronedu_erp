<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="headwise-collection-report.aspx.cs" Inherits="school_web.Admin.headwise_collection_report" %>
                                            ...
                                            <div class="prnt-dv-wpr printborder" id="tblCustomers">
                                                <div class="pgslry-head-div head" style="border-bottom: 1px solid #000; margin: 0px; float: left; width: 100%;">
                                                    ...
                                                    <div style="margin: 0px; padding: 0px; height: 110px; width: 80%; float: left;">
                                                        ...
                                                        <div style="margin: 7px 0px 0px 0px; padding: 0px; float: left; height: auto; text-align: center; vertical-align: middle; font-size: 13px; width: 100%;">
                                                            <span style="font-size: 14px; font-weight: bold;">Headwise Collection Report for the Date of 
                                                            ...
                                                            <table class="table table-bordered table-hover" style="border: 1px solid #c5c0c0;" datatable="ng" dt-options="vm.dtOptions">
                                                                ...
                                                                <tbody>
                                                                    <tr data-ng-repeat="x in reportfeesS">
                                                                        ...
                                                                        <td>{{x.className}}</td>
                                                                        <td>{{x.Section}}</td>
                                                                        <td data-ng-repeat="item in x.MyCollectiondRpTwoLevelList track by $index" class="txtcenter">{{item.Paid_amt}}</td>
                                                                        <td>{{x.MyCollectiondRpTwoLevelList[x.MyCollectiondRpTwoLevelList.length - 1].Total_paid_amt}}</td>
                                                                    </tr>
                                                                </tbody>
                                                                <tr>
                                                                    ...
                                                                    <td style="text-align: center;">{{ totalCollecteD | number:2 }}</td>
                                                                </tr>
                                                            </table>
                                                        </div>
                                                    </div>
    ...
    <script type="text/javascript">
        ...
        app.controller('RpCardAppCtrl', function ($scope, $http) {
            ...
            if (find_status == "1") {
                ...
                $http.get("webServices/account/headwise-dues.asmx/fetch_report_collection_head", { params: { "Session": session, "Session_id": session_id, "Class_id": class_id, "Fee_head_id": fee_head_id, "From_idate": from_idate, "To_idate": to_idate } }).then(function (response) {
                ...
                $http.get("webServices/account/headwise-dues.asmx/fetch_report_collection_fees", { params: { "Session": session, "Session_id": session_id, "Class_id": class_id, "Fee_head_id": fee_head_id, "From_idate": from_idate, "To_idate": to_idate } }).then(function (response) {
                    ...
                    if ($scope.reportAmountS == "") {
                        ...
                        $http.get("webServices/account/headwise-dues.asmx/fetch_report_total_footer", { params: { "Session": session, "Session_id": session_id, "Class_id": class_id, "Fee_head_id": fee_head_id, "From_idate": from_idate, "To_idate": to_idate } }).then(function (response) {
                        ...
                        students.forEach(student => {
                            const list = student.MyCollectiondRpTwoLevelList;
                            if (Array.isArray(list) && list.length > 0) {
                                const lastItem = list[list.length - 1];
                                totalDues += parseFloat(lastItem.Total_paid_amt || 0);
                            }
                        }); 

                        $scope.totalCollecteD = totalDues;
