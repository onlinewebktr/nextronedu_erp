<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="monthly-fee-for-hostel.aspx.cs" Inherits="school_web.Admin.monthly_fee_for_hostel" EnableEventValidation="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Monthly Fees For Hostel
</asp:Content>
    ...
    <script type="text/javascript">
        function Export() {
            ...
            $("[id*=tabledata1]").table2excel({
                filename: class_name + "MonthlyFeeHostel.xls",
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xl-12">
                    <%--<asp:Label ID="ltUsertop" runat="server" Style="font-weight: 500; font-size: 1rem;" class="mb-0 text-uppercase" Text="Monthly Fee For Hostel"></asp:Label>--%>
                    <ul class="sub-pag-menu-ul">
                        <li><a href="admission-fee-for-hosteler.aspx">Admission Fees</a></li>
                        <li><a href="annual-fee-for-hosteler.aspx">Annual Fees</a></li>
                        <li><a href="monthly-fee-for-hostel.aspx" class="sub-mnu-p-a-active">Monthly Fees</a></li>
                    </ul>
                </div>
                <div class="col-xl-12">
                    <hr />
                                ...
                                <div class="row g-3 needs-validation" novalidate="">
                                    <div class="col-xl-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <label for="validationCustom01" class="form-label Llabel">Room Type</label>
                ...
                <div class="col-xl-12">
                    <h6 class="mb-0 text-uppercase">Added Fee</h6>
                    <hr />
                    <div class="card">
                        <div class="card-body">
                            <div class="table-responsive">
                                <div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap5 hdrmodify">
                                    <div class="row">
                                        <div class="col-sm-2" id="Div1" runat="server">
                                            <label for="validationCustom01" class="find-dv-lbl" style="font-weight: bold">Session</label>
                                            <asp:DropDownList ID="ddl_session_serach" runat="server" class="form-select find-dv-txtbx"></asp:DropDownList>
                                        </div>
                                        <div class="col-sm-2" id="storeDv" runat="server">
                                        ...
                                        <div class="col-sm-2">
                                            ...
                                            <asp:DropDownList ID="ddl_hostel_srch" runat="server" class="form-control find-dv-txtbx" AutoPostBack="true" OnSelectedIndexChanged="ddl_hostel_srch_SelectedIndexChanged"></asp:DropDownList>
                                        </div>
                                        <div class="col-sm-2">
                                            <label for="validationCustom01" class="find-dv-lbl" style="font-weight: bold">Category</label>
                                            <asp:DropDownList ID="ddl_category_srch" runat="server" class="form-control find-dv-txtbx" AutoPostBack="true" OnSelectedIndexChanged="ddl_category_srch_SelectedIndexChanged"></asp:DropDownList>

                                        </div>
                                        <div class="col-sm-2">
                                            <label for="validationCustom01" class="find-dv-lbl" style="font-weight: bold">Month</label>
                                            <asp:DropDownList ID="ddl_months" runat="server" class="form-select find-dv-txtbx" AutoPostBack="true" OnSelectedIndexChanged="ddl_months_SelectedIndexChanged"></asp:DropDownList>
                                        </div>
                                        <div class="col-sm-2">
                                            ...
                                            <asp:LinkButton ID="print1" OnClientClick="return PrintPanel()" Style="margin: 20px 0px 5px 0px !important;" CssClass="btn btn-primary find-dv-btn" runat="server"
                            ...
                            <asp:Label ID="lbl_website" runat="server"></asp:Label>
                                                            ...
                                                            <div style="margin: 7px 0px 0px 0px; padding: 0px; float: left; height: auto; text-align: center; vertical-align: middle; font-size: 13px; width: 100%;">
                                                                <span style="font-size: 14px; font-weight: bold;">Hostel Monthly Fee Master
                                                                ...
                                                                <asp:Repeater ID="rd_viewaddedfee" runat="server">
                                                                    <ItemTemplate>
                                                                        <tr>
                                                                            ...
                                                                            <td style="text-align: left;">
                                                                                <asp:Label ID="Label2" runat="server" Text='<%#Bind("Hostel_name")%>'></asp:Label>
                                                                            </td>
                                                                            <td style="text-align: left;">
                                                                            ...
                                                                            <td style="text-align: left;">
                                                                                ...
                                                                                <asp:Label ID="lbl_Room_Category_id" runat="server" Text='<%#Bind("Room_Category_id")%>' Visible="false"></asp:Label>
    ...
    <div class="modal fade" id="myModal1" role="dialog" style="top: 0px">
        <div class="modal-dialog md-width" style="max-width: 500px; margin: 5.75rem auto;">
            ...
            <div class="modal-content" style="position: relative">
                <div class="modal-header">
                    <h3 class="modal-title" style="font-size: 18px;">Copy hostel monthly fee for next session</h3>
                ...
                <div class="modal-body md-bdy">
                    ...
                    <div class="mdl-frm-row">
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <asp:Button ID="btn_copy_monthly_copy" OnClick="btn_copy_monthly_copy_Click" runat="server" Text="Copy" class="btn btn-success" OnClientClick="return confirm('Are you sure you want to copy monthly fee?');" />
                            </div>
                        </div>
                    </div>
                </div>
