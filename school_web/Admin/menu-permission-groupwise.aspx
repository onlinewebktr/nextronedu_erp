<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="menu-permission-groupwise.aspx.cs" Inherits="school_web.Admin.menu_permission_groupwise" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:CheckBox ID="chk_edit_permission1" runat="server" />
    <asp:CheckBox ID="chk_delete1" runat="server" />
    <asp:CheckBox ID="chk_Download1" runat="server" />
    <asp:CheckBox ID="chk_print1" runat="server" />
    <asp:CheckBox ID="chk_add1" runat="server" />
