<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="castewise-student.aspx.cs" Inherits="school_web.Admin.castewise_student" EnableEventValidation="false" ValidateRequest="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Category-Wise Student's List
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"><a href="student-report-home.aspx" id="backbtns" runat="server" class="backlnk-css"><i class="bx bx-arrow-back"></i></a>Reports</div>
                <div class="ps-3">
                                        ...
                                        <div class="find-dv">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-2">
                                                    ...
                                                    <asp:DropDownList ID="ddl_cast" runat="server" class="form-select find-dv-txtbx"></asp:DropDownList>
                                                </div>
                                                <div class="col-sm-2">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-3">
                                                    <div class="home-grph-wpr-smll">
                                                        <div id="daily_collection" class="card-statistic-2" style="width: 100%; height: 320px; -webkit-tap-highlight-color: transparent; user-select: none; position: relative; padding: 10px;">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="grd-wpr">
                                            ...
                                            <div id="tblPrintIQ" runat="server">
                                                <div style="margin: 18px 0px 19px 0px; padding: 6px 0px 0px 0px; float: left; height: 33px; text-align: center; vertical-align: middle; font-size: 13px; width: 100%; border-top: 1px solid #000; border-bottom: 1px solid #000;">
                                                    <span style="font-size: 14px; font-weight: bold;">Caste Wise Student List-<asp:Label ID="lbl_class222" runat="server"></asp:Label></span>
                                                </div>
                                                                    ...
                                                                    <td style="text-align: left;">
                                                                        <div class="user-box dropdown" style="float: left; display: inherit; height: auto; border-left: 0px solid #f0f0f0; margin-left: 0px;">
                                                                            ...
                                                                            <ul class="dropdown-menu dropdown-menu-end">
                                                                                <li>
                                                                                    <a class="dropdown-item" href="student-details.aspx?admNo=<%#Eval("admissionserialnumber") %>&ssion=<%#Eval("Session_id") %>&clss=<%#Eval("Class_id") %>" target="_blank"><i class='bx bx-happy-heart-eyes'></i><span>View Student Details</span> </a>
                                                                                </li>
    ...
    <asp:HiddenField ID="hd_caste" runat="server" />
    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            var options = {
                title: 'CasteWise Student Summary',
                width: 980,
                height: 420,
            ...
            $.ajax({
                type: "POST",
                url: "castewise-student.aspx/GetChartData",
                data: "{Session: '" + $('#<%=hd_session.ClientID%>').val() + "', Class_id: '" + $('#<%=hd_class.ClientID%>').val() + "', Section: '" + $('#<%=hd_section.ClientID%>').val() + "', Caste: '" + $('#<%=hd_caste.ClientID%>').val() + "'}",
        ...
        $(document).ready(function () {
            ...
            var Caste = $('#<%= hd_caste.ClientID %>').val();
            ...
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "graph.asmx/Get_student_castewise",
                data: "{Session: '" + Session + "', Class_id: '" + Class + "', Section: '" + Section + "', Caste: '" + Caste + "'}",
                dataType: "json",
