<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="dues-boarding-point-wise.aspx.cs" Inherits="school_web.Admin.dues_boarding_point_wise" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Boarding Point Wise Outstanding
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Total Outstanding Transport Student</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row" data-ng-app="ComplainApp" data-ng-controller="ComplainAppCtrl">
                <div class="col-xl-12">
                    <ul class="sub-pag-menu-ul">
                        ...
                        <li><a href="total-outstanding-transport-student.aspx">Transport Student Outstanding</a></li>
                        <li><a href="dues-boarding-point-wise.aspx" class="sub-mnu-p-a-active">Boarding Point-Wise Outstanding</a></li>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="row">
                                                <div class="col-sm-7">
                                                    ...
                                                    <asp:DropDownList ID="ddl_vehicle" runat="server" class="form-control txtbx-ddl-style" AutoPostBack="true"></asp:DropDownList>
                                                </div>
                                                <div class="col-sm-5">
                                                    <label for="validationCustom01" class="find-dv-lbl">Route</label>
                                                    <asp:DropDownList ID="ddl_route" runat="server" class="form-control txtbx-ddl-style"></asp:DropDownList>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-3">
                                            ...
                                            <div class="select2-dv">
                                                <asp:DropDownList ID="ddl_boarding_piont" runat="server" class="form-control txtbx-ddl-style" CssClass="single-select"></asp:DropDownList>
                                            </div>
                                        </div>
                                        <div class="col-sm-2">
    ...
    <script type="text/javascript">
        function Export() {
            var class_name = "Dues_list_transport_student";
