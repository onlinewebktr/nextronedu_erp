<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="Print_Abacus_Certificate.aspx.cs" Inherits="school_web.Admin.Print_Abacus_Certificate" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">Print Abacus Certificate
</asp:Content>
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"> Print Abacus Certificate</li>
                        </ol>
                    </nav>
                </div>
            </div>
                                                                            ...
                                                                            <ItemTemplate>
                                                                                <tr>
                                                                                    ...
                                                                                    <td style="text-align: left;">
                                                                                        ...
                                                                                        <asp:Label ID="lbl_id" Visible="false" runat="server" Text='<%#Bind("Id1")%>'></asp:Label>
                                                                                        ...
                                                                                        <div class="user-box dropdown" style="float: left; display: inherit; height: auto; border-left: 0px solid #f0f0f0; margin-left: 0px;">
                                                                                            ...
                                                                                            <ul class="dropdown-menu dropdown-menu-end">
                                                                                                ...
                                                                                                <li>
                                                                                                    <a class="dropdown-item" href="slip/Abacus_certificate.aspx?Id=<%#Eval("Id1") %>" target="_blank"><i class='bx bx-printer'></i><span>Print</span></a>
                                                                                                </li>
                                                                                                <li>
        ...
        <div class="modal-dialog md-width">
            ...
            <div class="modal-content" style="position: relative">
                <div class="modal-header">
                    <h3 class="modal-title" style="font-size: 20px;">Update Abacus Certificate</h3>
