...
{
    public partial class fee_collection_details : System.Web.UI.Page
    {
        My mycode = new My();
            ...
            try
            {
                ...
                else
                {
                    if (!IsPostBack)
                    {
                        ...
                        mycode.bind_all_ddl_with_id_cap_All(ddl_class, "Select cd.Course_Name,cd.course_id from Add_course_table cd order by cd.Position asc");
