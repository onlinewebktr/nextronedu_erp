...
{
    public partial class Credit_Voucher_Entry : System.Web.UI.Page
    {
        ...
        private void fetch_particular()
        {
            ...
            SqlDataAdapter ad = new SqlDataAdapter("select Group_id from Account_Ledger_Groups where Group_id not in ('27','28','26') and firm='" + My.firm_id() + "'", My.conn);
        ...
        private void Update_data()
        {
            ...
            else
            {
                ...
                string Description = txt_remarks.Text; //$"Amount Credit from {txt_particular.Text}. Remarks : {txt_remarks.Text}";
                ...
                string Main_account_name = My.find_account_id_new("School Charges", "15", "School_Charges");




                My.send_to_account_ledger(Main_account_name, alternetacc_id, txt_amount.Text, VoucherNo, unique_entry_id, Description, Date, IDate, "0", "0", "0", VoucherType, My.firm_id(), My.get_session(), ViewState["Userid"].ToString(), "SCHOOL", VoucherNo);
        ...
        protected void lnk_excel_download_Click(object sender, EventArgs e)
        {
            if (ViewState["Is_Download"].ToString() == "1")
            {
                ...
                string pageName = My.with_excel_name("Credit_vouchar") + ".xls";
        ...
        private void save_data()
        {
            ...
            else
            {
                ...
                //DateTime Date1 = My.toDateTime(txt_date.Text + " " + mycode.time());
                ...
                VoucherNo = "CV" + My.session_wise_view_auto_serial(VoucherType + "_voucher", My.get_session(), My.firm_id());
        ...
        protected void lnkDel_Click(object sender, EventArgs e)
        {
            try
            {
                if (ViewState["Is_delete"].ToString() == "1")
                {
                    ...
                    string msg = "delete credit Voucher" + Unique_entry_id + " Cid=" + lbl_VoucherNo;
                    mycode.insert_data_logfile(ViewState["Userid"].ToString(), "1", msg, "1");
                    My.exeSql("delete from Account_Voucher_Details where unique_entry_id='" + Unique_entry_id + "' and VoucherType='Credit' ");
        ...
        protected void btn_find_by_Voucher_No_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string query = "  select (Select Account_name from Account_Ledger_Details where Account_id=t1.Account_id) as Account_CR,(Select Account_name from Account_Ledger_Details where Account_id=t1.Alternet_Account) as Account_Dr, Account_Id,Alternet_Account,Description,Credit As Amount,unique_entry_id,Date,VoucherNo_Manual as VoucherNo,VoucherNo as v1  from dbo.[Account_Voucher_Details] t1  where  VoucherType='Credit' and firm =" + My.firm_id() + " and  Bill_from='SCHOOL'  and t1.VoucherNo ='" + txt_Voucher.Text + "'  and    Credit>0 order by IDate";
                bind_data(query);
            }
        }
    }
