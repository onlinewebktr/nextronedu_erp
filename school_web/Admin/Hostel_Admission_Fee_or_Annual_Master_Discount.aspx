<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="Hostel_Admission_Fee_or_Annual_Master_Discount.aspx.cs" Inherits="school_web.Admin.Hostel_Admission_Fee_or_Annual_Master_Discount" EnableEventValidation="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Set Discount on Admission/Annual Fees
</asp:Content>
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Set Discount on Admission/Annual Fees</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <ul class="sub-pag-menu-ul sub-pag-menu-ul-mrgn">
                        <li><a href="Hostel_Admission_Fee_or_Annual_Master_Discount.aspx" class="sub-mnu-p-a-active">Set Discount on Admission/Annual Fees</a></li>

                        <li><a href="Hostel_discount_on_monthly_fee.aspx">Set Discount on Monthly Fees</a></li>
                                ...
                                <div class="row g-3 needs-validation" novalidate="">
                                    <div class="col-xl-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <label for="validationCustom01" class="form-label Llabel">Select Class</label>
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <asp:DropDownList ID="ddl_hostel" runat="server" class="form-select">
                                                </asp:DropDownList>
                                            </div>
                                            <div class="col-md-2">
                    ...
                    <div class="card">
                        <div class="card-body">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="find-dv">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-2">
                                                        <label for="validationCustom01" class="find-dv-lbl">Fee For</label>
                                                        <asp:DropDownList ID="ddl_fees_for_search" runat="server" class="form-select find-dv-txtbx">
                            ...
                            <asp:Label ID="lbl_website" runat="server"></asp:Label>
                                                                ...
                                                                <div style="margin: 7px 0px 0px 0px; padding: 0px; float: left; height: auto; text-align: center; vertical-align: middle; font-size: 13px; width: 100%;">
                                                                    <span style="font-size: 14px; font-weight: bold;">Set Discount
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <asp:Panel ID="Panel1" runat="server">
                                                                                <tr>
                                                                                    ...
                                                                                    <td style="text-align: left;">
                                                                                        <asp:Label ID="Label4" runat="server" Text='<%#Bind("parameter")%>'></asp:Label>
                                                                                    </td>
