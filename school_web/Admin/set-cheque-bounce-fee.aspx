<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="set-cheque-bounce-fee.aspx.cs" Inherits="school_web.Admin.set_cheque_bounce_fee" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Set Cheque Bounce Fees
</asp:Content>
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Form Sale Fees</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <ul class="sub-pag-menu-ul sub-pag-menu-ul-mrgn">
                        ...
                        <li ><a href="set-cheque-bounce-fee.aspx" class="sub-mnu-p-a-active">Set Cheque Bounce Fees</a></li>
                    </ul>
                </div>
                <hr />
                <div class="col-xl-4">
                    <div class="card">
                        <div class="card-body">
                            <asp:Label ID="ltUsertop" runat="server" Style="font-weight: 500; font-size: 1rem;" class="mb-0 text-uppercase" Text="Set Cheque Bounce Fees"></asp:Label>
                            <hr />
                ...
                <div class="col-xl-8">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h6 class="mb-0 text-uppercase">Added Cheque Bounce Fees</h6>
                            <hr />
