<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="set-student-wise-discount-s-month.aspx.cs" Inherits="school_web.Admin.set_student_wise_discount_s_month" %>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <ul class="sub-pag-menu-ul sub-pag-menu-ul-mrgn">
                        ...
                        <li><a href="set-student-wise-discount-s-month.aspx" class="sub-mnu-p-a-active">Month Wise</a></li>
                    </ul>
                </div>
                <hr />
                <div class="col-xl-12">
                                ...
                                <asp:Panel ID="std_basic_infoS" runat="server" Visible="false">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-12">
                                            ...
                                            <div class="fnd-box-wpr">
                                                <h2 class="fnd-box-row-wpr-h">Student Details <a href="set-student-wise-discount-s-month.aspx" class="btn btn-primary form-fnd-btns" style="background: #f00; border: 1px solid #ddd; width: auto; margin: -3px 0px -2px 0px; padding: 3px 10px 2px; float: right;">Find New Student</a></h2>
                                                <div class="fnd-box-wpr-inr">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-12">
                                            <div class="fnd-box-wpr">
                                                <h2 class="fnd-box-row-wpr-h">Give Discount</h2>
                                                <div class="fnd-box-wpr-inr">
                                                        ...
                                                        <div class="disc-month-checkbox-sec">
                                                            <div class="disc-pop-txtbx-sec">
                                                                <div class="row">
                                                                    <div class="col-md-3">
                                                                        <p>Month</p>
                                                                        <asp:DropDownList ID="ddl_disc_month" runat="server" class="form-select disc-pop-txtbx" AutoPostBack="true" OnSelectedIndexChanged="ddl_disc_month_SelectedIndexChanged"></asp:DropDownList>
                                                                    </div>
                                                                </div>
                                                            </div>
