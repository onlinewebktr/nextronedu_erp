<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="online-registration.aspx.cs" Inherits="school_web.Admin.online_registration" EnableEventValidation="false" ValidateRequest="false" %>
                ...
                <div class="col-xl-4" style="display:none">
                    <div class="card radius-10 border-start border-0 border-3 border-danger">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div>
                                    <p class="mb-0 text-secondary">Total Hostel Student</p>
                ...
                <div class="col-xl-4" style="display:none">
                    <div class="card radius-10 border-start border-0 border-3 border-success">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div>
                                    <p class="mb-0 text-secondary">Total Day Scholar Student</p>
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Paid Student List</li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <asp:Label ID="lbl_website" runat="server"></asp:Label>
                                                                    ...
                                                                    <div style="margin: 7px 0px 0px 0px; padding: 0px; float: left; height: auto; text-align: center; vertical-align: middle; font-size: 13px; width: 100%;">
                                                                        <span style="font-size: 14px; font-weight: bold;">Online Registration List
                                                            ...
                                                            <asp:Panel ID="Panel1" runat="server">
                                                                        ...
                                                                        <asp:Repeater ID="rd_view" runat="server" OnItemDataBound="rd_view_ItemDataBound">
                                                                            <ItemTemplate>
                                                                                <tr id="trR" runat="server">
                                                                                    ...
                                                                                    <td style="text-align: left;">
                                                                                        <div class="user-box dropdown" style="float: left; display: inherit; height: auto; border-left: 0px solid #f0f0f0; margin-left: 0px;">
                                                                                            ...
                                                                                            <ul class="dropdown-menu dropdown-menu-end">
                                                                                                ...
                                                                                                <li>
                                                                                                    <a class="dropdown-item" href="Online_Form_Edit.aspx?regiDs=<%#Eval("Registration_id") %>"><span>Edit Student Info</span> </a>
                                                                                                </li>
                                                                                                <li>
                                                                                                    <a class="dropdown-item" href="admission.aspx?regiDs=<%#Eval("Registration_id") %>&transfr=1"><span>Transfer Student</span> </a>
                                                                                                </li>

                                                                                                <li style="display:none">
                                                                                                    <asp:LinkButton ID="lnk_update_payment" class="dropdown-item" runat="server" OnClick="lnk_update_payment_Click">Get Payment</asp:LinkButton>

                                                                                                    <asp:Label ID="lbl_pay_slip" runat="server" Visible="false">
                                                                                                    <a  class="dropdown-item" href="slip/online-admission-fee-taken.aspx?regids=<%#Eval("Registration_id") %>&sessionid=<%#Eval("Session_id") %>" target="_blank">Payment Slip</a></asp:Label>
                                                                                                </li>
                                                                                            </ul>
                                                                                        </div>
                                                                                        ...
                                                                                        <asp:Label ID="lbl_fee_taken" runat="server" Text='<%#Bind("Fee_taken")%>' Visible="false"></asp:Label>
                                                                                    </td>
                                                                                    <td style="text-align: left;">
                                                                                    ...
                                                                                    <td style="text-align: left;">
                                                                                        <asp:Label ID="Label2" runat="server" Text='<%#Bind("Student_email_id")%>'></asp:Label>
                                                                                    </td>
                                                                                    <td style="text-align: left;">
                                                                ...
                                                                <div style="display: none">
                                                                    <asp:GridView ID="grd_excel" runat="server" AutoGenerateColumns="False" AutoGenerateSelectButton="False" AllowPaging="false" Font-Bold="False">
                                                                        <RowStyle />
                                                                        <Columns>
                                                                            ...
                                                                            <asp:TemplateField HeaderText="Mobile No.">
                                                                                <ItemTemplate>
                                                                                    <asp:Label ID="lbl_Student_mob_no" runat="server" Text='<%#Bind("Student_mob_no") %>'></asp:Label>
                                                                                </ItemTemplate>
                                                                            </asp:TemplateField>
                                                                            ...
                                                                            <asp:TemplateField HeaderText="Payment id">
                                                                             ...
                                                                             <asp:TemplateField HeaderText="Is Admission Fee Taken">
                                                                                <ItemTemplate>
                                                                                    <asp:Label ID="lbl_razorpay_payment_id" runat="server" Text='<%#Bind("AdmFeeTakenStatus") %>'></asp:Label>
                                                                                </ItemTemplate>
                                                                            </asp:TemplateField>
                                                                        </Columns>
                                                                    </asp:GridView>
        ...
        <div class="modal-dialog md-width" style="max-width: 600px;">
            ...
            <div class="modal-content" style="position: relative">
                <div class="modal-header">
                    <h3 class="modal-title" style="font-size: 20px;">Make Payment</h3>
                ...
                <div class="modal-body md-bdy">
                    <div class="row g-3 needs-validation" novalidate="">
                        ...
                        <div class="col-md-6">
                            <label for="validationCustom01" class="form-label">Admission Fee <sup>* </sup></label>
                            <asp:TextBox ID="txt_reg_fee" runat="server" class="form-control"></asp:TextBox>
                        </div>
                        <div class="col-md-6">
                            <label for="validationCustom01" class="form-label">Payment Mode <sup>*</sup></label>
                            <asp:DropDownList ID="ddl_payment_mode" Style="height: 32px; padding: 3px 7px;"
                                runat="server" class="form-select" OnSelectedIndexChanged="ddl_payment_mode_SelectedIndexChanged" AutoPostBack="true">
