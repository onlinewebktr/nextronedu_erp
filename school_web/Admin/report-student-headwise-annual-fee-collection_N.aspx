<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="report-student-headwise-annual-fee-collection_N.aspx.cs" Inherits="school_web.Admin.report_student_headwise_annual_fee_collection_N" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Student & Head wise Annual Fees Collection
</asp:Content>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#<%=txt_student_name.ClientID%>").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        url: 'report-student-headwise-annual-fee-collection_N.aspx/GetRooPath',
        ...
        $(function () {
            ...
            $("#<%=txt_admission_no.ClientID%>").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        url: 'report-student-headwise-annual-fee-collection_N.aspx/GetRooPathAdmNo',
                        data: "{ 'PathRooT': '" + request.term + "',Session_id:'" + sessionid + "'}",
                        dataType: "json",
                        type: "POST",
                        contentType: "application/json; charset=utf-8",
            ...
            <div class="row" data-ng-app="RpCardApp" data-ng-controller="RpCardAppCtrl">
                ...
                <div class="col-xl-12">
                    ...
                    <ul class="sub-pag-menu-ul">
                        ...
                        <li><a href="report-student-headwise-annual-fee-collection_N.aspx" class="sub-mnu-p-a-active">Student & Head wise Fee Collection</a></li>
                    </ul>
                </div>
                <div class="col-xl-12">
                    <hr />
