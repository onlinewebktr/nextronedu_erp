...
{
    public partial class reprint_admission_slip : System.Web.UI.Page
    {
        My mycode = new My();
            ...
            try
            {
                ...
                else
                {
                    if (!IsPostBack)
                    {
                        ...
                        try
                        {
                            if (Session["queryadmission"] == null)
                            {
                                Bind_course_wise();
                            }
                            else
                            {
                                ...
                                Bind_data(Session["queryadmission"].ToString());
        ...
        private void Bind_all_paid_student()
        {
            string query = " Select  ar.Session_id,ar.dateofadmission,ar.admissionserialnumber,ar.session,ar.class,ar.Section,ar.Academic_Sem_or_Year,ar.rollnumber,ar.studentname,ar.fathername,ar.mobilenumber,ar.email_id,ar.Academic_Sem_or_Year_id,ar.Class_id,ad.Slip_no,ad.Date, ad.Amount as Paid_amount, ar.father_mob from admission_registor ar join Student_Payment_History ad on ar.admissionserialnumber=ad.Addmission_no and ar.session=ad.Session where   (ar.Transfer_Status='New' or  ar.Transfer_Status='Transferred') and ad.Type='Admission'  and ar.Status='1' and ar.Session_id='" + ddl_session_serach.SelectedValue + "'   ";// ar.payment_status!= 'Unpaid'
            Session["queryadmission"] = query;
            Bind_data(Session["queryadmission"].ToString());
        }
        ...
        private void Bind_course_wise()
        {
            if (ddl_course_search.SelectedItem.Text == "All")
            {
                string query = "Select  ar.Session_id,ar.dateofadmission,ar.admissionserialnumber,ar.session,ar.class,ar.Section,ar.Academic_Sem_or_Year,ar.rollnumber,ar.studentname,ar.fathername,ar.mobilenumber,ar.email_id,ar.Academic_Sem_or_Year_id,ar.Class_id,ad.Slip_no,ad.Date, ad.Amount as Paid_amount, ar.father_mob from admission_registor ar join Student_Payment_History ad on ar.admissionserialnumber=ad.Addmission_no and ar.session=ad.Session where   (ar.Transfer_Status='New' or  ar.Transfer_Status='Transferred') and  ar.Session_id=" + ddl_session_serach.SelectedValue + " and ar.Status='1' and ad.Type='Admission'   ";//ar.payment_status!= 'Unpaid' and 
                Session["queryadmission"] = query;
                Bind_data(Session["queryadmission"].ToString());
            }
            else
            {
                string query = "Select  ar.Session_id,ar.dateofadmission,ar.admissionserialnumber,ar.session,ar.class,ar.Section,ar.Academic_Sem_or_Year,ar.rollnumber,ar.studentname,ar.fathername,ar.mobilenumber,ar.email_id,ar.Academic_Sem_or_Year_id,ar.Class_id,ad.Slip_no,ad.Date, ad.Amount as Paid_amount, ar.father_mob from admission_registor ar join Student_Payment_History ad on ar.admissionserialnumber=ad.Addmission_no and ar.session=ad.Session where     (ar.Transfer_Status='New' or  ar.Transfer_Status='Transferred') and  ar.Session_id=" + ddl_session_serach.SelectedValue + " and ar.Class_id='" + ddl_course_search.SelectedValue + "' and ar.Status='1' and ad.Type='Admission' ";//ar.payment_status!= 'Unpaid' 
                Session["queryadmission"] = query;
                Bind_data(Session["queryadmission"].ToString());
            }
        }
        ...
        //        string url = "slip/Admission_slip.aspx?admissionno=" + lbl_admissionserialnumber.Text + "&sessionid=" + lbl_sessionid.Text + "&classid=" + lbl_Class_id.Text + "&Slip_no=" + lbl_Slip_no.Text + "";
