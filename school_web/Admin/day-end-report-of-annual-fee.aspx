<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="day-end-report-of-annual-fee.aspx.cs" Inherits="school_web.Admin.day_end_report_of_annual_fee" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Day End Report of Annual Fee
</asp:Content>
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Day End Report of Annual Fee</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row" data-ng-app="RpCardApp" data-ng-controller="RpCardAppCtrl">
                <div class="col-xl-12">
                    ...
                    <ul class="sub-pag-menu-ul">
                        ...
                        <li><a href="day-end-report-of-annual-fee.aspx" class="sub-mnu-p-a-active"><%--Day End Report of --%>Annual Fee Collection Report</a></li>
