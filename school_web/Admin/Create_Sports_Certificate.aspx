<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="Create_Sports_Certificate.aspx.cs" Inherits="school_web.Admin.Create_Sports_Certificate" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Create Sports Certificate
</asp:Content>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#<%=txt_student_name.ClientID%>").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        url: 'Create_Sports_Certificate.aspx/GetRooPath',
        ...
        $(function () {
            ...
            $("#<%=txt_admission_no.ClientID%>").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        url: 'Create_Sports_Certificate.aspx/GetRooPathAdmNo',
                        data: "{ 'PathRooT': '" + request.term + "',Session_id:'" + sessionid + "'}",
                        dataType: "json",
                        type: "POST",
                        contentType: "application/json; charset=utf-8",
        ...
        <div class="page-content">
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active">Create Sports Certificate</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            <asp:Label ID="ltUsertop" runat="server" Style="font-weight: 500; font-size: 1rem;" class="mb-0 text-uppercase" Text="Create Sports Certificate"></asp:Label>
                            <hr />
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="text-align: left;">
                                                                        <asp:LinkButton ID="lnkSelectStd" runat="server" CausesValidation="false" OnClick="lnkSelectStd_Click" Style="background: #f00; padding: 2px 5px 1px 5px; display: inline-flex; color: #fff; border-radius: 2px;"
                                                                            ToolTip="Create Sport Certificate"><i class="bx bx-certification"></i> Create</asp:LinkButton>
        ...
        <div class="modal-dialog md-width">
            ...
            <div class="modal-content" style="position: relative">
                <div class="modal-header">
                    <h3 class="modal-title" style="font-size: 20px;">Create Sport Certificate</h3>
                ...
                <div class="modal-body md-bdy">
                    ...
                    <div class="mdl-frm-row">
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <asp:Button ID="btn_create" runat="server" Text="Submit" OnClick="btn_create_Click" class="btn btn-primary" Style="width: auto !important;" ValidationGroup="ab" />
                            </div>
                        </div>
                    </div>
                </div>
