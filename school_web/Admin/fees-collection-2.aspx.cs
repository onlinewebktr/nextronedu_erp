...
{
    public partial class fees_collection_2 : System.Web.UI.Page
    {
        My mycode = new My();
                    ...
                    if (flag == true)
                    {
                        if (iS_any_payment_done == "1")
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    Response.Redirect("fees-collection-2.aspx?adm=" + lbl_admission_no.Text, false);
        ...
        private void send_data_in_fee_collection_slip(string payable, string paid, object parameter, object content, object content_id, string slip_no, string entry_id, object ledger, string adno, string session, string classs, string sction, string disc_on_feehead, object month, object monthid, string prevpaid, SqlConnection con)
        {
            ...
            string qry = "insert into Monthly_Fee_Collection_Slip(adno,session,class,Section,parameter,Content,content_id,payable,paid,slipno,Ledger,disc_amt,Month,month_position,previously_paid,Date,Idate,branchid,Hostel_id,Room_category,Created_date,Created_idate) values ('" + adno + "','" + session + "','" + classs + "','" + sction + "','" + parameter + "','" + content + "','" + content_id + "','" + My.toDouble(payable).ToString("0.00") + "','" + My.toDouble(paid).ToString("0.00") + "','" + slip_no + "','" + ledger + "','" + disc_on_feehead + "','" + month + "','" + monthid + "','" + My.toDouble(prevpaid).ToString("0.00") + "','" + txt_payment_date.Text + "','" + My.DateConvertToIdate(txt_payment_date.Text) + "','" + ViewState["Branchid"].ToString() + "','" + ViewState["Hostel_id"].ToString() + "','" + ViewState["Room_Category_id"].ToString() + "','" + mycode.date() + "','" + mycode.idate() + "');";
        ...
        private void send_data_in_fee_collection__monthly_slip(string payable, string paid, object parameter, object content, object content_id, string slip_no, string ledger, string adno, string session, string classs, string sction, string disc_on_feehead, object month, object monthid, string prevpaid, string date, string idate)
        {
            ...
            string qry = "insert into Monthly_Fee_Collection_Slip(adno,session,class,Section,parameter,Content,content_id,payable,paid,slipno,Ledger,disc_amt,Month,month_position,previously_paid,Date,Idate,branchid,Created_date,Created_idate) values ('" + adno + "','" + session + "','" + classs + "','" + sction + "','" + parameter + "','" + content + "','" + content_id + "','" + My.toDouble(payable).ToString("0.00") + "','" + My.toDouble(paid).ToString("0.00") + "','" + slip_no + "','" + ledger + "','" + disc_on_feehead + "','" + month + "','" + monthid + "','" + My.toDouble(prevpaid).ToString("0.00") + "','" + date + "','" + idate + "','" + ViewState["Branchid"].ToString() + "','" + mycode.date() + "','" + mycode.idate() + "');";
            My.exeSql(qry);
        }
        ...
        private void send_data_in_fee_collection_slip_adm(string payable, string paid, object parameter, object content, object content_id, string slip_no, string entry_id, object ledger, string adno, string session, string classs, string sction, string disc_on_feehead, object month, object monthid, string prevpaid, SqlConnection con)
        {
            ...
            string qry = "insert into Monthly_Fee_Collection_Slip(adno,session,class,Section,parameter,Content,content_id,payable,paid,slipno,Ledger,disc_amt,Month,month_position,previously_paid,branchid,academicyear,Date,Idate,Hostel_id,Created_date,Created_idate) values ('" + adno + "','" + session + "','" + classs + "','" + sction + "','" + parameter + "','" + content + "','" + content_id + "','" + payable + "','" + paid + "','" + slip_no + "','" + ledger + "','" + disc_on_feehead + "','" + month + "','" + monthid + "','" + prevpaid + "','" + ViewState["branchid"].ToString() + "','0','" + txt_payment_date.Text + "','" + My.DateConvertToIdate(txt_payment_date.Text) + "','" + ViewState["Hostel_id"].ToString() + "','" + mycode.date() + "','" + mycode.idate() + "');";
            payments.exeSql(qry, con);
        }
        #endregion
        ...
        {
            SqlCommand cmd;
            string query = "insert into Student_Payment_History(Addmission_no,Session,Date,Idate,Description,Entry_id,Slip_no,Amount,Type,mode,discount,Discoun_in_School,Discoun_in_Hostel,Discoun_in_Transport,fine,is_ofline_sync,Is_online_sync,is_update_in_online,Previous_admission_no,App_Transection_id,time,user_id,Acamedic_Semester_Id,Branch,Class_id,User_Slip_no,Pay_mode_transaction_no,Remarks,Transection_in,parameter_New,Created_date,Created_idate,Bank_name,Bank_date) values (@Addmission_no,@Session,@Date,@Idate,@Description,@Entry_id,@Slip_no,@Amount,@Type,@mode,@discount,@Discoun_in_School,@Discoun_in_Hostel,@Discoun_in_Transport,@fine,@is_ofline_sync,@Is_online_sync,@is_update_in_online,@Previous_admission_no,@App_Transection_id,@time,@user_id,@Acamedic_Semester_Id,@Branch,@Class_id,@User_Slip_no,@Pay_mode_transaction_no,@Remarks,@Transection_in,@parameter_New,@Created_date,@Created_idate,@Bank_name,@Bank_date)";
            cmd = new SqlCommand(query);
            cmd.Parameters.AddWithValue("@Addmission_no", ad_no);
            cmd.Parameters.AddWithValue("@Session", ViewState["session"].ToString());
            cmd.Parameters.AddWithValue("@Date", txt_payment_date.Text);
        ...
        private void for_discount(string session_name, string session_id, string class_id, string admission_no, string hostel_taken, string transport_taken, string hostel_id, string room_category_id, string TransportPath_id, string Boarding_Point_id)
        {
            ...
            else
            {
                ...
                {
                    queryAdm = "select feetype as content,content_id,(convert(float, payable)-convert(float, paid)) as amount,group_id,Disc as discount,'2' as Type from Typewise_fee_collection where admission_no='" + admission_no + "' and session='" + session_name + "' and (group_id='1' or group_id='2') and status='Dues' union all select fmc.content,fmc.content_id,fmc.amount,cm.group_id,'0' as discount,'1' as Type from dbo.[Fee_master_content_wise] fmc join Content_master cm on fmc.content_id=cm.content_id  where fmc.class_id='" + class_id + "' and fmc.session_id='" + session_id + "' and fmc.parameter_id='3'  and fmc.Hostel_Id=" + hostel_id + " and fmc.Room_Category_id=" + room_category_id + " and fmc.Month='" + startmonthname + "' ";
                }
                else
                {
                    if (transport_taken.ToUpper() == "YES")
            ...
            DataTable dt1 = mycode.FillData(queryAdm);
            if (dt1.Rows.Count == 0)
            {
        ...
        private void save_adm_discount_data(string txt_fee, string txt_disc_fee, string lbl_content_id, string lbl_content, SqlConnection con)
        {
            if (My.toDouble(txt_disc_fee) > 0)
            {
                string discount_fee = txt_disc_fee;
                if (My.toDouble(txt_disc_fee) > My.toDouble(txt_fee))
                {
                    discount_fee = txt_fee;
                }
                ...
                if (ViewState["parameter"].ToString() == "HostelMonthlyFee")
                {
                    ...
                    if (hd_fee_group.Value == "1") //admission fee hostel
                    {
                        ...
                        query = "select * from Discount_Master where Class_id=" + ViewState["class_id"].ToString() + " and session='" + ViewState["session"].ToString() + "' and group_id='" + hd_fee_group.Value + "' and month='NA' and admission_no='" + hd_admission_no.Value + "' and fee_head_id='" + lbl_content_id + "' and parameter_id='" + parameter_id + "' and Hostel_id=" + ViewState["Hostel_id"].ToString() + "";
                    }
                    if (hd_fee_group.Value == "2") //Annual fee hostel
                    {
                        disc_for = "Hosteler";
                ...
                else
                {
                    if (hd_fee_group.Value == "1") //admission fee
                    {
                        ...
                        parameter_id = "1";
                        discount_on = "Admission";
                        query = "select * from Discount_Master where Class_id=" + ViewState["class_id"].ToString() + " and session='" + ViewState["session"].ToString() + "' and group_id='" + hd_fee_group.Value + "' and month='NA' and admission_no='" + hd_admission_no.Value + "' and fee_head_id='" + lbl_content_id + "' and parameter_id='" + parameter_id + "'";
                    }
                    if (hd_fee_group.Value == "2") //Annual fee
                    {
                        disc_for = "Days";
                ...
                if (dt.Rows.Count == 0)
                {
                    ...
                    cmd.Parameters.AddWithValue("@session", ViewState["session"].ToString());
                    cmd.Parameters.AddWithValue("@Discount_per", My.Round((My.toDouble(discount_fee) * 100) / My.toDouble(txt_fee), 2));
                    ...
                    cmd.Parameters.AddWithValue("@fee_head_id", lbl_content_id);
                    ...
                    if (payments.InsertUpdateData(cmd, con))
                    {
                        DataTable dtF = payments.dataTable("select * from Typewise_fee_collection where admission_no='" + hd_admission_no.Value + "' and session='" + ViewState["session"].ToString() + "' and (group_id='1' or group_id='2') and content_id='" + lbl_content_id + "'", con);
                        if (dtF.Rows.Count > 0)
                        {
                ...
                else
                {
                    foreach (DataRow dr in dt.Rows)
                    {
                        dr["Discount_per"] = My.Round((My.toDouble(discount_fee) * 100) / My.toDouble(txt_fee), 2);
                        dr["fee_head_id"] = lbl_content_id;
                ...
                if (isamountfill == true)
                {
                        ...
                        for (int ixi = 0; ixi < rp_month_for_discount.Items.Count; ixi++)
                        {
                            ...
                            if (chkM.Checked == true)
                            {
                                ...
                                for (int i = 0; i < rd_discount_fee_head.Items.Count; i++)
                                {
                                    ...
                                    Label lbl_fee_type = (Label)rd_discount_fee_head.Items[i].FindControl("lbl_fee_type");
                                    totla = totla + My.toDouble(txt_fee.Text);
                                    //==============*************** 

                                    if (lbl_fee_type.Text == "2")
                                    {
                                        save_adm_discount_data(txt_fee.Text, txt_disc_fee.Text, lbl_content_id.Text, lbl_content.Text, con);
                                    }
                                    else
                                    {
                    ...
                    if (flag == true)
                    {
                        if (ViewState["issubmit"].ToString() == "1")
                        {
                            ...
                            Response.Redirect("fees-collection-2.aspx?adm=" + txt_admission_no.Text + "&sessionid=" + ddlsessionad.SelectedValue, false);
                        }
                    }
                }
                else
        ...
        private void save_bus_discount(SqlConnection con)
        {
                    ...
                    if (lbl_discount_on.Text == "Monthly" || lbl_discount_on.Text == "TransportFee")
                    {
                        ...
                        if (dt.Rows.Count == 0)
                        {
                            ...
                            if (flag == true)
                            {
                                ...
                                Response.Redirect("fees-collection-2.aspx?adm=" + lbl_admission_no.Text + "&sessionid=" + ddlsessionad.SelectedValue, false);
                            }
                        }
                        else
                        {
        ...
        protected void btn_save_extra_head_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (ViewState["issubmit"].ToString() == "1")
                {
                    ...
                    Response.Redirect("fees-collection-2.aspx?adm=" + txt_admission_no.Text, false);
                }
            }
            catch (Exception ex)
            {
        ...
        protected void lnkDelExtFee_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                using (TransactionScope scope = new TransactionScope(TransactionScopeOption.RequiresNew, new TimeSpan(1, 0, 0)))
                {
                    ...
                    payments.delete_log(lbl_session_id.Text, ViewState["classid"].ToString(), lbl_admission_no.Text, "DeleteExtraFeeHead", desc, "fees-collection-2.aspx", ViewState["Userid"].ToString(), con);
                    dues_update_headwise_transaction.update_student_dues(ViewState["sessionIDs"].ToString(), ViewState["class_id"].ToString(), lbl_admission_no.Text, "0", "0", con);
        ...
        {
            mycode.bind_all_ddl_with_id(ddl_boarding_point, " select  Boarding_Point,Boarding_Point_id from  Transportation_Boarding_Point where Transportation_Id=" + ddl_bus_name.SelectedValue + " and TransportationPath_id=" + ddl_path_root.SelectedValue + "  and Session_Id='" + ddlsessionad.SelectedValue + "' order by Boarding_Point asc");
        }
        ...
        protected void btn_Submit_Click(object sender, EventArgs e)
        {
            if (ViewState["Is_Edit_Bus"].ToString() == "1")
            {
                ...
                else
                {
                    ...
                    Response.Redirect("fees-collection-2.aspx?adm=" + ViewState["Admission_no"].ToString(), false);
                }
            }
            else
            {
...
values ('" + ViewState["Admission_no"].ToString() + "','" + class1 + "','" + ViewState["session"].ToString() + "','MonthlyFee','" + mycode.date() + "','" + mycode.idate() + "','" + TransportationFeetype + "','" + My.toDouble(Amount).ToString("0.00") + "','0','" + My.toDouble(afterdicount).ToString("0.00") + "','Dues','" + ddl_monthname.SelectedItem.Text + "','" + content_id1 + "','','School','false','false','false','" + My.toDouble(disc_amount).ToString("0.00") + "','" + section + "','" + ViewState["Userid"].ToString() + "','" + ViewState["Branchid"].ToString() + "','" + group_id + "','" + class_id + "','" + position + "','" + afterdicount.ToString("0.00") + "')", con);
            ...
            {
                Session["msg"] = "Transportation has been successfully updated.";
                Response.Redirect("fees-collection-2.aspx?adm=" + ViewState["Admission_no"].ToString() + "&sessionid=" + ddlsessionad.SelectedValue, false);
            }
        }
                ...
                if (ViewState["Is_delete_Bus"].ToString() == "1")
                {
                    ...
                    using (TransactionScope scope = new TransactionScope(TransactionScopeOption.RequiresNew, new TimeSpan(1, 0, 0)))
                    {
                        ...
                        if (payments.InsertUpdateData(cmd1, con))
                        {
                            ...
                            payments.delete_log(ViewState["sessionIDs"].ToString(), ViewState["classid"].ToString(), lbl_admission_no.Text, "RemoveTransport", desc, "fees-collection-2.aspx", ViewState["Userid"].ToString(), con);
            ...
            try
            {
                if (ViewState["Is_delete_Hostel"].ToString() == "1")
                {
                    ...
                    using (TransactionScope scope = new TransactionScope(TransactionScopeOption.RequiresNew, new TimeSpan(1, 0, 0)))
                    {
                        ...
                        payments.delete_log(ViewState["sessionIDs"].ToString(), ViewState["classid"].ToString(), lbl_admission_no.Text, "RemoveHostel", desc, "fees-collection-2.aspx", ViewState["Userid"].ToString(), con);
                        dues_update_headwise_transaction.update_student_dues(ViewState["sessionIDs"].ToString(), ViewState["class_id"].ToString(), lbl_admission_no.Text, "0", "0", con);
