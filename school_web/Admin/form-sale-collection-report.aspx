<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="form-sale-collection-report.aspx.cs" Inherits="school_web.Admin.form_sale_collection_report" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Form Sale Collection
</asp:Content>
            ...
            <div class="row" data-ng-app="RpCardApp" data-ng-controller="RpCardAppCtrl">
                ...
                <div class="col-xl-12">
                    <ul class="sub-pag-menu-ul">
                        <li><a href="dcr-all-fees.aspx">Today Collection Sheet</a></li>
                        <li><a href="form-sale-collection-report.aspx" class="sub-mnu-p-a-active">Form Sale Collection</a></li>
                    </ul>
                </div>
