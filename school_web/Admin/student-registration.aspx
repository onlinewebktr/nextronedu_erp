<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="student-registration.aspx.cs" Inherits="school_web.Admin.student_registration" %>
                        ...
                        <div class="card-body">
                            <div class="p-4 border rounded" style="padding: 0px !important;">
                                ...
                                <div class="row g-3 needs-validation" style="padding: 0px 10px 10px 10px;">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <asp:TextBox ID="txt_form_slno" runat="server" class="form-control find-dv-txtbxAdmission date"></asp:TextBox>
                                    </div>
                                    <div class="col-md-3">
                                        <label for="validationCustom01" class="form-label"> Admission date<sup>*</sup></label>
                                        <div class="clndr-div">
                                            <i class="fa fa-calendar clndr-icon" aria-hidden="true"></i>
                                            <asp:TextBox ID="txt_admission_date_old" runat="server" class="form-control find-dv-txtbx"></asp:TextBox>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <label for="validationCustom01" class="form-label">Admit in Class<sup>*</sup></label>
                                        <div class="clndr-div">
                                            <asp:DropDownList ID="ddl_old_class" runat="server" class="form-select find-dv-txtbx"></asp:DropDownList>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <label for="validationCustom01" class="form-label">Admission date(Current Session)<sup>*<asp:RequiredFieldValidator ID="RequiredFieldValidator2" Display="Dynamic" runat="server" ErrorMessage="*" ValidationGroup="a" ControlToValidate="txt_admission_date"></asp:RequiredFieldValidator></sup></label>
                                        <div class="clndr-div">
                                            <i class="fa fa-calendar clndr-icon" aria-hidden="true"></i>
                                    ...
                                    <div class="col-md-3" id="transportpath" runat="server" visible="false" style="position: relative;display:none"  >
                                        <label for="validationCustom01" class="form-label" style="width: 100%">Transportation Distance</label>
                                ...
                                <div class="row g-3 needs-validation" style="padding: 0px 10px 10px 10px;">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <asp:DropDownList ID="ddl_student_mother_tongue" runat="server" class="form-select find-dv-txtbx">
                                            ...
                                            <asp:ListItem>Rajbansi</asp:ListItem>
                                    ...
                                    <div class="col-md-3">
                                        <label for="validationCustom01" class="form-label">Jati(Cast,Mandal,Yadav etc)</label>
                            ...
                            <div class="p-4 border rounded" style="padding: 0px !important; margin: 5px 0px 0px 0px;">
                                ...
                                <div class="row g-3 needs-validation" style="padding: 0px 10px 10px 10px;">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <asp:DropDownList ID="ddl_occupation" runat="server" class="form-select find-dv-txtbx">
                                            <asp:ListItem>Others</asp:ListItem>
                            ...
                            <div class="p-4 border rounded" style="padding: 0px !important; margin: 5px 0px 0px 0px;">
                                ...
                                <div class="row g-3 needs-validation" style="padding: 0px 10px 10px 10px;">
                                    ...
                                    <div class="col-md-3">
                                        <label for="validationCustom01" class="form-label">Occupation</label>
                                        <asp:DropDownList ID="ddl_m_occupation" runat="server" class="form-select find-dv-txtbx">
                                            <asp:ListItem>Others</asp:ListItem>
                                            <asp:ListItem>State Govt. Job</asp:ListItem>
                                            <asp:ListItem>Central Govt. Job</asp:ListItem>
                                            <asp:ListItem>Private Job</asp:ListItem>
                            ...
                            <div class="p-4 border rounded" style="padding: 0px !important; margin: 5px 0px 0px 0px;">
                                ...
                                <div class="row g-3 needs-validation" style="padding: 0px 10px 10px 10px;">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <asp:TextBox ID="txt_c_state" runat="server" class="form-control find-dv-txtbx" Visible="false"></asp:TextBox>
                                        <asp:DropDownList ID="ddl_temp_state" runat="server" class="form-select find-dv-txtbx"></asp:DropDownList>
                                    </div>
                                    <div class="col-md-3">
                            ...
                            <%-- =============== --%>
                            <div class="p-4 border rounded" style="padding: 0px !important; margin: 5px 0px 0px 0px;">
                                <h2 class="form-ttleS">Upload Documents</h2>
                                <div class="row g-3 needs-validation" style="padding: 0px 10px 10px 10px;">
                                    <div class="col-md-12">
                                        <label for="validationCustom01" class="form-label">DOB Approval : </label>
                                        <asp:CheckBox ID="chk_tc" runat="server" Text="Certificate" Style="margin: 0px 20px 0px 0px" />
                                        <asp:CheckBox ID="chkaffidivit" runat="server" Text="Affidavit" />
                                    </div>


                                    <div class="col-md-3">
                                        <label for="validationCustom01" class="form-label">Student's Image</label>
                                        <asp:FileUpload ID="FileUpload1" runat="server" class="form-control find-dv-txtbx" />
                                    </div>
                                    <div class="col-md-3">
                                        <label for="validationCustom01" class="form-label">Sign. of Parent</label>
                                        <asp:FileUpload ID="FileUpload2" runat="server" class="form-control find-dv-txtbx" />
                                    </div>
                                    <div class="col-md-3">
                                        <label for="validationCustom01" class="form-label">Transfer slc</label>
                                        <asp:FileUpload ID="FileUpload3" runat="server" class="form-control find-dv-txtbx" />
                                    </div>
                                    <div class="col-md-3">
                                        <label for="validationCustom01" class="form-label">DOB Proof</label>
                                        <asp:FileUpload ID="FileUpload4" runat="server" class="form-control find-dv-txtbx" />
                                    </div>
                                    <div class="col-md-3">
                                        <label for="validationCustom01" class="form-label">Admission Form</label>
                                        <asp:FileUpload ID="FileUpload5" runat="server" class="form-control find-dv-txtbx" />
                                    </div>
