<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="annual-fee-collection.aspx.cs" Inherits="school_web.Admin.annual_fee_collection" EnableEventValidation="false" %>
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Annual Fees Collection</li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <asp:Label ID="lbl_website" runat="server"></asp:Label>
                                                        ...
                                                        <div style="margin: 7px 0px 0px 0px; padding: 0px; float: left; height: auto; text-align: center; vertical-align: middle; font-size: 13px; width: 100%;">
                                                            <span style="font-size: 14px; font-weight: bold;">Annual Fees Collection
                                                            ...
                                                            <ItemTemplate>
                                                                <tr>
                                                                    ...
                                                                    <td style="text-align: left;" class="hiddenOnPrint">
                                                                        ...
                                                                        <asp:Button ID="btn_collection" runat="server" Text="Collect Fee" CssClass="btn btn-primary" Style="padding: 1px 5px; font-size: 13px;" OnClick="btn_collection_Click" />
                                                                    </td>
                                                                    ...
                                                                    <td style="text-align: left;">
                                                                        <asp:Label ID="Label5" runat="server" Text='<%#Bind("Payable_amount")%>'></asp:Label>
