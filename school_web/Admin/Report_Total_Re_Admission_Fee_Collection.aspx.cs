...
{
    public partial class Report_Total_Re_Admission_Fee_Collection : System.Web.UI.Page
    {
        My mycode = new My();
        ...
        private void Bind_data()
        {
            ...
            {
                bind_grd_view_data("select t2.rollnumber, t2.mobilenumber, t2.studentname,t1.Addmission_no,t2.class,t2.session,t1.Date,t1.Slip_no,t1.mode,t2.Session_id,t1.Class_id,t2.Academic_Sem_or_Year,t1.Amount,t1.Type,t1.Date from Student_Payment_History t1 join admission_registor t2 on  t1.Addmission_no=t2.admissionserialnumber and  t1.session=t2.session where t1.Session='" + ddlsession.SelectedItem.Text + "' and t1.Type='Readmission'  order by t1.Idate desc");
            }
            else
            {
                bind_grd_view_data("select t2.rollnumber, t2.mobilenumber, t2.studentname,t1.Addmission_no,t2.class,t2.session,t1.Date,t1.Slip_no,t1.mode,t2.Session_id,t1.Class_id,t2.Academic_Sem_or_Year,t1.Amount,t1.Type,t1.Date from Student_Payment_History t1 join admission_registor t2 on  t1.Addmission_no=t2.admissionserialnumber and  t1.session=t2.session where     t1.Class_id='" + ddlclass.SelectedValue + "' and t1.Session='" + ddlsession.SelectedItem.Text + "' and t1.Type='Readmission'  order by t1.Idate desc");
            }
        ...
        private void bind_grd_view_data(string query)
        {
            ...
            {
                lbl_print_headS.Text = "Annual Fees Collection Summary Report of Session : " + ddlsession.SelectedItem.Text + " and Class : " + ddlclass.SelectedItem.Text;
