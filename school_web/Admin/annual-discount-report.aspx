<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="annual-discount-report.aspx.cs" Inherits="school_web.Admin.annual_discount_report" EnableEventValidation="false" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Annual Fee Discount Report
</asp:Content>
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Annual Fee Discount</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <ul class="sub-pag-menu-ul">
                        <li><a href="admission-discount-report.aspx">Admission Fees Discount List</a></li>
                        <li><a href="annual-discount-report.aspx" class="sub-mnu-p-a-active">Annual Fees Discount List</a></li>
                ...
                <div class="col-xl-12">
                    ...
                    <div class="col-xl-12">
                        <h6 class="mb-0 text-uppercase">Annual Fee Discount List</h6>
                        <hr />
                        <div class="card">
                            <div class="card-body">
                            ...
                            <asp:Label ID="lbl_website" runat="server"></asp:Label>
                                                                    ...
                                                                    <div style="margin: 7px 0px 0px 0px; padding: 0px; float: left; height: auto; text-align: center; vertical-align: middle; font-size: 13px; width: 100%;">
                                                                        <span style="font-size: 18px; font-weight: bold;">Annual Discount List
