<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="Add_Class_Routine_Student.aspx.cs" Inherits="school_web.Admin.Add_Class_Routine_Student" %>
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Set Routine Details</li>
                        </ol>
                    </nav>
                </div>
            </div>
                            ...
                            <div class="p-4 border rounded">
                                <div class="row g-3 needs-validation" novalidate="">
                                    ...
                                    <%--<div class="col-lg-3">
                                        <div class="position-relative form-group">
                                            <label>Subject</label>
                                            <asp:DropDownList ID="ddl_subject" runat="server" CssClass="form-select find-dv-txtbx">
                                            </asp:DropDownList>
                                        </div>
                                    </div>--%>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="row">
                                            <div class="col-lg-6" runat="server" id="subjectdV">
                                                <label>Subject</label>
                                                <div style="margin: 0px; padding: 0px; float: left; height: auto; width: 100%" id="Div1" runat="server">
                                                    <table id="Table2" class="table table-striped table-bordered dataTable" role="grid" aria-describedby="example2_info" style="border: 1px solid #ddd;">
                                                        <thead>
                                                            <tr>
                                                                <th>#</th>
                                                                <th></th>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="position-relative form-group">
                                                    <label>Day</label>
                                                    <asp:DropDownList ID="ddl_day" runat="server" CssClass="form-select find-dv-txtbx" Visible="false">
                                                    ...
                                                    <div style="margin: 0px; padding: 0px; float: left; height: auto; width: 100%" id="daygrid" runat="server">
                                                        <table id="Table1" class="table table-striped table-bordered dataTable" role="grid" aria-describedby="example2_info" style="border: 1px solid #ddd;">
                                                            <thead>
                                                                <tr>
                                                                    <th>#</th>
                                                                    <th class="allCheckbox1"></th>
                                                                    <th>Day</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody>
                                                                <asp:Repeater ID="rp_day" runat="server">
                                                                    <ItemTemplate>
                                                                        <tr>
                                                                            <td>
                                                                                <asp:Label ID="lbl_SL" runat="server" Text='<%#Container.ItemIndex+1 %>'></asp:Label>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="position-relative form-group">
                                                    ...
                                                    <asp:Button ID="btn_Submit" runat="server" Text="Add" Visible="false" CssClass="btn btn-primary" OnClick="btn_Submit_Click" Style="padding: 3px 40px; margin-top: 27px;" />
                                                        ...
                                                        <asp:Repeater ID="RPDetails" runat="server" OnItemDataBound="RPDetails_ItemDataBound">
                                                            <ItemTemplate>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:Label ID="Label1" runat="server" Font-Names="Arial" Text='<%#Bind("Period_Name") %>'></asp:Label>
                                                                    ...
                                                                    <td style="text-align: left;">
                                                                        <div class="user-box dropdown" style="float: left; display: inherit; height: auto; border-left: 0px solid #f0f0f0; margin-left: 0px;">
                                                                            ...
                                                                            <ul class="dropdown-menu dropdown-menu-end">
                                                                                ...
                                                                                <asp:Label ID="lbl_period_type" runat="server" Text='<%#Bind("Period_type") %>' Visible="false"></asp:Label>
