<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="Scholarship_Result_Print.aspx.cs" Inherits="school_web.Admin.Scholarship_Result_Print" EnableEventValidation="false" ValidateRequest="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Scholarship Print Result
</asp:Content>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap5 hdrmodify">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="row">
                                            <div class="col-md-3">
                                                <label for="validationCustom01" class="form-label">Scholarship Name<sup>*</sup></label>
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                <asp:LinkButton ID="LinkButton1" Visible="false"  OnClick="LinkButton1_Click" Style="margin: 24px 0px 0px 10px !important;" CssClass="btn btn-primary find-dv-btn" runat="server"
                                                    ToolTip="Print"  ><i class='bx bx-printer'></i>Print All</asp:LinkButton>
                            ...
                            <asp:Label ID="lbl_website" runat="server"></asp:Label>
                                                        ...
                                                        <div style="margin: 7px 0px 0px 0px; padding: 0px; float: left; height: auto; text-align: center; vertical-align: middle; font-size: 13px; width: 100%;">
                                                            <span style="font-size: 14px; font-weight: bold;">Scholarship Print Result
                                                ...
                                                <asp:Panel ID="Panel1" runat="server">
                                                    <table id="example2" class="table table-striped table-bordered dataTable" data-page-length='1500' role="grid" aria-describedby="example2_info">
                                                        <thead>
                                                            <tr>
                                                                <th>#</th>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <div class="user-box dropdown" style="float: left; display: inherit; height: auto; border-left: 0px solid #f0f0f0; margin-left: 0px;">
                                                                                ...
                                                                                <ul class="dropdown-menu dropdown-menu-end">
                                                                                    ...
                                                                                    <li>
                                                                                        <a href="slip/Print_Result_Scholarship_Reg.aspx?Scholorshipid=<%#Eval("Test_id") %>&admin=<%#Eval("Registration_id") %>&type=in_s" target="_blank"><i class='bx bx-printer'></i><span>Print</span></a>
                                                                                    </li>
                                                                                </ul>
                                                                            </div>
                                                                        </td>
