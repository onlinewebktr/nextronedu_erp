<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="Report_Total_Admission_Fee_Collection_Today.aspx.cs" Inherits="school_web.Admin.Report_Total_Admission_Fee_Collection_Today" EnableEventValidation="false" ValidateRequest="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Admission Fees Collection Today
</asp:Content>
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Admission Fees Collection Today</li>
                        </ol>
                    </nav>
                </div>
            </div>
                                ...
                                <div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap5 hdrmodify">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <div class="grd-wpr" id="tblPrintIQ" runat="server"> 
                                                <div class="col-sm-12"> 
