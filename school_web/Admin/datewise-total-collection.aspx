<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="datewise-total-collection.aspx.cs" Inherits="school_web.Admin.datewise_total_collection" EnableEventValidation="false" ValidateRequest="false" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Date-Wise Total Collection
</asp:Content>
            ...
            <div class="row" data-ng-app="ComplainApp" data-ng-controller="ComplainAppCtrl">
                <div class="col-xl-12">
                    <ul class="sub-pag-menu-ul">
                        <li><a href="total-outstanding.aspx" class="sub-mnu-p-a-active">Total Outstanding</a></li>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="find-dv">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-2">
                                                    <label for="validationCustom01" class="find-dv-lbl">From Date</label>
                                                    <asp:TextBox ID="txt_from_date" runat="server" class="form-control txtbx-ddl-style datepicker"></asp:TextBox> 
                                                </div>
                                                <div class="col-sm-2">
                                                    <label for="validationCustom01" class="find-dv-lbl">To Date</label>
                                                    <asp:TextBox ID="txt_to_date" runat="server" class="form-control txtbx-ddl-style datepicker"></asp:TextBox> 
                                                </div> 
                                                <div class="col-sm-1">
                                                                        ...
                                                                        <asp:Repeater ID="rd_view" runat="server">
                                                                            <ItemTemplate>
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:Label ID="Label2" runat="server" Text='<%#Bind("Total_collection")%>'></asp:Label>
                                                                                    </td> 
                                                                                </tr>
                                                                            </ItemTemplate>
                                                                        </asp:Repeater>
