<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="Hostel_Damage_Item_View_Mapped_With_Student.aspx.cs" Inherits="school_web.Admin.Hostel_Damage_Item_View_Mapped_With_Student" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    View Mapped Damage Item with Student
</asp:Content>
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Set Discount Student Wise</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="col-xl-12">
                    <div class="col-xl-12">
                        <ul class="sub-pag-menu-ul">
                            ...
                            <li><a href="Hostel_Damage_Item_Mapping_With_Student.aspx">Damage Item Mapping</a></li>

                            <li><a href="Hostel_Damage_Item_View_Mapped_With_Student.aspx" class="sub-mnu-p-a-active">View Item Mapped </a></li>
                        </ul>
                    </div>
                </div>
                <hr />
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="p-4 border rounded"> 
                                <div class="col-xl-12">
                                    <h6 class="mb-0 text-uppercase">Added Student Wise Mapped Damaged Item</h6>
                                    <hr />
                                    <div class="card">
                                        <div class="card-body">
                                                            ...
                                                            <div class="find-dv">
                                                                <div class="row">
                                                                    <div class="col-sm-3">
                                                                        ...
                                                                        <asp:DropDownList ID="ddl_month" runat="server" class="form-select find-dv-txtbx" AutoPostBack="true" OnSelectedIndexChanged="ddl_month_SelectedIndexChanged"></asp:DropDownList>
                                                                    </div>
                            ...
                            <asp:Label ID="lbl_website" runat="server"></asp:Label>
                                                                                ...
                                                                                <div style="margin: 7px 0px 0px 0px; padding: 0px; float: left; height: auto; text-align: center; vertical-align: middle; font-size: 13px; width: 100%;">
                                                                                    <span style="font-size: 14px; font-weight: bold;">Maped Damaged Item
...
<td style="text-align: left;">
                                                                                                ...
                                                                                                <td style="text-align: left;">
                                                                                                    <asp:Label ID="lbl_month" runat="server" Text='<%#Bind("For_motn_name")%>'></asp:Label>
                                                                                                </td>
                                                                                                <td style="text-align: left;">
                                                                                                    <asp:Label ID="lbl_content" runat="server" Text='<%#Bind("Item_name")%>'></asp:Label>
                                                                                                </td>
                                                                                                <td style="text-align: left;">
