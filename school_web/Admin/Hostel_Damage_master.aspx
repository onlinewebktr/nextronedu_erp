<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="Hostel_Damage_master.aspx.cs" Inherits="school_web.Admin.Hostel_Damage_master" EnableEventValidation="false" %>
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Damage Item Master</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-xl-12">
                    ...
                    <ul class="sub-pag-menu-ul">
                        <li><a href="Hostel_Damage_master.aspx" class="sub-mnu-p-a-active">Item Master</a></li>
                ...
                <div class="col-xl-4">
                    <asp:Label ID="ltUsertop" runat="server" Style="font-weight: 500; font-size: 1rem;" class="mb-0 text-uppercase" Text="Item Master"></asp:Label>
                    <hr />
                    <div class="card">
                        <div class="card-body">
                ...
                <div class="col-xl-8">
                    <h6 class="mb-0 text-uppercase">Added Item Master</h6>
                    <hr />
                    <div class="card">
                        <div class="card-body">
                            ...
                            <asp:Label ID="lbl_website" runat="server"></asp:Label>
                                                                ...
                                                                <div style="margin: 7px 0px 0px 0px; padding: 0px; float: left; height: auto; text-align: center; vertical-align: middle; font-size: 13px; width: 100%;">
                                                                    <span style="font-size: 14px; font-weight: bold;">Item Master
                                                                    ...
                                                                    <asp:Repeater ID="rd_view" runat="server">
                                                                        <ItemTemplate>
                                                                            <tr>
                                                                                ...
                                                                                <td style="text-align: left;">
                                                                                    <asp:Label ID="lbl_price" runat="server" Text='<%# Getamount_comma_seperated(Eval("Price").ToString())%>'></asp:Label>
                                                                                </td>
