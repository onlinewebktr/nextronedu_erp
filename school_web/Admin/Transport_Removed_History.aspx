<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="Transport_Removed_History.aspx.cs" Inherits="school_web.Admin.Transport_Removed_History" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Transport Removed History
</asp:Content>
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Removed History</li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <asp:Label ID="lbl_website" runat="server"></asp:Label>
                                                                    ...
                                                                    <div style="margin: 7px 0px 0px 0px; padding: 0px; float: left; height: auto; text-align: center; vertical-align: middle; font-size: 13px; width: 100%;">
                                                                        <span style="font-size: 14px; font-weight: bold;">Transportation Removed History<asp:Label ID="lbl_class22" runat="server"></asp:Label></span>
                                                            ...
                                                            <asp:GridView ID="GrdView" runat="server" class="table table-bordered" AutoGenerateColumns="False" Width="100%"  >
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="End Month">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lbl_End_name" runat="server" Text='<%#Bind("Remove_Update_Month")%>'></asp:Label>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="Remove Date">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lbl_removedate" runat="server" Text='<%#Bind("Removed_date")%>'></asp:Label>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="Remove Remarks">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lbl_removedateremarks" style="word-break:break-all" runat="server" Text='<%#Bind("Remarks")%>'></asp:Label>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                </Columns>
                                                            </asp:GridView> 
