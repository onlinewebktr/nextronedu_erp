<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="report-headwise-monthley-fee.aspx.cs" Inherits="school_web.Admin.report_headwise_monthley_fee" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Head wise Monthly Fees Collection
</asp:Content>
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Day End Report of Monthly Fee</li>
                        </ol>
                    </nav>
                </div>
            </div>
            <div class="row" data-ng-app="RpCardApp" data-ng-controller="RpCardAppCtrl">
                <div class="col-xl-12">
                    ...
                    <ul class="sub-pag-menu-ul">
                        <li><a href="Today_Collection.aspx">Today All Collection </a></li>
                        <li><a href="day-end-report-typewise.aspx" class="sub-mnu-p-a-active"><%--Day End Report of --%>Monthly Fee Collection Report</a></li>
