<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="set-discount-on-annual-fee.aspx.cs" Inherits="school_web.Admin.set_discount_on_annual_fee" EnableEventValidation="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Set Discount on Annual Fees
</asp:Content>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <ul class="sub-pag-menu-ul sub-pag-menu-ul-mrgn">
                        ...
                        <li><a href="set-discount-on-annual-fee.aspx" class="sub-mnu-p-a-active">Annual Fees</a></li>
                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            <asp:Label ID="ltUsertop" runat="server" Style="font-weight: 500; font-size: 1rem;" class="mb-0 text-uppercase" Text="Set Discount for Annual Fees"></asp:Label>
                            <hr />
                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            <h6 class="mb-0 text-uppercase">Added Discount for Annual Fees</h6>
                            <hr />
                            ...
                            <asp:Label ID="lbl_website" runat="server"></asp:Label>
                                                                ...
                                                                <div style="margin: 7px 0px 0px 0px; padding: 0px; float: left; height: auto; text-align: center; vertical-align: middle; font-size: 13px; width: 100%;">
                                                                    <span style="font-size: 14px; font-weight: bold;">Discount Annual Fee
