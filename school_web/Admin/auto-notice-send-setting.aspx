<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="auto-notice-send-setting.aspx.cs" Inherits="school_web.Admin.auto_notice_send_setting" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xl-12">
                    <h6 class="mb-0 text-uppercase">Added Template Setting</h6>

                    <ul class="add-popup-ul">
                        <li><a href="#!" data-toggle="modal" data-target="#Mdladd"><span>+</span> Template Setting</a></li>
                    </ul>
                    <hr />
                    <div class="card">
                        <div class="card-body">
                                                        ...
                                                        <asp:Repeater ID="rd_view" runat="server" OnItemDataBound="rd_view_ItemDataBound">
                                                            <ItemTemplate>
                                                                <tr>
                                                                    ...
                                                                    <td style="text-align: left;">
                                                                        <asp:Label ID="lbl_notice_message" runat="server" Text='<%#Bind("Message_template")%>'></asp:Label>
                                                                    </td>
                                                                    <td style="text-align: left;">
                                                                        <asp:Label ID="lbl_send_date_day" runat="server" Text='<%#Bind("Send_date_day")%>'></asp:Label>
                                                                    </td>
                                                                    <td style="text-align: left;">
                                                                        <asp:Label ID="lbl_time_hr" runat="server" Text='<%#Bind("Time_hr")%>'></asp:Label>
                                                                        <asp:Label ID="lbl_time_mn" runat="server" Text='<%#Bind("Time_mn")%>'></asp:Label>
                                                                        <asp:Label ID="lbl_time_ap_pm" runat="server" Text='<%#Bind("Time_ap_pm")%>'></asp:Label>
                                                                    </td>
                                                                    <td style="text-align: left;">
        ...
        <div class="modal-dialog" style="max-width: 500px;">
            <div class="modal-content">
                <div class="modal-header" style="padding: 3px 17px;">
                    <h5 class="modal-title" style="font-size: 18px; padding: 5px 0px 0px 0px;">Template Setting</h5>
                    ...
                    <div class="p-4 border rounded" style="float: left; width: 100%;">
                        <div class="disc-tbl-wprs">
                            ...
                            <div class="row g-3 needs-validation">
                                ...
                                <div class="col-md-12" runat="server" id="msgTemplate" visible="false">
                                    <label for="validationCustom01" class="form-label">Template<sup>*</sup></label>
                                    <asp:Label ID="lbl_msg_template" class="form-control" runat="server"></asp:Label>
                                </div>

                                <div class="col-md-12">
                                    <label for="validationCustom01" class="form-label">Send Date<sup>*</sup></label>
                                    <asp:DropDownList ID="ddl_date" runat="server" class="form-select">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4" style="padding-right: 0px; display: none">
                                            <asp:DropDownList ID="ddl_minute" runat="server" class="form-select"> 
                                ...
                                <div class="col-12">
                                    <asp:Button ID="btn_Submit" runat="server" Text="Add" CssClass="btn btn-primary" OnClick="btn_Submit_Click1" />
