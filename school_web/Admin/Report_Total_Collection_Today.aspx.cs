...
{
    public partial class Report_Total_Collection_Today : System.Web.UI.Page
    {
        My mycode = new My();
        protected void Page_Load(object sender, EventArgs e)
        {
                    ...
                    else
                    {
                        ...
                        try
                        {
                            if (Request.QueryString["sessionid"] != null)
                            {
                                ...
                                txt_date1.Text = ViewState["Date"].ToString();
            ...
            {
                My.submitException(ex, "Report_Total_Collection_Today");
            }
        }
        ...
        private void Bind_data()
        {
            ...
            {
                bind_grd_view_data("select t2.rollnumber, t2.mobilenumber, t2.studentname,t1.Addmission_no,t2.class,t2.session,t1.Date,t1.Slip_no,t1.mode,t2.Session_id,t1.Class_id,t1.Amount,t1.Type,t1.Date from Student_Payment_History t1 join admission_registor t2 on  t1.Addmission_no=t2.admissionserialnumber and t1.session=t2.session where t1.Idate=" + mycode.ConvertStringToiDate(txt_date1.Text) + "  order by t1.Idate desc");
            }
            else
            {
                bind_grd_view_data("select t2.rollnumber, t2.mobilenumber, t2.studentname,t1.Addmission_no,t2.class,t2.session,t1.Date,t1.Slip_no,t1.mode,t2.Session_id,t1.Class_id,t1.Amount,t1.Type,t1.Date from Student_Payment_History t1 join admission_registor t2 on  t1.Addmission_no=t2.admissionserialnumber and t1.session=t2.session where t1.Class_id='" + ddlclass.SelectedValue + "' and  t1.Idate=" + mycode.ConvertStringToiDate(txt_date1.Text) + "  order by t1.Idate desc");
            }
        }
        ...
        private void bind_grd_view_data(string query)
        {
            ...
            {
                lbl_print_headS.Text = "Total Collection Summary Report of Date : " + txt_date1.Text + "  and Class : " + ddlclass.SelectedItem.Text;
        ...
        protected void btn_excels_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=Total_Collection_Today" + "_" + DateTime.Now + ".xls");
            Response.Charset = "";
