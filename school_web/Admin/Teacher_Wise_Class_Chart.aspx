<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="Teacher_Wise_Class_Chart.aspx.cs" Inherits="school_web.Admin.Teacher_Wise_Class_Chart" EnableEventValidation="false" ValidateRequest="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
   Teacher Class Routine Chart
</asp:Content>
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Teacher Class Routine Chart</li>
                        </ol>
                    </nav>
                </div>
            </div>
                                            ...
                                            <div class="find-dv">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-2">
                                                        ...
                                                        <asp:DropDownList ID="ddl_section" runat="server" class="form-select" AutoPostBack="true" OnSelectedIndexChanged="ddl_section_SelectedIndexChanged"></asp:DropDownList>
                                                    </div>

                                                    <div class="col-sm-2">
                                                        <label for="validationCustom01" class="find-dv-lbl">Teacher</label>
                                                        <asp:DropDownList ID="ddl_teacher" runat="server" class="form-select"></asp:DropDownList>
                                                    </div>
