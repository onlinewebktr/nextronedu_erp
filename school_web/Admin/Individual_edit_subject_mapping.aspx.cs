    ...
    public partial class Individual_edit_subject_mapping : System.Web.UI.Page
    {
        ...
        private void find_student()
        {
            ...
            else
            {
                ...
                Session["Session_id"] = dt.Rows[0]["Session_id"].ToString();
                Session["Class_id"] = dt.Rows[0]["Class_id"].ToString();
        ...
        protected void lnk_back_Click(object sender, EventArgs e)
        {
            try
            {
                Response.Redirect("mapped-sub-with-student.aspx?sid=" + Session["Session_id"].ToString() + "&cid=" + Session["Class_id"].ToString() + "&sec=" + Session["Section"].ToString(), false);
            }
            catch (Exception ex)
            {
            }
