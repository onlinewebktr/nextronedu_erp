<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="collect-annual-fees.aspx.cs" Inherits="school_web.Admin.collect_annual_fees" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        function openModalPrevious() {
            $('#MdlUpload_Previous_Payment').modal('show');
        }
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Collect Annual Fees</li>
                        </ol>
                    </nav>
                </div>
            </div>
            <ul class="sub-pag-menu-ul sub-pag-menu-ul-mrgn" style="position: absolute; right: 6px; float: none; top: 25px; width: auto;">
                <li><a id="a2" runat="server" class="sub-mnu-p-a-active">Set Discount on Annual Fees</a></li>
                ...
                <li><a id="a3" runat="server" data-toggle="modal" data-target="#MdlUpload_Previous_Payment" class="sub-mnu-p-a-active btn-info" style="background: #ff2c5b; border: 1px solid #001017; cursor: pointer;">Upload Previous Year Dues of Exist</a></li>
            </ul> 
                                ...
                                <div class="row">
                                    <div class="col-xl-6" style="padding-right: 0px">
                                        <div class="adm-box-wprs1">
                                            <asp:Label ID="Label4" runat="server" class="mb-0 text-uppercase" Style="font-weight: 500; font-size: 1rem;" Text="Annual Fees Deatils"></asp:Label>
                                    ...
                                    <div class="col-xl-6" style="padding-left: 0px">
                                        <div class="adm-box-wprs3">
                                            ...
                                            <div class="col-md-9" style="display:none"> 
                                                <asp:CheckBox ID="chk_split_month" runat="server" Text="Is Split Month" Checked="false" AutoPostBack="true" OnCheckedChanged="chk_split_month_CheckedChanged1" Visible="false" />
                                            </div> 
                                            <div class="col-md-3"> </div>
                                            <div class="col-md-9">
                                                <table class="table tab-content" id="splitmonth" runat="server" visible="false" style="background: #fff; border: 1px solid;">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered table-striped" OnRowDataBound="GridView1_RowDataBound" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" Width="100%" Style="text-align: center; margin: 0px 0px 0px 0px;" ShowFooter="True">
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="Sl. No.">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lbl_sln" runat="server" Text='<%#Container.DataItemIndex+1%>'></asp:Label>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Amount">
                                                                        <ItemTemplate>
                                                                            <asp:TextBox ID="txt_split_month_fee" runat="server" onkeypress="return isNumberKey(event)" OnTextChanged="txt_split_month_fee_TextChanged" Style="width: 50px" AutoPostBack="true"></asp:TextBox>
                                                                        </ItemTemplate>
                                                                        <FooterTemplate>
    ...
    <!--Start Upload Previous-->
    <div id="MdlUpload_Previous_Payment" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog" style="max-width: 800px;">
            <div class="modal-content">
                <div class="modal-header" style="padding: 27px 11px 9px 17px; background: #dbd2d2;">
                    <h5 class="modal-title" style="font-size: 18px; padding: 5px 0px 0px 0px;">Upload Previous Year Dues of Exist</h5>
                        ...
                        <div class="disc-tbl-wprs">
                            ...
                            <div class="prowwprs">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <asp:TextBox ID="txt_Old_Session" Style="width: 100%; border: 1px solid #000;" ReadOnly="true" runat="server"></asp:TextBox>
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        <asp:TextBox ID="txt_old_dues_amount" onkeypress="return isNumberKey(event)" runat="server" Style="width: 100%; border: 1px solid #000;"></asp:TextBox>
                                    </div>
                                    <div class="col-md-2">
                                        <asp:Button ID="btn_upload_Previous_year_dues" OnClick="btn_upload_Previous_year_dues_Click" runat="server" Text="Add" CssClass="btn btn-primary" />
                                    </div>
                                </div>
                            </div>
                        </div>
