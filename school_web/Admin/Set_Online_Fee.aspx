<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="Set_Online_Fee.aspx.cs" Inherits="school_web.Admin.Set_Course_Fee" EnableEventValidation="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Set Online Registration Fee  
</asp:Content>
    ...
    <div class="page-wrapper">
        <div class="page-content">
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Set Online Registration Fee  </li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-xl-12">
                    <h6 class="mb-0 text-uppercase" style="position: relative">Added Online Registration Fee  
                        <a href="#" data-toggle="modal" data-target="#myModal" class="add-forpopup-btn"><i class="bx bx-upload"></i>Add New Class Fee for Online Registration</a></h6>
                    <hr />
                    <div class="card">
                        <div class="card-body">
                                                ...
                                                <div class="prnt-dv-wpr">
                                                    ...
                                                    <div class="pgslry-head-div head" style="border-bottom: 1px solid #000; margin: 0px; float: left; width: 100%;">
                                                        ...
                                                        <div style="margin: 0px; padding: 0px; height: 110px; width: 80%; float: left;">
                                                            ...
                                                            <div style="margin: 7px 0px 0px 0px; padding: 0px; float: left; height: auto; text-align: center; vertical-align: middle; font-size: 13px; width: 100%;">
                                                                <span style="font-size: 14px; font-weight: bold;">Set Online Registration Fee -<asp:Label ID="lbl_class22" runat="server"></asp:Label></span>
                                                        ...
                                                        <table id="example21" class="table table-striped table-bordered dataTable" role="grid" aria-describedby="example2_info">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th>Total filled Application</th>
                                                                    <th>Payment Mode</th>
                                                                    <th>Is Active</th>
                                                                    <th></th>
                                                                </tr>
                                                                            ...
                                                                            <td style="text-align: left;">
                                                                                <%--<div class="user-box dropdown" style="float: left; display: inherit; height: auto; border-left: 0px solid #f0f0f0; margin-left: 0px;">
                                                                                    ...
                                                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                                                        ...
                                                                                        <li>
                                                                                            <asp:LinkButton ID="lnkActive" runat="server" OnClick="lnkActive_Click">Active</asp:LinkButton>
                                                                                        </li>
                                                                                    </ul>
                                                                                </div>--%>
                                                                                 <div class="user-box dropdown" style="float: left; display: inherit; height: auto; border-left: 0px solid #f0f0f0; margin-left: 0px;">
                                                                                    ...
                                                                                    <ul class="dropdown-menu dropdown-menu-end"> 
                                                                                        ...
                                                                                        <li>
                                                                                            <asp:LinkButton ID="lnkActive" class="dropdown-item" runat="server" CausesValidation="false" OnClick="lnkActive_Click" ToolTip="Documents"> <i class="bx bxs-image-add"></i><span>Active</span></asp:LinkButton>
                                                                                        </li>
                                                                                    </ul>
                                                                                </div> 
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Course Fee</h5>
    ...
    <div class="modal fade" id="myModal" role="dialog" style="top: 0px">
        <div class="modal-dialog md-width" style="max-width: 600px;">
            ...
            <div class="modal-content" style="position: relative">
                <div class="modal-header">
                    <h3 class="modal-title" style="font-size: 20px;">Add New Class Fee for Online Registration</h3>
                ...
                <div class="modal-body md-bdy">
                    <div class="row g-3 needs-validation" novalidate="">
                        ...
                        <div class="col-md-6">
                            <label for="validationCustom01" class="form-label">Test <sup>* </sup></label>
                            <asp:DropDownList ID="ddl_test" runat="server" class="form-select"></asp:DropDownList>
                        </div>
                        <div class="col-md-6">
                            <label for="validationCustom01" class="form-label">Course Name <sup>* </sup></label>
                            <asp:DropDownList ID="ddl_coursename" runat="server" class="form-select"></asp:DropDownList>
                        </div>
                        <div class="col-md-6">
