<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="Account_Wise_Payment_Report.aspx.cs" Inherits="school_web.Admin.Account_Wise_Payment_Report" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Account Wise Payment History
</asp:Content>
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Account Wise Payment History</li>
                        </ol>
                    </nav>
                </div>
            </div>
                                            ...
                                            <div id="tblPrintIQ" runat="server">
                                                <div class="pgslry-head-div head" style="border-bottom: 1px solid #000; margin: 0px; float: left; width: 100%;">
                                                    ...
                                                    <div style="margin: 0px; padding: 0px; height: 110px; width: 80%; float: left;">
                                                        ...
                                                        <div style="margin: 7px 0px 0px 0px; padding: 0px; float: left; height: auto; text-align: center; vertical-align: middle; font-size: 13px; width: 100%;">
                                                            <span style="font-size: 14px; font-weight: bold;">Account Wise Payment History
                                                            ...
                                                            <asp:Repeater ID="grd_view" runat="server">
                                                                <ItemTemplate>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <asp:Label ID="lbl_cr_account" runat="server" Visible="false" Text='<%#Eval("Credit","{0:n}") %>'></asp:Label>
                                                                            <asp:Label ID="lbl_dr_account" runat="server" Text='<%#Eval("Debit","{0:n}") %>'></asp:Label>
                                                                        </td>
                                                        ...
                                                        <tfoot>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <asp:Label Visible="false" ID="txt_total_credit" runat="server"></asp:Label>
                                                                </td>
                                                            </tr>
        ...
        function searching_by_ledger_name() {
            $("#<%=txt_account_name.ClientID%>").autocomplete({
                ...
                source: function (request, response) {
                    $.ajax({
                        url: 'Account_Wise_Payment_Report.aspx/Search_particular',
