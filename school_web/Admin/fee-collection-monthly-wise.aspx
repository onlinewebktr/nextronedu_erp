<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="fee-collection-monthly-wise.aspx.cs" Inherits="school_web.Admin.fee_collection_monthly_wise" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <asp:Button ID="btn_set_discount" Visible="false" runat="server" Text="Set Discount" CssClass="btn btn-success form-fnd-btns" OnClick="btn_set_discount_Click" />
                                                        ...
                                                        <div class=" row">
                                                            <div class="col-md-8">
                                                                <div class="imp-info-lft">
                                                                    ...
                                                                    <asp:Button ID="btn_admission_fee" runat="server" CssClass="button-61 collectadmissionfeebtn noclick" OnClick="btn_admission_fee_Click" />
                            ...
                            <asp:Label ID="lbl_website" runat="server"></asp:Label>
                                        ...
                                        <div class="col-xl-6" style="padding-left: 5px">
                                            <div class="fnd-box-wpr" style="margin: 5px 0px 0px 0px;">
                                                ...
                                                <div class="fnd-box-wpr-inr">
                                                    <div class="fnd-box-row-wpr">
                                                        <div class="col-md-12" style="background: #FFBA5F; padding: 3px 4px 4px 6px;">
