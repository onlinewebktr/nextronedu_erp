<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="Payment_Voucher.aspx.cs" Inherits="school_web.Admin.Payment_Voucher" ValidateRequest="false" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $("#Payment_Voucher").addClass("dcjq-parent active");
        });
    </script>
    <style>
        .maste-p {
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xl-4">
                    <asp:Label ID="ltUsertop" runat="server" Style="font-weight: 500; font-size: 1rem;" class="mb-0 text-uppercase" Text=" Add Payment Voucher"></asp:Label>
                    <hr />
                    <div class="card">
                        <div class="card-body">
                            <div class="p-4 border rounded">
                                <table style="width: 100%">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="position-relative form-group">
                                                <asp:DropDownList ID="ddl_account_cr" runat="server" CssClass="form-control" style="width:59%!important">
                                                </asp:DropDownList>
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="position-relative form-group">
                                                <asp:TextBox ID="txt_remarks" runat="server" CssClass="form-control" TextMode="MultiLine" style="height:100px"></asp:TextBox>
                                            </div>
                                        </td>
                                    </tr>
                                      ...
                                      <tr>
                                        <td>
                                            <div class="position-relative form-group">
                                                <label>Attachment(<sup> jpg,png,pdf </sup>)</label>
                                        ...
                                        <td>
                                            ...
                                            ErrorMessage="Invalid File. Please upload a File with extension: png, jpg, jpeg,pdf" ForeColor="Red"
                    ...
                    <div class="card">
                        <div class="card-body">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="find-dv">
                                            <div class="row">
                                                        ...
                                                        <td>
                                                            <div class="position-relative form-group">
                                                                ...
                                                                <div class="col-lg-6" style="padding: 0px;">
                                                                    <asp:TextBox ID="txt_fromdate" runat="server" CssClass="form-control datecalender" placeholder="dd/MM/yyyy" style="width: 100%;"></asp:TextBox>
                                                                </div>
                                                                <div id="fromtime" runat="server" visible="false" class="col-lg-6" style="padding: 0px;">
                                                                    <asp:TextBox ID="txt_fromtime" data-provide="timepicker" CssClass="form-control timepicker" runat="server"  style="width: 100%;"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="position-relative form-group">
                                                                ...
                                                                <div class="col-lg-6" style="padding: 0px;">
                                                                    <asp:TextBox ID="txt_to_date" runat="server" CssClass="form-control datecalender" placeholder="dd/MM/yyyy"  style="width: 100%;"></asp:TextBox>
                                                                </div>
                                                                <div id="totime" runat="server" visible="false" class="col-lg-6" style="padding: 0px;">
                                                                    <asp:TextBox ID="txt_to_time" data-provide="timepicker" CssClass="form-control timepicker" runat="server"  style="width: 100%;"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td>
                                                ...
                                                <table style="width: 100%; margin: 0px auto; background-color: beige;" class="noPrint">
                                                    <tr>
                                                        <td>Enter Payment Voucher No.</td>
                                                        <td>
                                                            <asp:TextBox ID="txt_Voucher" runat="server" CssClass="form-control" Style="width:100%"></asp:TextBox>
                                                        </td>
                                                        <td>
                            ...
                            <asp:Label ID="lbl_website" runat="server"></asp:Label>
                                                                ...
                                                                <div style="margin: 7px 0px 0px 0px; padding: 0px; float: left; height: auto; text-align: center; vertical-align: middle; font-size: 13px; width: 100%;">
                                                                    <span style="font-size: 14px; font-weight: bold;">Payment History
                                                            ...
                                                            <asp:GridView ID="grd_bill_trac" runat="server" class="mb-0 table table-bordered" ShowFooter="true" OnRowDataBound="grd_bill_trac_RowDataBound" AutoGenerateColumns="False" Width="100%">
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Remark" HeaderStyle-ForeColor="Maroon">
                                                                     ...
                                                                     <asp:TemplateField HeaderText="Attachment" HeaderStyle-ForeColor="Maroon">
                                                                        <ItemTemplate>
