...
{
    public partial class admission_fee_dcr : System.Web.UI.Page
    {
        My mycode = new My();
            ...
            try
            {
                if (!IsPostBack)
                {
                    ...
                    else
                    {
                        ...
                        hd_std_type.Value = ddl_student_type.SelectedValue;
        ...
        private void find_firm_details()
        {
            ...
            else
            {
                ...
                forMilliaKsba.Visible = false;
                forallSchool.Visible = true;
                if (dt.Rows[0]["firm_id"].ToString() == "MCES-002")
                {
                    forMilliaKsba.Visible = true;
                    forallSchool.Visible = false;
                }
            }
        }
        string scrpt;
        ...
        private void get_class_id()
        {
            if (ddl_class.SelectedValue == "0")
            {
                ...
                lbl_class22.Text = "Date : " + txt_from_date.Text + " to " + txt_to_date.Text + ", Session : " + ddl_session.SelectedItem.Text;
                if (txt_from_date.Text == txt_to_date.Text)
                {
                    ...
                    lbl_class22.Text = "Date : " + txt_from_date.Text + " - " + datatimes.ToString("dddd") + ", Session : " + ddl_session.SelectedItem.Text;
                }
            }
            else
            {
                hd_class_name.Value = ddl_class.SelectedItem.Text;
                lbl_class22.Text = "Date : " + txt_from_date.Text + " to " + txt_to_date.Text + ", Session : " + ddl_session.SelectedItem.Text + ", Class : " + ddl_class.SelectedItem.Text;
                if (txt_from_date.Text == txt_to_date.Text)
                {
                    DateTime datatimes = DateTime.ParseExact(txt_from_date.Text, "dd/MM/yyyy", CultureInfo.InvariantCulture);
                    lbl_class22.Text = "Date : " + txt_from_date.Text + " - " + datatimes.ToString("dddd") + ", Session : " + ddl_session.SelectedItem.Text + ", Class : " + ddl_class.SelectedItem.Text;
                }
            }
        }
