<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="report-student-headwise-annual-fee-collection.aspx.cs" Inherits="school_web.Admin.report_student_headwise_annual_fee_collection" EnableEventValidation="false" ValidateRequest="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Student Wise Annual Fee Collection
</asp:Content>
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Student & Head wise Annual Fees Collection</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-xl-12"> 
                    <ul class="sub-pag-menu-ul">
                        ...
                        <li><a href="report-student-headwise-annual-fee-collection.aspx" class="sub-mnu-p-a-active">Student & Head wise Fee Collection</a></li>
                    </ul>
                    </div>
                <div class="col-xl-12">
                    <hr />
                        ...
                        <div class="card-body">
                            ...
                            <asp:Label ID="lbl_website" runat="server"></asp:Label>
                                                            ...
                                                            <asp:Panel ID="pnl_grid" runat="server" Style="width: 100%;">
                                                                <asp:GridView ID="GridView2" runat="server" CssClass="table table-bordered table-striped" Style="width: 100%" AutoGenerateColumns="true" OnRowCreated="GridView2_RowCreated" ShowFooter="true">
                                                                </asp:GridView>
                                                            </asp:Panel>
                                                        </div>
                                                    </div>
