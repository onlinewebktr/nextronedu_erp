<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="Student_Stup_And_Start.aspx.cs" Inherits="school_web.Admin.Student_Stup_And_Start" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">Student Stop and Start Student
</asp:Content>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#<%=txt_student_name.ClientID%>").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        url: 'Student_Stup_And_Start.aspx/GetRooPath',
        ...
        $(function () {
            ...
            $("#<%=txt_admission_no.ClientID%>").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        url: 'Student_Stup_And_Start.aspx/GetRooPathAdmNo',
                        data: "{ 'PathRooT': '" + request.term + "',Session_id:'" + sessionid + "'}",
                        dataType: "json",
                        type: "POST",
                        contentType: "application/json; charset=utf-8",
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Student Stop and Start Student</li>
                        </ol>
                    </nav>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            <div class="p-4 border rounded">
                                            ...
                                            <div class="fnd-box-wpr-inr">
                                                <div class="fnd-box-row-wpr">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xl-3">
                                                            <asp:Button ID="btn_find_admission_no" runat="server" Text="Find" style="    margin: 22px 0px 0px 0px;" CssClass="btn btn-primary form-fnd-btns" OnClick="btn_find_admission_no_Click" />
                                                        </div>
                                                    </div> 
                                                </div> 
                                            </div>
                                ...
                                <asp:Panel ID="std_basic_infoS" runat="server" Visible="false">
                                    ...
                                    <div class="row">
                                        <div style="margin: 0px; padding: 8px 0px 0px 0px; height: 43px; width: 100%; border-bottom: 0px solid #e3d4d4; text-align: center;">
                                            <asp:RadioButton ID="rd_stop" runat="server" Text="Stop" GroupName="ab"     />
                                            <asp:RadioButton ID="rd_start" runat="server" Text="Start" GroupName="ab"    />
                                        </div>
                                       
                                        <div style="margin: 0px; padding: 0%; float: left; height: auto; width: 100%" id="pnl_stop_start" runat="server" visible="false">
                                           <table style="margin: 6px 0px 18px 31px;
    padding: 0px;
    float: left;
    height: auto;
    width: 93%;">
                                               ...
                                               <tr>
                                                ...
                                                <td style="padding: 5px;">
                                                    ...
                                                    <td style="text-align: center;">
                                                                        ...
                                                                        <asp:Button ID="btn_submit" runat="server" Text="Submit" CssClass="btn btn-primary form-fnd-btns" OnClick="btn_submit_Click"  />
