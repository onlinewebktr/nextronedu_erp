<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="bonafide-certificate.aspx.cs" Inherits="school_web.Admin.bonafide_certificate" EnableEventValidation="false" ValidateRequest="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Reprint Bonafide Certificate
</asp:Content>
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Reprint Bobafide Certificate</li>
                        </ol>
                    </nav>
                </div>
            </div>
                                                                            ...
                                                                            <ItemTemplate>
                                                                                <tr>
                                                                                    ...
                                                                                    <td style="text-align: left;">
                                                                                        <asp:Label ID="lbl_studentname" runat="server" Text='<%#Bind("Student_name1")%>'></asp:Label>
                                                                                    </td>
                                                                                    <td style="text-align: left;">
                                                                                    ...
                                                                                    <td style="text-align: left;">
                                                                                        <asp:Label ID="lbl_class" runat="server" Text='<%#Bind("Class_1")%>'></asp:Label>
                                                                                    </td> 
                                                                                    ...
                                                                                    <td style="text-align: left;">
                                                                                        ...
                                                                                        <div class="user-box dropdown" style="float: left; display: inherit; height: auto; border-left: 0px solid #f0f0f0; margin-left: 0px;">
                                                                                            ...
                                                                                            <ul class="dropdown-menu dropdown-menu-end">
                                                                                                <li>
                                                                                                    <a href="slip/bonafide-certificate.aspx?adm_no=<%#Eval("Admission_no")%>&clssid=<%#Eval("Class_id")%>&sessnid=<%#Eval("Session_id")%>" class="dropdown-item" target="_blank"><i class='bx bx-printer'></i><span>Print</span> </a>
                                                                                                </li> 
                                                                                                <li>
