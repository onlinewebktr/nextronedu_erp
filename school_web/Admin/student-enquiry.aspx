<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="student-enquiry.aspx.cs" Inherits="school_web.Admin.student_enquiry" EnableEventValidation="false" %>
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3">Student Enquiry</div>
                <div class="ps-3">
                ...
                <a href="slip/enquiry-slip.aspx" target="_blank" style="position: absolute; right: 24px; text-decoration: underline; font-size: 14px; font-weight: 600; color: #1a5bbb;">Print Enquiry Form</a>
            </div>
            ...
            <div class="row">
                <div class="col-xl-4">
                    <asp:Label ID="ltUsertop" runat="server" Style="font-weight: 500; font-size: 1rem;" class="mb-0 text-uppercase" Text="Add Enquiry"></asp:Label>
                        ...
                        <div class="card-body">
                            <div class="p-4 border rounded">
                                <div class="row g-3 needs-validation">
                                    ...
                                    <div class="col-md-12">
                                        <label for="validationCustom01" class="form-label">Contact No.<sup>*</sup></label>
                                        <asp:TextBox ID="txt_contact_no" runat="server" class="form-control" onkeypress="return isNumberKey(event)" MaxLength="10"></asp:TextBox>
                                    </div>
                                    <div class="col-md-12">
                ...
                <div class="col-xl-8">
                    <h6 class="mb-0 text-uppercase">Added Enquiry</h6>
                    <hr />
                    <div class="card">
                        <div class="card-body">
                            ...
                            <asp:Label ID="lbl_website" runat="server"></asp:Label>
                                                                ...
                                                                <div style="margin: 7px 0px 0px 0px; padding: 0px; float: left; height: auto; text-align: center; vertical-align: middle; font-size: 13px; width: 100%;">
                                                                    <span style="font-size: 14px; font-weight: bold;">Student Enquery
                                                        ...
                                                        <ItemTemplate>
                                                            <tr>
                                                                ...
                                                                <td style="text-align: left;">
                                                                    <asp:Label ID="Label1" runat="server" Text='<%#Bind("Enquiry_id")%>'></asp:Label>
                                                                </td>
                                                                <td style="text-align: left;">
                                                                ...
                                                                <td style="text-align: left;">
                                                                    <asp:Label ID="lbl_contact_no" runat="server" Text='<%#Bind("Contact_no")%>'></asp:Label>
                                                                </td>
                                                                <td style="text-align: left;">
