<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="report-headwise-fee-collection.aspx.cs" Inherits="school_web.Admin.report_headwise_fee_collection" EnableEventValidation="false" ValidateRequest="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Head wise Admission Fee Collection
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Head wise Admission Fee Collection</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    ...
                    <ul class="sub-pag-menu-ul">
                        <li><a href="report-today-fees-collection.aspx">Today Fee Collection Summary</a></li>
                        <li><a href="admission-fee-collection-report.aspx">Today Fees Collection</a></li>
                        <li><a href="report-headwise-fee-collection.aspx" class="sub-mnu-p-a-active">Head wise Fee Collection</a></li>
                        <li><a href="report-student-wise-admission-fee-collection.aspx">Total Accumulated Student Wise Fee Collection</a></li>
                        <li><a href="report-student-headwise-admission-fee-collection_N.aspx">Student & Head Wise Fee Collection</a></li>
                    </ul>
                </div>
                <div class="col-xl-12">
                    <hr />
                                                            ...
                                                            <asp:Panel ID="pnl_grid" runat="server" Style="width: 100%;">
                                                                <asp:GridView ID="GrdView" runat="server" class="table table-bordered" ShowFooter="false" AutoGenerateColumns="False" Width="100%" OnRowDataBound="GrdView_RowDataBound">
                                                                    <Columns>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Particular / Amount">
                                                                            <ItemTemplate>
                                                                                <%-- ===================== --%>
                                                                                <asp:GridView ID="GrdViews" runat="server" ShowHeader="false" OnRowDataBound="GrdViews_RowDataBound" class="table table-bordered" ShowFooter="true" AutoGenerateColumns="False" Width="100%" Style="width: 103%; border-collapse: collapse; margin: -9px;">
                                                                                    <Columns>
                                                                                        ...
                                                                                        <asp:TemplateField>
                                                                                            <ItemTemplate>
                                                                                                <asp:Label ID="lbl_Paid_amt" runat="server" Text='<%#Bind("Paid_amt","{0:n}")%>'></asp:Label>
                                                                                            </ItemTemplate>
                                                                                            <FooterTemplate>
                                                                ...
                                                                <asp:GridView ID="grd_ttl" runat="server" class="table table-bordered" OnRowDataBound="grd_ttl_RowDataBound" ShowFooter="true" AutoGenerateColumns="False" Width="100%">
                                                                    <Columns>
                                                                        <asp:TemplateField HeaderText="Sl No.">
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="lbl_sl" runat="server" Text='<%# Container.DataItemIndex + 1 %>'></asp:Label>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Particular">
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="lbl_particular" runat="server" Text='<%#Bind("feetype")%>'></asp:Label>
                                                                            </ItemTemplate>
                                                                            <FooterTemplate>
                                                                                <asp:Label ID="lbltotalamts" runat="server" Style="font-weight: 600" Text="Total Amount"></asp:Label>
                                                                            </FooterTemplate>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Amount">
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="lbl_amount" runat="server" Text='<%#Bind("Paid_amt","{0:n}")%>'></asp:Label>
                                                                            </ItemTemplate>
                                                                            <FooterTemplate>
                                                                                <asp:Label ID="lbltotals" runat="server" Style="font-weight: 600"></asp:Label>
                                                                            </FooterTemplate>
                                                                        </asp:TemplateField>
                                                                    </Columns>
                                                                </asp:GridView>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var ClassiD = $('#<%= hd_class_id.ClientID %>').val();
            ...
            $.ajax({
                ...
                url: "graph.asmx/find_paid_summary_reportS",
                data: '{"FromDate":"' + FroMdatE + '", "ToDate":"' + ToDatE + '", "ClasSID":"' + ClassiD + '", "SecTION":"' + SectioN + '", "TYPE":"' + Type + '"}',
                dataType: "json",
