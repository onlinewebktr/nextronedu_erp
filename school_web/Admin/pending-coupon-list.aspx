<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="pending-coupon-list.aspx.cs" Inherits="school_web.Admin.pending_coupon_list" %>
                                                            ...
                                                            <asp:Repeater ID="rd_view" runat="server">
                                                                <ItemTemplate>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <asp:LinkButton ID="lnk_status" runat="server" OnClick="lnk_status_Click" class="statusPending">Pending</asp:LinkButton>
                                                                            <asp:Label ID="Label9" Visible="false" runat="server" Text='<%#Bind("Status")%>'></asp:Label>
                            ...
                            <div class="fnd-box-wpr-inr" style="padding: 0px 0px;">
                                <div id="monthFeeDiscHead">
                                    <div class="disc-pop-tbl-wpr">
                                                    ...
                                                    <ItemTemplate>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <asp:Label ID="lbl_disc_row_id" runat="server" Text='<%#Bind("Id") %>' Visible="false"></asp:Label>
                                                            </td>
                                                            <td>
                                                                <asp:Label ID="Label5" runat="server" Text='<%#Bind("month") %>'></asp:Label>
                                                            </td>
                                                            <td class="noclick">
                                                                <asp:Label ID="Label11" runat="server" Visible="false" Text='<%#Bind("Fee_amount") %>'></asp:Label>
                                                                <asp:TextBox ID="txt_head_fee" class="noclick" runat="server" Style="width: 80px;" Text='<%#Eval("Fee_amount") %>' onkeypress="return isNumberKey(event)"></asp:TextBox>
                                                            </td>
                                                            <td>
                                                                <asp:Label ID="Label13" runat="server" Visible="false" Text='<%#Bind("disc_amount") %>'></asp:Label>
                                                                <asp:TextBox ID="txt_disc_fee" runat="server" Text='<%#Eval("disc_amount") %>' Style="width: 80px;" onkeypress="return isNumberKey(event)"></asp:TextBox>
                                                            </td>
                                                            <td>
                                                                <asp:Label ID="Label10" runat="server" Visible="false" Text='<%#Bind("Discount_per") %>'></asp:Label>
                                                                <asp:TextBox ID="txt_disc_perc" runat="server" Text='<%#Eval("Discount_per") %>' Style="width: 80px;" onkeypress="return isNumberKey(event)"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                    </ItemTemplate>
                                                </asp:Repeater>
                                        ...
                                        <asp:Button ID="btn_update_disc" runat="server" class="button-6161 disc-pop-save_disc" Text="Update" OnClick="btn_update_disc_Click" Style="margin: 5px 0px 10px 0px; width: auto; padding: 0px 10px 0px 10px !important; float: right; background: #e3e700 !important; color: #000; border: 1px solid #c5bf08;" />
                                        ...
                                        <div class="disc-pop-txtbx-sec">
                                            <div class="row">
                                                ...
                                                <div class="col-md-2">
                                                    <asp:Button ID="btn_update_status" runat="server" class="button-6161 disc-pop-save_disc" Text="Submit" OnClick="btn_update_status_Click" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
