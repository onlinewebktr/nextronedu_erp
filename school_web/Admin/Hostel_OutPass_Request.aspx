<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="Hostel_OutPass_Request.aspx.cs" Inherits="school_web.Admin.Hostel_OutPass_Request" EnableEventValidation="false" ValidateRequest="false" %>
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Hostel Out Pass Request</li>
                        </ol>
                    </nav>
                </div>
            </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-xl-12">
                                                        <div class="stdlst-count-bx-dv brd-rdius-lft">
                                                            ...
                                                            <p class="stdlst-count-bx-count" id="lbl_total_pending_student" runat="server">0</p>
                                                        </div>
                                                        ...
                                                        <div class="stdlst-count-bx-dv" style="background-color: rgb(72 163 215 / 15%) !important;">
                                                            ...
                                                            <h2 class="stdlst-count-bx-name">Forward/Approved To Parents</h2>
                                                            <p class="stdlst-count-bx-count" id="lbl_total_forward_student" runat="server">0</p>
                                                        </div>
                                                        ...
                                                        <div class="stdlst-count-bx-dv" style="background-color: rgb(215 119 72 / 15%) !important;">
                                                            ...
                                                            <h2 class="stdlst-count-bx-name">Assigned/on-Going to Hostel Warden</h2>
