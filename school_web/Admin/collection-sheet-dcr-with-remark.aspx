<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="collection-sheet-dcr-with-remark.aspx.cs" Inherits="school_web.Admin.collection_sheet_dcr_with_remark" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Collection Sheet With Remark
</asp:Content>
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Collection Sheet With Remark</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <ul class="sub-pag-menu-ul">
                        ...
                        <li><a href="collection-sheet-dcr-with-remark.aspx" class="sub-mnu-p-a-active">Collection Sheet With Remark</a></li>
                                ...
                                <div class="find-dv">
                                    <div class="row">
                                        <div class="col-sm-2">
                                            ...
                                            <asp:DropDownList ID="ddl_payment_mode" runat="server" class="form-select find-dv-txtbx txtbx-ddl-style"></asp:DropDownList>
                                        </div>
                                        <div class="col-sm-2">
                                            <label for="validationCustom01" class="find-dv-lbl">User</label>
                                            <asp:DropDownList ID="ddl_user" runat="server" class="form-select find-dv-txtbx txtbx-ddl-style"></asp:DropDownList>
                                        </div>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <asp:TextBox ID="txt_s_date" runat="server" class="form-control find-dv-txtbx datepicker txtbx-ddl-style"></asp:TextBox>
                                                </div>
                                                <div class="col-sm-6">
                                                    <label for="validationCustom01" class="find-dv-lbl">To Date</label>
                                                    <asp:TextBox ID="txt_e_date" runat="server" class="form-control find-dv-txtbx datepicker txtbx-ddl-style"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <table id="example2" class="table table-striped table-bordered dataTable" role="grid" aria-describedby="example2_info">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th class="fntsizes">Adm. No.</th>
                                                                <th class="fntsizes">Class</th>
                                                                <th class="fntsizes">Sec.</th>
                                                                <th class="fntsizes">Roll No.</th>
                                                                <th class="fntsizes">Amount</th>
                                                                <th class="fntsizes">Mode</th>
                                                                <th class="fntsizes">By</th>
                                                                <th>Remarks</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            <asp:Repeater ID="rd_view" runat="server">
                                                                <ItemTemplate>
                                                                    <tr>
                                                                        ...
                                                                        <td class="fntsizes">
                                                                            <asp:Label ID="Label8" runat="server" Text='<%#Bind("rollnumber")%>'></asp:Label>
                                                                        </td>
                                                                        ...
                                                                        <td>
                                                                            <asp:Label ID="Label2" runat="server" Text='<%#Bind("CollectionBy")%>'></asp:Label>
                                                                        </td>
                                                                        <td>
