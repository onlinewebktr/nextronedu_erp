<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="Mapping_Transportation-with-Student.aspx.cs" Inherits="school_web.Admin.Mapping_Transportation_with_Student" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Transport Mapping with Student
</asp:Content>
                                    ...
                                    <div class="col-xl-5">
                                        <div class="fnd-box-wpr">
                                            ...
                                            <div class="fnd-box-wpr-inr">
                                                ...
                                                <div class="row">
                                                    <div class="col-xl-6 padd-rght-5" style="display: block">
                                                        <div class="fnd-box-row-wpr">
                                                            <div class="row">
                                                                <div class="col-xl-5 padd-rght-5">
                                                                    <label for="validationCustom01" class="form-label-fnds">Session</label>
