<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="hostel-summary-report.aspx.cs" Inherits="school_web.Admin.hostel_summary_report" %>
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Room Bed Summary</li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <asp:Label ID="lbl_website" runat="server"></asp:Label>
                                                                ...
                                                                <div style="margin: 7px 0px 0px 0px; padding: 0px; float: left; height: auto; text-align: center; vertical-align: middle; font-size: 13px; width: 100%;">
                                                                    <span style="font-size: 14px; text-transform: uppercase; font-weight: bold;">Room Bed Summary
                                                                    ...
                                                                    <asp:Repeater ID="rd_view" runat="server">
                                                                        <ItemTemplate>
                                                                            <tr>
                                                                                ...
                                                                                <td style="text-align: left;">
                                                                                    <asp:Label ID="Label4" runat="server" Text='<%#Bind("Room_name")%>'></asp:Label>
                                                                                </td>
                                                                                <td style="text-align: left;">
                                                                                ...
                                                                                <td style="text-align: left;">
                                                                                    <asp:Label ID="lbl_total_empty_bed" runat="server" Text='<%#Bind("Total_empty_bed")%>'></asp:Label>
                                                                                </td> 
                                                                            </tr>
                                                                        </ItemTemplate>
                                                                    </asp:Repeater>
