<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="settled-cheque-list.aspx.cs" Inherits="school_web.Admin.settled_cheque_list" %>
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Settled Cheque Payment List</li>
                        </ol>
                    </nav>
                </div>
            </div>
                                                                        ...
                                                                        <asp:Repeater ID="rd_view" runat="server">
                                                                            <ItemTemplate>
                                                                                <tr>
                                                                                    ...
                                                                                    <td style="text-align: left;" class="hiddenOnPrint">
                                                                                        <div class="user-box dropdown" style="float: left; display: inherit; height: auto; border-left: 0px solid #f0f0f0; margin-left: 0px;">
                                                                                            ...
                                                                                            <ul class="dropdown-menu dropdown-menu-end">
                                                                                                <li>
                                                                                                    <asp:LinkButton ID="lnkSettleCheque" class="dropdown-item" runat="server" CausesValidation="false" OnClick="lnkSettleCheque_Click" ToolTip="View Details"> <i class="bx bx-info-circle"></i><span>View Details</span></asp:LinkButton>
                                                                                                </li>
                                                                                            </ul>
                                                                                        </div>
                                                                                    ...
                                                                                    <td style="text-align: left;">
                                                                                        <asp:Label ID="Label9" runat="server" Text='<%#Bind("Settled_date")%>'></asp:Label>
                                                                                    </td>
                                                                                </tr>
                                                                            </ItemTemplate>
                                                                        </asp:Repeater>
        ...
        <div class="modal-dialog md-width">
            ...
            <div class="modal-content" style="position: relative">
                <div class="modal-header" style="padding: 5px 15px;">
                    <h3 class="modal-title" style="font-size: 20px;">Cheque Settlement Details</h3>
                    ...
                    <div class="mdl-frm-row">
                        <table class="table table-bordered table-striped">
                            <tr>
                                <td>Admission No. : </td>
                                <td>
                                    <asp:Label ID="lbl_adm_no_p" runat="server"></asp:Label></td>
                            </tr>
                            <tr>
                                <td>Student Name : </td>
                                <td>
                                    <asp:Label ID="lbl_std_name_p" runat="server"></asp:Label></td>
                            </tr>
                            <tr>
                                <td>Slip No. : </td>
                                <td>
                                    <asp:Label ID="lbl_slip_no_p" runat="server"></asp:Label></td>
                            </tr>
                            <tr>
                                <td>Cheque No. : </td>
                                <td>
                                    <asp:Label ID="lbl_cheque_no_p" runat="server"></asp:Label></td>
                            </tr>
                            <tr>
                                <td>Bank Name : </td>
                                <td>
                                    <asp:Label ID="lbl_bank_name_p" runat="server"></asp:Label></td>
                            </tr>
                            <tr>
                                <td>Cheque Date : </td>
                                <td>
                                    <asp:Label ID="lbl_cheque_date_p" runat="server"></asp:Label></td>
                            </tr>
                            <tr>
                                <td>Check Amount : </td>
                                <td>
                                    <asp:Label ID="lbl_cheque_amt_p" runat="server"></asp:Label></td>
                            </tr>
                            <tr>
                                <td>Check Status : </td>
                                <td>
                                    <asp:Label ID="lbl_cheque_status_p" runat="server"></asp:Label></td>
                            </tr>
                            <tr>
                                <td>
                                    <asp:Label ID="lbl_chk_status" runat="server"></asp:Label>
                                    Date : </td>
                                <td>
                                    <asp:Label ID="lbl_cheque_update_date_p" runat="server"></asp:Label></td>
                            </tr>

                            <tr id="fineDV" runat="server">
                                <td>Fine Amount : </td>
                                <td>
                                    <asp:Label ID="lbl_fine_amt_p" runat="server"></asp:Label>
                                    <asp:LinkButton ID="lnk_remove_fine" runat="server" OnClick="lnk_remove_fine_Click" ToolTip="Remove Fine" Style="background: #f00; color: #fff; padding: 2px 4px 3px 4px; border-radius: 2px;" OnClientClick="return confirm('Are you sure you want to remove this?');" CausesValidation="false"><i class="lni lni-trash"></i></asp:LinkButton>
                                </td>
                            </tr>
                            <tr>
                                <td>Remark : </td>
                                <td>
                                    <asp:Label ID="lbl_remark_p" runat="server"></asp:Label></td>
                            </tr>
                        </table>
                    </div>
                </div>
