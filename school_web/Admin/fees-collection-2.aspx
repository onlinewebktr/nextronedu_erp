<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="fees-collection-2.aspx.cs" Inherits="school_web.Admin.fees_collection_2" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <div class="modal-body fltr-mdl-body">
                    ...
                    <div class="adm-box-wprs1">
                        <table style="width: 100%;" class="table table-hover table-bordered">
                            ...
                            <tr>
                                <th colspan="2">
                                    <asp:Label ID="lbl_amount_to_be_paid" runat="server" Style="font-size: 14px; color: #000;"></asp:Label>
                                </th>
    ...
    <div id="mdlDiscount" class="modal fade" role="dialog">
        <div class="modal-dialog" style="max-width: 800px;">
            <div class="modal-content">
                <div class="modal-header" style="padding: 3px 10px;">
                    <h5 class="modal-title" style="font-size: 18px; padding: 5px 0px 0px 0px;">Discount</h5>
                    <a href="#!" data-dismiss="modal" style="margin: 5px 0px 0px 0px !important; padding: 3px 5px 4px 5px; background: #fa2020; border: #9b0202;"
                        class="btn btn-primary find-dv-btn">Close</a>
                </div>
                                                    ...
                                                    <ItemTemplate>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <asp:Label ID="lbl_fee_type" Visible="false" runat="server" Text='<%#Bind("Type") %>'></asp:Label>
                                                            </td>
                                                        </tr>
                                                    </ItemTemplate>
                                                </asp:Repeater>
