<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="send-notice-to-students.aspx.cs" Inherits="school_web.Admin.send_notice_to_students" %>
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Send Notice to Students</li>
                        </ol>
                    </nav>
                </div>
            </div>
                                        ...
                                        <div class="row g-3 needs-validation" novalidate="">
                                          ...
                                          <asp:RadioButton ID="rd_individual" runat="server" Text="Individual" AutoPostBack="true" GroupName="ak" OnCheckedChanged="rd_individual_CheckedChanged" />
                                            ...
                                            <div class="col-md-12" style="position: relative">
                                                <asp:TextBox ID="txt_date" runat="server" CssClass="form-control calender-icon  find-dv-txtbx"></asp:TextBox>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <asp:TextBox ID="txt_notice_subject" runat="server" class="form-control find-dv-txtbx"></asp:TextBox>
                                            </div>
                                            <div class="col-md-12">
                                                <label for="validationCustom01" class="form-label">Link</label>
                                                <asp:TextBox ID="txt_link" runat="server" class="form-control find-dv-txtbx"></asp:TextBox>
                                            </div>
                                            ...
                                            <div class="col-md-12" id="usertypesDV" runat="server">
                                                <label>Also Send To<sup>*</sup></label>
                                                <div class="input-group input-group-icon">

                                                    <div class="month-checkbox" style="background-color: #fff; padding: 4px 0px 6px 6px;">
                                                        <asp:CheckBox ID="chk_user_Type" runat="server" Text="Teachers & Staff" />

                                                        <%--<asp:Repeater ID="rd_view" runat="server">
                                                            <ItemTemplate>
                                                                <asp:CheckBox ID="chk_user_Type" runat="server" Text='<%#Eval("User_Type")%>' />
                                                                <asp:Label ID="lbl_users" runat="server" Visible="false" Text='<%#Bind("User_Type")%>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:Repeater>--%>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-12" style="text-align: center">
                                                <asp:Button ID="btn_Submit" runat="server" Text="Send" CssClass="btn btn-primary" ValidationGroup="a" OnClick="btn_Submit_Click1" />
