<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="headwise-dues-report.aspx.cs" Inherits="school_web.Admin.headwise_dues_report" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Headwise Dues Report
</asp:Content>
                                            ...
                                            <div class="prnt-dv-wpr printborder" id="tblCustomers">
                                                <div class="pgslry-head-div head" style="border-bottom: 1px solid #000; margin: 0px; float: left; width: 100%;">
                                                    ...
                                                    <div style="margin: 0px; padding: 0px; height: 110px; width: 80%; float: left;">
                                                        ...
                                                        <div style="margin: 7px 0px 0px 0px; padding: 0px; float: left; height: auto; text-align: center; vertical-align: middle; font-size: 13px; width: 100%;">
                                                            <span style="font-size: 14px; font-weight: bold;">Headwise Dues Report for the Month of 
                                                ...
                                                <div class="grd-wpr" style="min-height: 300px; float: left; width: 100%">
                                                    <div class="prnt-dv-wpr printborder">
                                                        <div class="fxtblWpr">
                                                            <table class="table table-bordered table-hover" datatable="ng" dt-options="vm.dtOptions" style="border: 1px solid #c5c0c0;">
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <th class="scrollable-td fixed-hd">Contact No.</th>
                                                                        <th class="scrollable-td fixed-hd" data-ng-repeat="x in reportHead" class="txtcenter">{{x.ContentName}}</th>
                                                                ...
                                                                <tr>
                                                                    <td colspan="48" style="text-align: center;"><strong style="margin: 0px 5px 0px 0px; padding: 2px 5px; list-style-type: none; display: inline; font-size: 13px; border: 1px solid #bac419; background: #FBFFBB; border-radius: 2px; font-weight: 600; color: #000;">Total Dues : {{ totalDues | number:2 }}</strong></td>
                                                                </tr>
                                                            </table>
                                                        </div>
                                                    </div>
    ...
    <script type="text/javascript">
        ...
        app.controller('RpCardAppCtrl', function ($scope, $http) {
            ...
            if (find_status == "1") {
                ...
                $http.get("webServices/account/headwise-dues.asmx/fetch_report_estimate_head", { params: { "Session_id": session_id, "Months": months, "Class_id": class_id, "Fee_head_id": fee_head_id } }).then(function (response) {
                    $scope.reportHead = response.data;
                })

                $http.get("webServices/account/headwise-dues.asmx/fetch_report_estimate_fees", { params: { "Session_id": session_id, "Months": months, "Class_id": class_id, "Fee_head_id": fee_head_id } }).then(function (response) {
                    ...
                    if ($scope.reportAmountS == "") {
                        ...
                        $scope.reportfeesS = students;
                        $scope.totalDues = totalDues;


                        $("#intsLoader").addClass("hidden");
                    }
                })
                //$http.get("webServices/account/headwise-dues.asmx/fetch_report_estimate_total_footer", { params: { "Session_id": session_id, "Months": months, "Class_id": class_id, "Fee_head_id": fee_head_id } }).then(function (response) {
