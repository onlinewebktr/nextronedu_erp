<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="View_Sent_Message_to_Teacher.aspx.cs" Inherits="school_web.Admin.View_Sent_Message_to_Teacher" EnableEventValidation="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    View Sent Message to Teacher
</asp:Content>
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">View All Sent Message</li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <asp:Label ID="lbl_website" runat="server"></asp:Label>
                                                                    ...
                                                                    <div style="margin: 7px 0px 0px 0px; padding: 0px; float: left; height: auto; text-align: center; vertical-align: middle; font-size: 13px; width: 100%;">
                                                                        <span style="font-size: 14px; font-weight: bold;">Message-<asp:Label ID="lbl_class22" runat="server"></asp:Label></span>
                                                            ...
                                                            <asp:GridView ID="GrdView" runat="server" class="table table-bordered" AutoGenerateColumns="False" Width="100%" OnRowDataBound="GrdView_RowDataBound">
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Tecaher Name">
                                                                        <ItemTemplate>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Subject">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lbl_Subject" Style="word-break: break-all;" runat="server" Text='<%#Bind("Subject") %>'></asp:Label>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="Details">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lbl_Details" Style="word-break: break-all;" runat="server" Text='<%#Bind("Details") %>'></asp:Label>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="File">
                                                                        <ItemTemplate>
                                                                            ...
                                                                            <a runat="server" id="a1" href='<%#Eval("Attachments") %>' download style="padding: 0px 0px 2px 8px; font-family: ebrima; font-size: 17px; color: #0066CC; text-decoration: none;"><i class="fa fa-download" aria-hidden="true"></i></a>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
