<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="Pending_Online_Payment_MM.aspx.cs" Inherits="school_web.Admin.Pending_Online_Payment_MM" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">Pending Online Payment 
</asp:Content>
     ...
     <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3"> <i class="bx bx-arrow-back"></i> Reports</div>
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            <li class="breadcrumb-item"><a href="Home.aspx"><i class="bx bx-home-alt"></i></a>
                            </li>
                            <li class="breadcrumb-item active" aria-current="page">Pending online payment</li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <asp:Label ID="lbl_website" runat="server"></asp:Label>
                                                                ...
                                                                <div style="margin: 7px 0px 0px 0px; padding: 0px; float: left; height: auto; text-align: center; vertical-align: middle; font-size: 13px; width: 100%;">
                                                                    <span style="font-size: 14px; font-weight: bold;">Pending Online Payment-<asp:Label ID="lbl_class22" runat="server"></asp:Label></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                                    ...
                                                                    <asp:Repeater ID="rd_view" runat="server"  >
                                                                        <ItemTemplate>
                                                                                ...
                                                                                <td style="text-align: left;"  class="hiddenOnPrint">
                                                                                    <div class="user-box dropdown" style="float: left; display: inherit; height: auto; border-left: 0px solid #f0f0f0; margin-left: 0px;">
                                                                                        ...
                                                                                        <ul class="dropdown-menu dropdown-menu-end">
                                                                                            <li>
                                                                                                   <asp:LinkButton ID="lnkupdate_payment" class="dropdown-item" runat="server" CausesValidation="false" OnClick="lnkupdate_payment_Click" ToolTip="Check Status" OnClientClick="return ShowProgress();"> <span>Check Status</span></asp:LinkButton>
                                                                                            </li>
                                                                            ...
                                                                            <asp:CheckBox ID="chkRowData" runat="server" /></td>
                                                                               ...
                                                                               <td style="text-align: left;">
                                                                                    <asp:Label ID="lbl_razorpay_order_id" runat="server" Text='<%#Bind("razorpay_order_id")%>'></asp:Label>
                                                                                </td>
                                                                                  <td style="text-align: left;">
                                                                                 ...
                                                                                 <td style="text-align: left;">
                                                                                    <asp:Label ID="lbl_Total_pay" runat="server" Text='<%#Bind("Total_pay")%>'></asp:Label>
                                                ...
                                                <asp:Button ID="btn_process" runat="server" Visible="false" Text="Process" class="btn btn-success find-dv-btn" Style="margin-left: 20px;" OnClick="btn_process_Click" OnClientClick="return confirm('Are you sure want to Process?');" />
    ...
    <asp:HiddenField ID="hd_id" runat="server" />
     ...
     <script type="text/javascript">
         function ShowProgress() {
             ...
             return true; // Important for allowing postback
         }
      ...
      <div class="loading" align="center" >
              Please wait while we verify your payment. Do not close or navigate away from the app until the process is complete
        <br />
                <br />
          <img src="../Student_Profile/webview/RazorPay/loader.gif" />
