<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="fee-collection.aspx.cs" Inherits="school_web.Admin.fee_collection" %>
                                                        ...
                                                        <div class=" row">
                                                            <div class="col-md-8">
                                                                <div class="imp-info-lft">
                                                                    ...
                                                                    <asp:Button ID="btn_admission_fee" runat="server" CssClass="button-61 collectadmissionfeebtn" OnClick="btn_admission_fee_Click" />
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="imp-info-rght">
                                                                    <p runat="server" id="ExtraHeadBtn" data-toggle="modal" data-target="#mdlExtraHead" class="button-6161 disc-pupup-btn floatrght">Add Fee Head</p>
                                                                    <p runat="server" id="TransportBTN" visible="false" data-toggle="modal" data-target="#myModalTransport" class="button-6161 disc-pupup-btn floatrght" style="min-width: 50px;">Bus</p>
                                                                    <p runat="server" id="HostelBTN" visible="false" data-toggle="modal" data-target="#myModalHostel" class="button-6161 disc-pupup-btn floatrght">Hostel</p>
                                                                    <p runat="server" id="discBTN" visible="false" data-toggle="modal" data-target="#mdlDiscount" class="button-6161 disc-pupup-btn floatrght">Discount</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-6" style="padding-right: 5px">
                                            ...
                                            <div class="fnd-box-wpr" style="margin: 5px 0px 0px 0px; position: relative">
                                                <a href="#!" data-toggle="modal" data-target="#MdlRevisedPayment" class="revisePaySbtn" runat="server" target="_blank" id="revisedPayment" visible="false">Revise Payment</a>


                                                <a href="#!" data-toggle="modal" data-target="#ModalDiscount" class="discDetailSbtn" runat="server" target="_blank" id="discDTbtn" visible="false">Discount Details</a>
                                                                ...
                                                                <asp:Repeater ID="rl_ledger" runat="server" OnItemDataBound="rl_ledger_ItemDataBound">
                                                                    <ItemTemplate>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <a href="#!" runat="server" id="printLnk" target="_blank"><i class="bx bx-printer"></i></a>
                                                                            </td>
                                                                        </tr>
                                                                    </ItemTemplate>
                                                                </asp:Repeater>
                                        ...
                                        <div class="col-xl-6" style="padding-left: 5px">
                                            <div class="fnd-box-wpr" style="margin: 5px 0px 0px 0px;">
                                                ...
                                                <div class="fnd-box-wpr-inr">
                                                    ...
                                                    <div id="dvPassport" style="display: block; background: rgb(247 149 230); float: left; width: 100%; padding: 2px; border-radius: 2px; border: 1px solid rgb(221 109 201);">
                                                        <div class="fnd-box-row-wpr">
                                                            <div class="row">
                                                                <div class="col-md-3">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-3 padd-lft0" runat="server" id="paydateDVS">
                                                                ...
                                                                <script>
                                                                    ...
                                                                    //======================
                                                                    $(function () {
                                                                        $("#<%=txt_paid_adm_ann_fee_payment.ClientID %>").on('input', function () {
                                                                            calculate();
                                                                        });
                                                                        ...
                                                                        function calculate() {
                                                                            var ttl_amt = parseFloat($("#<%=txt_payble_adm_ann_fee.ClientID %>").val());
                                                                            var paid_amt = parseFloat($("#<%=txt_paid_adm_ann_fee_payment.ClientID %>").val());
                                                                            ...
                                                                            //======================
                                                                            var paid_amt_of_adm = $("#<%=txt_paid_adm_ann_fee_payment.ClientID %>").val();
                                                                            if (paid_amt_of_adm.length == 0) {
                                                                                $("#<%=txt_paid_adm_ann_fee_payment.ClientID %>").val('0');
                                                                            }
                                                                            if (paid_amt_of_adm.length == 2) {
                                                                                var frstChar = paid_amt_of_adm.substring(0, 1)
                                                                                while (paid_amt_of_adm.charAt(0) === '0') {
                                                                                    paid_amt_of_adm = paid_amt_of_adm.substring(1);
                                                                                }
                                                                                $("#<%=txt_paid_adm_ann_fee_payment.ClientID %>").val(paid_amt_of_adm);
                                                                            }
                                                                            ...
                                                                            if (ttl_amt < paid_amt) {
                                                                                $("#<%=txt_paid_adm_ann_fee_payment.ClientID %>").val('');
                                                                                $("#<%=txt_paid_adm_ann_fee_payment.ClientID %>").val(ttl_amt);
                                                                                $("#<%=txt_dues_adm_ann_fee.ClientID %>").val('0.00');
                                                                                final_amt = (mnthly_paid_amt + ttl_amt);
                                                                                $("#<%=txt_final_amt.ClientID %>").val(final_amt.toFixed(2));
                                                                            }
                                                                            else if (mnthly_ttl_bill_amt < mnthly_paid_amt) {
                                                                                final_amt = (mnthly_ttl_bill_amt + paid_amt);
                                                                                $("#<%=txt_final_amt.ClientID %>").val(final_amt.toFixed(2));
                                                                            }
                                                                            else {
                                                                                dues_amt = (ttl_amt - paid_amt);
                                                                                $("#<%=txt_dues_adm_ann_fee.ClientID %>").val(dues_amt.toFixed(2));
                                                                                final_amt = (mnthly_paid_amt + paid_amt);
                                                                                $("#<%=txt_final_amt.ClientID %>").val(final_amt.toFixed(2));
                                                                            }
                                                                        }
                                                                    });
                                                            ...
                                                            <div class="col-md-3 padd-lft0">
                                                                <asp:DropDownList ID="ddl_paymentmode" runat="server" class="form-select find-dv-txtbx">
                                                                    ...
                                                                    <asp:ListItem>Other APP</asp:ListItem>
                                                                </asp:DropDownList>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <script type="text/javascript">
                                                        ...
                                                        function on_payment_mode_selection() {
                                                            ...
                                                            else if ($('#<%= ddl_paymentmode.ClientID %> option:selected').val() == "Creditcard") {
                                                                $("#pnl_mode_t_nS").show();
                                                                $("#<%=lbl_mode_trns_no.ClientID%>").text("Transaction No.");
                                                                $("#bank_dt").hide();
                                                            }
                                                            ...
                                                            else if ($('#<%= ddl_paymentmode.ClientID %> option:selected').val() == "UPI") {
                                                                $("#pnl_mode_t_nS").show();
                                                                $("#<%=lbl_mode_trns_no.ClientID%>").text("Transaction No.");
                                                                $("#bank_dt").hide();
                                                            }
