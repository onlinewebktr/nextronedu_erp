...
{
    public partial class Account_Wise_Payment_Report : System.Web.UI.Page
    {
            ...
            try
            {
                if (!IsPostBack)
                {
                    ...
                    else
                    {
                        ...
                        string pagename_current = "Account_Wise_Payment_Report.aspx";
