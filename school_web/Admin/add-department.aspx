<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="add-department.aspx.cs" Inherits="school_web.Admin.add_department" EnableEventValidation="false" ValidateRequest="false" %>
    ...
    <div class="page-wrapper">
        <div class="page-content">
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Department Master</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-xl-8">
                    <h6 class="mb-0 text-uppercase">Added Department</h6>
                    <hr />
                    <div class="card">
                        <div class="card-body">
                            ...
                            <asp:Label ID="lbl_website" runat="server"></asp:Label>
                                                                ...
                                                                <div style="margin: 7px 0px 0px 0px; padding: 0px; float: left; height: auto; text-align: center; vertical-align: middle; font-size: 13px; width: 100%;">
                                                                    <span style="font-size: 14px; font-weight: bold;">Department Master List<asp:Label ID="lbl_class22" runat="server"></asp:Label></span>
                                                                            ...
                                                                            <asp:Panel ID="Panel1" runat="server">
                                                                                <tr>
                                                                                    ...
                                                                                    <td style="text-align: left;">
                                                                                        ...
                                                                                        <asp:Label ID="lbl_department_id" runat="server" Text='<%#Bind("department_id")%>' Visible="false"></asp:Label>
                                                                                    </td>
                                                                                </tr>
                                                                            </asp:Panel>
                                                                        </ItemTemplate>
