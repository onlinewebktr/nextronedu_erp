<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="create-demand-bill-installment-wise.aspx.cs" Inherits="school_web.Admin.create_demand_bill_installment_wise" %>
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Demand Bill</li>
                        </ol>
                    </nav>
                </div>
            </div>
                            ...
                            <div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap5 hdrmodify">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="find-dv">
                                            <div class="row g-3 needs-validation" novalidate="">
                                                ...
                                                <div class="col-sm-2">
                                                    ...
                                                    <asp:DropDownList ID="ddl_with" runat="server" class="form-select find-dv-txtbx">
                                                        <asp:ListItem Value="1">Total Dues</asp:ListItem>
                                                        <asp:ListItem Value="2">Only Monthly Fee</asp:ListItem>
                                                    </asp:DropDownList>
                                                </div>
                                                <div class="col-sm-1">
                                        ...
                                        <div class="grd-wpr" runat="server" id="printDBDV" visible="false">
                                            <div class="row">
                                                <div class="col-sm-3">
                                                    <label for="validationCustom01" class="form-label">To Installment<sup>*</sup></label>
                                                    <asp:DropDownList ID="ddl_installment_name" runat="server" class="form-control find-dv-txtbx"></asp:DropDownList>
                                                </div>
                                                <div class="col-sm-3">
