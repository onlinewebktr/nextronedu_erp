<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.Master" AutoEventWireup="true" CodeBehind="Credit_Voucher_Entry.aspx.cs" Inherits="school_web.Admin.Credit_Voucher_Entry" EnableEventValidation="false" ValidateRequest="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="head" runat="server">
    <style>
        ...
        .select2-container {
            display: block;
            width: 247.925px !important;
        }
    </style>
    <script type="text/javascript">
        $(document).ready(function () {
            $("#Credit_Voucher_Entry").addClass("dcjq-parent active");
        });
    </script>
    <style>
        .maste-p {
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="page-wrapper">
        <div class="page-content">
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Credit Voucher</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-4">
                    <asp:Label ID="ltUsertop" runat="server" Style="font-weight: 500; font-size: 1rem;" class="mb-0 text-uppercase" Text=" Add Credit Voucher"></asp:Label>
                    <hr />
                    <div class="card">
                        <div class="card-body">
                            <div class="p-4 border rounded">
                                <table style="width: 100%">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="position-relative form-group">
                                                <asp:TextBox ID="txt_remarks" runat="server" CssClass="form-control" TextMode="MultiLine" style="height:88px"></asp:TextBox>
                                            </div>
                                        </td>
                                    </tr>
                                </table>
                ...
                <div class="col-xl-8">
                    <h6 class="mb-0 text-uppercase">Credit Voucher History</h6>
                    <hr />
                    <div class="card">
                        <div class="card-body">
                            ...
                            <asp:Label ID="lbl_website" runat="server"></asp:Label>
                                                                ...
                                                                <div style="margin: 7px 0px 0px 0px; padding: 0px; float: left; height: auto; text-align: center; vertical-align: middle; font-size: 13px; width: 100%;">
                                                                    <span style="font-size: 14px; font-weight: bold;">Credit Voucher
                                                            ...
                                                            <asp:GridView ID="grd_bill_trac" runat="server" class="mb-0 table table-bordered" ShowFooter="true" OnRowDataBound="grd_bill_trac_RowDataBound" AutoGenerateColumns="False" Width="100%">
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Account(Cr)" HeaderStyle-ForeColor="Maroon">
                                                                       ...
                                                                       <FooterTemplate>
                                                                            <asp:Label ID="lbl_total1" runat="server" Font-Bold="true"></asp:Label>
                                                                        </FooterTemplate>
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="Account(Dr)" HeaderStyle-ForeColor="Maroon"  Visible="false">
                                                                        <ItemTemplate>
      ...
      <%--  function searching() {
            $("#<%=txt_particular.ClientID%>").autocomplete({
                ...
                source: function (request, response) {
                    $.ajax({
                        url: 'Credit_Voucher_Entry.aspx/Search_particular',
