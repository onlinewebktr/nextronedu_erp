...
{
    public partial class Report_Total_Admission_Fee_Collection : System.Web.UI.Page
    {
        My mycode = new My();
        ...
        private void bind_grd_view_data(string query)
        {
            ...
            {
                lbl_print_headS.Text = "Admission Fees Collection Summary Report of Session : " + ddlsession.SelectedItem.Text + " and Class : " + ddlclass.SelectedItem.Text;
        ...
        protected void btn_excels_Click(object sender, EventArgs e)
        {
            ...
            if (ViewState["Is_Download"].ToString() == "1")
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename=Total_Admission_Fee_Collection" + "_" + DateTime.Now + ".xls");
                Response.Charset = "";
