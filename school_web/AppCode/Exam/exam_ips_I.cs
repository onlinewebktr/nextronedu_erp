using school_web.Examination_Admin.slip.ips.api;
using System;
...
{
    public class exam_ips_I
    {
        My mycode = new My();
        #region ASSESMENT WISE
        //=================================
        internal static string get_marks(string Session_id, string Class_id, string Admission_no, string Term_id, string Assessment_id, string Subject_id, string Branch_id, string Subject_type, string subject_sub_level_id)
        {
            ...
            string assesment_weightage = get_assesment_weightage(Session_id, Branch_id, Class_id, Term_id, Assessment_id, Subject_id, subject_sub_level_id);
            string Maximum_Marks = get_assesment_max_marks(Session_id, Branch_id, Class_id, Term_id, Assessment_id, Subject_id, subject_sub_level_id);
            ...
            string round_off_value = Math.Round(final_marks).ToString();
        ...
        private static string get_assesment_max_marks(string Session_id, string Branch_id, string Class_id, string Term_id, string Assessment_id, string Subject_id, string subject_sub_level_id)
        {
            string query = "select Maximum_Marks from Exam_Subject_Sub_Level where Session_Id='" + Session_id + "' and Branch_Id='" + Branch_id + "' and Istatus=1 and Exam_Term_Id=" + Term_id + " and Assessment_Id=" + Assessment_id + " and Class_id=" + Class_id + " and Subject_id=" + Subject_id + " and Subject_Sub_Level_Id=" + subject_sub_level_id + "";
            DataTable dt = FillDatastatic(query);
            if (dt.Rows.Count == 0)
            {
                return "0";
        ...
        private static string get_assesment_weightage(string Session_id, string Branch_id, string Class_id, string Term_id, string Assessment_id, string Subject_id, string subject_sub_level_id)
        {
            string query = "select Maximum_Marks,Grade_System_Id from Exam_Subject_Sub_Level where Session_Id='" + Session_id + "' and Branch_Id='" + Branch_id + "' and Istatus=1 and Exam_Term_Id=" + Term_id + " and Assessment_Id=" + Assessment_id + " and Class_id=" + Class_id + " and Subject_id='" + Subject_id + "' and Subject_Sub_Level_Id='" + subject_sub_level_id + "'";
            DataTable dt = FillDatastatic(query);
            if (dt.Rows.Count == 0)
            {
                return "0";
        ...
        internal static string get_subject_total_marks(string session_id, string class_id, string admission_no, string term_id, string subject_id, string branch_id, string Type)
        {
            ...
            if (Type == "Scholastic")
            {
                if (Output == "Marks")
                {
                    ...
                    string grade = ipsExamSetting.get_grade_of_a_subject(session_id, branch_id, Grade_System_Id, final_marks, full_number, class_id);   // Grade of a subject
                    ...
                    string exam_settings = ipsExamSetting.get_exam_settings(session_id, branch_id, class_id);  // Settings
                ...
                else
                {
                    ...
                    string exam_settings = ipsExamSetting.get_exam_settings(session_id, branch_id, class_id);  // Is SpecialNote & QR Show
        ...
        {
            string query = "select Short_Name from Exam_Term_Details where Branch_Id='" + branch_id + "' and Exam_Term_Id=" + term_id + "";
            DataTable dt = FillDatastatic(query);
            if (dt.Rows.Count == 0)
            {
                return "";
            ...
            {
                return dt.Rows[0]["Short_Name"].ToString();
            }
        }
        ...
        internal static string get_ttl_mark_of_a_subject(string subject_id, string Admission_no, string Session_id, string Class_id, string Branch_id, string Term_idI, string Term_idII)
        {
            ...
            else
            {
                ...
                string termI_grade = get_grade(Session_id, Branch_id, system_grade, My.toDouble(dt.Rows[0]["Ttl_mark_for_term1"].ToString()));
                string termII_grade = get_grade(Session_id, Branch_id, system_grade, My.toDouble(dt.Rows[0]["Ttl_mark_for_termII"].ToString()));
                ...
                string termI_termII_grade = get_grade(Session_id, Branch_id, system_grade, termI_termIi_average_percent);
        ...
        internal string get_subject_heading_subjective_new(string Class_Id, string section, string termid, string assesment_id, string sessionid, string branchid)
        {
            ...
            else
            {
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    /// querymain += ", (select isnull(stuff((SELECT distinct ', ' +  Marks  from Exam_marks where   Admission_no=ar.admissionserialnumber  and Session_id='" + sessionid + "' and Branch_id='" + branchid + "' and Class_id=" + Class_Id + " and Section='" + section + "' and Term=" + termid + " and Assessment=" + assesment_id + " and Subject='" + dr["Subject_id"].ToString() + "'  FOR XML PATH('')), 1, 1,''), 'N/A')) " + dr["subject2"].ToString();

                    querymain += ", (select isnull(stuff((SELECT ', ' +  em.Marks  from Exam_marks em join  Exam_Subject_Sub_Level essl on em.Subject_activity=essl.Subject_Sub_Level_Id where   em.Admission_no=ar.admissionserialnumber  and em.Session_id='" + sessionid + "' and em.Branch_id='" + branchid + "' and em.Class_id=" + Class_Id + " and em.Section='" + section + "' and em.Term=" + termid + " and em.Assessment=" + assesment_id + " and em.Subject='" + dr["Subject_id"].ToString() + "' order by essl.Sequence_No asc  FOR XML PATH('')), 1, 1,''), 'N/A')) " + dr["subject2"].ToString();
        ...
        internal static string get_systm_grd_id(string Subject_id, string Session_id, string Class_id, string Branch_id, string Term_id)
        {
            string gradeid = "0";
            try
            {
                string query = "select top 2 Grade_System_Id from dbo.[Exam_Subject_Sub_Level] where Subject_id=" + Subject_id + " and Session_Id=" + Session_id + " and Branch_Id='" + Branch_id + "' and Exam_Term_Id='" + Term_id + "' order by Grade_System_Id asc";
                DataTable dt = FillDatastatic(query);
                if (dt.Rows.Count == 0)
                {
                    gradeid = "0";
                ...
                {
                    gradeid = dt.Rows[1]["Grade_System_Id"].ToString();
                }
                return gradeid;
            }
            catch (Exception ex)
        ...
        internal static string get_max_marks_in_head(string Session_id, string Class_id, string Branch_id, string Term_id, string Assessment_Id)
        {
            string max_marks = ""; string YourString = "";
            try
            {
                string query = "select DISTINCT Maximum_Marks from Exam_Subject_Sub_Level where Session_Id='" + Session_id + "' and Branch_Id='" + Branch_id + "' and Exam_Term_Id='" + Term_id + "' and Class_id='" + Class_id + "' and Assessment_Id='" + Assessment_Id + "'  order by Maximum_Marks desc";
                DataTable dt = FillDatastatic(query);
                if (dt.Rows.Count == 0)
                {
                    YourString = "0";
                ...
                else
                {
                    for (int i = 0; i < dt.Rows.Count; i++)
                    {
                        max_marks = max_marks + dt.Rows[i]["Maximum_Marks"].ToString() + "/";
                    }
                    YourString = max_marks.Remove(max_marks.Length - 1);
                }
        ...
        internal static string get_attendances(string Session_id, string Class_id, string Admission_no, string Branch_id, string Term_id, string Term_idII)
        {
            string TermIattandance = get_attandance_details(Session_id, Branch_id, Class_id, Term_id, Admission_no);    //Total Class/Present Class/Present attendance percent
            string TermIIattandance = get_attandance_details(Session_id, Branch_id, Class_id, Term_idII, Admission_no);    //Total Class/Present Class/Present attendance percent

            return TermIattandance + "/" + TermIIattandance;
        }


        //==========================TERM2
        internal static string get_overall_total_marks_final_termII(string Session_id, string Class_id, string Admission_no, string Branch_id, string Term_id)
        {
            Dictionary<string, object> dc1 = get_term_marks_calculation(Session_id, Branch_id, Class_id, Term_id);
            string Grade_System_Id = (String)dc1["Grade_System_Id"];
            Dictionary<string, object> dc2 = get_grade_logic(Session_id, Branch_id, Grade_System_Id);
            ...
            string result = "";
            string marksType = "";
            string obt_and_full_mark = get_obt_and_full_marks_final_year_only_termII(Session_id, Branch_id, Admission_no, Term_id, Class_id); // Obtain Mark/Full Mark/OverAll Percentage
        ...
        private static string get_obt_and_full_marks_final_year_only_termII(string session_id, string branch_id, string admission_no, string term_id, string class_id)
        {
            string returN = "0/0/0";
            string query = "select  isnull(sum(convert(float, t1.Marks)),0) as Marks,isnull(sum(convert(float, t1.Full_marks)),0) as Full_Marks  from Exam_temp_assesment_total_no_term_II t1 join Exam_Assessment_Details t3 on t1.Session_Id=t3.Session_Id and t1.Branch_Id=t3.Branch_Id and t1.Term_id=t3.Exam_Term_Id and t1.Class_id=t3.Class_id and t1.Assessment_id=t3.Assessment_Id where t1.Session_id=" + session_id + " and  t1.Admission_no='" + admission_no + "'  and t1.Branch_id='" + branch_id + "' and t1.Class_id=" + class_id + " and t1.Term_id='" + term_id + "'";
            DataTable dt = FillDatastatic(query);
            if (dt.Rows.Count == 0)
            {
                return returN;
            ...
            {
                double overall_percentage = (My.toDouble(dt.Rows[0]["Marks"].ToString()) / My.toDouble(dt.Rows[0]["Full_Marks"].ToString())) * 100;
                return dt.Rows[0]["Marks"].ToString() + "/" + dt.Rows[0]["Full_Marks"].ToString() + "/" + overall_percentage.ToString("0.00");
            }
        }
    }
}