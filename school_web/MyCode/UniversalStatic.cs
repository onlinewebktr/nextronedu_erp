...
namespace school_web.MyCode
{
    public class UniversalStatic
    {
        ...
        //public static void DrawLineInFooter(System.Web.UI.Control control, Color color, int thickness)
        //{
        //    int y = control.Height;
        //    DrawLine(control, color, 0, y, control.Width, y, thickness);
        //}
        //public static void DrawLine(System.Web.UI.Control control, Color color, int x, int y, int x1, int y1, int thickness)
        //{
