...
namespace school_web.MyCode  
{
    public class ZkemClient : IZKEM  
    {
        ...
        void objCZKEM_OnAttTransaction(int EnrollNumber, int IsInValid, int AttState, int VerifyMethod, int Year, int Month, int Day, int Hour, int Minute, int Second)
        {
        ...
        {
            //if (My.txt_enrollment != null)
            //{
            //    My.txt_enrollment.Text = EnrollNumber;
            //}
        ...
        {
            return objCZKEM.CaptureImage(FullImage, Width, Height, Image, ImageFile);
        }
        ...
        {
            return objCZKEM.SetUserTmp(dwMachineNumber, dwEnrollNumber, dwFingerIndex, ref TmpData);
        }
