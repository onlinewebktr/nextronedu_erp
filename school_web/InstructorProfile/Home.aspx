<%@ Page Title="" Language="C#" MasterPageFile="~/InstructorProfile/Teacher_Profile.Master" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="school_web.InstructorProfile.Home" %>
                                    ...
                                    <div class="stat-widget-five">
                                        ...
                                        <div class="stat-content">
                                            <div class="text-left dib">
                                                <div class="stat-text">
                                                    <span class="count">
                                                        <asp:Label ID="lbl_Teachers" runat="server" Text="1"></asp:Label></span>
                                                </div>
                                ...
                                <div class="stat-widget-five">
                                    ...
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            <div class="stat-text">
                                                <span class="count">
                                                    <asp:Label ID="lbl_Licence" runat="server" Text=""></asp:Label></span>
                                            </div>
                                            <div class="stat-heading">Total Licence</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane tabs-animation fade" id="tab-content-2" role="tabpanel" style="display: none">
                                <asp:Literal ID="ltScriptsTeacher" runat="server"></asp:Literal>
                                <div id="chartTeachers" style="width: 1000px; height: 400px;">
                                </div>
                            </div>
                            <div class="tab-pane tabs-animation fade" id="tab-content-3" role="tabpanel" style="display: none">
