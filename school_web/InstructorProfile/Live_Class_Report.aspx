<%@ Page Title="" Language="C#" MasterPageFile="~/InstructorProfile/Teacher_Profile.Master" AutoEventWireup="true" CodeBehind="Live_Class_Report.aspx.cs" Inherits="school_web.InstructorProfile.Live_Class_Report" %>
<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">Live Class Report
</asp:Content>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:Label ID="lbl_student_present" runat="server" Text='<%#Bind("no_of_persent") %>'></asp:Label>
                                                     <asp:Label ID="lbl_teacherName" runat="server" Text='<%#Bind("Name") %>' Visible="false"></asp:Label>
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                                    </asp:Repeater>
