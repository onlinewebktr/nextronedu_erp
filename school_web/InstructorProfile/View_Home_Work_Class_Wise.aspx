<%@ Page Title="" Language="C#" MasterPageFile="~/InstructorProfile/Teacher_Profile.Master" AutoEventWireup="true" CodeBehind="View_Home_Work_Class_Wise.aspx.cs" Inherits="school_web.InstructorProfile.View_Home_Work_Class_Wise" %>
        ...
        <div class="app-page-title">
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    ...
                    <div>
                        <asp:Literal ID="ltUsertop" runat="server">Uploaded Homework</asp:Literal>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <table class="table table-bordered" style="width: 100%:">
                        ...
                        <tr>
                            <td style="font-size: 16px; font-weight: bold;">Home Work Details
                            </td>
                        </tr>
                        <tr>
                            <td style="font-size: 14px!important;">
                                <div style="font-size: 14px!important; height: 100px; overflow-x: hidden; overflow-y: scroll; float: left; width: 100%;">
                                    <asp:Label ID="txt_info1" runat="server" Style="font-size: 13px!important"></asp:Label>
                                </div>
                            </td>
