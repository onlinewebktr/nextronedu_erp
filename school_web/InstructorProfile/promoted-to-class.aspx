<%@ Page Title="" Language="C#" MasterPageFile="~/InstructorProfile/Teacher_Profile.Master" AutoEventWireup="true" CodeBehind="promoted-to-class.aspx.cs" Inherits="school_web.InstructorProfile.promoted_to_class" %>
        ...
        <div class="app-page-title">
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    ...
                    <div>
                        <asp:Literal ID="ltUsertop" runat="server">Promoted to Class</asp:Literal>
                    </div>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-xs-10 col-sm-3 col-md-10 col-lg-10">
                                <div class="row" style="padding: 0px 0px 0px 15px;">
                                    ...
                                    <div class="form-group col-xs-10 col-sm-3 col-md-2 col-lg-2">
                                        <label>Promoted to Class<sup>*</sup></label>
                                        <asp:DropDownList ID="ddl_promoted_to_class" class="form-control" runat="server" Style="width: 98%"></asp:DropDownList>
                                    </div>

                                    <div class="form-group col-xs-10 col-sm-3 col-md-2 col-lg-2">
                                        <label for="validationCustom01" class="form-label">School Reopen on<sup>*</sup></label>
                                        <asp:TextBox ID="txt_school_reopen_on" runat="server" class="form-control" Style="width: 98%"></asp:TextBox>
                                    </div>
