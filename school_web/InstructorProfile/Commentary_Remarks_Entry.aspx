<%@ Page Title="" Language="C#" MasterPageFile="~/InstructorProfile/Teacher_Profile.Master" AutoEventWireup="true" CodeBehind="Commentary_Remarks_Entry.aspx.cs" Inherits="school_web.InstructorProfile.Commentary_Remarks_Entry" %>
        ...
        <div class="app-page-title">
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    ...
                    <div>
                        <asp:Literal ID="ltUsertop" runat="server">Commentary Remarks</asp:Literal>
                    </div>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-xs-10 col-sm-3 col-md-10 col-lg-10">
                                <div class="row" style="padding: 0px 0px 0px 15px;">
                                    ...
                                    <div class="form-group col-xs-10 col-sm-3 col-md-2 col-lg-2">
                                        <label>Remarks Type<sup>*</sup></label>
                                        <asp:DropDownList ID="ddl_remarkstype" class="form-control" runat="server" Style="width: 98%"></asp:DropDownList>
                                    </div> 
                                ...
                                <asp:Repeater ID="RPDetails" runat="server" OnItemDataBound="RPDetails_ItemDataBound">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                 <asp:DropDownList ID="ddl_remarkstypenew" class="form-control" runat="server" Style="width: 98%"></asp:DropDownList>
