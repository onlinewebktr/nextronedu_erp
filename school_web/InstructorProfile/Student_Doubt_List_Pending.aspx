<%@ Page Title="" Language="C#" MasterPageFile="~/InstructorProfile/Teacher_Profile.Master" AutoEventWireup="true" CodeBehind="Student_Doubt_List_Pending.aspx.cs" Inherits="school_web.InstructorProfile.Student_Doubt_List_Pending" %>

<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
    Student Asked Doubt List
</asp:Content>
        ...
        <div class="app-page-title">
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    ...
                    <div>
                        <asp:Literal ID="ltUsertop" runat="server">Student Asked Doubt List </asp:Literal>
