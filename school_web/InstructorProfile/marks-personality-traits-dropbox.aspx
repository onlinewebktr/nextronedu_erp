<%@ Page Title="" Language="C#" MasterPageFile="~/InstructorProfile/Teacher_Profile.Master" AutoEventWireup="true" CodeBehind="marks-personality-traits-dropbox.aspx.cs" Inherits="school_web.InstructorProfile.marks_personality_traits_dropbox" %>
                            ...
                            <div class="form-group col-xs-10 col-sm-3 col-md-10 col-lg-10">
                                <div class="row" style="padding: 0px 0px 0px 15px;">
                                    ...
                                    <div class="form-group col-xs-10 col-sm-3 col-md-2 col-lg-2">
                                        ...
                                        <asp:DropDownList ID="ddl_remarksF" class="form-control" runat="server" Style="width: 98%"></asp:DropDownList>
                                    </div>
                                ...
                                <asp:Repeater ID="RPDetails" runat="server" OnItemDataBound="RPDetails_ItemDataBound">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="ddl_remarks" runat="server" class="grd-txtbx-clas"></asp:DropDownList>
                                            </td>
                                        </tr>
                                    </ItemTemplate>
                                </asp:Repeater>
