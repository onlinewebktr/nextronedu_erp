<%@ Page Title="" Language="C#" MasterPageFile="~/InstructorProfile/Teacher_Profile.Master" AutoEventWireup="true" CodeBehind="view-self-added-syllabus.aspx.cs" Inherits="school_web.InstructorProfile.view_self_added_syllabus" %>
        ...
        <div class="app-page-title">
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    ...
                    <div>
                        <asp:Literal ID="ltUsertop" runat="server">Syllabus List</asp:Literal>

                    </div>
                </div>
                <div class="page-title-actions">
                    <a href="add-syllabus.aspx" class="btn-shadow btn btn-info">
