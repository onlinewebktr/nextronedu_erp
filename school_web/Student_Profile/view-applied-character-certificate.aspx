<%@ Page Title="" Language="C#" MasterPageFile="~/Student_Profile/main.Master" AutoEventWireup="true" CodeBehind="view-applied-character-certificate.aspx.cs" Inherits="school_web.Student_Profile.view_applied_character_certificate" %>
        ...
        <div class="container">
            ...
            <div class="main-card mb-3 card">
                <div class="card-header">
                    <h4 class="card-title">View Character Certificate</h4>
                </div>
                <div class="card-body">
