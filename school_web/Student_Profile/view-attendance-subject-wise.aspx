<%@ Page Title="" Language="C#" MasterPageFile="~/Student_Profile/main.Master" AutoEventWireup="true" CodeBehind="view-attendance-subject-wise.aspx.cs" Inherits="school_web.Student_Profile.view_attendance_subject_wise" %>
        ...
        <div class="container">
            ...
            <div class="main-card mb-3 card">
                <div class="card-header">
                    <h4 class="card-title">Attendance Subject Wise</h4>
                </div>
                                                                    ...
                                                                    <ItemTemplate>
                                                                        <tr>
                                                                            ...
                                                                            <td style="text-align: left;">
                                                                                ...
                                                                                <asp:Label ID="lbl_reg_id" Visible="false" runat="server" Text='<%#Bind("admissionserialnumber")%>'></asp:Label>
                                                                            </td>
                                                                            ...
                                                                            <td style="text-align: left;">
                                                                                <asp:Label ID="Label1" runat="server" Text='<%#Bind("Attendance_Date")%>'></asp:Label>
                                                                            </td>
                                                                            <td style="text-align: left;">
