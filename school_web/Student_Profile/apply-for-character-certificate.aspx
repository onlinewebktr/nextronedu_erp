<%@ Page Title="" Language="C#" MasterPageFile="~/Student_Profile/main.Master" AutoEventWireup="true" CodeBehind="apply-for-character-certificate.aspx.cs" Inherits="school_web.Student_Profile.apply_for_character_certificate" %>
                     ...
                     <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                        <div class="main-card mb-3 card">
                            <div class="card-header">
                                <h4 class="card-title">Apply For Character Certificate</h4>
                            </div>
                            <div class="card-body">
                                <div class="form-row">
                                    <div class="col-md-12">
                                        ...
                                        <asp:Button ID="btn_Submit" ValidationGroup="A" runat="server" Text="Apply For  Character Certificate" class="mt-2 btn btn-primary" OnClick="btn_Submit_Click" />
                                    </div>
                                </div>
                            </div>
                        </div>
