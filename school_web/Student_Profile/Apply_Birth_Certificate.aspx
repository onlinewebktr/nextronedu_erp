<%@ Page Title="" Language="C#" MasterPageFile="~/Student_Profile/main.Master" AutoEventWireup="true" CodeBehind="Apply_Birth_Certificate.aspx.cs" Inherits="school_web.Student_Profile.Apply_Birth_Certificate" %>
<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">Apply Birth Certificate
</asp:Content>
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                        <div class="main-card mb-3 card">
                            <div class="card-header">
                                <h4 class="card-title">Apply For Birth Certificate</h4>
                            </div>
                            <div class="card-body">
                                <div class="form-row">
                                    <div class="col-md-12">
                                        ...
                                        <asp:Button ID="btn_Submit" ValidationGroup="A" runat="server" Text="Apply For Birth Certificate" class="mt-2 btn btn-primary" OnClick="btn_Submit_Click" />
                                    </div>
                                </div>
                            </div>
                        </div>
