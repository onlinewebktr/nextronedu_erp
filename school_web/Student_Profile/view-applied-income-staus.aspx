<%@ Page Title="" Language="C#" MasterPageFile="~/Student_Profile/main.Master" AutoEventWireup="true" CodeBehind="view-applied-income-staus.aspx.cs" Inherits="school_web.Student_Profile.view_applied_income_staus" %>
<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">Applied Income Certificate Status
</asp:Content>
        ...
        <div class="container">
            ...
            <div class="main-card mb-3 card">
                <div class="card-header">
                    <h4 class="card-title">View Income Certificate</h4>
                </div>
                <div class="card-body">
