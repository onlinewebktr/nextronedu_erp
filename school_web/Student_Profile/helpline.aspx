<%@ Page Title="" Language="C#" MasterPageFile="~/Student_Profile/main.Master" AutoEventWireup="true" CodeBehind="helpline.aspx.cs" Inherits="school_web.Student_Profile.helpline" %>
<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">Help Desk
</asp:Content>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="main-card mb-3 card">
                            ...
                            <div class="card-body">
                                <div class="form-row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="hm-abot-img" style="text-align: center;">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="hm-abot-title-sec">
                                            ...
                                            <p class="othr-pg-cont-wpr-p" style="text-align: center;
    font-size: 51px;">
