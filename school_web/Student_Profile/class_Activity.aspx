<%@ Page Title="" Language="C#" MasterPageFile="~/Student_Profile/main.Master" AutoEventWireup="true" CodeBehind="class_Activity.aspx.cs" Inherits="school_web.Student_Profile.class_Activity" %>
<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">CLass Activity
</asp:Content>
        ...
        <div class="container">
            ...
            <div class="main-card mb-3 card">
                <div class="card-header">
                    <h4 class="card-title">CLass Activity</h4>
                </div>
                    ...
                    <div class="headingtablee">
                        <div class="row">
                              ...
                              <div class="col-lg-2 col-width-50 pads-rght-5">
                                <label for="validationCustom01" class="lebelheadpp">Subject</label>
                        ...
                        <div class="row">
                            ...
                            <a href='<%#Eval("Attachment") %>' id="attachmentss" runat="server" download="" style="background: #14bb00; padding: 5px 5px 5px 5px; border-radius: 2px; color: #fff; font-weight: 600;" target="_blank">Download</a>
                                                                            </td>
