<%@ Page Title="" Language="C#" MasterPageFile="~/Student_Profile/main.Master" AutoEventWireup="true" CodeBehind="view-applied-tc-staus.aspx.cs" Inherits="school_web.Student_Profile.view_applied_tc_staus" %>

<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
    View Applied TC Status
</asp:Content>
        ...
        <div class="container">
            ...
            <div class="main-card mb-3 card">
                <div class="card-header">
                    <h4 class="card-title">TC Status</h4>
                </div>
                                                ...
                                                <asp:Repeater ID="rd_view" runat="server" OnItemDataBound="rd_view_ItemDataBound">
                                                    <ItemTemplate>
                                                        <tr>
                                                            ...
                                                            <td style="text-align: left;">
                                                                <asp:Label ID="lbl_Reply_datetime" runat="server" Text='<%#Bind("Reply_datetime1")%>'></asp:Label>
                                                            </td>
