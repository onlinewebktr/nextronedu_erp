<%@ Page Title="" Language="C#" MasterPageFile="~/Student_Profile/main.Master" AutoEventWireup="true" CodeBehind="study-material.aspx.cs" Inherits="school_web.Student_Profile.study_material" %>
                            ...
                            <asp:Repeater ID="rd_view" runat="server">
                                <ItemTemplate>
                                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                        <div class="std-mt-dv">
                                            <a href="study-material-details.aspx?topicid=<%#Eval("TopicID") %>">
                                                ...
                                                <div class="std-mt-cont-sec">
                                                    ...
                                                    <p class="std-mt-cont-desc"><%#Eval("TopicName") %></p>
                                                    <p class="std-mt-cont-upload-date">Upload Date : <%#Eval("Date") %></p>
                                                </div>
                                            </a>
                                        </div>
                                    </div>
