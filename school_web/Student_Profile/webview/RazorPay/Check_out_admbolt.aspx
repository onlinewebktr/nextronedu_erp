<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Check_out_admbolt.aspx.cs" Inherits="school_web.Student_Profile.webview.RazorPay.Check_out_admbolt" %>
        ...
        <div>
            <div>
                ...
                <script>
                    ...
                    var callback_url = $("#<%=callback_url.ClientID%>").val();
                    ...
                    var options = {
                        ...
                        "callback_url": callback_url, //"https://eneqd3r9zrjok.x.pipedream.net/",
