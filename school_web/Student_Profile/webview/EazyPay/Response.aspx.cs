        ...
        private void RecoverResponsePacket()
        {
            ...
            try//1.ResponseCode
            {
                ...
                if (ResponseCode != "E000")// Transaction Failed.
                {
                    ...
                    My.exeSql("update Payment_transaction_process set razorpay_order_id='" + ViewState["ordertrackingid"].ToString() + "',razorpay_payment_id='',status='Failed',Remarks='"+ Remarks + "'  where  ordertrackingid='" + ViewState["ordertrackingid"].ToString() + "'");
                ...
                else
                {
                    ...
                    try
                    {
                        ...
                        //25070705075331830 | 12345 | 2.00 | Trisha Singh | A - 1019 | VIII | A | 1 | 2025 - 2026 | na@gmail.com | 8298649924
                        string resData = mandatory_fields;
                        string resData1 = resData;
                        string[] values = resData.Split('|');
                    ...
                    My.exeSql("update Payment_transaction_process set razorpay_order_id='" + ViewState["ordertrackingid"].ToString() + "',razorpay_payment_id='" + Unique_Ref_Number + "',status='Success',Remarks='Received successful confirmation in real time for the transaction.'  where  ordertrackingid='" + ViewState["ordertrackingid"].ToString() + "'");
