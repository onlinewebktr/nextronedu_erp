<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Notice_Board_Details.aspx.cs" Inherits="school_web.Student_Profile.webview.Notice_Board_Details" %>
...
<body  style="background-color: #fffdc0;">
    <form id="form1" runat="server">
        ...
        <div class="fullinfo">
            ...
            <%--<h2 class="messbox-sec-h2" style="display:none">Notice Board</h2>--%>
                            ...
                            <table class="table" style="width: 100%;">
                                ...
                                <tr>
                                    <td style="padding: 2px 0px 2px 0px;">
                                        <asp:Label ID="Label1" Style="font-size: 13px; text-transform: capitalize;"
                                ...
                                <tr>
                                    <td style="padding: 2px 0px 2px 0px; text-align: center">
                                        ...
                                        <asp:Panel ID="Panel1" runat="server">
                                            <a href='<%#Eval("Attachment") %>' download target="_blank" style="display: block; padding: 0px 0px 0px 0px; font-size: 22px; color: #0066CC; text-decoration: none;"><i class="fa fa-download" aria-hidden="true"></i></a>
                                        </asp:Panel>
                                    </td>
