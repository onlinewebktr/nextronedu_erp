<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="School_Calendar.aspx.cs" Inherits="school_web.Student_Profile.webview.School_Calendar" %>
...
<body>
    <form id="form1" runat="server">
        <div class="fullinfo">
            ...
            <%-- <h2 class="messbox-sec-h2">School Calendar</h2>--%>
            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2" style="padding-right: 5px; padding-left: 5px;">
                <p class="textcont1 "><b>Month</b>  </p>
            </div>
            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5" style="padding-right: 5px; padding-left: 5px;">
                <p class="textcont3">
