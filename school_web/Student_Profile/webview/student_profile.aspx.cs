...
namespace school_web.Student_Profile.webview
{
    public partial class student_profile : System.Web.UI.Page
    {
        ...
        private void BindDetails()
        {
            ...
            DataTable dt = mycode.FillTable("Select top 1 *,(" + house + ") as housename from admission_registor where admissionserialnumber='" + ViewState["regid"].ToString() + "' and Session_id=" + ViewState["sesssionid"].ToString() + " and Transfer_Status in ('New','NT') and  StudentStatus='AV' order by id desc ");
            if (dt.Rows.Count == 0)
            {
            ...
            else
            {
                ...
                lbl_account_name.Text = dt.Rows[0]["Bank_acount_no"].ToString();
        ...
        {
            Response.Redirect("student_profile_Edit.aspx?regid=" + ViewState["regid"].ToString(), false);
        }
    }
}