...
{
    public partial class Req_NewMonthley_worldline : System.Web.UI.Page
    {
        ...
        private void Bind_data_online_reg()
        {
            try
            {
                ...
                TXT_returnURL.Text = My.URL() + "Student_Profile/webview/worldline/Resp_NewMonthley_worldline.aspx";
