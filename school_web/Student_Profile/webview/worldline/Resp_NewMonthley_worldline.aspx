<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Resp_NewMonthley_worldline.aspx.cs" Inherits="school_web.Student_Profile.webview.worldline.Resp_NewMonthley_worldline" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <div class="loading" align="center" id="a1" runat="server">
                Please wait. Processing payment. Please do not close the app until the payment process is complete.
        <br />
                <br />
                <img src="loader.gif" />
                <div>
