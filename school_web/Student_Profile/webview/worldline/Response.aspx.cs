    ...
    public partial class Response : System.Web.UI.Page
    {
        ...
        private void btn_send_data()
        {
            if (ViewState["statuS"].ToString() == "Paid")
            {
                ...
                if (status == true)
                {
                    Response.Redirect("../Payment_Success_Message.aspx?orderid=" + ViewState["orderno"].ToString() + "&Regid=" + ViewState["Admission_no"].ToString() + "&payFrom=" + ViewState["payFrom"].ToString(), false);
                }
                else
                {
                    Response.Redirect("../Payment_Error_Message.aspx?orderid=" + ViewState["orderno"].ToString() + "&Regid=" + ViewState["Admission_no"].ToString() + "&payFrom=" + ViewState["payFrom"].ToString(), false);
                }
            }
