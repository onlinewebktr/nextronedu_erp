<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Class_Routing.aspx.cs" Inherits="school_web.Student_Profile.webview.Class_Routing" %>
    ...
    <form id="form1" runat="server">
        ...
        <script type="text/javascript">
            ...
            app.controller('RpCardAppCtrl', function ($scope, $http) {
                ...
                $http.get("WebService1.asmx/fetch_class_routine_details", { params: { "Session_id": session_id, "Class_id": class_id, "Section": section } }).then(function (response) {
                    ...
                    if ($scope.reportHeadinG == "") {
                        ...
                        $http.get("WebService1.asmx/fetch_class_routine_details_day", { params: { "Session_id": session_id, "Class_id": class_id, "Section": section } }).then(function (response) {
