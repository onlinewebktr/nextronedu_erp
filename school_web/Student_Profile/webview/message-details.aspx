<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="message-details.aspx.cs" Inherits="school_web.Student_Profile.webview.message_details" %>
                    ...
                    <ItemTemplate>
                        <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12" style="margin-top: 4px; padding-right: 10px; padding-left: 10px; border-bottom: 0px dashed #beb7b7;">
                            <table class="table" style="width: 100%;">
                                <tr>
                                    <td style="padding: 2px 0px 2px 0px; border-bottom: 1px solid #beb7b7; position: relative; font-weight: bold"><i class="fa fa-calendar" aria-hidden="true" style="color: #000"></i>&nbsp;<asp:Label ID="lbl_Posted_Date" Font-Bold="true" runat="server" Text='<%#Bind("Date1") %>'></asp:Label>
