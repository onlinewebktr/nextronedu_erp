<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OnlineResultview.aspx.cs" Inherits="school_web.Student_Profile.webview.OnlineResultview" %>
                                                    ...
                                                    <table style="margin: 0px; padding: 0px; float: left; height: auto; width: 100%; text-align: left">
                                                        ...
                                                        <tr>
                                                            <td style="padding: 1px 0px 1px 3px; text-align: left;" colspan="2">
                                                                ...
                                                                <%--<br />--%>
                                                                <span style="color: Blue; display: none">Answer</span>
