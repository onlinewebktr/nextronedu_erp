    ...
    public partial class Response : System.Web.UI.Page
    {
        ...
        private void handleResponse()
        {
            ...
            if (status.ToString() == "SUCCESS")
            {
                ...
                My.exeSql("update Payment_transaction_process set razorpay_payment_id='" + getepayTxnId + "',status='Success',Response_String='" + response + "',razorpay_signature='" + Encrypted_url + "'  where  ordertrackingid='" + ViewState["ordertrackingid"].ToString() + "' and Admission_no='" + ViewState["regid"].ToString() + "'");
            ...
            else
            {
                ...
                My.exeSql("update Payment_transaction_process set razorpay_payment_id='" + getepayTxnId + "',status='Failed',Response_String='" + response + "',razorpay_signature='" + Encrypted_url + "'  where  ordertrackingid='" + ViewState["ordertrackingid"].ToString() + "' and Admission_no='" + ViewState["regid"].ToString() + "'");
