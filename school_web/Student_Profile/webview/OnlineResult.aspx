<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OnlineResult.aspx.cs" Inherits="school_web.Student_Profile.webview.OnlineResult" %>
                ...
                <div class="certificate-wpr2">
                    <div class="mainwith">
                        ...
                        <asp:Label ID="lbl_schoolno" runat="server" Font-Bold="true"></asp:Label>
                            ...
                            <div class="slipno">
                                <div class="slipno_middle" style="width: 100%; text-align: center;padding-left: 210px;">
                        ...
                        <asp:Label ID="lbl_paymentdate" runat="server" Font-Bold="true"></asp:Label>
                            ...
                            <div class="studentdetails">
                                <table style="margin: 0px; padding: 0px; float: left; height: auto; width: 100%; font-size: 16px;">
                                    <tr>
