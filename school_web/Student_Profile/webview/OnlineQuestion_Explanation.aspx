<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OnlineQuestion_Explanation.aspx.cs" Inherits="school_web.Student_Profile.webview.OnlineQuestion_Explanation" %>
        ...
        <div class="texbox-border" style="padding: 0px 5px; overflow: auto">
            <div class="card wow rotateInDownLeft" data-wow-delay=".50s" style="background: #fff;">
                ...
                <asp:LinkButton ID="print1" OnClick="print1_Click" runat="server" CssClass="a11">
                    <img src="../../Online_Test_admin/Doc/backbtn.png" height="25" alt="" width="25" border="0" style="text-align: left; float: left; margin: 7px 0px 0px 10px;background: #000;
