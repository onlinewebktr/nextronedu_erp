<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Notice_Board.aspx.cs" Inherits="school_web.Student_Profile.webview.Notice_Board" %>
                            ...
                            <div style="width: 100%; float: left; height: auto; background-color: #ffffff; border-radius: 5px; box-shadow: rgba(0, 0, 0, 0.16) 0px 1px 4px; margin: 5px 0px 5px 0px;">
                                ...
                                <div style="position: relative; width: 75%; height: auto; padding: 5px 5px 5px 10px; float: left; border-left: 1px solid #c9c9c9;">
                                    ...
                                    <asp:Panel ID="Panel1" runat="server" Style="display: none;">
                                        <a href='<%#Eval("Attachment") %>' target="_blank" download style="display: block; padding: 0px 0px 0px 0px; font-size: 18px; color: #0066CC; text-decoration: none; float: right;"><i class="fa fa-download" aria-hidden="true"></i></a>
                                    </asp:Panel>
