...
namespace school_web.Student_Profile
{
    public partial class profile : System.Web.UI.Page
    {
        ...
        private void BindDetails()
        {
            ...
            DataTable dt = My.dataTable("Select top 1 *,(" + house + ") as housename from admission_registor where admissionserialnumber='" + ViewState["regid"].ToString() + "' and Session_id=" + ViewState["sesssionid"].ToString() + " and Transfer_Status in ('New','NT') and  StudentStatus='AV' order by id desc ");
            if (dt.Rows.Count == 0)
            {
        ...
        {
            Response.Redirect("profile-edit.aspx", false);
        }
    }
}