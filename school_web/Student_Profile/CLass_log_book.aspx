<%@ Page Title="" Language="C#" MasterPageFile="~/Student_Profile/main.Master" AutoEventWireup="true" CodeBehind="CLass_log_book.aspx.cs" Inherits="school_web.Student_Profile.CLass_log_book" %>
<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">Class Log-Book
</asp:Content>
        ...
        <div class="container">
            ...
            <div class="main-card mb-3 card">
                <div class="card-header">
                    <h4 class="card-title">Class Log-Book</h4>
                </div>
                                                                    ...
                                                                    <ItemTemplate>
                                                                        <tr>
                                                                            ...
                                                                            <td style="text-align: left;">
                                                                              <asp:Label ID="lbl_teacher" runat="server" Text='<%#Bind("Teacher")%>'></asp:Label>
                                                                            </td>
                                                                            ...
                                                                            <td style="text-align: left;">
                                                                                     <asp:Label ID="lbl_attachment" Visible="false" runat="server" Text='<%#Bind("Attachments") %>'></asp:Label>
                            <a href='<%#Eval("Attachments") %>' id="attachmentss" runat="server" download="" style="background: #14bb00; padding: 5px 5px 5px 5px; border-radius: 2px; color: #fff; font-weight: 600;">Download</a>
                                                                            </td>
