<%@ Page Title="" Language="C#" MasterPageFile="~/Examination_Admin/Admin.Master" AutoEventWireup="true" CodeBehind="student-result-final.aspx.cs" Inherits="school_web.Examination_Admin.student_result_final" %>
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active">Print Final Progress Report</li>
                        </ol>
                    </nav>
                </div>
            </div>
                                ...
                                <div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap5 hdrmodify">
                                    ...
                                    <div class="find-dv">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-2">
                                                <asp:Button ID="btn_print_all" runat="server" Text="Print All" class="btn btn-primary find-dv-btn" OnClick="btn_print_all_Click" />
                                            </div>
                                        </div>
                                    </div>
                                                            ...
                                                            <td style="text-align: left;">
                                                                ...
                                                                <%--<div class="user-box dropdown" style="float: left; display: inherit; height: auto; border-left: 0px solid #f0f0f0; margin-left: 0px;">
                                                                    ...
                                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                                        <li> 
                                                                            <a id="" runat="server" class="dropdown-item" target="_blank"><i class='bx bx-happy-heart-eyes'></i><span>View Progress Report</span> </a>
                                                                        </li>
                                                                    </ul>
                                                                </div>--%>
                                                            </td>
