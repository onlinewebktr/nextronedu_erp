<%@ Page Title="" Language="C#" MasterPageFile="~/Examination_Admin/Admin.Master" AutoEventWireup="true" CodeBehind="personality-traits-master.aspx.cs" Inherits="school_web.Examination_Admin.personality_traits_master" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Personality Traits Master   
</asp:Content>
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Personality Traits Master</li>
                        </ol>
                    </nav>
                </div>
            </div>
                                            ...
                                            <asp:GridView ID="grid_grade" runat="server" AutoGenerateColumns="False" Style="width: 100%" class="table table-striped table-bordered dataTable">
                                                <Columns> 
                                                    ...
                                                    <asp:TemplateField HeaderText="Remark Types">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lbl_Remark_Types" runat="server" Text='<%#Bind("Contents") %>'></asp:Label>
                                                        </ItemTemplate> 
                                                    </asp:TemplateField> 
