<%@ Page Title="" Language="C#" MasterPageFile="~/Examination_Admin/Admin.Master" AutoEventWireup="true" CodeBehind="tabulation-sheet-new.aspx.cs" Inherits="school_web.Examination_Admin.tabulation_sheet_new" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="head" runat="server">
    ...
    <link href="slip/assets/css/tabulationSheetNew.css" rel="stylesheet" />
    <script type="text/javascript">
        function PrintPanel() {
            ...
            printWindow.document.write('<link href="slip/assets/css/tabulationSheetNew.css" rel="stylesheet" type="text/css" />');
                                                        ...
                                                        <div class="prnt-dv-wpr printborder" id="tblCustomers">
                                                            ...
                                                            <table class="table  table-bordered" style="width: 100%">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <th data-ng-repeat="x in reportTFM" class="{{x.Bg_colors}}">{{x.FM}}</th>

                                                                    <th data-ng-repeat="x in reportTG" class="{{x.Bg_colors}}">{{x.FMG}}</th>
                                                                    ...
                                                                    <%--<th data-ng-repeat="x in reportTCSCG" class="{{x.Bg_colors}}">{{x.FMG}}</th>
                                                                    <th data-ng-repeat="x in reportTDSCG" class="{{x.Bg_colors}}">{{x.FMG}}</th>--%>
                                                                </tr>
        ...
        app.controller('RpCardAppCtrl', function ($scope, $http) {
            ...
            $scope.ButtonClickFind = function () {
                ...
                if (session_id == "0") {
                    ...
                    $http.get("webService/tabulation-sheet-new.asmx/fetch_tabulation_assesment", { params: { "Session_id": session_id, "Class_id": class_id, "Term_id": term_id, "Section": section } }).then(function (response) {
                        $scope.reportAssmentHeadinG = response.data;
                    })

                    $http.get("webService/tabulation-sheet-new.asmx/fetch_tabulation_subjects", { params: { "Session_id": session_id, "Class_id": class_id, "Term_id": term_id, "Section": section } }).then(function (response) {
                        $scope.reportSubjectHeadinG = response.data;
                    })

                    //FetchSubjTH/PR
                    $http.get("webService/tabulation-sheet-new.asmx/fetch_tabulation_subjects_th_pr", { params: { "Session_id": session_id, "Class_id": class_id, "Term_id": term_id, "Section": section, "Branch_id": branch_id } }).then(function (response) {
                        $scope.reportSubjectHeadinGthpr = response.data;
                    })
                    //FetchSubjMarkS
                    $http.get("webService/tabulation-sheet-new.asmx/fetch_tabulation_subjects_full_marks", { params: { "Session_id": session_id, "Class_id": class_id, "Term_id": term_id, "Section": section, "Branch_id": branch_id } }).then(function (response) {
                        $scope.reportSubjectHeadinGFM = response.data;
                    })

                    //FetchSubjMarkS
                    $http.get("webService/tabulation-sheet-new.asmx/fetch_tabulation_subjects_ttl_full_marks", { params: { "Session_id": session_id, "Class_id": class_id, "Term_id": term_id, "Section": section, "Branch_id": branch_id } }).then(function (response) {
                        $scope.reportTFM = response.data;
                    })

                    //FetchSubjMarkS
                    $http.get("webService/tabulation-sheet-new.asmx/fetch_tabulation_subjects_G", { params: { "Session_id": session_id, "Class_id": class_id, "Term_id": term_id, "Section": section, "Branch_id": branch_id } }).then(function (response) {
                        $scope.reportTG = response.data;
                    })

                    $http.get("webService/tabulation-sheet-new.asmx/fetch_tabulation_student_marks", { params: { "Session_id": session_id, "Class_id": class_id, "Term_id": term_id, "Section": section } }).then(function (response) {
                    ...
                    //======================
                    $http.get("webService/tabulation-sheet-new.asmx/fetch_tabulation_coscholastic", { params: { "Session_id": session_id, "Class_id": class_id, "Term_id": term_id, "Section": section, "Branch_id": branch_id } }).then(function (response) {
                        $scope.reportAssmentHeadinGCoscholastic = response.data;
                    })

                    //FetchSubjMarkS
                    $http.get("webService/tabulation-sheet-new.asmx/fetch_tabulation_coscholastic_G", { params: { "Session_id": session_id, "Class_id": class_id, "Term_id": term_id, "Section": section, "Branch_id": branch_id } }).then(function (response) {
                        $scope.reportTCSCG = response.data;
                    })


                    //======================
                    $http.get("webService/tabulation-sheet-new.asmx/fetch_tabulation_Descpline", { params: { "Session_id": session_id, "Class_id": class_id, "Term_id": term_id, "Section": section, "Branch_id": branch_id } }).then(function (response) {
                        $scope.reportAssmentHeadinGDescpline = response.data;
                    })

                    $http.get("webService/tabulation-sheet-new.asmx/fetch_tabulation_coscholastic_DESC", { params: { "Session_id": session_id, "Class_id": class_id, "Term_id": term_id, "Section": section, "Branch_id": branch_id } }).then(function (response) {
