<%@ Page Title="" Language="C#" MasterPageFile="~/Examination_Admin/Admin.Master" AutoEventWireup="true" CodeBehind="update-highest-marks.aspx.cs" Inherits="school_web.Examination_Admin.update_highest_marks" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="page-wrapper">
        <div class="page-content">
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Update Highest Marks</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <asp:Label ID="ltUsertop" runat="server" Style="font-weight: 500; font-size: 1rem;" class="mb-0 text-uppercase" Text="Update Highest Marks"></asp:Label>
                    <hr />
                    <div class="card">
                        <div class="card-body">
                                    ...
                                    <div class="col-md-10">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <asp:DropDownList ID="ddl_subject" class="form-select find-dv-txtbx" runat="server" Style="width: 98%"></asp:DropDownList>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-xl-12">
                                                    ...
                                                    <ItemTemplate>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <asp:Label ID="lbl_course_id" runat="server" Font-Names="Arial" Visible="false" Text='<%#Bind("course_id") %>'></asp:Label>
                                                            </td>
                                                            <td>
                                                                <asp:TextBox ID="txt_marks" runat="server" class="grd-txtbx-clas" onkeypress="return isNumberKey(event)"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                    </ItemTemplate>
                                                </asp:Repeater>
                                        ...
                                        <div class="form-group col-xs-10 col-sm-3 col-md-12 col-lg-12">
                                            <asp:Button ID="btn_save" runat="server" class="btn btn-sm btn-success" OnClick="btn_save_Click" Text="Save" Style="margin: 0px 0px 0px 0px; padding: 6px 10px 8px; float: right;" />
                                        </div>
                                    </div>
                                </div>
                            </div>
