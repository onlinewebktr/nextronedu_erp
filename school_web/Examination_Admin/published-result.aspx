<%@ Page Title="" Language="C#" MasterPageFile="~/Examination_Admin/Admin.Master" AutoEventWireup="true" CodeBehind="published-result.aspx.cs" Inherits="school_web.Examination_Admin.published_result" %>
                                                            ...
                                                            <%--<td style="text-align: left;">
                                                                <div class="user-box dropdown" style="float: left; display: inherit; height: auto; border-left: 0px solid #f0f0f0; margin-left: 0px;">
                                                                    ...
                                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                                        <li>
                                                                            <a class="dropdown-item" href="slip/report-card-termI.aspx?admNo=<%#Eval("Admission_no") %>&ssion_id=<%#Eval("Session_id") %>&clss_id=<%#Eval("Class_id") %>&Branch_id=<%#Eval("Branch_id") %>&Term_id=<%#Eval("Term") %>&RequestFrom=0" target="_blank"><i class='bx bx-happy-heart-eyes'></i><span>View Progress Report</span> </a>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                            </td>--%>
