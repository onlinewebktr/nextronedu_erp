<%@ Page Title="" Language="C#" MasterPageFile="~/Examination_Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Set_Assessment_Subject.aspx.cs" Inherits="school_web.Examination_Admin.Set_Assessment_Subject" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">Set Assessment Subject
</asp:Content>
                                    ...
                                    <div class="find-dv" style="margin: 0px 0px -1px 0px;">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-1">
                                                ...
                                                <a class="btn btn-success find-dv-btn" href="Assessment_Subject.aspx" style="float: right;"><i class="bx bx-arrow-back"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div id="pnl_Basic" runat="server" visible="false" class="diccontent">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                    ...
                                                    <asp:TextBox ID="txt_Name" runat="server" class="form-control" Enabled="false"></asp:TextBox>
                                                </div>
                                                        ...
                                                        <asp:GridView ID="grid_subject_assesment" runat="server" class="table table-bordered" AutoGenerateColumns="False" Width="100%" Style="margin-top: 20px;" OnRowDataBound="grid_subject_assesment_RowDataBound">
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Name Of Sub Level">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lbl_Subject_Activity_Name" runat="server" Text='<%#Bind("Subject_Activity_Name")%>'></asp:Label>
