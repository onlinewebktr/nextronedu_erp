<%@ Page Title="" Language="C#" MasterPageFile="~/Examination_Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Set_Assessment.aspx.cs" Inherits="school_web.Examination_Admin.Set_Assessment" %>
                                    ...
                                    <div class="find-dv" style="margin: 0px 0px -1px 0px;">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-1">
                                                ...
                                                <a class="btn btn-success find-dv-btn" href="Assessments.aspx" style="float: right;"><i class="bx bx-arrow-back"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div id="pnl_Basic" runat="server" visible="false" class="diccontent">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                    ...
                                                    <asp:RadioButton ID="rd_Scholastic" Checked="true" runat="server" Text="Scholastic" GroupName="ab" Font-Bold="true" />
                                                    <asp:RadioButton ID="rd_Co_scholastic" runat="server" Text="Co-scholastic" GroupName="ab" Font-Bold="true" />
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                    ...
                                                    <asp:DropDownList ID="ddl_exam_term" runat="server" class="form-select">
                                                    </asp:DropDownList>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="row" id="sublevel" runat="server" visible="false">
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                        ...
                                                        <a href="#" data-toggle="tooltip" title="Please select one of the nodes(level/sub level) which must be considered for calculation" style="margin: 7px 0px 0px 0px; float: left;"><i class="bx bxs-info-circle" style="font-size: 26px;"></i></a>
                                                        <asp:GridView ID="grid_subject_assesment" runat="server" class="table table-bordered" AutoGenerateColumns="False" Width="100%" Style="margin-top: 0px;" OnRowDataBound="grid_subject_assesment_RowDataBound">
                                                            <Columns>
