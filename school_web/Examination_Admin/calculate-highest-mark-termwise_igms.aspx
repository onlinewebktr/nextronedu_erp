<%@ Page Title="" Language="C#" MasterPageFile="~/Examination_Admin/Admin.Master" AutoEventWireup="true" CodeBehind="calculate-highest-mark-termwise_igms.aspx.cs" Inherits="school_web.Examination_Admin.calculate_highest_mark_termwise_igms" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server"> Calculate Highest Mark
</asp:Content>
