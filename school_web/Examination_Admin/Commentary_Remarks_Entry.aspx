<%@ Page Title="" Language="C#" MasterPageFile="~/Examination_Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Commentary_Remarks_Entry.aspx.cs" Inherits="school_web.Examination_Admin.Commentary_Remarks_Entry" %>
                            ...
                            <div class="p-4 border rounded">
                                <div class="row g-3 needs-validation" novalidate="">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <asp:DropDownList ID="ddl_remarkstype" class="form-select find-dv-txtbx" runat="server" Style="width: 98%"></asp:DropDownList>
                                    </div>
