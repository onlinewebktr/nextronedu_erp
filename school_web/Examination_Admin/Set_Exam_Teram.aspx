<%@ Page Title="" Language="C#" MasterPageFile="~/Examination_Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Set_Exam_Teram.aspx.cs" Inherits="school_web.Examination_Admin.Set_Exam_Teram" %>
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Set Exam Term</li>
                        </ol>
                    </nav>
                </div>
            </div>
                                    ...
                                    <div class="find-dv" style="margin: 0px 0px -1px 0px;">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-1">
                                                ...
                                                <a class="btn btn-success find-dv-btn" href="Exam_Teram.aspx" style="float: right;"><i class="bx bx-arrow-back"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                        <div id="pnl_Basic" runat="server" visible="false" class="diccontent">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <label for="validationCustom01" class="form-label" style="font-weight: bold">Mandatory to pass</label>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <label for="validationCustom01" class="form-label" style="font-weight: bold">Class<sup>*</sup></label>

                                                    <asp:DropDownList ID="ddl_class" Visible="false" runat="server" class="form-select" AutoPostBack="true" OnSelectedIndexChanged="ddl_class_SelectedIndexChanged">
                                                    </asp:DropDownList>
                                                    ...
                                                    <asp:HiddenField ID="hd_list" runat="server" />
                                                    <%--  <asp:ListBox ID="lst_class"   runat="server"   SelectionMode="Multiple"></asp:ListBox>--%>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                    <label for="validationCustom01" class="form-label" style="font-weight: bold">Exam Term<sup>*<asp:RequiredFieldValidator ID="RequiredFieldValidator3" Display="Dynamic" runat="server" ErrorMessage="*" ValidationGroup="a" ControlToValidate="txt_Name"></asp:RequiredFieldValidator></sup></label>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                    <label for="validationCustom01" class="form-label" style="font-weight: bold">Sequence No.<sup>*<asp:RequiredFieldValidator ID="RequiredFieldValidator1" Display="Dynamic" runat="server" ErrorMessage="*" ValidationGroup="a" ControlToValidate="txt_Sequence_No"></asp:RequiredFieldValidator></sup></label>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                    <label for="validationCustom01" class="form-label" style="font-weight: bold">No of Class<sup>*<asp:RequiredFieldValidator ID="RequiredFieldValidator5" Display="Dynamic" runat="server" ErrorMessage="*" ValidationGroup="a" ControlToValidate="txt_no_of_class"></asp:RequiredFieldValidator></sup></label>
                                                    <asp:TextBox ID="txt_no_of_class" runat="server" class="form-control" onkeypress="return isNumberKey(event)"></asp:TextBox>
                                                </div>
                                            </div>
                                        ...
                                        <div id="pn_Calculation" runat="server" visible="false" class="diccontent">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="row" id="sublevel" runat="server" visible="false" style="display: none">
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="border-top: 1px solid #ccc5c5; margin-top: 10px;">

                                                        <a href="#" data-toggle="tooltip" title="" style="margin: 7px 0px 0px 0px; float: left;"><i class="bx bxs-info-circle" style="font-size: 26px; float: left; margin: -8px 0px 0px 0px;"></i>Please select one of the nodes(level/sub level) which must be considered for calculation</a>
                                                        <asp:GridView ID="grid_assessment" runat="server" class="table table-bordered" AutoGenerateColumns="False" Width="100%" Style="margin-top: 0px;" OnRowDataBound="grid_assessment_RowDataBound">
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Name Of Sub Level">
                                                                    <ItemTemplate>
                                                                        ...
                                                                        <asp:Label ID="lbl_Assessment_Id" runat="server" Text='<%#Bind("Assessment_Id")%>' Visible="false"></asp:Label>
