<%@ Page Title="" Language="C#" MasterPageFile="~/Examination_Admin/Admin.Master" AutoEventWireup="true" CodeBehind="admit-card-student-wise.aspx.cs" Inherits="school_web.Examination_Admin.admit_card_student_wise" %>
        ...
        <div class="page-content">
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Print Admit Card Student-wise</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    ...
                    <hr />
                    <div style="float: left; width: 100%; margin: -13px 0px 3px 0px;">
                        <p style="float: right; margin: 0px; font-weight: 600;">
                            Student Type :
                                                        <asp:CheckBox ID="chk_days" runat="server" Text="Days" Checked="true" />
                            <asp:CheckBox ID="chk_hostel" runat="server" Text="Hostel" Checked="true" />
                        </p>
                    </div>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-4">
                                                            ...
                                                            <asp:DropDownList ID="ddl_exam" runat="server" class="form-select find-dv-txtbx">
                                                            </asp:DropDownList>
                                                        </div>
                                                        <div class="col-sm-3">
