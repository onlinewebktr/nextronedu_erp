<%@ Page Title="" Language="C#" MasterPageFile="~/Examination_Admin/Admin.Master" AutoEventWireup="true" CodeBehind="promoted-to-class.aspx.cs" Inherits="school_web.Examination_Admin.promoted_to_class" %>
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Promoted to Class</li>
                        </ol>
                    </nav>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            <div class="p-4 border rounded">
                                <div class="row g-3 needs-validation" novalidate="">
                                    <div class="col-sm-2">
                                        <label for="validationCustom01" class="find-dv-lbl">Session<sup>*</sup></label>
                                    ...
                                    <div class="col-md-2">
                                        <label for="validationCustom01" class="form-label">Promoted to Class<sup>*</sup></label>
                                        <asp:DropDownList ID="ddl_promoted_to_class" class="form-select find-dv-txtbx" runat="server" Style="width: 98%"></asp:DropDownList>
                                    </div>
                                    <div class="col-md-3">
                                        <label for="validationCustom01" class="form-label">Result Date<sup>*</sup></label>
                                        <asp:TextBox ID="txt_school_reopen_on" runat="server" class="form-control find-dv-txtbx datepicker"></asp:TextBox>
                                    </div>
                                    <div class="col-md-1">
                                        <asp:Button ID="btn_find" runat="server" Text="Find" CssClass="btn btn-primary" Style="margin: 22px 0px 0px 0px; padding: 4px 10px 4px;" OnClick="btn_find_Click" />
                                    </div>
                                </div>
                                                ...
                                                <asp:Repeater ID="RPDetails" runat="server" OnItemDataBound="RPDetails_ItemDataBound">
                                                    <itemtemplate>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:TextBox ID="txt_promoted_to" runat="server" class="form-control" Style="width: 98%"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                    </itemtemplate>
                                                </asp:Repeater>
