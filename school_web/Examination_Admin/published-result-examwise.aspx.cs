...
{
    public partial class published_result_examwise : System.Web.UI.Page
    {
        ...
        protected void lnk_status_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string qry = "update Exam_publish_result_examwise set Status='" + status + "' where Id=" + Id.Text + "";
