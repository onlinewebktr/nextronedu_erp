<%@ Page Title="" Language="C#" MasterPageFile="~/Examination_Admin/Admin.Master" AutoEventWireup="true" CodeBehind="examwise-make-attendance.aspx.cs" Inherits="school_web.Examination_Admin.examwise_make_attendance" %>
                                                ...
                                                <asp:Repeater ID="RPDetails" runat="server" OnItemDataBound="RPDetails_ItemDataBound">
                                                    <ItemTemplate>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:TextBox ID="txt_no_of_class" onblur="Calculation(this.value)" runat="server" class="grd-txtbx-clas" AutoPostBack="false" onkeypress="return isNumberKey(event)"></asp:TextBox>
                                                            </td>
                ...
                <div class="modal-body md-bdy">
                    ...
                    <div class="mdl-frm-row">
                     ...
                     <div class="mdl-frm-row">
                        <div class="row">
                            <div class="col-sm-4">
                                <label for="validationCustom01" class="find-dv-lbl">Assessment</label>
                            </div>
                            <div class="col-sm-8">
                                <asp:DropDownList ID="ddl_exam_p" runat="server" class="form-select"></asp:DropDownList>
                            </div>
                        </div>
                    </div>
