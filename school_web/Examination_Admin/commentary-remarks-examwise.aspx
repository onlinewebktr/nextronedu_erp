<%@ Page Title="" Language="C#" MasterPageFile="~/Examination_Admin/Admin.Master" AutoEventWireup="true" CodeBehind="commentary-remarks-examwise.aspx.cs" Inherits="school_web.Examination_Admin.commentary_remarks_examwise" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Commentary Remarks Exam-Wise
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="page-wrapper">
        <div class="page-content">
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Commentary Remarks</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                   <%-- <asp:Label ID="ltUsertop" runat="server" Style="font-weight: 500; font-size: 1rem;" class="mb-0 text-uppercase" Text=" Commentary Remarks"></asp:Label>
                    <hr />--%>
                    <div class="card">
                        <div class="card-body">
                            <div class="p-4 border rounded">
                                <div class="row g-3 needs-validation" novalidate="">
                                    ...
                                    <div class="col-md-2">
                                        <label for="validationCustom01" class="form-label">Remarks Type<sup>*</sup></label>
                                        <asp:DropDownList ID="ddl_remarkstype" class="form-select find-dv-txtbx" runat="server" ></asp:DropDownList>
                                    </div>
                                                ...
                                                <asp:Repeater ID="RPDetails" runat="server" OnItemDataBound="RPDetails_ItemDataBound">
                                                    <ItemTemplate>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:DropDownList ID="ddl_remarkstypenew" class="form-select" runat="server" Style="width: 98%"></asp:DropDownList>
                                                                <asp:TextBox ID="txt_marks" runat="server" class="grd-txtbx-clas" TextMode="MultiLine" Style="width: 100%;" Visible="false"></asp:TextBox>
