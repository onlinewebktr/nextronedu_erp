<%@ Page Title="" Language="C#" MasterPageFile="~/Examination_Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Allocated_Subject_List.aspx.cs" Inherits="school_web.Examination_Admin.Allocated_Subject_List" %>
                                        ...
                                        <div class="col-sm-12">
                                            <div id="tblPrintIQ" runat="server">
                                                <div class="prnt-dv-wpr">
                                                    ...
                                                    <table id="example2" data-page-length='100000' class="table table-bordered dataTable" role="grid" aria-describedby="example2_info" style="width: 100%">
                                                        <thead>
                                                            <tr>
                                                                <th>#</th>
                                                                <th>Student Name</th>
