<%@ Page Title="" Language="C#" MasterPageFile="~/Examination_Admin/Admin.Master" AutoEventWireup="true" CodeBehind="marks-entery-personality-traits-ddl.aspx.cs" Inherits="school_web.Examination_Admin.marks_entery_personality_traits_ddl" %>
                                                ...
                                                <asp:Repeater ID="RPDetails" runat="server" OnItemDataBound="RPDetails_ItemDataBound">
                                                    <ItemTemplate>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:DropDownList ID="ddl_remarks" runat="server" class="grd-txtbx-clas" style="width:100%"></asp:DropDownList>
                                                            </td>
                                                        </tr>
                                                    </ItemTemplate>
                                                </asp:Repeater>
