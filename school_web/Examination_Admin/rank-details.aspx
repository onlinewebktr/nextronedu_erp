<%@ Page Title="" Language="C#" MasterPageFile="~/Examination_Admin/Admin.Master" AutoEventWireup="true" CodeBehind="rank-details.aspx.cs" Inherits="school_web.Examination_Admin.rank_details" %>
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Rank Details</li>
                        </ol>
                    </nav>
                </div>
            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-7">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-3" runat="server" id="secctionDV">
                                            ...
                                            <div class="col-sm-2">
                                                <asp:Button ID="btn_calculate_final_rank" Style="padding: 3px 5px;" runat="server" Text="Find Final Rank" class="btn btn-primary find-dv-btn" OnClick="btn_calculate_final_rank_Click" />
                                            </div>


                                            <div class="col-sm-2"  runat="server" id="printDV" visible="false">
                                        ...
                                        <div class="prnt-dv-wpr printborder">
                                            <div class="pgslry-head-div head" style="border-bottom: 1px solid #000; margin: 0px; float: left; width: 100%;">
                                                ...
                                                <div style="margin: 0px; padding: 0px; height: 110px; width: 80%; float: left;">
                                                    ...
                                                    <div style="margin: 7px 0px 0px 0px; padding: 0px; float: left; height: auto; text-align: center; vertical-align: middle; font-size: 13px; width: 100%;">
                                                        <span style="font-size: 14px; font-weight: bold;">Student Rank List</span>
                                                    </div>
                                                </div>
                                            </div>
                                                            ...
                                                            <asp:Repeater ID="rd_view" runat="server">
                                                                <ItemTemplate>
                                                                    <tr>
                                                                        ...
                                                                        <td style="text-align: left;">
                                                                            <asp:Label ID="Label9" runat="server" Text='<%#Bind("mothername")%>'></asp:Label>
                                                                        </td>
                                                                        <td style="text-align: left;">
                                                                            <asp:Label ID="Label10" runat="server" Text='<%#Bind("dob")%>'></asp:Label>
                                                                        </td>
                                                                        <td style="text-align: left;">
                                                                            <asp:Label ID="Label5" runat="server" Text='<%#Bind("Total_obtained_mark")%>'></asp:Label>
                                                                        </td>
                                                                        <td style="text-align: left;">
                                                                            <asp:Label ID="Label6" runat="server" Text='<%#Bind("Total_full_mark")%>'></asp:Label>
                                                                        </td>
                                                                        <td style="text-align: left;">
                                                                            <asp:Label ID="Label7" runat="server" Text='<%#Bind("Mark_percentage")%>'></asp:Label>
                                                                        </td>
                                                                        <td style="text-align: left;">
