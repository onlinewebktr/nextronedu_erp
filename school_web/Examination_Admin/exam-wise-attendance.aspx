<%@ Page Title="" Language="C#" MasterPageFile="~/Examination_Admin/Admin.Master" AutoEventWireup="true" CodeBehind="exam-wise-attendance.aspx.cs" Inherits="school_web.Examination_Admin.exam_wise_attendance" %>
                            ...
                            <div class="p-4 border rounded">
                                <div class="row g-3 needs-validation" novalidate="">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <asp:DropDownList ID="ddl_term" class="form-select find-dv-txtbx" runat="server" Style="width: 98%" OnSelectedIndexChanged="ddl_term_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                                    </div>
                                    <div class="col-md-2">
                                        <label for="validationCustom01" class="form-label">Exam Assesment<sup>*</sup></label>
                ...
                <div class="modal-body md-bdy">
                    ...
                    <div class="mdl-frm-row">
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <asp:DropDownList ID="ddl_term_p" runat="server" class="form-select" AutoPostBack="true" OnSelectedIndexChanged="ddl_term_p_SelectedIndexChanged"></asp:DropDownList>
                            </div>
                        </div>
                    </div>
                     <div class="mdl-frm-row">
                        <div class="row">
                            <div class="col-sm-4">
                                <label for="validationCustom01" class="find-dv-lbl">Exam Assesment</label>
                            </div>
                            <div class="col-sm-8">
                                <asp:DropDownList ID="ddl_assesment_p" runat="server" class="form-select"></asp:DropDownList>
                            </div>
                        </div>
                    </div>
