<%@ Page Title="" Language="C#" MasterPageFile="~/Examination_Admin/Admin.Master" AutoEventWireup="true" CodeBehind="dues-setting-for-admit-card.aspx.cs" Inherits="school_web.Examination_Admin.dues_setting_for_admit_card" %>
                        ...
                        <div class="card-body">
                            <div class="p-4 border rounded">
                                <div class="row g-3 needs-validation" novalidate="">
                                    ...
                                    <div class="col-sm-12">
                                        <label for="validationCustom01" class="find-dv-lbl">Dues Calculate</label>
                                    ...
                                    <div class="col-sm-12">
                                        <label for="validationCustom01" class="find-dv-lbl">Dues calculate till month</label>
