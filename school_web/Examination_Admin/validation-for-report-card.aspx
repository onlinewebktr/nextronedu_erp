<%@ Page Title="" Language="C#" MasterPageFile="~/Examination_Admin/Admin.Master" AutoEventWireup="true" CodeBehind="validation-for-report-card.aspx.cs" Inherits="school_web.Examination_Admin.validation_for_report_card" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Validation for Report Card
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="page-wrapper">
        <div class="page-content">
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Validation for Report Card</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-4">
                    <asp:Label ID="ltUsertop" runat="server" Style="font-weight: 500; font-size: 1rem;" class="mb-0 text-uppercase" Text=" Add Validation for Report Card"></asp:Label>
                    <hr />
                    <div class="card">
                        <div class="card-body">
                            <div class="p-4 border rounded">
                                <div class="row g-3 needs-validation" novalidate="">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <asp:DropDownList ID="ddl_exam_term" runat="server" class="form-select find-dv-txtbx"></asp:DropDownList>
                                    </div>
                                    <div class="col-sm-12">
                                        <label for="validationCustom01" class="find-dv-lbl">Dues Type</label>
                                        <asp:DropDownList ID="ddl_dues_calculate" runat="server" class="form-select find-dv-txtbx">
                                            <asp:ListItem Value="1">Only Monthly Fee</asp:ListItem>
                                            <asp:ListItem Value="2">With Admission</asp:ListItem>
                                        </asp:DropDownList>
                                    </div>
                                    <div class="col-sm-12">
                ...
                <div class="col-xl-8">
                    <h6 class="mb-0 text-uppercase">Added Validation for Report Card</h6>
                    <hr />
                    <div class="card">
                        <div class="card-body">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td style="text-align: left;">
                                                                                ...
                                                                                <asp:Label ID="lbl_class_id" runat="server" Text='<%#Bind("Class_id")%>' Visible="false"></asp:Label>
                                                                                 <asp:Label ID="lbl_calculate_dues_type" runat="server" Text='<%#Bind("Calculate_dues_type")%>' Visible="false"></asp:Label>
