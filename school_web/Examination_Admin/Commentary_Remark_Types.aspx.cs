...
{
    public partial class Commentary_Remark_Types : System.Web.UI.Page
    {
        My mycode = new My();
        ...
        {
            string query = "Select  * from  Exam_Commentary_Remark_Types where   Branch_Id='" + ViewState["branchid"].ToString() + "'  ";
