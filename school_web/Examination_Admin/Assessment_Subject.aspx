<%@ Page Title="" Language="C#" MasterPageFile="~/Examination_Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Assessment_Subject.aspx.cs" Inherits="school_web.Examination_Admin.Assessment_Subject" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Assessments Subject</li>
                        </ol>
                    </nav>
                </div>
                                        ...
                                        <div class="find-dv">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-2">
                                                    ...
                                                    <asp:DropDownList ID="ddl_assessment" runat="server" class="form-select find-dv-txtbx">
                                                    </asp:DropDownList>
                                                </div>
                                                <div class="col-sm-1">
                                                    <asp:Button ID="btn_fina_class_wise" runat="server" Text="Find" OnClick="btn_fina_class_wise_Click" class="btn btn-primary find-dv-btn" />
                                                </div>
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Subject Name">
                                                        <ItemTemplate>
                                                            ...
                                                            (<asp:Label ID="lbl_Assessment_Subject_Idss" runat="server" Text='<%#Bind("Subject_id") %>'></asp:Label>)
                                                        </ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="Calulation Type">
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="Subject Type">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lbl_Scholastic_Co_scholastic" runat="server" Text='<%#Bind("Subject_Type_Scholastic_Co_Scholastic")%>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderText="Action">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lnkEdit" runat="server" CausesValidation="false" OnClick="lnkEdit_Click1" ToolTip="Edit"> <i class="lni lni-pencil-alt"></i><span> </span></asp:LinkButton>

                                                            <asp:Label ID="lbl_Assessment_Subject_Id" runat="server" Text='<%#Bind("Assessment_Subject_Id") %>' Visible="false"></asp:Label>
    ...
    <div class="modal fade" id="myModal" role="dialog" style="top: 0px">
        <div class="modal-dialog md-width" style="max-width: 650px;">
            <!-- Modal content-->
