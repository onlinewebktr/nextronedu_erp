<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="upper-final.aspx.cs" Inherits="school_web.Examination_Admin.slip.lddon.upper_final" %>
    ...
    <form id="form1" runat="server">
                            ...
                            <div class="report-card-std-info-dv">
                                <div class="report-card-std-info-dv-50">
                                    ...
                                    <p class="stds-info-p">
                                        ...
                                        <asp:Label ID="lbl_date_of_birth" runat="server" Text="{{x.For_class}}"></asp:Label>
                                    </p>
                                    <%-- <p class="stds-info-p">
        ...
        <script type="text/javascript">
            ...
            app.controller('RpCardAppCtrl', function ($scope, $http) {
                ...
                $http.get("api/final-report-upper.asmx/fetch_rp_card_bulks", { params: { "Session_id": session_id, "Class_id": class_id, "Section": section, "Branch_id": branch_id, "Term_idI": term_id1, "Term_idII": term_id2, "Term_idIII": term_id3, "UserType": userType, "Adm_no": adm_no } }).then(function (response) {
