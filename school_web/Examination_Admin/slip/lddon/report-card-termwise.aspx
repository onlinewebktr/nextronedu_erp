<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="report-card-termwise.aspx.cs" Inherits="school_web.Examination_Admin.slip.lddon.report_card_termwise" %>
    ...
    <form id="form1" runat="server">
                            ...
                            <div class="report-card-wpr" style="height: {{x.MySubjectMarkShowItemII[0].Height_dv}}">
                                ...
                                <div class="subs-mrks-area-lft-dv">
                                    ...
                                    <div class="remarks-rp ">
                                        <p>CLASS TEACHER'S REMARKS :<span class="{{x.MySubjectMarkShowItemII[0].Remarkss}}">{{x.MySubjectMarkShowItemII[0].Remarkss}}</span></p>
                                    </div>
                                </div>
        ...
        <script type="text/javascript">
            ...
            app.controller('RpCardAppCtrl', function ($scope, $http) {
                ...
                $http.get("api/term-report-card-Ld-fm.asmx/fetch_rp_card_bulks", { params: { "Session_id": session_id, "Class_id": class_id, "Section": section, "Branch_id": branch_id, "Term_id": term_id, "Adm_no": adm_no } }).then(function (response) {
