<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="lower-final.aspx.cs" Inherits="school_web.Examination_Admin.slip.lddon.lower_final" %>
       ...
       <div class="invoice-sec" data-ng-app="RpCardApp" data-ng-controller="RpCardAppCtrl">
        ...
        <script type="text/javascript">
            ...
            app.controller('RpCardAppCtrl', function ($scope, $http) {
                ...
                $http.get("api/final-report-lower.asmx/fetch_rp_card_bulks", { params: { "Session_id": session_id, "Class_id": class_id, "Section": section, "Branch_id": branch_id, "Term_idI": term_id1, "Term_idII": term_id2, "Term_idIII": term_id3, "UserType": userType, "Adm_no": adm_no } }).then(function (response) {
