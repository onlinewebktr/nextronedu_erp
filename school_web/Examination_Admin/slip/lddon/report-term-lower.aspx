<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="report-term-lower.aspx.cs" Inherits="school_web.Examination_Admin.slip.lddon.report_term_lower" %>
    ...
    <form id="form1" runat="server">
                        ...
                        <div class="invoice-wpr">
                            ...
                            <div class="report-card-wpr" style="height: {{x.MySubjectMarkShowItemII[0].Height_dv}}">
                                ...
                                <div class="hdr-exm-info">
                                    <h2 class="hdr-exm-info-name">PROGRESS REPORT CARD</h2>
                                    <p class="hdr-exm-info-session">{{x.Term_name}} ({{x.Session}})</p>
                                </div>
                                ...
                                <div class="subs-mrks-area-dv">
                                    <table>
                                        ...
                                        <tr data-ng-repeat="item in x.MySubjectMarkShowItemII track by $index">
                                            ...
                                            <td class="{{x.MySubjectMarkShowItemII[0].Is_text_center}} {{x.MySubjectMarkShowItemII[0].Is_subj_code_hide}} {{item.IsfontBold}}">{{item.Subject}}</td>
                                            <td class="{{item.IsfontBold}}">{{item.Subject_name}}</td>
                                            <td class="{{x.MySubjectMarkShowItemII[0].Is_text_center}} {{item.IsfontBold}}" data-ng-repeat="itemx in item.MySubjectMarkItemIII track by $index">{{itemx.Marks}}</td>
                                            <%--<td class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}">{{item.Total_marks}}</td>--%>
                                            <td class="{{x.MySubjectMarkShowItemII[0].Is_text_center}} {{item.Grade}} {{item.IsfontBold}}"><span class="{{item.Gbgclass}}" style="{{item.gradebg}}">{{item.Grade}}</span></td>
                                        </tr>
                                    </table>

                                    <div class="ovrll-sec">
                                        <div class="ovrll-ttl-marks-dv">
                                            <p class="ovrll-ttl-marks-cnt-p">Grand Total</p>
                                ...
                                <div class="subs-mrks-area-lft-dv" style="width: 100%;">
                                    ...
                                    <div class="remarks-rp ">
                                        <p style="min-height: 100px;">CLASS TEACHER'S REMARKS :<span class="{{x.MySubjectMarkShowItemII[0].Remarkss}}">{{x.MySubjectMarkShowItemII[0].Remarkss}}</span></p>
                                    </div>
                                </div>
                                ...
                                <div class="sig-dv v-false {{x.MySubjectMarkShowItemII[0].Sign_bottom}}">
                                    <div class="sig-left">
                                        <div class="lft-sig-img-dv">
                                            <img class="lft-sig-img {{x.Class_teacher_sig}}" src="{{x.Class_teacher_sig}}" />
                                        </div>
                                        <p class="sig-ps">{{x.Class_teacher_sigName}}</p>
                                    </div>
                                    <div class="sig-left">
                                        <div class="cntr-sig-img-dv">
                                            <img src="{{x.Examinee_sig}}" class="cntr-sig-img {{x.Examinee_sig}}" />
                                        </div>
                                        <p class="sig-ps {{x.ParantSign}}">{{x.Examinee_sigName}}</p>
                                    </div>
                                    ...
                                    <div class="sig-left">
                                        ...
                                        <p class="sig-ps">{{x.Principal_sigName}}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <script type="text/javascript">
            ...
            app.controller('RpCardAppCtrl', function ($scope, $http) {
                ...
                $http.get("api/term-Ld-fm-lower.asmx/fetch_rp_card_bulks", { params: { "Session_id": session_id, "Class_id": class_id, "Section": section, "Branch_id": branch_id, "Term_id": term_id, "Adm_no": adm_no } }).then(function (response) {
