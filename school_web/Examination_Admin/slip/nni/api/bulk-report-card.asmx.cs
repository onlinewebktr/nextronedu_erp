...
namespace school_web.Examination_Admin.slip.nni.api
{
    ...
    public class bulk_report_card : System.Web.Services.WebService
    {
        ...
        public class MyStudentsDetails
        {
            ...
            public List<Fetch_Details_of_attendances> My_attendances_details { get; set; }
        }
        ...
        public class Fetch_Details_of_Firm
        {
            ...
            public string Aff_year { get; set; }
        }
        ...
        public class MySubjectMarkShowII
        {
            ...
            public string Is_aff_year_show { get; set; }
        ...
        public class Fetch_Details_of_attendances
        {
        ...
        public void fetch_rp_card_bulks(string Session_id, string Class_id, string Section, string Branch_id, string Term_id)
        {
            ...
            else
            {
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    //================ OverAllNo
                    List<Fetch_Details_of_attendances> MBAttendanceALL = findAttendanceDetails(Session_id, dr["Admission_no"].ToString(), Class_id, Branch_id, dr["Section"].ToString(), Term_id);
                    ...
                    ShowMyStudents.Add(new MyStudentsDetails
                    {
                        ...
                        My_attendances_details = MBAttendanceALL
                    });
                }
        ...
        private List<Fetch_Details_of_graph> findGraphDetails(string Session_id, string admission_no, string Class_id, string Branch_id, string Section, string Term_id)
        {
            ...
            string tblName = "Exam_temp_assesment_total_no";
            ...
            {
                tblName = "Exam_temp_assesment_total_no_term_II";
            }
            ...
            else
            {
                foreach (DataRow dr in dt.Rows)
                {
                    MyFirmDetailData.Add(new Fetch_Details_of_Firm
                    {
                        ...
                        Aff_year = "Aff. : " + dr["Aff_year"].ToString(),
                    });
                }
            }
        ...
        private List<MySubjectMarkShowII> findSubjectMarkShowII(string Admission_no, string Session_id, string Class_id, string Branch_id, string Term_id)
        {
            ...
            else
            {
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    string Is_aff_year_show = arrs[47];   // AffYearHide
                    ...
                    MySubjectMarkShowItemII.Add(new MySubjectMarkShowII
                    {
                        ...
                        Is_aff_year_show = Is_aff_year_show,
                        LoopCount = (rowcount1 - 1).ToString(),
        ...
        private List<MySubjectMarkDetailsIII> findmyMarksIII(string Subject_id, string Admission_no, string Session_id, string Class_id, string Branch_id, string Term_id)
        {
            ...
            {
                first_term = Exam_setting.get_first_term(Session_id, Branch_id, Class_id);
            }
            ...
            else
            {
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    { 
                        ...
                        {
                            if (dr["Group_id"].ToString() == "1")
                            {
                                if (dr["Sequence_No"].ToString() == "1")
                                {
                                    ptII = My.toDouble(obt_marks);
                                }
                                else
                                {
                                    if (ptII >= My.toDouble(obt_marks))
                                    {
                                        obt_marks = ptII.ToString("0.0");
                                    }
                                    save_marks(dr["Session_id"].ToString(), dr["Class_id"].ToString(), Admission_no, dr["Term"].ToString(), dr["Assessment"].ToString(), Subject_id, dr["Branch_id"].ToString(), obt_marks, full_marks, marks_type, total_no);
                                }
                            }
        ...
        private List<Fetch_Details_of_attendances> findAttendanceDetails(string Session_id, string admission_no, string Class_id, string Branch_id, string Section, string Term_id)
        {
            List<Fetch_Details_of_attendances> My_attendances_details = new List<Fetch_Details_of_attendances>();
            string termids = "2";
            string first_term = Exam_setting.get_first_term(Session_id, Branch_id, Class_id);
            if (first_term == Term_id)
            {
            ...
            string query = "select * from Exam_Exam_Wise_Attendance where Session_id='" + Session_id + "' and Branch_id='" + Branch_id + "' and Class_id='" + Class_id + "' and Admission_no='" + admission_no + "' and Exam_Term_Id='" + termids + "'";
            SqlDataAdapter ad = new SqlDataAdapter(query, My.con);
            DataSet ds = new DataSet();
            ...
            else
            {
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    My_attendances_details.Add(new Fetch_Details_of_attendances
                    {
