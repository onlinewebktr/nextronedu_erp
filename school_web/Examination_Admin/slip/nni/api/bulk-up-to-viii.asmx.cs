...
{
    /// <summary>
    /// Summary description for bulk_up_to_viii
    /// </summary>
    ...
    public class bulk_up_to_viii : System.Web.Services.WebService
    {
        My mycode = new My();
        ...
        public void fetch_rp_card_bulks(string Session_id, string Class_id, string Section, string Branch_id, string Term_idI, string Term_idII, string Adm_no)
        {
            ...
            {
                string settings_for_final_year = final_up_to_viiiN.get_final_year_setting(Session_id, Class_id, Branch_id);
        ...
        private List<MyTotalsDetails> findTotalsDT(string Admission_no, string Session_id, string Class_id, string Branch_id, string Term_idI, string Term_idII)
        {
            ...
            string Total_marks = final_up_to_viiiN.get_overall_total_marks_final(Session_id, Class_id, Admission_no, Branch_id, Term_idI);
            ...
            string percent_remark = final_up_to_viiiN.get_percent_remark(overall_percent);
        ...
        private List<MySubjectMarkShow> findSubjectMarkShow(string Admission_no, string Session_id, string Class_id, string Branch_id, string Term_idI, string Term_idII, string Section)
        {
            ...
            else
            {
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    string ttl_mark_of_a_subject = final_up_to_viiiN.get_ttl_mark_of_a_subject_final_year(dr["Subject_id"].ToString(), Admission_no, Session_id, Class_id, Branch_id, Term_idI, Term_idII);
        ...
        private void update_assesment_marks(string Subject_id, string Admission_no, string Session_id, string Class_id, string Branch_id, string Term_id)
        {
            ...
            {
                string systm_grade_id = final_up_to_viiiN.get_systm_grd_id(Subject_id, Session_id, Class_id, Branch_id, Term_id, drs["Assessment_Id"].ToString());
