<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bulk-report-card-termI.aspx.cs" Inherits="school_web.Examination_Admin.slip.nni.bulk_report_card_termI" %>
                            ...
                            <div class="report-card-wpr" style="height: {{x.MySubjectMarkShowItemII[0].Height_dv}}">
                                ...
                                <div class="report-card-head hidden {{x.MySubjectMarkShowItemII[0].Hdr_scnd}}">
                                    ...
                                    <div class="report-card-rght-dv1">
                                        ...
                                        <asp:Label ID="lbl_aff_year" class="report-card-schl-aff-year {{x.MySubjectMarkShowItemII[0].Is_aff_year_show}}" runat="server" Text="{{x.MyFirmDetailData[0].Aff_year}}"></asp:Label>
                                ...
                                <div class="subs-mrks-area-rght-dv">
                                    ...
                                    <div class="qr-dvs {{x.MySubjectMarkShowItemII[0].qr_div_true}}">
                                        <img src="{{x.MySubjectMarkShowItemII[(x.MySubjectMarkShowItemII[0].LoopCount)].qr_code_Show}}" />
                                    </div>
                                    ...
                                    <div class="instruction-50  instruction-50-pl">
                                        <div class="subs-mrks-area-ovrall-dv" style="padding: 2px 0px 0px 0px;">
                                            <table>
                                                ...
                                                <tr  data-ng-repeat="item in x.My_attendances_details track by $index" class="{{item.Attendance_class_style}}">
                                                    <td>{{item.Exam_name}}</td>
                                                    <td>{{item.Total_working_days}}</td>
                                                    <td>{{item.Total_persent_days}}</td>
