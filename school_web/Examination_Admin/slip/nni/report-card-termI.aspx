<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="report-card-termI.aspx.cs" Inherits="school_web.Examination_Admin.slip.nni.report_card_termI" %>
    ...
    <form id="form1" runat="server">
                        ...
                        <div class="report-card-wpr" style="height: {{reportCardSubS[0].Height_dv}}">
                            ...
                            <div class="subs-mrks-area-rght-dv">
                                ...
                                <div class="qr-dvs v-false {{reportCardSubS[0].qr_div_true}}">
                                    <img src="{{reportCardSubS[(reportCardSubS[0].LoopCount)].qr_code_Show}}" />
                                </div>
                                    ...
                                    <div class="subs-mrks-area-ovrall-dv" style="padding: 2px 0px 0px 0px;">
                                        <table>
                                            ...
                                            <tr data-ng-repeat="x in reportAttendance" class="{{x.Attendance_class_style}}">
                                                <td>{{x.Exam_name}}</td>
                                                <td>{{x.Total_working_days}}</td>
                                                <td>{{x.Total_persent_days}}</td>
                                                <td>{{x.Attendance_percentage}}</td>
                                            </tr>
                                        </table>
                                    </div>
        ...
        <script type="text/javascript">
            ...
            app.controller('RpCardAppCtrl', function ($scope, $http) {
                ...
                ////========================Rank
                $http.get("api/report-card.asmx/fetch_rp_card_attendances", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id, "Term_id": term_id } }).then(function (response) {
