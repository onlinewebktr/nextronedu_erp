<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="final-bulk-up-to-viii.aspx.cs" Inherits="school_web.Examination_Admin.slip.nni.final_bulk_up_to_viii" %>
...
<head runat="server">
    ...
    <link href="css/finalb.css" rel="stylesheet" />
    ...
    <script type="text/javascript">
        function PrintPanel() {
            ...
            printWindow.document.write('<link href="css/finalb.css" rel="stylesheet" type="text/css" />');
    ...
    <form id="form1" runat="server">
                        ...
                        <div class="report-card-wpr" style="height: {{x.MySubjectMarkShowItem[0].Height_dv}};">
                            ...
                            <div class="subs-mrks-area-dv">
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <th style="background: background: {{x.MySubjectMarkShowItem[0].ThemeColor}}" class="{{x.MySubjectMarkShowItem[0].Is_text_center}}">G.P.</th>
                                    </tr>
                            ...
                            <div class="subs-mrks-area-rght-dv">
                                <div class="subs-mrks-area-ovrall-dv">
                                    ...
                                    <div class="prcntage-remrk-dv v-false {{x.MySubjectMarkShowItem[0].Prcnt_remark}}">
                                        <p>Remark : <span>{{x.MyTotalsDetailsItem[0].P_remark}}</span></p>
                                    </div>
                                </div>
                            </div>
        ...
        <script type="text/javascript">
            ...
            app.controller('RpCardAppCtrl', function ($scope, $http) {
                ...
                $http.get("api/bulk-up-to-viii.asmx/fetch_rp_card_bulks", { params: { "Session_id": session_id, "Class_id": class_id, "Section": section, "Branch_id": branch_id, "Term_idI": term_id, "Term_idII": term_id2, "Adm_no": adm_no } }).then(function (response) {
