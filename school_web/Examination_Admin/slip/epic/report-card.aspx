<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="report-card.aspx.cs" Inherits="school_web.Examination_Admin.slip.epic.report_card" %>
                                ...
                                <div class="report-card-std-info-dv">
                                    <div class="report-card-std-info-dv-50">
                                        ...
                                        <%--<p class="stds-info-p">
                                            ...
                                            <asp:Label ID="Label2" runat="server" Text="{{x.Height}}"></asp:Label>
                                        </p>--%>
                                    </div>
                                    ...
                                    <div class="report-card-std-info-dv-50">
                                        ...
                                        <%--<p class="stds-info-p">
                                            ...
                                            <asp:Label ID="Label3" runat="server" Text="{{x.Weignt}}"></asp:Label>
                                        </p>--%>
                                    </div>
                                ...
                                <div class="subs-mrks-area-dv">
                                    <table>
                                        <tr>
                                            ...
                                            <th class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}" colspan="8">{{x.TermShortname}}</th>
                                        </tr> 
                                        <tr>
                                    ...
                                    <table> 
                                        <tr>
                                            <th rowspan="2" class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}">SN</th>
                                            <th rowspan="2">SUBJECT</th>
                                            <th class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}" data-ng-repeat="item in x.MySubjectHeadingOP track by $index" colspan="2">{{item.Short_Name}}</th>
                                            <th colspan="2" class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}">Total</th>
                                        </tr>

                                        <tr> 
                                            <th class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}" data-ng-repeat="item in x.MySubjectHeadingVI track by $index">{{item.Short_Name}}</th>
                                            <th class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}">F.M.</th>
                                            <th class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}">O.M.</th>
                                        </tr>

                                        <tr data-ng-repeat="item in x.MySubjectMarkShowItemIII track by $index">
                                            <td class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}">{{item.Slnos}}</td>
                                            <td>{{item.Subject_name}}</td>
                                            <td class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}" data-ng-repeat="itemx in item.MySubjectMarkItemIV track by $index">{{itemx.Marks}}</td>
                                            <td class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}">{{item.SubjFulmarks}}</td>
                                            <td class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}">{{item.Total_marks}}</td>
                                            <%--<td class="{{x.MySubjectMarkShowItemII[0].Is_text_center}} {{item.Grade}}"><span class="{{item.Gbgclass}}" style="{{item.GradeBG}}">{{item.Grade}}</span></td>--%>
                                        </tr>
                                    </table>
