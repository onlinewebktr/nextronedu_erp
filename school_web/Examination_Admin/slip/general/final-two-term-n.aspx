<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="final-two-term-n.aspx.cs" Inherits="school_web.Examination_Admin.slip.general.final_two_term_n" %>
...
<head runat="server">
    ...
    <link href="css/finaltwoN.css" rel="stylesheet" />
    ...
    <script type="text/javascript">
        function PrintPanel() {
            ...
            printWindow.document.write('<link href="css/finaltwoN.css" rel="stylesheet" type="text/css" />');
    ...
    <form id="form1" runat="server">
                    ...
                    <div class="invoice-wpr" style="border-color: background: {{x.MySubjectMarkShowItem[0].ThemeColor}}">
                        ...
                        <div class="report-card-wpr" style="height: {{x.MySubjectMarkShowItem[0].Height_dv}};">
                            ...
                            <div class="prcntage-remrk-dv">
                                <p>Class Teacher Remark : <span class="{{x.MyTotalsDetailsItem[0].percent_remark}}">{{x.MyTotalsDetailsItem[0].percent_remark}}</span></p>
                            </div>
                            ...
                            <div class="subs-mrks-area-rght-dv">
                                <div class="subs-mrks-area-ovrall-dv">
                                    <%--<table>
                                        <tr>
                                            <th colspan="4" class="txt-center">ATTENDANCE</th>
                                        </tr>
                                        <tr>
                                            <th>EXAM</th>
                                            <th class="txt-center">WORKING DAYS</th>
                                            <th class="txt-center">PRESENT DAYS</th>
                                            <th class="txt-center">ATTENDANCE(%)</th>
                                        </tr>
                                        <tr data-ng-repeat="item in x.Fetch_Details_of_attendanceItem track by $index" class="{{item.Attendance_class_style}}">
                            ...
                            <%--<div class="instruction-dv-fr-auto-bottom">
                                <div class="instruction-50 instruction-50-pr">
                                    <div class="instruction-tbls">
                                        <table>
                                            ...
                                            <tr>
                                                <td colspan="2" class="txt-center">(Scholastic  Areas {{x.MyMarkRangeDetailsItem[0].RowCount}}-point grading scale)</td>
                                            </tr>
                                            <tr>
                                ...
                                <div class="instruction-50 instruction-50-pl"> 
                                    <div class="instruction-tbls floatrght">
                                        <div class="v-false {{x.MySubjectMarkShowItem[0].Ranksdv}}" style="padding: 2px 0px 0px 0px;">
                                            <table>
                                                <tr>
        ...
        <script type="text/javascript">
            ...
            app.controller('RpCardAppCtrl', function ($scope, $http) {
                ...
                $http.get("api/final-two-term-n.asmx/fetch_rp_card_bulks", { params: { "Session_id": session_id, "Class_id": class_id, "Section": section, "Branch_id": branch_id, "Term_idI": term_id, "Term_idII": term_id2, "Adm_no": adm_no } }).then(function (response) {
