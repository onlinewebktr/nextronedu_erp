<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="examwise-report.aspx.cs" Inherits="school_web.Examination_Admin.slip.general.examwise_report" %>
    ...
    <form id="form1" runat="server">
                        ...
                        <div class="invoice-wpr">
                            ...
                            <div class="report-card-wpr" style="height: {{x.MySubjectMarkShowItemII[0].Height_dv}}">
                                ...
                                <div class="subs-mrks-area-rght-dv">
                                    <div class="rp-card-graph-sec {{x.MySubjectMarkShowItemII[0].Graph}}" style="margin-top: 5px">
        ...
        <script type="text/javascript">
            ...
            app.controller('RpCardAppCtrl', function ($scope, $http) {
                ...
                $http.get("api/examwiseRP.asmx/fetch_rp_card_bulks", { params: { "Session_id": session_id, "Class_id": class_id, "Section": section, "Branch_id": branch_id, "Term_id": term_id, "Adm_no": adm_no, "Assesment_id": assesment_id } }).then(function (response) {
