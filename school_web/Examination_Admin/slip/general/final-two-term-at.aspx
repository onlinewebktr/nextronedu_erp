<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="final-two-term-at.aspx.cs" Inherits="school_web.Examination_Admin.slip.general.final_two_term_at" %>
...
<head runat="server">
    ...
    <link href="css/finaltwoAT.css" rel="stylesheet" />
    ...
    <script type="text/javascript">
        function PrintPanel() {
            ...
            printWindow.document.write('<link href="css/finaltwoAT.css" rel="stylesheet" type="text/css" />');
    ...
    <form id="form1" runat="server">
                    ...
                    <div class="invoice-wpr" style="border-color: background: {{x.MySubjectMarkShowItem[0].ThemeColor}}">
                        ...
                        <div class="report-card-wpr" style="height: {{x.MySubjectMarkShowItem[0].Height_dv}};">
                            ...
                            <div class="hdr-exm-info">
                                <h2 class="hdr-exm-info-name">FINAL REPORT CARD (FOR ACADEMIC SESSION : {{x.Session}})</h2>
                            </div>
                            <div class="report-card-std-info-dv">
                                ...
                                <div class="wdth37">
                                    ...
                                    <p class="stds-info-p">
                                        <i class="stds-info-p-i wdth45">ADMISSION NO.</i>  <i class="stds-info-p-doti">:</i>
                            ...
                            <div class="subs-mrks-area-dv">
                                <table>
                                    <tr>
                                        <th style="background: background: {{x.MySubjectMarkShowItem[0].ThemeColor}}" colspan="2">A-SCHOLASTIC AREA</th>
                                    ...
                                    <tr>
                                        ...
                                        <th style="background: background: {{x.MySubjectMarkShowItem[0].ThemeColor}}" class="{{x.MySubjectMarkShowItem[0].Is_text_center}}">Grade</th>
                                    </tr>
                                    ...
                                    <tr>
                                        <td colspan="2" class="txtUpper fontbld" style="text-align: right">Attendance</td>
                                        <td class="{{x.MySubjectMarkShowItem[0].Is_text_center}} fontbld" colspan="{{x.MySubjectHeading[0].TermColSpan}}">{{x.MySubjectMarkShowItem[0].Total_Present_class_of_term_I}}/{{x.MySubjectMarkShowItem[0].Total_class_of_term_I}}</td>
                                        <td class="{{x.MySubjectMarkShowItem[0].Is_text_center}} fontbld" colspan="{{x.MySubjectHeading[0].TermColSpan}}">{{x.MySubjectMarkShowItem[0].Total_Present_class_of_term_II}}/{{x.MySubjectMarkShowItem[0].Total_class_of_term_II}}</td>
                                        <td class="{{x.MySubjectMarkShowItem[0].Is_text_center}} fontbld" colspan="2">{{x.MySubjectMarkShowItem[0].Final_persent_days}}/{{x.MySubjectMarkShowItem[0].Final_working_days}}</td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" class="txtUpper fontbld" style="text-align: right">Attendance(%)</td>
                                        <td class="{{x.MySubjectMarkShowItem[0].Is_text_center}} fontbld" colspan="{{x.MySubjectHeading[0].TermColSpan}}">{{x.MySubjectMarkShowItem[0].Total_Precentage_class_of_term_I}}</td>
                                        <td class="{{x.MySubjectMarkShowItem[0].Is_text_center}} fontbld" colspan="{{x.MySubjectHeading[0].TermColSpan}}">{{x.MySubjectMarkShowItem[0].Total_Precentage_class_of_term_II}}</td>
                                        <td class="{{x.MySubjectMarkShowItem[0].Is_text_center}} fontbld" colspan="2">{{x.MySubjectMarkShowItem[0].Final_percent_days}}</td>
                                    </tr>
                                </table>

                                <div class="ovrll-sec">
                                    <div class="ovrll-ttl-marks-dv">
                                        <p class="ovrll-ttl-marks-cnt-p fontbld">Total Marks </p>
                                        <p class="ovrll-ttl-marks-num-p fontbld">{{x.MyTotalsDetailsItem[0].Overall_obt_marks}}/{{x.MyTotalsDetailsItem[0].Overall_full_marks}}</p>
                                    </div>
                                    <div class="ovrll-ttl-marks-dv">
                                        <p class="ovrll-ttl-marks-cnt-p fontbld">Percentage </p>
                                        <p class="ovrll-ttl-marks-num-p fontbld">{{x.MyTotalsDetailsItem[0].Overall_percents}} <span class="{{x.MyTotalsDetailsItem[0].Overall_obt_mark}}">(%)</span></p>
                                    </div>
                                    <div class="ovrll-ttl-marks-dv" style="margin: 0px 0px 0px 0px; float: right;">
                                        <p class="ovrll-ttl-marks-cnt-p fontbld">Grade </p>
                                        <p class="ovrll-ttl-marks-num-p fontbld">{{x.MyTotalsDetailsItem[0].Grade}}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="subs-mrks-area-lft-dv">
                                    ...
                                    <div class="subs-mrks-area-b-dv">
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                <th class="th-bg-rmov {{x.MySubjectMarkShowItem[0].Is_text_center}}" style="min-width: 65px;">
                                ...
                                <div class="prcntage-remrk-dv {{x.MyFirmDetailData[0].Teachrrmrk}}">
                                    <p>Class Teacher Remark : <span class="{{x.MyTotalsDetailsItem[0].P_remark}}">{{x.MyTotalsDetailsItem[0].P_remark}}</span></p>
                                </div>
                            </div>
                            ...
                            <div class="com-record-sec {{x.MyFirmDetailData[0].PromttoDV}}">
                                ...
                                <p class="com-prom-to-clss-teachr">Class Teacher's Remarks : <span class="{{x.MyTotalsDetailsItem[0].P_remark}}">{{x.MyTotalsDetailsItem[0].P_remark}}</span></p>
                            </div>



                            <div class="grding-scale-dv-sec">
                                <div class="issuedate-dv {{x.MyFirmDetailData[0].Issue_dateDIv}}" >
                                    <p>Issue Date : <span>{{x.MyFirmDetailData[0].Issue_date}}</span></p>
                                </div>

                                <p class="grding-scale-dv-p">{{x.MyMarkRangeDetailsItem[0].RowCount}} Point Grading Scale : <span data-ng-repeat="item in x.MyMarkRangeDetailsItem track by $index">{{item.Grade}} [{{item.Lower_Range}}-{{item.Upper_Range}}]</span></p>
                            </div>
        ...
        <script type="text/javascript">
            ...
            app.controller('RpCardAppCtrl', function ($scope, $http) {
                ...
                $http.get("api/final-two-term-at.asmx/fetch_rp_card_bulks", { params: { "Session_id": session_id, "Class_id": class_id, "Section": section, "Branch_id": branch_id, "Term_idI": term_id, "Term_idII": term_id2, "Adm_no": adm_no } }).then(function (response) {
