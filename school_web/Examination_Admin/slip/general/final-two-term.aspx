<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="final-two-term.aspx.cs" Inherits="school_web.Examination_Admin.slip.general.final_two_term" %>
...
<head runat="server">
    ...
    <link href="css/report-card-final.css" rel="stylesheet" />
    ...
    <script type="text/javascript">
        function PrintPanel() {
            ...
            printWindow.document.write('<link href="css/report-card-final.css" rel="stylesheet" type="text/css" />');
    ...
    <form id="form1" runat="server">
                    ...
                    <div class="invoice-wpr" style="border-color: background: {{x.MySubjectMarkShowItem[0].ThemeColor}}">
                        ...
                        <div class="report-card-wpr" style="height: {{x.MySubjectMarkShowItem[0].Height_dv}};">
                            ...
                            <div class="hdr-exm-info">
                                <h2 class="hdr-exm-info-name">ANNUAL REPORT CARD ({{x.Session}})</h2>
                            </div>
                            ...
                            <div class="subs-mrks-area-dv">
                                <table>
                                    <tr>
                                        ...
                                        <th colspan="2" style="background: background: {{x.MySubjectMarkShowItem[0].ThemeColor}}">SCHOLASTIC AREA</th>
                                    ...
                                    <tr>
                                        ...
                                        <th style="background: background: {{x.MySubjectMarkShowItem[0].ThemeColor}}" class="{{x.MySubjectMarkShowItem[0].Overall_av_marks}} {{x.MySubjectMarkShowItem[0].Is_text_center}}">TOTAL (T1+T2) (200)</th>
                                ...
                                <div class="ovrll-sec">
                                    <div class="ovrll-ttl-marks-dv" style="width: 36%;">
                                        <p class="ovrll-ttl-marks-cnt-p">Total Marks (Term-I)</p>
                                        <p class="ovrll-ttl-marks-num-p">{{x.MyTotalsDetailsItem[0].T1ObtMark}}/{{x.MyTotalsDetailsItem[0].T1FullMark}}</p>
                                    </div>
                                    <div class="ovrll-ttl-marks-dv">
                                        <p class="ovrll-ttl-marks-cnt-p">Percentage </p>
                                        <p class="ovrll-ttl-marks-num-p">{{x.MyTotalsDetailsItem[0].T1Persentage}} %</p>
                                    </div>
                                    <div class="ovrll-ttl-marks-dv" style="margin: 0px 0px 0px 0px; float: right;">
                                        <p class="ovrll-ttl-marks-cnt-p">Grade </p>
                                        <p class="ovrll-ttl-marks-num-p">{{x.MyTotalsDetailsItem[0].TermGradeT1}}</p>
                                    </div>
                                </div>
                                <div class="ovrll-sec">
                                    <div class="ovrll-ttl-marks-dv" style="width: 36%;">
                                        <p class="ovrll-ttl-marks-cnt-p">Total Marks (Term-II)</p>
                                        <p class="ovrll-ttl-marks-num-p">{{x.MyTotalsDetailsItem[0].T2ObtMark}}/{{x.MyTotalsDetailsItem[0].T2FullMark}}</p>
                                    </div>
                                    <div class="ovrll-ttl-marks-dv">
                                        <p class="ovrll-ttl-marks-cnt-p">Percentage </p>
                                        <p class="ovrll-ttl-marks-num-p">{{x.MyTotalsDetailsItem[0].T2Persentage}} %</p>
                                    </div>
                                    <div class="ovrll-ttl-marks-dv" style="margin: 0px 0px 0px 0px; float: right;">
                                        <p class="ovrll-ttl-marks-cnt-p">Grade </p>
                                        <p class="ovrll-ttl-marks-num-p">{{x.MyTotalsDetailsItem[0].TermGradeT2}}</p>
                                    </div>
                                </div>
                                 <div class="ovrll-sec">
                                    <div class="ovrll-ttl-marks-dv" style="width: 36%;">
                                        <p class="ovrll-ttl-marks-cnt-p">Total Marks (OVERALL)</p>
                                        <p class="ovrll-ttl-marks-num-p">{{x.MyTotalsDetailsItem[0].Overall_obt_marks}}/{{x.MyTotalsDetailsItem[0].Overall_full_marks}}</p>
                                    </div>
                                    <div class="ovrll-ttl-marks-dv">
                                        <p class="ovrll-ttl-marks-cnt-p">Percentage </p>
                                        <p class="ovrll-ttl-marks-num-p">{{x.MyTotalsDetailsItem[0].Overall_percents}} %</p>
                                    </div>
                                    <div class="ovrll-ttl-marks-dv" style="margin: 0px 0px 0px 0px; float: right;">
                                        <p class="ovrll-ttl-marks-cnt-p">Grade </p>
                            ...
                            <div class="sig-dv v-false {{x.MySubjectMarkShowItem[0].Sign_bottom}}">
                                ...
                                <div class="sig-left">
                                    <div class="cntr-sig-img-dv">
                                        <img src="{{x.MySignatureDetailsItem[1].Signature_image}}" style="display:none !important" class="cntr-sig-img {{x.MySignatureDetailsItem[1].Signature_image}}" />
                                    </div>
                                    <p class="sig-ps"  style="display:none !important">{{x.MySignatureDetailsItem[1].Signature_name}}</p>
                                </div>
        ...
        <script type="text/javascript">
            ...
            app.controller('RpCardAppCtrl', function ($scope, $http) {
                ...
                $http.get("api/final-two-term.asmx/fetch_rp_card_bulks", { params: { "Session_id": session_id, "Class_id": class_id, "Section": section, "Branch_id": branch_id, "Term_idI": term_id, "Term_idII": term_id2, "Adm_no": adm_no } }).then(function (response) {
