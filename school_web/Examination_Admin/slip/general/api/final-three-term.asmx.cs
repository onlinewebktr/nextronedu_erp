    ...
    public class final_three_term : System.Web.Services.WebService
    {
        ...
        private List<MySubjectMarkShow> findSubjectMarkShow(string Admission_no, string Session_id, string Class_id, string Branch_id, string Term_idI, string Term_idII, string Term_idIII, string UserType, string Section)
        {
            ...
            else
            {
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    string ttl_mark_of_a_subject = finalThree.get_ttl_mark_of_a_subject_final_year(dr["Subject_id"].ToString(), Admission_no, Session_id, Class_id, Branch_id, Term_idI, Term_idII, Term_idIII);
                    ...
                    string Total_marks = finalThree.get_overall_total_marks_final(Session_id, Class_id, Admission_no, Branch_id, Term_idI, Term_idII, Term_idIII);
