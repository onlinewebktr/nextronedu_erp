...
{
    /// <summary>
    /// Summary description for examwiseRP
    /// </summary>
    ...
    public class examwiseRP : System.Web.Services.WebService
    {
        My mycode = new My();
        public class MyStudentsDetails
        {
            ...
            public string Assesment_name { get; set; }

            public string Assesment_maximum_marks { get; set; }
            public string Assmnt_hlf_mark { get; set; }
        ...
        public void fetch_rp_card_bulks(string Session_id, string Class_id, string Section, string Branch_id, string Term_id, string Adm_no, string Assesment_id)
        {
            string query = "select DISTINCT em.Admission_no,em.Session_id,em.Class_id,em.Branch_id,em.Term,ar.class,ar.session,ar.Section,ar.rollnumber,ar.studentname,ar.dob,ar.mothername,ar.fathername,ar.studentimagepath,CASE WHEN ar.studentimagepath is null THEN '/images/dummy-student.jpg'  WHEN ar.studentimagepath is not null THEN ar.studentimagepath END AS Student_img, (select top 1 Short_Name from Exam_Term_Details where Session_Id=em.Session_id and Branch_id=em.Branch_id and Class_id=em.Class_id and Exam_Term_Id=em.Term) as Term_name,isnull((select top 1 Rank from Exam_rank_master where Session_id=ar.Session_id and Class_id=ar.Class_id and Branch_id=em.Branch_id and Admission_no=ar.admissionserialnumber and em.Term=" + Term_id + "),'0') as Rank,(select top 1 Assessment_Name from Exam_Assessment_Details where Session_Id=em.Session_id and Branch_id=em.Branch_id and Class_id=em.Class_id and Exam_Term_Id=em.Term and Assessment_Id=em.Assessment and Istatus=1) as Assesment_name,(select top 1 Maximum_Marks from Exam_Assessment_Details where Session_Id=em.Session_id and Branch_id=em.Branch_id and Class_id=em.Class_id and Exam_Term_Id=em.Term and Assessment_Id=em.Assessment and Istatus=1) as Assesment_maximum_marks from Exam_marks em join admission_registor ar on em.Session_id=ar.Session_id and em.Branch_id=ar.Branch_id and em.Class_id=ar.Class_id and em.Admission_no=ar.admissionserialnumber where em.Session_id=" + Session_id + " and em.Class_id=" + Class_id + " and em.Branch_id=" + Branch_id + " and em.Term=" + Term_id + " and em.Admission_no='" + Adm_no + "' and em.Assessment='" + Assesment_id + "'";
            if (Adm_no.ToUpper() == "BULK")
            {
                query = "select DISTINCT em.Admission_no,em.Session_id,em.Class_id,em.Branch_id,em.Term,ar.class,ar.session,ar.Section,ar.rollnumber,ar.studentname,ar.dob,ar.mothername,ar.fathername,ar.studentimagepath,CASE WHEN ar.studentimagepath is null THEN '/images/dummy-student.jpg'  WHEN ar.studentimagepath is not null THEN ar.studentimagepath END AS Student_img, (select top 1 Short_Name from Exam_Term_Details where Session_Id=em.Session_id and Branch_id=em.Branch_id and Class_id=em.Class_id and Exam_Term_Id=em.Term) as Term_name,isnull((select top 1 Rank from Exam_rank_master where Session_id=ar.Session_id and Class_id=ar.Class_id and Branch_id=em.Branch_id and Admission_no=ar.admissionserialnumber and em.Term=" + Term_id + "),'0') as Rank,(select top 1 Assessment_Name from Exam_Assessment_Details where Session_Id=em.Session_id and Branch_id=em.Branch_id and Class_id=em.Class_id and Exam_Term_Id=em.Term and Assessment_Id=em.Assessment and Istatus=1) as Assesment_name,(select top 1 Maximum_Marks from Exam_Assessment_Details where Session_Id=em.Session_id and Branch_id=em.Branch_id and Class_id=em.Class_id and Exam_Term_Id=em.Term and Assessment_Id=em.Assessment and Istatus=1) as Assesment_maximum_marks from Exam_marks em join admission_registor ar on em.Session_id=ar.Session_id and em.Branch_id=ar.Branch_id and em.Class_id=ar.Class_id and em.Admission_no=ar.admissionserialnumber where em.Session_id=" + Session_id + " and em.Class_id=" + Class_id + " and ar.Section='" + Section + "' and em.Branch_id=" + Branch_id + "  and  em.Term=" + Term_id + "  and em.Assessment='" + Assesment_id + "' order by ar.rollnumber asc";
            }
            ...
            else
            {
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    List<MySubjectMarkShowII> MBdetails = findSubjectMarkShowII(dr["Admission_no"].ToString(), Session_id, Class_id, Branch_id, Term_id, Assesment_id);

                    List<Fetch_Details_of_report_head> MBdetailsHeading = findSubjectHeadings(Session_id, Class_id, Branch_id, Term_id, Assesment_id);
                    ...
                    //================ DescplinE
                    List<Fetch_Details_of_report_descpline> MBdetailsDescplinE = findDescplineData(Session_id, dr["Admission_no"].ToString(), Class_id, Branch_id, Term_id, Assesment_id);
                    ...
                    string signatures = examwiseRp.get_signature(Session_id, Class_id, Section, Branch_id);
                    ...
                    string term_name = examwiseRp.get_term_name(Branch_id, Term_id);
                    ...
                    string Assesment_maximum_marks = dr["Assesment_maximum_marks"].ToString();
                    double assmnt_hlf_mark = My.toDouble(Assesment_maximum_marks) / 2;
                    ...
                    ShowMyStudents.Add(new MyStudentsDetails
                    {
                        ...
                        Assesment_name = dr["Assesment_name"].ToString(),

                        Assesment_maximum_marks = Assesment_maximum_marks,
                        Assmnt_hlf_mark = assmnt_hlf_mark.ToString(),
        ...
        private List<Fetch_Details_of_overall_no> findOverallNoDetails(string Session_id, string admission_no, string Class_id, string Branch_id, string Section, string Term_id)
        {
            ...
            string Total_marks = examwiseRp.get_overall_total_marks(Session_id, Class_id, admission_no, Branch_id, Term_id);
            string[] stringSeparatorss = new string[] { "/" };
        ...
        private List<Fetch_Details_of_Rank> findRankDetails(string Session_id, string admission_no, string Class_id, string Branch_id, string Section, string Term_id)
        {
            ...
            {
                string system_grade_id = examwiseRp.get_system_grade_id_final(Session_id, Branch_id, Class_id);
                foreach (DataRow dr in dt.Rows)
                {
                    string rank = "0";
                    if (dr["Rank"].ToString() == "1")
                    ...
                    string grade = examwiseRp.get_grade_final(Session_id, Branch_id, system_grade_id, My.toDouble(dr["Mark_percentage"].ToString()));
        ...
        private List<Fetch_Details_of_Signature> findSigDetails(string Session_id, string admission_no, string Class_id, string Branch_id, string Section)
        {
            ...
            else
            {
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    {
                        stgnature = examwiseRp.get_class_teacher_signature(Session_id, Class_id, Section, Branch_id);
                    }
                    if (dr["Signature_type"].ToString() == "2")
                    {
                        stgnature = examwiseRp.get_principal_signature(Session_id, Branch_id);
                    }
                    if (dr["Signature_type"].ToString() == "3")
                    {
                        stgnature = examwiseRp.get_examinee_or_parent_signature(Session_id, Branch_id, dr["Signature_type_e_p"].ToString());
                    }
        ...
        private List<Fetch_Details_of_report_head> findSubjectHeadings(string Session_id, string Class_id, string Branch_id, string Term_id, string Assesment_id)
        {
            ...
            if (rowcount1 > 0)
            {
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    if (i == 1)
                    {
                        extra_marks = examwiseRp.get_extra_marks(Class_id, Branch_id);
                        if (extra_marks != "0")
                        {
        ...
        private List<Fetch_Details_of_report_CoScholastic> findCoScholasticData(string Session_id, string Admission_no, string Class_id, string Branch_id, string Term_id)
        {
            ...
            else
            {
                foreach (DataRow dr in dt.Rows)
                {
                    string marks = examwiseRp.get_marks(dr["Session_id"].ToString(), dr["Class_id"].ToString(), dr["Admission_no"].ToString(), dr["Term"].ToString(), dr["Assessment"].ToString(), dr["Subject"].ToString(), dr["Branch_id"].ToString(), "Co-Scholastic");
        ...
        //================================= DescplinES
        private List<Fetch_Details_of_report_descpline> findDescplineData(string Session_id, string Admission_no, string Class_id, string Branch_id, string Term_id, string Assesment_id)
        {
            List<Fetch_Details_of_report_descpline> MyDescplineData = new List<Fetch_Details_of_report_descpline>();
            string query = "select ptt.*,pt.Activity_name from Exam_Personality_Traits_Exam_Wise ptt join Exam_Personality_Traits pt on ptt.Activity_Id=pt.Activity_Id where ptt.Session_id='" + Session_id + "' and ptt.Branch_id='" + Branch_id + "' and ptt.Class_id='" + Class_id + "' and ptt.Exam_Term_Id='" + Term_id + "' and ptt.Exam_Id='" + Assesment_id + "' and ptt.Admission_no='" + Admission_no + "'  order by pt.Position asc";
            SqlDataAdapter ad = new SqlDataAdapter(query, My.con);
            DataSet ds = new DataSet();
            ad.Fill(ds, "Exam_marks");
            DataTable dt = ds.Tables[0];
            ...
            if (rowcount1 > 0)
            {
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    if (isNum == true)
                    {
                        grade = examwiseRp.get_personality_grade(Session_id, Class_id, Branch_id, dr["Term_grade"].ToString());
                    }
                    else
                    {
        ...
        private List<Fetch_Details_of_report_grade_remark> findGradeRemarkData(string Session_id, string Admission_no, string Class_id, string Branch_id, string Term_id)
        {
            ...
            string sys_grade_id = examwiseRp.get_co_scholastic_system_grade_id(Session_id, Class_id, Admission_no, Branch_id, Term_id);
        ...
        private List<Fetch_Details_of_Firm> findFirmDetails()
        {
            ...
            else
            {
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    if (dr["Affiliation"].ToString().ToUpper() == "NA")
                    {
                        Frim_aff_no = "hidden";
                    }
        ...
        private List<MySubjectMarkShowII> findSubjectMarkShowII(string Admission_no, string Session_id, string Class_id, string Branch_id, string Term_id, string Assesment_id)
        {
            ...
            if (rowcount1 > 0)
            {
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    List<MySubjectMarkDetailsIII> MBdetailsIII = findmyMarksIII(dr["Subject"].ToString(), Admission_no, Session_id, Class_id, Branch_id, Term_id, Assesment_id);
                    string Total_marks = examwiseRp.get_subject_total_marks(dr["Session_id"].ToString(), dr["Class_id"].ToString(), dr["Admission_no"].ToString(), dr["Term"].ToString(), dr["Subject"].ToString(), dr["Branch_id"].ToString(), "Scholastic", Assesment_id);
                    ...
                    string percent_remark = examwiseRp.get_percent_remark(overall_percent);
                    string Gbgclass = "";
                    if (gradeBG.Length == 7)
                    {
                        gradeBG = "background:" + gradeBG;
        ...
        private List<MySubjectMarkDetailsIII> findmyMarksIII(string Subject_id, string Admission_no, string Session_id, string Class_id, string Branch_id, string Term_id, string Assesment_id)
        {
            ...
            {
                string subject_name = examwiseRp.get_subject_name(Subject_id, Class_id, Branch_id);
                foreach (DataRow dr in dt.Rows)
                {
                    string marks = examwiseRp.get_marks(dr["Session_id"].ToString(), dr["Class_id"].ToString(), Admission_no, dr["Term"].ToString(), dr["Assessment"].ToString(), Subject_id, dr["Branch_id"].ToString(), "Scholastic");
                    string[] stringSeparatorss = new string[] { "/" };
                    string[] arrs = marks.Split(stringSeparatorss, StringSplitOptions.None);
                    string obt_marks = arrs[0];
                    string full_marks = arrs[1];
