<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="report-card-with-full-m-m.aspx.cs" Inherits="school_web.Examination_Admin.slip.general.report_card_with_full_m_m" %>
                            ...
                            <div class="report-card-wpr" style="height: {{x.MySubjectMarkShowItemII[0].Height_dv}}">
                                ...
                                <div class="subs-mrks-area-lft-dv">
                                    ...
                                    <div class="remarks-rp">
                                        <p style="padding: 0px 0px 50px 0px;">REMARKS :</p>
                                    </div>
                                </div>
