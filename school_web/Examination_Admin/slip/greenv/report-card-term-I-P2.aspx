<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="report-card-term-I-P2.aspx.cs" Inherits="school_web.Examination_Admin.slip.greenv.report_card_term_I_P2" %>
                        ...
                        <div class="report-card-wpr" style="height: {{reportCardSubS[0].Height_dv}}">
                            <div class="report-card-head">
                                ...
                                <div class="report-card-rght-dv">
                                    ...
                                    <asp:Image ID="img_student_img" runat="server" style="display:none !important" />
                                </div>
                            </div>
