...
{
    /// <summary>
    /// Summary description for report_card_I
    /// </summary>
    ...
    public class report_card_I : System.Web.Services.WebService
    {
        My mycode = new My();
        ...
        {
            string qry = "delete from Exam_temp_assesment_total_no where   Session_Id=" + Session_id + " and Branch_Id='" + Branch_id + "' and Admission_no='" + Admission_no + "' and Term_id=" + Term_id + " and Class_id=" + Class_id + "";
