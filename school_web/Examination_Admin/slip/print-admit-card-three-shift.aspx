<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="print-admit-card-three-shift.aspx.cs" Inherits="school_web.Examination_Admin.slip.print_admit_card_three_shift" %>
                            ...
                            <div class="printpage-sec-main">
                                ...
                                <div class="administration-paragraph">
                                    <table class="{{x.MySchoolDetailsItem[0].Programe}}">
                                        ...
                                        <tr>
                                            <th colspan="2"></th>
                                            <th class="txtcentr">1ST SITTING <br />({{x.Shift1_start}} TO {{x.Shift1_end}})</th>
                                            <th class="txtcentr">2ND SITTING <br />({{x.Shift2_start}} TO {{x.Shift2_end}})</th>
                                            <th class="txtcentr">3RD SITTING <br />({{x.Shift3_start}} TO {{x.Shift3_end}})</th>
                                        </tr>
                                        <tr>
                                            <th>SN</th>
                                            <th>DATE</th>
                                        ...
                                        <tr data-ng-repeat="item in x.MyRoutineDetailsItem track by $index" class="{{item.Exam_date}}">
                                            <td>{{$index+1}}</td>
