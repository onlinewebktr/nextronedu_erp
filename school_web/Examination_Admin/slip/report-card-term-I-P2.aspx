<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="report-card-term-I-P2.aspx.cs" Inherits="school_web.Examination_Admin.slip.report_card_term_I_P2" %>
    ...
    <form id="form1" runat="server">
                    ...
                    <div class="invoice-wpr">
                        ...
                        <div class="report-card-wpr" style="height: {{reportCardSubS[0].Height_dv}}">
                            <div class="report-card-head">
                                ...
                                </div><asp:Label ID="lbl_aff_no" class="report-card-schl-affno" runat="server"></asp:Label>
                            ...
                            <div class="subs-mrks-area-dv">
                                <table>
                                    <tr>
                                        ...
                                        <th class="{{reportCardSubS[0].Is_text_center}}" colspan="2">SCHOLASTIC AREAS</th>
                                        <th data-ng-repeat="x in reportCardAssesment" colspan="2" class="{{reportCardSubS[0].Is_text_center}}">{{x.Assessment_Name}}</th>
                                        <th colspan="2" class="{{reportCardSubS[0].Is_text_center}}"></th>
                                    </tr>
                                    <tr>
                                        ...
                                        <th class="{{reportCardSubS[0].Is_text_center}}">{{reportCardSubS[0].grade_head_text}} ({{reportCardAssesment[0].Term_Maximum_Marks}})</th>
        ...
        <script type="text/javascript">
            ...
            app.controller('RpCardAppCtrl', function ($scope, $http) {
                ...
                $http.get("webService/report-card-P2.asmx/fetch_report_card_assesment", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id, "Term_id": term_id } }).then(function (response) {
                    $scope.reportCardAssesment = response.data;
                })

                $http.get("webService/report-card-P2.asmx/fetch_report_card", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id, "Term_id": term_id } }).then(function (response) {
                    $scope.reportCard = response.data;
                })


                $http.get("webService/report-card-P2.asmx/fetch_rp_card_subjects", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id, "Term_id": term_id } }).then(function (response) {
                    ...
                    if ($scope.reportCardSubS == "") {
                        ...
                        ////========================GRAPH
                        $http.get("webService/report-card-P2.asmx/fetch_rp_card_graph", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id, "Term_id": term_id } }).then(function (response) {
                            $scope.reportGraphs = response.data;
                        })


                        ////========================OverAll No.
                        $http.get("webService/report-card-P2.asmx/fetch_rp_card_total_no", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id, "Term_id": term_id } }).then(function (response) {
                ...
                $http.get("webService/report-card-P2.asmx/fetch_rp_card_marks_range", { params: { "Session_id": session_id, "Branch_id": branch_id, "Term_id": term_id } }).then(function (response) {
                    $scope.reportCardmarkRange = response.data;
                })


                ////========================Get Scholastic Data
                $http.get("webService/report-card-P2.asmx/fetch_report_card_coscholastic", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id, "Term_id": term_id } }).then(function (response) {
                    $scope.reportCardCoScholastic = response.data;
                })


                ////========================Get Discipline Data
                $http.get("webService/report-card-P2.asmx/fetch_report_card_discipline_activity", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id, "Term_id": term_id } }).then(function (response) {
                    $scope.reportCardDesciplineActivitY = response.data;
                })



                $http.get("webService/report-card-P2.asmx/fetch_rp_card_grade_remark").then(function (response) {
                    $scope.reportCardgeadeRemark = response.data;
                })

                $http.get("webService/report-card-P2.asmx/fetch_rp_card_signature", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id } }).then(function (response) {
                    $scope.reportSig = response.data;
                })


                ////========================Rank
                $http.get("webService/report-card-P2.asmx/fetch_rp_card_rank", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id, "Term_id": term_id } }).then(function (response) {
