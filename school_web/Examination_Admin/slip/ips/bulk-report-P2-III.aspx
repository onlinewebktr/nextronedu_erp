<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bulk-report-P2-III.aspx.cs" Inherits="school_web.Examination_Admin.slip.ips.bulk_report_P2_III" %>
    ...
    <form id="form1" runat="server">
                ...
                <div class="invoice-inr-sec" data-ng-repeat="x in reportCardS track by $index">
                    <div class="invoice-height-manage">
                        <div class="invoice-wpr" style="border: 5px solid #87878700;">
                            ...
                            <div class="report-card-wpr" style="height: {{x.MySubjectMarkShowItemII[0].Height_dv}}; border: 5px solid #87878700;">
                                <div class="report-card-head {{x.MySubjectMarkShowItemII[0].Hdr_frst}}">
                                    <div class="report-card-left-dv" style="height: 50px">
                                        <img src="{{x.MyFirmDetailData[0].Frim_logo}}" style="display: none" />
                                        <asp:Label ID="lbl_estd" runat="server" Text="{{x.MyFirmDetailData[0].Estd}}" Style="display: none !important" class="estdTextP v-false {{x.MySubjectMarkShowItemII[0].Is_estd_show}}"></asp:Label>
                                    </div>
                                    <div class="report-card-cntr-dv">
                                        <asp:Label ID="lbl_school_name" class="report-card-schlname" runat="server" Style="display: none" Text="{{x.MyFirmDetailData[0].Firm_name}}"></asp:Label>
                                        <asp:Label ID="lbl_aff_text" class="report-card-schl-affno-by" Style="display: none" runat="server" Text="{{x.MyFirmDetailData[0].Affiliated_by_full_text}}"></asp:Label>
                                        <asp:Label ID="lbl_address" runat="server" Style="display: none" class="report-card-schl-add" Text="{{x.MyFirmDetailData[0].Firm_address}}"></asp:Label>
                                        <asp:Label ID="lbl_contact_no" runat="server" Style="display: none" class="report-card-schl-cont v-false {{x.MySubjectMarkShowItemII[0].Is_contact_no_show}}" Text="{{x.MyFirmDetailData[0].Firm_contact_no}}"></asp:Label>
                                        <p class="report-card-schl-emil v-false {{x.MySubjectMarkShowItemII[0].Is_email_show}}" style="display: none">
                                            Email : 
                                        <asp:Label ID="lbl_email" runat="server" Text="{{x.MyFirmDetailData[0].Firm_email}}"></asp:Label>
                                        </p>

                                        <p class="report-card-schl-emil v-false {{x.MySubjectMarkShowItemII[0].Is_website_show}}" style="display: none">
                                            Website : 
                                    ...
                                    <%--<asp:Label ID="lbl_aff_no" Style="display: none" class="report-card-schl-affno" runat="server" Text="{{x.MySubjectMarkShowItemII[0].Aff_text}} : {{x.MyFirmDetailData[0].Frim_aff_no}}"></asp:Label>--%>

                                    <div class="report-card-rght-dv">
                                        <div class="sdt-img-dv {{x.Student_image}}" style="display: none">
                                ...
                                <div class="subs-mrks-area-dv">
                                    <table>
                                        <tr>
                                            ...
                                            <th data-ng-repeat="item in x.MySubjectHeading_one track by $index" class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}" rowspan="{{item.RowSpan}}" colspan="{{item.Sub_level_count}}">{{item.Assessment_Name}}</th>
                                            <th rowspan="2" class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}">{{x.MySubjectMarkShowItemII[0].grade_head_text}} ({{x.MySubjectHeading_one[0].Term_Maximum_Marks}})</th>
                                            <th rowspan="2" class="{{x.MySubjectMarkShowItemII[0].Grade}} {{x.MySubjectMarkShowItemII[0].Is_text_center}}">HIGHEST MARK</th>
                                        </tr>
                                        <tr>
                                            <th class="txtcenter">SN</th>
                                            <th>SUBJECTS</th>
                                            <th class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}" data-ng-repeat="item in x.MySubjectHeading track by $index">{{item.Subject_Activity_Name}}</th>
                                        </tr>
                                        ...
                                        <tr data-ng-repeat="item in x.MySubjectMarkShowItemII track by $index">
                                            ...
                                            <td class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}">{{item.Subj_highest_mark}}</td>
                                        </tr>
                                    </table>
                                </div>
                                ...
                                <div class="subs-mrks-area-lft-dv">
                                    <div class="subs-mrks-area-b-dv" style="margin-top: {{x.MySubjectMarkShowItemII[0].Co_sch_area_margn}}">
                                        <table>
                                            ...
                                            <%-- =============== --%>
                                            <tr class="{{x.MySubjectMarkShowItemII[0].Is_discipline_hide}}">
                                                <th>C</th>
                                            ...
                                            <tr class="{{x.MySubjectMarkShowItemII[0].Is_discipline_hide}}" data-ng-repeat="item in x.MyDescplineData track by $index">
                                                <td>{{$index+1}}</td>
                                    ...
                                    <div class="prcntage-remrk-dv v-false {{x.MySubjectMarkShowItemII[0].Prcnt_remark}}" style="margin-top: {{x.MySubjectMarkShowItemII[0].Percent_remark_area_margn}}">
                                        <p>Remark :</p>
                                        <span>{{x.MyOverallNoDetailData[0].P_remark}}</span>
                                    </div>
                                </div>
                                ...
                                <div class="subs-mrks-area-rght-dv">
                                    <div class="subs-mrks-area-ovrall-dv" style="margin-top: {{x.MySubjectMarkShowItemII[0].Overall_area_margn}}">
                                        <table>
                                            ...
                                            <tr>
                                                <td>OVERALL {{x.MyOverallNoDetailData[0].Mark_type}}</td>
                                                <td>{{x.MyOverallNoDetailData[0].Overall_percents}} <span class="{{x.MySubjectMarkShowItemII[0].Overall_obt_mark}}">(%)</span></td>
                                            </tr>



                                            <tr class="{{x.MySubjectMarkShowItemII[0].Overall_obt_mark}} {{x.MySubjectMarkShowItemII[0].Is_overall_grade_show}} {{x.MySubjectMarkShowItemII[0].Is_attendance_hide_claaswise}}">
                                                <td>OVERALL GRADE</td>
                                                <td>{{x.MyOverallNoDetailData[0].Grade}}</td>
                                            </tr>
                                            <tr class="{{x.MySubjectMarkShowItemII[0].Is_attandance_show}} {{x.MySubjectMarkShowItemII[0].Is_attendance_hide_claaswise}}">
                                    ...
                                    <div class="qr-dvs v-false {{x.MySubjectMarkShowItemII[0].qr_div_true}}">
        ...
        <script type="text/javascript">
            ...
            app.controller('RpCardAppCtrl', function ($scope, $http) {
                ...
                $http.get("api/bulk-report-P2-III.asmx/fetch_rp_card_bulks", { params: { "Session_id": session_id, "Class_id": class_id, "Section": section, "Branch_id": branch_id, "Term_id": term_id, "Admission_no": admission_no } }).then(function (response) {
