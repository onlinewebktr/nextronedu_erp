<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bulk-report-card-termI.aspx.cs" Inherits="school_web.Examination_Admin.slip.ips.bulk_report_card_termI" %>
    ...
    <form id="form1" runat="server">
                                ...
                                <div class="subs-mrks-area-dv">
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <th class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}">HIGHEST MARK</th>
                                        </tr>
                                ...
                                <div class="subs-mrks-area-lft-dv">
                                    <div class="subs-mrks-area-b-dv" style="margin-top: {{x.MySubjectMarkShowItemII[0].Co_sch_area_margn}}">
                                        <table>
                                            ...
                                            <tr data-ng-repeat="item in x.MyDescplineData track by $index" style="display: none">
                                                <td>{{$index+1}}</td>
        ...
        <script type="text/javascript">
            ...
            app.controller('RpCardAppCtrl', function ($scope, $http) {
                ...
                $http.get("api/bulk-report-card-termI.asmx/fetch_rp_card_bulks", { params: { "Session_id": session_id, "Class_id": class_id, "Section": section, "Branch_id": branch_id, "Term_id": term_id, "Admission_no": admission_no } }).then(function (response) {
