...
{
    /// <summary>
    /// Summary description for bulk_report_P2_III
    /// </summary>
    ...
    public class bulk_report_P2_III : System.Web.Services.WebService
    {
        My mycode = new My();
        public class MyStudentsDetails
        {
            ...
            public List<Fetch_Details_of_report_head_one> MySubjectHeading_one { get; set; }
        ...
        public class Fetch_Details_of_report_head_one
        {
        ...
        public class MySubjectMarkShowII
        {
            ...
            public string Is_attendance_hide_claaswise { get; set; }
            ...
            public string Is_discipline_hide { get; set; }
        ...
        public void fetch_rp_card_bulks(string Session_id, string Class_id, string Section, string Branch_id, string Term_id, string Admission_no)
        {
            ...
            else
            {
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    List<Fetch_Details_of_report_head_one> MBdetailsHeadingOne = findSubjectHeadings_one(Session_id, Class_id, Branch_id, Term_id);
                    ...
                    ShowMyStudents.Add(new MyStudentsDetails
                    {
                        ...
                        MySubjectHeading_one = MBdetailsHeadingOne,
        ...
        private List<Fetch_Details_of_overall_no> findOverallNoDetails(string Session_id, string admission_no, string Class_id, string Branch_id, string Section, string Term_id)
        {
            ...
            string Total_marks = P2_III.get_overall_total_marks(Session_id, Class_id, admission_no, Branch_id, Term_id);
            string[] stringSeparatorss = new string[] { "/" };
            ...
            string grade = arrs[4];
            string percent_remark = P2_III.get_percent_remark(overall_percent);
        ...
        private List<Fetch_Details_of_report_head_one> findSubjectHeadings_one(string Session_id, string Class_id, string Branch_id, string Term_id)
        {
            List<Fetch_Details_of_report_head_one> MySubjectHeading_one = new List<Fetch_Details_of_report_head_one>();
            ...
            else
            {
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    MySubjectHeading_one.Add(new Fetch_Details_of_report_head_one
                    {
        ...
        private List<Fetch_Details_of_report_grade_remark> findGradeRemarkData(string Session_id, string Admission_no, string Class_id, string Branch_id, string Term_id)
        {
            ...
            string sys_grade_id = Examination.get_co_scholastic_system_grade_id(Session_id, Class_id, Admission_no, Branch_id, Term_id);
        ...
        private List<MySubjectMarkShowII> findSubjectMarkShowII(string Admission_no, string Session_id, string Class_id, string Branch_id, string Term_id)
        {
            ...
            else
            {
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    string Total_marks = P2_III.get_subject_total_marks(dr["Session_id"].ToString(), dr["Class_id"].ToString(), dr["Admission_no"].ToString(), dr["Term"].ToString(), dr["Subject"].ToString(), dr["Branch_id"].ToString(), "Scholastic");
                    string sub_highest_mark = get_highest_mark(Session_id, Class_id, Branch_id, dr["Subject"].ToString(), Admission_no);
                    string[] stringSeparatorss = new string[] { "/" };
                    string[] arrs = Total_marks.Split(stringSeparatorss, StringSplitOptions.None);
                    ...
                    string Is_attendance_hide_claaswise = arrs[49];   // Is_attendance_hide
                    string Is_discipline_hide = arrs[50];   // Is_attendance_hide
                    ...
                    string subjName = dr["Subject_name"].ToString();
                    if (subjName.ToUpper() == "2ND LANGUAGE - BENGALI" || subjName.ToUpper() == "2ND LANGUAGE - HINDI" || subjName.ToUpper() == "2ND LANGUAGE BENGALI" || subjName.ToUpper() == "2ND LANGUAGE BENGALI ORAL" || subjName.ToUpper() == "2ND LANGUAGE HINDI" || subjName.ToUpper() == "2ND LANGUAGE HINDI ORAL" || subjName.ToUpper() == "2ND LANGUAGE-BENGALI" || subjName.ToUpper() == "2ND LANGUAGE-HINDI")
                    {
                        subjName = "2ND LANGUAGE H/B";
                    }
                    ...
                    MySubjectMarkShowItemII.Add(new MySubjectMarkShowII
                    {
                        ...
                        Subject_name = subjName,  //dr["Subject_name"].ToString(),
                        ...
                        Is_attendance_hide_claaswise = Is_attendance_hide_claaswise,
                        ...
                        Is_discipline_hide = Is_discipline_hide,
        ...
        private List<MySubjectMarkDetailsIII> findmyMarksIII(string Subject_id, string Admission_no, string Session_id, string Class_id, string Branch_id, string Term_id)
        {
            ...
            //    else
            //    {
            //        string subject_name = exam_ips_I.get_subject_name(Subject_id, Class_id, Branch_id);
            //        foreach (DataRow dr in dt.Rows)
            //        {
            //            if (systm_grade_id == "15" || systm_grade_id == "35")
            //            {
            //                string obt_markss = "0";
            ...
            //                save_marks(dr["Session_id"].ToString(), dr["Class_id"].ToString(), Admission_no, dr["Term"].ToString(), dr["Assessment"].ToString(), Subject_id, dr["Branch_id"].ToString(), obt_markss, full_markss, marks_types, total_nos, drs["Term_assesment_unique_id"].ToString());
            ...
            //            save_marks(dr["Session_id"].ToString(), dr["Class_id"].ToString(), Admission_no, dr["Term"].ToString(), dr["Assessment"].ToString(), Subject_id, dr["Branch_id"].ToString(), obt_marks, full_marks, marks_type, total_no, drs["Term_assesment_unique_id"].ToString());
            //            MySubjectMarkItemIII.Add(new MySubjectMarkDetailsIII
            //            {
            ...
            else
            {
                foreach (DataRow dr in dt.Rows)
                {
                    if (dr["Sequence_No"].ToString() != "1")
                    {
                        string marks = P2_III.get_marks(dr["Session_id"].ToString(), dr["Class_id"].ToString(), Admission_no, dr["Term"].ToString(), dr["Assessment"].ToString(), Subject_id, dr["Branch_id"].ToString(), "Scholastic", "1");
                        string[] stringSeparatorss = new string[] { "/" };
                        string[] arrs = marks.Split(stringSeparatorss, StringSplitOptions.None);
                        string obt_marks = arrs[0];
                        string full_marks = arrs[1];
                        ...
                        save_marks(dr["Session_id"].ToString(), dr["Class_id"].ToString(), Admission_no, dr["Term"].ToString(), dr["Assessment"].ToString(), Subject_id, dr["Branch_id"].ToString(), obt_marksss, full_marks, marks_type, total_no);
                        ...
                        //=============================
                        string markss = P2_III.get_marks(dr["Session_id"].ToString(), dr["Class_id"].ToString(), Admission_no, dr["Term"].ToString(), dr["Assessment"].ToString(), Subject_id, dr["Branch_id"].ToString(), "Scholastic", "2");
                        ...
                        save_marks(dr["Session_id"].ToString(), dr["Class_id"].ToString(), Admission_no, dr["Term"].ToString(), dr["Assessment"].ToString(), Subject_id, dr["Branch_id"].ToString(), obt_markssss, full_markss, marks_types, total_no);
                    ...
                    {
                        string marks = P2_III.get_marks(dr["Session_id"].ToString(), dr["Class_id"].ToString(), Admission_no, dr["Term"].ToString(), dr["Assessment"].ToString(), Subject_id, dr["Branch_id"].ToString(), "Scholastic", "0");
