    ...
    public class final_report_card1 : System.Web.Services.WebService
    {
        ...
        public void fetch_report_card(string Session_id, string Class_id, string Admission_no, string Branch_id, string Term_id)
        {
            ...
            else
            {
                ...
                {
                    string extra_marks = exam_ips_I.get_max_marks_in_head(Session_id, Class_id, Branch_id, Term_id, dr["Assessment_Id"].ToString());
                    ...
                    Show_of_report_head.Add(new Fetch_Details_of_report_head
                    {
                        ...
                        Maximum_Marks = extra_marks, // dr["Maximum_Marks"].ToString(),
        ...
        public void fetch_rp_card_subjects(string Session_id, string Class_id, string Admission_no, string Branch_id, string Term_idI, string Term_idII)
        {
            ...
            else
            {
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    string ttl_mark_of_a_subject = exam_ips_I.get_ttl_mark_of_a_subject_final_year(dr["Subject_id"].ToString(), Admission_no, Session_id, Class_id, Branch_id, Term_idI, Term_idII);
        ...
        private List<MySubjectMarkDetails> findmyBookingProduct(string Subject_id, string Admission_no, string Session_id, string Class_id, string Branch_id, string Term_id)
        {
            ...
            else
            {
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    {
                        string Term_i_marks = "-";
                        string Term_ii_marks = "-";
                        string Term_i_full_marks = "0";
                        string Term_ii_full_marks = "0";

                        MySubjectMarkItem.Add(new MySubjectMarkDetails
                        {
                            Subject_Name = dr["Subject_Name"].ToString(),
                            Marks_term_I = Term_i_marks,
                            Marks_term_II = Term_ii_marks,

                            Term_i_full_mark = Term_i_full_marks,
                            Term_ii_full_mark = Term_ii_full_marks,
                        });
                    }
        ...
        {
            string Total_marks = exam_ips_I.get_overall_total_marks_final_termII(Session_id, Class_id, Admission_no, Branch_id, Term_id);
            string[] stringSeparatorss = new string[] { "/" };
        ...
        {
            string attendance = exam_ips_I.get_attendances(Session_id, Class_id, Admission_no, Branch_id, Term_id, Term_idII);
