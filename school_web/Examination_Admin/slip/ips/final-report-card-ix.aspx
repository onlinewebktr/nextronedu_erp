<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="final-report-card-ix.aspx.cs" Inherits="school_web.Examination_Admin.slip.ips.final_report_card_ix" %>
    ...
    <form id="form1" runat="server">
                            ...
                            <div class="subs-mrks-area-dv">
                                <table>
                                    <tr>
                                        ...
                                        <th class="txtcenter" style="width:190px">SCHOLASTIC AREAS</th>
                                        <%-- <th data-ng-repeat="x in reportCardAssesment" class="txtcenter" rowspan="{{x.RowSpan}}">{{x.Assessment_Name}} ({{x.Maximum_Marks}})</th>--%>
                                        ...
                                        <th class="txtcenter">HALF YEARLY</th>


                                        <th data-ng-repeat="x in reportCardAssesmentTermII" class="txtcenter" rowspan="{{x.RowSpan}}" colspan="{{x.Sub_level_count}}">{{x.Assessment_Name}} <%--({{x.Maximum_Marks}})--%></th>
                                        <th rowspan="2" class="txtcenter"><%--{{reportCardSubS[0].grade_head_text}}--%>  TOTAL MARKS (B) ({{reportCardAssesment[0].Term_Maximum_Marks}})</th>
                                        <th rowspan="2" class="{{reportCardSubS[0].Grade}} txtcenter">GRADE</th>
                                    ...
                                    <tr>
                                        ...
                                        <th>SUBJECTS</th>
                                        <%--<th class="txtcenter" data-ng-repeat="x in reportCard">{{x.Subject_Activity_Name}}</th>--%>
                                        <th class="txtcenter">TOTAL MARKS (A) (100)</th>

                                        <th class="txtcenter" data-ng-repeat="x in reportCardTII">{{x.Subject_Activity_Name}}</th>
                                    </tr>
                                    ...
                                    <tr data-ng-repeat="x in reportCardSubS track by $index">
                                        ...
                                        <td class="txtcenter" data-ng-repeat="item in x.MySubjectMarkItemTII track by $index">{{item.Marks}}</td>
                                        <td class="txtcenter">{{x.Total_marksTII}}</td>
                                        <td class="{{x.Grade}} txtcenter">{{x.GradeTII}}</td>
                                        <td class="txtcenter">{{x.Heighst_mrk}}</td>
                                    </tr>
                                </table>
                            </div>
        ...
        <script type="text/javascript">
            ...
            app.controller('RpCardAppCtrl', function ($scope, $http) {
                ...
                $http.get("api/final_report_card_ix.asmx/fetch_report_card_assesment", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id, "Term_id": term_id1 } }).then(function (response) {
                    $scope.reportCardAssesment = response.data;
                })

                //TERMII HEADING
                $http.get("api/final_report_card_ix.asmx/fetch_report_card_assesment", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id, "Term_id": term_id2 } }).then(function (response) {
                    $scope.reportCardAssesmentTermII = response.data;
                })


                //TERMII HEADING
                $http.get("api/final_report_card_ix.asmx/fetch_report_card", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id, "Term_id": term_id1 } }).then(function (response) {
                    $scope.reportCard = response.data;
                })
                //TERMII HEADING
                $http.get("api/final_report_card_ix.asmx/fetch_report_card", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id, "Term_id": term_id2 } }).then(function (response) {
                    $scope.reportCardTII = response.data;
                })
                ...
                $http.get("api/final_report_card_ix.asmx/fetch_rp_card_subjects", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id, "Term_idI": term_id1, "Term_idII": term_id2 } }).then(function (response) {
                    ...
                    if ($scope.reportCardSubS == "") {
                        ...
                        ////========================OverAll No.
                        $http.get("api/final_report_card_ix.asmx/fetch_rp_card_total_no", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id, "Term_id": term_id2 } }).then(function (response) {
                            $scope.ttlNos = response.data;
                        })

                        ////========================ATTENDANCE
                        $http.get("api/final_report_card_ix.asmx/fetch_rp_card_attendance", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id, "Term_id": term_id1, "Term_idII": term_id2 } }).then(function (response) {
                ...
                //CO-SCHOLASTIC DATA
                $http.get("api/final_report_card_ix.asmx/fetch_report_card_co_scholastic", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id, "Term_idI": term_id1, "Term_idII": term_id2 } }).then(function (response) {
                ...
                $http.get("api/final_report_card_ix.asmx/fetch_rp_card_assesment_full_name").then(function (response) {
