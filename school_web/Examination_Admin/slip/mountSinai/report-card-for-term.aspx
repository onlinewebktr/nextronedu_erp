<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="report-card-for-term.aspx.cs" Inherits="school_web.Examination_Admin.slip.mountSinai.report_card_for_term" %>
                            ...
                            <div class="report-card-wpr" style="height: {{x.MySubjectMarkShowItemII[0].Height_dv}}">
                                ...
                                <div class="subs-mrks-area-dv">
                                    ...
                                    <div class="att-ovrll-sec">
                                        ...
                                        <div class="att-ovrll-ttl-marks-dv" style="margin: 0px 0px 0px 0px; float: right;">
                                            ...
                                            <p class="att-ovrll-ttl-marks-num-p">{{x.MySubjectMarkShowItemII[0].Percent_of_attandance}} (%)</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="subs-mrks-area-rght-dv">
                                    <div class="rp-card-graph-sec {{x.MySubjectMarkShowItemII[0].Graph}}">
                                        <p style="text-align: center; margin: 0px 0px 5px 0px; padding: 0px; width: 100%; float: left;">
                                ...
                                <div class="instruction-dv-fr-auto-bottom">
                                    ...
                                    <div class="instruction-50 instruction-50-pl">
                                        <div class="instruction-tbls" style="margin-top: {{reportCardSubS[0].Ins1_area_margn}}">
                                            <table>
                                                <tr>
                                                    <th colspan="2" class="txt-center">(Scholastic & Co-Scholastic Areas {{x.MyMarkRangeData[0].RowCount}}-point grading scale)</th>
                                                </tr>
                                                <%--<tr>
                                                ...
                                                <tr data-ng-repeat="item in x.MyMarkRangeData track by $index">
                                                    ...
                                                    <td class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}"><span class="{{item.GbgclassGScale}}" style="{{item.GradeBGGScale}}">{{item.Grade}}</span></td>
                                                </tr>
                                            </table>
                                        </div>
                                    </div>
