<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="report-card-termI.aspx.cs" Inherits="school_web.Examination_Admin.slip.dmbh.report_card_termI" %>
                            ...
                            <div class="subs-mrks-area-rght-dv">
                                ...
                                <div class="remrk-promot-to" style="margin-top: 10px;">
                                    <div class="promot-dvcustom wdth">
                                        <p class="fntsize13">Promoted to : <span class="{{promoT[0].ShowStatuS}}">Session : {{promoT[0].Session}}, Class :  {{promoT[0].Class_name}}, Section :  {{promoT[0].Section}}</span></p>
                                    </div>
                                </div>
