<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bulk-report-card-termI.aspx.cs" Inherits="school_web.Examination_Admin.slip.dmbh.bulk_report_card_termI" %>
                        ...
                        <div class="invoice-wpr">
                            ...
                            <div class="report-card-wpr" style="height: {{x.MySubjectMarkShowItemII[0].Height_dv}}">
                                ...
                                <div class="subs-mrks-area-rght-dv">
                                    ...
                                    <div class="remrk-promot-to" style="margin-top: 10px;">
                                        <div class="promot-dvcustom wdth">
                                            <p class="fntsize13">Promoted to : <span class="{{x.Fetch_Details_of_promoted_toItem[0].ShowStatuS}}">Session : {{x.Fetch_Details_of_promoted_toItem[0].Session}}, Class :  {{x.Fetch_Details_of_promoted_toItem[0].Class_name}}, Section :  {{x.Fetch_Details_of_promoted_toItem[0].Section}}</span></p>
                                        </div>
                                    </div>
                                ...
                                <div class="sig-dv v-false {{x.MySubjectMarkShowItemII[0].Sign_bottom}}">
                                    ...
                                    <div class="sig-left"  style="height: 10px;">
