...
namespace school_web.Examination_Admin.slip.dmbh.api
{
    /// <summary>
    ...
    public class bulk_report_card : System.Web.Services.WebService
    {
        ...
        public class MyStudentsDetails
        {
            ...
            public List<Fetch_Details_of_promoted_to> Fetch_Details_of_promoted_toItem { get; set; }
        }
        ...
        public void fetch_rp_card_bulks(string Session_id, string Class_id, string Section, string Branch_id, string Term_id)
        {
            ...
            else
            {
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    //================ OverAllNo
                    List<Fetch_Details_of_promoted_to> MBOPromotTo = findPromoteTo(Session_id, Class_id, dr["Admission_no"].ToString(), Branch_id);
                    ...
                    ShowMyStudents.Add(new MyStudentsDetails
                    {
                        ...
                        Fetch_Details_of_promoted_toItem = MBOPromotTo
                    });
                }
        ...
        private List<Fetch_Details_of_promoted_to> findPromoteTo(string Session_id, string Class_id, string Admission_no, string Branch_id)
        {
            List<Fetch_Details_of_promoted_to> Fetch_Details_of_promoted_toItem = new List<Fetch_Details_of_promoted_to>();
            ...
            if (isStdTransfer == "Yes")
            {
                ...
                else
                {
                    foreach (DataRow dr in dt.Rows)
                    {
                        Fetch_Details_of_promoted_toItem.Add(new Fetch_Details_of_promoted_to
                        {
                            Session = dr["session"].ToString(),
            ...
            return Fetch_Details_of_promoted_toItem;
        }
