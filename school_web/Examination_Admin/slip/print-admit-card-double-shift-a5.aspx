<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="print-admit-card-double-shift-a5.aspx.cs" Inherits="school_web.Examination_Admin.slip.print_admit_card_double_shift_a5" %>
                                ...
                                <div class="printpage-sec-main {{x.OneAdmitCardHeight}}">
                                    ...
                                    <div class="administration-paragraph">
                                        <table class="{{x.MySchoolDetailsItem[0].Programe}}">
                                            ...
                                            <tr>
                                                <th colspan="3"></th>
                                                <th style="font-size: 12px;">1ST SITTING<br />
                                                    <span class="nobreak">({{x.Shift1_start}} TO {{x.Shift1_end}})</span> </th>
                                                <th style="font-size: 12px;">2ND SITTING
                                                    <br />
