<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bulk-report-card-xi-to-xii.aspx.cs" Inherits="school_web.Examination_Admin.slip.sdhr.bulk_report_card_xi_to_xii" %>
    ...
    <form id="form1" runat="server">
                        ...
                        <div class="report-card-wpr" style="height: {{x.MySubjectMarkShowItemII[0].Height_dv}}">
                            ...
                            <div class="subs-mrks-area-dv">
                                <table>
                                    <tr>
                                        ...
                                        <th class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}">SCHOLASTIC AREAS ({{x.Term_name}} )</th>
                                        <th data-ng-repeat="item in x.MySubjectHeading track by $index" colspan="2" class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}">{{item.Assessment_Name}}</th>
                                    ...
                                    <tr>
                                        ...
                                        <th>SUBJECTS</th>
                                        <th class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}" data-ng-repeat="item in x.MySubjectHeading_obt_full track by $index">{{item.Short_Name}}</th>
                            ...
                            <div class="instruction-dv">
                                <div class="instruction-50 instruction-50-pr">
                                    <div class="instruction-tbls" style="margin-top: 25px">
                                        <table>
                                            <tr>
                            ...
                            <div class="sig-dv v-false {{x.MySubjectMarkShowItemII[0].Sign_bottom}}" style="bottom: 200px">
                                <div class="sig-left">
        ...
        <script type="text/javascript">
            ...
            app.controller('RpCardAppCtrl', function ($scope, $http) {
                ...
                messge("Please Wait...");
                $("#intsLoader").removeClass("hidden");
                $http.get("api/bulk-report-card-xi-to-xii.asmx/fetch_rp_card_bulks", { params: { "Session_id": session_id, "Class_id": class_id, "Section": section, "Branch_id": branch_id, "Term_id": term_id, "Admission_no": admission_no } }).then(function (response) {
