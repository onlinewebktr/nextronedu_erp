...
{
    /// <summary>
    /// Summary description for report_card_ix_to_x
    /// </summary>
    ...
    public class report_card_ix_to_x : System.Web.Services.WebService
    {
        My mycode = new My();
        ...
        public void fetch_rp_card_subjects(string Session_id, string Class_id, string Admission_no, string Branch_id, string Term_id)
        {
            ...
            else
            {
                ...
                {
                    List<MySubjectMarkDetails> MBdetails = findmyBookingProduct(dr["Subject"].ToString(), Admission_no, Session_id, Class_id, Branch_id, Term_id, dr["Subject_group"].ToString());
        ...
        private List<MySubjectMarkDetails> findmyBookingProduct(string Subject_id, string Admission_no, string Session_id, string Class_id, string Branch_id, string Term_id, string Subject_group)
        {
            ...
            {
                string subject_name = up_to_vi_to_viii.get_subject_name(Subject_id, Class_id, Branch_id);
                foreach (DataRow dr in dt.Rows)
                {
                    if (Subject_group == "2")
                    {
        ...
        [WebMethod]
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        public void fetch_rp_card_grade_remark(string Session_id, string Class_id, string Admission_no, string Branch_id, string Term_id)
        {
        ...
        public void fetch_rp_card_signature(string Session_id, string Class_id, string Admission_no, string Branch_id)
        {
            ...
            {
                string Section = up_to_vi_to_viii.get_student_section(Session_id, Admission_no, Branch_id, Class_id);
                foreach (DataRow dr in dt.Rows)
                {
                    string stgnature = "";
                    if (dr["Signature_type"].ToString() == "1")
                    {
                        stgnature = up_to_vi_to_viii.get_class_teacher_signature(Session_id, Class_id, Section, Branch_id);
                    }
                    if (dr["Signature_type"].ToString() == "2")
                    {
                        stgnature = up_to_vi_to_viii.get_principal_signature(Session_id, Branch_id);
                    }
                    if (dr["Signature_type"].ToString() == "3")
                    {
                        stgnature = up_to_vi_to_viii.get_examinee_or_parent_signature(Session_id, Branch_id, dr["Signature_type_e_p"].ToString());
                    }
        ...
        {
            string section = up_to_vi_to_viii.get_section(Session_id, Class_id, Admission_no, Branch_id);
            ...
            {
                string system_grade_id = up_to_vi_to_viii.get_system_grade_id_final(Session_id, Branch_id, Class_id);
                foreach (DataRow dr in dt.Rows)
                {
                    string rank = "0";
                    if (dr["Rank"].ToString() == "1")
                    ...
                    string grade = up_to_vi_to_viii.get_grade_final(Session_id, Branch_id, system_grade_id, My.toDouble(dr["Mark_percentage"].ToString()));
        ...
        {
            string Total_marks = up_to_vi_to_viii.get_overall_total_marks(Session_id, Class_id, Admission_no, Branch_id, Term_id);
            string[] stringSeparatorss = new string[] { "/" };
            string[] arrs = Total_marks.Split(stringSeparatorss, StringSplitOptions.None);
            ...
            string percent_remark = up_to_vi_to_viii.get_percent_remark(overall_percent);
