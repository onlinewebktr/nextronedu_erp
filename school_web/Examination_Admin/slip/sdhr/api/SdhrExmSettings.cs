...
{
    public class SdhrExmSettings
    {
        internal static string get_exam_settings(string session_id, string branch_id, string class_id)
        {
            string returN = "hidden/hidden/hidden/hidden/hidden/160px/hidden/hidden/hidden/show/hidden/hidden/hidden/hidden/1250px/sameLine/2px/2px/2px/2px/2px/2px/2px/hidden";
