<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bulk-report-card-ix-to-x.aspx.cs" Inherits="school_web.Examination_Admin.slip.sdhr.bulk_report_card_ix_to_x" %>
    ...
    <form id="form1" runat="server">
        ...
        <script type="text/javascript">
            ...
            app.controller('RpCardAppCtrl', function ($scope, $http) {
                ...
                messge("Please Wait...");
                $("#intsLoader").removeClass("hidden");
                $http.get("api/bulk-report-card-ix-to-x.asmx/fetch_rp_card_bulks", { params: { "Session_id": session_id, "Class_id": class_id, "Section": section, "Branch_id": branch_id, "Term_id": term_id, "Admission_no": admission_no } }).then(function (response) {
