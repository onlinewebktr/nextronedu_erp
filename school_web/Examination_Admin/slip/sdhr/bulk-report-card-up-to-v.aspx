<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bulk-report-card-up-to-v.aspx.cs" Inherits="school_web.Examination_Admin.slip.sdhr.bulk_report_card_up_to_v" %>
    ...
    <form id="form1" runat="server">
                        ...
                        <div class="report-card-wpr" style="height: {{x.MySubjectMarkShowItemII[0].Height_dv}}">
                            <div class="report-card-head {{x.MySubjectMarkShowItemII[0].Hdr_frst}}">
                                ...
                                <div class="report-card-cntr-dv">
                                    ...
                                    <asp:Label ID="lbl_contact_no" runat="server" Text="{{x.MyFirmDetailData[0].Firm_contact_no}}" class="report-card-schl-cont contcthlf v-false {{x.MySubjectMarkShowItemII[0].Is_contact_no_show}}"></asp:Label>
                                    <p class="report-card-schl-emil emailshlf v-false {{x.MySubjectMarkShowItemII[0].Is_email_show}}">
                                        Email : 
                                    ...
                                    <h2 class="report-card-rprt-crd">REPORT CARD <span class="{{x.MySubjectMarkShowItemII[0].Class_in_new_line}}"><span class="v-false {{x.MySubjectMarkShowItemII[0].Is_class_text_show}}">CLASS</span> {{x.For_class}}</span></h2>
                                </div>
                                <%--<asp:Label ID="lbl_aff_no" class="report-card-schl-affno" Text="{{x.MySubjectMarkShowItemII[0].Aff_text}} : {{x.MyFirmDetailData[0].Frim_aff_no}}" runat="server"></asp:Label>--%>
                                <div class="report-card-rght-dv">
                                    <img src="{{x.MyFirmDetailData[0].Extra_logo}}" class="class_extra_logo" />
                            ...
                            <div class="subs-mrks-area-dv">
                                <table>
                                    <tr>
                                        ...
                                        <th class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}" colspan="8">SCHOLASTIC AREAS ({{x.Term_name}} )</th>
                                    </tr>
                                    <tr>
                                ...
                                <div class="subs-mrks-area-b-dv" style="margin-top: {{x.MySubjectMarkShowItemII[0].Co_sch_area_margn}}">
                                    <table>
                                        ...
                                        <tr data-ng-repeat="item in x.MyDescplineData track by $index">
                                            ...
                                            <td colspan="3">{{item.Activity_name}}</td>
                                ...
                                <div class="instruction-50 instruction-50-pr">
                                    <div class="instruction-tbls" style="margin-top: {{x.MySubjectMarkShowItemII[0].Ins1_area_margn}}">
                                        <table>
                                            ...
                                            <tr>
                                                <td colspan="2" class="txt-center">(Scholastic Areas {{x.MyMarkRangeData[0].RowCount}}-point grading scale)</td>
                                            </tr>
                                            <tr>
                                                <td>MARKS RANGE</td>
                                                <td>GRADE</td>
                            ...
                            <div class="sig-dv v-false {{x.MySubjectMarkShowItemII[0].Sign_bottom}}">
                                ...
                                <div class="sig-left">
                                    ...
                                    <p class="sig-ps">Guardian's signature</p>
                                </div>

                                <div class="sig-left">
                                    <div class="rght-sig-img-dv">
                                        <img src="images/sign-headmistress.png" class="rght-sig-img" style="height: 70px;" />
                                        <%--<img src="{{x.MySignatureDetailData[2].Signature_image}}" class="rght-sig-img {{x.MySignatureDetailData[2].Signature_image}}" />--%>
                                    </div>
                                    <p class="sig-ps">Headmistress'</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <script type="text/javascript">
            ...
            app.controller('RpCardAppCtrl', function ($scope, $http) {
                ...
                messge("Please Wait...");
                $("#intsLoader").removeClass("hidden");
                $http.get("api/bulk-report-card-up-to-v.asmx/fetch_rp_card_bulks", { params: { "Session_id": session_id, "Class_id": class_id, "Section": section, "Branch_id": branch_id, "Term_id": term_id, "Admission_no": admission_no } }).then(function (response) {
