<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bulk-report-card-vi-to-viii.aspx.cs" Inherits="school_web.Examination_Admin.slip.sdhr.bulk_report_card_vi_to_viii" %>
    ...
    <form id="form1" runat="server">
                            ...
                            <div class="subs-mrks-area-dv">
                                <table>
                                    ...
                                    <tr data-ng-repeat="item in x.MySubjectMarkShowItemII track by $index">
                                        ...
                                        <td class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}" data-ng-repeat="itemx in item.MySubjectMarkItemIII track by $index" colspan="{{itemx.colSpan}}">{{itemx.AssesmtName}}<span class="{{itemx.BRhideN}}">
                                            <br />
                                        </span>{{itemx.Marks}}</td>
                                        <td class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}"><span class="{{item.CstmSUbj}}">Marks Obtained
                                            <br />
                                            ({{item.Full_marks}}) 
                                        </span>{{item.Total_marks}}</td>
                            ...
                            <div class="sig-dv v-false {{x.MySubjectMarkShowItemII[0].Sign_bottom}}">
                                ...
                                <div class="sig-left">
                                    <div class="rght-sig-img-dv">
                                        <img src="images/sign-principal.png" class="rght-sig-img" style="height: 55px;" />
        ...
        <script type="text/javascript">
            ...
            app.controller('RpCardAppCtrl', function ($scope, $http) {
                ...
                messge("Please Wait...");
                $("#intsLoader").removeClass("hidden");
                $http.get("api/bulk-report-card-vi-to-viii.asmx/fetch_rp_card_bulks", { params: { "Session_id": session_id, "Class_id": class_id, "Section": section, "Branch_id": branch_id, "Term_id": term_id, "Admission_no": admission_no } }).then(function (response) {
