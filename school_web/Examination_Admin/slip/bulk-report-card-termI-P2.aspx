<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bulk-report-card-termI-P2.aspx.cs" Inherits="school_web.Examination_Admin.slip.bulk_report_card_termI_P2" %>
    ...
    <form id="form1" runat="server">
                                ...
                                <div class="subs-mrks-area-dv">
                                    <table>
                                        <tr>
                                            ...
                                            <th class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}" colspan="2">SCHOLASTIC AREAS</th>
        ...
        <script type="text/javascript">
            ...
            app.controller('RpCardAppCtrl', function ($scope, $http) {
                ...
                $http.get("webService/bulk-report-card-termI-P2.asmx/fetch_rp_card_bulks", { params: { "Session_id": session_id, "Class_id": class_id, "Section": section, "Branch_id": branch_id, "Term_id": term_id } }).then(function (response) {
