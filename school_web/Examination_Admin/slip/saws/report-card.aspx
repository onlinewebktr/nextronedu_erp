<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="report-card.aspx.cs" Inherits="school_web.Examination_Admin.slip.saws.report_card" %>
                        ...
                        <div class="invoice-wpr">
                            ...
                            <div class="report-card-wpr" style="height: {{x.MySubjectMarkShowItemII[0].Height_dv}}">
                                ...
                                <div class="report-card-std-info-dv">
                                    ...
                                    <div class="report-card-std-img-dv" style="display: none">
                                ...
                                <div class="subs-mrks-area-lft-dv">
                                    ...
                                    <%--<div class="rankss-rp">
                                        <p>RANK :<span>{{x.MyRank}}<i>{{x.Ranksup}}</i></span></p>
                                    </div>--%>
