<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="report-card-term-I-P2.aspx.cs" Inherits="school_web.Examination_Admin.slip.vvc.report_card_term_I_P2" %>
                    ...
                    <div class="invoice-wpr">
                        ...
                        <div class="report-card-wpr" style="height: {{reportCardSubS[0].Height_dv}}">
                            <div class="report-card-head">
                                ...
                                <div class="report-card-rght-dv" style="overflow: inherit;">
                                    <asp:Label ID="lbl_aff_no" Visible="false" class="report-card-schl-affno" runat="server" Style="width: 110%;"></asp:Label>
                            ...
                            <div class="subs-mrks-area-dv">
                                <table>
                                    <tr>
                                        ...
                                        <th class="{{reportCardSubS[0].Is_text_center}}">SCHOLASTIC AREAS</th>
