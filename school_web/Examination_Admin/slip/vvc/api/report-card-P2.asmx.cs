...
namespace school_web.Examination_Admin.slip.vvc.api
{
    ...
    public class report_card_P2 : System.Web.Services.WebService
    {
        ...
        public void fetch_rp_card_subjects(string Session_id, string Class_id, string Admission_no, string Branch_id, string Term_id)
        {
            ...
            {
                My.exeSql("delete from Exam_temp_assesment_total_no where Session_id='" + Session_id + "' and Class_id='" + Class_id + "' and Branch_Id='" + Branch_id + "' and Term_id='" + Term_id + "' and Admission_no='" + Admission_no + "'; delete from Exam_temp_assesment_total_no_term_II where Session_id='" + Session_id + "' and Class_id='" + Class_id + "' and Branch_Id='" + Branch_id + "' and Term_id='" + Term_id + "' and Admission_no='" + Admission_no + "'; delete from Exam_rp_bulk_print_adm where Session_id='" + Session_id + "' and Admission_no='" + Admission_no + "';INSERT INTO Exam_rp_bulk_print_adm (Session_id,Admission_no,Class_id,Section) values ('" + Session_id + "','" + Admission_no + "','" + Class_id + "','" + dt.Rows[0]["Section"].ToString() + "')");
                foreach (DataRow dr in dt.Rows)
                {
        ...
        public void fetch_rp_card_signature(string Session_id, string Class_id, string Admission_no, string Branch_id)
        {
            ...
            {
                string Section = vvc_examination_P2.get_student_section(Session_id, Admission_no, Branch_id, Class_id);
                foreach (DataRow dr in dt.Rows)
                {
                    string stgnature = "";
        ...
        {
            string section = vvc_examination_P2.get_section(Session_id, Class_id, Admission_no, Branch_id);
