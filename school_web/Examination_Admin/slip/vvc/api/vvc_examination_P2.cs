...
{
    public class vvc_examination_P2
    {
        My mycode = new My();
        ...
        internal static string get_subject_total_marks(string session_id, string class_id, string admission_no, string term_id, string subject_id, string branch_id, string Type)
        {
            ...
            if (Type == "Scholastic")
            {
                if (Output == "Marks")
                {
                    ...
                    string grade = get_grade_if_50(session_id, branch_id, Grade_System_Id, final_marks, full_number);   // Grade of a subject
                    ...
                    string exam_settings = vvc_exam_setting.get_exam_settings(session_id, branch_id, class_id);  // Is SpecialNote & QR Show
