<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="assesment-wise-rp.aspx.cs" Inherits="school_web.Examination_Admin.slip.manidweep.assesment_wise_rp" %>
    ...
    <form id="form1" runat="server">
        ...
        <script type="text/javascript">
            ...
            app.controller('RpCardAppCtrl', function ($scope, $http) {
                ...
                $http.get("api/assesment-wise-rp.asmx/fetch_rp_card_bulks", { params: { "Session_id": session_id, "Class_id": class_id, "Section": section, "Branch_id": branch_id, "Term_id": term_id, "Adm_no": adm_no, "Assesment_id": assesment_id } }).then(function (response) {
