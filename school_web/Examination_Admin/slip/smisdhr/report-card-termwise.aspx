<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="report-card-termwise.aspx.cs" Inherits="school_web.Examination_Admin.slip.smisdhr.report_card_termwise" %>
                    ...
                    <div class="invoice-wpr">
                        ...
                        <div class="report-card-wpr" style="height: {{reportCardSubS[0].Height_dv}}">
                            ...
                            <div class="report-card-std-info-dv">
                                <div class="report-card-std-info-dv-50">
                                    ...
                                    <p class="stds-info-p">
                                        ...
                                        <asp:Label ID="lbl_height" runat="server" Text="TOFAIL SK."></asp:Label>
                                    </p>
                                </div>
                                ...
                                <div class="report-card-std-info-dv-50">
                                    ...
                                    <p class="stds-info-p">
                                        ...
                                        <asp:Label ID="lbl_age" runat="server" Text="25"></asp:Label>
                                    </p>

                                    <p class="stds-info-p">
                                        <i class="stds-info-p-i">WEIGHT</i>  <i class="stds-info-p-doti">:</i>
                                        <asp:Label ID="lbl_weight" runat="server" Text="TOFAIL SK."></asp:Label>
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="subs-mrks-area-dv">
                                <table>
                                    <tr>
                                        <th colspan="18" class="{{reportCardSubS[0].Is_text_center}} bgcolors">GRADES</th>
                                    </tr>
                                    <tr>
                                ...
                                <div class="subs-mrks-area-b-dv" style="margin-top: {{reportCardSubS[0].Co_sch_area_margn}}">
                                    <table>
                                        ...
                                        <tr data-ng-repeat="x in reportCardDesciplineActivitY">
                                            <td style="width: 50%;"><span class="actbld">{{x.Activity_name}}</span>
                                                <br />
                                                <span class="actnrml">({{x.Activity_details}})</span></td>
                                            <td>{{x.Term_grade}}</td>
                                        </tr>
                                    </table>
                                </div>
                            ...
                            <div class="instruction-dv">
                                ...
                                <div class="instruction-50 instruction-50-pl">
                                    <div class="instruction-tbls floatrght">
                                        <div style="margin-top: {{reportCardSubS[0].Ins2_area_margn}}">
                                            <table>
                                                <tr>
