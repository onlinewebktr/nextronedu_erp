<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="report-P2-II.aspx.cs" Inherits="school_web.Examination_Admin.slip.report_P2_II" %>
    ...
    <form id="form1" runat="server">
                            ...
                            <div class="subs-mrks-area-dv">
                                <table>
                                    <tr>
                                        ...
                                        <th class="txtcenter" colspan="2">SCHOLASTIC AREAS</th>
                                        <th data-ng-repeat="x in reportCardAssesment" colspan="{{x.Sub_level_count}}" class="txtcenter">{{x.Assessment_Name}}</th>
                                        <th colspan="2" class="txtcenter"></th>
                                    </tr>
                                    <tr>
                                        <th class="txtcenter" rowspan="3">SN</th>
                                        <th class="txtcenter" rowspan="3">SUBJECT CODE</th>
                                        <th class="txtcenter" rowspan="3">SUBJECTS</th>
                                        <th class="txtcenter" data-ng-repeat="x in reportCardSubLevel">{{x.Subject_Activity_Name}}</th>
                                        <th class="txtcenter">WEIGHTAGE <%--{{reportCardSubS[0].grade_head_text}} ({{reportCardAssesment[0].Term_Maximum_Marks}})--%></th>
                                        <th class="txtcenter {{reportCardSubS[0].Grade}}" rowspan="3">GRADE</th>
                                    </tr>
                                    <tr>
                                        <th class="txtcenter" data-ng-repeat="x in reportCardabcD">{{x.Alphabate}}</th>
                                    </tr>
                                    <tr>
                                        <th class="txtcenter" data-ng-repeat="x in reportCardMaxMarkSubLevel">{{x.MaxMark}}</th>
                                        <th class="txtcenter">100</th>
                                    </tr>
                                    <tr data-ng-repeat="x in reportCardSubS track by $index">
                                        ...
                                        <td class="txtcenter {{x.Grade}}">{{x.Grade}}</td>
                                    </tr>
                                </table>
                            </div>
        ...
        <script type="text/javascript">
            ...
            app.controller('RpCardAppCtrl', function ($scope, $http) {
                ...
                $http.get("webService/report-P2-II.asmx/fetch_report_card_assesment", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id, "Term_id": term_id } }).then(function (response) {
                    $scope.reportCardAssesment = response.data;
                })

                $http.get("webService/report-P2-II.asmx/fetch_report_card_sub_level", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id, "Term_id": term_id } }).then(function (response) {
                    $scope.reportCardSubLevel = response.data;
                })

                $http.get("webService/report-P2-II.asmx/fetch_report_card_max_mark_sub_level", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id, "Term_id": term_id } }).then(function (response) {
                    $scope.reportCardMaxMarkSubLevel = response.data;
                })
                $http.get("webService/report-P2-II.asmx/fetch_report_card_abcd", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id, "Term_id": term_id } }).then(function (response) {
                    $scope.reportCardabcD = response.data;
                })


                $http.get("webService/report-P2-II.asmx/fetch_rp_card_subjects", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id, "Term_id": term_id } }).then(function (response) {
                    ...
                    if ($scope.reportCardSubS == "") {
                        ...
                        ////========================GRAPH
                        $http.get("webService/report-P2-II.asmx/fetch_rp_card_graph", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id, "Term_id": term_id } }).then(function (response) {
                            $scope.reportGraphs = response.data;
                        })


                        ////========================OverAll No.
                        $http.get("webService/report-P2-II.asmx/fetch_rp_card_total_no", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id, "Term_id": term_id } }).then(function (response) {
                ...
                $http.get("webService/report-P2-II.asmx/fetch_rp_card_marks_range", { params: { "Session_id": session_id, "Branch_id": branch_id, "Term_id": term_id } }).then(function (response) {
                    $scope.reportCardmarkRange = response.data;
                })


                ////========================Get Scholastic Data
                $http.get("webService/report-P2-II.asmx/fetch_report_card_coscholastic", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id, "Term_id": term_id } }).then(function (response) {
                    $scope.reportCardCoScholastic = response.data;
                })


                ////========================Get Discipline Data
                $http.get("webService/report-P2-II.asmx/fetch_report_card_discipline_activity", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id, "Term_id": term_id } }).then(function (response) {
                    $scope.reportCardDesciplineActivitY = response.data;
                })



                $http.get("webService/report-P2-II.asmx/fetch_rp_card_grade_remark").then(function (response) {
                    $scope.reportCardgeadeRemark = response.data;
                })

                $http.get("webService/report-P2-II.asmx/fetch_rp_card_signature", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id } }).then(function (response) {
                    $scope.reportSig = response.data;
                })


                ////========================Rank
                $http.get("webService/report-P2-II.asmx/fetch_rp_card_rank", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id, "Term_id": term_id } }).then(function (response) {
