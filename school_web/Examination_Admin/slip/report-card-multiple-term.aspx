<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="report-card-multiple-term.aspx.cs" Inherits="school_web.Examination_Admin.slip.report_card_multiple_term" %>
    ...
    <form id="form1" runat="server">
                            ...
                            <div class="report-card-head {{reportCardSubS[0].Hdr_frst}}">
                                ...
                                <div class="report-card-cntr-dv">
                                    ...
                                    <h2 class="report-card-rprt-crd">
                                        <asp:Label ID="lbl_for_term" runat="server" Style="display: none"></asp:Label>
                            ...
                            <div class="subs-mrks-area-dv">
                                <table>
                                    <tr>
                                        ...
                                        <th colspan="2" class="{{reportCardSubS[0].Is_text_center}}">SCHOLASTIC AREAS</th>

                                        <th colspan="2" class="{{reportCardSubS[0].Is_text_center}}" data-ng-repeat="x in reportCard">{{x.Short_Name}}  <span class="{{reportCardSubS[0].Max_mark_show}}">({{x.Maximum_Marks}})</span></th>
                                        <th rowspan="2" class="{{reportCardSubS[0].Is_text_center}}">{{reportCardSubS[0].grade_head_text}} ({{reportCard[0].Term_Maximum_Marks}})</th>
                                        <th rowspan="2" class="{{reportCardSubS[0].Is_text_center}} {{reportCardSubS[0].Grade}}">GRADE</th>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <th class="{{reportCardSubS[0].Is_text_center}}">SUBJECTS</th>
                                        <th class="{{reportCardSubS[0].Is_text_center}}" data-ng-repeat="x in reportCardAssesmenT">{{x.Subject_Activity_Name}}  <%--<span class="{{reportCardSubS[0].Max_mark_show}}">({{x.Maximum_Marks}})</span>--%></th>
        ...
        <script type="text/javascript">
            ...
            app.controller('RpCardAppCtrl', function ($scope, $http) {
                ...
                $http.get("webService/multiple-terms.asmx/fetch_report_card", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id, "Term_id": term_id } }).then(function (response) {
                    $scope.reportCard = response.data;
                })

                $http.get("webService/multiple-terms.asmx/fetch_report_card_assesment", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id, "Term_id": term_id } }).then(function (response) {
                    $scope.reportCardAssesmenT = response.data;
                })


                $http.get("webService/multiple-terms.asmx/fetch_rp_card_subjects", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id, "Term_id": term_id } }).then(function (response) {
                    ...
                    if ($scope.reportCardSubS == "") {
                        ...
                        ////========================GRAPH
                        $http.get("webService/multiple-terms.asmx/fetch_rp_card_graph", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id, "Term_id": term_id } }).then(function (response) {
                            $scope.reportGraphs = response.data;
                        })


                        ////========================OverAll No.
                        $http.get("webService/multiple-terms.asmx/fetch_rp_card_total_no", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id, "Term_id": term_id } }).then(function (response) {
                ...
                $http.get("webService/multiple-terms.asmx/fetch_rp_card_marks_range", { params: { "Session_id": session_id, "Branch_id": branch_id, "Term_id": term_id } }).then(function (response) {
                    $scope.reportCardmarkRange = response.data;
                })


                ////========================Get Scholastic Data
                $http.get("webService/multiple-terms.asmx/fetch_report_card_coscholastic", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id, "Term_id": term_id } }).then(function (response) {
                    $scope.reportCardCoScholastic = response.data;
                })


                ////========================Get Discipline Data
                $http.get("webService/multiple-terms.asmx/fetch_report_card_discipline_activity", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id, "Term_id": term_id } }).then(function (response) {
                    $scope.reportCardDesciplineActivitY = response.data;
                })



                $http.get("webService/multiple-terms.asmx/fetch_rp_card_grade_remark", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id, "Term_id": term_id } }).then(function (response) {
                    $scope.reportCardgeadeRemark = response.data;
                })

                $http.get("webService/multiple-terms.asmx/fetch_rp_card_signature", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id } }).then(function (response) {
                    $scope.reportSig = response.data;
                })


                ////========================Rank
                $http.get("webService/multiple-terms.asmx/fetch_rp_card_rank", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id, "Term_id": term_id } }).then(function (response) {
