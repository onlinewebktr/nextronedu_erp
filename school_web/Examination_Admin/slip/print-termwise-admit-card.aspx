<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="print-termwise-admit-card.aspx.cs" Inherits="school_web.Examination_Admin.slip.print_termwise_admit_card" %>
    ...
    <form id="form1" runat="server">
                ...
                <div class="invoice-inr-sec" data-ng-repeat="x in reportAdmitS track by $index">
                    <div class="printheadse333">
                        <div class="invoice-wpr">
                            <div class="printpage-sec-main" style="height: 1230px">
                                ...
                                <div class="acardd">
                                    <asp:Label ID="Label2" CssClass="admitcarterm1" runat="server" Text="Admit Card <br> {{x.Exam_name}} - {{x.MySchoolDetailsItem[0].session_name}}"></asp:Label>
                                </div>
                                ...
                                <div class="nammarggg">
                                    <div class="stdinfodv">
                                        <div class="stdinfodv1sts">
                                            ...
                                            <div class="namehead {{x.IsadmitcardNoShow}}">
                                                ...
                                                <asp:Label ID="Label5" runat="server" CssClass="nameheadll" Text="{{x.Admitcard_no}}"></asp:Label>
                                            </div>
                                            <%--<div class="namehead">
                                            <p class="nameheadp">MOBILE NO. [FATHER] <span class="spdottt">:</span></p>
                                            <asp:Label ID="lbl_mother_name" runat="server" CssClass="nameheadll" Text="{{x.Father_mob}}"></asp:Label>
                                        </div>--%>
                                            <%--<div class="namehead" style="display: none">
                                            <p class="nameheadp">MOBILE NO.  [MOTHER] <span class="spdottt">:</span></p>
                                            <asp:Label ID="Label5" runat="server" CssClass="nameheadll" Text="{{x.Mother_mobile}}"></asp:Label>
                                        </div>--%>
                                        </div>
                                        ...
                                        <div class="stdinfodv2sec">
                                            ...
                                            <div class="namehead">
                                                ...
                                                <asp:Label ID="Label4" runat="server" CssClass="nameheadll" Style="padding: 0px 10px 0px 10px;" Text="{{x.Section_Name}}"></asp:Label>
                                            </div>
                                            <div class="namehead">
                                            ...
                                            <asp:Label ID="Label4" runat="server" CssClass="nameheadll" Text="{{x.House_name}}"></asp:Label>
                                        </div>--%>
                                            <%--<div class="namehead" style="display: none">
                                            <p class="nameheadp">MOBILE [SELF] <span class="spdottt">:</span></p>
                                            <asp:Label ID="Label2" runat="server" CssClass="nameheadll" Text="{{x.Student_mob_no}}"></asp:Label>
                                        </div>--%>
                                            <%--<div class="namehead">
                                    ...
                                    <div class="studimggr">
                                        <asp:Image ID="Image1" runat="server" ImageUrl="{{x.Student_img}}" class="studimggrt {{x.Student_img}}" />
                                ...
                                <div class="administration-paragraph ">
                                    <table class="{{x.MySchoolDetailsItem[0].Programe}}">
                                        ...
                                        <tr>
                                            ...
                                            <th>DAY</th>
                                            <th>Subject</th>
                                            <th style="width: 190px;">Sign. of the invigilator</th>
                                        </tr>
                                        <tr data-ng-repeat="item in x.MyRoutineDetailsItem track by $index">
                                            <td>{{$index+1}}</td>
                                            <td>{{item.Exam_date}}</td>
                                            <td class="nobreak">{{item.Exam_time}}</td>
                                            <td>{{item.Day}}</td>
        ...
        <asp:Panel ID="pnl_dues" runat="server" Visible="false">
            <div class="duesmsg-dv">
                <div class="duesmsg-dv-inrs">
                    ...
                    <p class="duesmsg-p">Please reach out to the school.</p>
                </div>
            </div>
        </asp:Panel>
        ...
        <script type="text/javascript">
            ...
            app.controller('RpCardAppCtrl', function ($scope, $http) {
                ...
                $http.get("webService/admit-card.asmx/fetch_admit_cards", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id, "Term_id": term_id, "Section": section, "Session_name": session_name, "Exam_id": exam_id, "CheckedStd": checkedStd, "UserType": UserType, "PageNo": PageNo } }).then(function (response) {
