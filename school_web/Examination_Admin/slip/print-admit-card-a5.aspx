<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="print-admit-card-a5.aspx.cs" Inherits="school_web.Examination_Admin.slip.print_admit_card_a5" %>
...
<head runat="server">
    ...
    <link href="assets/css/admitCardA5.css" rel="stylesheet" />
    ...
    <script type="text/javascript">
        function PrintPanel() {
            ...
            printWindow.document.write('<link href="assets/css/admitCardA5.css" rel="stylesheet" type="text/css" />');
                        ...
                        <div class="printheadse333">
                            <div class="invoice-wpr {{x.WhatDivTB}}">
                                <div class="printpage-sec-main {{x.OneAdmitCardHeight}}">
                                    ...
                                    <div class="acardd">
                                        <asp:Label ID="lbl_termname" CssClass="admitcarterm1" runat="server" Text="Admit Card <br> {{x.Exam_name}} - {{x.MySchoolDetailsItem[0].session_name}}"></asp:Label>
                                    </div>
                                    ...
                                    <div class="administration-paragraph">
                                        <table class="{{x.MySchoolDetailsItem[0].Programe}}">
                                            ...
                                            <tr data-ng-repeat="item in x.MyRoutineDetailsItem track by $index">
                                                <td>{{$index+1}}</td>
                                                <td class="nobreak">{{item.Exam_date}}</td>
