<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="report-card-term-I-P2.aspx.cs" Inherits="school_web.Examination_Admin.slip.bda.report_card_term_I_P2" %>
                    ...
                    <div class="invoice-wpr">
                        ...
                        <div class="report-card-wpr" style="height: {{reportCardSubS[0].Height_dv}}">
                            <div class="report-card-head">
                                ...
                                <asp:Label ID="lbl_aff_no" class="report-card-schl-affno" runat="server" Style="width: 110%;"></asp:Label>
                            ...
                            <div class="subs-mrks-area-dv">
                                <table>
                                    <tr>
                                        ...
                                        <th colspan="2" class="{{reportCardSubS[0].Is_text_center}}">Total</th> 
                                    </tr>
                                    <tr>
