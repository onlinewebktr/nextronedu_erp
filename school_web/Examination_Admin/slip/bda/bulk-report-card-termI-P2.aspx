<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bulk-report-card-termI-P2.aspx.cs" Inherits="school_web.Examination_Admin.slip.bda.bulk_report_card_termI_P2" %>
                            ...
                            <div class="report-card-wpr" style="height: {{x.MySubjectMarkShowItemII[0].Height_dv}}">
                                <div class="report-card-head">
                                    ...
                                    <div class="report-card-cntr-dv">
                                     ...
                                     <asp:Label ID="lbl_aff_no" class="report-card-schl-affno {{x.MyFirmDetailData[0].Frim_aff_no}}" runat="server" Text="{{x.MyFirmDetailData[0].Frim_aff_no}}" Style="width: 110%;"></asp:Label>
