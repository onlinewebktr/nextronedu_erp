...
using school_web.Examination_Admin.slip.bda.api;
using System;
...
namespace school_web.Examination_Admin.slip.bda
{
    public partial class report_card_term_I_P2 : System.Web.UI.Page
    {
        My mycode = new My();
        ...
        private void bind_student_info()
        {
            ...
            if (dt.Rows.Count != 0)
            {
                ...
                string term_name = bda_examination.get_term_name(hd_branch_id.Value, hd_term_id.Value);
        ...
        {
            string returN = "0";
            string query = "select Is_show_rank from Exam_report_card_setting where  Session_Id=" + ViewState["sessionid"].ToString() + " and Branch_Id='" + hd_branch_id.Value + "'";
        ...
        private void Bind_schoolinfo()
        {
            ...
            else
            {
                ...
                {
                    lbl_aff_no.Text = " AFF. No. : " + dt.Rows[0]["Affiliation"].ToString();
                }
