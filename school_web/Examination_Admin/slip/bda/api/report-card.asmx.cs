...
namespace school_web.Examination_Admin.slip.bda.api
{
    ...
    public class report_card : System.Web.Services.WebService
    {
        ...
        public void fetch_rp_card_signature(string Session_id, string Class_id, string Admission_no, string Branch_id)
        {
            ...
            {
                string Section = bda_examination.get_student_section(Session_id, Admission_no, Branch_id, Class_id);
                foreach (DataRow dr in dt.Rows)
                {
                    string stgnature = "";
        ...
        {
            string section = bda_examination.get_section(Session_id, Class_id, Admission_no, Branch_id);
