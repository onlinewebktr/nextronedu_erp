<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bulk-report-card-termI.aspx.cs" Inherits="school_web.Examination_Admin.slip.bulk_report_card_termI" %>
    ...
    <form id="form1" runat="server">
        ...
        <script type="text/javascript">
            ...
            app.controller('RpCardAppCtrl', function ($scope, $http) {
                ...
                $http.get("webService/bulk-report-card.asmx/fetch_rp_card_bulks", { params: { "Session_id": session_id, "Class_id": class_id, "Section": section, "Branch_id": branch_id, "Term_id": term_id } }).then(function (response) {
