<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="report-card-lower.aspx.cs" Inherits="school_web.Examination_Admin.slip.res.report_card_lower" %>
                                ...
                                <div class="subs-mrks-area-dv">
                                    ...
                                    <div class="ovrll-sec">
                                        ...
                                        <div class="ovrll-ttl-marks-dv" style="margin: 0px 0px 0px 0px; float: right;">
                                            <p class="ovrll-ttl-marks-cnt-p" style="border-right: 1px solid #cdc000;">Grade </p>

                                       <p class="ovrll-ttl-marks-num-p {{x.MyOverallNoDetailData[0].IfbgColorR}}" style="border-left: 0px solid #cdc000;"><span class="{{x.MyOverallNoDetailData[0].Grade_bg_class}}" style="{{x.MyOverallNoDetailData[0].GradeBG}}">{{x.MyOverallNoDetailData[0].Grade}}</span></p>
                                            </div>
                                    </div>
