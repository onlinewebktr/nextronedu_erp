<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="report-card.aspx.cs" Inherits="school_web.Examination_Admin.slip.res.report_card" %>
                            ...
                            <div class="report-card-wpr" style="height: {{x.MySubjectMarkShowItemII[0].Height_dv}}">
                                    ...
                                    <table>
                                       <%-- <tr>
                                        ...
                                        <tr>
                                            ...
                                            <th>SUBJECTS</th>
                                            <th class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}">FULL MARKS</th>
                                            <th class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}">PASS MARKS</th>
                                            ...
                                            <th class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}">MARKS OBTAINED<%--{{x.MySubjectMarkShowItemII[0].grade_head_text}}--%> <%--({{x.MySubjectMarkShowItemII[0].SubjFulmarks}})--%></th>
                                        ...
                                        <tr data-ng-repeat="item in x.MySubjectMarkShowItemII track by $index">
                                            ...
                                            <td class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}">100</td>
                                            <td class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}">30</td>
                                ...
                                <div class="subs-mrks-area-lft-dv">
                                    ...
                                    <div class="remarks-rp">
                                        <p style="min-height: 106px;">Class Teacher REMARKS :<span class="{{x.MySubjectMarkShowItemII[0].Remarkss}}">{{x.MySubjectMarkShowItemII[0].Remarkss}}</span></p>
                                    </div>
                                    <div class="remarks-rp">
                                        <p>Promoted to class : <span class="{{x.Promoted_to_class}}">{{x.Promoted_to_class}}</span></p>
                                    </div>
                                    <div class="remarks-rp">
                                        <p>Date : <span class="{{x.Result_date}}">{{x.Result_date}}</span></p>
                                    </div>
                                    <div class="remarks-rp">
                                        <p>Place : <span>Azamnagar, Katihar</span></p>
                                    </div>
                                ...
                                <div class="grding-scale-dv-sec">
                                    ...
                                    <table>
                                        <tr>
                                            <td>Grade</td>
                                            <td data-ng-repeat="item in x.MyMarkRangeData track by $index">{{item.Grade}}</td>
                                        </tr>
                                        <tr>
                                            <td>%Range</td>
                                            <td data-ng-repeat="item in x.MyMarkRangeData track by $index">{{item.Lower_Range}}-{{item.Upper_Range}}</td>
                                        </tr>
                                    </table>
