<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="print-admit-card-internal-exam.aspx.cs" Inherits="school_web.Examination_Admin.slip.print_admit_card_internal_exam" %>
...
<head runat="server">
    ...
    <link href="assets/css/internalAdmitCard.css" rel="stylesheet" />
    ...
    <script type="text/javascript">
        function PrintPanel() {
            ...
            printWindow.document.write('<link href="assets/css/internalAdmitCard.css" rel="stylesheet" type="text/css" />');
    ...
    <form id="form1" runat="server">
                ...
                <div class="printpagewprs">
                    <div class="invoice-inr-sec" data-ng-repeat="x in reportAdmitS track by $index">
                        <div class="printheadse333">
                            <div class="invoice-wpr {{x.WhatDiv}}">
                                <div class="printpage-sec-main">
                                    <div class="headdivv {{x.MySchoolDetailsItem[0].Content_header}}">
                                        ...
                                        <div class="schoolnameheadin">
                                            ...
                                            <asp:Label ID="lbl_under" CssClass="informatchild22-pp33" runat="server" Text="(Affiliated to CBSE, New Delhi upto 10+2)"></asp:Label>
                                    ...
                                    <div class="acardd">
                                        <asp:Label ID="lbl_termname" CssClass="admitcarterm1" runat="server" Text="{{x.Exam_name}}"></asp:Label>
                                        <p class="admitcarterm1sss">Admit Card</p>
                                    </div>
                                    ...
                                    <div class="administration-paragraph">
                                        <table>
                                            <tr>
                                                <th colspan="8" style="text-align: center;">EXAMINATION TIME</th>
                                            </tr>
                                            <tr>
                                                <th>DATE</th>
                                                <th>DAY</th>
                                                <th class="{{x.IsarrTimeShow}}">ARRIVAL TIME</th>
                                                <th>EXAM TIME</th>
                                            </tr>
                                            <tr>
                                                <td class="nobreak">{{x.Exam_date}}</td>
                                                <td class="nobreak">{{x.Exam_day}}</td>
                                                <td class="nobreak {{x.IsarrTimeShow}}">{{x.Arrival_time}}</td>
                                                <td class="nobreak">{{x.Exam_start_time}} to {{x.Exam_end_time}}</td>
        ...
        <script type="text/javascript">
            ...
            app.controller('RpCardAppCtrl', function ($scope, $http) {
                ...
                $http.get("webService/internal-admit-card.asmx/fetch_admit_cards", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Section": section, "Session_name": session_name, "Exam_id": exam_id, "CheckedStd": checkedStd, "UserType": UserType } }).then(function (response) {
