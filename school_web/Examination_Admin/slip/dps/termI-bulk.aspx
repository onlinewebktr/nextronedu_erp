<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="termI-bulk.aspx.cs" Inherits="school_web.Examination_Admin.slip.dps.termI_bulk" %>
    ...
    <form id="form1" runat="server">
                            ...
                            <div class="report-card-wpr" style="height: {{x.MySubjectMarkShowItemII[0].Height_dv}}">
                                <div class="report-card-head {{x.MySubjectMarkShowItemII[0].Hdr_frst}}">
                                    ...
                                    <div class="report-card-cntr-dv">
                                        ...
                                        <asp:Label ID="lbl_aff_no" class="report-card-schl-affno {{x.MySubjectMarkShowItemII[0].Is_aff_no_hide}}" runat="server" Text="{{x.MySubjectMarkShowItemII[0].Aff_text}} : {{x.MyFirmDetailData[0].Frim_aff_no}}"></asp:Label>
                                ...
                                <div class="report-card-head hidden {{x.MySubjectMarkShowItemII[0].Hdr_scnd}}">
                                    ...
                                    <div class="report-card-cntr-dv">
                                        ...
                                        <asp:Label ID="lbl_aff_no1" class="report-card-schl-affno1" runat="server" Text="{{x.MySubjectMarkShowItemII[0].Aff_text}} : {{x.MyFirmDetailData[0].Frim_aff_no}}"></asp:Label>
                                        <asp:Label ID="lbl_school_code" class="report-card-schl-code1" runat="server" Text="{{x.MyFirmDetailData[0].School_no}}"></asp:Label>
                                ...
                                <div class="subs-mrks-area-dv">
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <th class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}">SUBJECTS</th>
                                            <th class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}" data-ng-repeat="item in x.MySubjectHeading track by $index">{{item.Assessment_Name}} <span class="{{x.MySubjectMarkShowItemII[0].Max_mark_show}}">({{item.Maximum_Marks}})</span></th>
                                        ...
                                        <tr data-ng-repeat="item in x.MySubjectMarkShowItemII track by $index">
                                            ...
                                            <td class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}">{{item.Subject_name}}</td>
                                ...
                                <div class="subs-mrks-area-lft-dv">
                                    <div class="subs-mrks-area-b-dv" style="margin-top: {{x.MySubjectMarkShowItemII[0].Co_sch_area_margn}}">
                                        <table>
                                            <tr>
                                                <th class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}">B</th>
                                                <th class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}" colspan="2">CO-SCHOLASTIC AREAS</th>
                                            </tr>
                                            <tr>
                                                <th class="th-bg-rmov {{x.MySubjectMarkShowItemII[0].Is_text_center}}">SN</th>
                                            ...
                                            <tr>
                                                <th class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}">C</th>
                                                <th class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}" colspan="2">DISCIPLINE [ 5 - POINT GRADING SCALE]</th>
                                            </tr>
                                            <tr>
                                                <th class="th-bg-rmov {{x.MySubjectMarkShowItemII[0].Is_text_center}}">SN</th>
                                                <th class="th-bg-rmov">ACTIVITIES</th>
                                    ...
                                    <div class="subs-mrks-area-ovrall-dv" style="margin-top: {{x.MySubjectMarkShowItemII[0].Overall_area_margn}}">
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{x.MyOverallNoDetailData[0].Overall_percents}} <span class="{{x.MySubjectMarkShowItemII[0].Overall_obt_mark}}">(%)</span></td>
                                            </tr>--%>
                                            <tr class="{{x.MySubjectMarkShowItemII[0].Overall_obt_mark}}">
                                                <td>OVERALL GRADE</td>
                                ...
                                <div class="instruction-dv">
                                    <div class="instruction-50 instruction-50-pr">
                                        <div class="instruction-tbls" style="margin-top: {{x.MySubjectMarkShowItemII[0].Ins1_area_margn}}">
                                            <table>
                                                ...
                                                <tr>
                                                    <td>MARKS RANGE</td>
                                                    <td class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}">GRADE</td>
                                                </tr>
                                    ...
                                    <div class="instruction-50 instruction-50-pl" style="margin-top: {{x.MySubjectMarkShowItemII[0].Toppers_area_margn}}">
                                        <div class="instruction-tbls floatrght">
                                            <table>
                                                ...
                                                <tr data-ng-repeat="item in x.MyRankDetailData track by $index">
                                                    <td>{{item.Short_Name}} = {{item.Condition}}</td>
                                                </tr>
                                            </table>
                                        </div>
                                    </div>
        ...
        <script type="text/javascript">
            ...
            app.controller('RpCardAppCtrl', function ($scope, $http) {
                ...
                $http.get("bulk-termI.asmx/fetch_rp_card_bulks", { params: { "Session_id": session_id, "Class_id": class_id, "Section": section, "Branch_id": branch_id, "Term_id": term_id } }).then(function (response) {
