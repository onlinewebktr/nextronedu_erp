<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="term-report-fm.aspx.cs" Inherits="school_web.Examination_Admin.slip.dcs.term_report_fm" %>
                            ...
                            <div class="report-card-wpr" style="height: {{x.MySubjectMarkShowItemII[0].Height_dv}}">
                                ...
                                <div class="subs-mrks-area-dv">
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <th class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}">Highest Marks</th>
                                        </tr>
                                ...
                                <div class="subs-mrks-area-lft-dv">
                                    ...
                                    <div class="remarks-rp">
                                        <p>REMARKS :<span>{{x.MyOverallNoDetailData[0].GradeRmrks}}</span></p>
                                    </div>
                                </div>
                                ...
                                <div class="grding-scale-dv-sec">
                                    ...
                                    <div class="toppers-tbls v-false {{x.MySubjectMarkShowItemII[0].Ranksdv}}">
                                        <table>
                                            <tr>
                                                <th colspan="6" class="txt-center">TOPPERS</th>
                                            </tr>
                                            <tr>
                                                <th>Rank</th>
                                                <th>Name</th>
