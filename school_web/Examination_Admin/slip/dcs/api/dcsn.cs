    ...
    public class dcsn
    {
        ...
        private static string get_grade(string session_id, string branch_id, string Grade_System_Id, double final_marks, string Class_id)
        {
            ...
            else
            {
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    {
                        returN = dt.Rows[i]["Grade"].ToString() + "~" + dt.Rows[i]["Background_color"].ToString() + "~" + dt.Rows[i]["Remarks"].ToString();
                    }
                }
                return returN;
            }
        ...
        internal static string get_overall_total_marks(string Session_id, string Class_id, string Admission_no, string Branch_id, string Term_id)
        {
            ...
            if (Output == "Marks")
            {
                ...
                grade = arr[0];
                string gradeBG = arr[1];
                string gradeRemark = arr[2];
                result = obt_and_full_mark + "/" + marksType + "/" + grade + "/" + gradeBG + "/" + gradeRemark;
            }
            else
            {
                marksType = "GRADE";
                ...
                string gradeBG = arr[1];
                string gradeRemark = arr[2];
                result = overall_obt_marks + "/" + overall_full_marks + "/" + grade + "/" + marksType + "/" + grade + "/" + gradeBG + "/" + gradeRemark;
            }
