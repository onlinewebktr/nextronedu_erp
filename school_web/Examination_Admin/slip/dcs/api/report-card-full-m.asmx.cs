...
namespace school_web.Examination_Admin.slip.dcs.api
{
    /// <summary>
    /// Summary description for report_card_full_m
    /// </summary>
    ...
    public class report_card_full_m : System.Web.Services.WebService
    {
        ...
        public class Fetch_Details_of_overall_no
        {
            ...
            public string GradeRmrks { get; set; }
        }
        ...
        private List<Fetch_Details_of_overall_no> findOverallNoDetails(string Session_id, string admission_no, string Class_id, string Branch_id, string Section, string Term_id)
        {
            ...
            string Total_marks = dcsn.get_overall_total_marks(Session_id, Class_id, admission_no, Branch_id, Term_id);
            string[] stringSeparatorss = new string[] { "/" };
