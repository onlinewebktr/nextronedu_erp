<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="report-card-for-term.aspx.cs" Inherits="school_web.Examination_Admin.slip.igmssr.report_card_for_term" %>
                        ...
                        <div class="invoice-wpr">
                            ...
                            <div class="report-card-wpr" style="height: {{x.MySubjectMarkShowItemII[0].Height_dv}}">
                                ...
                                <div class="subs-mrks-area-dv">
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <th class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}">{{x.MySubjectMarkShowItemII[0].grade_head_text}} ({{x.Term_Full_marks}})</th>
                                            <th class="{{x.MySubjectMarkShowItemII[0].Is_text_center}} {{x.MySubjectMarkShowItemII[0].Grade}}">HIGHEST MARKS</th>
                                        </tr>
                                        ...
                                        <tr data-ng-repeat="item in x.MySubjectMarkShowItemII track by $index">
                                            ...
                                            <%--<td style="display:none"  class="{{x.MySubjectMarkShowItemII[0].Is_text_center}} {{item.Grade}}"><span class="{{item.Gbgclass}}" style="{{item.GradeBG}}">{{item.Grade}}</span></td>--%>
                                          <td    class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}"><span>{{item.SubjHighestMark}}</span></td>
                                ...
                                <div class="subs-mrks-area-lft-dv">
                                    <div class="subs-mrks-area-b-dv" style="margin-top: {{x.MySubjectMarkShowItemII[0].Co_sch_area_margn}}">
                                        <table>
                                            <tr>
                                                <th>B</th>
                                                <th colspan="2" style="text-align:center">CO-SCHOLASTIC AREAS</th>
                                            </tr>
                                            <tr>
                                                <th class="th-bg-rmov">SN</th>
                                                <th class="th-bg-rmov" style="text-align:center">SUBJECTS</th>
                                ...
                                <div class="subs-mrks-area-rght-dv">
                                    ...
                                    <div class="toppers-tbls v-false {{x.MySubjectMarkShowItemII[0].Ranksdv}}" style="display: none !important;">
                                        <table>
                                            <tr>
                                ...
                                <div class="grding-scale-dv-sec" style="display:none">
