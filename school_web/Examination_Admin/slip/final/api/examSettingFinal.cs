...
{
    public class examSettingFinal
    {
        internal static string get_exam_settings(string session_id, string branch_id, string class_id)
        {
            string returN = "hidden/hidden/hidden/hidden/hidden/160px/hidden/hidden/hidden/show/hidden/hidden/hidden/hidden/1250px/sameLine/2px/2px/2px/2px/2px/2px/2px/hidden/hidden/aa";
            ...
            else
            {
                ...
                try
                {
                    ...
                    if (dtms.Rows.Count > 0)
                    {
                        ...
                        try
                        {
                            if (dtms.Rows[0]["Theme_colour"].ToString() != "")
                            {
                                themeColor = dtms.Rows[0]["Theme_colour"].ToString();
                            }
                        }
                        catch (Exception ex)
                        {
                ...
                returN = special_note + "/" + Qr_code + "/" + instruction2 + "/" + Rank + "/" + Graph + "/" + GraphHeight + "/" + percent_remark + "/" + sign_top + "/" + sign_bottom + "/" + is_max_mark_show + "/" + is_estd_show + "/" + is_contact_no_show + "/" + is_email_show + "/" + is_class_text_show + "/" + height_dv + "/" + is_class_new_line + "/" + co_sch_area_margn + "/" + overall_area_margn + "/" + percent_remark_area_margn + "/" + graph_area_margn + "/" + ins1_area_margn + "/" + ins2_area_margn + "/" + toppers_area_margn + "/" + is_watermark_Show + "/" + is_std_img_hide + "/" + is_std_section_hide + "/" + aff_text + "/" + father_name1 + "/" + father_name2 + "/" + is_subj_code_hide + "/" + is_text_center + "/" + Is_website_show + "/" + WhatHeadShow + "/" + Is_aff_no_hide + "/" + Is_overall_grade_hide + "/" + Is_grace + "/" + Is_aff_year + "/" + Is_co_scholastic_hide + "/" + themeColor;
                return returN;
            }
        }
