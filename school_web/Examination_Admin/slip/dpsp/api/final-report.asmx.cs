...
using school_web.Examination_Admin.slip.lddon.api;
using System;
...
namespace school_web.Examination_Admin.slip.dpsp.api
{
    /// <summary>
    /// Summary description for final_report
    /// </summary>
    ...
    public class final_report : System.Web.Services.WebService
    {
        My mycode = new My();
        public class MyStudentsDetails
        {
            public string FinalRanks { get; set; }
        ...
        private List<MySubjectMarkShow> findSubjectMarkShow(string Admission_no, string Session_id, string Class_id, string Branch_id, string Term_idI, string Term_idII, string Term_idIII, string UserType, string Section)
        {
            ...
            else
            {
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    string ttl_mark_of_a_subject = LdFinalupper.get_ttl_mark_of_a_subject_final_year(dr["Subject_id"].ToString(), Admission_no, Session_id, Class_id, Branch_id, Term_idI, Term_idII, Term_idIII);
                    ...
                    //{
                    //    IsPassI = "SubjFail";
                    //    LdFinalupper.save_fail_history(Session_id, Branch_id, Class_id, dr["Subject_id"].ToString(), Admission_no, Term_idI);
                    //}
                    //if (40 > My.toDouble(TermIISubjPerc))
                    //{
                    //    IsPassII = "SubjFail";
                    //    LdFinalupper.save_fail_history(Session_id, Branch_id, Class_id, dr["Subject_id"].ToString(), Admission_no, Term_idII);
                    //}
                    //if (40 > My.toDouble(TermIIISubjPerc))
                    //{
                    //    IsPassIII = "SubjFail";
                    //    LdFinalupper.save_fail_history(Session_id, Branch_id, Class_id, dr["Subject_id"].ToString(), Admission_no, Term_idIII);
                    //}
                    //===========================
                    ...
                    string Total_marks = LdFinalupper.get_overall_total_marks_final(Session_id, Class_id, Admission_no, Branch_id, Term_idI, Term_idII, Term_idIII);
        ...
        private List<MyRpTotalCalculation> findTotCalculation(string Admission_no, string Session_id, string Class_id, string Branch_id, string Term_idI, string Term_idII, string Term_idIII, string Section)
        {
            ...
            string comentory_remarks = ""; // LdFinalupper.get_comentoryRemarks(Session_id, Class_id, Admission_no, Branch_id, Term_idIII);
            ////======================================
            ...
            string session_start_from = session_starts_from(Session_id, Class_id);
