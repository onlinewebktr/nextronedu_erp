<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="report-card-with-full-m.aspx.cs" Inherits="school_web.Examination_Admin.slip.dpsp.report_card_with_full_m" %>
                                ...
                                <div class="report-card-head {{x.Content_header}}">
                                    ...
                                    <div class="report-card-cntr-dv">
                                        ...
                                        <p class="report-card-schl-emil v-false {{x.MySubjectMarkShowItemII[0].Is_email_show}}">
                                            Email :  <asp:Label ID="lbl_email" runat="server" Text="{{x.Firm_email}}"></asp:Label>
                                        </p>
                                        <p class="report-card-schl-emil v-false {{x.MySubjectMarkShowItemII[0].Is_website_show}}">
                                            Website :  <asp:Label ID="Label2" runat="server" Text="{{x.Website}}"></asp:Label>
                                        </p>
