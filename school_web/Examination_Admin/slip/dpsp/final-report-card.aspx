<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="final-report-card.aspx.cs" Inherits="school_web.Examination_Admin.slip.dpsp.final_report_card" %>
                        ...
                        <div class="report-card-wpr" style="height: 1292px">
                            ...
                            <div class="report-card-std-info-dv">
                                <div class="report-card-std-info-dv-50">
                                    ...
                                    <p class="stds-info-p">
                                        ...
                                        <asp:Label ID="Label2" runat="server" Text="{{x.Date_of_birth}}"></asp:Label>
                                    </p>
                                    <p class="stds-info-p">
                                ...
                                <div class="report-card-std-info-dv-50">
                                    <p class="stds-info-p">
                                        ...
                                        <asp:Label ID="Label4" runat="server" Text="{{x.Admission_no}}"></asp:Label>
                                    </p>
                                    <p class="stds-info-p">
                            ...
                            <div class="subs-mrks-area-dv">
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="4" class=" {{x.MySubjectMarkShowItem[0].Is_text_center}} font-weight600">{{x.FinalRanks}}</td>
                                    </tr>
                                </table>
                            </div>

                            <div class="subs-mrks-area-lft-dv">
                                <div class="attendancesDv">
                                    <table>
                                        <tr>
                                            <th>ATTENDANCE</th>
                                            ...
                                            <th class="{{x.MySubjectMarkShowItem[0].Is_text_center}}">Overall</th>
                                        </tr>
                                        <tr>
                                            <td>WORKING DAYS</td>
                            ...
                            <div class="techer-sec">
                                <table>
                                    ...
                                    <tr>
                                        <td   style="width: 120px;">PROMOTED TO</td><td></td>
                                    </tr>
                                </table>
