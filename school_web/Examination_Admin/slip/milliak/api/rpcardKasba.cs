        ...
        internal static string get_subject_total_marks(string session_id, string class_id, string admission_no, string term_id, string subject_id, string branch_id, string Type)
        {
            ...
            if (Type == "Scholastic")
            {
                if (Output == "Marks")
                {
                    ...
                    string grade = milliaKasbaSetting.get_grade_of_a_subject_with_bg(session_id, branch_id, Grade_System_Id, final_marks, full_number, class_id);   // Grade of a subject
                    ...
                    string exam_settings = milliaKasbaSetting.get_exam_settings(session_id, branch_id, class_id);  // Settings
                ...
                else
                {
                    ...
                    string exam_settings = milliaKasbaSetting.get_exam_settings(session_id, branch_id, class_id);  // Is SpecialNote & QR Show
