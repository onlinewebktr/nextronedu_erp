<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="report-card.aspx.cs" Inherits="school_web.Examination_Admin.slip.milliak.report_card" %>
                        ...
                        <div class="invoice-wpr">
                            ...
                            <div class="report-card-wpr" style="height: {{x.MySubjectMarkShowItemII[0].Height_dv}}">
                                ...
                                <div class="hdr-exm-info">
                                    <h2 class="hdr-exm-info-name">{{x.MySubjectHeading[0].Assessment_Name}} EXAM <%--{{x.Term_name}}--%> REPORT CARD</h2>
                                ...
                                <div class="report-card-std-info-dv">
                                    ...
                                    <div class="report-card-std-info-dv-50">
                                        <p class="stds-info-p {{x.MySubjectMarkShowItemII[0].Ranksdv}}">
                                            ...
                                            <span style="margin: -9px 0px 0px 0px; display: inline-block;">{{x.MyRank}}<sup style="text-transform: lowercase; font-size: 14px;">{{x.Ranksup}}</sup></span>
                                        </p>
                                        <p class="stds-info-p">
                                        ...
                                        <p class="stds-info-p">
                                            ...
                                            <asp:Label ID="Label5" runat="server" Text="{{x.For_class}}  '{{x.Section}}'"></asp:Label>
                                        </p>
                                ...
                                <div class="subs-mrks-area-rght-dv" style="width: 100%;">
                                    ...
                                    <div class="toppers-tbls v-false {{x.MySubjectMarkShowItemII[0].Ranksdv}}" style="margin: 5px 0px 0px 0px;">
                                        <table>
                                            <tr>
                                            ...
                                            <tr data-ng-repeat="item in x.MyRankDetailData track by $index">
                                                <td>{{item.Rank}}<sup style="text-transform: lowercase; font-size: 14px;">{{item.RankSup}}</sup></td>
