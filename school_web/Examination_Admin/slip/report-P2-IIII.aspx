<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="report-P2-IIII.aspx.cs" Inherits="school_web.Examination_Admin.slip.report_P2_IIII" %>
    ...
    <form id="form1" runat="server">
                    ...
                    <div class="invoice-wpr">
                        ...
                        <div class="report-card-wpr" style="height: {{reportCardSubS[0].Height_dv}}">
                            ...
                            <div class="report-card-head">
                                ...
                                <div class="report-card-rght-dv1x">
                                    <asp:Image ID="img_extra_log" runat="server" class="class_extra_logo" />

                                    <div class="std_imgsdv">
                                        <asp:Image ID="img_student_img" runat="server" Style="display: none" class="{{reportCardSubS[0].Is_std_img_hide}}" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="report-card-std-info-dv">
                                <div class="report-card-std-info-dv-50">
                                    ...
                                    <p class="stds-info-p {{reportCardSubS[0].Father_name1}}">
                                ...
                                <div class="report-card-std-info-dv-50">
                                    <p class="stds-info-p {{reportCardSubS[0].Father_name2}}">
                                        <i class="stds-info-p-i">FATHER'S NAME</i>  <i class="stds-info-p-doti">:</i>
                                        <asp:Label ID="lbl_father_name1" runat="server" Text="TOFAIL SK."></asp:Label>
                                    </p>
                                    <p class="stds-info-p" runat="server" id="ranksDV" visible="false">
                                        <i class="stds-info-p-i">Rank</i>  <i class="stds-info-p-doti">:</i>
                                        <asp:Label ID="lbl_rank" class="{{reportCardSubS[0].IsRankShowlbl}} {{reportCardSubS[1].IsRankShowlbl}} {{reportCardSubS[2].IsRankShowlbl}} {{reportCardSubS[3].IsRankShowlbl}} {{reportCardSubS[4].IsRankShowlbl}} {{reportCardSubS[5].IsRankShowlbl}} {{reportCardSubS[6].IsRankShowlbl}} {{reportCardSubS[7].IsRankShowlbl}} {{reportCardSubS[8].IsRankShowlbl}}" runat="server" Text="{{reportCardSubS[0].Rank}}"></asp:Label>
                                    </p>
                            ...
                            <div class="subs-mrks-area-dv paddng-top">
                                <table>
                                    <tr>
                                        ...
                                        <th rowspan="2" class="{{reportCardSubS[0].Grade}} txtcenter">GRADE</th>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr data-ng-repeat="x in reportCardSubS track by $index">
                                        ...
                                        <td class="{{x.Grade}} txtcenter">{{x.Grade}}</td>
                                    </tr>
                                </table>
                            </div>
                            ...
                            <div class="instruction-dv-fr-auto-bottom">
                                ...
                                <div class="instruction-50 instruction-50-pl">
                                    <div class="instruction-tbls floatrght">
                                        ...
                                        <div class="v-false {{reportCardSubS[0].Ranksdv}}" style="display: none !important; margin-top: {{reportCardSubS[0].Toppers_area_margn}}">
                                            <table>
                                                <tr>
                            ...
                            <div class="sig-dvx v-false {{reportCardSubS[0].Sign_bottom}}">
                                <div class="sig-left">
        ...
        <script type="text/javascript">
            ...
            app.controller('RpCardAppCtrl', function ($scope, $http) {
                ...
                $http.get("webService/report-P2-IIII.asmx/fetch_report_card_assesment", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id, "Term_id": term_id } }).then(function (response) {
                    $scope.reportCardAssesment = response.data;
                })


                $http.get("webService/report-P2-IIII.asmx/fetch_report_card", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id, "Term_id": term_id } }).then(function (response) {
                    $scope.reportCard = response.data;
                })


                $http.get("webService/report-P2-IIII.asmx/fetch_rp_card_subjects", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id, "Term_id": term_id } }).then(function (response) {
                    ...
                    if ($scope.reportCardSubS == "") {
                        ...
                        ////========================GRAPH
                        $http.get("webService/report-P2-IIII.asmx/fetch_rp_card_graph", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id, "Term_id": term_id } }).then(function (response) {
                            $scope.reportGraphs = response.data;
                        })


                        ////========================OverAll No.
                        $http.get("webService/report-P2-IIII.asmx/fetch_rp_card_total_no", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id, "Term_id": term_id } }).then(function (response) {
                ...
                $http.get("webService/report-P2-IIII.asmx/fetch_rp_card_marks_range", { params: { "Session_id": session_id, "Branch_id": branch_id, "Term_id": term_id } }).then(function (response) {
                    $scope.reportCardmarkRange = response.data;
                })


                ////========================Get Scholastic Data
                $http.get("webService/report-P2-IIII.asmx/fetch_report_card_coscholastic", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id, "Term_id": term_id } }).then(function (response) {
                    $scope.reportCardCoScholastic = response.data;
                })


                ////========================Get Discipline Data
                $http.get("webService/report-P2-IIII.asmx/fetch_report_card_discipline_activity", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id, "Term_id": term_id } }).then(function (response) {
                    $scope.reportCardDesciplineActivitY = response.data;
                })



                $http.get("webService/report-P2-IIII.asmx/fetch_rp_card_grade_remark", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id, "Term_id": term_id } }).then(function (response) {
                    $scope.reportCardgeadeRemark = response.data;
                })

                $http.get("webService/report-P2-IIII.asmx/fetch_rp_card_signature", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id } }).then(function (response) {
                    $scope.reportSig = response.data;
                })


                ////========================Rank
                $http.get("webService/report-P2-IIII.asmx/fetch_rp_card_rank", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id, "Term_id": term_id } }).then(function (response) {
