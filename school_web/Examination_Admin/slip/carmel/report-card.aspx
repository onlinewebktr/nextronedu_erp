<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="report-card.aspx.cs" Inherits="school_web.Examination_Admin.slip.carmel.report_card" %>
    ...
    <form id="form1" runat="server">
                ...
                <div class="invoice-inr-sec" data-ng-repeat="x in reportCardS track by $index">
                    <div class="invoice-height-manage">
                        <div class="invoice-wpr">
                            ...
                            <div class="report-card-wpr" style="height: 1292px">
                                ...
                                <div class="hdr-exm-info">
                                    <h2 class="hdr-exm-info-name">{{x.Term_name}} ACADEMIC SESSION ({{x.Session}})</h2>
                                    <%--<p class="hdr-exm-info-session">SESSION : </p>--%>
                                </div>
                                ...
                                <div class="subs-mrks-area-dv">
                                    <table>
                                        <tr>
                                            ...
                                            <th class="fontsize15 {{x.MySubjectMarkShowItemII[0].Is_text_center}}" colspan="18">SCHOLASTIC AREAS</th>
                                        </tr>
                                        <tr>
                                            ...
                                            <th class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}">{{x.MySubjectMarkShowItemII[0].grade_head_text}} (100<%--{{x.MySubjectMarkShowItemII[0].SubjFulmarks}}--%>)</th>
                                        ...
                                        <tr>
                                            ...
                                            <td class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}" style="font-weight: bold">{{x.MyOverallNoDetailData[0].Overall_obt_marks}}</td>
                                            <td class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}" style="font-weight: bold" rowspan="2">{{x.MyOverallNoDetailData[0].Grade}}</td>
                                        </tr>
                                        <tr>
                                            <%--<td></td>--%>
                                            <td colspan="6" style="font-weight: bold">Percentage</td>
                                            <td class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}" style="font-weight: bold">{{x.MyOverallNoDetailData[0].Overall_percents}} <%--(%)--%></td>
                                        </tr>

                                        <tr>
                                            <td colspan="3" style="font-weight: bold">TOTAL WORKING DAYS : {{x.MySubjectMarkShowItemII[0].Total_no_of_class}}</td>
                                            <td colspan="5" style="font-weight: bold">TOTAL PRESENT DAYS : {{x.MySubjectMarkShowItemII[0].Present_class}}</td>
                                            <%--<td colspan="3" style="font-weight: bold">ATTENDANCE PERCENT : {{x.MySubjectMarkShowItemII[0].Percent_of_attandance}} (%)</td>--%>
                                        </tr>
                                    </table>
                                    ...
                                    <%--<div class="att-ovrll-sec {{x.MySubjectMarkShowItemII[0].Is_attandance_show}}">
                                        ...
                                        <div class="att-ovrll-ttl-marks-dv" style="margin: 0px 0px 0px 0px; float: right;">
                                            <p class="att-ovrll-ttl-marks-cnt-p">ATTENDANCE PERCENT</p>
                                ...
                                <div class="subs-mrks-area-lft-dv">
                                    <div class="subs-mrks-area-b-dv" style="margin-top: 3px">
                                        <table>
                                            <tr>
                                                <%--<th>B</th>--%>
                                                <th colspan="2" class="fontsize15 {{x.MySubjectMarkShowItemII[0].Is_text_center}}">CO-SCHOLASTIC AREAS</th>
                                            </tr>
                                            <%--<tr> 
                                    ...
                                    <div class="subs-mrks-area-b-dv" style="margin-top: 3px">
                                        <table>
                                            <tr>
                                                <%--<th>C</th>--%>
                                                <th colspan="2" class="fontsize15 {{x.MySubjectMarkShowItemII[0].Is_text_center}}">Cumulative Record {{x.Session}}</th>
                                            </tr>
                                            <%--<tr> 
                                                <th class="th-bg-rmov">ACTIVITIES</th>
                                                <th class="th-bg-rmov {{x.MySubjectMarkShowItemII[0].Is_text_center}}">GRADE</th>
                                    ...
                                    <div class="subs-mrks-area-b-dv" style="margin-top: 3px">
                                        <table>
                                            <tr>
                                                <th colspan="4" class="fontsize15 {{x.MySubjectMarkShowItemII[0].Is_text_center}}">Grading Benchmarks</th>
                                            </tr>
                                            <tr>
                                                <th class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}">MARKS RANGE</th>
                                                <th class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}">GRADE</th>
                                                <th class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}">MARKS RANGE</th>
                                                <th class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}">GRADE</th>
                                            </tr>
                                            <tr>
                                                <td class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}">91-100</td>
                                                <td class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}">A1</td>
                                                <td class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}">51-60</td>
                                                <td class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}">C1</td>
                                            </tr>
                                            <tr>
                                                <td class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}">81-90</td>
                                                <td class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}">A2</td>
                                                <td class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}">41-50</td>
                                                <td class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}">C2</td>
                                            </tr>
                                            <tr>
                                                <td class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}">71-80</td>
                                                <td class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}">B1</td>
                                                <td class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}">33-40</td>
                                                <td class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}">D</td>
                                            </tr>
                                            <tr>
                                                <td class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}">61-70</td>
                                                <td class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}">B2</td>
                                                <td class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}">32& Below</td>
                                                <td class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}">E (Needs improvement)</td>
                                            </tr>
                                        </table>
                                    </div>
                                ...
                                <div class="com-record-sec">
                                    <p class="com-prom-to-clss-p">Promoted to Class : <span>{{x.MyOverallNoDetailData[0].Promot_to_classss}}</span></p>
                                    <p class="com-prom-to-ropn-on">School Reopen on : <span>{{x.MyOverallNoDetailData[0].School_reopen_on}}</span></p>
                                    <p class="com-prom-to-clss-teachr">Class Teacher's Remarks : <span><i class="hidden" style="font-style: normal">hidden</i>{{x.MySubjectMarkShowItemII[0].Remarkss}}</span></p>
                                </div>
        ...
        <script type="text/javascript">
            ...
            app.controller('RpCardAppCtrl', function ($scope, $http) {
                ...
                $http.get("api/report-card.asmx/fetch_rp_card_bulks", { params: { "Session_id": session_id, "Class_id": class_id, "Section": section, "Branch_id": branch_id, "Term_id": term_id, "Adm_no": adm_no } }).then(function (response) {
