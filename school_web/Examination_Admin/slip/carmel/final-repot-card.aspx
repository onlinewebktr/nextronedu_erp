<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="final-repot-card.aspx.cs" Inherits="school_web.Examination_Admin.slip.carmel.final_repot_card" %>
...
<head runat="server">
    ...
    <link href="css/report-card-new.css" rel="stylesheet" />
    ...
    <script type="text/javascript">
        function PrintPanel() {
            ...
            printWindow.document.write('<link href="css/report-card-new.css" rel="stylesheet" type="text/css" />');
                    ...
                    <div class="invoice-wpr" style="border-color: background: {{x.MySubjectMarkShowItem[0].ThemeColor}}">
                        ...
                        <div class="report-card-wpr" style="height: {{x.MySubjectMarkShowItem[0].Height_dv}};">
                            ...
                            <div class="hdr-exm-info">
                                <h2 class="hdr-exm-info-name">PROGRESSIVE REPORT ACADEMIC SESSION ({{x.Session}})</h2>
                            ...
                            <div class="report-card-std-info-dv">
                                ...
                                <div class="report-card-std-info-dv-50">
                                    ...
                                    <p class="stds-info-p">
                                        ...
                                        <asp:Label ID="Label3" runat="server" Text="{{x.Section}}"></asp:Label>
                                    </p>
                                    <p class="stds-info-p">
                                        <i class="stds-info-p-i">ROLL NO.</i>  <i class="stds-info-p-doti">:</i>
                                        <asp:Label ID="Label16" runat="server" Text="{{x.Roll_no}}"></asp:Label>
                                    </p>
                                </div>
                            ...
                            <div class="subs-mrks-area-dv">
                                <table>
                                    <tr>
                                        <th colspan="20" class="{{x.MySubjectMarkShowItem[0].Is_text_center}}">SCHOLASTIC AREAS</th>
                                    </tr>
                                    <tr>
                                        <%--<th>A</th>--%>
                                        <th style="min-width: 130px;" rowspan="2">SUBJECTS</th>
                                        <th class="txt-center" colspan="{{x.MySubjectHeading[0].TermColSpan}}">
                                            <asp:Label ID="termITexts" runat="server"></asp:Label></th>
                                        <th colspan="{{x.MySubjectHeading[0].TermColSpan}}" class="txt-center">
                                            <asp:Label ID="termIITexts" runat="server"></asp:Label></th>
                                        <th class="txt-center" colspan="2">OVERALL RESULT</th>
                                    </tr>
                                    <tr>
                                        <%--<th>SN</th>--%>
                                        ...
                                        <th class="{{reportCardSubS[0].If_is_grade_ttl_mark_hide}} {{x.MySubjectMarkShowItem[0].Is_text_center}}">{{x.MySubjectMarkShowItem[0].ttl_marks_head_termI}} ({{x.MySubjectHeading[0].Term_Maximum_Marks}})</th>
                                        <th class="{{reportCardSubS[0].If_is_grade_ttl_mark_hide}} {{x.MySubjectMarkShowItem[0].Is_text_center}}">Gr</th>

                                        <th data-ng-repeat="item in x.MySubjectHeadingII track by $index" class="{{x.MySubjectMarkShowItem[0].Is_text_center}}">{{item.Short_Name}} ({{item.Maximum_Marks}})</th>
                                        <th class="{{reportCardSubS[0].If_is_grade_ttl_mark_hide}} {{x.MySubjectMarkShowItem[0].Is_text_center}}">{{x.MySubjectMarkShowItem[0].ttl_marks_head_termII}} ({{x.MySubjectHeadingII[0].Term_Maximum_Marks}})</th>
                                        <th class="{{reportCardSubS[0].If_is_grade_ttl_mark_hide}} {{x.MySubjectMarkShowItem[0].Is_text_center}}">Gr</th>


                                        <th class="{{x.MySubjectMarkShowItem[0].Overall_av_marks}} {{x.MySubjectMarkShowItem[0].Is_text_center}}">Term1+Term2 (200/2)</th>
                                        <%--<th class="{{x.MySubjectMarkShowItem[0].Is_text_center}}">{{x.MySubjectMarkShowItem[0].Overall_ab_grade}}</th>--%>
                                        <%--<th class="{{x.MySubjectMarkShowItem[0].Is_text_center}}">Percentage</th>--%>
                                        <th class="{{reportCardSubS[0].If_is_grade_ttl_mark_hide}} {{x.MySubjectMarkShowItem[0].Is_text_center}}">Gr</th>
                                    </tr>
                                    ...
                                    <tr data-ng-repeat="item in x.MySubjectMarkShowItem track by $index">
                                        ...
                                        <td class="{{reportCardSubS[0].If_is_grade_ttl_mark_hide}} {{x.MySubjectMarkShowItem[0].Is_text_center}}"><span class="{{item.IsPassII}}">{{item.Total_mark_of_a_subject_for_termII}}</span></td>
                                        ...
                                        <td class="{{x.MySubjectMarkShowItem[0].Is_text_center}}">{{item.SubjectPersentage}}</td>
                                    ...
                                    <tr>
                                        <td class="font-weight600">TOTAL MARKS</td>
                                        <td colspan="{{x.MySubjectHeading[0].TermColSpanbtms}}" class="txt-center font-weight600">{{x.MyTotalsDetailsItem[0].T1ObtMark}}</td>
                                        <td class="txt-center font-weight600">{{x.MyTotalsDetailsItem[0].TermGradeT1}}</td>
                                        <td colspan="{{x.MySubjectHeading[0].TermColSpanbtms}}" class="txt-center font-weight600">{{x.MyTotalsDetailsItem[0].T2ObtMark}}</td>
                                        <td class="txt-center font-weight600">{{x.MyTotalsDetailsItem[0].TermGradeT2}}</td>
                                        <td class="txt-center font-weight600">{{x.MyTotalsDetailsItem[0].Overall_obt_marks}}</td>
                                        <td class="txt-center font-weight600">{{x.MyTotalsDetailsItem[0].Grade}}</td>
                                    </tr>
                                    <%--<tr>
                                        <td class="font-weight600">PERCENTAGE</td>
                                        <td colspan="{{x.MySubjectHeading[0].TermColSpan}}" class="txt-center font-weight600">{{x.MyTotalsDetailsItem[0].T1Persentage}}</td>
                                        <td colspan="{{x.MySubjectHeading[0].TermColSpan}}" class="txt-center font-weight600">{{x.MyTotalsDetailsItem[0].T2Persentage}}</td>
                                        <td colspan="2" class="txt-center font-weight600">{{x.MyTotalsDetailsItem[0].Overall_percents}}</td>
                                    </tr>--%>
                                    <tr>
                                        <td class="font-weight600">ATTENDANCE</td>
                                        <td colspan="{{x.MySubjectHeading[0].TermColSpanAtndce}}" class="txt-center font-weight600">TOTAL WORKING DAYS : {{x.MySubjectMarkShowItem[0].Total_class_of_term_II}}</td>
                                        <td colspan="{{x.MySubjectHeading[0].TermColSpanAtndce}}" class="txt-center font-weight600">TOTAL PRESENT DAYS : {{x.MySubjectMarkShowItem[0].Total_Present_class_of_term_II}}</td>
                                        <%--<td colspan="2" class="txt-center font-weight600">{{x.MySubjectMarkShowItem[0].Final_persent_days}}</td>--%>
                                    </tr>
                                </table>
                            ...
                            <div class="subs-mrks-area-lft-dv">
                                <div class="subs-mrks-area-b-dv">
                                    <div class="subs-mrks-area-b-dv" style="padding: 3px 0px 0px 0px;">
                                        <table>
                                            <tr>
                                                <th colspan="3">CO-SCHOLASTIC AREAS<%-- [{{x.MyCoScholesticDetailsItem[0].RowCount}} - POINT GRADING SCALE]--%></th>
                                            </tr>
                                            <tr>
                            ...
                            <div class="subs-mrks-area-rght-dv">
                                <div class="subs-mrks-area-ovrall-dv" style="padding: 3px 0px 0px 0px;">
                                    <%--<table>
                                    ...
                                    <div class="instruction-tbls" style="margin-top: 0px">
                                        <table>
                                            <tr>
                                                <th colspan="2" class="txt-center">GRADING BENCHMARK</th>
                                            </tr>
                                            <%--<tr>
                            ...
                            <div class="comulative-record-sec">
                                <table>
                                    <tr>
                                        <th colspan="3">CUMULATIVE RECORD ({{x.Session}})</th>
                                    </tr>
                                    <tr>
                                        <th class="th-bg-rmov" style="text-align:left">ACTIVITIES</th> 
                                        <th class="th-bg-rmov" style="text-align:left">REMARKS
                                            <asp:Label ID="termITexts6" runat="server" Style="display: none !important"></asp:Label>
                                            <asp:Label ID="termITexts5" runat="server" Style="display: none !important"></asp:Label>
                                        </th>
                                    </tr>
                                    <tr data-ng-repeat="item in x.MyDecplineDetailsItem track by $index">
                                        <td>{{item.Activity_name}}</td>
                                        <%--<td>{{item.Term_grade1}}</td>--%>
                                        <td>{{item.Term_grade1}}</td>
                                    </tr>
                                </table>
                            </div>
                            ...
                            <div class="com-record-sec">
                                <p class="com-prom-to-clss-p">Promoted to Class : <span>{{x.MyTotalsDetailsItem[0].Promot_to_class}}</span></p>
                                <p class="com-prom-to-ropn-on">School Reopen on : <span>{{x.MyTotalsDetailsItem[0].School_reopen_on}}</span></p>
                                <p class="com-prom-to-clss-teachr">Class Teacher's Remarks : <span><i class="{{x.MyTotalsDetailsItem[0].P_remark}}" style="font-style: normal"></i>{{x.MyTotalsDetailsItem[0].P_remark}}</span></p>
                            </div>
                            ...
                            <div class="sig-dv v-false {{x.MySubjectMarkShowItem[0].Sign_bottom}}">
                                <div class="sig-left">
                                    ...
                                    <p class="datebtms-ps">Date<span></span></p>
                                </div>
                                ...
                                <div class="sig-left">
                                    <div class="cntr-sig-img-dv">
                                        <img src="{{x.MySignatureDetailsItem[0].Signature_image}}" class="cntr-sig-img {{x.MySignatureDetailsItem[0].Signature_image}}" />
                                    </div>
                                    <p class="sig-ps">{{x.MySignatureDetailsItem[0].Signature_name}}</p>
                                </div>
                                <div class="sig-left">
                            ...
                            <h2 class="btmstgline-h">“Transformative Education for fullness of life.”</h2>
                        </div>
                    </div>
                </div>
            </div>
