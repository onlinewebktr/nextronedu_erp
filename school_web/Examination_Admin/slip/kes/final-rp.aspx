<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="final-rp.aspx.cs" Inherits="school_web.Examination_Admin.slip.kes.final_rp" %>
    ...
    <form id="form1" runat="server">
                    ...
                    <div class="invoice-wpr">
                        ...
                        <div class="report-card-wpr" style="height: {{x.MySubjectMarkShowItem[0].Height_dv}}">
                            ...
                            <div class="hdr-exm-info">
                                ...
                                <p class="hdr-exm-info-session">ANNUAL EXAMINATION FOR ACADEMIC SESSION : {{x.Session}}</p>
                            </div>
                            ...
                            <div class="report-card-std-info-dv">
                                ...
                                <div class="report-card-std-info-dv-50">
                                    ...
                                    <p class="stds-info-p">
                                        ...
                                        <asp:Label ID="Label1" runat="server" Text="{{x.For_class}}"></asp:Label>
                                    </p>
                                    <p class="stds-info-p">
                            ...
                            <div class="subs-mrks-area-lft-dv">
                                ...
                                <div class="remarks-rp">
                                    <p>REMARKS :<span class=" {{x.MyRpTotalCalculationItem[0].P_remark}}">{{x.MyRpTotalCalculationItem[0].P_remark}}</span></p>
                                </div>
                            </div>
                            ...
                            <%--<div class="rp-card-graph-sec {{x.IsgraphShow}}">
        ...
        <script type="text/javascript">
            ...
            app.controller('RpCardAppCtrl', function ($scope, $http) {
                ...
                $http.get("api/final-report.asmx/fetch_rp_card_bulks", { params: { "Session_id": session_id, "Class_id": class_id, "Section": section, "Branch_id": branch_id, "Term_idI": term_id1, "Term_idII": term_id2, "Term_idIII": term_id3, "UserType": userType, "Adm_no": adm_no } }).then(function (response) {
                ...
                //$http.get("api/final-report-upper.asmx/fetch_rp_card_bulks", {
                //    params: {
