<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="term-3rd.aspx.cs" Inherits="school_web.Examination_Admin.slip.kes.term_3rd" %>
    ...
    <form id="form1" runat="server">
                    ...
                    <div class="invoice-height-manage">
                        <div class="invoice-wpr">
                            ...
                            <div class="report-card-wpr" style="height: {{x.MySubjectMarkShowItemII[0].Height_dv}}">
                                <%--<div class="report-card-head {{x.Content_header}}">
                                    ...
                                    <div class="report-card-cntr-dv">
                                        ...
                                        <p class="report-card-schl-emil v-false {{x.MySubjectMarkShowItemII[0].Is_website_show}}">
                                            Website : 
                                        <asp:Label ID="Label2" runat="server" Text="{{x.Website}}"></asp:Label>
                                        </p>
                                ...
                                <div style="height: 300px; float: left; width: 100%"></div>
                                <div class="hdr-exm-info">
                                    <h2 class="hdr-exm-info-name">REPORT CARD
                                        <br />
                                        {{x.Term_name}} </h2>
                                ...
                                <div class="subs-mrks-area-dv">
                                    <table>
                                        <%--<tr>
                                            ...
                                            <th class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}" data-ng-repeat="item in x.MySubjectHeadingAssesment track by $index" colspan="4">{{item.Assessment_Name}}</th>
                                        ...
                                        <tr>
                                            ...
                                            <%--<th class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}">{{x.MySubjectMarkShowItemII[0].grade_head_text}}</th>--%>
                                    ...
                                    <div class="ovrll-sec">
                                        <div class="ovrll-ttl-marks-dv">
                                            <p class="ovrll-ttl-marks-cnt-p">Rank </p>
                                            <p class="ovrll-ttl-marks-num-p">{{x.MyRank}}</p>
                                        </div>
                                        <div class="ovrll-ttl-marks-dv">
                                ...
                                <div class="subs-mrks-area-lft-dv">
                                    <div class="subs-mrks-area-b-dv" style="margin-top: 3px">
                                        <table style="margin: 0px 0px 3px 0px;">
                                            <tr>
                                                <th colspan="4">Aggregation</th>
                                            </tr>
                                            <tr>
                                                <th class="th-bg-rmov" style="text-transform: inherit;">1st TERM</th>
                                                <th class="th-bg-rmov {{x.MySubjectMarkShowItemII[0].Is_text_center}}">{{x.MyRpTotalCalculationItem[0].Obtained_Mark_TermI}}</th>

                                                <th class="th-bg-rmov"  style="text-transform: inherit;">2nd TERM</th>
                                                <th class="th-bg-rmov {{x.MySubjectMarkShowItemII[0].Is_text_center}}">{{x.MyRpTotalCalculationItem[0].Obtained_Mark_TermII}}</th>
                                            </tr>
                                            <tr>
                                                <th class="th-bg-rmov">FINAL</th>
                                                <th class="th-bg-rmov {{x.MySubjectMarkShowItemII[0].Is_text_center}}">{{x.MyRpTotalCalculationItem[0].Obtained_Mark_TermIII}}</th>

                                                <th class="th-bg-rmov">GRAND TOTAL</th>
                                                <th class="th-bg-rmov {{x.MySubjectMarkShowItemII[0].Is_text_center}}">{{x.MyRpTotalCalculationItem[0].GrandTTlOBT}}</th>
                                            </tr>
                                            <tr> 
                                                <th class="th-bg-rmov" colspan="2">GRAND TOTAL PERCENTAGE</th>
                                                <th class="th-bg-rmov   {{x.MySubjectMarkShowItemII[0].Is_text_center}}" colspan="2">{{x.MyRpTotalCalculationItem[0].GrandTTlPersentage}}%</th>
                                            </tr>
                                        </table>
                                        ...
                                        <table class="{{x.MyCoScholasticData[0].IsShow}}" style="margin: 0px 0px 4px 0px;">
                                            <tr>
                                                <th class="th-bg-rmov">Subject</th>
                                                <th class="th-bg-rmov {{x.MySubjectMarkShowItemII[0].Is_text_center}}">Maximum Marks</th>
                                                <th class="th-bg-rmov {{x.MySubjectMarkShowItemII[0].Is_text_center}}">Obtained Marks</th>
                                            </tr>
                                            <tr data-ng-repeat="item in x.MyCoScholasticData track by $index">
                                                <td>{{item.Subject_Name}}</td>
                                                <td class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}">{{item.Full_marks}}</td>
                                                <td class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}">{{item.Total_marks}}</td>
                                            </tr>
                                        </table>
                                        <table>
                                            ...
                                            <tr>
                                                <th colspan="3">Personality Traits</th>
                                            </tr>
                                            <tr>
                                    ...
                                    <div class="remarks-rp">
                                        <p>REMARKS :<span class=" {{x.MySubjectMarkShowItemII[0].Remarkss}}">{{x.MySubjectMarkShowItemII[0].Remarkss}}</span></p>
                                    </div>
                                </div>
                                ...
                                <div class="subs-mrks-area-rght-dv">
                                    ...
                                    <div class="toppers-tbls" style="margin: 2px 0px 0px 0px;">
                                        <div class="instruction-tbls">
                                            <table>
                                                <%-- <tr>
                                                    <th colspan="3" class="txt-center">{{x.MyMarkRangeData[0].RowCount}}-point grading scale</th>
                                                </tr>--%>
                                                <tr>
                                                    <th>GRADING SCALE</th>
                                                    <th>GRADE</th>
                                ...
                                <%--<div class="grding-scale-dv-sec">
                                    ...
                                    <p class="grding-scale-dv-p {{x.MyMarkRangeData_coscholestic[0].IsCoScholasticGrade}}">{{x.MyMarkRangeData_coscholestic[0].RowCount}} Point Co-Scholastic Grading Scale : <span data-ng-repeat="item in x.MyMarkRangeData_coscholestic track by $index">{{item.Grade}} [{{item.Lower_Range}}-{{item.Upper_Range}}]</span></p>
                                </div>--%>
        ...
        <script type="text/javascript">
            ...
            app.controller('RpCardAppCtrl', function ($scope, $http) {
                ...
                $http.get("api/3rdTerm.asmx/fetch_rp_card_bulks", { params: { "Session_id": session_id, "Class_id": class_id, "Section": section, "Branch_id": branch_id, "Term_id": term_id, "Adm_no": adm_no, "Term_id2": term_id2, "Term_id3": term_id3 } }).then(function (response) {
