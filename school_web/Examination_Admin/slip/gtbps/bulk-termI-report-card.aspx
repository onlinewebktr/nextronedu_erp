<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bulk-termI-report-card.aspx.cs" Inherits="school_web.Examination_Admin.slip.gtbps.bulk_termI_report_card" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function PrintPanel() {
            ...
            printWindow.document.write('<link href="https://fonts.googleapis.com/css?family=Montserrat:100,200,300,400,500,600,700" rel="stylesheet" /><link href="../assets/css/report-card.css" rel="stylesheet" type="text/css" /><link href="modify.css" rel="stylesheet" />');
    ...
    <form id="form1" runat="server">
                    ...
                    <div class="invoice-height-manage">
                        <div class="invoice-wpr">
                            ...
                            <div class="report-card-wpr" style="height: {{x.MySubjectMarkShowItemII[0].Height_dv}}">
                                ...
                                <div class="report-card-head hidden {{x.MySubjectMarkShowItemII[0].Hdr_scnd}}">
                                    <div class="report-card-left-dv">
                                        <img src="{{x.MyFirmDetailData[0].Frim_logo}}" />
                                        <asp:Label ID="Label3" runat="server" Text="{{x.MyFirmDetailData[0].Estd}}" class="estdTextP v-false {{x.MySubjectMarkShowItemII[0].Is_estd_show}}"></asp:Label>
                                    </div>
                                    <div class="report-card-cntr-dv">
                                        <asp:Label ID="lbl_school_name1" class="report-card-schlname" runat="server" Text="{{x.MyFirmDetailData[0].Firm_name}}"></asp:Label>
                                        <asp:Label ID="lbl_aff_text1" class="report-card-schl-affno-by" runat="server" Text="{{x.MyFirmDetailData[0].Affiliated_by_full_text}}"></asp:Label>
                                        <asp:Label ID="lbl_address1" runat="server" class="report-card-schl-add" Text="{{x.MyFirmDetailData[0].Firm_address}}"></asp:Label>


                                        <asp:Label ID="lbl_school_code" Style="display: none" class="report-card-schl-code1" runat="server" Text="{{x.MyFirmDetailData[0].School_no}}"></asp:Label>


                                        <asp:Label ID="lbl_contact_no1" runat="server" class="report-card-schl-cont1 v-false {{x.MySubjectMarkShowItemII[0].Is_contact_no_show}}" Text="{{x.MyFirmDetailData[0].Firm_contact_no}}"></asp:Label>
                                        <p class="report-card-schl-emil1 v-false {{x.MySubjectMarkShowItemII[0].Is_email_show}}">
                                            Email : 
                                        <asp:Label ID="lbl_email1" runat="server" Text="{{x.MyFirmDetailData[0].Firm_email}}"></asp:Label>
                                        </p>

                                        <p class="report-card-schl-website1 v-false {{x.MySubjectMarkShowItemII[0].Is_website_show}}">
                                            Website : 
                                        <asp:Label ID="lbl_website1" runat="server" Text="{{x.MyFirmDetailData[0].Website}}"></asp:Label>
                                        </p>
                                        <h2 class="report-card-ac-sson">ACADEMIC SESSION:
                                       <asp:Label ID="Label4" runat="server" Text="{{x.Session}}"></asp:Label></h2>
                                        <h2 class="report-card-rprt-crd">{{x.Term_name}} REPORT CARD <span class="{{x.MySubjectMarkShowItemII[0].Class_in_new_line}}"><span class="v-false {{x.MySubjectMarkShowItemII[0].Is_class_text_show}}">CLASS</span> {{x.For_class}}</span></h2>
                                    </div>


                                    <asp:Label ID="lbl_aff_no1" class="report-card-schl-affno" runat="server" Text="{{x.MySubjectMarkShowItemII[0].Aff_text}} : {{x.MyFirmDetailData[0].Frim_aff_no}}"></asp:Label>
                                    <div class="report-card-rght-dv2">
                                        <asp:Image ID="img_extra_log" src="{{x.MyFirmDetailData[0].Extra_logo}}" runat="server" class="class_extra_logo" />

                                        <div class="std_imgsdv {{x.Student_image}}">
                                            <asp:Image ID="img_student_img1" runat="server" src="{{x.Student_image}}" class="{{x.MySubjectMarkShowItemII[0].Is_std_img_hide}}" />
                                        </div>
                                    </div>
                                </div>

                                <div class="report-card-std-info-dv1">
                                    <div class="report-card-std-info-dv-50">
                                        ...
                                        <p class="stds-info-p {{x.MySubjectMarkShowItemII[0].Father_name1}}" style="display: none !important">
                                    ...
                                    <div class="report-card-std-info-dv-50">
                                        <p class="stds-info-p {{x.MySubjectMarkShowItemII[0].Father_name2}}" style="display: none !important">
                                            <i class="stds-info-p-i">FATHER'S NAME</i>  <i class="stds-info-p-doti">:</i>
                                ...
                                <div class="subs-mrks-area-dv">
                                    <table>
                                        <tr>
                                            ...
                                            <th class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}" colspan="8">SCHOLASTIC AREAS</th>
                                        </tr>
                                        <tr>
                                ...
                                <div class="subs-mrks-area-lft-dv">
                                    <div class="subs-mrks-area-b-dv" style="margin-top: {{x.MySubjectMarkShowItemII[0].Co_sch_area_margn}}">
                                        <table>
                                            ...
                                            <tr>
                                                <th>C</th>
                                                <th colspan="2">3 - POINT GRADING SCALE</th>
                                            </tr>
                                            <tr>
                                                <th class="th-bg-rmov">SN</th>
                                                <th class="th-bg-rmov">ACTIVITIES</th>
                                ...
                                <div class="subs-mrks-area-rght-dv">
                                    <div class="subs-mrks-area-ovrall-dv" style="margin-top: {{x.MySubjectMarkShowItemII[0].Overall_area_margn}}">
                                        <table>
                                            <tr class="{{x.MySubjectMarkShowItemII[0].Overall_obt_mark}}">
                                                ...
                                                <td class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}">{{x.MyOverallNoDetailData[0].Overall_obt_marks}}/{{x.MyOverallNoDetailData[0].Overall_full_marks}} <%--{{x.MySubjectMarkShowItemII[0].Overall_obt_mark}}/{{x.MySubjectMarkShowItemII[0].Overall_full_mark}}--%></td>
                                            </tr>
                                            <tr>
                                                <td>OVERALL {{ttlNos[0].Mark_type}} <%--{{x.MySubjectMarkShowItemII[0].Marks_type}}--%></td>
                                                <td class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}">{{x.MyOverallNoDetailData[0].Overall_percents}} <%--{{x.MySubjectMarkShowItemII[0].Overall_percent}}--%> <span class="{{x.MySubjectMarkShowItemII[0].Overall_obt_mark}}">(%)</span></td>
                                            </tr>
                                            <tr class="{{x.MySubjectMarkShowItemII[0].Overall_obt_mark}} {{x.MySubjectMarkShowItemII[0].Is_overall_grade_show}}">
                                                <td>OVERALL GRADE</td>
                                            ...
                                            <tr class="{{x.MySubjectMarkShowItemII[0].Is_attandance_show}}">
                                                ...
                                                <td class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}">{{x.MySubjectMarkShowItemII[0].Total_no_of_class}}</td>
                                            </tr>
                                            <tr class="{{x.MySubjectMarkShowItemII[0].Is_attandance_show}}">
                                                <td>TOTAL PRESENT DAYS</td>
                                                <td class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}">{{x.MySubjectMarkShowItemII[0].Present_class}}</td>
                                            </tr>
                                            <tr class="{{x.MySubjectMarkShowItemII[0].Is_attandance_show}}">
                                                <td>ATTENDANCE PERCENT</td>
                                                <td class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}">{{x.MySubjectMarkShowItemII[0].Percent_of_attandance}} (%)</td>
                                            </tr>
                                    ...
                                    <div class="gtbps-result-sec {{x.IsSecndTerm}}">
                                        <p class="gtbps-result-rslt-p">RESULT : </p>
                                        <p class="gtbps-result-rmrk-p">{{x.MySubjectMarkShowItemII[0].Remarkss}} <span></span></p>
                                    </div>
                                    ...
                                    <div class="remarks-rp {{x.MySubjectMarkShowItemII[0].Remarkss}} {{x.IsFirstTerm}}">
                                ...
                                <div class="instruction-dv">
                                    ...
                                    <div class="instruction-50  instruction-50-pl">
                                        <div class="instruction-tbls floatrght">
                                            <div style="margin-top: {{x.MySubjectMarkShowItemII[0].Toppers_area_margn}}">
                                                <table>
                                                    <tr>
                                                        <th class="txt-center">3 Point Grading Scale</th>
                                                    </tr>
                                                    <tr>
                                                        <td>A = Excellent</td>
                                                    </tr>
        ...
        <script type="text/javascript">
            ...
            app.controller('RpCardAppCtrl', function ($scope, $http) {
                ...
                $http.get("bulk-report-card.asmx/fetch_rp_card_bulks", { params: { "Session_id": session_id, "Class_id": class_id, "Section": section, "Branch_id": branch_id, "Term_id": term_id } }).then(function (response) {
