...
{
    /// <summary>
    /// Summary description for termI_report_card1
    /// </summary>
    ...
    public class termI_report_card1 : System.Web.Services.WebService
    {
        My mycode = new My();
        ...
        public void fetch_rp_card_signature(string Session_id, string Class_id, string Admission_no, string Branch_id)
        {
            ...
            {
                string Section = Exam_gtps_termI.get_student_section(Session_id, Admission_no, Branch_id, Class_id);
                foreach (DataRow dr in dt.Rows)
                {
                    string stgnature = "";
        ...
        {
            string section = Exam_gtps_termI.get_section(Session_id, Class_id, Admission_no, Branch_id);
