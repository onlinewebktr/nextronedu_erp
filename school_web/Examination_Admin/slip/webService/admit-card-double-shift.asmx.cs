...
{
    /// <summary>
    /// Summary description for admit_card_double_shift
    /// </summary>
    ...
    public class admit_card_double_shift : System.Web.Services.WebService
    {
        #region ONESHIFTS
        ...
        public void fetch_admit_cards(string Session_id, string Class_id, string Admission_no, string Branch_id, string Term_id, string Section, string Session_name, string Exam_id, string CheckedStd, string UserType, string PageNo)
        {
            ...
            else
            {
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    List<MyRoutineDetails> MBdetails = findmyRoutine(Session_id, Class_id, dr["admissionserialnumber"].ToString(), Branch_id, Term_id, Section, Session_name, Exam_id, PageNo);
        ...
        private List<MyRoutineDetails> findmyRoutine(string Session_id, string Class_id, string Admission_no, string Branch_id, string Term_id, string Section, string Session_name, string Exam_id, string PageNo)
        {
