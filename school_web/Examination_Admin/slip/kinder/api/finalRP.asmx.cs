...
namespace school_web.Examination_Admin.slip.kinder.api
{
    /// <summary>
    /// Summary description for finalRP
    /// </summary>
    ...
    public class finalRP : System.Web.Services.WebService
    {
        My mycode = new My();
        public class MyStudentsDetails
        {
            ...
            public string RP_issue_date { get; set; }
        ...
        public class Fetch_Details_of_report_descpline
        {
            ...
            public string Term_gradeT2 { get; set; }
        ...
        public class MySubjectMarkShowII
        {
            ...
            public List<MySubjectMarkDetailsIIISem2> MySubjectMarkItemIIISem2 { get; set; }
        }

        public class MySubjectMarkDetailsIII
        {
            public string Marks { get; set; }
            public string gradebgss { get; set; }
            public string Gbgclass { get; set; }
            public string Total_marks { get; set; }
        }
        public class MySubjectMarkDetailsIIISem2
        {
            public string Marks { get; set; }
            public string gradebgss { get; set; }
            public string Gbgclass { get; set; }
        ...
        public class Fetch_Details_of_overall_no
        {
            ...
            public string P_remark { get; set; }
            public string Grade { get; set; }
            public string gradebgall { get; set; }
            public string Grade_bg_class { get; set; }
            public string IfbgColorL { get; set; }
            public string IfbgColorR { get; set; }

            public string GradeT2 { get; set; }
            public string gradebgallT2 { get; set; }
            public string Grade_bg_classT2 { get; set; }
            public string IfbgColorLT2 { get; set; }
            public string IfbgColorRT2 { get; set; }

            public string TotalClassesT1 { get; set; }
            public string TotalPClassesT1 { get; set; }
            public string TotalClassesT2 { get; set; }
            public string TotalPClassesT2 { get; set; }
            public string RemarkssT1 { get; set; }
            public string RemarkssT2 { get; set; }
        ...
        public void fetch_rp_card_bulks(string Session_id, string Class_id, string Section, string Branch_id, string Term_idI, string Term_idII, string Adm_no)
        {
            ...
            else
            {
                ...
                string issueDate = getIssuedate(Session_id, Class_id, dt.Rows[0]["Section"].ToString());
                foreach (DataRow dr in dt.Rows)
                {
                    My.exeSql("delete from Exam_temp_assesment_total_no where Session_id='" + Session_id + "' and Class_id='" + Class_id + "' and Branch_Id='" + Branch_id + "' and Term_id='" + Term_idI + "' and Admission_no='" + dr["Admission_no"].ToString() + "'; delete from Exam_temp_assesment_total_no_term_II where Session_id='" + Session_id + "' and Class_id='" + Class_id + "' and Branch_Id='" + Branch_id + "' and Term_id='" + Term_idI + "' and Admission_no='" + dr["Admission_no"].ToString() + "';INSERT INTO Exam_rp_bulk_print_adm (Session_id,Admission_no) values ('" + Session_id + "','" + dr["Admission_no"].ToString() + "')");
                    List<MySubjectMarkShowII> MBdetails = findSubjectMarkShowII(dr["Admission_no"].ToString(), Session_id, Class_id, Branch_id, Term_idI, dtF.Rows[0]["firm_id"].ToString(), Term_idII);
                    ...
                    //================ DescplinE
                    List<Fetch_Details_of_report_descpline> MBdetailsDescplinE = findDescplineData(Session_id, dr["Admission_no"].ToString(), Class_id, Branch_id, Term_idI, Term_idII);

                    //================ Mark Range
                    List<Fetch_Details_of_report_marks_range> MBdetailsMarkRange = findMarkRangeData(Session_id, Branch_id, Term_idI);

                    //================ Grade Remarks
                    List<Fetch_Details_of_report_grade_remark> MBdetailsGradeRemark = findGradeRemarkData(Session_id, dr["Admission_no"].ToString(), Class_id, Branch_id, Term_idI);
                    ...
                    //================ OverAllNo
                    List<Fetch_Details_of_overall_no> MBOverALL = findOverallNoDetails(Session_id, dr["Admission_no"].ToString(), Class_id, Branch_id, dr["Section"].ToString(), Term_idI, Term_idII);
                    string signatures = kinder_RP.get_signature(Session_id, Class_id, Section, Branch_id);
                    ...
                    string term_name = kinder_RP.get_term_name(Branch_id, Term_idI);
                    string rank = "0";
        ...
        private string getIssuedate(string session_id, string class_id, string Section)
        {
            string retuRN = "";
            DataTable dt = My.dataTable("select Issue_date from Exam_report_card_issue_date where Session_id='" + session_id + "' and Class_id='" + class_id + "' and Section='" + Section + "'");
            if (dt.Rows.Count > 0)
            {
        ...
        private List<Fetch_Details_of_overall_no> findOverallNoDetails(string Session_id, string admission_no, string Class_id, string Branch_id, string Section, string Term_id, string Term_idII)
        {
            List<Fetch_Details_of_overall_no> MyOverallNoDetailData = new List<Fetch_Details_of_overall_no>();
            string Total_marks = kinder_RP.get_overall_total_grade_to_grade(Session_id, Class_id, admission_no, Branch_id, Term_id);
            string[] stringSeparatorss = new string[] { "/" };
            ...
            string Total_marksT2 = kinder_RP.get_overall_total_grade_to_grade(Session_id, Class_id, admission_no, Branch_id, Term_idII);
            string[] stringSeparator = new string[] { "/" };
            string[] arr = Total_marksT2.Split(stringSeparator, StringSplitOptions.None);

            string gradeT2 = arr[0];
            string gradeBGT2 = arr[1];
            string ifbgColorLftT2 = "";
            string ifbgColorRghtT2 = "";
            string grade_bg_classT2 = "";
            if (gradeBGT2.Length == 7)
            {
                gradeBGT2 = "background:" + gradeBGT2;
                grade_bg_classT2 = "gradeBGCls";
                ifbgColorLftT2 = "bgColorPddL";
                ifbgColorRghtT2 = "bgColorPddR";
            }


            string attendanceT1 = get_attendance(Session_id, Class_id, admission_no, Branch_id, Term_id);
            string[] stringSeparatoratt = new string[] { "月" };
            string[] arratt = attendanceT1.Split(stringSeparatoratt, StringSplitOptions.None);
            string totalClasses = arratt[0];
            string totalPClasses = arratt[1];

            string attendanceT2 = get_attendance(Session_id, Class_id, admission_no, Branch_id, Term_idII);
            string[] stringSeparatoratt2 = new string[] { "月" };
            string[] arratt2 = attendanceT2.Split(stringSeparatoratt2, StringSplitOptions.None);
            string totalClasses2 = arratt2[0];
            string totalPClasses2 = arratt2[1];


            string remarkssT1 = get_remarks(Session_id, Branch_id, Class_id, Term_id, admission_no);  // REMARKS 
            string remarkssT2 = get_remarks(Session_id, Branch_id, Class_id, Term_idII, admission_no);  // REMARKS 

            string promot_to_class = get_promot_to_class(Session_id, Branch_id, Class_id, admission_no, Section);
            string[] stringSeparatorssP = new string[] { "月" };
            string[] arrp = promot_to_class.Split(stringSeparatorssP, StringSplitOptions.None);
            string promot_to_classss = arrp[0];
            string school_reopen_on = arrp[1];
            ...
            MyOverallNoDetailData.Add(new Fetch_Details_of_overall_no
            {
                ...
                GradeT2 = gradeT2,
                gradebgallT2 = gradeBGT2,
                Grade_bg_classT2 = grade_bg_classT2,
                IfbgColorLT2 = ifbgColorLftT2,
                IfbgColorRT2 = ifbgColorRghtT2,

                TotalClassesT1 = totalClasses,
                TotalPClassesT1 = totalPClasses,

                TotalClassesT2 = totalClasses2,
                TotalPClassesT2 = totalPClasses2,
                RemarkssT1 = remarkssT1,
                RemarkssT2 = remarkssT2,
        ...
        private string get_remarks(string session_id, string branch_id, string class_id, string term_id, string admission_no)
        {
        ...
        private string get_attendance(string session_id, string class_id, string admission_no, string branch_id, string term_id)
        {
            string returN = "0月0";
            string querys = "select Total_no_of_class,No_of_class_Attendance as No_of_class_persent from Exam_Term_Wise_Attendance where Session_id='" + session_id + "' and Admission_no='" + admission_no + "' and Class_id='" + class_id + "' and Exam_Term_Id='" + term_id + "'";
            DataTable dt = My.dataTable(querys);
            if (dt.Rows.Count > 0)
            {
                returN = dt.Rows[0]["Total_no_of_class"].ToString() + "月" + dt.Rows[0]["No_of_class_persent"].ToString();
            }
            return returN;
        }
        ...
        private List<Fetch_Details_of_Signature> findSigDetails(string Session_id, string admission_no, string Class_id, string Branch_id, string Section)
        {
            ...
            else
            {
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    {
                        stgnature = kinder_RP.get_class_teacher_signature(Session_id, Class_id, Section, Branch_id);
                    }
                    if (dr["Signature_type"].ToString() == "2")
                    {
                        stgnature = kinder_RP.get_principal_signature(Session_id, Branch_id);
                    }
                    if (dr["Signature_type"].ToString() == "3")
                    {
                        stgnature = kinder_RP.get_examinee_or_parent_signature(Session_id, Branch_id, dr["Signature_type_e_p"].ToString());
                    }
        ...
        private List<Fetch_Details_of_report_head> findSubjectHeadings(string Session_id, string Class_id, string Branch_id, string Term_id)
        {
            ...
            else
            {
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    if (i == 1)
                    {
                        extra_marks = kinder_RP.get_extra_marks(Class_id, Branch_id);
                        if (extra_marks != "0")
                        {
        ...
        //================================= DescplinES
        private List<Fetch_Details_of_report_descpline> findDescplineData(string Session_id, string Admission_no, string Class_id, string Branch_id, string Term_id, string Term_idII)
        {
            ...
            else
            {
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    if (isNum == true)
                    {
                        grade = kinder_RP.get_personality_grade(Session_id, Class_id, Branch_id, dr["Term_grade"].ToString());
                    }
                    else
                    {
                    ...
                    DataTable dtT2 = My.dataTable("select ptt.*, pt.Activity_name from Exam_Personality_Traits_Term_Wise ptt join Exam_Personality_Traits pt on ptt.Activity_Id = pt.Activity_Id where ptt.Session_id ='" + Session_id + "' and ptt.Branch_id = '" + Branch_id + "' and ptt.Class_id=" + Class_id + " and  ptt.Admission_no = '" + Admission_no + "' and ptt.Activity_Id='" + dr["Activity_Id"].ToString() + "' and ptt.Exam_Term_Id='" + Term_idII + "'");
                    string gradeT2 = "";
                    if (dtT2.Rows.Count > 0)
                    {
                        bool isNumT2 = valid_amount(dtT2.Rows[0]["Term_grade"].ToString());
                        if (isNumT2 == true)
                        {
                            gradeT2 = kinder_RP.get_personality_grade(Session_id, Class_id, Branch_id, dtT2.Rows[0]["Term_grade"].ToString());
                        }
                        else
                        {
                            gradeT2 = dtT2.Rows[0]["Term_grade"].ToString();
                        }
                    }
        ...
        private List<Fetch_Details_of_report_grade_remark> findGradeRemarkData(string Session_id, string Admission_no, string Class_id, string Branch_id, string Term_id)
        {
            ...
            string sys_grade_id = kinder_RP.get_co_scholastic_system_grade_id(Session_id, Class_id, Admission_no, Branch_id, Term_id);
        ...
        private List<MySubjectMarkShowII> findSubjectMarkShowII(string Admission_no, string Session_id, string Class_id, string Branch_id, string Term_id, string firm_id, string Term_idII)
        {
            ...
            else
            {
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    List<MySubjectMarkDetailsIIISem2> MBdetailsIIISem2 = findmyMarksIIISem2(dr["Subject"].ToString(), Admission_no, Session_id, Class_id, Branch_id, Term_idII);

                    string Total_marks = kinder_RP.get_subject_total_marks(dr["Session_id"].ToString(), dr["Class_id"].ToString(), dr["Admission_no"].ToString(), dr["Term"].ToString(), dr["Subject"].ToString(), dr["Branch_id"].ToString(), "Scholastic");
                    ...
                    string percent_remark = kinder_RP.get_percent_remark(overall_percent);
                    //QQQQQRRRR
                    string url = "";
                    string markType = "";
                    ...
                    MySubjectMarkShowItemII.Add(new MySubjectMarkShowII
                    {
                        ...
                        MySubjectMarkItemIIISem2 = MBdetailsIIISem2
                    });
                }
            }
        ...
        private List<MySubjectMarkDetailsIII> findmyMarksIII(string Subject_id, string Admission_no, string Session_id, string Class_id, string Branch_id, string Term_id)
        {
            ...
            else
            {
                foreach (DataRow dr in dt.Rows)
                {
                    string marks = kinder_RP.get_marks(dr["Session_id"].ToString(), dr["Class_id"].ToString(), Admission_no, dr["Term"].ToString(), dr["Assessment"].ToString(), Subject_id, dr["Branch_id"].ToString(), "Scholastic");
        ...
        private List<MySubjectMarkDetailsIIISem2> findmyMarksIIISem2(string Subject_id, string Admission_no, string Session_id, string Class_id, string Branch_id, string Term_id)
        {
            List<MySubjectMarkDetailsIIISem2> MySubjectMarkItemIIISem2 = new List<MySubjectMarkDetailsIIISem2>();
            string query = "select DISTINCT t1.Session_id,t1.Class_id,t1.Exam_Term_Id as Term,t1.Assessment_Id as Assessment,t1.Branch_Id,t1.Assessment_Name,t1.Sequence_No from Exam_Assessment_Details t1 where t1.Session_Id=" + Session_id + " and t1.Branch_id='" + Branch_id + "' and t1.Class_id=" + Class_id + " and t1.Exam_Term_Id=" + Term_id + " and t1.Scholastic_Co_scholastic='Scholastic' order by t1.Sequence_No asc";
            SqlDataAdapter ad = new SqlDataAdapter(query, My.con);
            DataSet ds = new DataSet();
            ad.Fill(ds, "Exam_marks");
            ...
            else
            {
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    MySubjectMarkItemIIISem2.Add(new MySubjectMarkDetailsIIISem2
                    {
                        Marks = obt_marks,
                        Total_marks = "0",
                        gradebgss = gradeBG,
            ...
            return MySubjectMarkItemIIISem2;
        }
