<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="report-card.aspx.cs" Inherits="school_web.Examination_Admin.slip.kinder.report_card" %>
                                ...
                                <div class="subs-mrks-area-dv">
                                    <table>
                                        ...
                                        <tr data-ng-repeat="item in x.MySubjectMarkShowItemII track by $index">
                                            ...
                                            <td class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}" data-ng-repeat="itemx in item.MySubjectMarkItemIII track by $index"><span class="{{itemx.Gbgclass}}" style="{{itemx.GradeBG}}">{{itemx.Marks}}</span></td>
