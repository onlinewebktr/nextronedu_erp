<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="print-admit-d-shift-portrait.aspx.cs" Inherits="school_web.Examination_Admin.slip.print_admit_d_shift_portrait" %>
    ...
    <form id="form1" runat="server">
        <div class="invoice-sec" data-ng-app="RpCardApp" data-ng-controller="RpCardAppCtrl" runat="server" id="admitcrdDV">
            ...
            <div id="tblPrintIQ" runat="server">
                <div class="printpagewprs" style="margin: 0 auto; padding: 0; width: 850px; height: auto;">
                    <div class="invoice-inr-sec {{x.WhatDiv}}" style="float: left; width: 100%;" data-ng-repeat="x in reportAdmitS track by $index">
                        <div class="printheadse333">
                            <div class="invoice-wpr {{x.WhatDivTB}}">
                                <div class="printpage-sec-main" style="height: 580px;">
                                    ...
                                    <div class="acardd" style="margin: -6px 0px 0px 0px;">
                                    ...
                                    <div class="nammarggg">
                                        <div class="stdinfodv" id="stdDt1" runat="server">
                                            <div class="stdinfodv1sts">
                                                ...
                                                <div class="nameheadss {{x.IsadmitcardNoShow}}">
                                        ...
                                        <div class="studimggr" style="margin: -48px 0px 0px 0px; background: #fff;">
                                    ...
                                    <div class="administration-paragraph timetb">
                                        <table class="{{x.MySchoolDetailsItem[0].Programe}}">
                                            ...
                                            <tr>
                                                ...
                                                <th>DATE</th>
                                                <th>SUBJECT</th>
                                                <th style="width: 145px;">Sign. of the invig.</th>
                                                <th>SUBJECT</th>
                                                <th style="width: 145px;">Sign. of the invig.</th>
                                            </tr>
                                            <tr data-ng-repeat="item in x.MyRoutineDetailsItem track by $index">
                                                <td>{{$index+1}}</td>
                                                <td style="text-transform: uppercase">{{item.Exam_date}} ({{item.Day}})</td>
                                                <td style="text-transform:uppercase">{{item.Subject_name1}}</td>
                                                <td></td>
                                        ...
                                        <div class="courses-sec33" style="display: none">
                                            <table>
                                                <tr>
                                        ...
                                        <div class="sig-dv {{x.SignWirhSetting}}" style="bottom: 5px;">
                                            <div class="sig-left">
