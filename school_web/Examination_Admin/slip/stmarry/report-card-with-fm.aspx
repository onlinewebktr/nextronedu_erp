<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="report-card-with-fm.aspx.cs" Inherits="school_web.Examination_Admin.slip.stmarry.report_card_with_fm" %>
    ...
    <form id="form1" runat="server">
                            ...
                            <div class="report-card-wpr" style="height: 1292px">
                                <div class="report-card-head {{x.Content_header}}">
                                    ...
                                    <div class="report-card-cntr-dv">
                                        ...
                                        <h2 class="report-card-rprt-crd">{{x.Term_name}} REPORT CARD</h2>
                                    </div>
                                    <asp:Label ID="lbl_aff_no" class="report-card-schl-affno" runat="server">{{x.Frim_aff_no}}</asp:Label>
                                </div>
                                ...
                                <div class="subs-mrks-area-dv">
                                    <table>
                                        ...
                                        <tr data-ng-repeat="item in x.MySubjectMarkShowItemII track by $index">
                                            ...
                                            <td class="{{x.MySubjectMarkShowItemII[0].Is_text_center}} {{itemx.For_obt_mrk_css}}" data-ng-repeat="itemx in item.MySubjectMarkItemIII track by $index">{{itemx.Marks}}</td>
                                ...
                                <div class="subs-mrks-area-lft-dv">
                                    <div class="subs-mrks-area-b-dv" style="margin-top: 2px}}">
                                        <table>
                                            <tr>
                                                <th>B</th>
        ...
        <script type="text/javascript">
            ...
            app.controller('RpCardAppCtrl', function ($scope, $http) {
                ...
                $http.get("api/report-card-full-m.asmx/fetch_rp_card_bulks", { params: { "Session_id": session_id, "Class_id": class_id, "Section": section, "Branch_id": branch_id, "Term_id": term_id, "Adm_no": adm_no } }).then(function (response) {
