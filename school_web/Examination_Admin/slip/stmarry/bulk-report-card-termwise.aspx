<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bulk-report-card-termwise.aspx.cs" Inherits="school_web.Examination_Admin.slip.stmarry.bulk_report_card_termwise" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function PrintPanel() {
            ...
            printWindow.document.write('<link href="../assets/css/onprintCSS.css" rel="stylesheet" /><link href="../assets/css/report-card.css" rel="stylesheet" type="text/css" />');
    ...
    <form id="form1" runat="server">
        <div class="invoice-sec" data-ng-app="RpCardApp" data-ng-controller="RpCardAppCtrl">
            ...
            <div id="tblPrintIQ" runat="server">
                <div class="invoice-inr-sec {{x.MySubjectMarkShowItemII[0].PrintShow}}" data-ng-repeat="x in reportCardS track by $index">
                    <div class="invoice-height-manage">
                        <div class="invoice-wpr">
                            ...
                            <div class="report-card-wpr" style="height: {{x.MySubjectMarkShowItemII[0].Height_dv}}">
                                ...
                                <div class="{{x.MySubjectMarkShowItemII[0].duesclassdesabled2}}"></div>
                                ...
                                <div class="report-card-std-info-dv">
                                    ...
                                    <div class="report-card-std-info-dv-50">
                                        ...
                                        <p class="stds-info-p {{x.MySubjectMarkShowItemII[0].Ranksdv}}">
                                            ...
                                            <asp:Label ID="Label1" runat="server" Text="{{x.MySubjectMarkShowItemII[x.MySubjectMarkShowItemII[0].Rowcounts].Rank}}"></asp:Label>
                                        </p>
                                        <p class="stds-info-p">
                                ...
                                <div class="subs-mrks-area-dv">
                                    <table>
                                        ...
                                        <tr data-ng-repeat="item in x.MySubjectMarkShowItemII track by $index">
                                            ...
                                            <td class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}" data-ng-repeat="itemx in item.MySubjectMarkItemIII track by $index"><span class="{{item.PassoRFail}}">{{itemx.Marks}}</span></td>
                                ...
                                <div class="subs-mrks-area-rght-dv">
                                    <div class="subs-mrks-area-ovrall-dv" style="margin-top: {{x.MySubjectMarkShowItemII[0].Overall_area_margn}}">
                                        <table>
                                            ...
                                            <tr class="{{x.MySubjectMarkShowItemII[0].SpecialNote}}">
                                                <td class="spcial-notes" colspan="2"><p style="margin: 0px 0px 10px 0px;">REMARKS : <span class="{{x.MySubjectMarkShowItemII[0].Remarkss}}">{{x.MySubjectMarkShowItemII[0].Remarkss}}</span> </p></td>
                                            </tr>
                                        </table>
                                    </div>
                                    ...
                                    <%--<div class="remarks-rp {{x.MySubjectMarkShowItemII[0].Remarkss}}">
                                     ...
                                     <div class="{{x.MySubjectMarkShowItemII[0].duesclassdesabled}}">{{x.MySubjectMarkShowItemII[0].Desabletext}}</div>
                                ...
                                <div class="instruction-dv-fr-auto-bottom">
                                    ...
                                    <div class="instruction-50  instruction-50-pl">
                                        <div class="instruction-tbls floatrght">
                                            ...
                                            <div class="rankdvs v-false {{x.MySubjectMarkShowItemII[0].Ranksdv}}" style="margin-top: {{x.MySubjectMarkShowItemII[0].Toppers_area_margn}}">
                                                <table>
                                                    <tr>
        ...
        <script type="text/javascript">
            ...
            app.controller('RpCardAppCtrl', function ($scope, $http) {
                ...
                $http.get("api/bulk-report-card.asmx/fetch_rp_card_bulks", { params: { "Session_id": session_id, "Class_id": class_id, "Section": section, "Branch_id": branch_id, "Term_id": term_id, "UserType": userType } }).then(function (response) {
