<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="final-rp-new.aspx.cs" Inherits="school_web.Examination_Admin.slip.stmarry.final_rp_new" %>
    ...
    <form id="form1" runat="server">
                    ...
                    <div class="invoice-wpr" style="border-color: background: {{x.MySubjectMarkShowItem[0].ThemeColor}}">
                        ...
                        <div class="report-card-wpr" style="height: {{x.MySubjectMarkShowItem[0].Height_dv}};">
                            ...
                            <div class="report-card-head {{x.MyFirmDetailData[0].Content_header}}">
                                ...
                                <div class="report-card-cntr-dv">
                                    <asp:Label ID="Label3" class="report-card-schlname" runat="server">{{x.MyFirmDetailData[0].Firm_name}}</asp:Label>
                                    <asp:Label ID="Label7" class="report-card-schl-affno-by" runat="server">{{x.MyFirmDetailData[0].Affiliated_by_full_text}}</asp:Label>
                                    <asp:Label ID="Label11" runat="server" class="report-card-schl-add">{{x.MyFirmDetailData[0].Firm_address}}</asp:Label>

                                    <asp:Label ID="Label12" runat="server" Text="{{x.MyFirmDetailData[0].Firm_contact_no}}" class="report-card-schl-cont v-false {{x.MySubjectMarkShowItem[0].Is_contact_no_show}}"></asp:Label>
                                    <p class="report-card-schl-emil v-false {{x.MySubjectMarkShowItem[0].Is_email_show}}">
                                        Email :
                                        <asp:Label ID="Label13" runat="server">{{x.MyFirmDetailData[0].Firm_email}}</asp:Label>
                                    </p>

                                    <p class="report-card-schl-emil v-false {{x.MySubjectMarkShowItem[0].Is_website_show}}">
                                        Website :
                                        <asp:Label ID="Label14" runat="server">{{x.MyFirmDetailData[0].Website}}</asp:Label>
                                    </p>
                                    <h2 class="report-card-ac-sson">ACADEMIC SESSION :
                                        <asp:Label ID="lbl_sessions" runat="server">{{x.Session}}</asp:Label></h2>
                                    <h2 class="report-card-rprt-crd">FINAL REPORT CARD</h2>
                                </div>
                                <asp:Label ID="Label15" class="report-card-schl-affno" runat="server" Text="{{x.MySubjectMarkShowItem[0].Aff_text}} : {{x.MyFirmDetailData[0].Frim_aff_no}}"></asp:Label>
                            </div>
                            ...
                            <div class="report-card-std-info-dv">
                                ...
                                <div class="report-card-std-info-dv-50">
                                    ...
                                    <p class="stds-info-p">
                                        <i class="stds-info-p-i">CLASS SECTION</i>  <i class="stds-info-p-doti">:</i>
                                        <asp:Label ID="Label9" runat="server" Text="{{x.For_class}} {{x.Section}}"></asp:Label>
                                    </p>
                                    <p class="stds-info-p">
                            ...
                            <div class="subs-mrks-area-dv">
                                <table>
                                    <tr>
                                        ...
                                        <th class="txt-center" colspan="3">OVERALL</th>
                                    </tr>
                                    <tr>
                                        <th>SN</th>
                                        <th style="min-width: 130px;">SUBJECTS</th>
                                        ...
                                        <%--<th>{{x.MySubjectMarkShowItem[0].TermI_grade_head}} <span class="{{x.MySubjectMarkShowItem[0].If_is_mrk_hide}}">({{x.MySubjectHeading[0].Term_Maximum_Marks}})</span></th>--%>
                                        ...
                                        <%--<th>{{x.MySubjectMarkShowItem[0].TermII_grade_head}} <span class="{{x.MySubjectMarkShowItem[0].If_is_mrk_hide}}">({{x.MySubjectHeadingII[0].Term_Maximum_Marks}})</span></th>--%>


                                        <th class="{{x.MySubjectMarkShowItem[0].Overall_av_marks}} {{x.MySubjectMarkShowItem[0].Is_text_center}}">GRAND TOTAL (200)</th>
                                    ...
                                    <tr data-ng-repeat="item in x.MySubjectMarkShowItem track by $index">
                                        ...
                                        <td class="{{x.MySubjectMarkShowItem[0].Is_text_center}}">{{item.HighestMarks}}</td>
                                    </tr>
                                    <%--<tr>
                                    ...
                                    <tr>
                                        <td colspan="2" class="font-weight600">TOTAL MARKS</td>
                                        <td colspan="{{x.MySubjectHeading[0].TermColSpan}}" class="txt-center font-weight600">{{x.MyTotalsDetailsItem[0].T1ObtMark}}</td>
                                        <td colspan="{{x.MySubjectHeading[0].TermColSpan}}" class="txt-center font-weight600">{{x.MyTotalsDetailsItem[0].T2ObtMark}}</td>
                                        <td colspan="3" class="txt-center font-weight600">{{x.MyTotalsDetailsItem[0].Overall_obt_marks}}</td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" class="font-weight600">PERCENTAGE</td>
                                        ...
                                        <td colspan="3" class="txt-center font-weight600">{{x.MyTotalsDetailsItem[0].Overall_percents}}</td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" class="font-weight600">RANK</td>
                                        <td colspan="{{x.MySubjectHeading[0].TermColSpan}}" class="txt-center font-weight600">{{x.MyTotalsDetailsItem[0].RanksT1}}</td>
                                        <td colspan="{{x.MySubjectHeading[0].TermColSpan}}" class="txt-center font-weight600">{{x.MyTotalsDetailsItem[0].RanksT2}}</td>
                                        <td colspan="3" class="txt-center font-weight600">{{x.MyTotalsDetailsItem[0].RanksFinal}}</td>
                                    </tr>
                            ...
                            <div class="subs-mrks-area-rght-dv">
                                <div class="subs-mrks-area-ovrall-dv"  style="padding: 3px 0px 0px 0px;">
                                    ...
                                    <div class="instruction-tbls" style="margin-top: 4px">
                                        <table>
                                            <tr>
        ...
        <script type="text/javascript">
            ...
            app.controller('RpCardAppCtrl', function ($scope, $http) {
                ...
                $http.get("api/final-rp-card-bulk-new.asmx/fetch_rp_card_bulks", { params: { "Session_id": session_id, "Class_id": class_id, "Section": section, "Branch_id": branch_id, "Term_idI": term_id, "Term_idII": term_id2, "Adm_no": adm_no } }).then(function (response) {
