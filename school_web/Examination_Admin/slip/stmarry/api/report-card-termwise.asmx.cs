...
{
    /// <summary>
    /// Summary description for report_card_termwise
    /// </summary>
    ...
    public class report_card_termwise : System.Web.Services.WebService
    {
        My mycode = new My();
        ...
        public void fetch_rp_card_subjects(string Session_id, string Class_id, string Admission_no, string Branch_id, string Term_id)
        {
            ...
            {
                string check_is_dues = Exam_setting.check_dues(Session_id, Class_id, Admission_no, Term_id);
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    //========================
                    string isDues = "hidden"; string isDues2 = "hidden"; string desabletext = "";
