...
namespace school_web.Examination_Admin.slip.stmarry.api
{
    ...
    public class report_card : System.Web.Services.WebService
    {
        ...
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        public void fetch_rp_card_subjects(string Session_id, string Class_id, string Admission_no, string Branch_id, string Term_id, string UserType)
        {
            ...
            else
            {
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    string Full_mark_of_a_subject = arrs[49];   // WhatHeadShow
                    //QQQQQRRRR 
                    string url = "";
        ...
        public void fetch_rp_card_signature(string Session_id, string Class_id, string Admission_no, string Branch_id)
        {
            ...
            {
                string Section = termwise.get_student_section(Session_id, Admission_no, Branch_id, Class_id);
                foreach (DataRow dr in dt.Rows)
                {
                    string stgnature = "";
        ...
        {
            string section = termwise.get_section(Session_id, Class_id, Admission_no, Branch_id);
