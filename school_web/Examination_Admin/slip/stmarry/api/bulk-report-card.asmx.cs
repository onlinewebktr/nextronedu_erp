...
namespace school_web.Examination_Admin.slip.stmarry.api
{
    ...
    public class bulk_report_card : System.Web.Services.WebService
    {
        ...
        public void fetch_rp_card_bulks(string Session_id, string Class_id, string Section, string Branch_id, string Term_id, string UserType)
        {
            ...
            else
            {
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    List<MySubjectMarkShowII> MBdetails = findSubjectMarkShowII(dr["Admission_no"].ToString(), Session_id, Class_id, Branch_id, Term_id, UserType);
        ...
        private List<MySubjectMarkShowII> findSubjectMarkShowII(string Admission_no, string Session_id, string Class_id, string Branch_id, string Term_id, string UserType)
        {
            ...
            else
            {
                ...
                if (UserType != "Admin")
                {
                    check_is_dues = Exam_setting.check_dues(Session_id, Class_id, Admission_no, Term_id);
                }
                string rank = "0";
                string isChecked = "0";
                foreach (DataRow dr in dt.Rows)
