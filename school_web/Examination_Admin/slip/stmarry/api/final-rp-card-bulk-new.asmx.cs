...
{
    /// <summary>
    /// Summary description for final_rp_card_bulk_new
    /// </summary>
    ...
    public class final_rp_card_bulk_new : System.Web.Services.WebService
    {
        My mycode = new My();
        ...
        private List<MySubjectMarkShow> findSubjectMarkShow(string Admission_no, string Session_id, string Class_id, string Branch_id, string Term_idI, string Term_idII, string Section)
        {
            ...
            else
            {
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    //else
                    //{
                    if (40 > My.toDouble(Total_mark_of_a_subject_for_termI_final))
                    {
                        IsPassI = "SubjFail";
                        stMarry_final.save_fail_history(Session_id, Branch_id, Class_id, dr["Subject_id"].ToString(), Admission_no, Term_idI);
                    }
                    ...
                    //else
                    //{
                    if (40 > My.toDouble(Total_mark_of_a_subject_for_termII_final))
                    {
                        IsPassII = "SubjFail";
