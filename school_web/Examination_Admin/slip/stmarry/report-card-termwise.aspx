<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="report-card-termwise.aspx.cs" Inherits="school_web.Examination_Admin.slip.stmarry.report_card_termwise" %>
    ...
    <form id="form1" runat="server">
                            ...
                            <div class="report-card-std-info-dv">
                                ...
                                <div class="report-card-std-info-dv-50">
                                    ...
                                    <p class="stds-info-p" runat="server" id="ranksDV" visible="false">
                                        ...
                                        <asp:Label ID="lbl_rank" runat="server" Text="{{reportCardSubS[reportCardSubS[0].Rowcounts].Rank}}"></asp:Label>
                                    </p>
                            ...
                            <div class="subs-mrks-area-dv">
                                <table>
                                    ...
                                    <tr data-ng-repeat="x in reportCardSubS track by $index">
                                        ...
                                        <td class="{{reportCardSubS[0].Is_text_center}}" data-ng-repeat="item in x.MySubjectMarkItem track by $index"><span class="{{x.PassoRFail}}">{{item.Marks}}</span></td>
                                    ...
                                    <table>
                                        ...
                                        <tr class=" {{reportCardSubS[0].SpecialNote}}">
                                            <td class="spcial-notes" colspan="2">
                                                <p style="margin: 0px 0px 10px 0px;">REMARKS : <span class="{{reportCardSubS[0].Remarkss}}">{{reportCardSubS[0].Remarkss}}</span></p>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                            ...
                            <div class="instruction-dv-fr-auto-bottom">
                                ...
                                <div class="instruction-50 instruction-50-pl">
                                    <div class="instruction-tbls floatrght">
                                        ...
                                        <div class="rankdvs v-false {{reportCardSubS[0].Ranksdv}}" style="margin-top: {{reportCardSubS[0].Toppers_area_margn}}">
                                            <table>
                                                <tr>
        ...
        <script type="text/javascript">
            ...
            app.controller('RpCardAppCtrl', function ($scope, $http) {
                ...
                $http.get("api/report-card.asmx/fetch_rp_card_subjects", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id, "Term_id": term_id, "UserType": userType } }).then(function (response) {
