    ...
    public partial class final_report_card : System.Web.UI.Page
    {
        ...
        private void find_terms()
        {
            ...
            if (dt.Rows.Count == 3)
            {
                ...
                termITexts3.Text = dt.Rows[2]["Short_Name"].ToString();
        ...
        private void bind_student_info()
        {
            ...
            if (dt.Rows.Count != 0)
            {
                ...
                lbl_for_term.Text = "FINAL ASSESSMENT ";
                lbl_for_term1.Text = "FINAL ASSESSMENT ";
        ...
        private void Bind_schoolinfo()
        {
            ...
            else
            {
                ...
                if (dt.Rows[0]["Affiliation"].ToString() == "" || dt.Rows[0]["Affiliation"].ToString() == "NA")
                {
                    lbl_aff_no1.Visible = false;
