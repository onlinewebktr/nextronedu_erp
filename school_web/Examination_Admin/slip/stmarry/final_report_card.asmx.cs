...
{ 
    /// <summary>
    /// Summary description for final_report_card1
    /// </summary>
    ...
    public class final_report_card1 : System.Web.Services.WebService
    {

        //========================
        public class Fetch_Details_of_report_head_term
        {
        ...
        List<Fetch_Details_of_report_head_term> Show_of_report_head_term = new List<Fetch_Details_of_report_head_term>();
        [WebMethod]
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        public void fetch_report_card_terms_dt(string Session_id, string Class_id, string Branch_id)
        {
            ...
            else
            {
                ...
                {
                    Show_of_report_head_term.Add(new Fetch_Details_of_report_head_term
                    {
                ...
                Context.Response.Write(js.Serialize(Show_of_report_head_term));
            }
        }
        ...
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        public void fetch_rp_card_subjects(string Session_id, string Class_id, string Admission_no, string Branch_id, string Term_idI, string Term_idII, string Term_idIII, string UserType)
        {
            string section = get_Section(Session_id, Class_id, Admission_no);
            My.exeSql("delete from Exam_temp_assesment_total_no where Session_id='" + Session_id + "' and Admission_no='" + Admission_no + "'; delete from Exam_temp_assesment_total_no_term_II where Session_id='" + Session_id + "' and Admission_no='" + Admission_no + "'; delete from  Exam_marks  where Session_id='" + Session_id + "' and Admission_no='" + Admission_no + "' and Created_by='AI'");
            ...
            { 
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    string sub_highest_mark =  get_highest_mark(dr["Subject_id"].ToString(), Session_id, Class_id, dr["Section"].ToString()); //get_highest_mark(Session_id, Class_id, Branch_id, dr["Subject_id"].ToString(), Admission_no, Term_idI, Term_idII, Term_idIII);
                    ...
                    //My.exeSql("delete from Exam_fail_history_subjectwise where Session_Id=" + Session_id + " and Branch_id='" + Branch_id + "' and Class_id=" + Class_id + " and Subject_id=" + dr["Subject_id"].ToString() + " and Admission_no='" + Admission_no + "' and Term_id=" + Term_idI + ";delete from Exam_fail_history_subjectwise where Session_Id=" + Session_id + " and Branch_id='" + Branch_id + "' and Class_id=" + Class_id + " and Subject_id=" + dr["Subject_id"].ToString() + " and Admission_no='" + Admission_no + "' and Term_id=" + Term_idII + "; delete from Exam_fail_history_subjectwise where Session_Id=" + Session_id + " and Branch_id='" + Branch_id + "' and Class_id=" + Class_id + " and Subject_id=" + dr["Subject_id"].ToString() + " and Admission_no='" + Admission_no + "' and Term_id=" + Term_idIII + "");
                    ...
                    //========================
                    string isDues = "hidden"; string isDues2 = "hidden"; string desabletext = ""; string printBTN = "";
        ...
        private string get_Section(string session_id, string class_id, string admission_no)
        {
            string section = "";
            DataTable dt = My.dataTable("select Section from admission_registor where Session_id='" + session_id + "' and Class_id='" + class_id + "' and admissionserialnumber='" + admission_no + "' and Status='1'");
            if (dt.Rows.Count > 0)
            {
        ...
        //    else
        //    {
        //        string Term_iii_mark = "0"; string Term_iii_max_mark = "0"; string Term_iii_full_mark = "0";
        //        string systm_grade_id = exam_ips_I.get_systm_grd_id(Subject_id, Session_id, Class_id, Branch_id, Term_id);
        //        foreach (DataRow dr in dt.Rows)
        //        {
        //            #region FindAllTerM
        //            string thridTerM = "0";
        //            string querytrm = "select Exam_Term_Id from Exam_Term_Details where Class_id='" + Class_id + "' and Session_Id='" + Session_id + "' and Branch_Id='" + Branch_id + "' order by Sequence_No asc";
        //            DataTable dttrm = mycode.FillData(querytrm);
        //            if (dttrm.Rows.Count == 3)
        //            {
        //                thridTerM = dttrm.Rows[0]["Exam_Term_Id"].ToString();


        //                //FindThirdTermData
        //                string queryIII = "select t1.Marks as Term_iii_mark,t1.Full_marks as Term_iii_full_mark, t1.Maximum_mark as Term_iii_max_mark from  Exam_temp_assesment_total_no_term_II t1 join Exam_Assessment_Details t3 on t1.Session_Id=t3.Session_Id and t1.Branch_Id=t3.Branch_Id and t1.Term_id=t3.Exam_Term_Id and t1.Class_id=t3.Class_id and t1.Assessment_id=t3.Assessment_Id where t1.Session_id=1 and t1.Admission_no='" + Admission_no + "' and t1.Subject_id='" + Subject_id + "' and t1.Branch_id='" + Branch_id + "' and t1.Class_id=" + Class_id + " and t1.Term_id='" + thridTerM + "' order by t3.Sequence_No asc";
        //                DataTable dtIII = mycode.FillData(queryIII);
        //                if (dttrm.Rows.Count == 3)
        //                {
        //                    Term_iii_mark = dttrm.Rows[0]["Term_iii_mark"].ToString();
        //                    Term_iii_max_mark = dttrm.Rows[0]["Term_iii_max_mark"].ToString();
        //                    Term_iii_full_mark = dttrm.Rows[0]["Term_iii_full_mark"].ToString();
        //                }
        //            }
        ...
        //                double term_iii_ttl_mark = (My.toDouble(Term_iii_mark) * My.toDouble(Term_iii_max_mark)) / My.toDouble(Term_iii_full_mark);
        ...
        //                string term_III_grade = Examination.get_grade_final(Session_id, Branch_id, system_grade_id, term_iii_ttl_mark);
        //                Term_i_mark = term_I_grade;
        //                Term_ii_mark = term_II_grade;
        //                Term_iii_mark = term_III_grade;
        //            }
        ...
        [WebMethod]
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        public void fetch_report_card_coscholastic(string Session_id, string Class_id, string Admission_no, string Branch_id, string Term_idI, string Term_idII, string Term_idIII)
        {
        ...
        public class Fetch_Details_of_report_descipline
        {
            ...
            public string Term_III_grade { get; set; }
            public string RowCount { get; set; }
        }
        ...
        public void fetch_report_card_descipline(string Session_id, string Class_id, string Admission_no, string Branch_id, string Term_idI, string Term_idII)
        {
            ...
            else
            {
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    //string termIII_grade = Examination.get_descipline_number(Session_id, Branch_id, Class_id, Admission_no, Term_idII, dr["Assessment_id"].ToString());
                    ...
                    Show_of_report_descipline.Add(new Fetch_Details_of_report_descipline
                    {
                        ...
                        //Term_III_grade = termIII_grade,
                        //RowCount = dt.Rows.Count.ToString(),

                        Subject_name = dr["Activity_name"].ToString(),
                        Term_I_grade = grade_t1,
                        Term_II_grade = grade_t2,
                        Term_III_grade = grade_t3,
                        RowCount = dt.Rows.Count.ToString(),
                    });
                }
                JavaScriptSerializer js = new JavaScriptSerializer();
        ...
        [WebMethod]
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        public void fetch_rp_card_total_no(string Session_id, string Class_id, string Admission_no, string Branch_id, string Term_idI, string Term_idII, string Term_idIII)
        {
            string Total_marks = stMarry_final.get_overall_total_marks_final(Session_id, Class_id, Admission_no, Branch_id, Term_idI, Term_idII, Term_idIII);
            string[] stringSeparatorss = new string[] { "/" };
        ...
        {
            DataTable dtAssesment = My.dataTable("select * from Exam_Assessment_Details where Session_Id='" + session_id + "' and Exam_Term_Id='" + term_id + "' and Class_id='" + class_id + "' and Scholastic_Co_scholastic='Scholastic' and Istatus='1' order by Sequence_No asc");
        ...
        #region RankS
        public class Fetch_Details_of_report_rank
        {
            public string Rank { get; set; }
        }

        List<Fetch_Details_of_report_rank> Show_of_report_ranks = new List<Fetch_Details_of_report_rank>();
        [WebMethod]
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        public void fetch_rp_card_ranks(string Session_id, string Class_id, string Admission_no, string Branch_id, string Term_idI, string Term_idII, string Term_idIII)
        {
            ...
            else
            {
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    Show_of_report_ranks.Add(new Fetch_Details_of_report_rank
                    {
                        Rank = rank_data,
                    });
                }
                JavaScriptSerializer js = new JavaScriptSerializer();
                Context.Response.Write(js.Serialize(Show_of_report_ranks));
            }
        }
        ...
        //============================================
        public class Fetch_Details_of_promoted_to
        {
        ...
        List<Fetch_Details_of_promoted_to> Show_of_promoted_to = new List<Fetch_Details_of_promoted_to>();
        [WebMethod]
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        public void fetch_rp_card_promoted_to(string Session_id, string Class_id, string Admission_no, string Branch_id)
        {
            ...
            if (isStdTransfer == "Yes")
            {
                ...
                else
                {
                    foreach (DataRow dr in dt.Rows)
                    {
                        Show_of_promoted_to.Add(new Fetch_Details_of_promoted_to
                        {
                    ...
                    JavaScriptSerializer js = new JavaScriptSerializer();
                    Context.Response.Write(js.Serialize(Show_of_promoted_to));
                }
            }
            else
            {
