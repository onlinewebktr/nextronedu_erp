<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="report-card-termwise.aspx.cs" Inherits="school_web.Examination_Admin.slip.stpaul.report_card_termwise" %>
                                    ...
                                    <table>
                                        ...
                                        <tr class=" {{reportCardSubS[0].SpecialNote}}">
                                            <td class="spcial-notes" colspan="2">
                                                <p style="margin: 0px 0px 10px 0px;">REMARKS : <span class="{{ttlNos[0].P_remark}}">{{ttlNos[0].P_remark}}</span></p>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
