<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="final-report-card.aspx.cs" Inherits="school_web.Examination_Admin.slip.stpaul.final_report_card" %>
    ...
    <form id="form1" runat="server">
                        ...
                        <div class="report-card-wpr" style="height: {{reportCardSubS[0].Height_dv}}">
                            <div class="report-card-head {{reportCardSubS[0].Hdr_frst}}">
                                ...
                                <div class="report-card-cntr-dv">
                                    <asp:Label ID="lbl_school_name" class="report-card-schlname-new-font" runat="server"></asp:Label>

                                    <asp:Label ID="lbl_address" runat="server" class="report-card-schl-add"></asp:Label>
                                    <asp:Label ID="Label1" runat="server" class="report-card-schl-add" Text="Affiliated to CISCE New Delhi WB408"></asp:Label>
                                    <asp:Label ID="lbl_aff_text" Style="display: none" class="report-card-schl-affno-by" runat="server"></asp:Label>
                                    ...
                                    <h2 class="report-card-rprt-crd">
                                        ...
                                        REPORT CARD  <span class="{{reportCardSubS[0].Class_in_new_line}}" style="display: none"><span class="v-false {{reportCardSubS[0].Is_class_text_show}}">CLASS</span>
                                            <asp:Label ID="lbl_for_class" runat="server"></asp:Label></span></h2>
                                </div>
                                <asp:Label ID="lbl_aff_no" Style="display: none" class="report-card-schl-affno" runat="server"></asp:Label>
                                <div class="report-card-rght-dvss">
                                    <img src="about-St.-Paul.jpg" />
                                    <asp:Image ID="img_student_img" Style="display: none" runat="server" class="{{reportCardSubS[0].Is_std_img_hide}}" />
                                </div>
                            </div>
                            ...
                            <div class="report-card-std-info-dv">
                                ...
                                <div class="report-card-std-info-dv-50">
                                    ...
                                    <p class="stds-info-p {{reportCardSubS[0].Is_std_section_hide}}">
                                        ...
                                        <asp:Label ID="lbl_classs" runat="server"></asp:Label>
                            ...
                            <div class="subs-mrks-area-dv">
                                <table>
                                    <tr>
                                        <th>A</th>
                                        <th colspan="9" class="{{reportCardSubS[0].Is_text_center}}">SCHOLASTIC AREA</th>
                                        <%--<th class="txt-center">
                                    ...
                                    <tr>
                                        ...
                                        <td class=" {{reportCardSubS[0].Is_text_center}} font-weight600">{{ttlNos[0].Overall_obt_marks}}</td>
                                        <td class=" {{reportCardSubS[0].Is_text_center}} font-weight600">{{ttlNos[0].Overall_percents}}</td>
                                    </tr>
                                    <%--<tr>
                            ...
                            <div class="coscholstic-area-tbls-wprs">
                                <table>
                                    <tr>
                                        <th>B</th>
                                        <th colspan="4" class="{{reportCardSubS[0].Is_text_center}}">CO-SCHOLASTIC AREAS [{{reportCardTermII_coscholastic_data[0].RowCount}} - POINT GRADING SCALE]</th>
                                    </tr>
                                    <tr>
                            ...
                            <div class="instruction-grading-area-tbls-wprs">
                                <table>
                                    <tr>
                                        <th colspan="{{reportCardmarkRange[0].ColSpanPlus}}" class="txt-center">INSTRUCTIONS</th>
                                    </tr>
                                    <tr>
                                        <td colspan="{{reportCardmarkRange[0].ColSpanPlus}}" class="txt-center" style="font-size: 14px; font-weight: 600;">(Co-Scholastic Areas {{reportCardmarkRange[0].RowCount}}-point grading scale)</td>
                                    </tr>
                                    <tr>
                                        <td class="{{reportCardSubS[0].Is_text_center}}">MARKS RANGE</td>
                                        <td class="{{reportCardSubS[0].Is_text_center}}" data-ng-repeat="x in reportCardmarkRange">{{x.Lower_Range}}-{{x.Upper_Range}}</td>
                                    </tr>
                                    <tr>
                                        <td class="{{reportCardSubS[0].Is_text_center}}">GRADE</td>
                                        <td class="{{reportCardSubS[0].Is_text_center}}" data-ng-repeat="x in reportCardmarkRange">{{x.Grade}}</td>
                                    </tr>
                                </table>
                            </div>

                            <div class="attendance-area-tbls-wprs">
                                <table style="margin: 3px 0px 0px 0px;">
                                    <tr>
                                        <th colspan="5" class="{{reportCardSubS[0].Is_text_center}}">ATTENDANCE</th>
                                    </tr>
                                    <tr>
                                        <th></th>
                            ...
                            <%--<div class="promot-dvs  {{promoT[0].ShowStatuS}}">
                            ...
                            <div class="subs-mrks-area-rght-dv">
                                <div class="subs-mrks-area-ovrall-dv" style="margin-top: {{reportCardSubS[0].Overall_area_margn}}">
                                    <table>
                                        ...
                                        <tr class="{{reportCardSubS[0].Overall_obt_mark}}">
                                            <td>OVERALL RANK</td>
                                            <td class="{{reportCardSubS[0].Is_text_center}}">{{ranks[3].Rank}}</td>
                                        </tr>
                                    </table>
        ...
        <script type="text/javascript">
            ...
            app.controller('RpCardAppCtrl', function ($scope, $http) {
                ...
                $http.get("api/final_report_card.asmx/fetch_report_card_terms_dt", { params: { "Session_id": session_id, "Class_id": class_id, "Branch_id": branch_id } }).then(function (response) {
                    $scope.reportCardTerms = response.data;
                })


                $http.get("api/final_report_card.asmx/fetch_report_card", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id, "Term_id": term_id1 } }).then(function (response) {
                    $scope.reportCard = response.data;
                })

                //TERMII HEADING
                $http.get("api/final_report_card.asmx/fetch_report_card", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id, "Term_id": term_id2 } }).then(function (response) {
                    $scope.reportCardTermII = response.data;
                })

                //TERMIII HEADING
                $http.get("api/final_report_card.asmx/fetch_report_card", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id, "Term_id": term_id3 } }).then(function (response) {
                    $scope.reportCardTermIII = response.data;
                })

                $http.get("api/final_report_card.asmx/fetch_rp_card_subjects", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id, "Term_idI": term_id1, "Term_idII": term_id2, "Term_idIII": term_id3, "UserType": userType } }).then(function (response) {
                    ...
                    if ($scope.reportCardSubS == "") {
                        ...
                        ////========================OverAll No.
                        $http.get("api/final_report_card.asmx/fetch_rp_card_total_no", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id, "Term_idI": term_id1, "Term_idII": term_id2, "Term_idIII": term_id3 } }).then(function (response) {
                            $scope.ttlNos = response.data;
                        })


                        $http.get("api/final_report_card.asmx/fetch_rp_card_ranks", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id, "Term_idI": term_id1, "Term_idII": term_id2, "Term_idIII": term_id3 } }).then(function (response) {
                ...
                //CO-SCHOLASTIC DATA
                $http.get("api/final_report_card.asmx/fetch_report_card_coscholastic", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id, "Term_idI": term_id1, "Term_idII": term_id2, "Term_idIII": term_id3 } }).then(function (response) {
                ...
                $http.get("api/final_report_card.asmx/fetch_rp_card_assesment_full_name").then(function (response) {
                ...
                $http.get("api/final_report_card.asmx/fetch_rp_card_promoted_to", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id } }).then(function (response) {
