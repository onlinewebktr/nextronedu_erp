<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bulk-final-report-card.aspx.cs" Inherits="school_web.Examination_Admin.slip.stpaul.bulk_final_report_card" %>
    ...
    <form id="form1" runat="server">
                        ...
                        <div class="report-card-wpr" style="height: {{x.MySubjectMarkShowItem[0].Height_dv}}">
                            <div class="report-card-head">
                                ...
                                <div class="report-card-cntr-dv">
                                    <asp:Label ID="lbl_school_name" class="report-card-schlname-new-font" runat="server" Text="{{x.MyFirmDetailData[0].Firm_name}}"></asp:Label>
                                    <asp:Label ID="lbl_address" runat="server" class="report-card-schl-add" Text="{{x.MyFirmDetailData[0].Firm_address}}"></asp:Label>
                                    <asp:Label ID="lbl_aff_text" class="report-card-schl-affno-by" runat="server" Text="Affiliated to CISCE New Delhi WB408"></asp:Label>
                                    ...
                                    <h2 class="report-card-rprt-crd">FINAL REPORT CARD  <span class="{{x.MySubjectMarkShowItem[0].Class_in_new_line}}" style="display: none"><span class="v-false {{x.MySubjectMarkShowItem[0].Is_class_text_show}}">CLASS</span> {{x.For_class}}</span></h2>
                                </div>
                                <asp:Label ID="lbl_aff_no" Style="display: none" class="report-card-schl-affno" runat="server" Text="{{x.MySubjectMarkShowItem[0].Aff_text}} : {{x.MyFirmDetailData[0].Frim_aff_no}}"></asp:Label>
                                <div class="report-card-rght-dvss">
                                    <img src="about-St.-Paul.jpg" />
                                    <img src="{{x.Student_image}}" style="display: none" class="{{x.MySubjectMarkShowItem[0].Is_std_img_hide}} {{x.Student_image}}" />
                                </div>
                            </div>
                            ...
                            <div class="report-card-std-info-dv">
                                ...
                                <div class="report-card-std-info-dv-50">
                                    ...
                                    <p class="stds-info-p {{x.MySubjectMarkShowItem[0].Is_std_section_hide}}">
                                        ...
                                        <asp:Label ID="lbl_section" runat="server">{{x.For_class}} ({{x.Section}})</asp:Label>
                                    </p>
                                    <p class="stds-info-p">
                            ...
                            <div class="subs-mrks-area-dv">
                                <table>
                                    <tr>
                                        <th>A</th>
                                        <th colspan="9" class="{{x.MySubjectMarkShowItem[0].Is_text_center}}">SCHOLASTIC AREA</th>
                                    </tr>
                                    <tr>
                                        <th>SN</th>
                                    ...
                                    <tr>
                                        ...
                                        <td class=" {{x.MySubjectMarkShowItem[0].Is_text_center}} font-weight600">{{x.MyRpTotalCalculationItem[0].Overall_obt_marks}}</td>
                            ...
                            <div class="ttl-tbls-wprs">
                                <table>
                                    <tr>
                                        ...
                                        <td class="{{x.MySubjectMarkShowItem[0].Is_text_center}}">{{x.MyRpTotalCalculationItem[0].Overall_obt_marks}}/{{x.MyRpTotalCalculationItem[0].Overall_full_marks}}   ({{x.MyRpTotalCalculationItem[0].ObtMarkInWord}})</td>
                                    </tr>
                                    <tr>
                                        <td>OVERALL {{x.MyRpTotalCalculationItem[0].Mark_type}}</td>
                                        <td class="{{x.MySubjectMarkShowItem[0].Is_text_center}}">{{x.MyRpTotalCalculationItem[0].Overall_percents}} <span class="{{x.MySubjectMarkShowItem[0].Overall_obt_mark}}">(%)</span></td>
                                    </tr>
                                </table>
                            </div>
                            <div class="coscholstic-area-tbls-wprs">
                                <table>
                                    <tr>
                                        <th>B</th>
                                        <th colspan="4" class="{{x.MySubjectMarkShowItem[0].Is_text_center}}">CO-SCHOLASTIC AREAS [{{x.MyRpCoScholosticItem[0].RowCount}} - POINT GRADING SCALE]</th>
                                    </tr>
                                    <tr>
                            ...
                            <div class="instruction-grading-area-tbls-wprs">
                                <table>
                                    <tr>
                                        <th colspan="{{x.MyRpMarksRangeItem[0].ColSpanPlus}}" class="txt-center">INSTRUCTIONS</th>
                                    </tr>
                                    <tr>
                                        <td colspan="{{x.MyRpMarksRangeItem[0].ColSpanPlus}}" class="txt-center"  style="font-size: 14px; font-weight: 600;">(Co-Scholastic Areas {{x.MyRpMarksRangeItem[0].RowCount}}-point grading scale)</td>
                                    </tr>
                                    <tr>
                                        <td class="{{x.MySubjectMarkShowItem[0].Is_text_center}}">MARKS RANGE</td>
                                        <td class="{{x.MySubjectMarkShowItem[0].Is_text_center}}" data-ng-repeat="itemxx in x.MyRpMarksRangeItem track by $index">{{itemxx.Lower_Range}}-{{itemxx.Upper_Range}}</td>
                                    </tr>
                                    <tr>
                                        <td class="{{x.MySubjectMarkShowItem[0].Is_text_center}}">GRADE</td>
                                        <td class="{{x.MySubjectMarkShowItem[0].Is_text_center}}" data-ng-repeat="itemxx in x.MyRpMarksRangeItem track by $index">{{itemxx.Grade}}</td>
                                    </tr>
                                </table>
                            </div>
                            ...
                            <div class="prcntage-remrk-dv v-false {{x.MySubjectMarkShowItem[0].Prcnt_remark}}" style="margin-top: {{x.MySubjectMarkShowItem[0].Percent_remark_area_margn}}">
                                <p>Remark :</p>
                                <span>{{x.MyRpTotalCalculationItem[0].P_remark}}</span>
                            </div>
                            <%--<div class="promot-dvs  {{x.MyRpPromotToItem[0].ShowStatuS}}">
                                ...
                                <div class="subs-mrks-area-ovrall-dv" style="margin-top: {{x.MySubjectMarkShowItem[0].Overall_area_margn}}">
                                    <table>
                                        <tr class="{{x.MySubjectMarkShowItem[0].Overall_obt_mark}}">
                                            <td>TOTAL OBTAINED MARKS</td>
                                            <td class="{{x.MySubjectMarkShowItem[0].Is_text_center}}">{{x.MyRpTotalCalculationItem[0].Overall_obt_marks}}/{{x.MyRpTotalCalculationItem[0].Overall_full_marks}}</td>
                                        </tr>
                                        <tr>
                                            <td>OVERALL {{x.MyRpTotalCalculationItem[0].Mark_type}}</td>
                                            <td class="{{x.MySubjectMarkShowItem[0].Is_text_center}}">{{x.MyRpTotalCalculationItem[0].Overall_percents}} <span class="{{x.MySubjectMarkShowItem[0].Overall_obt_mark}}">(%)</span></td>
                                        ...
                                        <tr class="{{x.MySubjectMarkShowItem[0].Overall_obt_mark}}">
                                            <td>OVERALL RANK</td>
                                            <td class="{{x.MySubjectMarkShowItem[0].Is_text_center}}">{{x.MyRpRanksItem[3].Rank}}</td>
                                        </tr>
                                    </table>
                                    ...
                                    <div class="instruction-tbls" style="margin-top: {{x.MySubjectMarkShowItem[0].Ins1_area_margn}}">
                                        <table>
                                            ...
                                            <tr data-ng-repeat="itemxx in x.MyRpMarksRangeItem track by $index">
                                                <td class="{{x.MySubjectMarkShowItem[0].Is_text_center}}">{{itemxx.Lower_Range}}-{{itemxx.Upper_Range}}</td>
        ...
        <script type="text/javascript">
            ...
            app.controller('RpCardAppCtrl', function ($scope, $http) {
                ...
                $http.get("../stmarry/api/bulk-final-report-card.asmx/fetch_rp_card_bulks", { params: { "Session_id": session_id, "Class_id": class_id, "Section": section, "Branch_id": branch_id, "Term_idI": term_id1, "Term_idII": term_id2, "Term_idIII": term_id3, "UserType": userType } }).then(function (response) {
