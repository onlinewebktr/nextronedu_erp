<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bulk-report-card-termwise.aspx.cs" Inherits="school_web.Examination_Admin.slip.stpaul.bulk_report_card_termwise" %>
    ...
    <form id="form1" runat="server">
                            ...
                            <div class="report-card-wpr" style="height: {{x.MySubjectMarkShowItemII[0].Height_dv}}">
                                <div class="report-card-head {{x.MySubjectMarkShowItemII[0].Hdr_frst}}">
                                    ...
                                    <div class="report-card-rght-dvss">
                                        ...
                                        <img src="{{x.Student_image}}" style="display: none" class="{{x.MySubjectMarkShowItemII[0].Is_std_img_hide}} {{x.Student_image}}" />
                                    </div> 
                                </div>
                                    ...
                                    <div class="subs-mrks-area-ovrall-dv" style="margin-top: {{x.MySubjectMarkShowItemII[0].Overall_area_margn}}">
                                        <table>
                                            ...
                                            <tr class="{{x.MySubjectMarkShowItemII[0].SpecialNote}}">
                                                <td class="spcial-notes" colspan="2">
                                                    <p style="margin: 0px 0px 10px 0px;">REMARKS : <span class="{{x.MySubjectMarkShowItemII[0].P_remark}}">{{x.MySubjectMarkShowItemII[0].P_remark}}</span> </p>
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
        ...
        <script type="text/javascript">
            ...
            app.controller('RpCardAppCtrl', function ($scope, $http) {
                ...
                $http.get("api/bulk-report-card.asmx/fetch_rp_card_bulks", { params: { "Session_id": session_id, "Class_id": class_id, "Section": section, "Branch_id": branch_id, "Term_id": term_id } }).then(function (response) {
