<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="report-card.aspx.cs" Inherits="school_web.Examination_Admin.slip.bidhan.report_card" %>
                            ...
                            <div class="report-card-wpr" style="height: {{x.MySubjectMarkShowItemII[0].Height_dv}}">
                                ...
                                <div class="subs-mrks-area-dv">
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <th style="min-width: 170px;">SUBJECTS</th>
                                            ...
                                            <th class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}">{{x.MySubjectMarkShowItemII[0].grade_head_text}} <span class="{{x.MySubjectMarkShowItemII[0].Grade}}">({{x.MySubjectMarkShowItemII[0].SubjFulmarks}})</span></th>
                                ...
                                <div class="subs-mrks-area-rght-dv">
                                    <div class="subs-mrks-area-ovrall-dv" style="margin-top: {{reportCardSubS[0].Overall_area_margn}}">
                                        <table>
                                            <tr class="{{x.MySubjectMarkShowItemII[0].Grade}}">
                                                <td>TOTAL OBTAINED MARKS</td>
                                                <td class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}">{{x.MyOverallNoDetailData[0].Overall_obt_marks}}/{{x.MyOverallNoDetailData[0].Overall_full_marks}}</td>
                                            </tr>
                                            <tr class="{{x.MySubjectMarkShowItemII[0].Grade}}">
                                                <td>OVERALL</td>
                                                <td class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}">{{x.MyOverallNoDetailData[0].Overall_percents}} (%)</td>
                                            </tr>
                                            <tr>
                                                <td>OVERALL GRADE</td>
                                                <td class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}"><span class="{{x.MyOverallNoDetailData[0].Grade_bg_class}}" style="{{x.myoverallnodetaildata[0].gradebg}}">{{x.MyOverallNoDetailData[0].Grade}}</span></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr class=" {{reportCardSubS[0].Is_attandance_show}}">
                                                ...
                                                <td class="{{x.MySubjectMarkShowItemII[0].Is_text_center}}"><span class="{{x.MySubjectMarkShowItemII[0].AttendanceColor}}">{{x.MySubjectMarkShowItemII[0].Percent_of_attandance}} (%)</span></td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 5px 5px 10px;" colspan="2">
                                                    <p style="margin: 0px">REMARKS : <span class="{{x.MySubjectMarkShowItemII[0].Remarkss}}">{{x.MySubjectMarkShowItemII[0].Remarkss}}</span></p>
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
                                    ...
                                    <div class="instruction-50 instruction-50-pr">
                                        <div class="instruction-tbls">
                                            <table>
                                                ...
                                                <tr>
                                                    <td colspan="2" class="txt-center">(Scholastic and Co-Scholastic Areas {{x.MyMarkRangeData[0].RowCount}}-point grading scale)</td>
                                                </tr>
                                                <tr>
                                                    <td>MARKS RANGE</td>
                                                    <td>GRADE</td>
