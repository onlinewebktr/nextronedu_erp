<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="report-card-lower.aspx.cs" Inherits="school_web.Examination_Admin.slip.bidhan.report_card_lower" %>
                    ...
                    <div class="invoice-height-manage">
                        <div class="invoice-wpr">
                            ...
                            <div class="report-card-wpr" style="height: {{x.MySubjectMarkShowItemII[0].Height_dv}}">
                                ...
                                <div class="subs-mrks-area-lft-dv" style="width: 56%; padding: 5px 1px 0px 0px;">
                                ...
                                <div class="subs-mrks-area-rght-dv" style="padding: 3px 0px 0px 2px; width: 44%">
