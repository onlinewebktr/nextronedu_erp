...
{
    public class rpcard_for_bidhan
    {
        My mycode = new My();
        ...
        internal static string get_subject_total_marks(string session_id, string class_id, string admission_no, string term_id, string subject_id, string branch_id, string Type)
        {
            ...
            if (Type == "Scholastic")
            {
                if (Output == "Marks")
                {
                    ...
                    string grade = bidhanExamSetting.get_grade_of_a_subject_with_bg(session_id, branch_id, Grade_System_Id, final_marks, full_number, class_id);   // Grade of a subject
                    ...
                    string exam_settings = bidhanExamSetting.get_exam_settings(session_id, branch_id, class_id);  // Settings
                ...
                else
                {
                    ...
                    string exam_settings = bidhanExamSetting.get_exam_settings(session_id, branch_id, class_id);  // Is SpecialNote & QR Show
                   // return grade + "月" + hide_last_grade_clumn + "月" + obt_and_full_mark + "月" + exam_setting + "月" + attandance + "月" + Grade_head_text + "月" + remarkss + "月" + exam_settings + "月" + gradeBG;
                    return grade + "月" + hide_last_grade_clumn + "月" + obt_and_full_mark + "月" + exam_setting + "月" + attandance + "月" + Grade_head_text + "月" + remarkss + "月" + exam_settings + "月" + full_number + "月" + gradeBG;
                }
            }
            else
            {
