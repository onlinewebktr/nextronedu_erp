<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="report-card-nursery-to-ukg-termwise.aspx.cs" Inherits="school_web.Examination_Admin.slip.bhc.report_card_nursery_to_ukg_termwise" %>
    ...
    <form id="form1" runat="server">
                        ...
                        <div class="report-card-wpr" style="height: {{reportCardSubS[0].Height_dv}}">
                            <div class="report-card-head {{reportCardSubS[0].Hdr_frst}}">
                                ...
                                <div class="report-card-cntr-dv">
                                    <asp:Label ID="lbl_school_name" class="report-card-schlname bckgrdcolr" runat="server"></asp:Label>
                                    ...
                                    <h2 class="report-card-ac-sson bckgrdcolr">ACADEMIC SESSION:
                                 ...
                                 <asp:Label ID="lbl_aff_nos" class="report-card-schl-affno {{reportCardSubS[0].Is_aff_no_hide}}" runat="server"></asp:Label>
                            ...
                            <div class="subs-mrks-area-dv">
                                <table>
                                    <tr>
                                        <th class="{{reportCardSubS[0].Is_text_center}} bckgrdcolr">A</th>
                                        <th colspan="18" class="{{reportCardSubS[0].Is_text_center}} bckgrdcolr">SCHOLASTIC AREAS</th>
                                    </tr>
                                    <tr>
                                        <th class="{{reportCardSubS[0].Is_text_center}} bckgrdcolr">SN</th>
                                        <th class=" bckgrdcolr">SUBJECTS</th>
                                        <th class="{{reportCardSubS[0].Is_text_center}} bckgrdcolr" data-ng-repeat="x in reportCard">{{x.Assessment_Name}}  <span class="{{reportCardSubS[0].Max_mark_show}}">({{x.Maximum_Marks}})</span></th>
                                        <th class="{{reportCardSubS[0].Is_text_center}} bckgrdcolr">{{reportCardSubS[0].grade_head_text}} ({{reportCard[0].Term_Maximum_Marks}})</th>
                                        <th class="{{reportCardSubS[0].Is_text_center}} {{reportCardSubS[0].Grade}} bckgrdcolr">GRADE</th>
                                    </tr>
                            ...
                            <div class="subs-mrks-area-lft-dv">
                                <div class="subs-mrks-area-b-dv {{reportCardSubS[0].Is_co_scholastic_hide}}" style="margin-top: {{reportCardSubS[0].Co_sch_area_margn}}">
                                    <table>
                                        <tr>
                                            <th class="{{reportCardSubS[0].Is_text_center}}">B</th>
                                            <th class="{{reportCardSubS[0].Is_text_center}}" colspan="2">CO-SCHOLASTIC AREAS</th>
                                        </tr>
                                        <tr>
                                            <th class="th-bg-rmov {{reportCardSubS[0].Is_text_center}}">SN</th>
                                        ...
                                        <%-- <tr>
                                            <th class="{{reportCardSubS[0].Is_text_center}}">C</th>
                                            <th class="{{reportCardSubS[0].Is_text_center}}" colspan="2">DISCIPLINE [ 5 - POINT GRADING SCALE]</th>
                                        </tr>
                                        <tr>
                                            <th class="th-bg-rmov {{reportCardSubS[0].Is_text_center}}">SN</th>
                                            <th class="th-bg-rmov">ACTIVITIES</th>
                            ...
                            <div class="remrk-promot-to">
                                <div class="prcntage-remrk-dv-custombw">
                                    <p>Remarks :</p>
                                </div>
                            </div>
                            ...
                            <%--<div class="instruction-dv">
                                ...
                                <div class="instruction-50 instruction-50-pl" style="margin-top: {{reportCardSubS[0].Toppers_area_margn}}">
                                    <div class="instruction-tbls floatrght">
                                        <table>
                                            <tr>
                                                <th colspan="5" class="txt-center">ABBREVIATION</th>
                                            </tr>
                                            <tr data-ng-repeat="x in reportAbbrev">
                                                <td>{{x.Short_Name}} = {{x.Condition}}</td>
                                            </tr>
                                        </table>
                                    </div>
                                </div>
        ...
        <script type="text/javascript">
            ...
            app.controller('RpCardAppCtrl', function ($scope, $http) {
                ...
                $http.get("api/nursery-to-ukg-termwise.asmx/fetch_report_card", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id, "Term_id": term_id } }).then(function (response) {
                    $scope.reportCard = response.data;
                })


                $http.get("api/nursery-to-ukg-termwise.asmx/fetch_rp_card_subjects", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id, "Term_id": term_id } }).then(function (response) {
                    ...
                    if ($scope.reportCardSubS == "") {
                        ...
                        ////========================GRAPH
                        $http.get("api/nursery-to-ukg-termwise.asmx/fetch_rp_card_graph", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id, "Term_id": term_id } }).then(function (response) {
                            $scope.reportGraphs = response.data;
                        })


                        ////========================OverAll No.
                        $http.get("api/nursery-to-ukg-termwise.asmx/fetch_rp_card_total_no", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id, "Term_id": term_id } }).then(function (response) {
                ...
                $http.get("api/nursery-to-ukg-termwise.asmx/fetch_rp_card_marks_range", { params: { "Session_id": session_id, "Branch_id": branch_id, "Term_id": term_id } }).then(function (response) {
                    $scope.reportCardmarkRange = response.data;
                })


                ////========================Get Scholastic Data
                $http.get("api/nursery-to-ukg-termwise.asmx/fetch_report_card_coscholastic", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id, "Term_id": term_id } }).then(function (response) {
                    $scope.reportCardCoScholastic = response.data;
                })


                ////========================Get Discipline Data
                $http.get("api/nursery-to-ukg-termwise.asmx/fetch_report_card_discipline_activity", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id, "Term_id": term_id } }).then(function (response) {
                    $scope.reportCardDesciplineActivitY = response.data;
                })



                $http.get("api/nursery-to-ukg-termwise.asmx/fetch_rp_card_signature", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id } }).then(function (response) {
                    $scope.reportSig = response.data;
                })


                ////========================Rank
                $http.get("api/nursery-to-ukg-termwise.asmx/fetch_rp_card_abbreviation", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id, "Term_id": term_id } }).then(function (response) {
                    $scope.reportAbbrev = response.data;
                })
            });
