<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="report-card-termI.aspx.cs" Inherits="school_web.Examination_Admin.slip.bhc.report_card_termI" %>
    ...
    <form id="form1" runat="server">
                        ...
                        <div class="report-card-wpr" style="height: {{reportCardSubS[0].Height_dv}}">
                            <div class="report-card-head {{reportCardSubS[0].Hdr_frst}}">
                                ...
                                <div class="report-card-cntr-dv">
                                    <asp:Label ID="lbl_school_name" class="report-card-schlname colorblue" runat="server"></asp:Label>
                            ...
                            <div class="report-card-std-info-dv">
                                <div class="report-card-std-info-dv-50">
                                    <p class="stds-info-p">
                                        <i class="stds-info-p-i fontwt600">Student's Name</i>  <i class="stds-info-p-doti">:</i>
                                        <asp:Label ID="lbl_student_name" runat="server" class="fontwt600"></asp:Label>
                                    </p>
                                    <p class="stds-info-p">
                                        <i class="stds-info-p-i fontwt600">DATE OF BIRTH</i>  <i class="stds-info-p-doti">:</i>
                                        <asp:Label ID="lbl_date_of_birth" runat="server" class="fontwt600"></asp:Label>
                                    </p>
                                    <p class="stds-info-p">
                                        <i class="stds-info-p-i fontwt600">MOTHER'S NAME</i>  <i class="stds-info-p-doti">:</i>
                                        <asp:Label ID="lbl_mother_name" runat="server" class="fontwt600"></asp:Label>
                                    </p>
                                    <p class="stds-info-p {{reportCardSubS[0].Father_name1}}" runat="server" id="FtherDV1">
                                        <i class="stds-info-p-i fontwt600">FATHER'S NAME</i>  <i class="stds-info-p-doti">:</i>
                                        <asp:Label ID="lbl_father_name" runat="server" class="fontwt600"></asp:Label>
                                    </p>
                                </div>
                                ...
                                <div class="report-card-std-info-dv-50">
                                    <p class="stds-info-p  {{reportCardSubS[0].Father_name2}}" runat="server" id="FtherDV2">
                                        <i class="stds-info-p-i fontwt600">FATHER'S NAME</i>  <i class="stds-info-p-doti">:</i>
                                        <asp:Label ID="lbl_father_name2" runat="server" class="fontwt600"></asp:Label>
                                    </p>

                                    <p class="stds-info-p" runat="server" id="ranksDV" visible="false">
                                        <i class="stds-info-p-i fontwt600">Rank</i>  <i class="stds-info-p-doti">:</i>
                                        <asp:Label ID="lbl_rank" runat="server" class="fontwt600"></asp:Label>
                                    </p>


                                    <p class="stds-info-p">
                                        <i class="stds-info-p-i fontwt600">ADMISSION NUMBER</i>  <i class="stds-info-p-doti">:</i>
                                        <asp:Label ID="lbl_admission_no" runat="server" class="fontwt600"></asp:Label>
                                    </p>
                                    <p class="stds-info-p {{reportCardSubS[0].Is_std_section_hide}}">
                                        <i class="stds-info-p-i fontwt600">SECTION</i>  <i class="stds-info-p-doti">:</i>
                                        <asp:Label ID="lbl_section" runat="server" class="fontwt600"></asp:Label>
                                    </p>
                                    <p class="stds-info-p">
                                        <i class="stds-info-p-i fontwt600">ROLL NO.</i>  <i class="stds-info-p-doti">:</i>
                                        <asp:Label ID="lbl_roll_no" runat="server" class="fontwt600"></asp:Label>
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="subs-mrks-area-dv">
                                <table>
                                    <tr>
                                        ...
                                        <th colspan="18" class="bckgrdcolr {{reportCardSubS[0].Is_text_center}}">SCHOLASTIC AREAS</th>
                                    </tr>
                                    <tr>
                                        ...
                                        <th class="bckgrdcolr {{reportCardSubS[0].Is_text_center}}">{{reportCardSubS[0].grade_head_text}} ({{reportCard[0].Term_Maximum_Marks}})</th>
                                    ...
                                    <tr data-ng-repeat="x in reportCardSubS track by $index">
                                        ...
                                        <td class="{{reportCardSubS[0].Is_subj_code_hide}}">{{x.Subject}}</td>
                            ...
                            <div class="subs-mrks-area-lft-dv">
                                <div class="subs-mrks-area-b-dv {{reportCardSubS[0].Is_co_scholastic_hide}}" style="margin-top: {{reportCardSubS[0].Co_sch_area_margn}}">
                                    <table>
                                        <tr>
                                            <th class="bckgrdcolr">B</th>
                                            <th colspan="2" class="bckgrdcolr">CO-SCHOLASTIC AREAS</th>
                                        </tr>
                                        <tr>
                                            <th class="th-bg-rmov bckgrdcolr">SN</th>
                                            <th class="th-bg-rmov bckgrdcolr">ACTIVITIES</th>
                                            <th class="th-bg-rmov bckgrdcolr">GRADE</th>
                                        </tr>
        ...
        <script type="text/javascript">
            ...
            app.controller('RpCardAppCtrl', function ($scope, $http) {
                ...
                ////========================Get Discipline Data
                $http.get("api/report-card.asmx/fetch_report_card_discipline_activity", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id, "Term_id": term_id } }).then(function (response) {
                    $scope.reportCardDesciplineActivitY = response.data;
                })



                $http.get("api/report-card.asmx/fetch_rp_card_grade_remark", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id, "Term_id": term_id } }).then(function (response) {
                ...
                ////========================Rank
                $http.get("api/report-card.asmx/fetch_rp_card_rank", { params: { "Session_id": session_id, "Class_id": class_id, "Admission_no": admission_no, "Branch_id": branch_id, "Term_id": term_id } }).then(function (response) {
