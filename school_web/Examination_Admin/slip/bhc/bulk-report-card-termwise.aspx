<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bulk-report-card-termwise.aspx.cs" Inherits="school_web.Examination_Admin.slip.bhc.bulk_report_card_termwise" %>
    ...
    <form id="form1" runat="server">
                            ...
                            <div class="report-card-wpr" style="height: {{x.MySubjectMarkShowItemII[0].Height_dv}}">
                                <div class="report-card-head">
                                    ...
                                    <div class="report-card-cntr-dv">
                                        <asp:Label ID="lbl_school_name" class="report-card-schlname bckgrdcolr" runat="server" Text="{{x.MyFirmDetailData[0].Firm_name}}"></asp:Label>
                                    ...
                                    <asp:Label ID="lbl_aff_no" class="report-card-schl-affno" runat="server" Text="{{x.MyFirmDetailData[0].Frim_aff_no}}"></asp:Label>
                                ...
                                <div class="subs-mrks-area-dv">
                                    <table>
                                        <tr>
                                            <th class="bckgrdcolr {{x.MySubjectMarkShowItemII[0].Is_text_center}}">A</th>
                                            <th class="bckgrdcolr {{x.MySubjectMarkShowItemII[0].Is_text_center}}">SCHOLASTIC AREAS</th>
                                            <th class="bckgrdcolr {{x.MySubjectMarkShowItemII[0].Is_text_center}}" data-ng-repeat="item in x.MySubjectHeadingAssesment track by $index" colspan="2">{{item.Assessment_Name}} <%--<span class="{{x.MySubjectMarkShowItemII[0].Max_mark_show}}">({{item.Maximum_Marks}})</span>--%></th>
                                            <th colspan="2" class="bckgrdcolr {{x.MySubjectMarkShowItemII[0].Is_text_center}}"></th>
                                        </tr>
                                        <tr>
                                            <th class="bckgrdcolr {{x.MySubjectMarkShowItemII[0].Is_text_center}}">SN</th>
                                            <th class="bckgrdcolr {{x.MySubjectMarkShowItemII[0].Is_text_center}} {{x.MySubjectMarkShowItemII[0].Is_subj_code_hide}}">SUBJECT CODE</th>
                                            <th class="bckgrdcolr">SUBJECTS</th>
                                            <th class="bckgrdcolr {{x.MySubjectMarkShowItemII[0].Is_text_center}}" data-ng-repeat="item in x.MySubjectHeading track by $index">{{item.Short_Name}} <%--<span class="{{x.MySubjectMarkShowItemII[0].Max_mark_show}}">({{item.Maximum_Marks}})</span>--%></th>
                                            <th class="bckgrdcolr {{x.MySubjectMarkShowItemII[0].Is_text_center}}">TOTAL MARKS SCORED</th>
                                            <%--<th class="bckgrdcolr {{x.MySubjectMarkShowItemII[0].Is_text_center}} {{x.MySubjectMarkShowItemII[0].Grade}}">GRADE</th>--%>
                                            <th class="bckgrdcolr {{x.MySubjectMarkShowItemII[0].Is_text_center}} {{x.MySubjectMarkShowItemII[0].Grade}}">HIGHEST MARKS</th>
                                        </tr>
                                        <tr data-ng-repeat="item in x.MySubjectMarkShowItemII track by $index">
                                            ...
                                            <td class="{{x.MySubjectMarkShowItemII[0].Is_text_center}} {{item.Grade}}">{{item.Sub_highest_mark}}</td>
                                        </tr>
                                    </table>
                                </div>
                                ...
                                <div class="subs-mrks-area-lft-dv">
                                    <div class="subs-mrks-area-b-dv {{x.MySubjectMarkShowItemII[0].Is_co_scholastic_hide}}" style="margin-top: {{x.MySubjectMarkShowItemII[0].Co_sch_area_margn}}">
                                        <table>
                                            <tr>
                                                <th>B</th>
        ...
        <script type="text/javascript">
            ...
            app.controller('RpCardAppCtrl', function ($scope, $http) {
                ...
                $http.get("api/bulk-report-card-P2.asmx/fetch_rp_card_bulks", { params: { "Session_id": session_id, "Class_id": class_id, "Section": section, "Branch_id": branch_id, "Term_id": term_id } }).then(function (response) {
