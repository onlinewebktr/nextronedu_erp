...
{
    public partial class report_card_nursery_to_ukg_termwise : System.Web.UI.Page
    {
        My mycode = new My();
        ...
        private void Bind_schoolinfo()
        {
            ...
            else
            {
                ...
                lbl_estd.Text = "SCHOOL CODE : " + dt.Rows[0]["school_no"].ToString();
                lbl_aff_text.Text = dt.Rows[0]["Affiliated_by_full_text"].ToString();
                lbl_aff_nos.Text = ViewState["AffText"].ToString() + "  : " + dt.Rows[0]["Affiliation"].ToString();
