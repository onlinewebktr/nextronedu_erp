<%@ Page Title="" Language="C#" MasterPageFile="~/Library_Admin/Library_Master.Master" AutoEventWireup="true" CodeBehind="Staff_Book_History.aspx.cs" Inherits="school_web.Library_Admin.Staff_Book_History" %>
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">
                                <asp:Label ID="lbl_title" runat="server">Staff Book History</asp:Label>
                            </li>
                        </ol>
                    </nav>
                </div>
                                                ...
                                                <div id="tblPrintIQ" runat="server">
                                                    <div class="prnt-dv-wpr">
                                                        <div class="pgslry-head-div head">
                                                            ...
                                                            <div style="margin: 0px; padding: 0px; height: 133px; width: 80%; float: left;">
                            ...
                            <asp:Label ID="lbl_website" runat="server"></asp:Label>
                                                                ...
                                                                <div style="margin: 7px 0px 0px 0px; padding: 0px; float: left; height: auto; text-align: center; vertical-align: middle; font-size: 13px; width: 100%;">
                                                                    <span style="font-size: 14px; font-weight: bold;">
                                                                        <asp:Label ID="lbl_heading_print" runat="server">All Staff Issued Book List </asp:Label><asp:Label ID="lbl_class22" runat="server"></asp:Label></span>
                                                        ...
                                                        <asp:Panel ID="Panel2" runat="server">
                                                            <table id="example21" data-page-length='1500' class="table table-striped table-bordered dataTable" role="grid" aria-describedby="example2_info">
                                                                <thead>
                                                                    <tr>
                                                                        <th>#</th>
                                                                        <th>Name</th>
                                                                    ...
                                                                    <asp:Repeater ID="rd_view" runat="server" OnItemDataBound="rd_view_ItemDataBound">
                                                                        <ItemTemplate>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <asp:Label ID="lblteacher_id" runat="server" Text='<%#Bind("user_id") %>'></asp:Label>
                                                                                </td>
                                                                                <td>
                                                                                    <asp:Label ID="lbl_book_issue_no" runat="server" Text='<%#Bind("transaction_no") %>'></asp:Label>
                                                                                </td>
                                                                                ...
                                                                                <td>
                                                                                    ...
                                                                                    <asp:Panel ID="pnl_print_issuebook_slip_id" runat="server">
                                                                                        ...
                                                                                        <a href="print/Print_Issue_Book_Invoice_staff.aspx?adm=<%#Eval("user_id") %>&Slip_no=<%#Eval("transaction_no") %>" target="_blank" style="text-decoration: underline; color:red; float:left;" title="Print Issue Book Invoice"><i class="bx bx-printer"></i></a>
                                                                                    </asp:Panel>

                                                                                    <asp:Panel ID="pnl_print_returnbook_slip_id" runat="server">

                                                                                        <a href="print/Print_Return_Book_Invoice_staff.aspx?adm=<%#Eval("user_id") %>&Slip_no=<%#Eval("Book_reurn_slip_id") %>" target="_blank" style="text-decoration: underline; color:green;float:left;" title="Print Return Book Invoice"><i class="bx bx-printer"></i> </a>
                                                                                    </asp:Panel>
                                                                                </td>
