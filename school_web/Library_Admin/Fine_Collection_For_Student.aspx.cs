...
{
    public partial class Fine_Collection_For_Student : System.Web.UI.Page
    {
                    ...
                    else
                    {
                        ...
                        try
                        {
                            if (Request.QueryString["page"] != null)
                            {
                                ...
                                Txt_startdate.Text = "";
                                txt_end_date.Text = "";
                                lbl_heading_print.Text = "Fine Collection Student List";

                                if (Request.QueryString["type"].ToString() == "today")
                                {
                                    Txt_startdate.Text = mycode.date();
                                    txt_end_date.Text = mycode.date();
                                    lbl_title.Text = "Today Fine Collection Student List";
                                    date_wise_find();
                                }
                                else
                                {
        ...
        private void bind_grd_view(string qry)
        {
            ...
            else
            {
                ...
                {
                    total = total + My.toDouble(dt.Rows[i]["Total_Fine"].ToString());
                }
