...
{
    public partial class All_Available_Book : System.Web.UI.Page
    {
        My mycode = new My();
                ...
                else
                {
                    if (!IsPostBack)
                    {
                       ...
                       // mycode.bind_all_ddl_with_id_cap_All(ddl_lcation, "Select location,Location_id from lib_location_details where Branch_id = '" + ViewState["Branch_id"].ToString() + "'");
                        ...
                        mycode.bind_all_ddl_with_id_cap_All(ddl_lcation, "Select lb.location,lb.Location_id from lib_location_details  lb join Library_Book_Entry_Master_Uniqe lbq on lb.Location_id=lbq.Location where lb.Branch_id = '" + ViewState["Branch_id"].ToString() + "'");
        ...
        private void Bind_Top_All_book()
        {
            ...
            string query = " Select sum(cast(EnterQuantity as float )) as count,AuthorName,Publication,EnterVolumePart,Edition,PublicationYear,NoOfPages,NameOfBook,Book_Unique_Identifier,(" + booktype + ") as booktype,(" + BookStatus + ") as Book_Status,(" + Book_Category + ") as Book_Category,(" + location + ") as location_new,ISBN_Num,SelectClass,Branch_id,Type,BookStatus,Book_Category_Id,Location,(" + Sub_Location + ") as Sub_Location from Library_Book_Entry lbe  where lbe.Issued_Status='Not Issued' and lbe.Branch_id=" + ViewState["Branch_id"].ToString() + " and lbe.Is_Delete=1 group by AuthorName,Publication,EnterVolumePart,Edition,PublicationYear,NoOfPages,NameOfBook,Book_Unique_Identifier,ISBN_Num,SelectClass,Branch_id,Type,BookStatus,Book_Category_Id,Location,Sub_Location_id ";
        ...
        protected void ddl_book_status_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    string query = " Select sum(cast(EnterQuantity as float )) as count,AuthorName,Publication,EnterVolumePart,Edition,PublicationYear,NoOfPages,NameOfBook,Book_Unique_Identifier,(" + booktype + ") as booktype,(" + BookStatus + ") as Book_Status,(" + Book_Category + ") as Book_Category,(" + location + ") as location_new,ISBN_Num,SelectClass,Branch_id,Type,BookStatus,Book_Category_Id,Location,(" + Sub_Location + ") as Sub_Location from Library_Book_Entry lbe where lbe.Issued_Status='Not Issued' and lbe.Branch_id=" + ViewState["Branch_id"].ToString() + " and BookStatus='" + ddl_book_status.SelectedValue + "' and lbe.Is_Delete=1 group by AuthorName,Publication,EnterVolumePart,Edition,PublicationYear,NoOfPages,NameOfBook,Book_Unique_Identifier,ISBN_Num,SelectClass,Branch_id,Type,BookStatus,Book_Category_Id,Location,Sub_Location_id ";
        ...
        protected void ddl_lcation_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    string query = " Select sum(cast(EnterQuantity as float )) as count,AuthorName,Publication,EnterVolumePart,Edition,PublicationYear,NoOfPages,NameOfBook,Book_Unique_Identifier,(" + booktype + ") as booktype,(" + BookStatus + ") as Book_Status,(" + Book_Category + ") as Book_Category,(" + location + ") as location_new,ISBN_Num,SelectClass,Branch_id,Type,BookStatus,Book_Category_Id,Location,(" + Sub_Location + ") as Sub_Location from Library_Book_Entry lbe where lbe.Issued_Status='Not Issued' and lbe.Branch_id=" + ViewState["Branch_id"].ToString() + " and Location='" + ddl_lcation.SelectedValue + "' and SelectClass='" + ddl_class_wise.SelectedValue + "'  and lbe.Is_Delete=1 group by AuthorName,Publication,EnterVolumePart,Edition,PublicationYear,NoOfPages,NameOfBook,Book_Unique_Identifier,ISBN_Num,SelectClass,Branch_id,Type,BookStatus,Book_Category_Id,Location,Sub_Location_id ";
                    Bind_Data(query);
                }
        ...
        private void class_wise_search_data()
        {
            ...
            else
            {
                ...
                {
                    string query = " Select sum(cast(EnterQuantity as float )) as count,AuthorName,Publication,EnterVolumePart,Edition,PublicationYear,NoOfPages,NameOfBook,Book_Unique_Identifier,(" + booktype + ") as booktype,(" + BookStatus + ") as Book_Status,(" + Book_Category + ") as Book_Category,(" + location + ") as location_new,ISBN_Num,SelectClass,Branch_id,Type,BookStatus,Book_Category_Id,Location,(" + Sub_Location + ") as Sub_Location from Library_Book_Entry lbe where lbe.Issued_Status='Not Issued' and lbe.Branch_id=" + ViewState["Branch_id"].ToString() + " and SelectClass='" + ddl_class_wise.SelectedValue + "' and lbe.Is_Delete=1 group by AuthorName,Publication,EnterVolumePart,Edition,PublicationYear,NoOfPages,NameOfBook,Book_Unique_Identifier,ISBN_Num,SelectClass,Branch_id,Type,BookStatus,Book_Category_Id,Location,Sub_Location_id ";
                    Bind_Data(query);
                }
            }
        }
        ...
        private void Bind_Data(string qry)
        {
            ...
            else
            {
                ...
                {
                    total = total+My.toint(dt.Rows[i]["count"].ToString()) ;   
                }
                lbl_totalbook.Text = total.ToString(); 
            }
        }
