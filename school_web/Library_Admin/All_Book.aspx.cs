...
namespace school_web.Library_Admin
{
    public partial class All_Book : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                else
                {
                    if (!IsPostBack)
                    {
                        ...
                        mycode.bind_all_ddl_with_id_cap_NA_All(ddl_class_wise, "Select Course_Name,course_id from Add_course_table order by Position");

                        mycode.bind_all_ddl_with_id_cap_All(ddl_book_status, "Select BookStatus,BookStatusId from Library_Book_Status");

                        mycode.bind_all_ddl_with_id(ddl_lcation, "Select lb.location,lb.Location_id from lib_location_details  lb join Library_Book_Entry_Master_Uniqe lbq on lb.Location_id=lbq.Location where lb.Branch_id = '" + ViewState["Branch_id"].ToString() + "'");
                        get_firm_name();
        ...
        {
            string query = "Select   *,(" + booktype + ") as booktype,(" + BookStatus + ") as Book_Status,(" + Book_Category + ") as Book_Category,(" + location + ") as location_new,("+ Sub_Location + ") as Sub_Location from Library_Book_Entry_Master_Uniqe lbe where  lbe.Branch_id=" + ViewState["Branch_id"].ToString() + " and lbe.Is_Delete=1 order by lbe.id desc";
            Bind_Data(query);
        }
        ...
        protected void ddl_class_wise_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    query = "Select *,(" + booktype + ") as booktype,(" + BookStatus + ") as Book_Status,(" + Book_Category + ") as Book_Category,(" + location + ") as location_new,(" + Sub_Location + ") as Sub_Location from Library_Book_Entry_Master_Uniqe lbe where   lbe.Branch_id=" + ViewState["Branch_id"].ToString() + " and lbe.Is_Delete=1";
                }
                else
                {
                    query = "Select *,(" + booktype + ") as booktype,(" + BookStatus + ") as Book_Status,(" + Book_Category + ") as Book_Category,(" + location + ") as location_new,(" + Sub_Location + ") as Sub_Location from Library_Book_Entry_Master_Uniqe lbe where lbe.SelectClass='" + ddl_class_wise.SelectedValue + "' and lbe.Branch_id=" + ViewState["Branch_id"].ToString() + " and lbe.Is_Delete=1";
                }
        ...
        private void Bind_Data(string qry)
        {
            ...
            else
            {
                ...
                {
                    total = total + My.toint(dt.Rows[i]["EnterQuantity"].ToString());
                }
