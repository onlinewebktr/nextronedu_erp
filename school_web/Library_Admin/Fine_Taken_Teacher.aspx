<%@ Page Title="" Language="C#" MasterPageFile="~/Library_Admin/Library_Master.Master" AutoEventWireup="true" CodeBehind="Fine_Taken_Teacher.aspx.cs" Inherits="school_web.Library_Admin.Fine_Taken_Teacher" %>
                                            ...
                                            <div class="find-dv">
                                                ...
                                                <asp:TextBox ID="Txt_date" runat="server" class="form-control find-dv-txtbx"></asp:TextBox>
                                                    ...
                                                    <div class="col-sm-2">
                                                        ...
                                                        <div class="clndr-div">
                                                <asp:TextBox ID="Txt_date2" runat="server" class="form-control find-dv-txtbx"></asp:TextBox>
                                                          <i class="fa fa-calendar clndr-icon" aria-hidden="true"></i>
                                       </div>  
                                                    </div>
                                                    <div class="col-sm-1">
