<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Print_Issue_Book_Invoice_Student.aspx.cs" Inherits="school_web.Library_Admin.print.Print_Issue_Book_Invoice" %>
                    ...
                    <div class="mainwith">
                        ...
                        <asp:Label ID="lbl_slipno" runat="server" Font-Bold="true"></asp:Label>
                            ...
                            <div class="slipno_middle">
                                <b>Book Issue Receipt (Office copy)</b>
                            </div>
                        ...
                        <div class="pay_particular">
                            <asp:GridView ID="grd_fee" runat="server" CssClass="table table-bordered table-striped" AutoGenerateColumns="False" Width="100%" Style="text-align: center;">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="No. of Pages">
                                        <ItemTemplate>
                                            <asp:Label ID="lbl_Edition" runat="server" Text='<%#Bind("NoOfPages") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                ...
                <div class="mainautot" id="studentcopY">
                    <div class="mainwith sdtcopymrgN" id="studentcopYInr">
                        ...
                        <asp:Label ID="lbl_slipno1" runat="server" Font-Bold="true"></asp:Label>
                            ...
                            <div class="slipno_middle">
                                <b>Book Issue Receipt(Student copy)</b>
                            </div>
                            <div class="slipno_right">
                                Book Issue  :
                        ...
                        <div class="pay_particular">
                            <asp:GridView ID="grd_fee1" runat="server" CssClass="table table-bordered table-striped" AutoGenerateColumns="False" Width="100%" Style="text-align: center;">
                                <Columns>
