<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Print_Return_Book_Invoice_Student.aspx.cs" Inherits="school_web.Library_Admin.print.Print_Return_Book_Invoice_Student" %>
...
<body>
    <form id="form1" runat="server">
        <div class="main">
            ...
            <div class="prnt-btn-sec noPrint" runat="server" id="printBtns">
                            ...
                            <asp:GridView ID="grd_fee" runat="server" CssClass="table table-bordered table-striped" AutoGenerateColumns="False" Width="100%" Style="text-align: center;" ShowFooter="True" OnRowDataBound="grd_fee_RowDataBound">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Return Date" Visible="false">
                                     ...
                                     <asp:TemplateField HeaderText="Adjustment Monthly Fee">
                                        <ItemTemplate>
                                            <asp:Label ID="lbl_adjustment" runat="server" Text='<%#Bind("Monthname") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                ...
                <div class="mainautot" id="studentcopY">
                    <div class="mainwith sdtcopymrgN" id="studentcopYInr">
                        ...
                        <asp:Label ID="lbl_slipno1" runat="server" Font-Bold="true"></asp:Label>
                            ...
                            <div class="slipno_middle">
                                <b>Book Return Receipt(Student copy)</b>
                            </div>
                            <div class="slipno_right">
                                Book Return Date  :
                        ...
                        <div class="pay_particular">
                            <asp:GridView ID="grd_fee1" runat="server" CssClass="table table-bordered table-striped" AutoGenerateColumns="False" Width="100%" Style="text-align: center;" OnRowDataBound="grd_fee1_RowDataBound">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Edition">
                                        <ItemTemplate>
                                            <asp:Label ID="lbl_Edition" runat="server" Text='<%#Bind("Edition") %>'></asp:Label>
                                            <asp:Label ID="Label1" runat="server" Text='<%#Bind("NoOfPages") %>' Visible="false"></asp:Label>
                                        </ItemTemplate>
