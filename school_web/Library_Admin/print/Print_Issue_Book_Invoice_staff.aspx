<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Print_Issue_Book_Invoice_staff.aspx.cs" Inherits="school_web.Library_Admin.print.Print_Issue_Book_Invoice_staff" %>
                ...
                <div class="mainautot" id="studentcopY">
                    <div class="mainwith sdtcopymrgN" id="studentcopYInr">
                        ...
                        <asp:Label ID="lbl_slipno1" runat="server" Font-Bold="true"></asp:Label>
                            ...
                            <div class="slipno_middle">
                                <b>Book Issue Receipt(Staff copy)</b>
                            </div>
                            <div class="slipno_right">
                                Book Issue  :
