<%@ Page Title="" Language="C#" MasterPageFile="~/Library_Admin/Library_Master.Master" AutoEventWireup="true" CodeBehind="Fine_Collection_For_staff.aspx.cs" Inherits="school_web.Library_Admin.Fine_Collection_For_staff" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Staff Fine Collection
</asp:Content>
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><asp:Label ID="lbl_title" runat="server">Staff Book History</asp:Label> </li>
                        </ol>
                    </nav>
                </div>
            </div>
                            ...
                            <asp:Label ID="lbl_website" runat="server"></asp:Label>
                                                        ...
                                                        <asp:Panel ID="Panel2" runat="server">
                                                            <table id="example21" data-page-length='1500' class="table table-striped table-bordered dataTable" role="grid" aria-describedby="example2_info">
                                                                ...
                                                                <tfoot>
                                                                    <tr>
                                                                        <td colspan="12" style="text-align: right; font-weight: bold;">Total Fine Collection</td>
