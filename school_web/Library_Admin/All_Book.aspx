<%@ Page Title="" Language="C#" MasterPageFile="~/Library_Admin/Library_Master.Master" AutoEventWireup="true" CodeBehind="All_Book.aspx.cs" Inherits="school_web.Library_Admin.All_Book" %>
        ...
        $(function () {
            $("#<%=txt_AuthorName.ClientID%>").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        url: 'All_Book.aspx/Getbookauthername',
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <asp:Label ID="lbl_website" runat="server"></asp:Label>
                                                            ...
                                                            <div style="margin: 7px 0px 0px 0px; padding: 0px; float: left; height: auto; text-align: center; vertical-align: middle; font-size: 13px; width: 100%;">
                                                                <span style="font-size: 14px; font-weight: bold;">All Book List<asp:Label ID="lbl_class22" runat="server"></asp:Label></span>
                                                    ...
                                                    <asp:Panel ID="Panel2" runat="server">
                                                      ...
                                                      <div class="table-responsive">   <table id="example2" data-page-length='1500' class="table table-striped table-bordered dataTable" role="grid" aria-describedby="example2_info">
                                                            <thead>
                                                                <tr>
                                                                    <th>#</th>
                                                                    <th>Item Code</th>
                                                            ...
                                                            <tfoot>
                                                                <tr>
                                                                    <td colspan="15" style="text-align: right; font-weight: bold;">Total Available Books</td>
                                                                    <td>
