                        ...
                        try
                        {
                            if (Request.QueryString["page"] != null)
                            {
                                ...
                                if (Request.QueryString["page"].ToString() == "today")
                                {
                                    ...
                                    lbl_title.Text = "Today Student Book " + Request.QueryString["type"] + " List";
                                    date_wise_data_find();
                                }
                                else
                                {
                                    ...
                                    lbl_heading_print.Text = "Student Book " + Request.QueryString["type"] + " List";
                                    bind_all_data();
                                }
                            ...
                            {
                                ViewState["type"] = "N/A";
                                lbl_heading_print.Text = "Student Book History";
                                bind_all_data();
                            }
                        }
                        catch
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (ViewState["type"].ToString() == "issued")
                    {
                        ...
                        query = "select ar.class,ar.admissionserialnumber,ar.rollnumber,ar.Section,ar.session,ar.studentname,lst.issue_date,lst.due_date,lst.book_no,lbe.NameOfBook,lbe.AuthorName,lbe.Publication,lbe.EnterVolumePart,lbe.Edition,lbe.PublicationYear,lbe.ISBN_Num,lst.status,lst.transaction_no,lst.Book_status,lst.Book_reurn_slip_id,lst.returned_date,lbe.BookId  from admission_registor ar join lib_student_transaction_details  lst on ar.admissionserialnumber=lst.student_id  and ar.Session_Id=lst.Session_id join Library_Book_Entry lbe on lbe.BookId=lst.book_no where   ar.Status=1 and    lst.issue_idate>=" + idate + " and lst.issue_idate<=" + idate2 + "  and  lst.status='Issued'  order by ar.rollnumber,lst.issue_date";
                    }
                    else if (ViewState["type"].ToString() == "return")
                    {
                        query = "select ar.class,ar.admissionserialnumber,ar.rollnumber,ar.Section,ar.session,ar.studentname,lst.issue_date,lst.due_date,lst.book_no,lbe.NameOfBook,lbe.AuthorName,lbe.Publication,lbe.EnterVolumePart,lbe.Edition,lbe.PublicationYear,lbe.ISBN_Num,lst.status,lst.transaction_no,lst.Book_status,lst.Book_reurn_slip_id,lst.returned_date,lbe.BookId  from admission_registor ar join lib_student_transaction_details  lst on ar.admissionserialnumber=lst.student_id  and ar.Session_Id=lst.Session_id join Library_Book_Entry lbe on lbe.BookId=lst.book_no where   ar.Status=1 and    lst.return_idate>=" + idate + " and lst.return_idate<=" + idate2 + " and  lst.status='Return'  order by ar.rollnumber,lst.issue_date";

                    }
                    else
                    {
                        query = "select ar.class,ar.admissionserialnumber,ar.rollnumber,ar.Section,ar.session,ar.studentname,lst.issue_date,lst.due_date,lst.book_no,lbe.NameOfBook,lbe.AuthorName,lbe.Publication,lbe.EnterVolumePart,lbe.Edition,lbe.PublicationYear,lbe.ISBN_Num,lst.status,lst.transaction_no,lst.Book_status,lst.Book_reurn_slip_id,lst.returned_date,lbe.BookId  from admission_registor ar join lib_student_transaction_details  lst on ar.admissionserialnumber=lst.student_id  and ar.Session_Id=lst.Session_id join Library_Book_Entry lbe on lbe.BookId=lst.book_no where   ar.Status=1 and    lst.issue_idate>=" + idate + " and lst.issue_idate<=" + idate2 + "   order by ar.rollnumber,lst.issue_date";
