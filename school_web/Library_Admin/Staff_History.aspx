<%@ Page Title="" Language="C#" MasterPageFile="~/Library_Admin/Library_Master.Master" AutoEventWireup="true" CodeBehind="Staff_History.aspx.cs" Inherits="school_web.Library_Admin.Staff_History" %>
      ...
      <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3">All Books</div>
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            <li class="breadcrumb-item"><a href="Lib_Home.aspx"><i class="bx bx-home-alt"></i></a>
                            </li>
                            <li class="breadcrumb-item active" aria-current="page">Book’s List</li>
                        </ol>
                    </nav>
                </div>
            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="find-dv">
                                                <div class="row">
                                                    <div class="col-sm-2">
                                                        <label for="validationCustom01" class="find-dv-lbl">Library Card No.</label>
                                                        <asp:TextBox ID="Txt_card" runat="server" class="form-control"></asp:TextBox>
                                                    </div>
                                                    <div class="col-sm-2">
                                                        <label for="validationCustom01" class="find-dv-lbl">Status</label>
                                                        <asp:DropDownList ID="ddlstatus" runat="server" class="form-control find-dv-txtbx" AutoPostBack="true">
                                                    ...
                                                    <div class="col-sm-1">
                                                     ...
                                                     <div class="col-sm-2">
                                                        <asp:LinkButton ID="btn_print" runat="server" class="btn btn-primary find-dv-btn" Visible="false" OnClientClick="return printpage();"> Print</asp:LinkButton>
                                                    </div>

                                                    <div class="col-sm-2">
                                                        <asp:LinkButton ID="btn_excels" runat="server" Visible="false" class="btn btn-primary find-dv-btn">  <i class='bx bx-download'></i> Excel</asp:LinkButton>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="grd-wpr">
