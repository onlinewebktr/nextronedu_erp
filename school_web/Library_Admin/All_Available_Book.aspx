<%@ Page Title="" Language="C#" MasterPageFile="~/Library_Admin/Library_Master.Master" AutoEventWireup="true" CodeBehind="All_Available_Book.aspx.cs" Inherits="school_web.Library_Admin.All_Available_Book" EnableEventValidation="false" %>
        ...
        $(function () {
            $("#<%=txt_AuthorName.ClientID%>").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        url: 'All_Available_Book.aspx/Getbookauthername',
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">All Available Books</li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="grd-wpr">
                                            ...
                                            <div id="tblPrintIQ" runat="server">
                                                <div class="prnt-dv-wpr" style="float: left; width: 100%; overflow: auto">
                            ...
                            <asp:Label ID="lbl_website" runat="server"></asp:Label>
                                                            ...
                                                            <div style="margin: 7px 0px 0px 0px; padding: 0px; float: left; height: auto; text-align: center; vertical-align: middle; font-size: 13px; width: 100%;">
                                                                <span style="font-size: 14px; font-weight: bold;">Available Book List<asp:Label ID="lbl_class22" runat="server"></asp:Label></span>
                                                    ...
                                                    <asp:Panel ID="Panel2" runat="server">
                                                        ...
                                                        <table id="example2" data-page-length='1500' class="table table-striped table-bordered dataTable" role="grid" aria-describedby="example2_info">
                                                                ...
                                                                <asp:Repeater ID="rd_view" runat="server" OnItemDataBound="rd_view_ItemDataBound">
                                                                    <itemtemplate>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td style="text-align: left;">
                                                                                <asp:Label ID="lbl_qty" runat="server" Text='<%#Bind("count")%>'></asp:Label>
                                                            ...
                                                            <tfoot>
                                                                <tr>
                                                                    <td colspan="13" style="text-align: right; font-weight: bold;">Total Available Books</td>
                                                                    <td>
