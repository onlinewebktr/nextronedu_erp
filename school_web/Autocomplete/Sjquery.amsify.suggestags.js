...
/**
 * amsifySuggestagss made global
 * @type amsifySuggestagss
 */
var amsifySuggestagss;
...
(function (factory) {
     ...
     * @type {Object}
     */
    amsifySuggestagss = function (selector) {
        ...
        this.classes = {
            ...
            focus: '.amsify-focus',
            sTagsInput: '.Samsify-suggestags-input',
    ...
    amsifySuggestagss.prototype = {
        ...
        setIcon: function () {
            ...
            if (this.settings.type == 'bootstrap') {
                return '<span class="bx bx-message-alt-x ' + removeClass + '"></span>';
    ...
    $.fn.amsifySuggestagss = function (options, method) {
        /**
         * Initializing each instance of selector
         * @return {object}
         */
        return this.each(function () {
            var amsifySuggestagss = new amsifySuggestagss(this);
            amsifySuggestagss._settings(options);
            amsifySuggestagss._setMethod(method);
            amsifySuggestagss._init();
        });
    };
}));