<%@ Page Title="" Language="C#" MasterPageFile="~/Payroll/Adminmaster.Master" AutoEventWireup="true" CodeBehind="salary-chart-report.aspx.cs" Inherits="school_web.Payroll.salary_chart_report" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="page-wrapper">
        <div class="page-content">
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Salary Chart Report</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <h6 class="mb-0 text-uppercase">Salary Chart Report</h6>
                    <hr />
                    <div class="card">
                        <div class="card-body">
                                                ...
                                                <asp:Panel ID="pnl_grids" runat="server" Visible="false">
                                                    ...
                                                    <div id="tblPrintIQ" runat="server">
                                                        <div class="prnt-dv-wpr-mth">
                                                            <div class="prnt-dv-head">
                                                                <asp:Label ID="lbl_frm_name" runat="server" class="prnt-firm-name" Text=""></asp:Label>
                                                                <asp:Label ID="lbl_date_period" runat="server" class="prnt-date-p" Text=""></asp:Label>
                                                                <h2></h2>
                                                            </div>
                                                            ...
                                                            <div class="rp-tbl-2">
                                                                <table>
                                                                    <tr>
                                                                        <td>
                                                                            <asp:Label ID="Label1" runat="server" Text="Net Payable Salary"></asp:Label></td>
                                                                        <td>
                                                                            <asp:Label ID="txt_net_payable" runat="server" Text=""></asp:Label>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                            <asp:Label ID="Label3" runat="server" Text="Total Bank Transfer"></asp:Label>
                                                                        </td>
                                                                        <td>
                                                                            <asp:Label ID="txt_bt" runat="server" Text=""></asp:Label>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                            <asp:Label ID="Label5" runat="server" Text="Total Cheque Amount"></asp:Label>
                                                                        </td>
                                                                        <td>
                                                                            <asp:Label ID="txt_check_amount" runat="server" Text="Label"></asp:Label>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                            <asp:Label ID="Label7" runat="server" Text="Total Cash Amount"></asp:Label>
                                                                        </td>
                                                                        <td>
                                                                            <asp:Label ID="txt_cash" runat="server" Text="Label"></asp:Label>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </div>
                                                            <div class="rp-tbl-1">
                                                                <table>
                                                                    <tr>
                                                                        <td>
                                                                            <asp:Label ID="lbl_emp_pf" runat="server" Text="Label"></asp:Label></td>
                                                                        <td>
                                                                            <asp:Label ID="txt_emp_pf" runat="server" Text="Label"></asp:Label>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                            <asp:Label ID="lbl_emp_esi" runat="server" Text="Label"></asp:Label>
                                                                        </td>
                                                                        <td>
                                                                            <asp:Label ID="txt_emp_esi" runat="server" Text="Label"></asp:Label>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                            <asp:Label ID="lbl_em_pf" runat="server" Text="Label"></asp:Label>
                                                                        </td>
                                                                        <td>
                                                                            <asp:Label ID="txt_em_pf" runat="server" Text="Label"></asp:Label>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                            <asp:Label ID="lbl_em_esi" runat="server" Text="Label"></asp:Label>
                                                                        </td>
                                                                        <td>
                                                                            <asp:Label ID="txt_em_esi" runat="server" Text="Label"></asp:Label>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </div>
