<%@ Page Title="" Language="C#" MasterPageFile="~/Payroll/Adminmaster.Master" AutoEventWireup="true" CodeBehind="individual-monthly-attendance-report.aspx.cs" Inherits="cms_web.Payroll.individual_monthly_attendance_report" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="page-wrapper">
        <div class="page-content">
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Individual Monthly Attendance Report</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <h6 class="mb-0 text-uppercase">Individual Monthly Attendance Report</h6>
                    <hr />
                    <div class="card">
                        <div class="card-body">
                            ...
                            <asp:Label ID="lbl_website" runat="server"></asp:Label>
                                                        ...
                                                        <div style="margin: 0px; padding: 0px; float: left; width: 100%">
                                                            ...
                                                            <table style="margin: 0px; padding: 0px; float: left; height: auto; width: 100%;">
                                                                <tr>
                                                                    <td colspan="4" style="padding: 5px;">Employee Name 
                                                        <asp:Label ID="lbl_emp_name" runat="server" Text=""></asp:Label>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td style="padding: 5px;">Total days in month</td>
                                                                    <td style="padding: 5px;">
                                                                        <asp:Label ID="lbl_ttl_days_in_mnth" runat="server" Text="" Font-Bold="true"></asp:Label></td>
                                                                    <td style="padding: 5px;">Total Present</td>
                                                                    <td style="padding: 5px;">
                                                                        <asp:Label ID="lbl_ttl_present" runat="server" Text="" Font-Bold="true"></asp:Label></td>
                                                                </tr>
                                                                <tr>
                                                                    <td style="padding: 5px;">Total Absent</td>
                                                                    <td style="padding: 5px;">
                                                                        <asp:Label ID="lbl_absent" runat="server" Text="" Font-Bold="true"></asp:Label></td>
                                                                    <td style="padding: 5px;">Total working days</td>
                                                                    <td style="padding: 5px;">
                                                                        <asp:Label ID="lbl_ttl_working_days" runat="server" Text="" Font-Bold="true"> </asp:Label></td>
                                                                </tr>
                                                                <tr>
                                                                    <td style="padding: 5px;">Total half day working</td>
                                                                    <td style="padding: 5px;">
                                                                        <asp:Label ID="lbl_half_day_working" runat="server" Text="" Font-Bold="true"></asp:Label></td>
                                                                    <td style="padding: 5px;">On leave</td>
                                                                    <td style="padding: 5px;">
                                                                        <asp:Label ID="lbl_on_leave" runat="server" Text="" Font-Bold="true"></asp:Label></td>
                                                                </tr>

                                                            </table>
                                                        </div>
                                                        <asp:GridView ID="grd_attendance" runat="server" AutoGenerateColumns="False" AutoGenerateSelectButton="False" AllowPaging="false" Font-Bold="False" Style="margin-top: 0; width: 100%; overflow: scroll" class="table table-striped table-bordered dataTable"   OnRowDataBound="grd_attendance_RowDataBound">
                                                            <RowStyle />
                                                            <Columns>
