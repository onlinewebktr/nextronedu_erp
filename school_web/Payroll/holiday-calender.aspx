<%@ Page Title="" Language="C#" MasterPageFile="~/Payroll/Adminmaster.Master" AutoEventWireup="true" CodeBehind="holiday-calender.aspx.cs" Inherits="school_web.Payroll.holiday_calender" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xl-4">
                    <asp:Label ID="ltUsertop" runat="server" Style="font-weight: 500; font-size: 1rem;" class="mb-0 text-uppercase" Text="Add Holiday Calender"></asp:Label>
                    <hr />
                    <div class="card">
                        <div class="card-body">
                ...
                <div class="col-xl-8">
                    <h6 class="mb-0 text-uppercase">Added Holiday Calender</h6>
                    <hr />
                    <div class="card">
                        <div class="card-body">
