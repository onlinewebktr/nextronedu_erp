<%@ Page Title="" Language="C#" MasterPageFile="~/Payroll/Adminmaster.Master" AutoEventWireup="true" CodeBehind="Income_Type.aspx.cs" Inherits="school_web.Payroll.Income_Type" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">Income Type Master
</asp:Content>
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="row">
                ...
                <div class="col-xl-8">
                    <h6 class="mb-0 text-uppercase">Added Income Type Master</h6>
                    <hr />
                    <div class="card">
                        <div class="card-body">
                                                            ...
                                                            <asp:Panel ID="Panel1" runat="server">
                                                                <tr>
                                                                    ...
                                                                    <td style="text-align: left;">
                                                                        <asp:Label ID="lbl_name" runat="server" Text='<%#Bind("Income_Type")%>'></asp:Label>
                                                                    </td>
                                                                     <td style="text-align: left;">
                                                                    ...
                                                                    <td style="text-align: left;">
                                                                        ...
                                                                        <asp:Label ID="lbl_department_id" runat="server" Text='<%#Bind("Income_Type_id")%>' Visible="false"></asp:Label> 
                                                                    </td>
                                                                </tr>
                                                            </asp:Panel>
                                                        </ItemTemplate>
