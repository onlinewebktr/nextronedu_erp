<%@ Page Title="" Language="C#" MasterPageFile="~/Payroll/Adminmaster.Master" AutoEventWireup="true" CodeBehind="employee-list.aspx.cs" Inherits="school_web.Payroll.employee_list" %>
                                                                    ...
                                                                    <td style="text-align: left;">
                                                                        <div class="user-box dropdown" style="float: left; display: inherit; height: auto; border-left: 0px solid #f0f0f0; margin-left: 0px;">
                                                                            ...
                                                                            <ul class="dropdown-menu dropdown-menu-end">
                                                                                ...
                                                                                <li>
                                                                                    <a class="dropdown-item" href="user-details.aspx?empCoDE=<%#Eval("Emp_Code") %>" target="_blank"><i class='bx bx-printer'></i><span>Print User Details</span></a>
                                                                                </li>
                                                                                <li>
