<%@ Page Title="" Language="C#" MasterPageFile="~/Payroll/Adminmaster.Master" AutoEventWireup="true" CodeBehind="Deduction_Type_Master.aspx.cs" Inherits="school_web.Payroll.Deduction_Type_Master" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">Deduction Type
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="page-wrapper">
        <div class="page-content">
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Deduction Type Master</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-4">
                    <asp:Label ID="ltUsertop" runat="server" Style="font-weight: 500; font-size: 1rem;" class="mb-0 text-uppercase" Text="Add Deduction Type Master"></asp:Label>
                    <hr />
                    <div class="card">
                        <div class="card-body">
                ...
                <div class="col-xl-8">
                    <h6 class="mb-0 text-uppercase">Added Deduction Master</h6>
                    <hr />
                    <div class="card">
                        <div class="card-body">
                                                            ...
                                                            <asp:Panel ID="Panel1" runat="server">
                                                                <tr>
                                                                    ...
                                                                    <td style="text-align: left;">
                                                                        <asp:Label ID="lbl_name" runat="server" Text='<%#Bind("deduction_type")%>'></asp:Label>
                                                                    </td>
                                                                     <td style="text-align: left;">
                                                                    ...
                                                                    <td style="text-align: left;">
                                                                        ...
                                                                        <asp:Label ID="lbl_department_id" runat="server" Text='<%#Bind("deduction_type_id")%>' Visible="false"></asp:Label> 
                                                                    </td>
                                                                </tr>
                                                            </asp:Panel>
                                                        </ItemTemplate>
