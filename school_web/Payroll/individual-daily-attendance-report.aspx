<%@ Page Title="" Language="C#" MasterPageFile="~/Payroll/Adminmaster.Master" AutoEventWireup="true" CodeBehind="individual-daily-attendance-report.aspx.cs" Inherits="school_web.Payroll.individual_daily_attendance_report" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="page-wrapper">
        <div class="page-content">
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Individual Daily Attendance Report</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <h6 class="mb-0 text-uppercase">Individual Daily Attendance Report</h6>
                    <hr />
                    <div class="card">
                        <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="find-dv">
                                                <div class="row">
                                                    <div class="col-sm-2">
                                                        ...
                                                        <asp:TextBox ID="txt_date" runat="server" class="form-select find-dv-txtbx datepicker"></asp:TextBox>
                                                    </div>
                                            ...
                                            <asp:Panel ID="pnl_grids" runat="server" Visible="false">
                                                <div class="prnt-btn-sec" style="display:none">
                                                ...
                                                <div id="tblPrintIQ" runat="server">
                                                    <div class="prnt-dv-wpr">
                                                        <div class="pgslry-head-div" style="display:none">
