<%@ Page Title="" Language="C#" MasterPageFile="~/Inventory_management/Site3.Master" AutoEventWireup="true" CodeBehind="Sale_history.aspx.cs" Inherits="school_web.Inventory_management.Sale_history" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="page-content">
        ...
        <div class="row">
            ...
            <div class="col-xl-12" id="tblPrintIQ">
                <h6 class="mb-0 text-uppercase">Sale History
                                            ...
                                            <table style="width: 100%;" id="example" class=" table table-hover table-striped table-bordered">
                                                <thead>
                                                    ...
                                                    <th>Roll No.</th>
                                                        ...
                                                        <th>Net Total</th>
                                                        <th style="display:none">Transprtation Charge</th>
                                                        <th style="display:none">Extra expense </th>
                                                        <th>Flat disc </th>
                                                        <th>After dis. </th>
                                                        <th>Round Off</th>
                                                        <th>Grand Total</th>
 ...
 <asp:Label ID="lbl_party_id1" runat="server" Text='<%#Bind("party_id")%>'></asp:Label>
                                                                ...
                                                                <td>
                                                                 ...
                                                                 <td> <asp:Label ID="lbl_rollnumber" runat="server" Text='<%#Bind("rollnumber")%>'></asp:Label></td>
                                                                <td>
                                                                    <asp:Label ID="lbl_invoice_no" runat="server" Text='<%#Bind("Bill_No")%>'></asp:Label>

                                                                    <asp:Label ID="lbl_partyid" runat="server" Text='<%#Bind("Consignee_Id")%>' Visible="false"></asp:Label>
                                                                ...
                                                                <td>
                                                                    <asp:Label ID="llb_discount" runat="server" Text='<%#Bind("Discount")%>'></asp:Label>
                                                                </td>

                                                                <td>
                                                                    <asp:Label ID="Label12" runat="server" Text='<%#Bind("Taxable")%>'></asp:Label>


                                                                </td>
                                                                <td>
                                                                    <asp:Label ID="lbl_Total_Gst_value" runat="server" Text='<%#Bind("GST")%>'></asp:Label>
                                                                </td>

                                                                <td style="display:none">
                                                                    <asp:Label ID="Label3" runat="server" Text='<%#Bind("CGST")%>'></asp:Label>
                                                                </td >
                                                                <td style="display:none">
                                                                    <asp:Label ID="Label4" runat="server" Text='<%#Bind("SGST")%>'></asp:Label>
                                                                </td>


                                                                <td>
                                                                    <asp:Label ID="Label14" runat="server" Text='<%#Bind("GrandTotal")%>'></asp:Label>
                                                                </td>
                                                                 

                                                                <td style="display:none">
                                                                    <asp:Label ID="Label11" runat="server" Text='<%#Bind("transprtation_charge")%>'></asp:Label>
                                                                </td>
                                                                <td style="display:none">
                                                                    <asp:Label ID="Label13" runat="server" Text='<%#Bind("expense")%>'></asp:Label>
                                                                </td>
                                                                <td>
                                                                    <asp:Label ID="Label16" runat="server" Text='<%#Bind("flat_disc")%>'></asp:Label>
                                                                </td>
                                                                <td>
                                                                    <asp:Label ID="Label17" runat="server" Text='<%#Bind("After_flat_discount")%>'></asp:Label>
                                                                </td>
                                                                <td>
                                                                    <asp:Label ID="Label15" runat="server" Text='<%#Bind("round_off")%>'></asp:Label>
                                                                </td>
                                                                <td>
                                                                    <asp:Label ID="Label5" runat="server" Text='<%#Bind("NetPayable")%>'></asp:Label>
                                                                </td>
                                                                <td>
                                                                    <asp:Label ID="lbl_total_paid" runat="server" Text='<%#Bind("Total_Paid_Amount")%>'></asp:Label>
                                                                </td>
                                                                <td>
                                                                    <asp:Label ID="lbl_total_dues" runat="server" Text='<%#Bind("Duse_Amount")%>'></asp:Label>
                                                                </td>
                                                                <td>
