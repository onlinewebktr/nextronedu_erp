<%@ Page Title="" Language="C#" MasterPageFile="~/Inventory_management/Site3.Master" AutoEventWireup="true" CodeBehind="User_Wise_Sales_Return_Report.aspx.cs" Inherits="school_web.Inventory_management.User_Wise_Sales_Return_Report" EnableEventValidation="false" %>
<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">User Wise Sales Return Report
</asp:Content>
      ...
      <div class="page-content">
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">User Wise Sales Return Report</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="row">
                        ...
                        <div class="p-4 border rounded serchbox">
                            <div class="row g-3 needs-validation" novalidate="">
                                 <div class="col-md-3">
                                   ...
                                   <asp:DropDownList ID="ddl_seesionuser" runat="server" class="form-control find-dv-txtbx"></asp:DropDownList>
                                </div>
            ...
            <div class="col-xl-12" id="tblPrintIQ">
                <h6 class="mb-0 text-uppercase" style="font-size: 15px; margin: 10px 0px 10px 0px;">User Wise Sales Return Reports:-<asp:Label ID="lbl_heading" runat="server"></asp:Label>
