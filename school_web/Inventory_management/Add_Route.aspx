<%@ Page Title="" Language="C#" MasterPageFile="~/Inventory_management/Site3.Master" AutoEventWireup="true" CodeBehind="Add_Route.aspx.cs" Inherits="school_web.Inventory_management.Add_Route" %>
<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">Create Route
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="page-content">
        ...
        <div class="row">
            <div class="col-xl-6">
                <asp:Label ID="ltUsertop" runat="server" Style="font-weight: 500; font-size: 1rem;" class="mb-0 text-uppercase" Text="Create Route"></asp:Label>
                <hr />
                <div class="card">
                    <div class="card-body">
                        <div class="p-4 border rounded">
                            <div class="row g-3 needs-validation" novalidate="">
                                <div class="col-md-12">
                                    <label for="validationCustom01" class="form-label">Enter Route Name  <sup>*<asp:RequiredFieldValidator ID="RequiredFieldValidator1" Display="Dynamic" runat="server" ErrorMessage="*" ValidationGroup="a" ControlToValidate="Txt_route_Name"></asp:RequiredFieldValidator></sup></label>

                                    <asp:TextBox ID="Txt_route_Name" runat="server" class="form-control"></asp:TextBox>
            ...
            <div class="col-xl-6">
                <h6 class="mb-0 text-uppercase">Added Route</h6>
                <hr />
                <div class="card">
                    <div class="card-body">
                                                    ...
                                                    <asp:GridView ID="GrdView_Create_Brand" runat="server" class="table table-bordered" AutoGenerateColumns="False" Width="100%">
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Route Name">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lbl_Route_name" runat="server" Text='<%#Bind("Route_name")%>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            ...
                                                            <asp:TemplateField HeaderText="Action">
                                                                <ItemTemplate>
                                                                    ...
                                                                    <asp:Label ID="lbl_Route_id" runat="server" Text='<%#Bind("Route_id")%>' Visible="false"></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
