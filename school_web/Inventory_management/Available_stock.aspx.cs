...
{
    public partial class Available_stock : System.Web.UI.Page
    {
        My mycode = new My();
        string scrpt;
        ...
        private void bind_all_data()
        {
            ...
            cmd.Parameters.AddWithValue("@sp_status", "Fetch_Stock");
        ...
        protected void btn_filter_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //if (ddl_itemtype.SelectedValue == "ALL")
                //{
                DataRow[] dr = dt.Select("Item_type='Assets' or Item_type='Consumable'");
                //}
                //else
                //{
