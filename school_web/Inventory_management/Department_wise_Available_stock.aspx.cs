...
{
    public partial class Department_wise_Available_stock : System.Web.UI.Page
    {
        My mycode = new My();
        string scrpt;
        ...
        {
            mycode.bind_all_ddl_with_id(ddl_store, " select Store_name,Store_id from dbo.[HMS_Invetory_Create_Store] where Sector_id!=1 ");
        }
        ...
        {
            SqlCommand cmd = new SqlCommand("sp_HMS_Temp_inventory_transfer_to_location");
            cmd.Parameters.AddWithValue("@sp_status ", "Fetch4");
            cmd.Parameters.AddWithValue("@Status ", "APPROVED");
            cmd.Parameters.AddWithValue("@Location_id ", ddl_location.SelectedValue);
            cmd.Parameters.AddWithValue("@Transfer_from_store ", ddl_store.SelectedValue);
        ...
        {
            mycode.bind_all_ddl_with_id(ddl_location, "select Location,Location_id from HMS_location_master where Store_id='" + ddl_store.SelectedValue + "' order by Location asc");
        }
