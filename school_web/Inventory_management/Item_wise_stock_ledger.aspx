<%@ Page Title="" Language="C#" MasterPageFile="~/Inventory_management/Site3.Master" AutoEventWireup="true" CodeBehind="Item_wise_stock_ledger.aspx.cs" Inherits="school_web.Inventory_management.Item_wise_stock_ledger" EnableEventValidation="false" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Item Wise Stock Ledger</li>
                    </ol>
                </nav>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        <div class="p-4 border rounded serchbox">
                            <div class="row g-3 needs-validation" novalidate="">
                                ...
                                <div class="col-md-5">
                                    <label for="validationCustom01" class="form-label">Select Year <sup></sup></label>
                                    <asp:DropDownList ID="ddl_year" runat="server" CssClass="form-control find-dv-txtbx">
                                       
                                    </asp:DropDownList>
                                </div>

                                <div class="col-md-5">
                                    <label for="validationCustom01" class="form-label">Select Month <sup> </sup></label>
                                    <asp:DropDownList ID="ddl_month" runat="server" CssClass="form-control find-dv-txtbx">
                                    </asp:DropDownList>
                                </div>
  ...
  margin: 10px 0px 10px 0px;">Item Wise Stock Ledger :- <asp:Label ID="lbl_heading" runat="server"  ></asp:Label>
 ...
 <asp:GridView ID="GrdView" runat="server" class="table table-bordered" AutoGenerateColumns="False" Width="100%" OnRowDataBound="GrdView_RowDataBound">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Opening Stock">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lbl_opening_stock" runat="server"></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderText="Purchase">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lbl_Purchase" runat="server"></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderText="Closing Stock">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lbl_closing_stock" runat="server"></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
