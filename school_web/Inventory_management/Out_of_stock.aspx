<%@ Page Title="" Language="C#" MasterPageFile="~/Inventory_management/Site3.Master" AutoEventWireup="true" CodeBehind="Out_of_stock.aspx.cs" Inherits="school_web.Inventory_management.Out_of_stock" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Out of stock</div>
            <div class="ps-3">
        ...
        <div class="row">
            ...
            <div class="col-xl-12">
                <h6 class="mb-0 text-uppercase">Total Out of stock
                                ...
                                <div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap5 hdrmodify">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div id="tblPrintIQ">
                                                 <asp:Panel ID="pnl_grid" runat="server" Style="width: 100%;"><table style="width: 100%;" id="example" class=" table table-hover table-striped table-bordered">
                                                    <thead>
                                                        <tr>
                                                            <th>#</th>
                                                            <th>Item Name</th>
