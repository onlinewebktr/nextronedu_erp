<%@ Page Title="" Language="C#" MasterPageFile="~/Inventory_management/Site3.Master" AutoEventWireup="true" CodeBehind="purchase_return_history.aspx.cs" Inherits="school_web.Inventory_management.purchase_return_history" %>
    ...
    <div class="page-content">
        ...
        <div class="row">
            ...
            <div class="col-xl-12" id="tblPrintIQ">
                <h6 class="mb-0 text-uppercase">Purchase Return History  
                                                    ...
                                                    <asp:Repeater ID="RPDetails" runat="server">
                                                        <ItemTemplate>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:LinkButton ID="lnk_view_items" OnClick="lnk_view_items_Click" runat="server">View</asp:LinkButton>
                                                                </td>
                                                            </tr>
                                                        </ItemTemplate>
                                                    </asp:Repeater>
                                ...
                                <asp:Repeater ID="Repeater1" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label ID="Label7" runat="server" Text='<%#Bind("Brand_name")%>'></asp:Label>
                                            </td>
                                            <td>
