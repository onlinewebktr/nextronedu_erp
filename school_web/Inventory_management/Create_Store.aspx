<%@ Page Title="" Language="C#" MasterPageFile="~/Inventory_management/Site3.Master" AutoEventWireup="true" CodeBehind="Create_Store.aspx.cs" Inherits="school_web.Inventory_management.Create_Store" EnableEventValidation="false" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-xl-6">
                <asp:Label ID="ltUsertop" runat="server" Style="font-weight: 500; font-size: 1rem;" class="mb-0 text-uppercase" Text="Create Store"></asp:Label>
                <hr />
                <div class="card">
                    <div class="card-body">
                        <div class="p-4 border rounded">
                            <div class="row g-3 needs-validation" novalidate="">
                                <div class="col-md-6">
                                    <label for="validationCustom01" class="form-label">Enter Store Name  <sup>*<asp:RequiredFieldValidator ID="RequiredFieldValidator1" Display="Dynamic" runat="server" ErrorMessage="*" ValidationGroup="a" ControlToValidate="Txt_Store_Name"></asp:RequiredFieldValidator></sup></label>

                                    <asp:TextBox ID="Txt_Store_Name" runat="server" class="form-control"></asp:TextBox>

                                </div>
                                <div class="col-md-6">
                                    <label for="validationCustom01" class="form-label">Sector<sup>*<asp:RequiredFieldValidator ID="RequiredFieldValidator2" Display="Dynamic" runat="server" ErrorMessage="*" ValidationGroup="a" ControlToValidate="Ddl_Sector"></asp:RequiredFieldValidator></sup></label>

                                    <asp:DropDownList ID="Ddl_Sector" runat="server" class="form-control find-dv-txtbx">
                                        <asp:ListItem Value="0" Enabled="true">Select</asp:ListItem>
                                        <asp:ListItem Value="9000">IPD</asp:ListItem>
                                        <asp:ListItem Value="9002">EMERGENCY</asp:ListItem>
                                        <asp:ListItem Value="9001">OT</asp:ListItem>
                                        <asp:ListItem Value="9003">OPD</asp:ListItem>
                                        <asp:ListItem Value="9004">LAB</asp:ListItem>
                                        <asp:ListItem Value="9008">DAYCARE</asp:ListItem>
                                        <asp:ListItem Value="9005">Canteen</asp:ListItem>
                                        <asp:ListItem Value="9006">Account</asp:ListItem>
                                        <asp:ListItem Value="9007">HR</asp:ListItem>
                                    </asp:DropDownList>
            ...
            <div class="col-xl-6">
                <h6 class="mb-0 text-uppercase">Added Store</h6>
                <hr />
                <div class="card">
                    <div class="card-body">
                                            ...
                                            ToolTip="Print"><i class='bx bx-printer'></i></asp:LinkButton><div id="tblPrintIQ" runat="server">
                                                <div class="pgslry-head-div" style="width: 100%;">
                                                    <div style="margin: 7px 0px 0px 0px; padding: 0px; float: left; height: auto; text-align: center; vertical-align: middle; font-size: 13px; width: 100%;" class="head">
                                                        <span style="font-size: 14px; font-weight: bold;">Store List </span>


                                                    </div>
                                                    <asp:GridView ID="GrdView_Create_Store" runat="server" class="table table-bordered" AutoGenerateColumns="False" Width="100%">
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Action">
                                                                <ItemTemplate>
                                                                    ...
                                                                    <asp:Label ID="lbl_Sector_id" runat="server" Text='<%#Bind("Sector_id")%>' Visible="false"></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
