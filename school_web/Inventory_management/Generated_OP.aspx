<%@ Page Title="" Language="C#" MasterPageFile="~/Inventory_management/Site3.Master" AutoEventWireup="true" CodeBehind="Generated_OP.aspx.cs" Inherits="school_web.Inventory_management.Generated_OP" %>
    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-xl-6" style="margin: 0px auto;">
                <asp:Label ID="ltUsertop" runat="server" Style="font-weight: 500; font-size: 1rem;" class="mb-0 text-uppercase" Text="Search Generated PO"></asp:Label>
                <hr />
                <div class="card">
                    <div class="card-body">
            ...
            <div class="col-xl-12" id="tblPrintIQ">
                <h6 class="mb-0 text-uppercase">Generated P.O. 

                       <asp:LinkButton ID="lnk_excel_download" runat="server" OnClick="lnk_excel_download_Click" class="btn-print noPrint" Style="float: right"><i class="fa fa-file-excel"> </i></asp:LinkButton>
                    <asp:LinkButton ID="print1" OnClientClick="return PrintPanel('tblPrintIQ')" runat="server" ToolTip="Print" class="btn-print noPrint" Style="float: right"><i class="fa fa-print" aria-hidden="true"></i></asp:LinkButton>
                                        ...
                                        <asp:GridView ID="GrdView_Generate_PO" runat="server" class="table table-bordered" AutoGenerateColumns="False" Width="100%">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="P.O Date">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lbl_Po_date" runat="server" Text='<%#Bind("Po_date")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="P.O No.">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lbl_PO_no" runat="server" Text='<%#Bind("PO_no")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderText="Status">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lbl_verify_status" runat="server" CssClass='<%#Bind("verify_status")%>' Text='<%#Bind("verify_status")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderText="Action">
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="lnk_print" runat="server" CausesValidation="false" OnClick="lnk_print_Click" ToolTip="Print">Print</asp:LinkButton>
                                                        ...
                                                        <asp:Label ID="lbl_entry_id_po" runat="server" Text='<%#Bind("entry_id_po")%>' Visible="false"></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
