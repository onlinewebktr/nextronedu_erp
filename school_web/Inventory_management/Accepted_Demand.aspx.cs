...
{
    public partial class Accepted_Demand : System.Web.UI.Page
    {
        My mycode = new My();
        string scrpt;
        ...
        private void bind_all_data()
        {
            ...
            cmd.Parameters.AddWithValue("@sp_status", "ALLDEMAND1");
            cmd.Parameters.AddWithValue("@Is_accept ", 1);
        ...
        protected void Btn_Find_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string todate = txt_to_Date.Text;


                if (Convert.ToInt32(My.convertidate(txt_from_Date.Text)) > Convert.ToInt32(My.convertidate(txt_to_Date.Text)))
                {
        ...
        private void bind_gridview_for_items(Label lbl_Cart_id, Label lbl_Demand_no)
        {
            ...
            if (ds.Tables[0].Rows[0]["Is_stock_stranfered"].ToString() == "True")
            {
                btn_accept_demand.Visible = false;
            }
            else
            {
                btn_accept_demand.Visible = true;
            }
