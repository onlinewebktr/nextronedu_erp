<%@ Page Title="" Language="C#" MasterPageFile="~/Inventory_management/Site3.Master" AutoEventWireup="true" CodeBehind="Generate_OP.aspx.cs" Inherits="school_web.Inventory_management.Generate_OP" %>
                        ...
                        <div class="p-4 border rounded serchbox">
                            <div class="row g-3 needs-validation" novalidate="">
                                ...
                                <div class="col-md-3" style="display: none;">
                                    ...
                                    <asp:Label ID="lbl_purchase_order_number" runat="server" class="form-control find-dv-txtbx datepicker" Style="height: 37px;"></asp:Label>
                                </div>
                            </div>
                            <div class="row g-3 needs-validation" novalidate="" style="margin-top: 10px;">
                                <div class="col-md-5">
                                    <label for="validationCustom01" class="form-label">
                                        Select Item <sup>*<asp:RequiredFieldValidator ID="RequiredFieldValidator1" Display="Dynamic" runat="server" ErrorMessage="*" ValidationGroup="a" ControlToValidate="txt_Item"></asp:RequiredFieldValidator></sup>
        ...
        function searching() {
            $("#<%=txt_suppliername.ClientID%>").autocomplete({
                ...
                source: function (request, response) {
                    $.ajax({
                        url: '../MasterAdmin/Search.aspx/Search_supplier_name',
            ...
            $("#<%=txt_Item.ClientID%>").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        url: '../MasterAdmin/Search.aspx/Search_inventory_item',
                        data: "{ 'itemName': '" + request.term + "'}",
                        dataType: "json",
                        type: "POST",
                        contentType: "application/json; charset=utf-8",
