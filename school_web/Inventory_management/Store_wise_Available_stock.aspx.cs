...
{
    public partial class Store_wise_Available_stock : System.Web.UI.Page
    {
        My mycode = new My();
        string scrpt;
        ...
        private void bind_all_data()
        {
            ...
            cmd.Parameters.AddWithValue("@sp_status", "Fetch_Stock1");
        ...
        protected void btn_filter_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DataRow[] dr = dt.Select("Item_type='" + ddl_itemtype.SelectedValue + "'");
                if (dr.Length != 0)
                {
