<%@ Page Title="" Language="C#" MasterPageFile="~/Inventory_management/Site3.Master" AutoEventWireup="true" CodeBehind="Day_End_Closing_Report.aspx.cs" ValidateRequest="false" EnableEventValidation="false" Inherits="school_web.Inventory_management.Day_End_Closing_Report " %>
<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">Day End Closing Report
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Day End Wise Closing Report</li>
                    </ol>
                </nav>
            </div>
        </div>
  ...
  margin: 10px 0px 10px 0px;">Day End Wise Closing Report :- <asp:Label ID="lbl_heading" runat="server"  ></asp:Label>
 ...
 <asp:GridView ID="GrdView" runat="server" class="table table-bordered" AutoGenerateColumns="False" Width="100%" OnRowDataBound="GrdView_RowDataBound">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Closing Stock">
                                                     ...
                                                     <asp:TemplateField HeaderText="Closing Sale Amount">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lbl_closingsale_amount" runat="server"></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
