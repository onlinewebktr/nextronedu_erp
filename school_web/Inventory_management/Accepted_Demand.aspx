<%@ Page Title="" Language="C#" MasterPageFile="~/Inventory_management/Site3.Master" AutoEventWireup="true" CodeBehind="Accepted_Demand.aspx.cs" Inherits="school_web.Inventory_management.Accepted_Demand" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                            ...
                            <fieldset class="fieldset" style="background-color: White">
                                ...
                                <table>
                                    ...
                                    <tr>
                                            ...
                                            <asp:GridView ID="GrdView_Generate_PO" runat="server" class="data-Table table table-bordered" AutoGenerateColumns="False" Width="100%">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Accept Quantity">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txt_qty" runat="server" Text='<%#Bind("Accept_qty")%>' Style="width: 50px;"></asp:TextBox>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                     ...
                                     <tr>
                                        <td colspan="3">
                                            <asp:Button ID="btn_accept_demand" runat="server" Text="Update" OnClick="btn_accept_demand_Click" />
                                        </td>
                                    </tr>
                                </table>
    ...
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Accepted Demand</div>
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        <li class="breadcrumb-item"><a href="Dashboard.aspx"><i class="bx bx-home-alt"></i></a>
                        </li>
                        <li class="breadcrumb-item active" aria-current="page">Accepted Demand</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-xl-6" style="margin: 0px auto;">
                <asp:Label ID="ltUsertop" runat="server" Style="font-weight: 500; font-size: 1rem;" class="mb-0 text-uppercase" Text="Search Accepted Demand"></asp:Label>
                <hr />
                <div class="card">
                    <div class="card-body">
            ...
            <div class="col-xl-12"  id="tblPrintIQ">
                <h6 class="mb-0 text-uppercase">Accepted Demand 
     ...
     <script type='text/javascript'>
        $(function () {
            ...
            $('.close1').click(function () {
                $('.popup1').hide();
                document.getElementById('<%= hd_view.ClientID %>').value = "0";
