<%@ Page Title="" Language="C#" MasterPageFile="~/Inventory_management/Site3.Master" AutoEventWireup="true" CodeBehind="stock-storewise.aspx.cs" Inherits="school_web.Inventory_management.stock_storewise" %>
    ...
    <div class="page-content">
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">StoreWise Available Stock</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="row">
                    ...
                    <div class="card-body">
                        <div class="p-4 border rounded">
                            <div class="row g-3 needs-validation" novalidate="">
                                <div class="col-md-5">
                                    <label for="validationCustom01" class="form-label">Store <sup>*</sup></label>
            ...
            <div class="col-xl-12" id="tblPrintIQ">
                <h6 class="mb-0 text-uppercase">StoreWise Available Stock
