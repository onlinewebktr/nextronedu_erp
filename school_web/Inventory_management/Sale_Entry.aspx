<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sale_Entry.aspx.cs" Inherits="school_web.Inventory_management.Sale_Entry" %>
...
<body>
    <form id="form1" runat="server">
            ...
            <div class="page-wrapper">
                <div class="page-content">
                    ...
                    <div class="page-breadcrumb d-flex align-items-center mb-2 eeewe">
                        ...
                        <div class="col-xl-1">
                            <a href="#" data-toggle="modal" data-target="#myModal4" style="background: #0c17e8; color: #fff; padding: 5px 9px 5px 10px; border-radius: 5px; margin: 0px 0px 0px 0px; text-decoration: none; position: absolute; right: 96px; top: 7px; font-size: 14px;"><i class="bx bx-plus-medical"></i>Add Student</a>
                        </div>
                        <div class="col-xl-1">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0 p-0">
                                                        ...
                                                        <div class="fnd-box-row-wpr">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-xl-10 padd-lft-5">
                                                                    <asp:TextBox ID="txt_seal_to" runat="server" CssClass="form-control find-dv-txtbx" AutoPostBack="true" OnTextChanged="txt_seal_to_TextChanged"></asp:TextBox>
                                                                ...
                                                                <div class="col-xl-2 padd-lft-5" style="display: none">
                                                                    <asp:TextBox ID="txt_mobileno" runat="server" CssClass="form-control find-dv-txtbx"></asp:TextBox>
        ...
        <script type="text/javascript">
            $(function () {
                ...
                $("#<%=txt_seal_to.ClientID%>").autocomplete({
                    source: function (request, response) {
                        $.ajax({
                            url: 'Sale_Entry.aspx/GetRooPath',
            ...
            $(function () {
                //var saletype = $('#<%= hd_saletype.ClientID %>').val();

                $("#<%=txt_item_Descriptin.ClientID%>").autocomplete({
                    source: function (request, response) {
                        $.ajax({
                            url: 'Sale_Entry.aspx/Getitem',
        ...
        <div id="myModal4" runat="server" class="conf-alrt-sec modal fade" role="dialog" data-backdrop="static" data-keyboard="false" style="top: 56px;">
            <div class="conf-alrt-inr" style="width: 750px; padding: 8px 12px 0px 10px;">
                <div class="popupTablWpR">
                    <div class="row">
                        <div class="col-md-6">
                            <h2 class="popup-dt-h">Add New Student</h2>
                        </div>
                        <div class="col-md-6">
                            <ul class="conf-btn-ul" style="margin: 0px 0px 0px 0px;">
                                <li>
                    ...
                    <asp:Panel ID="pnl_student_entery" runat="server">
                        <table style="width: 100%;" id="Table111" border="1" class="table table-hover table-bordered ">
                            ...
                            <tr>
                                <td class="td1">Registration No<sup>*<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txt_regid" ErrorMessage="Requred" ValidationGroup="ck"></asp:RequiredFieldValidator>

                                </sup>
                                </td>
                                <td class="td1">Class<sup>*</sup>
                                </td>
                                <td class="td1">Section<sup>*<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txt_section" ErrorMessage="Requred" ValidationGroup="ck"></asp:RequiredFieldValidator>
                            ...
                            <tr>
                                <td class="td1">
                                    <asp:TextBox ID="txt_regid" oninput="this.value = this.value.toUpperCase()" runat="server" CssClass="form-control"></asp:TextBox>
                                </td>
                                <td class="td1">
                            ...
                            <tr>
                                <td class="td1">Student Name<sup>*<asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txt_student_name" ErrorMessage="Requred" ValidationGroup="ck"></asp:RequiredFieldValidator>

                                </sup>
                                </td>
                                <td class="td1">Father's Name<sup>*<asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txt_father_name" ErrorMessage="Requred" ValidationGroup="ck"></asp:RequiredFieldValidator>

                                </sup>
                                </td>
                                <td class="td1">Mother's Name<sup>*<asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txt_mothername" ErrorMessage="Requred" ValidationGroup="ck"></asp:RequiredFieldValidator>
                            ...
                            <tr>
                                ...
                                <td class="td1">
                                    <asp:TextBox ID="txt_mothername" oninput="this.value = this.value.toUpperCase()" runat="server" CssClass="form-control">

                                    </asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td class="td1">Dob<sup>*<asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="txt_dob" ErrorMessage="Requred" ValidationGroup="ck"></asp:RequiredFieldValidator>

                                </sup></td>
                                <td class="td1">Gender<sup>*</sup>
                                </td>
                                <td class="td1">Mobile<sup>*<asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txt_Mobile_no" ErrorMessage="Requred" ValidationGroup="ck"></asp:RequiredFieldValidator>
                            ...
                            <tr>
                                <td>
                                    <asp:TextBox ID="txt_dob" runat="server" class="form-control find-dv-txtbx" placeholder="dd/mm/yyyy" onkeyup="var v = this.value; if (v.match(/^\d{2}$/) !== null) {this.value = v + '/';} else if (v.match(/^\d{2}\/\d{2}$/) !== null) {this.value = v + '/';}" MaxLength="10"></asp:TextBox>
                                ...
                                <td class="td1">
                                    <asp:TextBox ID="txt_Mobile_no" onkeypress="return isNumberKey(event)" runat="server" CssClass="form-control"></asp:TextBox>
                                </td>
                                <td class="td1"></td>
                            </tr>
                            <tr>
        ...
        <script type="text/javascript"> 
            ...
            $(function () {
                ...
                <%--function calculate_bank() {
                    var payble_amount = parseFloat($("#<%=txt_payble_amount.ClientID %>").val());
                     var recived_cash = parseFloat($("#<%=txt_recived.ClientID %>").val());
                     var txt_recived_from_bank = parseFloat($("#<%=txt_recived_from_bank.ClientID %>").val());
                     var total_paid = parseFloat($("#<%=txt_total_paid.ClientID %>").val());
                    var total_dues = parseFloat($("#<%=txt_dues.ClientID %>").val());
                    var dues_amt = 0;
                    var final_amt = 0;


                    var restamountincash = (payble_amount - txt_recived_from_bank);
                    $("#<%=txt_recived.ClientID %>").val(restamountincash.toFixed(2));

                    var recived_cash = parseFloat($("#<%=txt_recived.ClientID %>").val());
                    var txt_recived_from_bank = parseFloat($("#<%=txt_recived_from_bank.ClientID %>").val());

                    var ttl_recivedamt = (restamountincash + txt_recived_from_bank);
