<%@ Page Title="" Language="C#" MasterPageFile="~/Inventory_management/Site3.Master" AutoEventWireup="true" CodeBehind="Inventory_Stock_Log_Report.aspx.cs" Inherits="school_web.Inventory_management.Inventory_Stock_Log_Report" EnableEventValidation="false" %>
<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">Stock Reconciliation Report
</asp:Content>
     ...
     <div class="page-content">
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Stock Reconciliation Report</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-xl-12" id="tblPrintIQ">
                <h6 class="mb-0 text-uppercase" style="font-size: 15px;
  margin: 10px 0px 10px 0px;">Stock Reconciliation Report :- <asp:Label ID="lbl_heading" runat="server"  ></asp:Label>
 ...
 <asp:GridView ID="GrdView" runat="server" class="table table-bordered" AutoGenerateColumns="False" Width="100%"  >
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Item">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lbl_itemname" runat="server" Text='<%#Bind("Item_Name")%>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Unit">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lbl_unitname" runat="server" Text='<%#Bind("Unit")%>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                     
                                                     <asp:TemplateField HeaderText="Old Quty">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lbl_oldquty" runat="server" Text='<%#Bind("Old_Quantity")%>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                      <asp:TemplateField HeaderText="Change Quty">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lbl_changeqty" runat="server" Text='<%#Bind("Changed_Quantity")%>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                     <asp:TemplateField HeaderText="Change Quty">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lbl_New_Quantity" runat="server" Text='<%#Bind("New_Quantity")%>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>

                                                     <asp:TemplateField HeaderText="Action Type">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lbl_Action_Type" runat="server" Text='<%#Bind("Action_Type")%>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>

                                                   <asp:TemplateField HeaderText="Reason">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lbl_Reason" runat="server" Text='<%#Bind("Reason")%>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>

                                                      <asp:TemplateField HeaderText="Reason">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lbl_Changed_On" runat="server" Text='<%#Bind("date_time")%>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
