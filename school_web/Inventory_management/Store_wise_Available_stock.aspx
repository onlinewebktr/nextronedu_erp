<%@ Page Title="" Language="C#" MasterPageFile="~/Inventory_management/Site3.Master" AutoEventWireup="true" CodeBehind="Store_wise_Available_stock.aspx.cs" Inherits="school_web.Inventory_management.Store_wise_Available_stock" %>
    ...
    <div class="page-content">
        ...
        <div class="row">
            ...
            <div class="col-xl-12" id="tblPrintIQ">
                <h6 class="mb-0 text-uppercase">Available Stock</h6>
                <hr />
                <div class="card">
                    <div class="card-body">
                        <div class="table-responsive">
                            <div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap5 hdrmodify">
                                <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                        <table style="width: auto; margin: 0px auto;" class=" table table-hover table-striped table-bordered noPrint">
                                            <tr>
