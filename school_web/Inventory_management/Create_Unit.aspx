<%@ Page Title="" Language="C#" MasterPageFile="~/Inventory_management/Site3.Master" AutoEventWireup="true" CodeBehind="Create_Unit.aspx.cs" Inherits="school_web.Inventory_management.Create_Unit" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-xl-6">
                <asp:Label ID="ltUsertop" runat="server" Style="font-weight: 500; font-size: 1rem;" class="mb-0 text-uppercase" Text="Create Unit"></asp:Label>
                <hr />
                <div class="card">
                    <div class="card-body">
                        <div class="p-4 border rounded">
                            <div class="row g-3 needs-validation" novalidate="">
                                <div class="col-md-6">
                                    <label for="validationCustom01" class="form-label">Enter Unit Name  <sup>*<asp:RequiredFieldValidator ID="RequiredFieldValidator1" Display="Dynamic" runat="server" ErrorMessage="*" ValidationGroup="a" ControlToValidate="Txt_Unit_Name"></asp:RequiredFieldValidator></sup></label>
                                    <asp:TextBox ID="Txt_Unit_Name" runat="server" class="form-control"></asp:TextBox>

                                </div>
                                <div class="col-md-6">
                                    <label for="validationCustom01" class="form-label">Under UQS  </label>
                                    <asp:DropDownList ID="ddl_uqc" runat="server" CssClass="form-control">
                                    </asp:DropDownList>
            ...
            <div class="col-xl-6">
                <h6 class="mb-0 text-uppercase">Added Unit</h6>
                <hr />
                <div class="card">
                    <div class="card-body">
                                            ...
                                            ToolTip="Print"><i class='bx bx-printer'></i></asp:LinkButton><div id="tblPrintIQ" runat="server">
                                                <div class="pgslry-head-div" style="width: 100%;">
                                                    <div style="margin: 7px 0px 0px 0px; padding: 0px; float: left; height: auto; text-align: center; vertical-align: middle; font-size: 13px; width: 100%;" class="head">
                                                        <span style="font-size: 14px; font-weight: bold;">Unit List </span>


                                                    </div>
                                                    <asp:GridView ID="GrdView_Create_Unit" runat="server" class="table table-bordered" AutoGenerateColumns="False" Width="100%">
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="UAC Code">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lbl_uqc_code" runat="server" Text='<%#Bind("uqc_code")%>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
