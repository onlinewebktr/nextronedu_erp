<%@ Page Title="" Language="C#" MasterPageFile="~/Inventory_management/Site3.Master" AutoEventWireup="true" CodeBehind="Department_wise_Available_stock.aspx.cs" Inherits="school_web.Inventory_management.Department_wise_Available_stock" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Available Stock</div>
            <div class="ps-3">
        ...
        <div class="row">
            <div class="col-xl-8" style="margin: 0px auto;">
                <asp:Label ID="ltUsertop" runat="server" Style="font-weight: 500; font-size: 1rem;" class="mb-0 text-uppercase" Text="Department wise Available Stock"></asp:Label>
                <hr />
                <div class="card">
                    <div class="card-body">
                        <div class="p-4 border rounded">
                            <div class="row g-3 needs-validation" novalidate="">
                                <div class="col-md-5">
                                    <label for="validationCustom01" class="form-label">Select Store</label>
                                ...
                                <div class="col-md-5">
                                    <label for="validationCustom01" class="form-label">Select Department</label>
                                    <asp:DropDownList ID="ddl_location" runat="server" class="form-control find-dv-txtbx"></asp:DropDownList>
                                </div>
                                <div class="col-md-2" style="padding: 26px 0px 0px 0px;">
                                    <asp:Button ID="Btn_Find" runat="server" Text="Find" CssClass="btn btn-primary" ValidationGroup="a" OnClick="Btn_Find_Click" />
                                ...
                                <div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap5 hdrmodify">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <p>
                                                <asp:Label ID="lbl_storename" runat="server" Text=""></asp:Label>
                                            </p>
                                                    ...
                                                    <asp:Repeater ID="RPDetails" runat="server">
                                                        <ItemTemplate>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:Label ID="lbl_Name" runat="server" Text='<%#Bind("Store_name")%>'></asp:Label>
                                                                    <asp:Label ID="lbl_store_id" runat="server" Text='<%#Bind("Transfer_from_store")%>' Visible="false"></asp:Label>
                                                                </td>

                                                                <td>
                                                                    <asp:Label ID="lbl_location" runat="server" Text='<%#Bind("Location_name")%>'></asp:Label>
                                                                </td>
                                                                <td>
                                                                    <asp:Label ID="Label1" runat="server" Text='<%#Bind("Item_Name")%>'></asp:Label>
                                                                </td>
                                                                <td>
                                                                    <asp:Label ID="Label7" runat="server" Text='<%#Bind("Batch_no")%>'></asp:Label>
                                                                </td>
                                                                <td>
                                                                    <asp:Label ID="Label2" runat="server" Text='<%#Bind("Expiry_date")%>'></asp:Label>
                                                                </td>
                                                                <td>
                                                                    <asp:Label ID="Label3" runat="server" Text='<%#Bind("Brand_name")%>'></asp:Label>
                                                                </td>
                                                                <td>
