<%@ Page Title="" Language="C#" MasterPageFile="~/Inventory_management/Site3.Master" AutoEventWireup="true" CodeBehind="Date_Wise_Purchase_Report.aspx.cs" Inherits="school_web.Inventory_management.Date_Wise_Purchase_Report" %>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="p-4 border rounded serchbox">
                            <div class="row g-3 needs-validation" novalidate="">
                                <div class="col-md-10">
                                    <label for="validationCustom01" class="form-label">Purchase Invoice Wise </label>
                                ...
                                <div class="col-md-2" style="padding: 26px 0px 0px 0px;">
                                    <asp:Button ID="btn_find_Invoice" runat="server" Text="Find" OnClick="btn_find_Invoice_Click" CssClass="btn btn-primary" ValidationGroup="a" />
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <asp:Repeater ID="RPDetails" runat="server" OnItemDataBound="RPDetails_ItemDataBound">
                                            <ItemTemplate>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:Label ID="lbl_invoice_no" runat="server" Text='<%#Bind("invoice_no")%>'></asp:Label></td>
                                                    <td>
                                                        <asp:Label ID="lbl_Item_Code" runat="server" Text='<%#Bind("Item_Code")%>'></asp:Label></td>
                                                    <td>
                                                        <asp:Label ID="lbl_brand" runat="server" Text='<%#Bind("brand")%>'></asp:Label></td>
                                                    <td>
                                                        <asp:Label ID="lbl_hsn_no" runat="server" Text='<%#Bind("hsn_no")%>'></asp:Label></td>
                                                    ...
                                                    <td>
                                                        <asp:Label ID="lbl_NetTotal" runat="server" Text='<%#Bind("NetTotal")%>'></asp:Label>
                                                    </td>
                                                    <td>
                                            ...
                                            <FooterTemplate>
                                                <tr>
                                                    ...
                                                    <td></td>
                                                    <td></td>
                                                    <td style="border-top: 2px solid #000!important; font-size: 12px;"><b>Sub Total:-</b></td>
                                                    <td style="border-top: 2px solid #000!important; font-size: 12px;"></td>
                                                    <td style="border-top: 2px solid #000!important; font-size: 12px;">
                                                        <asp:Label ID="lbl_tot_Rate" runat="server" Font-Bold="true"></asp:Label></td>
                                                    <td style="border-top: 2px solid #000!important; font-size: 12px;">
                                                        <asp:Label ID="lbl_tot_quantity" runat="server" Font-Bold="true"></asp:Label></td>
                                                    <td style="border-top: 2px solid #000!important; font-size: 12px;"></td>
                                                    <td style="border-top: 2px solid #000!important; font-size: 12px;">
                                                        <asp:Label ID="lbl_total_amt" runat="server" Font-Bold="true"></asp:Label></td>
                                                    <td style="border-top: 2px solid #000!important; font-size: 12px;">
                                                        <asp:Label ID="lbl_tot_discount" runat="server" Font-Bold="true"></asp:Label></td>
                                                    <td style="border-top: 2px solid #000!important; font-size: 12px;">
                                                        <asp:Label ID="lbl_tot_taxable" runat="server" Font-Bold="true"></asp:Label></td>
                                                    <td style="border-top: 2px solid #000!important; font-size: 12px;">
                                                        <asp:Label ID="lbl_tot_IGST" runat="server" Font-Bold="true"></asp:Label></td>
                                                    <td style="border-top: 2px solid #000!important; font-size: 12px;">
                                                        <asp:Label ID="lbl_tot_SGST" runat="server" Font-Bold="true"></asp:Label></td>
                                                    <td style="border-top: 2px solid #000!important; font-size: 12px;">
                                                        <asp:Label ID="lbl_tot_CGST" runat="server" Font-Bold="true"></asp:Label></td>
                                                    <td style="border-top: 2px solid #000!important; font-size: 12px;">
                                                        <asp:Label ID="lbl_tot_NetTotal" runat="server" Font-Bold="true"></asp:Label></td>
