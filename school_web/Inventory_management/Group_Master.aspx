<%@ Page Title="" Language="C#" MasterPageFile="~/Inventory_management/Site3.Master" AutoEventWireup="true" CodeBehind="Group_Master.aspx.cs" Inherits="school_web.Inventory_management.Group_Master" EnableEventValidation="false" %>
<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">Create Group
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="page-content">
        ...
        <div class="row">
            <div class="col-xl-6">
                <asp:Label ID="ltUsertop" runat="server" Style="font-weight: 500; font-size: 1rem;" class="mb-0 text-uppercase" Text="Create Group"></asp:Label>
                <hr />
                <div class="card">
                    <div class="card-body">
                        <div class="p-4 border rounded">
                            <div class="row g-3 needs-validation" novalidate="">
                                <div class="col-md-12">
                                    <label for="validationCustom01" class="form-label">Enter Group Name  <sup>*<asp:RequiredFieldValidator ID="RequiredFieldValidator1" Display="Dynamic" runat="server" ErrorMessage="*" ValidationGroup="a" ControlToValidate="Txt_Group_Name"></asp:RequiredFieldValidator></sup></label>

                                    <asp:TextBox ID="Txt_Group_Name" runat="server" class="form-control"></asp:TextBox>
            ...
            <div class="col-xl-6">
                <h6 class="mb-0 text-uppercase">Added Group </h6>
                <hr />
                <div class="card">
                    <div class="card-body">
                                            ...
                                            ToolTip="Print"><i class='bx bx-printer'></i></asp:LinkButton><div id="tblPrintIQ" runat="server">
                                                <div class="pgslry-head-div" style="width: 100%;">
                                                    <div style="margin: 7px 0px 0px 0px; padding: 0px; float: left; height: auto; text-align: center; vertical-align: middle; font-size: 13px; width: 100%;" class="head">
                                                        <span style="font-size: 14px; font-weight: bold;">Group List </span>


                                                    </div>
                                                    <asp:GridView ID="GrdView_Create_Group" runat="server" class="table table-bordered" AutoGenerateColumns="False" Width="100%">
                                                        <Columns>
