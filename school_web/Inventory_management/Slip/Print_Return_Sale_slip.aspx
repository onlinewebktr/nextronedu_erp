<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Print_Return_Sale_slip.aspx.cs" Inherits="school_web.Inventory_management.Slip.Print_Return_Sale_slip" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Print Return Sale slip</title>
                                ...
                                <div class="printSlip">
                                    ...
                                    <table class="data-Table">
                                        <thead>
                                            ...
                                            <tr>
                                                <td colspan="4" class="border-top" style="border: none;">
                                                    <div style="background-color: #ebf1cc; box-shadow: 5px 5px #daddca; width: 100%; margin: 0px auto; text-align: center; font-size: 17px;">Sales Return</div>
                                                </td>
                                            </tr>
                                            <tr>
                                                                    ...
                                                                    <ItemTemplate>
                                                                        <tr>
                                                                            ...
                                                                            <td style="text-align: right;">
                                                                                <asp:Label ID="lbl_Total" runat="server" Text='<%#Bind("Net_Total")%>'></asp:Label>
                                                                            </td>
                                            ...
                                            <tr>
                                                <td colspan="4" style="padding: 0px 0px 10px 0px; padding-left: 5px; text-align: left; border: 1px solid #fff; vertical-align: top">
                                                        ...
                                                        <table style="width: 98%; float: left; margin: 0px 0px 0px 5px;">
                                                            <tr>
                                                                <td>
                                                                    ...
                                                                    <asp:Label ID="lbl_payment_tra" runat="server"></asp:Label>
                                                    ...
                                                    <div style="margin: 0px; padding: 0px; float: left; height: auto; width: 30%">
                                                        <table style="width: 100%; float: left; margin: 0px; padding: 0px;">
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                <td class="noborder">Retuern Total :</td>
                                                                <td class="noborder">
