<%@ Page Title="" Language="C#" MasterPageFile="~/Inventory_management/Site3.Master" AutoEventWireup="true" CodeBehind="Upload_Item_stock_by_excel.aspx.cs" Inherits="school_web.Inventory_management.Upload_Item_stock_by_excel" MaintainScrollPositionOnPostback="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
  Upload Item stock by excel
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Upload Item Stock By Excel </div>
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        <li class="breadcrumb-item"><a href="Dashboard.aspx"><i class="bx bx-home-alt"></i></a>
                        </li>
                        <li class="breadcrumb-item active" aria-current="page">Upload Stock By Excel</li>
                    </ol>
                </nav>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        <div class="p-4 border rounded">
                            <div class="row g-3 needs-validation" novalidate="">
                                <div class="col-md-12">
                                    <a href="../important_docx/Inventory_stock.csv">Download Item Format</a>
                                </div>


                                <div class="col-md-6">
                                    <label for="validationCustom01" class="form-label">Select Sector <sup>*</sup></label>
                                     <asp:DropDownList ID="ddl_sector" runat="server" class="form-control find-dv-txtbx" AutoPostBack="true" OnSelectedIndexChanged="ddl_sector_SelectedIndexChanged"></asp:DropDownList>

                                </div>
                                <div class="col-md-6">
                                     <label for="validationCustom01" class="form-label">Select Store <sup>*</sup></label>
