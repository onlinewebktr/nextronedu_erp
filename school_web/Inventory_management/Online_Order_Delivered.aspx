<%@ Page Title="" Language="C#" MasterPageFile="~/Inventory_management/Site3.Master" AutoEventWireup="true" CodeBehind="Online_Order_Delivered.aspx.cs" Inherits="school_web.Inventory_management.Online_Order_Delivered" EnableEventValidation="false" ValidateRequest="false" %>
<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">Delivered Order
</asp:Content>
      ...
      <div class="page-content">
        ...
        <div class="row">
            ...
            <div class="col-xl-12" id="tblPrintIQ">
                <h6 class="mb-0 text-uppercase">Delivered Order
                                                    ...
                                                    <ItemTemplate>
                                                        <tr>
                                                            ...
                                                            <td>
                                                             ...
                                                             <td>
                                                                <asp:Label ID="lbl_Date2" runat="server" Text='<%#Bind("Date2")%>'></asp:Label>
                                                            </td>
                                                             <td>
                                                                <asp:Label ID="lbl_New_bill_no" runat="server" Text='<%#Bind("New_bill_no")%>'></asp:Label>
                                                            </td>
                                                             <td>
                                                                <asp:Label ID="Label1" runat="server" Text='<%#Bind("Process_by")%>'></asp:Label>
                                                            </td>
                                                            ...
                                                            <td class="noPrint">
                                                                <div class="user-box dropdown" style="float: left; display: inherit; height: auto; border-left: 0px solid #f0f0f0; margin-left: 0px;">
                                                                    ...
                                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                                        <li>
                                                                            <a class="dropdown-item" href="Slip/Print_Sale_slip.aspx?unique_entry_id=<%#Eval("unique_no") %>&partyid=<%#Eval("user_id") %>" target="_blank"><i class='bx bx-printer'></i><span>Print slip</span></a>
                                                                        </li>
