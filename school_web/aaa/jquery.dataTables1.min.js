...
(function (Ea, Q, k) {
    var P = function (h) {
        ...
        function nb(a) {
            for (
                var b = a.oClasses, c = a.sTableId, e = a.aLengthMenu, d = h.isArray(e[0]), f = d ? e[0] : e, e = d ? e[1] : e, d = h("<select/>", { name: c + "_length", "aria-controls": c, class: b.sLengthSelect }), g = 0, j = f.length;
                g < j;
                g++
            )
        ...
        function Ua(a, b, c, e) {
            ...
            c && a.oFeatures.bSortMulti
                ? ((c = h.inArray(b, D(d, "0"))),
                    -1 !== c ? ((b = g(d[c], !0)), null === b && 1 === d.length && (b = 0), null === b ? d.splice(c, 1) : ((d[c][1] = f[b]), (d[c]._idx = b))) : (d.push([b, f[0], 0]), (d[d.length - 1]._idx = 0)))
                : d.length && d[0][0] == b
        ...
        m.defaults = {
            ...
            aaSortingFixed: [],
            ajax: null,
            aLengthMenu: [99999999, 10, 25, 50, 100],
            aoColumns: null,
            aoColumnDefs: null,
            aoSearchCols: [],
