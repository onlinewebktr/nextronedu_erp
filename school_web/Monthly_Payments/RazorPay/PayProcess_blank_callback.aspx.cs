                ...
                else
                {
                    ...
                    if (ViewState["statuS"].ToString() == "Paid")
                    {
                        ...
                        if (status == true)
                        {
                            ...
                            Response.Redirect("Payment_Success_Message.aspx?orderid=" + dt.Rows[0]["ordertrackingid"].ToString() + "&Regid=" + dt.Rows[0]["Admission_no"].ToString(), false);
                        }
                        else
                        {
                            Response.Redirect("Payment_Error_Message.aspx?orderid=" + dt.Rows[0]["ordertrackingid"].ToString() + "&Regid=" + dt.Rows[0]["Admission_no"].ToString(), false);
                        }
                    }
