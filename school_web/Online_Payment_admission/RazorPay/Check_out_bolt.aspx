<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Check_out_bolt.aspx.cs" Inherits="school_web.Online_Payment_admission.RazorPay.Check_out_bolt" %>
        ...
        <div>
            ...
            <script>
               ...
               /* }*/
                ...
                function launchBOLT() {
                    rzp1.open();
                    rzp1.on('open', function () {
                        // Use a timeout to ensure the QR code option is hidden after the modal is rendered
                        setTimeout(function () {
                            // Assuming the QR code option has a specific class or ID
                            $('[data-testid="upi-qr-container"]').hide(); // Adjust the selector as needed
                        }, 1000); // Adjust the timeout as necessary
                    });
                    //setInterval(function () {
                    //    var dv = $('[data-testid="upi-qr-container"]');
                    //    if (dv) {
                    //        dv.empty();
                    //    }
                    //}, 500);
