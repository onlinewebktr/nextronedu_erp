<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PostPgResponseonline.aspx.cs" Inherits="school_web.Online_Payment_admission.Sabpaisa.PostPgResponseonline" %>
   ...
   <form id="form1" runat="server">
           <div>
            ...
            <div class="loading" align="center" id="a1" runat="server">
                Please wait while we process your payment. Please do not close the app until the payment process is complete
        <br />
                <br />
                <img src="loader.gif" />
