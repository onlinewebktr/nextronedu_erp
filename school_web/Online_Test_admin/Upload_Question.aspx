<%@ Page Title="" Language="C#" MasterPageFile="~/Online_Test_admin/Admin.Master" AutoEventWireup="true" CodeBehind="Upload_Question.aspx.cs" Inherits="school_web.Online_Test_admin.Upload_Question" %>
                                            ...
                                            <div id="tblPrintIQ" runat="server">
                                                <div class="pgslry-head-div head" style="border-bottom: 1px solid #000; margin: 0px; float: left; width: 100%;">
                                                    ...
                                                    <div style="margin: 0px; padding: 0px; height: 110px; width: 80%; float: left;">
                                                        ...
                                                        <div style="margin: 7px 0px 0px 0px; padding: 0px; float: left; height: auto; text-align: center; vertical-align: middle; font-size: 13px; width: 100%;">
                                                            <span style="font-size: 14px; font-weight: bold;">Exam List  <asp:Label ID="lbl_class22" runat="server"></asp:Label></span>
                                                        </div>
                                                    </div>
                                                </div>
                                                                ...
                                                                <ItemTemplate>
                                                                    <tr>
                                                                                ...
                                                                                <ul class="dropdown-menu dropdown-menu-end">
                                                                                      <li>
                                                                                        <asp:Panel ID="Panel22" runat="server">
                                                                                            <a class="dropdown-item" href="Upload_ExcelBulk_Questions.aspx?examid=<%#Eval("Entry_id") %>&Session_id=<%#Eval("Session_id") %>&Class_id=<%#Eval("Class_id") %>&Section=<%#Eval("Section") %>" target="_blank"><i class='bx bx-upload'></i><span>Upload Question MS CSV/Excel</span></a>
                                                                                        </asp:Panel>
                                                                                    </li>
                                                                                    <li>
                                                                                        <asp:Panel ID="Panel11" runat="server">
                                                                                            <a class="dropdown-item" href="Upload_Bulk_Questions.aspx?examid=<%#Eval("Entry_id") %>&Session_id=<%#Eval("Session_id") %>&Class_id=<%#Eval("Class_id") %>&Section=<%#Eval("Section") %>" target="_blank"><i class='bx bx-upload'></i><span>Upload Question MS Word</span></a>
                                                                                        </asp:Panel>
                                                                                    </li>
                                                                                     ...
                                                                                     <li>
                                                                                        <asp:Panel ID="Panel2" runat="server">
                                                                                            <a class="dropdown-item" href="Question_Details.aspx?testid=<%#Eval("top_oneexam_id") %>&type=view" target="_blank"><i class='bx bx-notepad' style="margin-right: 3px;"></i>Question Details</a>
                                                                                        </asp:Panel>
                                                                                    </li>
                                                                                       <li>
                                                                                        <asp:LinkButton ID="lnkDel" class="dropdown-item" runat="server" ToolTip="Delete" OnClientClick="return confirm('Are you sure you want to delete this?');" CausesValidation="false" OnClick="lnkDel_Click"><i class="lni lni-trash"> Delete Question</i></asp:LinkButton>
                                                                                    </li>
                                                                                </ul>
                                                                            </div>
                                                                        ...
                                                                        <td style="text-align: left;">
                                                                            ...
                                                                            <asp:Label ID="lbl_Exam_id" Visible="false" runat="server" Text='<%#Bind("top_oneexam_id")%>'></asp:Label>
