...
{
    public partial class Report_Upload_Question_List : System.Web.UI.Page
    {
        My mycode = new My();
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                My.submitException(ex, "Report_Upload_Question_List");
            }
        }
        string scrpt;
        ...
        private void Bind_data_all()
        {
            try
            {
                ...
                condition += $" and  Exam_id in (select test_id from question_info where Uploding_status='Administrator') ";
        ...
        protected void btn_excels_Click(object sender, EventArgs e)
        {
            try
            {
                string exportname = My.with_excel_name("UploadQuestion_Exam_list");
