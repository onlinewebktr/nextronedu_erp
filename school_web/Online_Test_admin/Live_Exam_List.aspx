<%@ Page Title="" Language="C#" MasterPageFile="~/Online_Test_admin/Admin.Master" AutoEventWireup="true" CodeBehind="Live_Exam_List.aspx.cs" Inherits="school_web.Online_Test_admin.Live_Exam_List" EnableEventValidation="false" ValidateRequest="false" %>
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Live Exam List</li>
                        </ol>
                    </nav>
                </div>
                                                                ...
                                                                <ItemTemplate>
                                                                    <tr>
                                                                        ...
                                                                        <td style="text-align: left;">
                                                                            <asp:Panel ID="Panel11" runat="server" Visible="false" Style="">
                                                                                <a class="dropdown-item" href="Question_Details.aspx?testid=<%#Eval("Exam_id") %>&type=view" target="_blank"><i class='bx bx-notepad'></i><span>Question Details</span></a>
                                                                            </asp:Panel>
