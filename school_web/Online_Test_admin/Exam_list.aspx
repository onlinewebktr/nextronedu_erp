<%@ Page Title="" Language="C#" MasterPageFile="~/Online_Test_admin/Admin.Master" AutoEventWireup="true" CodeBehind="Exam_list.aspx.cs" Inherits="school_web.Online_Test_admin.Exam_list" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="head" runat="server">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap5 hdrmodify">
                                    ...
                                    <i class="fa fa-calendar clndr-icon" aria-hidden="true" style="top: 6px !important;
    left: 157px !important;"></i>
                                </div>
                                                    ...
                                                    <script>
                                                     ...
                                                     <div class="col-sm-3">
                                                           ...
                                                           <asp:Button ID="btn_find_bydate" runat="server" Text="Find" OnClick="btn_find_bydate_Click" class="btn btn-primary find-dv-btn" />
                                                    ...
                                                    <div class="col-sm-1">
                                                        <a class="btn btn-success find-dv-btn" onclick="openModal()" style="margin: 18px 7px 1px 0px !important; float: right; padding: 3px 6px 6px 11px; font-size: 14px;"><i class="bx bx-plus-medical"></i></a>
                                                ...
                                                <div id="tblPrintIQ" runat="server">
                                                    <div class="pgslry-head-div head" style="border-bottom: 1px solid #000; margin: 0px; float: left; width: 100%;">
                                                        ...
                                                        <div style="margin: 0px; padding: 0px; height: 110px; width: 80%; float: left;">
                                                            ...
                                                            <div style="margin: 7px 0px 0px 0px; padding: 0px; float: left; height: auto; text-align: center; vertical-align: middle; font-size: 13px; width: 100%;">
                                                                <span style="font-size: 14px; font-weight: bold;">Exam List
                                                                ...
                                                                <asp:Repeater ID="rd_view" runat="server" OnItemDataBound="rd_view_ItemDataBound">
                                                                    <itemtemplate>
                                                                        <tr>
                                                                                    ...
                                                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                                                        ...
                                                                                        <li>
                                                                                            <asp:Panel ID="Panel11" runat="server">
                                                                                                <a class="dropdown-item" href="Question_Details.aspx?testid=<%#Eval("top_oneexam_id") %>&type=view" target="_blank"><i class='bx bx-notepad'></i><span>Question Details</span></a>
                                                                                            </asp:Panel>
                                                                                        </li>


                                                                                        <li>
                                                                                            <asp:LinkButton ID="lnkEdit" class="dropdown-item" runat="server" CausesValidation="false" OnClick="lnkEdit_Click" ToolTip="Edit"><i class="lni lni-pencil-alt"></i><span>Edit Row</span></asp:LinkButton>
                                                                                        </li>
                                                                                        <li>
                                                                                            <asp:LinkButton ID="lnkDel" class="dropdown-item" runat="server" ToolTip="Delete" OnClientClick="return confirm('Are you sure you want to delete this?');" CausesValidation="false" OnClick="lnkDel_Click"><i class="lni lni-trash"></i><span>Delete Row</span></asp:LinkButton>
                                                                                        </li>

                                                                                        <li>
                                                                                            <asp:LinkButton ID="lnk_deletequestion" class="dropdown-item" runat="server" ToolTip="Delete" OnClientClick="return confirm('Are you sure you want to delete question?');" CausesValidation="false" OnClick="lnk_deletequestion_Click"><i class="lni lni-trash"></i><span>Delete Question</span></asp:LinkButton>
                                                                                        </li>
                                                                                        <li>
                                                                                            ...
                                                                                            <asp:LinkButton ID="lnk_active_inactive" runat="server" ToolTip="Active/Inactive" CausesValidation="false" OnClick="lnk_active_inactive_Click" class="dropdown-item">
                                                                                                <span>Active</span></asp:LinkButton>
                                                                                        </li>
                                                                                    </ul>
                                                                                </div>
                                                                            ...
                                                                            <td style="text-align: left;">
                                                                                <asp:Label ID="lbl_subject" Visible="false" runat="server" Text='<%#Bind("subject_name")%>'></asp:Label>
                                                                            ...
                                                                            <td style="text-align: left;">
                                                                                ...
                                                                                <asp:Label ID="lbl_id" Visible="false" runat="server" Text='<%#Bind("Id")%>'></asp:Label>
                                                                                 ...
                                                                                 <asp:Label ID="lbl_top_oneexam_id" Visible="false" runat="server" Text='<%#Bind("top_oneexam_id")%>'></asp:Label>
                                                                            </td>
                                                                            <td style="text-align: left;">

                                                                                <asp:Label ID="lblquestion_uploadstatus" runat="server"></asp:Label>
                                                                            </td>
                                                                             <td style="text-align: left;">
                                                                                <asp:Label ID="lbl_paper_type" runat="server" Text='<%#Bind("Paper_type")%>'></asp:Label>
                                                                            </td>
    ...
    <script>
        $(function () {
            $("#<%=txt_livedate.ClientID %>").datepicker({
                dateFormat: "dd/mm/yy",
                changeMonth: true,
                changeYear: true,
                readOnly: true,
    ...
    <div id="myModal" class="modal fade" role="dialog" style="top: 64px;">
        <div class="modal-dialog">
            <div class="modal-content" style="top: 30px;">
                <div class="modal-header" style="padding: 5px 16px; margin-top: 5px;">
                    ...
                    <div class="p-4 border rounded">
                        <div class="row g-3 needs-validation" novalidate="">
                            <div class="col-md-12">
                                ...
                                <asp:DropDownList ID="ddl_class_add" runat="server" class="form-select" AutoPostBack="true" OnSelectedIndexChanged="ddl_class_add_SelectedIndexChanged">
                                </asp:DropDownList>
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <asp:DropDownList ID="ddl_subjectname" runat="server" class="form-select">
                            ...
                            <div class="col-md-4">
                                <label for="validationCustom01" class="form-label">Paper Description(Test Name)  </label>
                                <asp:TextBox ID="txt_Testname" runat="server" class="form-control"></asp:TextBox>
                            </div>
                            <div class="col-md-4">
                                <label for="validationCustom01" class="form-label">Per Question Marks  </label>
                                <asp:TextBox ID="txt_marks" runat="server" class="form-control" onkeypress="return isNumberKey(event)"></asp:TextBox>
                            </div>

                            <div class="col-md-4">
                                <label for="validationCustom01" class="form-label">Live Date </label>
                                <div class="clndr-dv-wpr">
                                    <asp:TextBox ID="txt_livedate" style="border: 1px solid #000;" runat="server" CssClass="form_control"></asp:TextBox>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="clndr-dv-wpr">
                                    <!--<asp:TextBox ID="txt_time_from" CssClass="form-control timepicker" step="60" MinutesInterval="1" runat="server"></asp:TextBox>-->
                                     <asp:DropDownList ID="ddl_timespan" runat="server" class="form-select">
                            ...
                            <div class="col-md-4">
                                <label for="validationCustom01" class="form-label">Paper Time (Minutes)  </label>

                               <asp:TextBox ID="txt_time_duration" runat="server" class="form-control" onkeypress="return isNumberKey(event)"></asp:TextBox>  
                            </div>

                            <div class="col-md-4" style="display:none">
                                <label for="validationCustom01" class="form-label">Is Active</label>
