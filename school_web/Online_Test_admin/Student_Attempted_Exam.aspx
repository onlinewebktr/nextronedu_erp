<%@ Page Title="" Language="C#" MasterPageFile="~/Online_Test_admin/Admin.Master" AutoEventWireup="true" CodeBehind="Student_Attempted_Exam.aspx.cs" Inherits="school_web.Online_Test_admin.Student_Attempted_Exam" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">
    Attempted Exam Student List
</asp:Content>
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"> Attempted Exam Student List</li>
                        </ol>
                    </nav>
                </div>
                                        ...
                                        <div class="find-dv">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-2">
                                                    ...
                                                    <asp:DropDownList ID="ddl_subject" runat="server" class="form-select find-dv-txtbx" AutoPostBack="true" OnSelectedIndexChanged="ddl_subject_SelectedIndexChanged">
                                                    </asp:DropDownList>
                                                </div>
                                                                        ...
                                                                        <div class="user-box dropdown" style="float: left; display: inherit; height: auto; border-left: 0px solid #f0f0f0; margin-left: 0px;">
                                                                            ...
                                                                            <ul class="dropdown-menu dropdown-menu-end">
                                                                                ...
                                                                                <li>
                                                                                    ...
                                                                                    <a class="dropdown-item" href="Result_viewdetails.aspx?studentid=<%#Eval("admissionserialnumber") %>&testid=<%#Eval("Exam_id") %>&Attemptid=<%#Eval("Attempt_id")%>" target="_blank"><i class='bx bx-notepad'></i><span>Result View</span></a>
                                                                                ...
                                                                                <asp:Panel ID="Panel2" runat="server">
                                                                                    ...
                                                                                    <a class="dropdown-item" href="OnlineQuestion_Explanation.aspx?testid=<%#Eval("Exam_id") %>" target="_blank"><i class='bx bx-notepad'></i><span> Question Explanation View</span></a>
                                                                                    </asp:Panel> 
                                                                                </li>
