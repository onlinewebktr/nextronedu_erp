<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Notice_Board_Details.aspx.cs" Inherits="school_web._adminETutorProf.webview.Notice_Board_Details" %>
                    ...
                    <ItemTemplate>
                        <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12" style="margin-top: 4px; padding-right: 10px; padding-left: 10px; border-bottom: 0px dashed #beb7b7;">
                            <table class="table" style="width: 100%;">
                                ...
                                <tr>
                                    <div id="imgdis" runat="server" visible="false">
                                        <td style="padding: 2px 0px 2px 0px;text-align: center;">
                                            <asp:Image ID="Image1" runat="server" ImageUrl='<%# Bind("Attachment") %>'
                                                Style="margin: 0px 5px 5px 0px; border: 2px solid #FF9933;"   />
