<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Notice_Board.aspx.cs" Inherits="school_web._adminETutorProf.webview.Notice_Board" %>
                        ...
                        <div class="col-md-3 col-lg-3 col-sm-12 col-xs-12" style="margin-top: 4px; padding-right: 10px; padding-left: 10px; border-bottom: 0px dashed #beb7b7;">
                            <div style="width: 100%; float: left; height: auto; background-color: #ffffff; border-radius: 5px; box-shadow: rgba(0, 0, 0, 0.16) 0px 1px 4px; margin: 5px 0px 5px 0px;">
                                ...
                                <div style="width: 25%; height: 30px; padding: 0px; float: left;">
                                    ...
                                    <br />
                                    <%--<asp:Label ID="Label4" runat="server" Text='<%#Bind("year") %>' Style="position: absolute; top: 29px; left: 44px; font-size: 14px; color: #7b7676;"></asp:Label>--%>
                                </div>

                                <div style="position: relative; width: 75%; height: auto; padding: 5px 5px 5px 10px; float: left; border-left: 1px solid #c9c9c9;">
                                    ...
                                    <asp:Label ID="lbl_sunjects" runat="server" Text='<%#Bind("Subject") %>' Style="font-size: 15px; font-size: 15px; width: 100%; float: left; color: #000; padding: 0px 20px 1px 0px; border-bottom: 1px solid #ddd;"></asp:Label>

                                    <asp:Label ID="lbl_notice1" runat="server" Text='<%#Bind("Notice") %>' Style="line-height: 25px; font-size: 14px; margin: 0px 0px 5px 0px; float: left; width: 100%; min-height: 50px;"
                                    ...
                                    <br />
                                    <a href="Notice_Board_Details.aspx?Id=<%#Eval("Id") %>" style="display: block; padding: 0px 0px 0px 0px; font-size: 14px; color: rgb(232 30 30); text-decoration: none; float: left; font-weight: bold;">Read More...</a>
                                    <br />

                                    <asp:Label ID="lbl_Attachments" runat="server" Text='<%#Bind("Attachment") %>' Visible="false"></asp:Label>
                                    <asp:Panel ID="Panel1" runat="server" Style="display: none">
                                        <a href='<%#Eval("Attachment") %>' target="_blank" download style="display: block; padding: 0px 0px 0px 0px; font-size: 22px; color: #0066CC; text-decoration: none; float: left;"><i class="fa fa-download" aria-hidden="true"></i></a>
                                    </asp:Panel>
