<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="yearly-report.aspx.cs" Inherits="school_web._adminETutorProf.principle_profile.yearly_report" %>
...
<head runat="server">
    ...
    <title>Tabs: Academic & Collection</title>
            ...
            $(document).ready(function () {
                ...
                $(function () {
                    ...
                    $.ajax({
                        ...
                        url: "WebService1.asmx/find_academics_session",
                        data: '{"Session":"' + session_id + '","Session_name":"' + session_name + '"}',
                        dataType: "json",
                ...
                $(function () {
                    ...
                    $.ajax({
                        type: "POST",
                        contentType: "application/json; charset=utf-8",
                        url: "WebService1.asmx/find_modewise_amount_session",
                        data: '{"Session":"' + session_id + '","Session_name":"' + session_name + '"}',
                        dataType: "json",
                        success: function (response) {
                            var chartData = JSON.parse(response.d);
