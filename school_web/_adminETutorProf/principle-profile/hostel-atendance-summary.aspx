<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="hostel-atendance-summary.aspx.cs" Inherits="school_web._adminETutorProf.principle_profile.hostel_atendance_summary" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Hostel Attendance Summary</title>
                        ...
                        <div id="foundStd hidden">
                            <div class="activity-card {{x.Status}} {{x.Status_bdr}}" data-ng-repeat="x in reportAtt">
                                <div class="date-info">
                                    ...
                                    <p class="mdl-p">H. Roll No. : {{x.Hostel_Roll_number}}</p>
                                </div>
        ...
        <script type="text/javascript">
            ...
            app.controller('myctrlAttndnce', function ($scope, $http, $exceptionHandler) {
                ...
                $scope.ButtonClickTtlPersent = function () {
                    var statusS = "Present";
                    var Sec = "OverALL";
                    $http.get("WebService1.asmx/fetch_attendance_status_of_std_hostel", { params: { "Session_id": sessions_id, "Idate": idate, "StatusS": statusS } }).then(function (response) {
