<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="hostel-attendance-report.aspx.cs" Inherits="school_web._adminETutorProf.principle_profile.hostel_attendance_report" %>
        ...
        <div class="filter-section">
            <div class="filter-form">
                <div class="filter-item">
                    ...
                    <asp:DropDownList ID="ddl_session" runat="server"></asp:DropDownList>
                </div>
                <div class="filter-item">
                    <label for="class">House</label>
                    <asp:DropDownList ID="ddl_house" runat="server"></asp:DropDownList>
                </div>
                <div class="filter-item">
