<%@ Page Title="" Language="C#" MasterPageFile="~/LMS_VC_Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Teacher_Wise_Class_Report.aspx.cs" Inherits="school_web.LMS_VC_Admin.Teacher_Wise_Class_Report" %>
        ...
        <div class="app-page-title">
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    ...
                    <div>
                        <asp:Literal ID="ltUsertop" runat="server">Teacher Wise Class Report</asp:Literal>
                                ...
                                <div class="row" style="padding: 10px 0px 10px 0px; border: 1px solid #ccc; margin: 0px auto; background: #dbdbdb;">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label style="float: left;">Select Teacher</label>
                                            <div class="input-group input-group-icon" style="float: left; display: flex; width: 45%; margin: 0px 0px 0px 17px;">
                                                <asp:DropDownList ID="ddl_teacher" runat="server" CssClass="form-control">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                    </div>
