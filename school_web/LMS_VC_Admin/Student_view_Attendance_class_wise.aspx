<%@ Page Title="" Language="C#" MasterPageFile="~/LMS_VC_Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Student_view_Attendance_class_wise.aspx.cs" Inherits="school_web.LMS_VC_Admin.Student_view_Attendance_class_wise" EnableEventValidation="false" ValidateRequest="false" %>
<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">lass Wise View Attendance
</asp:Content>
