...
namespace school_web.LMS_VC_Admin
{
    public partial class View_student_list : System.Web.UI.Page
    {
        ...
        private void BindCourse()
        {
            ...
            ddl_CourseCat1.SelectedValue = My.get_top_one_class();
        ...
        protected void img_expor_excel_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                else if (ViewState["flag"].ToString() == "2")
                {
                    ...
                    dt = code.FillTable("select * from dbo.[admission_registor] where Class_id='" + ddl_CourseCat.SelectedValue + "' and Status='1' order by rollnumber Desc");
                    export_to_excel(dt, "Student_list");
                }

                else if (ViewState["flag"].ToString() == "3")
                {
                    dt = code.FillTable("select * from dbo.[admission_registor] where admissionserialnumber='" + txt_student_regid.Text + "' and Status='1' order by rollnumber Desc");
                    export_to_excel(dt, "Student_list");
                }
