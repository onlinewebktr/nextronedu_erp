<%@ Page Title="" Language="C#" MasterPageFile="~/LMS_VC_Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Pending_for_dues_sync_list.aspx.cs" Inherits="school_web.LMS_VC_Admin.Pending_for_dues_sync_list" %>

<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
  Pending Dues Sync List
</asp:Content>
        ...
        <div class="app-page-title">
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    ...
                    <div>
                        <asp:Literal ID="ltUsertop" runat="server">Pending Dues Sync List</asp:Literal>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="main-card mb-3 card">
                    <div class="card-body">
                         <h5 class="card-title">
                                  No. of Pending Dues Sync:-<asp:Label ID="lbl_total" runat="server" Style="color: #f81b1b;"></asp:Label>
                                ...
                                <asp:Repeater ID="RPDetails" runat="server"  >
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label ID="lbl_mobile" runat="server" style="word-break:break-all" Font-Names="Arial" Text='<%#Bind("mobilenumber") %>'></asp:Label>
