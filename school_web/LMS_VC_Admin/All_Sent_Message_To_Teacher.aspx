<%@ Page Title="" Language="C#" MasterPageFile="~/LMS_VC_Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="All_Sent_Message_To_Teacher.aspx.cs" Inherits="school_web.LMS_VC_Admin.Send_All_Sent_Message_To_Teacher" %>

<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
    View All Sent Message To Teacher
</asp:Content>
        ...
        <div class="app-page-title">
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    ...
                    <div>
                        <asp:Literal ID="ltUsertop" runat="server">   View All Sent Message To Teacher</asp:Literal>

                    </div>
                </div>
                <div class="page-title-actions">
                    <a href="Send_Teacher_Message.aspx">
                                ...
                                <asp:Repeater ID="RPDetails" runat="server" OnItemDataBound="RPDetails_ItemDataBound">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <a id="a1" runat="server" href='<%#Eval("Attachments") %>' download style="display: block; padding: 5px 0px 7px 9px; font-family: ebrima; font-size: 21px; color: #0066CC; text-decoration: none;"><i class="fa fa-download" aria-hidden="true"></i></a>
                                                ...
                                                <div class="btn-actions-pane-right text-capitalize actions-icon-btn">
                                                    <div class="btn-group dropdown">
                                                        ...
                                                        <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu-right rm-pointers dropdown-menu-shadow dropdown-menu-hover-link dropdown-menu">
                                                            ...
                                                            <asp:Label ID="lbl_Attachment" runat="server" Text='<%#Bind("Attachments") %>' Visible="false"></asp:Label>
