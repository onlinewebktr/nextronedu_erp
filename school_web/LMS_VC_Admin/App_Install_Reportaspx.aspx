<%@ Page Title="" Language="C#" MasterPageFile="~/LMS_VC_Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="App_Install_Reportaspx.aspx.cs" Inherits="school_web.LMS_VC_Admin.App_Install_Reportaspx" %>
        ...
        <div class="app-page-title">
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    ...
                    <div>
                        <asp:Literal ID="ltUsertop" runat="server">Download App Status</asp:Literal>
        ...
        <div class="main-card mb-3 card">
            <div class="card-body">
                <div class="form-row">
                    ...
                    <div class="col-md-4">
                        <div class="position-relative form-group">
                            <label>Select App Download Status.</label>
                            <div class="input-group input-group-icon">
                                <asp:DropDownList ID="ddl_downloadstatus" runat="server" CssClass="form-control">
            ...
            <div class="col-lg-12">
                <div class="main-card mb-3 card">
                    <div class="card-body">
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <asp:Label ID="lbl_iStatus" runat="server" Font-Names="Arial" Text='<%#Bind("gcm_id") %>' Visible="false"></asp:Label>
                                                  <asp:Label ID="lbl_session" runat="server" Font-Names="Arial" Visible="false" Text='<%#Bind("session") %>'></asp:Label>
                                            </td>
                        ...
                        <div class="card-footer" style="padding: 10px 0px 12px 0px;">
                            <div style="margin: 9px 0px 0px 0px; float: right; width: 100%;">


                                <asp:Button ID="btn_send_message" runat="server" class="btn btn-primary" Text="Send Message" OnClick="btn_send_message_Click" OnClientClick='return confirm("Are you sure want to send sms ?")' />
                            </div>
                        </div>
                    </div>
                </div>
