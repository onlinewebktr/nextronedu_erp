<%@ Page Title="" Language="C#" MasterPageFile="~/LMS_VC_Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Upload_Study_Material.aspx.cs" Inherits="school_web.LMS_VC_Admin.Upload_Studey_Material" EnableEventValidation="false" ValidateRequest="false" %>
                        ...
                        <div class="form-row">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-xs-10 col-sm-6 col-md-3 col-lg-3">
                                    ...
                                    <asp:DropDownList ID="ddl_subject" class="form-control" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddl_subject_SelectedIndexChanged"></asp:DropDownList>
                                </div>

                                <div class="form-group col-xs-10 col-sm-6 col-md-3 col-lg-3">
                                    <label>Teacher Name<sup>*</sup></label>
                                    <asp:DropDownList ID="ddl_teacher" class="form-control" runat="server" Style="width: 98%"></asp:DropDownList>
                                </div>
                                ...
                                <div class="form-group col-xs-10 col-sm-6 col-md-3 col-lg-3" style="display: none;">
                                    <label>Is for Quiz</label>
                                    <asp:DropDownList ID="ddl_Quiz" runat="server" CssClass="form-control">
                                ...
                                <div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    ...
                                    <table class="tab-content table table-bordered" style="margin: 0px; padding: 0px; float: left; width: 50%;">
                                        <tr>
                                            <td colspan="3" style="padding: 5px 5px 5px 5px!important; font-size: 14px;">Upload Multiple Graphic (jpg,png only -file size 5 MB)</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td colspan="3" style="padding: 5px 5px 5px 5px!important; font-size: 14px;">Upload Multiple Attachment(pdf only -file size 5 MB)</td>
                                        </tr>
                                        <tr>
                                            <td style="padding: 5px 5px 5px 5px!important; font-size: 14px;">Choose file<sup></sup></td>
                                            <td style="padding: 5px 5px 5px 5px!important">
