<%@ Page Title="" Language="C#" MasterPageFile="~/LMS_VC_Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Events.aspx.cs" Inherits="school_web.LMS_VC_Admin.Notice_board" ValidateRequest="false" %>
        ...
        <div class="app-page-title">
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    ...
                    <div>
                        <asp:Literal ID="ltUsertop" runat="server"> Events</asp:Literal>
                        ...
                        <div class="form-row">
                            <div class="col-md-12">
                                ...
                                <div class="card-footer pull-right">
                                    <asp:Button ID="btn_submit" runat="server" ValidationGroup="A"  Text="Submit" CssClass="btn btn-primary" OnClick="btn_submit_Click" />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        ...
                        <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered">
                         ...
                         <a href="View_Events.aspx" >
                            <button type="button" class="btn-shadow btn btn-info" style="margin:10px 0px 0px 0px">
