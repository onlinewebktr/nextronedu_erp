<%@ Page Title="" Language="C#" MasterPageFile="~/LMS_VC_Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Student_view_Attendance_Chart.aspx.cs" Inherits="school_web.LMS_VC_Admin.Student_view_Attendance_Chart" EnableEventValidation="false" ValidateRequest="false" %>
                                    ...
                                    <table class="tab-content table table-bordered">
                                        ...
                                        <tr>
                                            <td style="padding: 10px 10px 10px 10px">
                                                <asp:DropDownList ID="ddl_session" Style="width: 100px!important;" runat="server" CssClass="form-control" >
                                            ...
                                            <td style="padding: 10px 10px 10px 10px">
                                                <asp:Button ID="btn_find" runat="server" Text="Find" class="mt-2 btn btn-primary" OnClick="btn_find_Click" ValidationGroup="a" Style="float: left" />
                                        ...
                                        <asp:GridView ID="GrdView"  runat="server" class="table table-hover table-striped table-bordered" AutoGenerateColumns="False" Width="100%">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="01">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lbl_date1" runat="server"  Text='<%#Bind("_01")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>

                                                <asp:TemplateField HeaderText="02">
                                                    <ItemTemplate>
                                                          <asp:Label ID="lbl_date1" runat="server"  Text='<%#Bind("_02")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>

                                                <asp:TemplateField HeaderText="03">
                                                    <ItemTemplate>
                                                         <asp:Label ID="lbl_date1" runat="server"  Text='<%#Bind("_03")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>

                                                <asp:TemplateField HeaderText="04">
                                                    <ItemTemplate>
                                                         <asp:Label ID="lbl_date1" runat="server"  Text='<%#Bind("_04")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>

                                                <asp:TemplateField HeaderText="05">
                                                    <ItemTemplate>
                                                         <asp:Label ID="lbl_date1" runat="server"  Text='<%#Bind("_05")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="06">
                                                    <ItemTemplate>
                                                         <asp:Label ID="lbl_date1" runat="server"  Text='<%#Bind("_06")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="07">
                                                    <ItemTemplate>
                                                          <asp:Label ID="lbl_date1" runat="server"  Text='<%#Bind("_07")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="08">
                                                    <ItemTemplate>
                                                          <asp:Label ID="lbl_date1" runat="server"  Text='<%#Bind("_08")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="09">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lbl_date1" runat="server"  Text='<%#Bind("_09")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="10">
                                                    <ItemTemplate>
                                                          <asp:Label ID="lbl_date1" runat="server"  Text='<%#Bind("_10")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="11">
                                                    <ItemTemplate>
                                                      <asp:Label ID="lbl_date1" runat="server"  Text='<%#Bind("_11")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="12">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lbl_date12" runat="server" Text='<%#Bind("_12")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="13">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lbl_date13" runat="server" Text='<%#Bind("_13")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="14">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lbl_date14" runat="server" Text='<%#Bind("_14")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="15">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lbl_date15" runat="server" Text='<%#Bind("_15")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="16">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lbl_date16" runat="server" Text='<%#Bind("_16")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="17">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lbl_date17" runat="server" Text='<%#Bind("_17")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>

                                                <asp:TemplateField HeaderText="18">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lbl_date18" runat="server" Text='<%#Bind("_18")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="19">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lbl_date19" runat="server" Text='<%#Bind("_19")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>

                                                <asp:TemplateField HeaderText="20">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lbl_date20" runat="server" Text='<%#Bind("_20")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="21">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lbl_date21" runat="server" Text='<%#Bind("_21")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="22">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lbl_date22" runat="server" Text='<%#Bind("_22")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="23">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lbl_date23" runat="server" Text='<%#Bind("_13")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="24">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lbl_date24" runat="server" Text='<%#Bind("_24")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="25">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lbl_date25" runat="server" Text='<%#Bind("_25")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="26">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lbl_date26" runat="server" Text='<%#Bind("_26")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="27">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lbl_date27" runat="server" Text='<%#Bind("_27")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderText="28">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lbl_date28" runat="server" Text='<%#Bind("_28")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="29">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lbl_date29" runat="server" Text='<%#Bind("_29")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="30">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lbl_date30" runat="server" Text='<%#Bind("_30")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="31">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lbl_date31" runat="server" Text='<%#Bind("_31")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                        </asp:GridView>
