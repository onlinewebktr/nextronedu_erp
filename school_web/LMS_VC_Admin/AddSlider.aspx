<%@ Page Title="" Language="C#" MasterPageFile="~/LMS_VC_Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="AddSlider.aspx.cs" Inherits="school_web.LMS_VC_Admin.AddSlider" %>
        ...
        <div class="app-page-title">
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    ...
                    <div>
                        <asp:Literal ID="ltUsertop" runat="server">Add Slider</asp:Literal>
                        ...
                        <div class="form-row">
                            <div class="col-md-12">
                                <div class="position-relative form-group">
                                    ...
                                    You have&nbsp;<asp:Label ID="lblCountLimit" runat="server" ForeColor="Maroon" Text="50"></asp:Label>
                                    characters left 
                                </div>
            ...
            <div class="col-lg-9">
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        ...
                        <h5 class="card-title">Added Slider </h5>
                        ...
                        <asp:GridView ID="GrdView" runat="server" class="mb-0 table table-bordered" AutoGenerateColumns="False" Width="100%">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Description">
                                    <ItemTemplate>
                                        <asp:Label ID="lbl_Description" runat="server" Text='<%#Bind("caption")%>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Slider Image">
                                    <ItemTemplate>
                                        <asp:Label ID="lbl_Image" runat="server" Text='<%#Bind("Image_path")%>' Visible="false"></asp:Label>
                                        <asp:Label ID="lbl_Id" runat="server" Text='<%#Bind("Id")%>' Visible="false"></asp:Label>
                                        <a target="_blank" href='<%#Eval("Image_path") %>'>
                                            <asp:Image ID="myImg" runat="server" ImageUrl='<%# Bind("Image_path") %>' Style="height: 60px; width: 60px; margin: 0px; border: 2px solid #f93; padding: 2px" />
                                        </a>
                                    </ItemTemplate>
                                </asp:TemplateField>
