<%@ Page Title="" Language="C#" MasterPageFile="~/LMS_VC_Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Student_Attendence_Reprot.aspx.cs" Inherits="school_web.LMS_VC_Admin.Student_Attendence_Reprot" %>

<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
    Student Attendence Reprot
</asp:Content>
                            ...
                            <div class="form-row" style="font-size: 16px;">
                                <div class="row" style="padding: 10px 0px 10px 0px; border: 1px solid #ccc; margin: 0px auto; background: #dbdbdb;">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <div class="form-group">
                                            <label style="float: left;"></label>
                                            <asp:Button ID="btn_find_admission_no" runat="server" Text="Find" CssClass="btn btn-primary" OnClick="btn_find_admission_no_Click" Style="margin: 32px 0px 0px 0px;" />
