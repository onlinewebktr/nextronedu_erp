<%@ Page Title="" Language="C#" MasterPageFile="~/LMS_VC_Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Class_Routine_List.aspx.cs" Inherits="school_web.LMS_VC_Admin.Class_Routine_List" EnableEventValidation="false" %>
                                    ...
                                    <div runat="server" visible="false" id="grid111">
                                        <asp:GridView ID="grd_class" runat="server" AutoGenerateColumns="False" Width="100%" Style="margin: 2px 0px 2px 0px"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Class Period">
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="Starting Time- End Time">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lbl_Start_Time1" runat="server" Text='<%#Bind("Start_Time1") %>'></asp:Label>--
                                                         <asp:Label ID="lbl_End_time1" runat="server" Text='<%#Bind("End_time1") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                        </asp:GridView>
