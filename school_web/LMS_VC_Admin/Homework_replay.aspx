<%@ Page Title="" Language="C#" MasterPageFile="~/LMS_VC_Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Homework_replay.aspx.cs" Inherits="school_web.LMS_VC_Admin.Homework_replay" %>

<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">   Homework Reply Status
</asp:Content>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        <table style="width: 100%;" id="Table1" class="table  table-striped table-bordered">
                            <tr>
                                <td style="padding: 5px 0px 5px 0px; width: 60px; font-weight: bold">Topic</td>
                                <td style="padding: 5px 0px 5px 0px">
                                    <asp:Label ID="lbl_tpoicname" runat="server"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <thead>
                                <tr>
                                    <th colspan="11">
                                        ...
                                        <p style="width: auto; float: left; background-color: #29a700; padding: 4px 9px 0px 0px; margin: 0px 0px 0px 9px; line-height: 10px; color: #fff; border-radius: 2px; font-weight: 500;">
