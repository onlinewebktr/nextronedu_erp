<%@ Page Title="" Language="C#" MasterPageFile="~/LMS_VC_Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="update-about-us.aspx.cs" Inherits="school_web.LMS_VC_Admin.update_about_us" EnableEventValidation="false" ValidateRequest="false" %>
                ...
                <div class="row">
                    <div class="col-lg-12 colmd-12 col-sm-12 col-xs-12">
                        <div class="main-card mb-3 card">
                            <div class="card-body">
                                <h5 class="card-title"> School History</h5>
                                <div class="txtbx-sec">
