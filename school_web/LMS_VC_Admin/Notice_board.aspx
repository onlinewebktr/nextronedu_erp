<%@ Page Title="" Language="C#" MasterPageFile="~/LMS_VC_Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Notice_board.aspx.cs" Inherits="school_web.LMS_VC_Admin.Notice_board1" %>
    ...
    <div class="app-main__inner">
        ...
        <div class="row">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-row">
                            ...
                            <div class="card-footer pull-right">
                                <asp:Button ID="btn_submit" runat="server" Text="Send" CssClass="btn btn-primary" OnClick="btn_submit_Click" ValidationGroup="A" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-8"  style="display:none">
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        <h5 class="card-title">Top 10  Notice Board</h5>
