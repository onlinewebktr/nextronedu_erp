<%@ Page Title="" Language="C#" MasterPageFile="~/LMS_VC_Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="AddInstructor.aspx.cs" Inherits="school_web.LMS_VC_Admin.AddInstructor" EnableEventValidation="false" %>
                                    ...
                                    <asp:Repeater ID="RPDetails" runat="server" OnItemDataBound="RPDetails_ItemDataBound">
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:Label ID="lbl_zoomuserid" runat="server" Text='<%#Bind("zoomuserid") %>'></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:Label ID="lbl_zoompwd" runat="server" Text='<%#Bind("zoompwd") %>'></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:Label ID="lblStatusD" runat="server" Text='<%#Bind("StatusD") %>'></asp:Label></td>
                                                    ...
                                                    <div class="btn-actions-pane-right text-capitalize actions-icon-btn">
                                                        <div class="btn-group dropdown">
                                                            ...
                                                            <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu-right rm-pointers dropdown-menu-shadow dropdown-menu-hover-link dropdown-menu">
                                                                <asp:LinkButton ID="lnk_edit" Visible="false" runat="server" CssClass="dropdown-item" OnClick="lnk_edit_Click"><span>Edit</span></asp:LinkButton>
                                                                ...
                                                                <asp:LinkButton ID="lnkedit_zoom" Text="Update Zoom ID" CssClass="dropdown-item" Visible="false" runat="server" OnClick="lnkedit_zoom_Click" />
                                                                 <asp:LinkButton ID="lnk_update_zoomuserid" Text="Update Zoom User Id" CssClass="dropdown-item" runat="server" OnClick="lnk_update_zoomuserid_Click" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </td>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content" style="position: relative; float: left;">
                    <div class="modal-header">
                        <h3 class="modal-title" style="font-size: 20px!important;">Update Zoom Id</h3>
