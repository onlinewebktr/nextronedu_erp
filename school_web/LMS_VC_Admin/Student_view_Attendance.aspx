<%@ Page Title="" Language="C#" MasterPageFile="~/LMS_VC_Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Student_view_Attendance.aspx.cs" Inherits="school_web.LMS_VC_Admin.Student_view_Attendance" %>
<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">Subject Wise Attendance View
</asp:Content>
