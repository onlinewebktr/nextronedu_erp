<%@ Page Title="" Language="C#" MasterPageFile="~/LMS_VC_Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Vice_Principal.aspx.cs" Inherits="school_web.LMS_VC_Admin.Voice_Principal" %>
<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">Vice- Principal's Desk
</asp:Content>
                ...
                <div class="row">
                    <div class="col-lg-12 colmd-12 col-sm-12 col-xs-12">
                        <div class="main-card mb-3 card">
                            <div class="card-body">
                                <h5 class="card-title">Vice- Principal's Desk</h5>
                                <div class="txtbx-sec">
