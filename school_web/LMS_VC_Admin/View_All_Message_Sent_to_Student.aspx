<%@ Page Title="" Language="C#" MasterPageFile="~/LMS_VC_Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="View_All_Message_Sent_to_Student.aspx.cs" Inherits="school_web.LMS_VC_Admin.View_All_Message_Sent_to_Student" %>

<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
    View All Sent Message to Student
</asp:Content>
        ...
        <div class="app-page-title">
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    ...
                    <div>
                        <asp:Literal ID="ltUsertop" runat="server">  View All Sent Message to Student</asp:Literal>

                    </div>
                </div>
                <div class="page-title-actions">
                    <a href="Send_Message_Class_Wise.aspx">
                ...
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        <div class="form-row">
                               <div class="col-md-2">
                                <div class="position-relative form-group">
                                    ...
                                    <div class="input-group input-group-icon">
                                        <asp:DropDownList ID="ddl_send_type" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddl_send_type_SelectedIndexChanged">
                            ...
                            <div class="col-md-2" id="class1" runat="server" >
                                <div class="position-relative form-group">
                                    <label>Class</label>
                                    <div class="input-group input-group-icon">
                            ...
                            <div class="col-md-2" id="class2" runat="server">
                                <div class="position-relative form-group">
                                    <label>Section</label>
                                    <div class="input-group input-group-icon">
                                ...
                                <asp:Repeater ID="RPDetails" runat="server" OnItemDataBound="RPDetails_ItemDataBound">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label ID="sendby" runat="server" Text='<%#Bind("Message_By") %>'></asp:Label>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <asp:Label ID="lbl_Section_Id" runat="server" Text='<%#Bind("Section_Id") %>'  ></asp:Label>
                                                <asp:Label ID="lbl_section" runat="server" Visible="false"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="lbl_Heading" runat="server" style="word-break:break-all;" Text='<%#Bind("Subject") %>'></asp:Label>
                                            </td>
                                            <td>
