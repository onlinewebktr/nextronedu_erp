<%@ Page Title="" Language="C#" MasterPageFile="~/LMS_VC_Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="View_teacherwise_homework_list.aspx.cs" Inherits="school_web.LMS_VC_Admin.View_teacherwise_homework_list" ValidateRequest="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
    Uploaded Homework Teacher Wise
</asp:Content>
        ...
        <div class="app-page-title">
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    ...
                    <div>
                        <asp:Literal ID="ltUsertop" runat="server">Uploaded Homework Teacher Wise</asp:Literal>
                                    ...
                                    <asp:GridView ID="GrdViewimg" runat="server" class="mb-0 table table-bordered" CssClass="table table-striped table-bordered gridcss" AutoGenerateColumns="False" Width="100%">
                                        <columns>
                                            ...
                                            <asp:TemplateField HeaderText="Download and view">
                                                <itemtemplate>
                                                    <a href='<%#Eval("Images") %>' download target="_blank" style="display: block; padding: 2px; font-family: ebrima; font-size: 31px; color: #0066CC; text-decoration: none;"><i class="fa fa-download" aria-hidden="true"></i></a>
