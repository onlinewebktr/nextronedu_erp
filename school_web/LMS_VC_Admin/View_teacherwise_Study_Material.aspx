<%@ Page Title="" Language="C#" MasterPageFile="~/LMS_VC_Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="View_teacherwise_Study_Material.aspx.cs" Inherits="school_web.LMS_VC_Admin.View_teacherwise_topic" ValidateRequest="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
    Teacher Wise Study Material
</asp:Content>
        ...
        <div class="app-page-title">
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    ...
                    <div>
                        <asp:Literal ID="ltUsertop" runat="server"> Teacher Wise Study Material</asp:Literal>
                            ...
                            <div class="col-md-4">
                                <div class="position-relative form-group">
                                    ...
                                    <div class="input-group input-group-icon">
                                        <asp:DropDownList ID="ddl_teacher_list" runat="server" CssClass="form-control" AutoPostBack="false" OnSelectedIndexChanged="ddl_teacher_list_SelectedIndexChanged"></asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-2">
                                ...
                                <asp:Repeater ID="RPDetails" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label ID="lbl_SetionNamee" runat="server" Text='<%#Bind("Section_Subject") %>'></asp:Label>
                                            </td>
                                            <td>
                                                ...
                                                <div class="btn-actions-pane-right text-capitalize actions-icon-btn">
                                                    <div class="btn-group dropdown">
                                                        ...
                                                        <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu-right rm-pointers dropdown-menu-shadow dropdown-menu-hover-link dropdown-menu">
                                                            <asp:LinkButton ID="lnk_view" runat="server" CssClass="dropdown-item" OnClick="lnk_view_Click"><i class="dropdown-icon lnr-inbox"></i><span>View</span></asp:LinkButton>
                                                            <asp:LinkButton ID="lnk_edit" Visible="false" runat="server" CssClass="dropdown-item" OnClick="lnk_edit_Click"><i class="dropdown-icon lnr lnr-pencil"></i><span>Edit</span></asp:LinkButton>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div style="float: left; width: 100%; overflow: auto; max-height: 400px">
                        <table class="table table-bordered" style="width: 100%">
                            <tr style="display: none">
                                <td style="font-size: 16px; font-weight: bold;">Lesson Name
                                </td>
                            </tr>
                            <tr style="display: none">
                                <td style="font-size: 14px;">
                                    <asp:Label ID="lbl_lession" runat="server" Style="font-size: 14px!important"></asp:Label>
                                </td>
                                        ...
                                        <asp:GridView ID="GrdViewimg" runat="server" class="mb-0 table table-bordered" CssClass="table table-striped table-bordered gridcss" AutoGenerateColumns="False" Width="100%" OnRowDataBound="GrdViewimg_RowDataBound">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Download">
                                                    <ItemTemplate>
                                                        <a id="a2" runat="server" href='<%#Eval("Images") %>' download target="_blank" style="display: block; padding: 2px; font-family: ebrima; font-size: 31px; color: #0066CC; text-decoration: none;"><i class="fa fa-download" aria-hidden="true"></i></a>
