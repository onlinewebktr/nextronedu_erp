<%@ Page Title="" Language="C#" MasterPageFile="~/LMS_VC_Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Upload_Home_Work.aspx.cs" Inherits="school_web.LMS_VC_Admin.Upload_Home_Work" EnableEventValidation="false" ValidateRequest="false" %>
        ...
        <div class="app-page-title">
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    ...
                    <div>
                        <asp:Literal ID="ltUsertop" runat="server">Upload Homework</asp:Literal>
                        ...
                        <div class="form-row">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-xs-10 col-sm-3 col-md-3 col-lg-3">
                                    ...
                                    <asp:TextBox ID="txt_date" class="form-control" runat="server" Style="width: 98%"></asp:TextBox>
                                    <script>
                                        $(function () {
                                ...
                                <div class="form-group col-xs-10 col-sm-6 col-md-6 col-lg-6">
                                    ...
                                    <asp:TextBox ID="txtTopic" class="form-control" runat="server" Style="width: 100%"></asp:TextBox>
                                </div>
                                <div class="clearfix"></div>
                                <div class="form-group col-xs-10 col-sm-12 col-md-12 col-lg-12">
                                    <label>Homework Details<sup>*</sup></label>
                                    <script src="https://cdn.tiny.cloud/1/iy1ra884vfzlku7fjsu4no0s3ltmenw6t742wzhxxcws4y76/tinymce/7/tinymce.min.js" referrerpolicy="origin"></script>
                                ...
                                <div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    <table class="tab-content table table-bordered" style="margin: 0px; padding: 0px; float: left; width: 50%;">
                                        <tr>
                                            <td colspan="3" style="padding: 5px 5px 5px 5px!important; font-size: 14px;">Upload Multiple Attachment(jpg,png,Pdf only -file size 10 MB)</td>
                                        </tr>
                                        <tr>
