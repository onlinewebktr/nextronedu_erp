...
namespace school_web.LMS_VC_Admin
{
    ...
    public class WebService1 : System.Web.Services.WebService
    {
        ...
        {
            string sql = @"select t1.*,t2.studentname as Full_name,t2.mobilenumber as Mobile_no,t2.gcm_id  from Complain_feedback t1 join admission_registor t2 on t1.User_id=t2.admissionserialnumber where t1.Request_id='" + Request_id + "'";
