<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Scholarship_Apply.aspx.cs" Inherits="school_web.Scholarship.Scholarship_Apply" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Scholarship Apply</title>
    <meta charset="UTF-8" />
                                ...
                                <div class="online_frm-bg">
                                    <div class="online_frm">
                                        <div class="aplication-sec">
                                            <div class="app-head-sec" style="background: rgb(12 12 12 / 0%) !important;
text-align:center">
                                                <a class="acc-dt-sub-btn btnfont" style=" width: 150px;"
                                                    href="Download_Scholarship_Admit_Card.aspx"><i class="fa fa-download"></i>&nbsp;Admit Card</a>
                                                <a class="acc-dt-sub-btn btnfont" href="Download_Scholarship_Result.aspx" style=" width: 150px; margin: 10px 0px 10px 10px"><i class="fa fa-download"></i>&nbsp;Result</a>
                                            </div>
                                            <div class="app-head-sec">
                                                <h2 class="regi-title">Scholarship Apply-
                                            ...
                                            <div class="reg-content-sec">
                                                ...
                                                <div class="scroll_data">
                                                    ...
                                                    <asp:GridView ID="grid_Scholarship" runat="server" class="table table-bordered" AutoGenerateColumns="False" Width="100%" OnRowDataBound="grid_Scholarship_RowDataBound" ShowHeader="False">
                                                        <Columns>
                                                            <asp:TemplateField HeaderText=" ">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lbl_Scholarship_Program" runat="server" Text='<%#Bind("Test_name")%>' Visible="false"></asp:Label>
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <asp:TemplateField HeaderText="Action">
                                                                                <ItemTemplate>
                                                                                    ...
                                                                                    <asp:Button ID="btn_Submit" runat="server" Text="Apply" CssClass="acc-dt-sub-btn btnfont" ValidationGroup="a" OnClick="btn_Submit_Click" Style="margin: 0px 0px 0px;" />
                                                                                    <asp:Label ID="lbl_Isactive" Visible="false" runat="server" Text='<%#Bind("Isactive")%>'></asp:Label>

                                                                                    <asp:Label ID="lbl_start_Idate" Visible="false" runat="server" Text='<%#Bind("start_Idate")%>'></asp:Label>
                                                                                    <asp:Label ID="lbl_end_Idate" Visible="false" runat="server" Text='<%#Bind("end_Idate")%>'></asp:Label>
                                                                                    ...
                                                                                    <asp:Label ID="lbl_no_application" runat="server" Text='<%#Bind("no_application")%>' Visible="false"></asp:Label>
                                                                                    <asp:Label ID="lbl_Test_id" runat="server" Text='<%#Bind("Test_id")%>' Visible="false"></asp:Label>
                                                ...
                                                <table border="1" style="margin: 0px; padding: 0px; float: left; height: auto; width: 100%">
                                                    <tr>
                                                        <td style="background: #90ee902e;">
                                                            ...
                                                            <span class="a1">Scholarship Apply  Application Running</span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="background: #ff00008c">
                                                            ...
                                                            <span class="a1">Scholarship Apply Application Closed</span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="background: #ffa5005e">
                                                            ...
                                                            <span class="a1">Scholarship Apply Application Upcoming</span>
                                                        </td>
                                                    </tr>
                                                </table>
