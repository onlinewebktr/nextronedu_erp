...
{
    public partial class Scholarship_registration : System.Web.UI.Page
    {
        string scrpt;
                ...
                if (!IsPostBack)
                {
                    if (Session["terms"] != null)
                    {
                        ...
                        if (Request.QueryString["regiDs"] != "0")
                        {
                            ...
                            class_id = Request.QueryString["classid"];
        ...
        private void check_payment_mode()
        {
            DataTable dt = mycode.FillData("select * from Scholarship_Parameter_fees where Test_id='" + ViewState["testid"].ToString() + "' and Session_id='" + ddl_session.SelectedValue + "' and Class_id='" + ViewState["class_id"].ToString() + "' ");
            if (dt.Rows.Count == 0)
            {
                rd_payment_mode_online.Visible = false;
                rd_payment_mode_ofline.Visible = true;
            }
            else
            {
                ...
                else
                {
                    ...
                    rd_payment_mode_ofline.Visible = false;
                    rd_payment_mode_online.Visible = true;
                }
        ...
        {
            DataTable dt = mycode.FillData("Select * from Scholarship_Admission where Registration_id='" + regiD + "' and Test_id='" + ViewState["testid"].ToString() + "' ");
            if (dt.Rows.Count == 0)
            {
            }
            else
            {
                ...
                try
                {
                    dl_nationality.Text = dt.Rows[0]["Nationality"].ToString();
                }
                catch
                {
                ...
                {
                    ddl_blod_group.Text = dt.Rows[0]["Blood_group"].ToString();
                }
                catch
                {
        ...
        private void Fee_selection()
        {
            ...
            {
                ViewState["paymentModeOffline"] = "0";
                DataTable dt = mycode.FillTable("Select * from Scholarship_Parameter_fees where Session_id='" + ddl_session.SelectedValue + "' and Class_id='" + ddl_class.SelectedValue + "' and Test_id='" + ViewState["testid"].ToString() + "'");
                if (dt.Rows.Count == 0)
                {
                    double regfee = 0;
                ...
                else
                {
                    ...
                    if (dt.Rows[0]["Payment_mode"].ToString() == "Offline")
                    {
                        paymenyModeDV.Visible = false;
                        ViewState["paymentModeOffline"] = "1";
                    }
                }
            }
        }
        ...
        private void save_data(string type)
        {
            ...
            if (type == "1")
            {
                DataTable dt = mycode.FillData("Select * from Scholarship_Admission where Registration_id='" + hd_applicationid.Value + "' and Test_id='" + ViewState["testid"].ToString() + "'");
                if (dt.Rows.Count == 0)
                {
                    string regi_code = UsesCode.reg_format_Scholarship("Scholarship_reg_id");
                    hd_applicationid.Value = regi_code;
                    string query = "INSERT INTO Scholarship_Admission (Student_mob_no,Student_email_id,Steps_done,Registration_id,Date,idate,Session_id,Class_id,Payable_amount,Test_id,Reg_payment_type,School_branch_address) values (@Student_mob_no,@Student_email_id,@Steps_done,@Registration_id,@Date,@idate,@Session_id,@Class_id,@Payable_amount,@Test_id,@Reg_payment_type,@School_branch_address)";
                    ...
                    cmd.Parameters.AddWithValue("@Test_id", ViewState["testid"].ToString());
                    cmd.Parameters.AddWithValue("@Reg_payment_type", ViewState["paymentModeOffline"].ToString());
                    cmd.Parameters.AddWithValue("@School_branch_address", Session["SchoolBranch"].ToString());
                    if (InsertUpdate.InsertUpdateData(cmd))
                    {
                        ViewState["regiD"] = regi_code;
                        process_active("2");
                        lbl_selected_branch.Text = Session["SchoolBranch"].ToString();
                    }
                    ViewState["Student_image"] = "";
                    ViewState["Father_sig"] = "";
                    ViewState["mother_sig"] = "";
                ...
                else
                {
                    if (dt.Rows[0]["Steps_done"].ToString() == "10")
                    {
                        ...
                        if (dt.Rows[0]["Payment_Status"].ToString() == "Unpaid")
                        {
                            ...
                            {
                                Response.Redirect("Print_Page.aspx?PaymentSliP=" + dt.Rows[0]["Registration_id"].ToString());
                            }
                            else
                            {
                                ViewState["regiD"] = dt.Rows[0]["Registration_id"].ToString();
                                Response.Redirect("Scholarship_preview.aspx?regNo=" + dt.Rows[0]["Registration_id"].ToString(), false);
                            }
                        }
                        ...
                        try
                        {
                            ...
                            if (ViewState["mother_photo"].ToString() == "")
                            {
                                img_mother_photo.Visible = false;
                            }
                            else
                            {
                                img_mother_photo.ImageUrl = ViewState["mother_photo"].ToString();
                                img_mother_photo.Visible = true;

                            }
                            if (ViewState["father_photo"].ToString() == "")
                            {
                                img_father_photo.Visible = false;
                            }
                            else
                            {
                                img_father_photo.ImageUrl = ViewState["father_photo"].ToString();
                                img_father_photo.Visible = true;

                            }

                            if (ViewState["Family_photo"].ToString() == "")
                            {
                                img_Family_photo.Visible = false;
                            }
                            else
                            {
                                img_Family_photo.ImageUrl = ViewState["Family_photo"].ToString();
                                img_Family_photo.Visible = true;
                            }


                            if (ViewState["birth_certificate"].ToString() == "")
                            {
                                img_Birth_Certificate.Visible = false;
                            }
                            ...
                            {
                                img_Birth_Certificate.ImageUrl = ViewState["birth_certificate"].ToString();
                                img_Birth_Certificate.Visible = true;

                            }


                            if (ViewState["residential_certificate"].ToString() == "")
                            {
                                img_Residential_Certificate.Visible = false;
                            }
                            else
                            {
                                img_Residential_Certificate.ImageUrl = ViewState["residential_certificate"].ToString();
                                img_Residential_Certificate.Visible = true;
                            }
            ...
            if (type == "2")
            {
                DataTable dt = mycode.FillData("Select Steps_done,Registration_id from Scholarship_Admission where Registration_id='" + ViewState["regiD"].ToString() + "' and Session_id='" + ddl_session.SelectedValue + "'");
                if (dt.Rows.Count != 0)
                {
                    string query = "Update Scholarship_Admission set Name=@Name,Student_first_name=@Student_first_name,Student_middle_name=@Student_middle_name,Student_last_name=@Student_last_name,DOB=@DOB,Gender=@Gender,Nationality=@Nationality,Blood_group=@Blood_group,Religion=@Religion,Category=@Category,Aadhar_no=@Aadhar_no,Identification_marks=@Identification_marks,Services=@Services,Class_id=@Class_id,Class=@Class,Payable_amount=@Payable_amount,Steps_done=@Steps_done,Session_id=@Session_id,Payment_mode=@Payment_mode,payment_slip=@payment_slip,razorpay_payment_id=@razorpay_payment_id,razorpay_order_id=@razorpay_order_id,Reg_payment_type=@Reg_payment_type,Height=@Height,Weight=@Weight,Sibling_name1=@Sibling_name1,Sibling_age1=@Sibling_age1,Sibling_school1=@Sibling_school1,Sibling_class1=@Sibling_class1,Sibling_name2=@Sibling_name2,Sibling_age2=@Sibling_age2,Sibling_school2=@Sibling_school2,Sibling_class2=@Sibling_class2,School_branch_address=@School_branch_address where Registration_id = @Registration_id";
                    cmd = new SqlCommand(query);
                    cmd.Parameters.AddWithValue("@School_branch_address", Session["SchoolBranch"].ToString());
                    cmd.Parameters.AddWithValue("@Reg_payment_type", ViewState["paymentModeOffline"].ToString());
                    cmd.Parameters.AddWithValue("@Session_id", ddl_session.SelectedValue);
                    ...
                    cmd.Parameters.AddWithValue("@Nationality", dl_nationality.Text);
                    cmd.Parameters.AddWithValue("@Blood_group", ddl_blod_group.Text);
                    ...
                    if (rd_payment_mode_ofline.Checked == true)
                    {
                        cmd.Parameters.AddWithValue("@Payment_mode", "Offline");
                        ...
                        cmd.Parameters.AddWithValue("@payment_slip", ViewState["payment_slip"].ToString());
                    }
                    else
                    {
                        cmd.Parameters.AddWithValue("@razorpay_payment_id", "");
                        cmd.Parameters.AddWithValue("@razorpay_order_id", "");
                        cmd.Parameters.AddWithValue("@payment_slip", "#");
                        cmd.Parameters.AddWithValue("@Payment_mode", "Online");
                    }
            ...
            if (type == "3")
            {
                ...
                if (dt.Rows.Count != 0)
                {
                    string query = "Update Scholarship_Admission set Last_school=@Last_school,Last_school_board=@Last_school_board,Passout_classs=@Passout_classs,Percentage=@Percentage,Reason_for_shift=@Reason_for_shift,Passed_year=@Passed_year,Steps_done=@Steps_done,Session_id=@Session_id where Registration_id = @Registration_id";
                    cmd = new SqlCommand(query);
                    cmd.Parameters.AddWithValue("@Registration_id", ViewState["regiD"].ToString());
                    cmd.Parameters.AddWithValue("@Session_id", ddl_session.SelectedValue);
            ...
            if (type == "7")
            {
                ...
                if (dt.Rows.Count != 0)
                {
                    string query = "Update Scholarship_Admission set Is_student_handicapped=@Is_student_handicapped,Medical_remarks=@Medical_remarks,About_theschool=@About_theschool,Steps_done=@Steps_done,Session_id=@Session_id where Registration_id = @Registration_id";
                    cmd = new SqlCommand(query);
                    cmd.Parameters.AddWithValue("@Registration_id", ViewState["regiD"].ToString());
                    cmd.Parameters.AddWithValue("@Session_id", ddl_session.SelectedValue);
            ...
            if (type == "8")
            {
                DataTable dt = mycode.FillData("Select Steps_done,Student_image,Registration_id from Scholarship_Admission where Registration_id='" + ViewState["regiD"].ToString() + "' and Session_id='" + ddl_session.SelectedValue + "'");
                if (dt.Rows.Count != 0)
                {
        ...
        private void save_final_with_img(string regID, string filepath1, string fathersignature, string mothersignature)
        {
            ...
            SqlCommand cmd;
            string query = "Update Scholarship_Admission set Student_image=@Student_image,Payment_Status=@Payment_Status,Date=@Date,idate=@idate,Steps_done=@Steps_done,father_signature=@father_signature,mother_signature=@mother_signature,Order_id=@Order_id,mother_photo=@mother_photo,father_photo=@father_photo,Family_photo=@Family_photo,birth_certificate=@birth_certificate,residential_certificate=@residential_certificate where Registration_id = @Registration_id";
            cmd = new SqlCommand(query);
            ...
            cmd.Parameters.AddWithValue("@Date", mycode.date());
            cmd.Parameters.AddWithValue("@idate", mycode.idate());
            cmd.Parameters.AddWithValue("@Steps_done", "9");
            ...
            if (InsertUpdate.InsertUpdateData(cmd))
            {
                ...
                Response.Redirect("Scholarship_preview.aspx?regNo=" + regID, false);
            }
        }
        ...
        {
            DataTable dt = mycode.FillData("Select *,(Select top 1 Session from session_details where session_id=Scholarship_Admission.Session_id) as session from Scholarship_Admission where Student_mob_no='" + txt_std_mob.Text + "' and Test_id='" + ViewState["testid"].ToString() + "' and Steps_done!='10'");// and Session_id='" + ddl_session.SelectedValue + "'
            if (dt.Rows.Count == 0)
            {
            ...
            { 
                double regfee = 0;
                DataTable dtfee = mycode.FillTable("Select * from Scholarship_Parameter_fees where Session_id='" + ddl_session.SelectedValue + "' and Class_id='" + ddl_class.SelectedValue + "' and Test_id='" + ViewState["testid"].ToString() + "'");
                if (dtfee.Rows.Count > 0)
                {
                    regfee = Convert.ToDouble(dtfee.Rows[0]["Fees"].ToString());
                    ViewState["regfee"] = regfee.ToString("0.00");
                    txt_reg_fees.Text = regfee.ToString("0.00");
                    if (dt.Rows[0]["Payment_mode"].ToString() == "Offline")
                    {
                ...
                My.exeSql("update Scholarship_Admission set Class='" + ddl_class.SelectedItem.Text + "', Class_id='" + ddl_class.SelectedValue + "', Payable_amount='" + regfee.ToString("0.00") + "' where Id=" + dt.Rows[0]["Id"].ToString() + "");


                DataTable dtd = mycode.FillData("Select *, (Select top 1 Session from session_details where session_id=Scholarship_Admission.Session_id) as session from Scholarship_Admission where Student_mob_no='" + txt_std_mob.Text + "' and Test_id='" + ViewState["testid"].ToString() + "' and Steps_done!='10'");// and Session_id='" + ddl_session.SelectedValue + "'
                if (dtd.Rows.Count > 0)
                {
                    rd_view.DataSource = dtd;
                    rd_view.DataBind();
                }
        ...
        protected void btn_std_dt_Click(object sender, EventArgs e)
        {
            ...
            else if (rd_payment_mode_online.Checked == false && rd_payment_mode_ofline.Checked == false)
            {
                chnage_color_fisrt_button();
            ...
            else
            {
                ...
                if (rd_payment_mode_ofline.Checked == true)
                {
                    if (ViewState["paymentModeOffline"].ToString() == "0")
                    {
        ...
        {
            if (txt_inputcatcha.Text != "")
            {

                //if (ViewState["Student_image"] == null || ViewState["Student_image"].ToString() == "")
                //{
                //    alert("Please upload student image");
                //}
                //else if (ViewState["Father_sig"] == null || ViewState["Father_sig"].ToString() == "")
                //{
                //    alert("Please upload father's signature");
                //}
                //else if (ViewState["mother_sig"].ToString() == null || ViewState["mother_sig"].ToString() == "")
                //{
                //    alert("Please upload mother's signature");
                //}
                //else if (ViewState["mother_photo"].ToString() == null || ViewState["mother_photo"].ToString() == "")
                //{
                //    alert("Please upload mother's photo");
                //}
                //else if (ViewState["father_photo"].ToString() == null || ViewState["father_photo"].ToString() == "")
                //{
                //    alert("Please upload father's photo");
                //}
                //else if (ViewState["birth_certificate"].ToString() == null || ViewState["birth_certificate"].ToString() == "")
                //{
                //    alert("Please upload birth certificate.");
                //}
                //else if (ViewState["residential_certificate"].ToString() == null || ViewState["residential_certificate"].ToString() == "")
                //{
                //    alert("Please upload residential certificate.");
                //}
                //else
                //{
                //    if (ViewState["totcaptc"].ToString() == txt_inputcatcha.Text)
                //    {
                //        mycode.executequery("update Scholarship_Admission set Reg_payment_type='" + ViewState["paymentModeOffline"].ToString() + "' where Registration_id='" + hd_applicationid.Value + "' and Test_id='" + ViewState["testid"].ToString() + "'");
                //        save_data("8");
                //    }
                //    else
                //    {
        ...
        protected void lnkEdit_Click(object sender, EventArgs e)
        {
            ...
            My.exeSql("update SCHOLARSHIP_ADMISSION set School_branch_address='" + Session["SchoolBranch"].ToString() + "' where Registration_id='" + hd_applicationid.Value + "' and Test_id='" + ViewState["testid"].ToString() + "'");
            save_data("1");
        ...
        protected void btn_upload_student_image_Click(object sender, EventArgs e)
        {
            ...
            if (FileUpload1.HasFile)
            {
                ...
                {
                    alert("Please Reduce or compress size of student image max(200kb)");
                    FileUpload1.Focus();
                }
            }
            else
        ...
        protected void btn_upload_father_sig_Click(object sender, EventArgs e)
        {
            ...
            if (FileUpload2.HasFile)
            {
                ...
                {
                    alert("Please Reduce or compress size of father's signature max(200kb)");
                    FileUpload1.Focus();
                }
            }
            else
        ...
        protected void btn_payment_slip_Click(object sender, EventArgs e)
        {
            ...
            if (FileUpload4.HasFile)
            {
                ...
                {
                    alert("Please Reduce or compress size of payment slip max(200kb)");
                    FileUpload4.Focus();
                }
            }
            else
        ...
        public void chnage_color_fisrt_button()
        {
            ...
            if (txt_dob.Text == "")
            {
                txt_dob.BackColor = HexColor("#f91111");
            }
            else
            {
            ...
            if (ddl_Category.Text == "Select")
            {
                ddl_Category.BackColor = HexColor("#f91111");

            }
            else
            {

                ddl_Category.BackColor = HexColor("#ffffff");
                ddl_Category.BorderColor = HexColor("#000000");
            }


            if (rd_day.Checked == false && rd_hostel.Checked == false && rd_dayboarding.Checked == false)
            {
                rd_day.BackColor = HexColor("#f91111");
                rd_hostel.BackColor = HexColor("#f91111");
                rd_dayboarding.BackColor = HexColor("#f91111");
            }
            else
            {
            ...
            if (ddl_class.SelectedItem.Text == "Select")
            {
                ddl_class.BackColor = HexColor("#f91111");

            }
            else
            {
                ddl_class.BackColor = HexColor("#ffffff");
                ddl_class.BorderColor = HexColor("#000000");

            }

            if (rd_payment_mode_online.Checked == false && rd_payment_mode_ofline.Checked == false)
            {
                rd_payment_mode_online.BackColor = HexColor("#f91111");
                rd_payment_mode_ofline.BackColor = HexColor("#f91111");


            }
            else
            {
                rd_payment_mode_online.BackColor = HexColor("#ffffff");
                rd_payment_mode_ofline.BackColor = HexColor("#ffffff");

                if (txt_transaction_no.Text == "")
                {
                    txt_transaction_no.BackColor = HexColor("#f91111");
                }
                else
                {
                    txt_transaction_no.BackColor = HexColor("#ffffff");
                    txt_transaction_no.BorderColor = HexColor("#000000");

                }
                if (ddl_transactiontype.Text == "Select")
                {
                    ddl_transactiontype.BackColor = HexColor("#f91111");
                }

                else
                {
                    ddl_transactiontype.BackColor = HexColor("#ffffff");
                    ddl_transactiontype.BorderColor = HexColor("#000000");

                }

                if (ViewState["payment_slip"].ToString() == "#")
                {
                    FileUpload4.BackColor = HexColor("#f91111");
                }
                else
                {
                    FileUpload4.BackColor = HexColor("#ffffff");
                    FileUpload4.BorderColor = HexColor("#000000");
            ...
            if (txt_father_first_name.Text == "")
            {
                txt_father_first_name.BackColor = HexColor("#f91111");
            }
            else
            {
            ...
            {
                txt_father_mobile.BackColor = HexColor("#f91111");
            }
            else
            {
            ...
            //{
            //    txt_annual_income.BackColor = HexColor("#f91111");
            ...
            if (txt_mother_first_name.Text == "")
            {
                txt_mother_first_name.BackColor = HexColor("#f91111");
        ...
        protected static string ReCaptcha_Key = "6Lei-hsjAAAAAPIrIutG5yVsxOGcBoLFb1p4GJ3H";
        protected static string ReCaptcha_Secret = "6Lei-hsjAAAAAP896x77fTJkMoNB_QXmG6WD9QLw";
