<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Scholarship-registration.aspx.cs" Inherits="school_web.Scholarship.Scholarship_registration" %>
                                            ...
                                            <div class="online_frm">
                                                <asp:Panel ID="pnl_account_details" runat="server">
                                                    <div class="online_frm-hdg">
                                                        <h2 class="online_frm-h">Account Details</h2>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                                                <div class="online_frm-grp">
                                                                    ...
                                                                    <asp:TextBox ID="txt_std_mob" runat="server" CssClass="form_control" MaxLength="10"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                ...
                                                <asp:Panel ID="pnl_student_details" runat="server" Visible="false">
                                                    ...
                                                    <div class="online_frm-inr">
                                                        <div class="row" id="paymenyModeDV" runat="server">
                                                        ...
                                                        <div class="row" id="paymentid1" runat="server" visible="false" style="display: none">
                                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                                <div class="online_frm-grp">
                                                        ...
                                                        <div class="row" id="paymentid2" runat="server" visible="false" style="display: none">
                                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                                <div class="online_frm-grp">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                                <div class="online_frm-grp">
                                                                    ...
                                                                    <asp:TextBox ID="txt_middle_name" runat="server" oninput="this.value = this.value.toUpperCase()" CssClass="form_control" onkeypress="return IsCharacter(event)"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                                <div class="online_frm-grp">
                                                                    <h2 class="online_frm-grp-h">Last Name <sup></sup></h2>
                                                                    <asp:TextBox ID="txt_last_name" runat="server" oninput="this.value = this.value.toUpperCase()" CssClass="form_control" onkeypress="return IsCharacter(event)"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                                <div class="online_frm-grp">
                                                                    ...
                                                                    <asp:DropDownList ID="dl_nationality" runat="server" CssClass="form_control">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                                <div class="online_frm-grp">
                                                                    ...
                                                                    <asp:DropDownList ID="ddl_blod_group" runat="server" CssClass="form_control">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                                <div class="online_frm-grp">
                                                                    <h2 class="online_frm-grp-h">Height<sup> </sup><i style="float: right; font-style: normal;">cms</i></h2>
                                                                    <asp:TextBox ID="txt_height" oninput="this.value = this.value.toUpperCase()" runat="server" CssClass="form_control"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                                <div class="online_frm-grp">
                                                                    <h2 class="online_frm-grp-h">Weight Fees<sup> </sup><i style="float: right; font-style: normal;">kg</i></h2>
                                                                    <asp:TextBox ID="txt_weight" oninput="this.value = this.value.toUpperCase()" runat="server" CssClass="form_control"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                                <div class="online_frm-grp">
                                                                    ...
                                                                    <asp:DropDownList ID="ddl_class" runat="server" CssClass="form_control" AutoPostBack="true" Enabled="false" OnSelectedIndexChanged="ddl_class_SelectedIndexChanged"></asp:DropDownList>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                                <div class="online_frm-grp">
                                                                ...
                                                                <div class="online_frm-grp" style="background: #ffffffd4; padding: 6px;">
                                                                    ...
                                                                    <table class="table-bordered" style="width: 100%">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <asp:TextBox ID="txt_age_sibling1" runat="server" Style="width: 70px" class="form-control"></asp:TextBox></td>
                                                                            <td>
                                                                                <asp:TextBox ID="txt_school_sibling1" runat="server" class="form-control"></asp:TextBox></td>
                                                                            <td>
                                                                                <asp:DropDownList ID="ddl_class_sb1" class="form-control" runat="server"></asp:DropDownList>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>2.</td>
                                                                            ...
                                                                            <td>
                                                                                <asp:TextBox ID="txt_age_sibling2" runat="server" Style="width: 70px" class="form-control"></asp:TextBox></td>
                                                                            <td>
                                                                                <asp:TextBox ID="txt_school_sibling2" runat="server" class="form-control"></asp:TextBox></td>
                                                                            <td>
                                                                                <asp:DropDownList ID="ddl_class_sb2" class="form-control" runat="server"></asp:DropDownList></td>
                                                                        </tr>
                                                                    </table>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                                <div class="online_frm-grp">
                                                                    ...
                                                                    <asp:TextBox ID="txt_board" runat="server" oninput="this.value = this.value.toUpperCase()" CssClass="form_control"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                                <div class="online_frm-grp">
                                                                    ...
                                                                    <asp:TextBox ID="txt_passout_classs" oninput="this.value = this.value.toUpperCase()" runat="server" CssClass="form_control"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                                <div class="online_frm-grp">
                                                                    <h2 class="online_frm-grp-h">Percentage %</h2>
                                                                    <asp:TextBox ID="txt_percentage" oninput="this.value = this.value.toUpperCase()" runat="server" CssClass="form_control"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                                <div class="online_frm-grp">
                                                                    ...
                                                                    <asp:TextBox ID="txt_year" runat="server" oninput="this.value = this.value.toUpperCase()" CssClass="form_control"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                                <div class="online_frm-grp">
                                                                    ...
                                                                    <asp:TextBox ID="txt_occupation" oninput="this.value = this.value.toUpperCase()" runat="server" CssClass="form_control"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                                <div class="online_frm-grp">
                                                                    <h2 class="online_frm-grp-h">Qualification</h2>
                                                                    <asp:TextBox ID="txt_qualitication" oninput="this.value = this.value.toUpperCase()" runat="server" CssClass="form_control"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                                <div class="online_frm-grp">
                                                                    ...
                                                                    <asp:TextBox ID="txt_designation" oninput="this.value = this.value.toUpperCase()" runat="server" CssClass="form_control"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                                <div class="online_frm-grp">
                                                    ...
                                                    <div class="online_frm-inr">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                                <div class="online_frm-grp">
                                                                    <h2 class="online_frm-grp-h">Occupation</h2>
                                                                    <asp:TextBox ID="txt_Mother_Occupation" oninput="this.value = this.value.toUpperCase()" runat="server" CssClass="form_control"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                                <div class="online_frm-grp">
                                                                    <h2 class="online_frm-grp-h">Qualification</h2>
                                                                    <asp:TextBox ID="txt_mother_Qualification" oninput="this.value = this.value.toUpperCase()" runat="server" CssClass="form_control"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                                <div class="online_frm-grp">
                                                                    <h2 class="online_frm-grp-h">Designation</h2>
                                                                    <asp:TextBox ID="txt_mother_Designation" oninput="this.value = this.value.toUpperCase()" runat="server" CssClass="form_control"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                                <div class="online_frm-grp">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                                <div class="online_frm-grp">
                                                                    ...
                                                                    <asp:TextBox ID="txt_State" runat="server" oninput="this.value = this.value.toUpperCase()" CssClass="form_control"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                                <div class="online_frm-grp">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                                <div class="online_frm-grp">
                                                                    ...
                                                                    <asp:TextBox ID="txt_Pstate" runat="server" oninput="this.value = this.value.toUpperCase()" CssClass="form_control"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                                <div class="online_frm-grp">
                                                ...
                                                <asp:Panel ID="pnl_docs" runat="server" Visible="false">
                                                    ...
                                                    <div class="online_frm-inr">
                                                        <div class="row">
                                                            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                                                <div class="online_frm-grp">
                                                                    <h2 class="online_frm-grp-h">Student Recent passport size photograph</h2>
                                                        ...
                                                        <script>
                                                            $('#<%=FileUpload1.ClientID%>').on('change', function () {
                                                                $('#<%=btn_upload_student_image.ClientID%>').click();
                                                            })
                                                        </script>
                                                        ...
                                                        <div class="row" style="display: none">
                                                            ...
                                                            <script>
                                                                $('#<%=FileUpload2.ClientID%>').on('change', function () {
                                                                    $('#<%=btn_upload_father_sig.ClientID%>').click();
                                                                })
                                                            </script>

                                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                                <div class="online_frm-grp">
                                                                    <asp:Image ID="img_father_sig" runat="server" Visible="false" Style="height: 50px; width: 200px; padding: 2px; border: 2px solid #000; margin: 31px 0px 10px 0px!important;" />
                                                        ...
                                                        <div class="row" style="display: none">
                                                                ...
                                                                <div class="online_frm-grp">
                                                                    ...
                                                                    <script>
                                                                        $('#<%=FileUpload3.ClientID%>').on('change', function () {
                                                                            $('#<%=btn_mother_signature.ClientID%>').click();
                                                                        })
                                                                    </script>
                                                            ...
                                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                                <div class="online_frm-grp">
                                                                    <asp:Image ID="img_mother_signature" Visible="false" runat="server" Style="height: 50px; width: 200px; padding: 2px; border: 2px solid #000; margin: 31px 0px 10px 0px!important;" />
                                                        ...
                                                        <div class="row" style="display: none">
                                                            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                                                <div class="online_frm-grp">
                                                                    ...
                                                                    <script>
                                                                        $('#<%=file_mother_photo.ClientID%>').on('change', function () {
                                                                            $('#<%=btn_mothers_photo.ClientID%>').click();
                                                                        })
                                                                    </script>
                                                        ...
                                                        <div class="row" style="display: none">
                                                            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                                                <div class="online_frm-grp">
                                                                    ...
                                                                    <script>
                                                                        $('#<%=file_father_photo.ClientID%>').on('change', function () {
                                                                            $('#<%=btn_upload_father_photo.ClientID%>').click();
                                                                        })
                                                                    </script>
                                                        ...
                                                        <div class="row" style="display: none">
                                                            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                                                <div class="online_frm-grp">
                                                                    ...
                                                                    <script>
                                                                        $('#<%=file_upload_Family_photo.ClientID%>').on('change', function () {
                                                                            $('#<%=btn_upload_Family_photo.ClientID%>').click();
                                                                        })
                                                                    </script>
                                                        ...
                                                        <div class="row" style="display: none">
                                                            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                                                <div class="online_frm-grp">
                                                                    <h2 class="online_frm-grp-h">Birth Certificate of the child</h2>
                                                                    ...
                                                                    <script>
                                                                        $('#<%=file_birth_Certificate.ClientID%>').on('change', function () {
                                                                            $('#<%=btn_upload_birth_certificate.ClientID%>').click();
                                                                        })
                                                                    </script>
                                                        ...
                                                        <div class="row" style="display: none">
                                                            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                                                <div class="online_frm-grp">
                                                                    <h2 class="online_frm-grp-h">Residential Certificate (voter id card/electric bill etc mention Residential  address) <sup></sup></h2>
                                                                    ...
                                                                    <script>
                                                                        $('#<%=file_Residential_Certificate.ClientID%>').on('change', function () {
                                                                            $('#<%=btn_upload_Residential_Certificate.ClientID%>').click();
                                                                        })
                                                                    </script>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                ...
                                                                <asp:RequiredFieldValidator ID="rfvCaptcha" ErrorMessage="Captcha validation is required." ControlToValidate="txtCaptcha"
                                                                    runat="server" ForeColor="Red" Display="Dynamic" ValidationGroup="ab" />

                                                                <asp:TextBox ID="txt_enter_captcha" runat="server" Visible="false" placeholder="Enter Captcha" CssClass="form_control" MaxLength="6" Style="padding: 4px 5px 4px 5px; width: 130px; margin: 0px 5px 0px 0px;"></asp:TextBox>
                                                                <asp:Label ID="Captcha" Visible="false" runat="server" CssClass="protected form_control"></asp:Label>
                                                                <asp:Button ID="btnRefresh" Visible="false" runat="server" Text="Refresh" CssClass="btn-warning" OnClick="btnRefresh_Click" Style="width: 70px; padding: 11px 5px; margin: 0px 0px 0px 3px; border-radius: 4px; border: 1px solid #ddd;" />--%>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Form Filled Summary</h5>
                        <asp:Button ID="btnclose" runat="server" class="btn btn-secondary" OnClientClick="return close()" Style="background: #f00; color: #fff; font-weight: 600;"
                            Text="Close" />
                    </div>
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: left;">
                                                        ...
                                                        <asp:LinkButton ID="lnkEdit" runat="server" CausesValidation="false" OnClick="lnkEdit_Click" ToolTip="Select" Style="background: #029d00; color: #fff; padding: 3px 5px 4px 5px; font-weight: 600; border-radius: 2px;"> Select </asp:LinkButton>
            ...
            var onloadCallback = function () {
                grecaptcha.render('dvCaptcha', {
                    ...
                    'callback': function (response) {
                        $.ajax({
                            type: "POST",
                            url: "Scholarship-registration.aspx/VerifyCaptcha",
