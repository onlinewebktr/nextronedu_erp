<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Print_Page_Seat_full.aspx.cs" Inherits="school_web.print.Print_Page_Seat_full" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Online Registration  Seat Full</title>
                ...
                <div class="print-pg-sec" id="tblPrintIQ" runat="server">
                    <div class="print_form-inr">
                        ...
                        <div class="certificate-type-name-t-sec">
                            <h1 class="t-certificate-type-name-h">Admission Registration Receipt -<asp:Label ID="lbl_session1" runat="server" Text=""></asp:Label>
                            </h1>
                        </div>
